...
isGlob('abc/[a-z].js');
isGlob('abc/***REMOVED***a,b***REMOVED***.js');
//=> true
```
...
```js
isGlob('!foo.js', ***REMOVED***strict: false***REMOVED***);
isGlob('*.js', ***REMOVED***strict: false***REMOVED***);
isGlob('**/abc.js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/*.js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/(aaa|bbb).js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/[a-z].js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/***REMOVED***a,b***REMOVED***.js', ***REMOVED***strict: false***REMOVED***);
//=> true
```
...
```js
isGlob('abc/@(a).js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/!(a).js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/+(a).js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/*(a).js', ***REMOVED***strict: false***REMOVED***);
isGlob('abc/?(a).js', ***REMOVED***strict: false***REMOVED***);
