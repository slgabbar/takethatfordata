...
```js
var prom = new Promise(function(resolve, reject) ***REMOVED***
  // do a thing, possibly async, then…

  if (/* everything turned out fine */) ***REMOVED***
...
prom.then(function(result) ***REMOVED***
...
```js
Promise._unhandledRejectionFn = function(rejectError) ***REMOVED******REMOVED***;
```
