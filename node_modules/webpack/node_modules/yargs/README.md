...
const yargs = require('yargs') // eslint-disable-line
  .command('serve', 'start the server', (yargs) => ***REMOVED***
    yargs.option('port', ***REMOVED***
      describe: 'port to bind on',
      default: 5000
    ***REMOVED***)    
  ***REMOVED***, (argv) => ***REMOVED***
    if (argv.verbose) console.info(`start server on :$***REMOVED***argv.port***REMOVED***`)
    serve(argv.port)
  ***REMOVED***)
  .option('verbose', ***REMOVED***
    alias: 'v',
    default: false
  ***REMOVED***)
  .help()
