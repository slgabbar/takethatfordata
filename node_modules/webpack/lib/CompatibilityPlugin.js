...
class CompatibilityPlugin ***REMOVED***
		...
		compiler.plugin("compilation", (compilation, params) => ***REMOVED***
			...
			params.normalModuleFactory.plugin("parser", (parser, parserOptions) => ***REMOVED***
				...
				parser.plugin("call require", (expr) => ***REMOVED***
					...
					dep.loc = expr.loc;
					if(parser.state.current.dependencies.length > 1) ***REMOVED***
			...
			***REMOVED***);
			...
			params.normalModuleFactory.plugin("after-resolve", (data, done) => ***REMOVED***
				...
				if(matchJson.test(data.request) && data.loaders.length === 0) ***REMOVED***
					data.loaders.push(***REMOVED***
