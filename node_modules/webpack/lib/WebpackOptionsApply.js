...
class WebpackOptionsApply extends OptionsApply ***REMOVED***
	constructor() ***REMOVED***
		super();
	***REMOVED***

	process(options, compiler) ***REMOVED***
		let ExternalsPlugin;
		...
		if(typeof options.target === "string") ***REMOVED***
			let JsonpTemplatePlugin;
			let NodeSourcePlugin;
			let NodeTargetPlugin;
			let NodeTemplatePlugin;

			switch(options.target) ***REMOVED***
				case "web":
				...
				case "async-node":
					...
					compiler.apply(
						new NodeTemplatePlugin(***REMOVED***
			...
			***REMOVED***
		***REMOVED*** else if(options.target !== false) ***REMOVED***
			options.target(compiler);
		***REMOVED*** else ***REMOVED***
			throw new Error("Unsupported target '" + options.target + "'.");
		***REMOVED***

		if(options.output.library || options.output.libraryTarget !== "var") ***REMOVED***
		...
		***REMOVED***
		...
		let modern;
		let comment;
		if(options.devtool && (options.devtool.indexOf("sourcemap") >= 0 || options.devtool.indexOf("source-map") >= 0)) ***REMOVED***
			...
			compiler.apply(new Plugin(***REMOVED***
				...
				noSources: noSources,
			***REMOVED***));
		***REMOVED*** else if(options.devtool && options.devtool.indexOf("eval") >= 0) ***REMOVED***
			legacy = options.devtool.indexOf("@") >= 0;
			modern = options.devtool.indexOf("#") >= 0;
			comment = legacy && modern ? "\n//@ sourceURL=[url]\n//# sourceURL=[url]" :
				legacy ? "\n//@ sourceURL=[url]" :
		...
		***REMOVED***
		...
		compiler.apply(
			...
			new AMDPlugin(options.module, options.amd || ***REMOVED******REMOVED***),
		...
		if(options.performance) ***REMOVED***
		...
		***REMOVED***
		...
		compiler.resolvers.normal = ResolverFactory.createResolver(Object.assign(***REMOVED***
			fileSystem: compiler.inputFileSystem
		***REMOVED***, options.resolve));
		compiler.resolvers.context = ResolverFactory.createResolver(Object.assign(***REMOVED***
			fileSystem: compiler.inputFileSystem,
			resolveToContext: true
		***REMOVED***, options.resolve));
		compiler.resolvers.loader = ResolverFactory.createResolver(Object.assign(***REMOVED***
			fileSystem: compiler.inputFileSystem
		***REMOVED***, options.resolveLoader));
