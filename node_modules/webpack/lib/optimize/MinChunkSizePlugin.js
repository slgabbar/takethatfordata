...
class MinChunkSizePlugin ***REMOVED***
	constructor(options) ***REMOVED***
		if(typeof options !== "object" || Array.isArray(options)) ***REMOVED***
	...
	apply(compiler) ***REMOVED***
		...
		compiler.plugin("compilation", (compilation) => ***REMOVED***
			compilation.plugin("optimize-chunks-advanced", (chunks) => ***REMOVED***
				const equalOptions = ***REMOVED***
					chunkOverhead: 1,
					entryChunkMultiplicator: 1
				***REMOVED***;

				const sortedSizeFilteredExtendedPairCombinations = chunks.reduce((combinations, a, idx) => ***REMOVED***
