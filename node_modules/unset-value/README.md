...
var obj = ***REMOVED***a: ***REMOVED***b: ***REMOVED***c: 'd', e: 'f'***REMOVED******REMOVED******REMOVED***;
unset(obj, 'a.b.c');
console.log(obj);
//=> ***REMOVED***a: ***REMOVED***b: ***REMOVED***e: 'f'***REMOVED******REMOVED******REMOVED***;
```
...
```js
unset(***REMOVED***a: 'b'***REMOVED***, 'a') // true
```
...
```js
unset(***REMOVED***a: ***REMOVED***b: ***REMOVED***c: 'd'***REMOVED******REMOVED******REMOVED***, 'd') // true
```

### delete nested values

```js
var one = ***REMOVED***a: ***REMOVED***b: ***REMOVED***c: 'd'***REMOVED******REMOVED******REMOVED***;
unset(one, 'a.b');
console.log(one);
//=> ***REMOVED***a: ***REMOVED******REMOVED******REMOVED***

var two = ***REMOVED***a: ***REMOVED***b: ***REMOVED***c: 'd'***REMOVED******REMOVED******REMOVED***;
unset(two, 'a.b.c');
console.log(two);
//=> ***REMOVED***a: ***REMOVED***b: ***REMOVED******REMOVED******REMOVED******REMOVED***

var three = ***REMOVED***a: ***REMOVED***b: ***REMOVED***c: 'd', e: 'f'***REMOVED******REMOVED******REMOVED***;
unset(three, 'a.b.c');
console.log(three);
//=> ***REMOVED***a: ***REMOVED***b: ***REMOVED***e: 'f'***REMOVED******REMOVED******REMOVED***
```
