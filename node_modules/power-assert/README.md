...
The core value of power-assert is absolute simplicity and stability. Especially, power-assert sticks to the simplest form of testing, `assert(any_expression)`.
        ...
        assert(types[index].name === bob.name)
               |    ||      |    |   |   |
               |    ||      |    |   |   "bob"
               |    ||      |    |   Person***REMOVED***name:"bob",age:5***REMOVED***
               |    ||      |    false
               |    |11     "alice"
               |    Person***REMOVED***name:"alice",age:3***REMOVED***
...
describe('Array', function()***REMOVED***
    let ary;
    beforeEach(() => ***REMOVED***
        ary = [1,2,3];
    ***REMOVED***);
    describe('#indexOf()', () => ***REMOVED***
        it('should return index when the value is present', () => ***REMOVED***
            const zero = 0, two = 2;
            assert(ary.indexOf(zero) === two);
        ***REMOVED***);
        it('should return -1 when the value is not present', () => ***REMOVED***
...
describe('various types', () => ***REMOVED***
    let types;
    class Person ***REMOVED***
        constructor(name, age) ***REMOVED***
            this.name = name;
            this.age = age;
        ***REMOVED***
    ***REMOVED***
...
```javascript
var assert = require('power-assert').customize(***REMOVED***
    output: ***REMOVED***
        maxDepth: 2
    ***REMOVED***
***REMOVED***);
...
(function () ***REMOVED***
    ...
    empower(q.assert, formatter(), ***REMOVED***destructive: true***REMOVED***);
    qunitTap(q, require('util').puts, ***REMOVED***showSourceOnFailure: false***REMOVED***);
    q.config.autorun = false;
***REMOVED***)();

q.test('spike', function (assert) ***REMOVED***
    assert.ok(true);
    ...
    var func = function () ***REMOVED*** return false; ***REMOVED***;
    assert.ok(func());


    var obj = ***REMOVED***
        age: function () ***REMOVED***
            return 0;
        ***REMOVED***
    ***REMOVED***;
    assert.ok(obj.age());
    ...
    var isFalsy = function (arg) ***REMOVED***
        return !(arg);
    ***REMOVED***;
    var positiveInt = 50;
    ...
    var sum = function () ***REMOVED***
        var result = 0;
        for (var i = 0; i < arguments.length; i += 1) ***REMOVED***
            result += arguments[i];
        ***REMOVED***
        return result;
    ***REMOVED***;
...
#           |   |   |
#           |   |   false
#           |   Object***REMOVED***baz:false***REMOVED***
#           Object***REMOVED***bar:#Object#***REMOVED***
# , test: spike
...
#           |   |
#           |   0
#           Object***REMOVED***age:#function#***REMOVED***
# , test: spike
...
#           |    |    |   |    |    |      |   7
#           |    |    6   1    2    3      false
#           |    Object***REMOVED***sum:#function#***REMOVED***
#           Object***REMOVED***calc:#Object#***REMOVED***
#
# [number] seven
# => 7
