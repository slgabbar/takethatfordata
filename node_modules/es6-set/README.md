...
var set = new Set(['raz', 'dwa', ***REMOVED******REMOVED***]);
...
set.forEach(function (value) ***REMOVED***
 // 'raz', ***REMOVED******REMOVED***, 'foo' iterated
***REMOVED***);

// FF nightly only:
for (value of set) ***REMOVED***
 // 'raz', ***REMOVED******REMOVED***, 'foo' iterated
***REMOVED***

var iterator = set.values();

iterator.next(); // ***REMOVED*** done: false, value: 'raz' ***REMOVED***
iterator.next(); // ***REMOVED*** done: false, value: ***REMOVED******REMOVED*** ***REMOVED***
iterator.next(); // ***REMOVED*** done: false, value: 'foo' ***REMOVED***
