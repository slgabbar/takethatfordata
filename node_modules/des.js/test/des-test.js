...
describe('DES', function() ***REMOVED***
  describe('Key Derivation', function() ***REMOVED***
    it('should derive proper keys', function() ***REMOVED***
      var d = des.DES.create(***REMOVED***
        type: 'encrypt',
  ...
  ***REMOVED***);
  ...
  describe('encryption/decryption', function() ***REMOVED***
    var vectors = [
      ***REMOVED***
    ...
    vectors.forEach(function(vec, i) ***REMOVED***
      it('should encrypt vector ' + i, function() ***REMOVED***
        var key = new Buffer(vec.key, 'hex');
        var input = new Buffer(vec.input, 'hex');

        var enc = des.DES.create(***REMOVED***
          type: 'encrypt',
          key: key
        ***REMOVED***);
        var dec = des.DES.create(***REMOVED***
          type: 'decrypt',
          key: key
        ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    it('should buffer during encryption/decryption', function() ***REMOVED***
