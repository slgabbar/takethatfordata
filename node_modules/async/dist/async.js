...
function slice(arrayLike, start) ***REMOVED***
    start = start|0;
    var newLen = Math.max(arrayLike.length - start, 0);
    var newArr = Array(newLen);
    for(var idx = 0; idx < newLen; idx++)  ***REMOVED***
 ...
 * @method
 * @category Util
 * @param ***REMOVED***Function***REMOVED*** fn - The function you want to eventually apply all
 * arguments to. Invokes with (arguments...).
 * @param ***REMOVED***...****REMOVED*** arguments... - Any number of arguments to automatically apply
 * when the continuation is called.
 * @returns ***REMOVED***Function***REMOVED*** the partially-applied function
 * @example
 *
 * // using apply
 * async.parallel([
 ...
 * three
 */
var apply = function(fn/*, ...args*/) ***REMOVED***
    var args = slice(arguments, 1);
    return function(/*callArgs*/) ***REMOVED***
...
var initialParams = function (fn) ***REMOVED***
    return function (/*...args, callback*/) ***REMOVED***
...
function wrap(defer) ***REMOVED***
    return function (fn/*, ...args*/) ***REMOVED***
        var args = slice(arguments, 1);
 ...
 * @alias wrapSync
 * @category Util
 * @param ***REMOVED***Function***REMOVED*** func - The synchronous function, or Promise-returning
 * function to convert to an ***REMOVED***@link AsyncFunction***REMOVED***.
 * @returns ***REMOVED***AsyncFunction***REMOVED*** An asynchronous wrapper of the `func`. To be
...
function invokeCallback(callback, error, value) ***REMOVED***
    try ***REMOVED***
...
function rethrow(error) ***REMOVED***
    throw error;
***REMOVED***

var supportsSymbol = typeof Symbol === 'function';

function isAsync(fn) ***REMOVED***
    return supportsSymbol && fn[Symbol.toStringTag] === 'AsyncFunction';
***REMOVED***

function wrapAsync(asyncFn) ***REMOVED***
    return isAsync(asyncFn) ? asyncify(asyncFn) : asyncFn;
***REMOVED***

function applyEach$1(eachfn) ***REMOVED***
    return function(fns/*, ...args*/) ***REMOVED***
        var args = slice(arguments, 1);
        ...
        ***REMOVED***
        ...
        function iterateeCallback(err, value) ***REMOVED***
            ...
            if (err) ***REMOVED***
                ...
                callback(err);
            ***REMOVED***
            else if (value === breakLoop || (done && running <= 0)) ***REMOVED***
                done = true;
                return callback(null);
            ***REMOVED***
            else ***REMOVED***
 ...
 * @param ***REMOVED***AsyncFunction***REMOVED*** iteratee - An async function to apply to each
...
function eachOfArrayLike(coll, iteratee, callback) ***REMOVED***
    ...
    ***REMOVED***
    ...
    function iteratorCallback(err, value) ***REMOVED***
        if (err) ***REMOVED***
            callback(err);
        ***REMOVED*** else if ((++completed === length) || value === breakLoop) ***REMOVED***
            callback(null);
        ***REMOVED***
    ***REMOVED***
...
function _asyncMap(eachfn, arr, iteratee, callback) ***REMOVED***
    ...
    eachfn(arr, function (value, _, callback) ***REMOVED***
        var index = counter++;
        _iteratee(value, function (err, v) ***REMOVED***
            results[index] = v;
            callback(err);
        ***REMOVED***);
    ***REMOVED***, function (err) ***REMOVED***
 ...
 * @param ***REMOVED***Array|Iterable|Object***REMOVED*** fns - A collection of ***REMOVED***@link AsyncFunction***REMOVED***s
...
/**
 * Determines the best order for running the ***REMOVED***@link AsyncFunction***REMOVED***s in `tasks`, based on
 * their requirements. Each function can optionally depend on other functions
 * being completed first, and each function is run as soon as its requirements
 * are satisfied.
 *
 * If any of the ***REMOVED***@link AsyncFunction***REMOVED***s pass an error to their callback, the `auto` sequence
 * will stop. Further tasks will not execute (so any other functions depending
 * on it will not run), and the main `callback` is immediately called with the
 * error.
 *
 * ***REMOVED***@link AsyncFunction***REMOVED***s also receive an object containing the results of functions which
 ...
 * function or an array of requirements, with the ***REMOVED***@link AsyncFunction***REMOVED*** itself the last item
...
var auto = function (tasks, concurrency, callback) ***REMOVED***
    ...
    ***REMOVED***
    ...
    function runTask(key, task) ***REMOVED***
        ...
        var taskCallback = onlyOnce(function(err, result) ***REMOVED***
            runningTasks--;
 ...
 * @category Control Flow
 * @param ***REMOVED***Object***REMOVED*** tasks - An object, each of whose properties is an ***REMOVED***@link AsyncFunction***REMOVED*** of
...
function autoInject(tasks, callback) ***REMOVED***
    ...
    baseForOwn(tasks, function (taskFn, key) ***REMOVED***
        ...
        ***REMOVED*** else if (hasNoDeps) ***REMOVED***
            // no dependencies, use the function as-is
            newTasks[key] = taskFn;
        ***REMOVED*** else ***REMOVED***
            params = parseParams(taskFn);
            if (taskFn.length === 0 && !fnIsAsync && params.length === 0) ***REMOVED***
 ...
 * @category Control Flow
 * @param ***REMOVED***AsyncFunction***REMOVED*** worker - An asynchronous function for processing an array
 ...
 * ***REMOVED***);
 */
function seq(/*...functions*/) ***REMOVED***
    ...
    return function(/*...args*/) ***REMOVED***
        ...
        ***REMOVED***
        ...
        reduce(_functions, args, function(newargs, fn, cb) ***REMOVED***
            fn.apply(that, newargs.concat(function(err/*, ...nextargs*/) ***REMOVED***
 ...
 * ***REMOVED***);
 */
var compose = function(/*...args*/) ***REMOVED***
...
/**
 * The same as [`concat`]***REMOVED***@link module:Collections.concat***REMOVED*** but runs a maximum of `limit` async operations at a time.
 *
 * @name concatLimit
 * @static
 * @memberOf module:Collections
 ...
 * @param ***REMOVED***Array|Iterable|Object***REMOVED*** coll - A collection to iterate over.
 * @param ***REMOVED***number***REMOVED*** limit - The maximum number of async operations at a time.
 * @param ***REMOVED***AsyncFunction***REMOVED*** iteratee - A function to apply to each item in `coll`,
 ...
 * (err, results).
 */
var concatLimit = function(coll, limit, iteratee, callback) ***REMOVED***
    callback = callback || noop;
    var _iteratee = wrapAsync(iteratee);
    mapLimit(coll, limit, function(val, callback) ***REMOVED***
        _iteratee(val, function(err /*, ...args*/) ***REMOVED***
            if (err) return callback(err);
 ...
 * callback with.
 * @returns ***REMOVED***AsyncFunction***REMOVED*** Returns a function that when invoked, automatically
 ...
 * ***REMOVED***, callback);
 */
var constant = function(/*...values*/) ***REMOVED***
    var values = slice(arguments);
    var args = [null].concat(values);
    return function (/*...ignoredArgs, callback*/) ***REMOVED***
...
function _createTester(check, getResult) ***REMOVED***
    return function(eachfn, arr, iteratee, cb) ***REMOVED***
        cb = cb || noop;
        var testPassed = false;
        var testResult;
        eachfn(arr, function(value, _, callback) ***REMOVED***
            iteratee(value, function(err, result) ***REMOVED***
                if (err) ***REMOVED***
                    callback(err);
                ***REMOVED*** else if (check(result) && !testResult) ***REMOVED***
                    testPassed = true;
 ...
 * @param ***REMOVED***Array|Iterable|Object***REMOVED*** coll - A collection to iterate over.
 * @param ***REMOVED***AsyncFunction***REMOVED*** iteratee - A truth test to apply to each item in `coll`.
...
function consoleFunc(name) ***REMOVED***
    return function (fn/*, ...args*/) ***REMOVED***
        var args = slice(arguments, 1);
        args.push(function (err/*, ...args*/) ***REMOVED***
            var args = slice(arguments, 1);
...
/**
 * Logs the result of an [`async` function]***REMOVED***@link AsyncFunction***REMOVED*** to the
 ...
 * @method
 * @category Util
 * @param ***REMOVED***AsyncFunction***REMOVED*** function - The function you want to eventually apply
 * all arguments to.
 ...
 * @category Control Flow
 * @param ***REMOVED***AsyncFunction***REMOVED*** fn - An async function which is called each time
 * `test` passes. Invoked with (callback).
 * @param ***REMOVED***AsyncFunction***REMOVED*** test - asynchronous truth test to perform before each
...
function doDuring(fn, test, callback) ***REMOVED***
    ...
    function next(err/*, ...args*/) ***REMOVED***
        if (err) return callback(err);
        var args = slice(arguments, 1);
        args.push(check);
 ...
 * @category Control Flow
 * @param ***REMOVED***AsyncFunction***REMOVED*** iteratee - A function which is called each time `test`
...
function doWhilst(iteratee, test, callback) ***REMOVED***
    callback = onlyOnce(callback || noop);
    var _iteratee = wrapAsync(iteratee);
    var next = function(err/*, ...args*/) ***REMOVED***
        if (err) return callback(err);
        var args = slice(arguments, 1);
 ...
 * @category Control Flow
 * @param ***REMOVED***AsyncFunction***REMOVED*** iteratee - An async function which is called each time
 ...
 */
function doUntil(iteratee, test, callback) ***REMOVED***
    doWhilst(iteratee, function() ***REMOVED***
 ...
 * @category Collection
 * @param ***REMOVED***Array|Iterable|Object***REMOVED*** coll - A collection to iterate over.
 * @param ***REMOVED***AsyncFunction***REMOVED*** iteratee - An async function to apply to
 ...
 * @method
 * @category Util
 * @param ***REMOVED***AsyncFunction***REMOVED*** fn - an async function, one that expects a node-style
 * callback as its last argument.
 * @returns ***REMOVED***AsyncFunction***REMOVED*** Returns a wrapped function with the exact same call
 ...
 * @category Collection
 * @param ***REMOVED***Array|Iterable|Object***REMOVED*** coll - A collection to iterate over.
 * @param ***REMOVED***AsyncFunction***REMOVED*** iteratee - An async truth test to apply to each item
 ...
 * @method
 * @category Control Flow
 * @param ***REMOVED***AsyncFunction***REMOVED*** fn - an async function to call repeatedly.
 * Invoked with (next).
 ...
 */
var groupByLimit = function(coll, limit, iteratee, callback) ***REMOVED***
    callback = callback || noop;
    var _iteratee = wrapAsync(iteratee);
    mapLimit(coll, limit, function(val, callback) ***REMOVED***
 ...
 * @example
 *
 * async.groupBy(['userId1', 'userId2', 'userId3'], function(userId, callback) ***REMOVED***
 *     db.findById(userId, function(err, user) ***REMOVED***
 *         if (err) return callback(err);
 *         return callback(null, user.age);
 *     ***REMOVED***);
 * ***REMOVED***, function(err, result) ***REMOVED***
 *     // result is object containing the userIds grouped by age
 *     // e.g. ***REMOVED*** 30: ['userId1', 'userId3'], 42: ['userId2']***REMOVED***;
 * ***REMOVED***);
 */
 ...
 * @memberOf module:Utils
 * @method
 * @see [async.setImmediate]***REMOVED***@link module:Utils.setImmediate***REMOVED***
 * @category Util
...
function _parallel(eachfn, tasks, callback) ***REMOVED***
    ...
    eachfn(tasks, function (task, key, callback) ***REMOVED***
        wrapAsync(task)(function (err, result) ***REMOVED***
            if (arguments.length > 2) ***REMOVED***
                result = slice(arguments, 1);
            ***REMOVED***
            results[key] = result;
 ...
 * @method
 * @category Control Flow
 * @param ***REMOVED***Array***REMOVED*** tasks - An array containing [async functions]***REMOVED***@link AsyncFunction***REMOVED***
 ...
 * @method
 * @category Util
 * @param ***REMOVED***AsyncFunction***REMOVED*** fn - The async function you want to wrap
...
function reflect(fn) ***REMOVED***
    ...
    return initialParams(function reflectOn(args, reflectCallback) ***REMOVED***
        args.push(function callback(error, cbArg) ***REMOVED***
            if (error) ***REMOVED***
                reflectCallback(null, ***REMOVED*** error: error ***REMOVED***);
            ***REMOVED*** else ***REMOVED***
                var value;
                if (arguments.length <= 2) ***REMOVED***
                    value = cbArg;
                ...
                ***REMOVED***
                reflectCallback(null, ***REMOVED*** value: value ***REMOVED***);
            ***REMOVED***
        ***REMOVED***);
 ...
 * @category Collection
 * @param ***REMOVED***Array|Iterable|Object***REMOVED*** coll - A collection to iterate over.
 * @param ***REMOVED***Function***REMOVED*** iteratee - An async truth test to apply to each item in
 * `coll`.
 ...
 * @method
 * @category Control Flow
 * @see [async.retryable]***REMOVED***@link module:ControlFlow.retryable***REMOVED***
 ...
 * @param ***REMOVED***AsyncFunction***REMOVED*** task - An async function to retry.
...
function retry(opts, task, callback) ***REMOVED***
    ...
    ***REMOVED***
    ...
    function retryAttempt() ***REMOVED***
        _task(function(err) ***REMOVED***
            if (err && attempt++ < options.times &&
                (typeof options.errorFilter != 'function' ||
                    options.errorFilter(err))) ***REMOVED***
...
function sortBy (coll, iteratee, callback) ***REMOVED***
    ...
    map(coll, function (x, callback) ***REMOVED***
        _iteratee(x, function (err, criteria) ***REMOVED***
            if (err) return callback(err);
 ...
 * @method
 * @category Util
 * @param ***REMOVED***AsyncFunction***REMOVED*** asyncFn - The async function to limit in time.
 ...
 * @returns ***REMOVED***AsyncFunction***REMOVED*** Returns a wrapped function that can be used with any
 ...
 * @method
 * @category Control Flow
 * @param ***REMOVED***Array|Iterable|Object***REMOVED*** tasks - A collection containing functions to
 * run, each function is passed a `callback(err, result)` it must call on
 * completion with an error `err` (which can be `null`) and an optional `result`
 * value.
 * @param ***REMOVED***Function***REMOVED*** [callback] - An optional callback which is called when one
 * of the tasks has succeeded, or all have failed. It receives the `err` and
 * `result` arguments of the last attempt at completing the `task`. Invoked with
 * (err, results).
 * @example
 * async.tryEach([
 *     function getDataFromFirstWebsite(callback) ***REMOVED***
 *         // Try getting the data from the first website
 *         callback(err, data);
 *     ***REMOVED***,
 *     function getDataFromSecondWebsite(callback) ***REMOVED***
 ...
 *
 */
function tryEach(tasks, callback) ***REMOVED***
    var error = null;
    var result;
    callback = callback || noop;
    eachSeries(tasks, function(task, callback) ***REMOVED***
        wrapAsync(task)(function (err, res/*, ...args*/) ***REMOVED***
            if (arguments.length > 2) ***REMOVED***
                result = slice(arguments, 1);
            ***REMOVED*** else ***REMOVED***
                result = res;
 ...
 * @category Util
 * @param ***REMOVED***AsyncFunction***REMOVED*** fn - the memoized function
 * @returns ***REMOVED***AsyncFunction***REMOVED*** a function that calls the original unmemoized function
 */
 ...
 * callback. Invoked with (err, [results]);
 */
function until(test, iteratee, callback) ***REMOVED***
    whilst(function() ***REMOVED***
        return !test.apply(this, arguments);
    ***REMOVED***, iteratee, callback);
***REMOVED***
 ...
 * @method
 * @category Control Flow
 * @param ***REMOVED***Array***REMOVED*** tasks - An array of [async functions]***REMOVED***@link AsyncFunction***REMOVED***
 * to run.
...
var waterfall = function(tasks, callback) ***REMOVED***
    ...
    ***REMOVED***
    ...
    function next(err/*, ...args*/) ***REMOVED***
        if (err || taskIndex === tasks.length) ***REMOVED***
 ...
 * (`function (arg1, arg2, ..., callback) ***REMOVED******REMOVED***`)
 ...
 * [ES2017 `async` function]***REMOVED***@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function***REMOVED***.
 ...
 * must still wrap the function with [asyncify]***REMOVED***@link module:Utils.asyncify***REMOVED***,
 * because the `async function` will be compiled to an ordinary function that
 * returns a promise.
 *
 * @typedef ***REMOVED***Function***REMOVED*** AsyncFunction
 * @static
 */
