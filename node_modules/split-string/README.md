...
split('a.***REMOVED***b.c***REMOVED***');
//=> [ 'a', '***REMOVED***b', 'c***REMOVED***' ]

// support all basic bracket types: "<>***REMOVED******REMOVED***[]()"
split('a.***REMOVED***b.c***REMOVED***', ***REMOVED***brackets: true***REMOVED***);
//=> [ 'a', '***REMOVED***b.c***REMOVED***' ]

// also supports nested brackets 
split('a.***REMOVED***b.***REMOVED***c.d***REMOVED***.e***REMOVED***.f', ***REMOVED***brackets: true***REMOVED***);
//=> [ 'a', '***REMOVED***b.***REMOVED***c.d***REMOVED***.e***REMOVED***', 'f' ]

// support only the specified brackets
split('[a.b].(c.d)', ***REMOVED***brackets: ***REMOVED***'[': ']'***REMOVED******REMOVED***);
//=> [ '[a.b]', '(c', 'd)' ]
```
...
```js
split('a.b,c', ***REMOVED***sep: ','***REMOVED***);
//=> ['a.b', 'c']
...
split('a.b.\\c', ***REMOVED***keepEscaping: true***REMOVED***);
//=> ['a', 'b\.c']
```
...
split('a."b.c.d".e', ***REMOVED***keepQuotes: true***REMOVED***);
//=> ['a', '"b.c.d"', 'e']
...
split('a."b.c.d".e', ***REMOVED***keepDoubleQuotes: true***REMOVED***);
//=> ['a', '"b.c.d"', 'e']
```
...
split('a.\'b.c.d\'.e', ***REMOVED***keepSingleQuotes: true***REMOVED***);
//=> ['a', '\'b.c.d\'', 'e']
```
...
```js
var arr = split('a.b', function(tok) ***REMOVED***
  if (tok.arr[tok.arr.length - 1] === 'a') ***REMOVED***
    tok.split = false;
  ***REMOVED***
***REMOVED***);
console.log(arr);
