...
sourceMapResolve.resolveSourceMap(code, "/js/foo.js", fs.readFile, function(error, result) ***REMOVED***
  if (error) ***REMOVED***
    return notifyFailure(error)
  ***REMOVED***
  result
  // ***REMOVED***
  //   map: ***REMOVED***file: "foo.js", mappings: "...", sources: ["/coffee/foo.coffee"], names: []***REMOVED***,
  //   url: "/js/foo.js.map",
  //   sourcesRelativeTo: "/js/foo.js.map",
  //   sourceMappingURL: "foo.js.map"
  // ***REMOVED***

  sourceMapResolve.resolveSources(result.map, result.sourcesRelativeTo, fs.readFile, function(error, result) ***REMOVED***
    if (error) ***REMOVED***
      return notifyFailure(error)
    ***REMOVED***
    result
...
sourceMapResolve.resolve(code, "/js/foo.js", fs.readFile, function(error, result) ***REMOVED***
  if (error) ***REMOVED***
    return notifyFailure(error)
  ***REMOVED***
  result
...
The spec says that if a source map (as a string) starts with `)]***REMOVED***'`, it should
