...
nodeCode = nodeCode
  ...
  // Change `module.exports = ***REMOVED***...***REMOVED***` to `return ***REMOVED***...***REMOVED***`.
  .replace(/module\.exports = (\***REMOVED***[^***REMOVED***]+\***REMOVED***)\s*$/, "return $1")

  // Indent.
  .replace(/^(?!$)/gm, "  ")

var code = template.replace(/[ \t]*\***REMOVED***\***REMOVED***source-map-resolve-node.js\***REMOVED***\***REMOVED***/, nodeCode)
