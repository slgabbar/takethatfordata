...
module.exports = function (t, a) ***REMOVED***
	var x = ***REMOVED******REMOVED***, y = ***REMOVED******REMOVED***, z = ***REMOVED******REMOVED***, count, count2, count3, pipe;
	...
	count2 = 0;
	count3 = 0;
	x.on('foo', function () ***REMOVED***
		++count;
	***REMOVED***);
	y.on('foo', function () ***REMOVED***
		++count2;
	***REMOVED***);
	z.on('foo', function () ***REMOVED***
		++count3;
	***REMOVED***);
