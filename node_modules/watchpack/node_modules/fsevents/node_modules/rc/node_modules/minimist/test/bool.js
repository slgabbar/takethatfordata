...
test('boolean and alias array with options hash', function (t) ***REMOVED***
    var aliased = [ '-h', 'derp' ];
    var regular = [ '--herp', 'derp' ];
    var alt = [ '--harp', 'derp' ];
    var opts = ***REMOVED***
        alias: ***REMOVED*** 'h': ['herp', 'harp'] ***REMOVED***,
        boolean: 'h'
    ***REMOVED***;
    var aliasedArgv = parse(aliased, opts);
    var propertyArgv = parse(regular, opts);
...
test('boolean --boool=true', function (t) ***REMOVED***
    var parsed = parse(['--boool=true'], ***REMOVED***
        default: ***REMOVED***
            boool: false
        ***REMOVED***,
        boolean: ['boool']
...
test('boolean --boool=false', function (t) ***REMOVED***
    var parsed = parse(['--boool=false'], ***REMOVED***
        default: ***REMOVED***
          boool: true
        ***REMOVED***,
        boolean: ['boool']
