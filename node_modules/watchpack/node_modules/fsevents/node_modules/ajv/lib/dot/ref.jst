...
***REMOVED******REMOVED***??***REMOVED******REMOVED***
  ...
  ***REMOVED******REMOVED***? $refVal === undefined ***REMOVED******REMOVED***
    ***REMOVED******REMOVED*** var $message = 'can\'t resolve reference ' + $schema + ' from id ' + it.baseId; ***REMOVED******REMOVED***
    ***REMOVED******REMOVED***? it.opts.missingRefs == 'fail' ***REMOVED******REMOVED***
      ***REMOVED******REMOVED*** console.log($message); ***REMOVED******REMOVED***
...
***REMOVED******REMOVED***? $refCode ***REMOVED******REMOVED***
  ...
  ***REMOVED******REMOVED***? $async ***REMOVED******REMOVED***
    ***REMOVED******REMOVED*** if (!it.async) throw new Error('async schema referenced by sync schema'); ***REMOVED******REMOVED***
    try ***REMOVED*** ***REMOVED******REMOVED***? $breakOnError ***REMOVED******REMOVED***var ***REMOVED******REMOVED***=$valid***REMOVED******REMOVED*** =***REMOVED******REMOVED***?***REMOVED******REMOVED*** ***REMOVED******REMOVED***=it.yieldAwait***REMOVED******REMOVED*** ***REMOVED******REMOVED***=__callValidate***REMOVED******REMOVED***; ***REMOVED***
    catch (e) ***REMOVED***
