...
var ourTheme = themes(***REMOVED***hasUnicode: true, hasColor: true***REMOVED***)

// fetch the default non-color unicode theme for osx
var ourTheme = themes(***REMOVED***hasUnicode: true, hasColor: false, platform: 'darwin'***REMOVED***)

// create a new theme based on the color ascii theme for this platform
// that brackets the progress bar with arrows
var ourTheme = themes.newTheme(theme(hasUnicode: false, hasColor: true***REMOVED***), ***REMOVED***
  preProgressbar: '→',
  postProgressbar: '←'
***REMOVED***)
```
