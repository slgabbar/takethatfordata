...
Readable.prototype.push = function (chunk, encoding) ***REMOVED***
  ...
  if (!state.objectMode && typeof chunk === 'string') ***REMOVED***
...
function readableAddChunk(stream, state, chunk, encoding, addToFront) ***REMOVED***
  ...
  ***REMOVED*** else if (chunk === null) ***REMOVED***
    state.reading = false;
...
function chunkInvalid(state, chunk) ***REMOVED***
  var er = null;
  if (!Buffer.isBuffer(chunk) && typeof chunk !== 'string' && chunk !== null && chunk !== undefined && !state.objectMode) ***REMOVED***
