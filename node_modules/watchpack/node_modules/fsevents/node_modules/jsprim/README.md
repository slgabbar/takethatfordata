...
becomes:
    ...
    [
        [ 'I',  'A', 'i',   ***REMOVED*** 'datum1': [ 1, 2 ], 'datum2': [ 3, 4 ] ***REMOVED*** ],
        [ 'I',  'A', 'ii',  ***REMOVED*** 'datum1': [ 3, 4 ] ***REMOVED*** ],
        [ 'I',  'B', 'i',   ***REMOVED*** 'datum1': [ 5, 6 ] ***REMOVED*** ],
        [ 'I',  'B', 'ii',  ***REMOVED*** 'datum1': [ 7, 8 ], 'datum2': [ 3, 4 ] ***REMOVED*** ],
        [ 'I',  'B', 'iii', ***REMOVED******REMOVED*** ],
        [ 'II', 'A', 'i',   ***REMOVED*** 'datum1': [ 1, 2 ], 'datum2': [ 3, 4 ] ***REMOVED*** ]
    ]
...
1. If traversal fails, the resulting value is undefined, and no error is
   thrown.  For example, `pluck(***REMOVED******REMOVED***, "foo.bar")` is just undefined.
2. If "obj" has property "key" directly (without traversing), the
   corresponding property is returned.  For example,
   `pluck(***REMOVED*** 'foo.bar': 1 ***REMOVED***, 'foo.bar')` is 1, not undefined.  This is also
   true recursively, so `pluck(***REMOVED*** 'a': ***REMOVED*** 'foo.bar': 1 ***REMOVED*** ***REMOVED***, 'a.foo.bar')` is
...
For example:
    ...
    mergeObjects(undefined, ***REMOVED*** 'objectMode': true ***REMOVED***, ***REMOVED*** 'highWaterMark': 0 ***REMOVED***)

returns:

    ***REMOVED*** 'objectMode': true, 'highWaterMark': 0 ***REMOVED***

For another example:

    mergeObjects(
        ***REMOVED*** 'highWaterMark': 16, 'objectMode': 7 ***REMOVED***, /* from caller */
        ***REMOVED*** 'objectMode': true ***REMOVED***,                   /* overrides */
        ***REMOVED*** 'highWaterMark': 0 ***REMOVED***);                  /* default */

returns:

    ***REMOVED*** 'objectMode': true, 'highWaterMark': 16 ***REMOVED***
