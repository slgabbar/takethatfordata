...
function ExtendedHeaderWriter (props) ***REMOVED***
  // console.error(">> ehw ctor")
  var me = this

  if (!(me instanceof ExtendedHeaderWriter)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  var p =
    ***REMOVED*** path : ("PaxHeader" + path.join("/", props.path || ""))
...
ExtendedHeaderWriter.prototype.end = function () ***REMOVED***
  ...
  ***REMOVED***
  ...
  me.body.forEach(function (l) ***REMOVED***
    me._stream.write(l)
  ***REMOVED***)
  me._ready = true
...
ExtendedHeaderWriter.prototype._encodeFields = function () ***REMOVED***
  // console.error(">> ehw _encodeFields")
  this.body = []
  if (this.fields.prefix) ***REMOVED***
    this.fields.path = this.fields.prefix + "/" + this.fields.path
    this.fields.prefix = ""
  ***REMOVED***
  encodeFields(this.fields, "", this.body, this.fields.noProprietary)
  var me = this
  this.body.forEach(function (l) ***REMOVED***
    me.props.size += l.length
  ***REMOVED***)
***REMOVED***

function encodeFields (fields, prefix, body, nop) ***REMOVED***
  // console.error(">> >> ehw encodeFields")
  // "%d %s=%s\n", <length>, <keyword>, <value>
  // The length is a decimal number, and includes itself and the \n
  // Numeric values are decimal strings.

  Object.keys(fields).forEach(function (k) ***REMOVED***
    var val = fields[k]
...
function encodeField (k, v, nop) ***REMOVED***
  // lowercase keys must be valid, otherwise prefix with
  // "NODETAR."
  if (k.charAt(0) === k.charAt(0).toLowerCase()) ***REMOVED***
    var m = k.split(".")[0]
    if (!tar.knownExtended[m]) k = "NODETAR." + k
  ***REMOVED***

  // no proprietary
  if (nop && k.charAt(0) !== k.charAt(0).toLowerCase()) ***REMOVED***
    return []
  ***REMOVED***
  ...
  if (lenBuf.length + s.length !== len) ***REMOVED***
