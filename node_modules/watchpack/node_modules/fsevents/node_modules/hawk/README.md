...
var handler = function (req, res) ***REMOVED***
    ...
    Hawk.server.authenticate(req, credentialsFunc, ***REMOVED******REMOVED***, function (err, credentials, artifacts) ***REMOVED***
        ...
        var header = Hawk.server.header(credentials, artifacts, ***REMOVED*** payload: payload, contentType: headers['Content-Type'] ***REMOVED***);
...
var header = Hawk.client.header('http://example.com:8000/resource/1?b=1&a=2', 'GET', ***REMOVED*** credentials: credentials, ext: 'some-app-data' ***REMOVED***);
requestOptions.headers.Authorization = header.field;

// Send authenticated request

Request(requestOptions, function (error, response, body) ***REMOVED***

    // Authenticate the server's response

    var isValid = Hawk.client.authenticate(response, credentials, header.artifacts, ***REMOVED*** payload: body ***REMOVED***);
...
var handler = function (req, res) ***REMOVED***
    ...
    Hawk.uri.authenticate(req, credentialsFunc, ***REMOVED******REMOVED***, function (err, credentials, attributes) ***REMOVED***
        ...
        res.writeHead(!err ? 200 : 401, ***REMOVED*** 'Content-Type': 'text/plain' ***REMOVED***);
...
var bewit = Hawk.uri.getBewit('http://example.com:8080/resource/1?b=1&a=2', ***REMOVED*** credentials: credentials, ttlSec: duration, ext: 'some-app-data' ***REMOVED***);
