...
namespace fse ***REMOVED***
  class FSEvents : public node::ObjectWrap ***REMOVED***
  public:
...
FSEvents::FSEvents(const char *path, Nan::Callback *handler): handler(handler) ***REMOVED***
  CFStringRef dirs[] = ***REMOVED*** CFStringCreateWithCString(NULL, path, kCFStringEncodingUTF8) ***REMOVED***;
  paths = CFArrayCreate(NULL, (const void **)&dirs, 1, NULL);
  threadloop = NULL;
  lockingStart();
***REMOVED***
FSEvents::~FSEvents() ***REMOVED***
...
void FSEvents::Initialize(v8::Handle<v8::Object> exports) ***REMOVED***
