...
* [Brace Expansion](https://github.com/jonschlinkert/braces) (`foo/bar-***REMOVED***1..5***REMOVED***.md`, `one/***REMOVED***two,three***REMOVED***/four.md`)
...
```js
mm(['a.js', 'b.md', 'c.txt'], '*.***REMOVED***js,txt***REMOVED***');
//=> ['a.js', 'c.txt']
```
...
mm(['a.md', 'b.js', 'c.txt', 'd.json'], ['*.*', '!*.***REMOVED***js,txt***REMOVED***']);
//=> ['a.md', 'd.json']
```
...
mm.isMatch('.verb.md', '*.md', ***REMOVED***dot: true***REMOVED***);
//=> true
```
...
['a.md', 'b.txt', 'c.md'].forEach(function(fp) ***REMOVED***
...
* `patterns` *****REMOVED***String|Array***REMOVED*****:
...
var fn = mm.filter(['***REMOVED***1..10***REMOVED***', '![7-9]', '!***REMOVED***3..4***REMOVED***']);
arr.filter(fn);
//=> [1, 2, 5, 6, 10]
```
...
* filepath `***REMOVED***String***REMOVED***`: The file path to test.
* patterns `***REMOVED***String|Array***REMOVED***`: One or more glob patterns
* options: `***REMOVED***Object***REMOVED***`: options to pass to the `.matcher()` method.
...
***REMOVED*** options: ***REMOVED*** track: false, dot: undefined, makeRe: true, negated: false ***REMOVED***,
  pattern: '(.*\\/|^)bar\\/(?:(?!(?:^|\\/)\\.).)*?',
  history: [],
  tokens:
   ***REMOVED*** path:
...
```js
mm.isMatch('abc', '\\a\\b\\c', ***REMOVED***unescape: true***REMOVED***);
//=> true
```
...
```js
mm.match(['abc', '\\a\\b\\c'], '\\a\\b\\c', ***REMOVED***unescape: true***REMOVED***);
//=> ['abc', 'abc']

mm.match(['abc', '\\a\\b\\c'], '\\a\\b\\c', ***REMOVED***unescape: true, nodupes: true***REMOVED***);
//=> ['abc']
```
...
In simple cases, brace expansion appears to work the same way as the logical `OR` operator. For example, `(a|b)` will achieve the same result as `***REMOVED***a,b***REMOVED***`.

Here are some powerful features unique to brace expansion (versus character classes):

* range expansion: `a***REMOVED***1..3***REMOVED***b/*.js` expands to: `['a1b/*.js', 'a2b/*.js', 'a3b/*.js']`
* nesting: `a***REMOVED***c,***REMOVED***d,e***REMOVED******REMOVED***b/*.js` expands to: `['acb/*.js', 'adb/*.js', 'aeb/*.js']`
...
With the exception of brace expansion (`***REMOVED***a,b***REMOVED***`, `***REMOVED***1..5***REMOVED***`, etc), most of the special characters convert directly to regex, so you can expect them to follow the same rules and produce the same results as regex.
