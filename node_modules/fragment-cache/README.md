...
* `cacheName` *****REMOVED***String***REMOVED*****
* `returns` *****REMOVED***Object***REMOVED*****: Returns the [map-cache](https://github.com/jonschlinkert/map-cache) instance.
...
* `key` *****REMOVED***String***REMOVED*****: Property name to set
* `val` *****REMOVED***any***REMOVED*****: The value of `key`
* `returns` *****REMOVED***Object***REMOVED*****: The cache instance for chaining
...
* `name` *****REMOVED***String***REMOVED*****: Cache name
* `key` *****REMOVED***String***REMOVED*****: Optionally specify a property to check for on cache `name`
...
* `name` *****REMOVED***String***REMOVED*****
* `returns` *****REMOVED***Object***REMOVED*****: Returns cache `name`, or the value of `key` if specified
