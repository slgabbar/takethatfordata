...
* `pattern` *****REMOVED***String***REMOVED*****: The pattern to use for randomizing
* `length` *****REMOVED***Object***REMOVED*****: The length of the string to generate
...
* `!`: Special characters (`~!@#$%^&()_+-=***REMOVED******REMOVED***[];\',.`)
...
* `randomize('?', 20, ***REMOVED***chars: 'jonschlinkert'***REMOVED***)` will generate a 20-character randomized string from the letters contained in `jonschlinkert`.
* `randomize('?', ***REMOVED***chars: 'jonschlinkert'***REMOVED***)` will generate a 13-character randomized string from the letters contained in `jonschlinkert`.
...
* `randomize('!', 5)`: results in single-digit randomized, _valid_ non-letter characters (`~!@#$%^&()_+-=***REMOVED******REMOVED***[]
