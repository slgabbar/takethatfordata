...
function genCombMulTo (alen, blen) ***REMOVED***
  var len = alen + blen - 1;
  var src = [
    'var a = self.words;',
    'var b = num.words;',
  ...
  ***REMOVED***
  ...
  for (var k = 0; k < len; k++) ***REMOVED***
    ...
    for (var j = minJ + 1; j <= maxJ; j++) ***REMOVED***
      i = k - j;
  ...
  ***REMOVED***
  ...
  for (k = 0; k < len; k++) ***REMOVED***
    src.push('o[' + k + '] = w' + k + ';');
  ***REMOVED***
  src.push('if (c !== 0) ***REMOVED***',
           '  o[' + k + '] = c;',
           '  out.length++;',
           '***REMOVED***',
           'return out;');
