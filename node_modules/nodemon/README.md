...
```js
process.once('SIGUSR2', function () ***REMOVED***
  gracefulShutdown(function () ***REMOVED***
...
***REMOVED***).on('readable', function() ***REMOVED*** // the `readable` event indicates that data is ready to pick up
