  ...
  * ***REMOVED******REMOVED***pwd***REMOVED******REMOVED*** - the current directory
  * ***REMOVED******REMOVED***filename***REMOVED******REMOVED*** - the filename you pass to nodemon
  ...
  For example:
    ...
    ***REMOVED***
      "ext": "*.pde",
      "verbose": true,
      "exec": "processing --sketch=***REMOVED******REMOVED***pwd***REMOVED******REMOVED*** --run"
    ***REMOVED***
  ...
  instead of repeating the same option in each of your local configs:
    ...
    ***REMOVED***
      ...
      "execMap": ***REMOVED***
        "rb": "ruby",
        "pde": "processing --sketch=***REMOVED******REMOVED***pwd***REMOVED******REMOVED*** --run"
      ***REMOVED***
    ***REMOVED***
