...
header, footer a, footer p ***REMOVED***
  color: #4F4D3F;
***REMOVED***
...
header strong ***REMOVED***
  font-weight: 500;
  font-size: 110%;
***REMOVED***

header h1, header h2 ***REMOVED***
  text-align: center;
***REMOVED***

body > p, h2, ul ***REMOVED***
  margin: 20px 48px;
***REMOVED***
...
@media screen and (max-width: 500px) ***REMOVED***
  body > p, h2, ul ***REMOVED***
    margin: 20px 10px;
  ***REMOVED***
