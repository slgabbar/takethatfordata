...
***REMOVED***());
export ***REMOVED*** RequestEndStatus ***REMOVED***;
export function addAuthHeader_(headers, authToken) ***REMOVED***
    if (authToken !== null && authToken.length > 0) ***REMOVED***
        headers['Authorization'] = 'Firebase ' + authToken;
    ***REMOVED***
***REMOVED***
export function addVersionHeader_(headers) ***REMOVED***
 ...
 * @template T
 */
export function makeRequest(requestInfo, authToken, pool) ***REMOVED***
