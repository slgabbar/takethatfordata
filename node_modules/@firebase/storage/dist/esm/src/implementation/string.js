...
export var StringFormat = ***REMOVED***
    RAW: 'raw',
    BASE64: 'base64',
    BASE64URL: 'base64url',
    DATA_URL: 'data_url'
***REMOVED***;
export function formatValidator(stringFormat) ***REMOVED***
...
var StringData = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***
    return StringData;
***REMOVED***());
export ***REMOVED*** StringData ***REMOVED***;
export function dataFromString(format, string) ***REMOVED***
...
***REMOVED***
export function utf8Bytes_(string) ***REMOVED***
    var b = [];
...
***REMOVED***
export function percentEncodedBytes_(string) ***REMOVED***
    var decoded;
    try ***REMOVED***
...
***REMOVED***
export function base64Bytes_(format, string) ***REMOVED***
    switch (format) ***REMOVED***
...
var DataURLParts = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***
    return DataURLParts;
***REMOVED***());
export function dataURLBytes_(string) ***REMOVED***
    ...
    ***REMOVED***
***REMOVED***
export function dataURLContentType_(string) ***REMOVED***
    var parts = new DataURLParts(string);
