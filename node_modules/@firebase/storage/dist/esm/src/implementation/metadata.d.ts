...
import ***REMOVED*** AuthWrapper ***REMOVED*** from './authwrapper';
export declare function noXform_(metadata: Metadata, value: any): any;
/**
 * @struct
 */
export declare class Mapping ***REMOVED***
    server: string;
    local: string;
    writable: boolean;
...
export ***REMOVED*** Mappings ***REMOVED***;
...
export declare function fromResource(authWrapper: AuthWrapper, resource: ***REMOVED***
    [name: string]: any;
***REMOVED***, mappings: Mappings): Metadata;
