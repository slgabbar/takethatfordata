 ...
 */
function validate(name, specs, passed) ***REMOVED***
...
***REMOVED***
exports.and_ = and_;
function stringSpec(opt_validator, opt_optional) ***REMOVED***
...
function uploadDataSpec() ***REMOVED***
...
function metadataSpec(opt_optional) ***REMOVED***
    return new ArgSpec(MetadataUtils.metadataValidator, opt_optional);
***REMOVED***
exports.metadataSpec = metadataSpec;
function nonNegativeNumberSpec() ***REMOVED***
    function validator(p) ***REMOVED***
...
function looseObjectSpec(opt_validator, opt_optional) ***REMOVED***
    function validator(p) ***REMOVED***
...
function nullFunctionSpec(opt_optional) ***REMOVED***
    function validator(p) ***REMOVED***
