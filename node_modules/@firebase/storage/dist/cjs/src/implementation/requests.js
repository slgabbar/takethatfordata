...
function metadataHandler(authWrapper, mappings) ***REMOVED***
...
function getMetadata(authWrapper, location, mappings) ***REMOVED***
...
function updateMetadata(authWrapper, location, metadata, mappings) ***REMOVED***
    var urlPart = location.fullServerUrl();
    var url = UrlUtils.makeNormalUrl(urlPart);
    var method = 'PATCH';
...
function deleteObject(authWrapper, location) ***REMOVED***
    var urlPart = location.fullServerUrl();
    var url = UrlUtils.makeNormalUrl(urlPart);
    var method = 'DELETE';
    var timeout = authWrapper.maxOperationRetryTime();
...
function metadataForUpload_(location, blob, opt_metadata) ***REMOVED***
...
function multipartUpload(authWrapper, location, mappings, blob, opt_metadata) ***REMOVED***
...
function checkResumeHeader_(xhr, opt_allowed) ***REMOVED***
    var status;
    try ***REMOVED***
...
function createResumableUpload(authWrapper, location, mappings, blob, opt_metadata) ***REMOVED***
    var urlPart = location.bucketOnlyServerUrl();
    var metadata = metadataForUpload_(location, blob, opt_metadata);
    var urlParams = ***REMOVED*** name: metadata['fullPath'] ***REMOVED***;
    var url = UrlUtils.makeUploadUrl(urlPart);
 ...
 */
function getResumableUploadStatus(authWrapper, location, url, blob) ***REMOVED***
 ...
 *     for upload.
 */
function continueResumableUpload(location, authWrapper, url, blob, chunkSize, mappings, opt_status, opt_progressCallback) ***REMOVED***
