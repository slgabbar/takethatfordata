...
var ViewProcessor = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    ViewProcessor.prototype.applyOperation = function (oldViewCache, operation, writesCache, completeCache) ***REMOVED***
        ...
        if (operation.type === Operation_1.OperationType.OVERWRITE) ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***
        else if (operation.type === Operation_1.OperationType.MERGE) ***REMOVED***
            var merge = operation;
            ...
            ***REMOVED***
        ***REMOVED***
        else if (operation.type === Operation_1.OperationType.ACK_USER_WRITE) ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***
        else if (operation.type === Operation_1.OperationType.LISTEN_COMPLETE) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (affectedTree.value != null) ***REMOVED***
            ...
            ***REMOVED***
                ...
                serverCache.getNode().forEachChild(KeyIndex_1.KEY_INDEX, function (name, node) ***REMOVED***
