 ...
 */
exports.LUIDGenerator = (function () ***REMOVED***
    var id = 1;
 ...
 */
exports.sha1 = function (str) ***REMOVED***
 ...
 */
exports.enableLogging = function (logger_, persistent) ***REMOVED***
    ...
    if (logger_ === true) ***REMOVED***
        if (typeof console !== 'undefined') ***REMOVED***
            ...
            ***REMOVED***
                ...
                // IE does this.
                exports.logger = function (message) ***REMOVED***
                    console.log(message);
                ***REMOVED***;
            ***REMOVED***
        ***REMOVED***
 ...
 */
exports.logWrapper = function (prefix) ***REMOVED***
    return function () ***REMOVED***
        var var_args = [];
        for (var _i = 0; _i < arguments.length; _i++) ***REMOVED***
            var_args[_i] = arguments[_i];
 ...
 * @param ***REMOVED***...string***REMOVED*** var_args
 */
exports.fatal = function () ***REMOVED***
    var var_args = [];
    for (var _i = 0; _i < arguments.length; _i++) ***REMOVED***
        var_args[_i] = arguments[_i];
    ***REMOVED***
 ...
 * does not use https.
 */
exports.warnIfPageIsSecure = function () ***REMOVED***
 ...
 */
exports.warnAboutUnsupportedMethod = function (methodName) ***REMOVED***
 ...
 */
exports.isInvalidJSONNumber = function (data) ***REMOVED***
 ...
 */
exports.executeWhenDOMReady = function (fn) ***REMOVED***
    if (util_7.isNodeSdk() || document.readyState === 'complete') ***REMOVED***
        fn();
    ***REMOVED***
    else ***REMOVED***
 ...
 */
exports.nameCompare = function (a, b) ***REMOVED***
    if (a === b) ***REMOVED***
        return 0;
    ***REMOVED***
    else if (a === exports.MIN_NAME || b === exports.MAX_NAME) ***REMOVED***
        return -1;
    ***REMOVED***
    else if (b === exports.MIN_NAME || a === exports.MAX_NAME) ***REMOVED***
        return 1;
    ***REMOVED***
    else ***REMOVED***
 ...
 */
exports.stringCompare = function (a, b) ***REMOVED***
    if (a === b) ***REMOVED***
        return 0;
    ***REMOVED***
    else if (a < b) ***REMOVED***
 ...
 */
exports.requireKey = function (key, obj) ***REMOVED***
 ...
 * @return ***REMOVED***string***REMOVED***
 */
exports.ObjectToUniqueKey = function (obj) ***REMOVED***
 ...
 */
exports.splitStringBySize = function (str, segsize) ***REMOVED***
    var len = str.length;
 ...
 */
exports.each = function (obj, fn) ***REMOVED***
    ...
    ***REMOVED***
         ...
         */
        util_2.forEach(obj, function (key, val) ***REMOVED*** return fn(val, key); ***REMOVED***);
    ***REMOVED***
***REMOVED***;
/**
 ...
 * @return ***REMOVED***function(*)***REMOVED***
 */
exports.bindCallback = function (callback, context) ***REMOVED***
 ...
 * @return ***REMOVED***string***REMOVED***
 */
exports.doubleToIEEE754String = function (v) ***REMOVED***
 ...
 * @return ***REMOVED***boolean***REMOVED***
 */
exports.isChromeExtensionContentScript = function () ***REMOVED***
 ...
 * @return ***REMOVED***boolean***REMOVED***
 */
exports.isWindowsStoreApp = function () ***REMOVED***
 ...
 */
exports.errorForServerCode = function (code, query) ***REMOVED***
 ...
 * @private
 */
exports.INTEGER_REGEXP_ = new RegExp('^-?\\d***REMOVED***1,10***REMOVED***$');
/**
 * If the string contains a 32-bit integer, return it.  Else return null.
 * @param ***REMOVED***!string***REMOVED*** str
 * @return ***REMOVED***?number***REMOVED***
 */
exports.tryParseInt = function (str) ***REMOVED***
    if (exports.INTEGER_REGEXP_.test(str)) ***REMOVED***
 ...
 */
exports.exceptionGuard = function (fn) ***REMOVED***
    try ***REMOVED***
        fn();
    ***REMOVED***
    catch (e) ***REMOVED***
 ...
 */
exports.callUserCallback = function (callback) ***REMOVED***
    var var_args = [];
    for (var _i = 1; _i < arguments.length; _i++) ***REMOVED***
        var_args[_i - 1] = arguments[_i];
    ***REMOVED***
    if (typeof callback === 'function') ***REMOVED***
        exports.exceptionGuard(function () ***REMOVED***
 ...
 */
exports.beingCrawled = function () ***REMOVED***
 ...
 */
exports.exportPropGetter = function (object, name, fnGet) ***REMOVED***
 ...
 */
exports.setTimeoutNonBlocking = function (fn, time) ***REMOVED***
