...
var Query = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***);
    ...
    Query.validateQueryEndpoints_ = function (params) ***REMOVED***
        ...
        ***REMOVED***
        if (params.getIndex() === KeyIndex_1.KEY_INDEX) ***REMOVED***
            ...
            if (params.hasStart()) ***REMOVED***
                ...
                if (startName != util_2.MIN_NAME) ***REMOVED***
            ...
            ***REMOVED***
            if (params.hasEnd()) ***REMOVED***
                ...
                if (endName != util_2.MAX_NAME) ***REMOVED***
                    throw new Error(tooManyArgsError);
                ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***
        else if (params.getIndex() === PriorityIndex_1.PRIORITY_INDEX) ***REMOVED***
            if ((startNode != null && !validation_1.isValidPriority(startNode)) ||
                (endNode != null && !validation_1.isValidPriority(endNode))) ***REMOVED***
