...
function initStandalone(app, url) ***REMOVED***
    return ***REMOVED***
...
function registerDatabase(instance) ***REMOVED***
    // Register the Database Service with the 'firebase' namespace.
    var namespace = instance.INTERNAL.registerService('database', function (app, unused, url) ***REMOVED*** return RepoManager_1.RepoManager.getInstance().databaseFromApp(app, url); ***REMOVED***, 
