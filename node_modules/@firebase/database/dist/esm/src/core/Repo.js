 ...
 */
import ***REMOVED*** generateWithValues, resolveDeferredValueSnapshot, resolveDeferredValueTree ***REMOVED*** from './util/ServerValues';
...
var Repo = /** @class */ (function () ***REMOVED***
    ...
    function Repo(repoInfo_, forceRestClient, app) ***REMOVED***
        ...
        ***REMOVED***);
        ...
        this.statsReporter_ = StatsManager.getOrCreateReporter(repoInfo_, function () ***REMOVED*** return new StatsReporter(_this.stats_, _this.server_); ***REMOVED***);
    ...
    ***REMOVED***;
    ...
    Repo.prototype.onDataUpdate_ = function (pathString, data, isMerge, tag) ***REMOVED***
        ...
        if (tag) ***REMOVED***
            if (isMerge) ***REMOVED***
                var taggedChildren = map(data, function (raw) ***REMOVED***
        ...
        ***REMOVED***
            ...
            var changedChildren = map(data, function (raw) ***REMOVED***
                return nodeFromJSON(raw);
            ***REMOVED***);
    ...
    ***REMOVED***;
    ...
    Repo.prototype.onServerInfoUpdate_ = function (updates) ***REMOVED***
        var _this = this;
        each(updates, function (value, key) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    Repo.prototype.update = function (path, childrenToMerge, onComplete) ***REMOVED***
        ...
        forEach(childrenToMerge, function (changedKey, changedValue) ***REMOVED***
            empty = false;
        ...
        if (!empty) ***REMOVED***
            ...
            this.server_.merge(path.toString(), childrenToMerge, function (status, errorReason) ***REMOVED***
                ...
                ***REMOVED***
                ...
                _this.callOnCompleteCallback(onComplete, status, errorReason);
            ***REMOVED***);
            forEach(childrenToMerge, function (changedPath) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    Repo.prototype.runOnDisconnectEvents_ = function () ***REMOVED***
        ...
        var events = [];
        resolvedOnDisconnectTree.forEachTree(Path.Empty, function (path, snap) ***REMOVED***
    ...
    Repo.prototype.onDisconnectUpdate = function (path, childrenToMerge, onComplete) ***REMOVED***
        ...
        ***REMOVED***
        this.server_.onDisconnectMerge(path.toString(), childrenToMerge, function (status, errorReason) ***REMOVED***
            if (status === 'ok') ***REMOVED***
                forEach(childrenToMerge, function (childName, childNode) ***REMOVED***
    ...
    ***REMOVED***;
    Repo.prototype.stats = function (showDelta) ***REMOVED***
        ...
        ***REMOVED***, 0);
        forEach(stats, function (stat, value) ***REMOVED***
