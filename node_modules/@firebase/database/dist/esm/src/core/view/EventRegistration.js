...
import ***REMOVED*** DataEvent, CancelEvent ***REMOVED*** from './Event';
...
***REMOVED***());
export ***REMOVED*** ValueEventRegistration ***REMOVED***;
/**
            ...
            ***REMOVED***
                ...
                if (otherCount === thisCount) ***REMOVED***
                    ...
                    if (otherCount === 1) ***REMOVED***
                        var otherKey /** @type ***REMOVED***!string***REMOVED*** */ = getAnyKey(other.callbacks_);
                        var thisKey /** @type ***REMOVED***!string***REMOVED*** */ = getAnyKey(this.callbacks_);
                    ...
                    ***REMOVED***
                        ...
                        return every(this.callbacks_, function (eventType, cb) ***REMOVED*** return other.callbacks_[eventType] === cb; ***REMOVED***);
                    ***REMOVED***
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***
...
***REMOVED***());
export ***REMOVED*** ChildEventRegistration ***REMOVED***;
