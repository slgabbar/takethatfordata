...
import ***REMOVED*** contains, clone, map, safeGet ***REMOVED*** from '@firebase/util';
import ***REMOVED*** NamedNode ***REMOVED*** from './Node';
import ***REMOVED*** PRIORITY_INDEX ***REMOVED*** from './indexes/PriorityIndex';
import ***REMOVED*** KEY_INDEX ***REMOVED*** from './indexes/KeyIndex';
...
var IndexMap = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***
    Object.defineProperty(IndexMap, "Default", ***REMOVED***
        ...
        get: function () ***REMOVED***
            ...
            _defaultIndexMap =
                _defaultIndexMap ||
                    new IndexMap(***REMOVED*** '.priority': fallbackObject ***REMOVED***, ***REMOVED*** '.priority': PRIORITY_INDEX ***REMOVED***);
    ...
    ***REMOVED***;
    ...
    IndexMap.prototype.addToIndexes = function (namedNode, existingChildren) ***REMOVED***
        var _this = this;
        var newIndexes = map(this.indexes_, function (indexedChildren, indexName) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    IndexMap.prototype.removeFromIndexes = function (namedNode, existingChildren) ***REMOVED***
        var newIndexes = map(this.indexes_, function (indexedChildren) ***REMOVED***
            if (indexedChildren === fallbackObject) ***REMOVED***
    ...
    ***REMOVED***;
    return IndexMap;
***REMOVED***());
export ***REMOVED*** IndexMap ***REMOVED***;
