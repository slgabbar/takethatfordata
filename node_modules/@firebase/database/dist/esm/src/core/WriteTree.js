...
var WriteTree = /** @class */ (function () ***REMOVED***
    ...
    WriteTree.prototype.removeWrite = function (writeId) ***REMOVED***
        ...
        ***REMOVED***
            ...
            ***REMOVED***
                ...
                forEach(children, function (childName) ***REMOVED***
        ...
        if (!writeIdsToExclude && !includeHiddenWrites) ***REMOVED***
            ...
            ***REMOVED***
                ...
                ***REMOVED***
                    ...
                    !subMerge.hasCompleteWrite(Path.Empty)) ***REMOVED***
        ...
        ***REMOVED***
            ...
            ***REMOVED***
                ...
                if (!includeHiddenWrites &&
                    ...
                    !merge.hasCompleteWrite(Path.Empty)) ***REMOVED***
                    return null;
                ***REMOVED***
                else ***REMOVED***
    ...
    WriteTree.prototype.calcCompleteEventChildren = function (treePath, completeServerChildren) ***REMOVED***
        ...
        if (topLevelSet) ***REMOVED***
            if (!topLevelSet.isLeafNode()) ***REMOVED***
                ...
                topLevelSet.forEachChild(PRIORITY_INDEX, function (childName, childSnap) ***REMOVED***
        ...
        ***REMOVED***
            ...
            completeServerChildren.forEachChild(PRIORITY_INDEX, function (childName, childNode) ***REMOVED***
                var node = merge_1
    ...
    ***REMOVED***;
    ...
    WriteTree.prototype.recordContainsPath_ = function (writeRecord, path) ***REMOVED***
        ...
        ***REMOVED***
            ...
            return !!findKey(writeRecord.children, function (childSnap, childName) ***REMOVED***
    ...
    ***REMOVED***;
    return WriteTree;
***REMOVED***());
export ***REMOVED*** WriteTree ***REMOVED***;
/**
...
var WriteTreeRef = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    return WriteTreeRef;
***REMOVED***());
export ***REMOVED*** WriteTreeRef ***REMOVED***;
