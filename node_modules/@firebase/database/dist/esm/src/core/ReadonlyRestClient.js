...
import ***REMOVED*** logWrapper, warn ***REMOVED*** from './util/util';
import ***REMOVED*** jsonEval ***REMOVED*** from '@firebase/util';
import ***REMOVED*** safeGet ***REMOVED*** from '@firebase/util';
import ***REMOVED*** querystring ***REMOVED*** from '@firebase/util';
    ...
    ***REMOVED***;
    ...
    ReadonlyRestClient.prototype.listen = function (query, currentHashFn, tag, onComplete) ***REMOVED***
        ...
        this.restRequest_(pathString + '.json', queryStringParamaters, function (error, result) ***REMOVED***
            ...
            ***REMOVED***
            if (safeGet(_this.listens_, listenId) === thisListen) ***REMOVED***
                var status_1;
                if (!error) ***REMOVED***
                    status_1 = 'ok';
                ***REMOVED***
...
export ***REMOVED*** ReadonlyRestClient ***REMOVED***;
