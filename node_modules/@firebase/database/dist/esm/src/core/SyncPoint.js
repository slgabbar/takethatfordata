...
import ***REMOVED*** isEmpty, forEach, findValue, safeGet ***REMOVED*** from '@firebase/util';
import ***REMOVED*** ViewCache ***REMOVED*** from './view/ViewCache';
...
var SyncPoint = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    SyncPoint.prototype.applyOperation = function (operation, writesCache, optCompleteServerCache) ***REMOVED***
        ...
        ***REMOVED***
            ...
            var events_1 = [];
            forEach(this.views_, function (key, view) ***REMOVED***
    ...
    SyncPoint.prototype.addEventRegistration = function (query, eventRegistration, writesCache, serverCache, serverCacheComplete) ***REMOVED***
        ...
        if (!view) ***REMOVED***
            ...
            ***REMOVED***
            ...
            /** @type ***REMOVED***!Node***REMOVED*** */ (eventCache), eventCacheComplete, false), new CacheNode(
    ...
    ***REMOVED***;
    ...
    SyncPoint.prototype.removeEventRegistration = function (query, eventRegistration, cancelError) ***REMOVED***
        ...
        if (queryId === 'default') ***REMOVED***
            ...
            var self_1 = this;
            forEach(this.views_, function (viewQueryId, view) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    SyncPoint.prototype.getCompleteView = function () ***REMOVED***
        var completeView = findValue(this.views_, function (view) ***REMOVED***
            return view
                .getQuery()
                .getQueryParams()
                .loadsAllData();
    ...
    ***REMOVED***;
    return SyncPoint;
***REMOVED***());
export ***REMOVED*** SyncPoint ***REMOVED***;
