 ...
 */
import ***REMOVED*** executeWhenDOMReady, isChromeExtensionContentScript, isWindowsStoreApp, log, logWrapper, LUIDGenerator, splitStringBySize ***REMOVED*** from '../core/util/util';
import ***REMOVED*** CountedSet ***REMOVED*** from '../core/util/CountedSet';
import ***REMOVED*** StatsManager ***REMOVED*** from '../core/stats/StatsManager';
import ***REMOVED*** PacketReceiver ***REMOVED*** from './polling/PacketReceiver';
import ***REMOVED*** FORGE_DOMAIN, FORGE_REF, LAST_SESSION_PARAM, LONG_POLLING, PROTOCOL_VERSION, REFERER_PARAM, TRANSPORT_SESSION_PARAM, VERSION_PARAM ***REMOVED*** from './Constants';
import ***REMOVED*** base64Encode, stringify ***REMOVED*** from '@firebase/util';
    ...
    ***REMOVED***
    ...
    BrowserPollConnection.prototype.open = function (onMessage, onDisconnect) ***REMOVED***
        ...
        ***REMOVED***, Math.floor(LP_CONNECT_TIMEOUT));
        ...
        executeWhenDOMReady(function () ***REMOVED***
            if (_this.isClosed_)
                return;
            ...
            ***REMOVED***
            if (!isNodeSdk() &&
                ...
                location.href &&
                location.href.indexOf(FORGE_DOMAIN) !== -1) ***REMOVED***
...
***REMOVED***());
export ***REMOVED*** BrowserPollConnection ***REMOVED***;
/*********************************************************************************************
...
var FirebaseIFrameScriptHolder = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    FirebaseIFrameScriptHolder.prototype.close = function () ***REMOVED***
        ...
        ***REMOVED***
        if (isNodeSdk() && this.myID) ***REMOVED***
            var urlParams = ***REMOVED******REMOVED***;
...
***REMOVED***());
export ***REMOVED*** FirebaseIFrameScriptHolder ***REMOVED***;
