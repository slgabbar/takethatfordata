 ...
 */
import ***REMOVED*** setWebSocketImpl ***REMOVED*** from './realtime/WebSocketConnection';
import ***REMOVED*** FirebaseIFrameScriptHolder, FIREBASE_LONGPOLL_COMMAND_CB_NAME, FIREBASE_LONGPOLL_DATA_CB_NAME ***REMOVED*** from './realtime/BrowserPollConnection';
import ***REMOVED*** Client ***REMOVED*** from 'faye-websocket';
 ...
 */
FirebaseIFrameScriptHolder.nodeRestRequest = function (req, onComplete) ***REMOVED***
    if (!FirebaseIFrameScriptHolder.request)
        FirebaseIFrameScriptHolder.request = /** @type ***REMOVED***function(***REMOVED***url: string, forever: boolean***REMOVED***, function(Error, number, string))***REMOVED*** */ require('request');
    FirebaseIFrameScriptHolder.request(req, function (error, response, body) ***REMOVED***
        if (error)
 ...
 */
FirebaseIFrameScriptHolder.prototype.doNodeLongPoll = function (url, loadCB) ***REMOVED***
    var self = this;
    FirebaseIFrameScriptHolder.nodeRestRequest(***REMOVED*** url: url, forever: true ***REMOVED***, function (body) ***REMOVED***
        self.evalBody(body);
        loadCB();
    ***REMOVED***);
***REMOVED***;
 ...
 */
FirebaseIFrameScriptHolder.prototype.evalBody = function (body) ***REMOVED***
    var jsonpCB;
