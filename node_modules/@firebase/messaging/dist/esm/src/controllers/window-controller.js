...
import ***REMOVED*** createSubscribe ***REMOVED*** from '@firebase/util';
var WindowController = /** @class */ (function (_super) ***REMOVED***
    ...
    function WindowController(app) ***REMOVED***
        ...
        _this.onMessage_ = createSubscribe(function (observer) ***REMOVED***
            _this.messageObserver_ = observer;
        ***REMOVED***);
        _this.tokenRefreshObserver_ = null;
        _this.onTokenRefresh_ = createSubscribe(function (observer) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    WindowController.prototype.requestPermission = function () ***REMOVED***
        var _this = this;
        if (Notification.permission === NOTIFICATION_PERMISSION.granted) ***REMOVED***
            return Promise.resolve();
        ***REMOVED***
        return new Promise(function (resolve, reject) ***REMOVED***
            var managePermissionResult = function (result) ***REMOVED***
                if (result === NOTIFICATION_PERMISSION.granted) ***REMOVED***
                    return resolve();
                ***REMOVED***
                else if (result === NOTIFICATION_PERMISSION.denied) ***REMOVED***
    ...
    WindowController.prototype.getSWRegistration_ = function () ***REMOVED***
        ...
        ***REMOVED***
        ...
        return navigator.serviceWorker
            .register(DefaultSW.path, ***REMOVED***
            scope: DefaultSW.scope
        ***REMOVED***)
            .catch(function (err) ***REMOVED***
            throw _this.errorFactory_.create(Errors.codes.FAILED_DEFAULT_REGISTRATION, ***REMOVED***
    ...
    WindowController.prototype.setupSWMessageListener_ = function () ***REMOVED***
        ...
        ***REMOVED***
        navigator.serviceWorker.addEventListener('message', function (event) ***REMOVED***
            if (!event.data || !event.data[WorkerPageMessage.PARAMS.TYPE_OF_MSG]) ***REMOVED***
                // Not a message from FCM
                return;
            ***REMOVED***
            var workerPageMessage = event.data;
            switch (workerPageMessage[WorkerPageMessage.PARAMS.TYPE_OF_MSG]) ***REMOVED***
