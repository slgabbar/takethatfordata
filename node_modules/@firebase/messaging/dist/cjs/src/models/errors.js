...
***REMOVED***;
var ERROR_MAP = (_a = ***REMOVED******REMOVED***,
    ...
    _a[CODES.FAILED_DEFAULT_REGISTRATION] = 'We are unable to register the ' +
        'default service worker. ***REMOVED***$browserErrorMessage***REMOVED***',
    ...
    _a[CODES.TOKEN_SUBSCRIBE_FAILED] = 'A problem occured while subscribing the ' + 'user to FCM: ***REMOVED***$message***REMOVED***',
    ...
    _a[CODES.UNABLE_TO_RESUBSCRIBE] = 'There was an error while re-subscribing ' +
        ...
        'user on next visit. ***REMOVED***$message***REMOVED***',
