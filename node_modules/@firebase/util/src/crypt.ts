...
const stringToByteArray = function(str) ***REMOVED***
...
export const base64 = ***REMOVED***
  ...
  ***REMOVED***,
   ...
   */
  encodeByteArray(input, opt_webSafe?) ***REMOVED***
  ...
  ***REMOVED***,
   ...
   * @return ***REMOVED***string***REMOVED*** The base64 encoded string.
   */
  encodeString(input, opt_webSafe) ***REMOVED***
  ...
  ***REMOVED***,
   ...
   */
  decodeString(input, opt_webSafe) ***REMOVED***
    // Shortcut for Mozilla browsers that implement
    // a native base64 encoder in the form of "btoa/atob"
    if (this.HAS_NATIVE_SUPPORT && !opt_webSafe) ***REMOVED***
      return atob(input);
  ...
  ***REMOVED***,
   ...
   */
  decodeStringToByteArray(input, opt_webSafe) ***REMOVED***
    this.init_();
