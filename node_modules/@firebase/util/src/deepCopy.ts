 ...
 */
export function deepExtend(target: any, source: any): any ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (let prop in source) ***REMOVED***
    if (!source.hasOwnProperty(prop)) ***REMOVED***
      continue;
    ***REMOVED***
...
export function patchProperty(obj: any, prop: string, value: any) ***REMOVED***
  obj[prop] = value;
***REMOVED***
