 ...
 */
export const decode = function(token) ***REMOVED***
  var header = ***REMOVED******REMOVED***,
    claims = ***REMOVED******REMOVED***,
 ...
 */
export const isValidTimestamp = function(token) ***REMOVED***
 ...
 */
export const issuedAtTime = function(token) ***REMOVED***
  var claims = decode(token).claims;
 ...
 * @return ***REMOVED***boolean***REMOVED***
 */
export const isValidFormat = function(token) ***REMOVED***
 ...
 * @return ***REMOVED***boolean***REMOVED***
 */
export const isAdmin = function(token) ***REMOVED***
  var claims = decode(token).claims;
