 ...
 * @struct
 */
var Sha1 = /** @class */ (function (_super) ***REMOVED***
    ...
    function Sha1() ***REMOVED***
        ...
        _this.pad_[0] = 128;
        for (var i = 1; i < _this.blockSize; ++i) ***REMOVED***
            _this.pad_[i] = 0;
        ***REMOVED***
        _this.reset();
        return _this;
    ...
    ***REMOVED***;
     ...
     * @private
     */
    Sha1.prototype.compress_ = function (buf, opt_offset) ***REMOVED***
    ...
    ***REMOVED***;
    Sha1.prototype.update = function (bytes, opt_length) ***REMOVED***
