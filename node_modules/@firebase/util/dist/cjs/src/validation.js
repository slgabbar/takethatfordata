 ...
 */
exports.validateArgCount = function (fnName, minCount, maxCount, argCount) ***REMOVED***
    var argError;
 ...
 */
function errorPrefix(fnName, argumentNumber, optional) ***REMOVED***
    var argName = '';
 ...
 */
function validateNamespace(fnName, argumentNumber, namespace, optional) ***REMOVED***
...
function validateCallback(fnName, argumentNumber, callback, optional) ***REMOVED***
...
function validateContextObject(fnName, argumentNumber, context, optional) ***REMOVED***
    if (optional && !context)
        return;
