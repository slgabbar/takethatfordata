...
import ***REMOVED*** Observer, Unsubscribe ***REMOVED*** from '@firebase/util';

export interface User extends UserInfo ***REMOVED***
  delete(): Promise<any>;
...
export interface UserInfo ***REMOVED***
  displayName: string | null;
  email: string | null;
  phoneNumber: string | null;
  photoURL: string | null;
...
export interface ActionCodeInfo ***REMOVED******REMOVED***

export type ActionCodeSettings = ***REMOVED***
  android?: ***REMOVED***
    installApp?: boolean;
  ...
  ***REMOVED***;
  ...
  iOS?: ***REMOVED*** bundleId: string ***REMOVED***;
  url: string;
***REMOVED***;

export type AdditionalUserInfo = ***REMOVED***
  isNewUser: boolean;
  profile: Object | null;
  providerId: string;
...
export interface ApplicationVerifier ***REMOVED***
  type: string;
  verify(): Promise<any>;
***REMOVED***

export interface AuthCredential ***REMOVED***
  providerId: string;
***REMOVED***

export interface AuthProvider ***REMOVED***
  providerId: string;
***REMOVED***

export interface ConfirmationResult ***REMOVED***
  confirm(verificationCode: string): Promise<any>;
  verificationId: string;
***REMOVED***

export class EmailAuthProvider extends EmailAuthProvider_Instance ***REMOVED***
  static PROVIDER_ID: string;
  static credential(email: string, password: string): AuthCredential;
***REMOVED***
export class EmailAuthProvider_Instance implements AuthProvider ***REMOVED***
  providerId: string;
***REMOVED***

export interface Error ***REMOVED***
  code: string;
  message: string;
***REMOVED***

export class FacebookAuthProvider extends FacebookAuthProvider_Instance ***REMOVED***
  static PROVIDER_ID: string;
  static credential(token: string): AuthCredential;
***REMOVED***
export class FacebookAuthProvider_Instance implements AuthProvider ***REMOVED***
  addScope(scope: string): AuthProvider;
  providerId: string;
  setCustomParameters(customOAuthParameters: Object): AuthProvider;
***REMOVED***

export class GithubAuthProvider extends GithubAuthProvider_Instance ***REMOVED***
  static PROVIDER_ID: string;
  static credential(token: string): AuthCredential;
***REMOVED***
export class GithubAuthProvider_Instance implements AuthProvider ***REMOVED***
  addScope(scope: string): AuthProvider;
  providerId: string;
  setCustomParameters(customOAuthParameters: Object): AuthProvider;
***REMOVED***

export class GoogleAuthProvider extends GoogleAuthProvider_Instance ***REMOVED***
  static PROVIDER_ID: string;
  static credential(
    idToken?: string | null,
...
***REMOVED***
export class GoogleAuthProvider_Instance implements AuthProvider ***REMOVED***
  addScope(scope: string): AuthProvider;
  providerId: string;
  setCustomParameters(customOAuthParameters: Object): AuthProvider;
***REMOVED***

export class OAuthProvider implements AuthProvider ***REMOVED***
  providerId: string;
  addScope(scope: string): AuthProvider;
...
export class PhoneAuthProvider extends PhoneAuthProvider_Instance ***REMOVED***
  static PROVIDER_ID: string;
  static credential(
    verificationId: string,
...
***REMOVED***
export class PhoneAuthProvider_Instance implements AuthProvider ***REMOVED***
...
export class RecaptchaVerifier extends RecaptchaVerifier_Instance ***REMOVED******REMOVED***
export class RecaptchaVerifier_Instance implements ApplicationVerifier ***REMOVED***
  constructor(
...
export class TwitterAuthProvider extends TwitterAuthProvider_Instance ***REMOVED***
  static PROVIDER_ID: string;
  static credential(token: string, secret: string): AuthCredential;
***REMOVED***
export class TwitterAuthProvider_Instance implements AuthProvider ***REMOVED***
  providerId: string;
  setCustomParameters(customOAuthParameters: Object): AuthProvider;
***REMOVED***

export type UserCredential = ***REMOVED***
...
export interface UserMetadata ***REMOVED***
  creationTime?: string;
...
export interface OAuthCredential extends AuthCredential ***REMOVED***
  idToken?: string;
  accessToken?: string;
  secret?: string;
***REMOVED***

export class FirebaseAuth ***REMOVED***
  private constructor();

  static Persistence: ***REMOVED***
    LOCAL: Persistence;
    NONE: Persistence;
    SESSION: Persistence;
  ***REMOVED***;
