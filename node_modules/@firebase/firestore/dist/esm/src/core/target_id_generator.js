 ...
 */
var TargetIdGenerator = /** @class */ (function () ***REMOVED***
    function TargetIdGenerator(generatorId, initAfter) ***REMOVED***
        if (initAfter === void 0) ***REMOVED*** initAfter = 0; ***REMOVED***
        ...
        if (afterGenerator >= generatorId) ***REMOVED***
            // For example, if:
        ...
        ***REMOVED***
    ***REMOVED***
    TargetIdGenerator.prototype.next = function () ***REMOVED***
        this.previousId += 1 << RESERVED_BITS;
        return this.previousId;
    ***REMOVED***;
    TargetIdGenerator.forLocalStore = function (initAfter) ***REMOVED***
        if (initAfter === void 0) ***REMOVED*** initAfter = 0; ***REMOVED***
        return new TargetIdGenerator(GeneratorIds.LocalStore, initAfter);
    ***REMOVED***;
    TargetIdGenerator.forSyncEngine = function () ***REMOVED***
        return new TargetIdGenerator(GeneratorIds.SyncEngine);
    ***REMOVED***;
    return TargetIdGenerator;
***REMOVED***());
export ***REMOVED*** TargetIdGenerator ***REMOVED***;
