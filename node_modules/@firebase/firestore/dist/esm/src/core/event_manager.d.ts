...
import ***REMOVED*** OnlineState, TargetId ***REMOVED*** from './types';
import ***REMOVED*** ViewSnapshot ***REMOVED*** from './view_snapshot';
import ***REMOVED*** EventHandler ***REMOVED*** from '../util/misc';
/**
 ...
 * backend.
 */
export declare class EventManager ***REMOVED***
    private syncEngine;
    private queries;
    private onlineState;
 ...
 */
export declare class QueryListener ***REMOVED***
