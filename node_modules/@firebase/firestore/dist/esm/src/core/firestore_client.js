 ...
 */
import ***REMOVED*** EventManager, QueryListener ***REMOVED*** from './event_manager';
import ***REMOVED*** SyncEngine ***REMOVED*** from './sync_engine';
import ***REMOVED*** EagerGarbageCollector ***REMOVED*** from '../local/eager_garbage_collector';
import ***REMOVED*** IndexedDbPersistence ***REMOVED*** from '../local/indexeddb_persistence';
import ***REMOVED*** LocalStore ***REMOVED*** from '../local/local_store';
import ***REMOVED*** MemoryPersistence ***REMOVED*** from '../local/memory_persistence';
import ***REMOVED*** NoOpGarbageCollector ***REMOVED*** from '../local/no_op_garbage_collector';
import ***REMOVED*** Datastore ***REMOVED*** from '../remote/datastore';
import ***REMOVED*** RemoteStore ***REMOVED*** from '../remote/remote_store';
...
var FirestoreClient = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    FirestoreClient.prototype.startIndexedDbPersistence = function () ***REMOVED***
        ...
        var serializer = new JsonProtoSerializer(this.databaseInfo.databaseId, ***REMOVED***
            useProto3Json: true
        ***REMOVED***);
...
***REMOVED***());
export ***REMOVED*** FirestoreClient ***REMOVED***;
