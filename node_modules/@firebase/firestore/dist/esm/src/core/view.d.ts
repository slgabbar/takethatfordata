 ...
 */
import ***REMOVED*** DocumentKeySet, MaybeDocumentMap ***REMOVED*** from '../model/collections';
import ***REMOVED*** DocumentKey ***REMOVED*** from '../model/document_key';
import ***REMOVED*** DocumentSet ***REMOVED*** from '../model/document_set';
import ***REMOVED*** TargetChange ***REMOVED*** from '../remote/remote_event';
import ***REMOVED*** Query ***REMOVED*** from './query';
import ***REMOVED*** OnlineState ***REMOVED*** from './types';
import ***REMOVED*** DocumentChangeSet, ViewSnapshot ***REMOVED*** from './view_snapshot';
export declare type LimboDocumentChange = AddedLimboDocument | RemovedLimboDocument;
export declare class AddedLimboDocument ***REMOVED***
    key: DocumentKey;
    constructor(key: DocumentKey);
***REMOVED***
export declare class RemovedLimboDocument ***REMOVED***
    key: DocumentKey;
    constructor(key: DocumentKey);
***REMOVED***
/** The result of applying a set of doc changes to a view. */
export interface ViewDocumentChanges ***REMOVED***
...
***REMOVED***
export interface ViewChange ***REMOVED***
