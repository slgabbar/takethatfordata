 ...
 */
import ***REMOVED*** Blob ***REMOVED*** from '../api/blob';
import ***REMOVED*** GeoPoint ***REMOVED*** from '../api/geo_point';
import ***REMOVED*** DatabaseId ***REMOVED*** from '../core/database_info';
import ***REMOVED*** Bound, Direction, NanFilter, NullFilter, OrderBy, Query, RelationFilter, RelationOp ***REMOVED*** from '../core/query';
import ***REMOVED*** SnapshotVersion ***REMOVED*** from '../core/snapshot_version';
import ***REMOVED*** Timestamp ***REMOVED*** from '../core/timestamp';
import ***REMOVED*** QueryPurpose ***REMOVED*** from '../local/query_data';
...
import ***REMOVED*** DeleteMutation, FieldMask, FieldTransform, MutationResult, PatchMutation, Precondition, ServerTimestampTransform, SetMutation, TransformMutation ***REMOVED*** from '../model/mutation';
import ***REMOVED*** FieldPath, ResourcePath ***REMOVED*** from '../model/path';
...
import ***REMOVED*** mapCodeFromRpcCode, mapRpcCodeFromCode ***REMOVED*** from './rpc_error';
import ***REMOVED*** DocumentWatchChange, ExistenceFilterChange, WatchTargetChange, WatchTargetChangeState ***REMOVED*** from './watch_change';
...
var JsonProtoSerializer = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    JsonProtoSerializer.prototype.fromDocument = function (document) ***REMOVED***
        return new Document(this.fromName(document.name), this.fromVersion(document.updateTime), this.fromFields(document.fields || ***REMOVED******REMOVED***), ***REMOVED*** hasLocalMutations: false ***REMOVED***);
    ***REMOVED***;
    ...
    ***REMOVED***;
    JsonProtoSerializer.prototype.fromFound = function (doc) ***REMOVED***
        ...
        return new Document(key, version, fields, ***REMOVED*** hasLocalMutations: false ***REMOVED***);
    ***REMOVED***;
    ...
    ***REMOVED***;
    JsonProtoSerializer.prototype.toTestWatchChange = function (watchChange) ***REMOVED***
        if (watchChange instanceof ExistenceFilterChange) ***REMOVED***
            return ***REMOVED***
                filter: ***REMOVED***
        ...
        ***REMOVED***
        if (watchChange instanceof DocumentWatchChange) ***REMOVED***
            if (watchChange.newDoc instanceof Document) ***REMOVED***
                ...
                ***REMOVED***;
            ***REMOVED***
            else if (watchChange.newDoc instanceof NoDocument) ***REMOVED***
                var doc = watchChange.newDoc;
                return ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***
        if (watchChange instanceof WatchTargetChange) ***REMOVED***
            var cause = undefined;
    ...
    ***REMOVED***;
    JsonProtoSerializer.prototype.fromWatchChange = function (change) ***REMOVED***
        ...
        ***REMOVED***
            ...
            var doc = new Document(key, version, fields, ***REMOVED***
    ...
    ***REMOVED***;
    JsonProtoSerializer.prototype.toMutation = function (mutation) ***REMOVED***
        ...
        ***REMOVED***
            ...
            ***REMOVED***;
        ***REMOVED***
        else if (mutation instanceof TransformMutation) ***REMOVED***
            result = ***REMOVED***
                transform: ***REMOVED***
    ...
    ***REMOVED***;
    ...
    JsonProtoSerializer.prototype.toRelationFilter = function (filter) ***REMOVED***
        if (filter instanceof RelationFilter) ***REMOVED***
            return ***REMOVED***
                fieldFilter: ***REMOVED***
    ...
    ***REMOVED***;
    ...
    JsonProtoSerializer.prototype.toUnaryFilter = function (filter) ***REMOVED***
        if (filter instanceof NanFilter) ***REMOVED***
            return ***REMOVED***
                unaryFilter: ***REMOVED***
                    field: this.toFieldPathReference(filter.field),
                    op: 'IS_NAN'
            ...
            ***REMOVED***;
        ***REMOVED***
        else if (filter instanceof NullFilter) ***REMOVED***
            return ***REMOVED***
                unaryFilter: ***REMOVED***
                    field: this.toFieldPathReference(filter.field),
                    op: 'IS_NULL'
    ...
    ***REMOVED***;
    JsonProtoSerializer.prototype.fromDocumentMask = function (proto) ***REMOVED***
        ...
        var fields = paths.map(function (path) ***REMOVED*** return FieldPath.fromServerFormat(path); ***REMOVED***);
        return new FieldMask(fields);
    ***REMOVED***;
    return JsonProtoSerializer;
***REMOVED***());
export ***REMOVED*** JsonProtoSerializer ***REMOVED***;
/**
