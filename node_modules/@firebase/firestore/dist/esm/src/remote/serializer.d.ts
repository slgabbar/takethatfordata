...
import ***REMOVED*** Direction, Filter, OrderBy, Query, RelationOp ***REMOVED*** from '../core/query';
...
import ***REMOVED*** FieldMask, Mutation, MutationResult ***REMOVED*** from '../model/mutation';
import ***REMOVED*** FieldPath, ResourcePath ***REMOVED*** from '../model/path';
import ***REMOVED*** FirestoreError ***REMOVED*** from '../util/error';
import ***REMOVED*** WatchChange, WatchTargetChangeState ***REMOVED*** from './watch_change';
import ***REMOVED*** ApiClientObjectMap ***REMOVED*** from '../protos/firestore_proto_api';
export interface SerializerOptions ***REMOVED***
    /**
 ...
 */
export declare class JsonProtoSerializer ***REMOVED***
    private databaseId;
    private options;
    ...
    toFields(fields: fieldValue.ObjectValue): ***REMOVED***
        [key: string]: api.Value;
    ***REMOVED***;
    fromFields(object: ***REMOVED******REMOVED***): fieldValue.ObjectValue;
