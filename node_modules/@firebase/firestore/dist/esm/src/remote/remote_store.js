...
import ***REMOVED*** Transaction ***REMOVED*** from '../core/transaction';
import ***REMOVED*** OnlineState ***REMOVED*** from '../core/types';
import ***REMOVED*** QueryData, QueryPurpose ***REMOVED*** from '../local/query_data';
import ***REMOVED*** NoDocument ***REMOVED*** from '../model/document';
import ***REMOVED*** DocumentKey ***REMOVED*** from '../model/document_key';
import ***REMOVED*** BATCHID_UNKNOWN, MutationBatchResult ***REMOVED*** from '../model/mutation_batch';
import ***REMOVED*** emptyByteString ***REMOVED*** from '../platform/platform';
import ***REMOVED*** assert ***REMOVED*** from '../util/assert';
import ***REMOVED*** Code ***REMOVED*** from '../util/error';
import * as log from '../util/log';
import * as objUtils from '../util/obj';
import ***REMOVED*** ResetMapping, UpdateMapping ***REMOVED*** from './remote_event';
import ***REMOVED*** isPermanentError ***REMOVED*** from './rpc_error';
import ***REMOVED*** WatchChangeAggregator, WatchTargetChange, WatchTargetChangeState ***REMOVED*** from './watch_change';
 ...
 */
var RemoteStore = /** @class */ (function () ***REMOVED***
    function RemoteStore(
        ...
        datastore, onlineStateHandler) ***REMOVED***
         ...
         */
        this.listenTargets = ***REMOVED******REMOVED***;
        /**
         ...
         */
        this.pendingTargetResponses = ***REMOVED******REMOVED***;
    ...
    ***REMOVED***
     ...
     * LocalStore, etc.
     */
    RemoteStore.prototype.start = function () ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.updateOnlineState = function (newState) ***REMOVED***
        if (newState !== this.watchStreamOnlineState) ***REMOVED***
            if (newState === OnlineState.Healthy) ***REMOVED***
            ...
            ***REMOVED***
            else if (newState === OnlineState.Unknown) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.updateOnlineStateAfterFailure = function () ***REMOVED***
        if (this.watchStreamOnlineState === OnlineState.Healthy) ***REMOVED***
            this.updateOnlineState(OnlineState.Unknown);
        ***REMOVED***
        else ***REMOVED***
            this.watchStreamFailures++;
            if (this.watchStreamFailures >= ONLINE_ATTEMPTS_BEFORE_FAILURE) ***REMOVED***
                if (this.shouldWarnOffline) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    RemoteStore.prototype.isNetworkEnabled = function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    RemoteStore.prototype.enableNetwork = function () ***REMOVED***
        var _this = this;
        if (this.isNetworkEnabled()) ***REMOVED***
        ...
        ***REMOVED***
        ...
        return this.localStore.getLastStreamToken().then(function (token) ***REMOVED***
            _this.writeStream.lastStreamToken = token;
            if (_this.shouldStartWatchStream()) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     * enableNetwork().
     */
    RemoteStore.prototype.disableNetwork = function () ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.disableNetworkInternal = function () ***REMOVED***
        if (this.isNetworkEnabled()) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    RemoteStore.prototype.shutdown = function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    RemoteStore.prototype.listen = function (queryData) ***REMOVED***
        ...
        if (this.shouldStartWatchStream()) ***REMOVED***
            // The listen will be sent in onWatchStreamOpen
            this.startWatchStream();
        ***REMOVED***
        else if (this.isNetworkEnabled() && this.watchStream.isOpen()) ***REMOVED***
            this.sendWatchRequest(queryData);
        ***REMOVED***
    ***REMOVED***;
    /** Removes the listen from server */
    RemoteStore.prototype.unlisten = function (targetId) ***REMOVED***
        ...
        if (this.isNetworkEnabled() && this.watchStream.isOpen()) ***REMOVED***
            this.sendUnwatchRequest(targetId);
            if (objUtils.isEmpty(this.listenTargets)) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.sendWatchRequest = function (queryData) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.sendUnwatchRequest = function (targetId) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.shouldStartWatchStream = function () ***REMOVED***
        return (this.isNetworkEnabled() &&
            !this.watchStream.isStarted() &&
            !objUtils.isEmpty(this.listenTargets));
    ***REMOVED***;
    RemoteStore.prototype.cleanUpWatchStreamState = function () ***REMOVED***
        ...
        this.pendingTargetResponses = ***REMOVED******REMOVED***;
    ***REMOVED***;
    RemoteStore.prototype.onWatchStreamOpen = function () ***REMOVED***
        var _this = this;
        // TODO(b/35852690): close the stream again (with some timeout?) if no watch
        // targets are active
        objUtils.forEachNumber(this.listenTargets, function (targetId, queryData) ***REMOVED***
            _this.sendWatchRequest(queryData);
        ***REMOVED***);
        return Promise.resolve();
    ***REMOVED***;
    RemoteStore.prototype.onWatchStreamClose = function (error) ***REMOVED***
        ...
        ***REMOVED***
        return Promise.resolve();
    ***REMOVED***;
    RemoteStore.prototype.onWatchStreamChange = function (watchChange, snapshotVersion) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (!snapshotVersion.isEqual(SnapshotVersion.MIN) &&
            snapshotVersion.compareTo(this.localStore.getLastRemoteSnapshotVersion()) >= 0) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     * SyncEngine.
     */
    RemoteStore.prototype.handleWatchChangeBatch = function (snapshotVersion, changes) ***REMOVED***
        var _this = this;
        ...
        objUtils.forEachNumber(aggregator.existenceFilters, function (targetId, filter) ***REMOVED***
            var queryData = _this.listenTargets[targetId];
            if (!queryData) ***REMOVED***
                // A watched target might have been removed already.
                return;
            ***REMOVED***
            var query = queryData.query;
            if (query.isDocumentQuery()) ***REMOVED***
                if (filter.count === 0) ***REMOVED***
            ...
            ***REMOVED***
                ...
                var promise = _this.localStore
                    ...
                    .then(function (trackedRemote) ***REMOVED***
                    if (remoteEvent.targetChanges[targetId]) ***REMOVED***
                        var mapping = remoteEvent.targetChanges[targetId].mapping;
                        if (mapping !== null) ***REMOVED***
                            if (mapping instanceof UpdateMapping) ***REMOVED***
                        ...
                        ***REMOVED***
                    ***REMOVED***
                    if (trackedRemote.size !== filter.count) ***REMOVED***
        ...
        ***REMOVED***);
        return Promise.all(promises).then(function () ***REMOVED***
            ...
            objUtils.forEachNumber(remoteEvent.targetChanges, function (targetId, change) ***REMOVED***
                if (change.resumeToken.length > 0) ***REMOVED***
                    var queryData = _this.listenTargets[targetId];
                    // A watched target might have been removed already.
                    if (queryData) ***REMOVED***
                        _this.listenTargets[targetId] = queryData.update(***REMOVED***
    ...
    ***REMOVED***;
    ...
    RemoteStore.prototype.handleTargetError = function (watchChange) ***REMOVED***
        var _this = this;
        assert(!!watchChange.cause, 'Handling target error without a cause');
        var error = watchChange.cause;
        var promiseChain = Promise.resolve();
        watchChange.targetIds.forEach(function (targetId) ***REMOVED***
            promiseChain = promiseChain.then(function () ***REMOVED***
                if (objUtils.contains(_this.listenTargets, targetId)) ***REMOVED***
        ...
        ***REMOVED***);
        return promiseChain;
    ***REMOVED***;
    RemoteStore.prototype.cleanUpWriteStreamState = function () ***REMOVED***
        this.lastBatchSeen = BATCHID_UNKNOWN;
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.fillWritePipeline = function () ***REMOVED***
        var _this = this;
        if (!this.canWriteMutations()) ***REMOVED***
            return Promise.resolve();
        ***REMOVED***
        else ***REMOVED***
            return this.localStore
                .nextMutationBatch(this.lastBatchSeen)
                .then(function (batch) ***REMOVED***
                if (batch === null) ***REMOVED***
                    if (_this.pendingWrites.length === 0) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.canWriteMutations = function () ***REMOVED***
        return (this.isNetworkEnabled() && this.pendingWrites.length < MAX_PENDING_WRITES);
    ***REMOVED***;
    // For testing
    RemoteStore.prototype.outstandingWrites = function () ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    RemoteStore.prototype.commit = function (batch) ***REMOVED***
        assert(this.canWriteMutations(), "commit called when batches can't be written");
        this.lastBatchSeen = batch.batchId;
        this.pendingWrites.push(batch);
        if (this.shouldStartWriteStream()) ***REMOVED***
            this.startWriteStream();
        ***REMOVED***
        else if (this.isNetworkEnabled() && this.writeStream.handshakeComplete) ***REMOVED***
            this.writeStream.writeMutations(batch.mutations);
        ***REMOVED***
    ***REMOVED***;
    RemoteStore.prototype.shouldStartWriteStream = function () ***REMOVED***
        return (this.isNetworkEnabled() &&
            !this.writeStream.isStarted() &&
            this.pendingWrites.length > 0);
    ***REMOVED***;
    RemoteStore.prototype.startWriteStream = function () ***REMOVED***
        assert(this.shouldStartWriteStream(), 'startWriteStream() called when shouldStartWriteStream() is false.');
        this.writeStream.start(***REMOVED***
        ...
        ***REMOVED***);
    ***REMOVED***;
    RemoteStore.prototype.onWriteStreamOpen = function () ***REMOVED***
        this.writeStream.writeHandshake();
        return Promise.resolve();
    ***REMOVED***;
    RemoteStore.prototype.onWriteHandshakeComplete = function () ***REMOVED***
        var _this = this;
        ...
        return this.localStore
            ...
            for (var _i = 0, _a = _this.pendingWrites; _i < _a.length; _i++) ***REMOVED***
                var batch = _a[_i];
                _this.writeStream.writeMutations(batch.mutations);
            ***REMOVED***
        ***REMOVED***);
    ***REMOVED***;
    RemoteStore.prototype.onMutationResult = function (commitVersion, results) ***REMOVED***
        var _this = this;
        ...
        return this.syncEngine.applySuccessfulWrite(success).then(function () ***REMOVED***
            // It's possible that with the completion of this mutation another
            // slot has freed up.
            return _this.fillWritePipeline();
        ***REMOVED***);
    ***REMOVED***;
    RemoteStore.prototype.onWriteStreamClose = function (error) ***REMOVED***
        var _this = this;
        assert(this.isNetworkEnabled(), 'onWriteStreamClose() should only be called when the network is enabled');
        // If the write stream closed due to an error, invoke the error callbacks if
        // there are pending writes.
        if (error && this.pendingWrites.length > 0) ***REMOVED***
            ...
            if (this.writeStream.handshakeComplete) ***REMOVED***
            ...
            ***REMOVED***
            return errorHandling.then(function () ***REMOVED***
                // The write stream might have been started by refilling the write
                // pipeline for failed writes
                if (_this.shouldStartWriteStream()) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    RemoteStore.prototype.handleHandshakeError = function (error) ***REMOVED***
        // Reset the token if it's a permanent error or the error code is
        // ABORTED, signaling the write stream is no longer valid.
        if (isPermanentError(error.code) || error.code === Code.ABORTED) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    RemoteStore.prototype.handleWriteError = function (error) ***REMOVED***
        var _this = this;
        if (isPermanentError(error.code)) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    RemoteStore.prototype.createTransaction = function () ***REMOVED***
        return new Transaction(this.datastore);
    ***REMOVED***;
    RemoteStore.prototype.handleUserChange = function (user) ***REMOVED***
    ...
    ***REMOVED***;
    return RemoteStore;
***REMOVED***());
export ***REMOVED*** RemoteStore ***REMOVED***;
