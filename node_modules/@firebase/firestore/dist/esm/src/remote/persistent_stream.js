...
import ***REMOVED*** ExponentialBackoff ***REMOVED*** from './backoff';
    ...
    ***REMOVED***;
    ...
    PersistentStream.prototype.close = function (finalState, error) ***REMOVED***
        ...
        if (finalState !== PersistentStreamState.Error) ***REMOVED***
            ...
            this.backoff.reset();
        ***REMOVED***
        else if (error && error.code === Code.RESOURCE_EXHAUSTED) ***REMOVED***
...
***REMOVED***());
export ***REMOVED*** PersistentStream ***REMOVED***;
/**
...
export ***REMOVED*** PersistentListenStream ***REMOVED***;
/**
...
***REMOVED***(PersistentStream));
export ***REMOVED*** PersistentWriteStream ***REMOVED***;
