...
import ***REMOVED*** CredentialsProvider, Token ***REMOVED*** from '../api/credentials';
...
import ***REMOVED*** Connection, Stream ***REMOVED*** from './connection';
import ***REMOVED*** JsonProtoSerializer ***REMOVED*** from './serializer';
import ***REMOVED*** WatchChange ***REMOVED*** from './watch_change';
export interface WriteRequest extends api.WriteRequest ***REMOVED***
    database?: string;
***REMOVED***
/**
 ...
 */
export interface PersistentStreamListener ***REMOVED***
    /**
 ...
 */
export declare abstract class PersistentStream<SendType, ReceiveType, ListenerType extends PersistentStreamListener> ***REMOVED***
    private queue;
...
export interface WatchStreamListener extends PersistentStreamListener ***REMOVED***
    /**
 ...
 */
export declare class PersistentListenStream extends PersistentStream<api.ListenRequest, api.ListenResponse, WatchStreamListener> ***REMOVED***
...
export interface WriteStreamListener extends PersistentStreamListener ***REMOVED***
    /**
 ...
 */
export declare class PersistentWriteStream extends PersistentStream<api.WriteRequest, api.WriteResponse, WriteStreamListener> ***REMOVED***
    private databaseInfo;
    private serializer;
