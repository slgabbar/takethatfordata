...
import ***REMOVED*** BatchId, ProtoByteString, TargetId ***REMOVED*** from '../core/types';
...
import ***REMOVED*** MutationBatch, MutationBatchResult ***REMOVED*** from '../model/mutation_batch';
...
import ***REMOVED*** LocalViewChanges ***REMOVED*** from './local_view_changes';
import ***REMOVED*** Persistence ***REMOVED*** from './persistence';
import ***REMOVED*** QueryData ***REMOVED*** from './query_data';
/** The result of a write to the local store. */
export interface LocalWriteResult ***REMOVED***
    batchId: BatchId;
 ...
 */
export declare class LocalStore ***REMOVED***
