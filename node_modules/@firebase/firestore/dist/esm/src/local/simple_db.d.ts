 ...
 */
export declare class SimpleDb ***REMOVED***
    private db;
 ...
 */
export declare class IterationController ***REMOVED***
    private dbCursor;
    private shouldStop;
    private nextKey;
...
export interface IterateOptions ***REMOVED***
 ...
 */
export declare class SimpleDbTransaction ***REMOVED***
    private transaction;
    private aborted;
    /**
 ...
 */
export declare class SimpleDbStore<KeyType extends IDBValidKey, ValueType> ***REMOVED***
    private store;
