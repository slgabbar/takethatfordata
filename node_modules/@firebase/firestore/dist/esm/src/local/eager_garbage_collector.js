 ...
 */
var EagerGarbageCollector = /** @class */ (function () ***REMOVED***
    function EagerGarbageCollector() ***REMOVED***
        this.isEager = true;
        /**
    ...
    ***REMOVED***
    EagerGarbageCollector.prototype.addGarbageSource = function (garbageSource) ***REMOVED***
        this.sources.push(garbageSource);
        garbageSource.setGarbageCollector(this);
    ***REMOVED***;
    EagerGarbageCollector.prototype.removeGarbageSource = function (garbageSource) ***REMOVED***
        this.sources.splice(this.sources.indexOf(garbageSource), 1);
        garbageSource.setGarbageCollector(null);
    ***REMOVED***;
    EagerGarbageCollector.prototype.addPotentialGarbageKey = function (key) ***REMOVED***
        this.potentialGarbage = this.potentialGarbage.add(key);
    ***REMOVED***;
    EagerGarbageCollector.prototype.collectGarbage = function (txn) ***REMOVED***
        var _this = this;
        var promises = [];
        var garbageKeys = documentKeySet();
        this.potentialGarbage.forEach(function (key) ***REMOVED***
            var hasRefsPromise = _this.documentHasAnyReferences(txn, key);
            promises.push(hasRefsPromise.next(function (hasRefs) ***REMOVED***
        ...
        ***REMOVED***);
        ...
        this.potentialGarbage = documentKeySet();
        return PersistencePromise.waitFor(promises).next(function () ***REMOVED*** return garbageKeys; ***REMOVED***);
    ***REMOVED***;
    EagerGarbageCollector.prototype.documentHasAnyReferences = function (txn, key) ***REMOVED***
        var initial = PersistencePromise.resolve(false);
        return this.sources
            .map(function (source) ***REMOVED*** return function () ***REMOVED*** return source.containsKey(txn, key); ***REMOVED***; ***REMOVED***)
...
***REMOVED***());
export ***REMOVED*** EagerGarbageCollector ***REMOVED***;
