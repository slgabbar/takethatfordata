 ...
 * on persistence.
 */
export interface PersistenceTransaction ***REMOVED***
***REMOVED***
/**
 ...
 * writes.
 */
export interface Persistence ***REMOVED***
    /**
     ...
     */
    runTransaction<T>(action: string, transactionOperation: (transaction: PersistenceTransaction) => PersistencePromise<T>): Promise<T>;
***REMOVED***
