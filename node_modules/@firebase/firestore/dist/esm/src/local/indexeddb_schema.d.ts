...
import ***REMOVED*** BatchId ***REMOVED*** from '../core/types';
import ***REMOVED*** TargetId ***REMOVED*** from '../core/types';
import ***REMOVED*** ResourcePath ***REMOVED*** from '../model/path';
import ***REMOVED*** EncodedResourcePath ***REMOVED*** from './encoded_resource_path';
 ...
 */
export declare class DbTimestamp ***REMOVED***
    seconds: number;
    nanos: number;
 ...
 */
export declare class DbOwner ***REMOVED***
    ownerId: string;
 ...
 */
export declare class DbMutationQueue ***REMOVED***
    /**
 ...
 * with a new batchId.
 */
export declare class DbMutationBatch ***REMOVED***
    /**
 ...
 */
export declare class DbDocumentMutation ***REMOVED***
    static store: string;
    /**
 ...
 */
export declare class DbNoDocument ***REMOVED***
    path: string[];
 ...
 */
export declare class DbRemoteDocument ***REMOVED***
    /**
 ...
 */
export declare class DbTarget ***REMOVED***
    /**
 ...
 * particular target.
 */
export declare class DbTargetDocument ***REMOVED***
    /**
 ...
 */
export declare class DbTargetGlobal ***REMOVED***
    /**
