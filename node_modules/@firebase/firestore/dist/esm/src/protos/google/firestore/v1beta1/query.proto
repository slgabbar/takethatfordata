...
// A Firestore query.
message StructuredQuery ***REMOVED***
  // A selection of a collection, such as `messages as m1`.
  message CollectionSelector ***REMOVED***
    // The collection ID.
  ...
  ***REMOVED***
  ...
  message FieldReference ***REMOVED***
    string field_path = 2;
  ***REMOVED***
