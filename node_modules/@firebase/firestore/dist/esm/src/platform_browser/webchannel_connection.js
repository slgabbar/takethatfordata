 ...
 */
import ***REMOVED*** ErrorCode, EventType, WebChannel, XhrIoPool, createWebChannelTransport ***REMOVED*** from '@firebase/webchannel-wrapper';
import ***REMOVED*** SDK_VERSION ***REMOVED*** from '../core/version';
import ***REMOVED*** mapCodeFromHttpStatus, mapCodeFromRpcStatus ***REMOVED*** from '../remote/rpc_error';
...
var RPC_NAME_REST_MAPPING = ***REMOVED***
...
var WebChannelConnection = /** @class */ (function () ***REMOVED***
    function WebChannelConnection(info) ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    WebChannelConnection.prototype.modifyHeadersForRequest = function (headers, token) ***REMOVED***
        if (token) ***REMOVED***
    ...
    ***REMOVED***;
    WebChannelConnection.prototype.invokeRPC = function (rpcName, request, token) ***REMOVED***
        var _this = this;
        var url = this.makeUrl(rpcName);
        return new Promise(function (resolve, reject) ***REMOVED***
            // tslint:disable-next-line:no-any XhrIoPool doesn't have TS typings.
            _this.pool.getObject(function (xhr) ***REMOVED***
                xhr.listenOnce(EventType.COMPLETE, function () ***REMOVED***
                    try ***REMOVED***
                        switch (xhr.getLastErrorCode()) ***REMOVED***
                ...
                ***REMOVED***);
                ...
                var headers = ***REMOVED*** 'Content-Type': 'text/plain' ***REMOVED***;
                _this.modifyHeadersForRequest(headers, token);
                xhr.send(url, 'POST', requestString, headers, XHR_TIMEOUT_SECS);
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    WebChannelConnection.prototype.invokeStreamingRPC = function (rpcName, request, token) ***REMOVED***
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.invokeRPC(rpcName, request, token);
    ***REMOVED***;
    WebChannelConnection.prototype.openStream = function (rpcName, token) ***REMOVED***
        var urlParts = [
            this.baseUrl,
            '/',
            RPC_STREAM_SERVICE,
        ...
        var request = ***REMOVED***
            ...
            initMessageHeaders: ***REMOVED******REMOVED***,
        ...
        ***REMOVED***;
        ...
        // on a closed stream
        var closed = false;
        var streamBridge = new StreamBridge(***REMOVED***
            sendFn: function (msg) ***REMOVED***
                ...
                ***REMOVED***
            ***REMOVED***,
            closeFn: function () ***REMOVED*** return channel.close(); ***REMOVED***
        ***REMOVED***);
        // Closure events are guarded and exceptions are swallowed, so catch any
        // exception and rethrow using a setTimeout so they become visible again.
        // Note that eventually this function could go away if we are confident
        // enough the code is exception free.
        var unguardedEventListen = function (type, fn) ***REMOVED***
            // TODO(dimond): closure typing seems broken because WebChannel does
            // not implement goog.events.Listenable
            channel.listen(type, function (param) ***REMOVED***
                try ***REMOVED***
                    fn(param);
                ***REMOVED***
                catch (e) ***REMOVED***
            ...
            ***REMOVED***);
        ***REMOVED***;
        unguardedEventListen(WebChannel.EventType.OPEN, function () ***REMOVED***
            if (!closed) ***REMOVED***
                log.debug(LOG_TAG, 'WebChannel transport opened.');
            ***REMOVED***
        ***REMOVED***);
        unguardedEventListen(WebChannel.EventType.CLOSE, function () ***REMOVED***
            if (!closed) ***REMOVED***
                closed = true;
            ...
            ***REMOVED***
        ***REMOVED***);
        unguardedEventListen(WebChannel.EventType.ERROR, function (err) ***REMOVED***
            if (!closed) ***REMOVED***
                closed = true;
            ...
            ***REMOVED***
        ***REMOVED***);
        unguardedEventListen(WebChannel.EventType.MESSAGE, function (msg) ***REMOVED***
            if (!closed) ***REMOVED***
    ...
    ***REMOVED***;
    // visible for testing
    WebChannelConnection.prototype.makeUrl = function (rpcName) ***REMOVED***
...
***REMOVED***());
export ***REMOVED*** WebChannelConnection ***REMOVED***;
