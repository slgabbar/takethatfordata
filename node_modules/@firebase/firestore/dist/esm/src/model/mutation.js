...
import ***REMOVED*** Document, NoDocument ***REMOVED*** from './document';
import ***REMOVED*** ObjectValue, ServerTimestampValue ***REMOVED*** from './field_value';
/**
...
var FieldMask = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    return FieldMask;
***REMOVED***());
export ***REMOVED*** FieldMask ***REMOVED***;
...
***REMOVED***());
export ***REMOVED*** ServerTimestampTransform ***REMOVED***;
...
***REMOVED***());
export ***REMOVED*** FieldTransform ***REMOVED***;
...
***REMOVED***());
export ***REMOVED*** MutationResult ***REMOVED***;
...
***REMOVED***)(MutationType || (MutationType = ***REMOVED******REMOVED***));
/**
...
var Precondition = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    return Precondition;
***REMOVED***());
export ***REMOVED*** Precondition ***REMOVED***;
/**
...
var Mutation = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    return Mutation;
***REMOVED***());
export ***REMOVED*** Mutation ***REMOVED***;
/**
...
var SetMutation = /** @class */ (function (_super) ***REMOVED***
    ...
    ***REMOVED***
    SetMutation.prototype.applyToRemoteDocument = function (maybeDoc, mutationResult) ***REMOVED***
        ...
        return new Document(this.key, version, this.value, ***REMOVED***
    ...
    ***REMOVED***;
    return SetMutation;
***REMOVED***(Mutation));
export ***REMOVED*** SetMutation ***REMOVED***;
/**
    ...
    ***REMOVED***
    PatchMutation.prototype.applyToRemoteDocument = function (maybeDoc, mutationResult) ***REMOVED***
        ...
        ***REMOVED***
        ...
        return new Document(this.key, version, newData, ***REMOVED***
            hasLocalMutations: false
        ***REMOVED***);
    ***REMOVED***;
...
***REMOVED***(Mutation));
export ***REMOVED*** PatchMutation ***REMOVED***;
/**
    ...
    ***REMOVED***
    TransformMutation.prototype.applyToRemoteDocument = function (maybeDoc, mutationResult) ***REMOVED***
        ...
        ***REMOVED***
        ...
        return new Document(this.key, doc.version, newData, ***REMOVED***
            hasLocalMutations: false
        ***REMOVED***);
    ***REMOVED***;
    ...
    TransformMutation.prototype.localTransformResults = function (localWriteTime, baseDoc) ***REMOVED***
        ...
        for (var _i = 0, _a = this.fieldTransforms; _i < _a.length; _i++) ***REMOVED***
            ...
            if (transform instanceof ServerTimestampTransform) ***REMOVED***
                ...
                if (baseDoc instanceof Document) ***REMOVED***
...
***REMOVED***(Mutation));
export ***REMOVED*** TransformMutation ***REMOVED***;
...
***REMOVED***(Mutation));
export ***REMOVED*** DeleteMutation ***REMOVED***;
