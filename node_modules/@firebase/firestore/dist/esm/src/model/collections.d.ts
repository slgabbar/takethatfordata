...
import ***REMOVED*** Document, MaybeDocument ***REMOVED*** from './document';
...
export declare function maybeDocumentMap(): SortedMap<DocumentKey, MaybeDocument>;
export declare type DocumentMap = SortedMap<DocumentKey, Document>;
export declare function documentMap(): SortedMap<DocumentKey, Document>;
export declare type DocumentVersionMap = SortedMap<DocumentKey, SnapshotVersion>;
export declare function documentVersionMap(): SortedMap<DocumentKey, SnapshotVersion>;
export declare type DocumentKeySet = SortedSet<DocumentKey>;
export declare function documentKeySet(): SortedSet<DocumentKey>;
