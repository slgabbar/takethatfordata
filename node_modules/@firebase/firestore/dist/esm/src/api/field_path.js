 ...
 */
import ***REMOVED*** FieldPath as InternalFieldPath ***REMOVED*** from '../model/path';
import ***REMOVED*** Code, FirestoreError ***REMOVED*** from '../util/error';
import ***REMOVED*** invalidClassError, validateArgType, validateNamedArrayAtLeastNumberOfElements ***REMOVED*** from '../util/input_validation';
...
var FieldPath = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    return FieldPath;
***REMOVED***());
export ***REMOVED*** FieldPath ***REMOVED***;
/**
 ...
 */
export function fromDotSeparatedString(path) ***REMOVED***
