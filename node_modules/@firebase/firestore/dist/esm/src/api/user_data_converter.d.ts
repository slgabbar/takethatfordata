...
import ***REMOVED*** FieldValue, ObjectValue ***REMOVED*** from '../model/field_value';
import ***REMOVED*** FieldMask, FieldTransform, Mutation, Precondition ***REMOVED*** from '../model/mutation';
...
export declare class ParsedSetData ***REMOVED***
...
export declare class ParsedUpdateData ***REMOVED***
    readonly data: ObjectValue;
 ...
 * the full context.
 */
export declare class DocumentKeyReference ***REMOVED***
 ...
 * classes.
 */
export declare class UserDataConverter ***REMOVED***
