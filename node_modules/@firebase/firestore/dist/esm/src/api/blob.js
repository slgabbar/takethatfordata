...
import ***REMOVED*** invalidClassError, validateArgType, validateExactNumberOfArgs ***REMOVED*** from '../util/input_validation';
 ...
 */
var Blob = /** @class */ (function () ***REMOVED***
    function Blob(binaryString) ***REMOVED***
        assertBase64Available();
        this._binaryString = binaryString;
    ***REMOVED***
    Blob.fromBase64String = function (base64) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    Blob.fromUint8Array = function (array) ***REMOVED***
        ...
        ***REMOVED***
        ...
        var binaryString = Array.prototype.map
            .call(array, function (char) ***REMOVED***
            return String.fromCharCode(char);
        ***REMOVED***)
            .join('');
        return new Blob(binaryString);
    ***REMOVED***;
    Blob.prototype.toBase64 = function () ***REMOVED***
        validateExactNumberOfArgs('Blob.toBase64', arguments, 0);
        assertBase64Available();
        return PlatformSupport.getPlatform().btoa(this._binaryString);
    ***REMOVED***;
    Blob.prototype.toUint8Array = function () ***REMOVED***
        validateExactNumberOfArgs('Blob.toUint8Array', arguments, 0);
        assertUint8ArrayAvailable();
        var buffer = new Uint8Array(this._binaryString.length);
        for (var i = 0; i < this._binaryString.length; i++) ***REMOVED***
            buffer[i] = this._binaryString.charCodeAt(i);
        ***REMOVED***
        return buffer;
    ***REMOVED***;
    Blob.prototype.toString = function () ***REMOVED***
        return 'Blob(base64: ' + this.toBase64() + ')';
    ***REMOVED***;
    Blob.prototype.isEqual = function (other) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     * with an underscore.
     */
    Blob.prototype._compareTo = function (other) ***REMOVED***
        return primitiveComparator(this._binaryString, other._binaryString);
    ***REMOVED***;
    return Blob;
***REMOVED***());
export ***REMOVED*** Blob ***REMOVED***;
