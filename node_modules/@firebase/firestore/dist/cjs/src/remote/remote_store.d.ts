...
import ***REMOVED*** OnlineState, TargetId ***REMOVED*** from '../core/types';
import ***REMOVED*** LocalStore ***REMOVED*** from '../local/local_store';
import ***REMOVED*** QueryData ***REMOVED*** from '../local/query_data';
import ***REMOVED*** Datastore ***REMOVED*** from './datastore';
import ***REMOVED*** RemoteSyncer ***REMOVED*** from './remote_syncer';
/**
 ...
 */
export declare class RemoteStore ***REMOVED***
    /**
     ...
     */
    private watchStreamOnlineState;
    ...
    constructor(
        ...
        /** The client-side proxy for interacting with the backend. */
        datastore: Datastore, onlineStateHandler: (onlineState: OnlineState) => void);
     ...
     */
    private updateOnlineState(newState);
    /**
     ...
     */
    private updateOnlineStateAfterFailure();
