...
import ***REMOVED*** RemoteEvent ***REMOVED*** from './remote_event';
/**
 ...
 */
export declare class DocumentWatchChange ***REMOVED***
    ...
    constructor(
        ...
        newDoc: Document | NoDocument | null);
***REMOVED***
export declare class ExistenceFilterChange ***REMOVED***
    targetId: TargetId;
    existenceFilter: ExistenceFilter;
    constructor(targetId: TargetId, existenceFilter: ExistenceFilter);
***REMOVED***
export declare enum WatchTargetChangeState ***REMOVED***
    NoChange = 0,
    Added = 1,
    Removed = 2,
    Current = 3,
    Reset = 4,
***REMOVED***
export declare class WatchTargetChange ***REMOVED***
