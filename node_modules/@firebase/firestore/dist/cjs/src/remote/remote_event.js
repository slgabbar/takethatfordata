    ...
    ***REMOVED***;
    RemoteEvent.prototype.handleExistenceFilterMismatch = function (targetId) ***REMOVED***
        ...
        this.targetChanges[targetId] = ***REMOVED***
            ...
            snapshotVersion: snapshot_version_1.SnapshotVersion.MIN,
...
***REMOVED***)(CurrentStatusUpdate = exports.CurrentStatusUpdate || (exports.CurrentStatusUpdate = ***REMOVED******REMOVED***));
var EMPTY_KEY_SET = collections_1.documentKeySet();
var ResetMapping = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    return ResetMapping;
***REMOVED***());
exports.ResetMapping = ResetMapping;
