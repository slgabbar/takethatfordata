    ...
    IndexedDbMutationQueue.prototype.getAllMutationBatchesAffectingQuery = function (transaction, query) ***REMOVED***
        ...
        ***REMOVED***)
            ...
            uniqueBatchIDs.forEach(function (batchID) ***REMOVED***
                ...
                ***REMOVED***));
            ***REMOVED***);
            return persistence_promise_1.PersistencePromise.waitFor(promises).next(function () ***REMOVED*** return results; ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
...
function getStore(txn, store) ***REMOVED***
    if (txn instanceof simple_db_1.SimpleDbTransaction) ***REMOVED***
