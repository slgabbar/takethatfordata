...
function decode(path) ***REMOVED***
    ...
    assert_1.assert(length >= 2, 'Invalid path ' + path);
    if (length === 2) ***REMOVED***
        assert_1.assert(path.charAt(0) === escapeChar && path.charAt(1) === encodedSeparatorChar, 'Non-empty path ' + path + ' had length 2');
    ...
    ***REMOVED***
    ...
    for (var start = 0; start < length;) ***REMOVED***
        ...
        if (end < 0 || end > lastReasonableEscapeIndex) ***REMOVED***
            assert_1.fail('Invalid encoded resource path: "' + path + '"');
        ***REMOVED***
        ...
        ***REMOVED***
        start = end + 2;
    ***REMOVED***
    return new path_1.ResourcePath(segments);
***REMOVED***
 ...
 */
function prefixSuccessor(path) ***REMOVED***
