    ...
    WebChannelConnection.prototype.invokeRPC = function (rpcName, request, token) ***REMOVED***
        ...
        return new Promise(function (resolve, reject) ***REMOVED***
            ...
            _this.pool.getObject(function (xhr) ***REMOVED***
                xhr.listenOnce(webchannel_wrapper_1.EventType.COMPLETE, function () ***REMOVED***
                    try ***REMOVED***
    ...
    ***REMOVED***;
    WebChannelConnection.prototype.openStream = function (rpcName, token) ***REMOVED***
        ...
        ***REMOVED***;
        ...
        // on a closed stream
        var closed = false;
        var streamBridge = new stream_bridge_1.StreamBridge(***REMOVED***
        ...
        ***REMOVED***);
        ...
        var unguardedEventListen = function (type, fn) ***REMOVED***
            ...
            ***REMOVED***);
        ***REMOVED***;
        unguardedEventListen(webchannel_wrapper_1.WebChannel.EventType.OPEN, function () ***REMOVED***
            if (!closed) ***REMOVED***
                log.debug(LOG_TAG, 'WebChannel transport opened.');
            ***REMOVED***
        ***REMOVED***);
        unguardedEventListen(webchannel_wrapper_1.WebChannel.EventType.CLOSE, function () ***REMOVED***
            if (!closed) ***REMOVED***
                closed = true;
            ...
            ***REMOVED***
        ***REMOVED***);
        unguardedEventListen(webchannel_wrapper_1.WebChannel.EventType.ERROR, function (err) ***REMOVED***
            if (!closed) ***REMOVED***
                closed = true;
            ...
            ***REMOVED***
        ***REMOVED***);
        unguardedEventListen(webchannel_wrapper_1.WebChannel.EventType.MESSAGE, function (msg) ***REMOVED***
            if (!closed) ***REMOVED***
