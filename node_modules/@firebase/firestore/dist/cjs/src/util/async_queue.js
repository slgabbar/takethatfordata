...
var AsyncQueue = /** @class */ (function () ***REMOVED***
    function AsyncQueue() ***REMOVED***
    ...
    ***REMOVED***
     ...
     * operation.
     */
    AsyncQueue.prototype.schedule = function (op, delay) ***REMOVED***
        var _this = this;
        if (this.failure) ***REMOVED***
            assert_1.fail('AsyncQueue is already failed: ' +
                (this.failure.stack || this.failure.message));
        ***REMOVED***
        if ((delay || 0) > 0) ***REMOVED***
            this.delayedOperationsCount++;
            var delayedOp_1 = ***REMOVED***
                handle: null,
                op: op,
                deferred: new promise_1.Deferred()
            ***REMOVED***;
            delayedOp_1.handle = setTimeout(function () ***REMOVED***
                _this.scheduleInternal(function () ***REMOVED***
                    return delayedOp_1.op().then(function (result) ***REMOVED***
                        delayedOp_1.deferred.resolve(result);
                    ***REMOVED***);
                ***REMOVED***);
                delayedOp_1.handle = null;
                _this.delayedOperationsCount--;
                if (_this.delayedOperationsCount === 0) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    AsyncQueue.prototype.scheduleInternal = function (op) ***REMOVED***
        var _this = this;
        this.tail = this.tail.then(function () ***REMOVED***
            ...
            return op()
                ...
                if (message.indexOf('Firestore Test Simulated Error') < 0) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     * to catch some bugs.
     */
    AsyncQueue.prototype.verifyOperationInProgress = function () ***REMOVED***
        assert_1.assert(this.operationInProgress, 'verifyOpInProgress() called when no op in progress on this queue.');
    ***REMOVED***;
    /**
     ...
     */
    AsyncQueue.prototype.drain = function (executeDelayedTasks) ***REMOVED***
        var _this = this;
        this.delayedOperations.forEach(function (entry) ***REMOVED***
            if (entry.handle) ***REMOVED***
                clearTimeout(entry.handle);
                if (executeDelayedTasks) ***REMOVED***
                    _this.scheduleInternal(entry.op).then(entry.deferred.resolve, entry.deferred.reject);
                ***REMOVED***
                else ***REMOVED***
                    entry.deferred.reject(new error_1.FirestoreError(error_1.Code.CANCELLED, 'Operation cancelled by shutdown'));
                ***REMOVED***
            ***REMOVED***
        ***REMOVED***);
        this.delayedOperations = [];
        this.delayedOperationsCount = 0;
        return this.schedule(function () ***REMOVED*** return Promise.resolve(); ***REMOVED***);
    ***REMOVED***;
    return AsyncQueue;
***REMOVED***());
