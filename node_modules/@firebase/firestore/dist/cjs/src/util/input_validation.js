 ...
 */
function validateExactNumberOfArgs(functionName, args, numberOfArgs) ***REMOVED***
 ...
 */
function validateAtLeastNumberOfArgs(functionName, args, minNumberOfArgs) ***REMOVED***
 ...
 */
function validateBetweenNumberOfArgs(functionName, args, minNumberOfArgs, maxNumberOfArgs) ***REMOVED***
 ...
 * number of elements.
 */
function validateNamedArrayAtLeastNumberOfElements(functionName, value, name, minNumberOfElements) ***REMOVED***
 ...
 * using typeof checks.
 */
function validateArgType(functionName, type, position, argument) ***REMOVED***
 ...
 */
function validateOptionalArgType(functionName, type, position, argument) ***REMOVED***
 ...
 * typeof checks.
 */
function validateNamedType(functionName, type, optionName, argument) ***REMOVED***
 ...
 * typeof checks or is undefined.
 */
function validateNamedOptionalType(functionName, type, optionName, argument) ***REMOVED***
    if (argument !== undefined) ***REMOVED***
 ...
 */
function validateNamedPropertyEquals(functionName, inputName, optionName, input, expected) ***REMOVED***
    ...
    ***REMOVED***
    ...
    throw new error_1.FirestoreError(error_1.Code.INVALID_ARGUMENT, "Invalid value " + actualDescription + " provided to function " + functionName + "() for option \"" + optionName + "\". Acceptable values: " + expectedDescription.join(', '));
***REMOVED***
exports.validateNamedPropertyEquals = validateNamedPropertyEquals;
/**
 * Validates that the provided named option equals one of the expected values or
 * is undefined.
 */
function validateNamedOptionalPropertyEquals(functionName, inputName, optionName, input, expected) ***REMOVED***
    if (input !== undefined) ***REMOVED***
        validateNamedPropertyEquals(functionName, inputName, optionName, input, expected);
    ***REMOVED***
***REMOVED***
exports.validateNamedOptionalPropertyEquals = validateNamedOptionalPropertyEquals;
...
function validateDefined(functionName, position, argument) ***REMOVED***
    if (argument === undefined) ***REMOVED***
 ...
 */
function validateOptionNames(functionName, options, optionNames) ***REMOVED***
 ...
 * an instanceof check.
 */
function invalidClassError(functionName, type, position, argument) ***REMOVED***
