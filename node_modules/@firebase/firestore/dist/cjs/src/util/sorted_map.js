...
var SortedMapIterator = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***
    SortedMapIterator.prototype.getNext = function () ***REMOVED***
        assert_1.assert(this.nodeStack.length > 0, 'getNext() called on iterator when hasNext() is false.');
    ...
    ***REMOVED***;
    ...
    LLRBNode.prototype.check = function () ***REMOVED***
        if (this.isRed() && this.left.isRed()) ***REMOVED***
            throw assert_1.fail('Red node has red child(' + this.key + ',' + this.value + ')');
        ***REMOVED***
        if (this.right.isRed()) ***REMOVED***
            throw assert_1.fail('Right child of (' + this.key + ',' + this.value + ') is red');
        ***REMOVED***
        var blackDepth = this.left.check();
        if (blackDepth !== this.right.check()) ***REMOVED***
            throw assert_1.fail('Black depths differ');
        ***REMOVED***
        else ***REMOVED***
