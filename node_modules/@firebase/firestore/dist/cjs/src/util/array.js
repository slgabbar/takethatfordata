 ...
 */
function includes(array, value) ***REMOVED***
 ...
 */
function some(array, predicate) ***REMOVED***
    for (var i = 0; i < array.length; i++) ***REMOVED***
 ...
 * class/function.
 */
function forEachType(array, type, fn, thisArg) ***REMOVED***
    array.forEach(function (value) ***REMOVED***
        if (value instanceof type) ***REMOVED***
 ...
 */
function findIndex(array, predicate) ***REMOVED***
    for (var i = 0; i < array.length; i++) ***REMOVED***
        if (predicate(array[i])) ***REMOVED***
            return i;
        ***REMOVED***
    ***REMOVED***
    return null;
