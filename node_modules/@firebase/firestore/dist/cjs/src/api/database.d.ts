...
import ***REMOVED*** Query as InternalQuery ***REMOVED*** from '../core/query';
import ***REMOVED*** Transaction as InternalTransaction ***REMOVED*** from '../core/transaction';
import ***REMOVED*** ViewSnapshot ***REMOVED*** from '../core/view_snapshot';
...
import ***REMOVED*** AnyJs ***REMOVED*** from '../util/misc';
import ***REMOVED*** CompleteFn, ErrorFn, NextFn, PartialObserver, Unsubscribe ***REMOVED*** from './observer';
import ***REMOVED*** UserDataConverter ***REMOVED*** from './user_data_converter';
/**
 * Options that can be provided in the Firestore constructor when not using
 * Firebase (aka standalone mode).
 */
export interface FirestoreDatabase ***REMOVED***
    projectId: string;
    database?: string;
***REMOVED***
/**
 ...
 */
export declare class Firestore implements firestore.FirebaseFirestore, FirebaseService ***REMOVED***
 ...
 */
export declare class Transaction implements firestore.Transaction ***REMOVED***
    private _firestore;
...
***REMOVED***
export declare class WriteBatch implements firestore.WriteBatch ***REMOVED***
    private _firestore;
    private _mutations;
    private _committed;
 ...
 */
export declare class DocumentReference implements firestore.DocumentReference ***REMOVED***
    _key: DocumentKey;
...
export interface SnapshotOptions extends firestore.SnapshotOptions ***REMOVED***
***REMOVED***
export declare class DocumentSnapshot implements firestore.DocumentSnapshot ***REMOVED***
    private _firestore;
    private _key;
...
***REMOVED***
export declare class QueryDocumentSnapshot extends DocumentSnapshot implements firestore.QueryDocumentSnapshot ***REMOVED***
...
***REMOVED***
export declare class Query implements firestore.Query ***REMOVED***
...
***REMOVED***
export declare class QuerySnapshot implements firestore.QuerySnapshot ***REMOVED***
    private _firestore;
...
***REMOVED***
export declare class CollectionReference extends Query implements firestore.CollectionReference ***REMOVED***
