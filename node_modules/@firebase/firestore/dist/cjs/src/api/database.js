    ...
    ***REMOVED***
    Transaction.prototype.get = function (documentRef) ***REMOVED***
        ...
        return this._transaction
            ...
            ***REMOVED***
            var doc = docs[0];
            if (doc instanceof document_1.NoDocument) ***REMOVED***
    ...
    Transaction.prototype.update = function (documentRef, fieldOrUpdateData, value) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (typeof fieldOrUpdateData === 'string' ||
            fieldOrUpdateData instanceof field_path_1.FieldPath) ***REMOVED***
...
var DocumentReference = /** @class */ (function () ***REMOVED***
    ...
    DocumentReference.prototype.onSnapshot = function () ***REMOVED***
        ...
        ***REMOVED***;
        ...
        if (typeof args[currArg] === 'object' &&
            !observer_1.isPartialObserver(args[currArg])) ***REMOVED***
        ...
        ***REMOVED***;
        if (observer_1.isPartialObserver(args[currArg])) ***REMOVED***
    ...
    ***REMOVED***;
    DocumentReference.prototype.onSnapshotInternal = function (options, observer) ***REMOVED***
        ...
        ***REMOVED***
        var asyncObserver = new async_observer_1.AsyncObserver(***REMOVED***
...
var DocumentSnapshot = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***
    DocumentSnapshot.prototype.data = function (options) ***REMOVED***
        input_validation_1.validateBetweenNumberOfArgs('DocumentSnapshot.data', arguments, 0, 1);
        options = validateSnapshotOptions('DocumentSnapshot.data', options);
        return !this._document
            ? undefined
            : this.convertObject(this._document.data, field_value_1.FieldValueOptions.fromSnapshotOptions(options));
    ***REMOVED***;
    DocumentSnapshot.prototype.get = function (fieldPath, options) ***REMOVED***
        input_validation_1.validateBetweenNumberOfArgs('DocumentSnapshot.get', arguments, 1, 2);
        ...
        if (this._document) ***REMOVED***
            ...
            if (value !== undefined) ***REMOVED***
                return this.convertValue(value, field_value_1.FieldValueOptions.fromSnapshotOptions(options));
            ***REMOVED***
        ***REMOVED***
        return undefined;
    ***REMOVED***;
    ...
    ***REMOVED***);
    DocumentSnapshot.prototype.isEqual = function (other) ***REMOVED***
        if (!(other instanceof DocumentSnapshot)) ***REMOVED***
            throw input_validation_1.invalidClassError('isEqual', 'DocumentSnapshot', 1, other);
        ***REMOVED***
    ...
    ***REMOVED***;
    DocumentSnapshot.prototype.convertValue = function (value, options) ***REMOVED***
        if (value instanceof field_value_1.ObjectValue) ***REMOVED***
            return this.convertObject(value, options);
        ***REMOVED***
        else if (value instanceof field_value_1.ArrayValue) ***REMOVED***
            return this.convertArray(value, options);
        ***REMOVED***
        else if (value instanceof field_value_1.RefValue) ***REMOVED***
...
var QueryDocumentSnapshot = /** @class */ (function (_super) ***REMOVED***
    ...
    ***REMOVED***
    QueryDocumentSnapshot.prototype.data = function (options) ***REMOVED***
        ...
        assert_1.assert(typeof data === 'object', 'Document in a QueryDocumentSnapshot should exist');
        return data;
    ***REMOVED***;
...
var Query = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    Query.prototype.validateNewFilter = function (filter) ***REMOVED***
        if (filter instanceof query_1.RelationFilter && filter.isInequality()) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    QuerySnapshot.prototype.isEqual = function (other) ***REMOVED***
        if (!(other instanceof QuerySnapshot)) ***REMOVED***
            throw input_validation_1.invalidClassError('isEqual', 'QuerySnapshot', 1, other);
        ***REMOVED***
        return (this._firestore === other._firestore &&
...
function validateSnapshotOptions(methodName, options) ***REMOVED***
    ...
    ***REMOVED***
    input_validation_1.validateOptionNames(methodName, options, ['serverTimestamps']);
    input_validation_1.validateNamedOptionalPropertyEquals(methodName, 'options', 'serverTimestamps', options.serverTimestamps, ['estimate', 'previous', 'none']);
    return options;
***REMOVED***
 ...
 */
function changesFromSnapshot(firestore, snapshot) ***REMOVED***
    ...
    ***REMOVED***
        ...
        return snapshot.docChanges.map(function (change) ***REMOVED***
            ...
            var oldIndex = -1;
            var newIndex = -1;
            if (change.type !== view_snapshot_1.ChangeType.Added) ***REMOVED***
                oldIndex = indexTracker_1.indexOf(change.doc.key);
                assert_1.assert(oldIndex >= 0, 'Index for document not found');
                indexTracker_1 = indexTracker_1.delete(change.doc.key);
            ***REMOVED***
            if (change.type !== view_snapshot_1.ChangeType.Removed) ***REMOVED***
...
exports.PublicQueryDocumentSnapshot = api_1.makeConstructorPrivate(QueryDocumentSnapshot);
