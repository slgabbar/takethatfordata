 ...
 */
export declare abstract class FieldValueImpl implements firestore.FieldValue ***REMOVED***
    static delete(): FieldValueImpl;
    static serverTimestamp(): FieldValueImpl;
    isEqual(other: FieldValueImpl): boolean;
***REMOVED***
export declare class DeleteFieldValueImpl extends FieldValueImpl ***REMOVED***
    private constructor();
    /** Singleton instance. */
    static instance: DeleteFieldValueImpl;
***REMOVED***
export declare class ServerTimestampFieldValueImpl extends FieldValueImpl ***REMOVED***
    private constructor();
    /** Singleton instance. */
