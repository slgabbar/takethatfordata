...
var UserDataConverter = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    UserDataConverter.prototype.parseUpdateData = function (methodName, input) ***REMOVED***
        ...
        objUtils.forEach(input, function (key, value) ***REMOVED***
            ...
            if (value instanceof field_value_3.DeleteFieldValueImpl) ***REMOVED***
    ...
    UserDataConverter.prototype.parseUpdateVarargs = function (methodName, field, value, moreFieldsAndValues) ***REMOVED***
        ...
        ***REMOVED***
        ...
        for (var i = 0; i < keys.length; ++i) ***REMOVED***
            ...
            if (value_1 instanceof field_value_3.DeleteFieldValueImpl) ***REMOVED***
                // Add it to the field mask, but don't add anything to updateData.
                fieldMaskPaths.push(path);
            ***REMOVED***
            else ***REMOVED***
    ...
    ***REMOVED***;
    ...
    UserDataConverter.prototype.parseScalarValue = function (value, context) ***REMOVED***
        ...
        ***REMOVED***
        else if (value instanceof blob_1.Blob) ***REMOVED***
        ...
        ***REMOVED***
        else if (value instanceof field_value_3.FieldValueImpl) ***REMOVED***
            if (value instanceof field_value_3.DeleteFieldValueImpl) ***REMOVED***
                ...
                ***REMOVED***
            ***REMOVED***
            else if (value instanceof field_value_3.ServerTimestampFieldValueImpl) ***REMOVED***
...
function validatePlainObject(message, context, input) ***REMOVED***
    if (!looksLikeJsonObject(input) || !input_validation_1.isPlainObject(input)) ***REMOVED***
 ...
 */
function fieldPathFromArgument(methodName, path) ***REMOVED***
    if (path instanceof field_path_1.FieldPath) ***REMOVED***
