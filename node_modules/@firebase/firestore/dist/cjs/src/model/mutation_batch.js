...
var MutationBatch = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***
    ...
    MutationBatch.prototype.applyToRemoteDocument = function (docKey, maybeDoc, batchResult) ***REMOVED***
        if (maybeDoc) ***REMOVED***
            assert_1.assert(maybeDoc.key.isEqual(docKey), "applyToRemoteDocument: key " + docKey + " should match maybeDoc key\n        " + maybeDoc.key);
        ***REMOVED***
    ...
    ***REMOVED***;
    ...
    MutationBatch.prototype.applyToLocalView = function (docKey, maybeDoc) ***REMOVED***
        if (maybeDoc) ***REMOVED***
            assert_1.assert(maybeDoc.key.isEqual(docKey), "applyToLocalDocument: key " + docKey + " should match maybeDoc key\n        " + maybeDoc.key);
        ***REMOVED***
