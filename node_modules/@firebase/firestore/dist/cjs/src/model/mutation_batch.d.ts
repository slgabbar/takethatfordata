...
import ***REMOVED*** BatchId, ProtoByteString ***REMOVED*** from '../core/types';
...
import ***REMOVED*** Mutation, MutationResult ***REMOVED*** from './mutation';
export declare const BATCHID_UNKNOWN = -1;
/**
 * A batch of mutations that will be sent as one unit to the backend.
 */
export declare class MutationBatch ***REMOVED***
    batchId: BatchId;
...
export declare class MutationBatchResult ***REMOVED***
