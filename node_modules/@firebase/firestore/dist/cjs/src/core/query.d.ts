...
import ***REMOVED*** FieldValue ***REMOVED*** from '../model/field_value';
import ***REMOVED*** FieldPath, ResourcePath ***REMOVED*** from '../model/path';
export declare class Query ***REMOVED***
...
***REMOVED***
export declare class RelationOp ***REMOVED***
    name: string;
...
***REMOVED***
export declare class RelationFilter implements Filter ***REMOVED***
    field: FieldPath;
    op: RelationOp;
    value: FieldValue;
 ...
 */
export declare class NullFilter implements Filter ***REMOVED***
    field: FieldPath;
 ...
 */
export declare class NanFilter implements Filter ***REMOVED***
    field: FieldPath;
    constructor(field: FieldPath);
    matches(doc: Document): boolean;
    canonicalId(): string;
 ...
 */
export declare function fieldFilter(field: FieldPath, op: RelationOp, value: FieldValue): NullFilter;
/**
 * The direction of sorting in an order by.
 */
export declare class Direction ***REMOVED***
    name: string;
 ...
 */
export declare class Bound ***REMOVED***
 ...
 */
export declare class OrderBy ***REMOVED***
