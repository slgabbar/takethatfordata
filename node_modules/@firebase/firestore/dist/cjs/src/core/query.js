...
var Query = /** @class */ (function () ***REMOVED***
        ...
        if (this.memoizedCanonicalId === null) ***REMOVED***
            ...
            ***REMOVED***
            ...
            for (var _b = 0, _c = this.orderBy; _b < _c.length; _b++) ***REMOVED***
                ...
                canonicalId += ',';
            ***REMOVED***
            if (!types_1.isNullOrUndefined(this.limit)) ***REMOVED***
                canonicalId += '|l:';
    ...
    ***REMOVED***;
    Query.prototype.matchesAncestor = function (doc) ***REMOVED***
        ...
        if (document_key_1.DocumentKey.isDocumentKey(this.path)) ***REMOVED***
 ...
 */
function fieldFilter(field, op, value) ***REMOVED***
    if (value.isEqual(field_value_1.NullValue.INSTANCE)) ***REMOVED***
    ...
    ***REMOVED***
    else if (value.isEqual(field_value_1.DoubleValue.NAN)) ***REMOVED***
        if (op !== RelationOp.EQUAL) ***REMOVED***
