...
import ***REMOVED*** Mutation ***REMOVED*** from '../model/mutation';
import ***REMOVED*** MutationBatchResult ***REMOVED*** from '../model/mutation_batch';
import ***REMOVED*** RemoteEvent ***REMOVED*** from '../remote/remote_event';
import ***REMOVED*** RemoteStore ***REMOVED*** from '../remote/remote_store';
import ***REMOVED*** RemoteSyncer ***REMOVED*** from '../remote/remote_syncer';
...
import ***REMOVED*** Transaction ***REMOVED*** from './transaction';
import ***REMOVED*** BatchId, OnlineState, TargetId ***REMOVED*** from './types';
import ***REMOVED*** ViewSnapshot ***REMOVED*** from './view_snapshot';
 ...
 * global async queue.
 */
export declare class SyncEngine implements RemoteSyncer ***REMOVED***
    private localStore;
    private remoteStore;
    private currentUser;
    private viewHandler;
