...
var EventManager = /** @class */ (function () ***REMOVED***
    function EventManager(syncEngine) ***REMOVED***
        ...
        this.queries = new obj_map_1.ObjectMap(function (q) ***REMOVED***
...
var QueryListener = /** @class */ (function () ***REMOVED***
    ...
    QueryListener.prototype.onViewSnapshot = function (snap) ***REMOVED***
        ...
        if (!this.options.includeDocumentMetadataChanges) ***REMOVED***
            ...
            for (var _i = 0, _a = snap.docChanges; _i < _a.length; _i++) ***REMOVED***
                var docChange = _a[_i];
                if (docChange.type !== view_snapshot_1.ChangeType.Metadata) ***REMOVED***
                    docChanges.push(docChange);
                ***REMOVED***
            ***REMOVED***
            snap = new view_snapshot_1.ViewSnapshot(snap.query, snap.docs, snap.oldDocs, docChanges, snap.fromCache, snap.hasPendingWrites, snap.syncStateChanged);
        ***REMOVED***
    ...
    ***REMOVED***;
    QueryListener.prototype.raiseInitialEvent = function (snap) ***REMOVED***
        ...
        snap = new view_snapshot_1.ViewSnapshot(snap.query, snap.docs, document_set_1.DocumentSet.emptySet(snap.docs), QueryListener.getInitialViewChanges(snap), snap.fromCache, snap.hasPendingWrites, true);
    ...
    ***REMOVED***;
    ...
    QueryListener.getInitialViewChanges = function (snap) ***REMOVED***
        ...
        snap.docs.forEach(function (doc) ***REMOVED***
            result.push(***REMOVED*** type: view_snapshot_1.ChangeType.Added, doc: doc ***REMOVED***);
        ***REMOVED***);
        return result;
    ***REMOVED***;
