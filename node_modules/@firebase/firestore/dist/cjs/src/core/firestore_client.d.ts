...
import ***REMOVED*** ListenOptions, Observer, QueryListener ***REMOVED*** from './event_manager';
import ***REMOVED*** Mutation ***REMOVED*** from '../model/mutation';
import ***REMOVED*** Platform ***REMOVED*** from '../platform/platform';
import ***REMOVED*** AsyncQueue ***REMOVED*** from '../util/async_queue';
import ***REMOVED*** DatabaseId, DatabaseInfo ***REMOVED*** from './database_info';
 ...
 */
export declare class FirestoreClient ***REMOVED***
    private platform;
