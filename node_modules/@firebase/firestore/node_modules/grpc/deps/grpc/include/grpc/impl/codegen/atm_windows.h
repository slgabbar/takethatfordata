...
static __inline gpr_atm gpr_atm_acq_load(const gpr_atm* p) ***REMOVED***
  gpr_atm result = *p;
  gpr_atm_full_barrier();
  return result;
***REMOVED***

static __inline gpr_atm gpr_atm_no_barrier_load(const gpr_atm* p) ***REMOVED***
  /* TODO(dklempner): Can we implement something better here? */
  return gpr_atm_acq_load(p);
***REMOVED***

static __inline void gpr_atm_rel_store(gpr_atm* p, gpr_atm value) ***REMOVED***
  gpr_atm_full_barrier();
  *p = value;
***REMOVED***

static __inline void gpr_atm_no_barrier_store(gpr_atm* p, gpr_atm value) ***REMOVED***
  /* TODO(ctiller): Can we implement something better here? */
  gpr_atm_rel_store(p, value);
***REMOVED***

static __inline int gpr_atm_no_barrier_cas(gpr_atm* p, gpr_atm o, gpr_atm n) ***REMOVED***
...
static __inline int gpr_atm_acq_cas(gpr_atm* p, gpr_atm o, gpr_atm n) ***REMOVED***
#ifdef GPR_ARCH_64
  return o == (gpr_atm)InterlockedCompareExchangeAcquire64(
                  (volatile LONGLONG*)p, (LONGLONG)n, (LONGLONG)o);
#else
...
static __inline int gpr_atm_rel_cas(gpr_atm* p, gpr_atm o, gpr_atm n) ***REMOVED***
#ifdef GPR_ARCH_64
...
static __inline int gpr_atm_full_cas(gpr_atm* p, gpr_atm o, gpr_atm n) ***REMOVED***
#ifdef GPR_ARCH_64
...
static __inline gpr_atm gpr_atm_no_barrier_fetch_add(gpr_atm* p,
                                                     gpr_atm delta) ***REMOVED***
  /** Use the CAS operation to get pointer-sized fetch and add */
  gpr_atm old;
  do ***REMOVED***
    old = *p;
  ***REMOVED*** while (!gpr_atm_no_barrier_cas(p, old, old + delta));
  return old;
***REMOVED***

static __inline gpr_atm gpr_atm_full_fetch_add(gpr_atm* p, gpr_atm delta) ***REMOVED***
  /** Use a CAS operation to get pointer-sized fetch and add */
  gpr_atm old;
#ifdef GPR_ARCH_64
  do ***REMOVED***
    old = *p;
  ***REMOVED*** while (old != (gpr_atm)InterlockedCompareExchange64((volatile LONGLONG*)p,
                                                        (LONGLONG)old + delta,
                                                        (LONGLONG)old));
#else
  do ***REMOVED***
    old = *p;
  ***REMOVED*** while (old != (gpr_atm)InterlockedCompareExchange(
                      (volatile LONG*)p, (LONG)old + delta, (LONG)old));
#endif
  return old;
***REMOVED***

static __inline gpr_atm gpr_atm_full_xchg(gpr_atm* p, gpr_atm n) ***REMOVED***
