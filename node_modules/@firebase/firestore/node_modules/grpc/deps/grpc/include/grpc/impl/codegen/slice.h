...
typedef struct grpc_slice_refcount_vtable ***REMOVED***
  void (*ref)(void*);
  void (*unref)(grpc_exec_ctx* exec_ctx, void*);
  int (*eq)(grpc_slice a, grpc_slice b);
  uint32_t (*hash)(grpc_slice slice);
***REMOVED*** grpc_slice_refcount_vtable;
...
typedef struct grpc_slice_refcount ***REMOVED***
...
struct grpc_slice ***REMOVED***
  struct grpc_slice_refcount* refcount;
  union grpc_slice_data ***REMOVED***
    struct grpc_slice_refcounted ***REMOVED***
      uint8_t* bytes;
      size_t length;
    ***REMOVED*** refcounted;
    struct grpc_slice_inlined ***REMOVED***
      uint8_t length;
