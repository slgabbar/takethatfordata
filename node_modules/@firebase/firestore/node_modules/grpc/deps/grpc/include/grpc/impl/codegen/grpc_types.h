...
***REMOVED*** grpc_byte_buffer_type;

typedef struct grpc_byte_buffer ***REMOVED***
  void* reserved;
  grpc_byte_buffer_type type;
  union grpc_byte_buffer_data ***REMOVED***
    struct /* internal */ ***REMOVED***
      void* reserved[8];
    ***REMOVED*** reserved;
    struct grpc_compressed_buffer ***REMOVED***
      grpc_compression_algorithm compression;
      grpc_slice_buffer slice_buffer;
    ***REMOVED*** raw;
  ***REMOVED*** data;
***REMOVED*** grpc_byte_buffer;
...
typedef enum ***REMOVED***
  ...
  GRPC_ARG_INTEGER,
  GRPC_ARG_POINTER
***REMOVED*** grpc_arg_type;

typedef struct grpc_arg_pointer_vtable ***REMOVED***
  void* (*copy)(void* p);
  void (*destroy)(grpc_exec_ctx* exec_ctx, void* p);
  int (*cmp)(void* p, void* q);
***REMOVED*** grpc_arg_pointer_vtable;
...
/** A single argument... each argument has a key and a value
    ...
    A note on naming keys:
      ...
      be restricted to the regex [A-Za-z][_A-Za-z0-9]***REMOVED***,15***REMOVED***.
      Key names must be restricted to the regex [A-Za-z][_A-Za-z0-9]***REMOVED***,47***REMOVED***.
...
typedef struct ***REMOVED***
  grpc_arg_type type;
  char* key;
  union grpc_arg_value ***REMOVED***
    char* string;
    int integer;
    struct grpc_arg_pointer ***REMOVED***
      void* p;
...
/** Result of a grpc call. If the caller satisfies the prerequisites of a
    ...
    caller. */
typedef enum grpc_call_error ***REMOVED***
  /** everything went ok */
  GRPC_CALL_OK = 0,
...
typedef struct grpc_metadata ***REMOVED***
  ...
  struct /* internal */ ***REMOVED***
    void* obfuscated[4];
  ***REMOVED*** internal_data;
***REMOVED*** grpc_metadata;

/** The type of completion (for grpc_event) */
typedef enum grpc_completion_type ***REMOVED***
  /** Shutting down */
  GRPC_QUEUE_SHUTDOWN,
  ...
  GRPC_OP_COMPLETE
***REMOVED*** grpc_completion_type;

/** The result of an operation.

    Returned by a completion queue when the operation started with tag. */
typedef struct grpc_event ***REMOVED***
...
***REMOVED*** grpc_op_type;

struct grpc_byte_buffer;

/** Operation data: one field for each op type (except SEND_CLOSE_FROM_CLIENT
   which has no arguments) */
typedef struct grpc_op ***REMOVED***
  ...
  void* reserved;
  union grpc_op_data ***REMOVED***
    /** Reserved for future usage */
    struct /* internal */ ***REMOVED***
      void* reserved[8];
    ***REMOVED*** reserved;
    struct grpc_op_send_initial_metadata ***REMOVED***
      size_t count;
      grpc_metadata* metadata;
      /** If \a is_set, \a compression_level will be used for the call.
       * Otherwise, \a compression_level won't be considered */
      struct grpc_op_send_initial_metadata_maybe_compression_level ***REMOVED***
        uint8_t is_set;
        grpc_compression_level level;
      ***REMOVED*** maybe_compression_level;
      struct grpc_op_send_initial_metadata_maybe_stream_compression_level ***REMOVED***
        uint8_t is_set;
        grpc_stream_compression_level level;
      ***REMOVED*** maybe_stream_compression_level;
    ***REMOVED*** send_initial_metadata;
    struct grpc_op_send_message ***REMOVED***
    ...
    ***REMOVED*** send_message;
    struct grpc_op_send_status_from_server ***REMOVED***
    ...
    ***REMOVED*** send_status_from_server;
    /** ownership of the array is with the caller, but ownership of the elements
        stays with the call object (ie key, value members are owned by the call
        object, recv_initial_metadata->array is owned by the caller).
        After the operation completes, call grpc_metadata_array_destroy on this
        value, or reuse it in a future op. */
    struct grpc_op_recv_initial_metadata ***REMOVED***
      grpc_metadata_array* recv_initial_metadata;
    ***REMOVED*** recv_initial_metadata;
    /** ownership of the byte buffer is moved to the caller; the caller must
        call grpc_byte_buffer_destroy on this value, or reuse it in a future op.
       */
    struct grpc_op_recv_message ***REMOVED***
      struct grpc_byte_buffer** recv_message;
    ***REMOVED*** recv_message;
    struct grpc_op_recv_status_on_client ***REMOVED***
    ...
    ***REMOVED*** recv_status_on_client;
    struct grpc_op_recv_close_on_server ***REMOVED***
      /** out argument, set to 1 if the call failed in any way (seen as a
          cancellation on the server), or 0 if the call succeeded */
      int* cancelled;
    ***REMOVED*** recv_close_on_server;
  ***REMOVED*** data;
***REMOVED*** grpc_op;
...
typedef enum ***REMOVED***
  ...
  GRPC_CQ_PLUCK
***REMOVED*** grpc_cq_completion_type;

#define GRPC_CQ_CURRENT_VERSION 1
typedef struct grpc_completion_queue_attributes ***REMOVED***
...
***REMOVED*** grpc_completion_queue_attributes;
