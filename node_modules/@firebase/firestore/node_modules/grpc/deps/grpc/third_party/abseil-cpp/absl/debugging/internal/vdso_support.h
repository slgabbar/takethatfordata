...
//  FN fn = nullptr;
//  if (vdso.LookupSymbol("__vdso_getcpu", "LINUX_2.6", STT_FUNC, &info)) ***REMOVED***
...
namespace debug_internal ***REMOVED***

// NOTE: this class may be used from within tcmalloc, and can not
// use any memory allocation routines.
class VDSOSupport ***REMOVED***
 public:
  VDSOSupport();
...
#ifdef __powerpc64__
  enum ***REMOVED*** kVDSOSymbolType = STT_NOTYPE ***REMOVED***;
#else
  enum ***REMOVED*** kVDSOSymbolType = STT_FUNC ***REMOVED***;
#endif

  // Answers whether we have a vdso at all.
  bool IsPresent() const ***REMOVED*** return image_.IsPresent(); ***REMOVED***

  // Allow to iterate over all VDSO symbols.
  SymbolIterator begin() const ***REMOVED*** return image_.begin(); ***REMOVED***
  SymbolIterator end() const ***REMOVED*** return image_.end(); ***REMOVED***
 ...
 private:
  ...
  //              0   => there is no VDSO.
  //           else   => vma of VDSO Elf***REMOVED***32,64***REMOVED***_Ehdr.
  //
...
***REMOVED***  // namespace debug_internal
