...
//   if (!absl::LoadTimeZone("America/New_York", &nyc)) ***REMOVED***
//      // handle error case
//   ***REMOVED***
//
...
//
//   absl::TimeZone syd;
//   if (!absl::LoadTimeZone("Australia/Sydney", &syd)) ***REMOVED***
//      // handle error case
//   ***REMOVED***
...
namespace time_internal ***REMOVED***
...
***REMOVED***  // namespace time_internal
...
class Duration ***REMOVED***
 public:
  // Value semantics.
  constexpr Duration() : rep_hi_(0), rep_lo_(0) ***REMOVED******REMOVED***  // zero-length duration
  ...
  ***REMOVED***
  ...
  Duration& operator/=(T r) ***REMOVED***
    ...
    return *this /= x;
  ***REMOVED***
  Duration& operator*=(float r) ***REMOVED*** return *this *= static_cast<double>(r); ***REMOVED***
  Duration& operator/=(float r) ***REMOVED*** return *this /= static_cast<double>(r); ***REMOVED***
 ...
 private:
  ...
  friend constexpr Duration time_internal::MakeDuration(int64_t hi,
                                                        uint32_t lo);
  constexpr Duration(int64_t hi, uint32_t lo) : rep_hi_(hi), rep_lo_(lo) ***REMOVED******REMOVED***
  int64_t rep_hi_;
  uint32_t rep_lo_;
***REMOVED***;
...
constexpr bool operator>(Duration lhs, Duration rhs) ***REMOVED*** return rhs < lhs; ***REMOVED***
constexpr bool operator>=(Duration lhs, Duration rhs) ***REMOVED*** return !(lhs < rhs); ***REMOVED***
constexpr bool operator<=(Duration lhs, Duration rhs) ***REMOVED*** return !(rhs < lhs); ***REMOVED***
constexpr bool operator==(Duration lhs, Duration rhs);
constexpr bool operator!=(Duration lhs, Duration rhs) ***REMOVED*** return !(lhs == rhs); ***REMOVED***
...
inline Duration operator+(Duration lhs, Duration rhs) ***REMOVED*** return lhs += rhs; ***REMOVED***
inline Duration operator-(Duration lhs, Duration rhs) ***REMOVED*** return lhs -= rhs; ***REMOVED***

// Multiplicative Operators
template <typename T>
inline Duration operator*(Duration lhs, T rhs) ***REMOVED***
  return lhs *= rhs;
***REMOVED***
template <typename T>
inline Duration operator*(T lhs, Duration rhs) ***REMOVED***
  return rhs *= lhs;
***REMOVED***
template <typename T>
inline Duration operator/(Duration lhs, T rhs) ***REMOVED***
  return lhs /= rhs;
***REMOVED***
inline int64_t operator/(Duration lhs, Duration rhs) ***REMOVED***
...
inline int64_t IDivDuration(Duration num, Duration den, Duration* rem) ***REMOVED***
...
constexpr Duration ZeroDuration() ***REMOVED*** return Duration(); ***REMOVED***

// AbsDuration()
//
// Returns the absolute value of a duration.
inline Duration AbsDuration(Duration d) ***REMOVED***
...
Duration Nanoseconds(T n) ***REMOVED***
  return n * Nanoseconds(1);
***REMOVED***
template <typename T, time_internal::IsFloatingPoint<T> = 0>
Duration Microseconds(T n) ***REMOVED***
  return n * Microseconds(1);
***REMOVED***
template <typename T, time_internal::IsFloatingPoint<T> = 0>
Duration Milliseconds(T n) ***REMOVED***
  return n * Milliseconds(1);
***REMOVED***
template <typename T, time_internal::IsFloatingPoint<T> = 0>
Duration Seconds(T n) ***REMOVED***
  return n * Seconds(1);
***REMOVED***
template <typename T, time_internal::IsFloatingPoint<T> = 0>
Duration Minutes(T n) ***REMOVED***
  return n * Minutes(1);
***REMOVED***
template <typename T, time_internal::IsFloatingPoint<T> = 0>
Duration Hours(T n) ***REMOVED***
  return n * Hours(1);
***REMOVED***
...
inline std::ostream& operator<<(std::ostream& os, Duration d) ***REMOVED***
...
class Time ***REMOVED***
 public:
  ...
  constexpr Time() ***REMOVED******REMOVED***

  // Assignment operators.
  Time& operator+=(Duration d) ***REMOVED***
    rep_ += d;
    return *this;
  ***REMOVED***
  Time& operator-=(Duration d) ***REMOVED***
 ...
 private:
  ...
  constexpr explicit Time(Duration rep) : rep_(rep) ***REMOVED******REMOVED***
  Duration rep_;
***REMOVED***;

// Relational Operators
constexpr bool operator<(Time lhs, Time rhs) ***REMOVED*** return lhs.rep_ < rhs.rep_; ***REMOVED***
constexpr bool operator>(Time lhs, Time rhs) ***REMOVED*** return rhs < lhs; ***REMOVED***
constexpr bool operator>=(Time lhs, Time rhs) ***REMOVED*** return !(lhs < rhs); ***REMOVED***
constexpr bool operator<=(Time lhs, Time rhs) ***REMOVED*** return !(rhs < lhs); ***REMOVED***
constexpr bool operator==(Time lhs, Time rhs) ***REMOVED*** return lhs.rep_ == rhs.rep_; ***REMOVED***
constexpr bool operator!=(Time lhs, Time rhs) ***REMOVED*** return !(lhs == rhs); ***REMOVED***

// Additive Operators
inline Time operator+(Time lhs, Duration rhs) ***REMOVED*** return lhs += rhs; ***REMOVED***
inline Time operator+(Duration lhs, Time rhs) ***REMOVED*** return rhs += lhs; ***REMOVED***
inline Time operator-(Time lhs, Duration rhs) ***REMOVED*** return lhs -= rhs; ***REMOVED***
inline Duration operator-(Time lhs, Time rhs) ***REMOVED*** return lhs.rep_ - rhs.rep_; ***REMOVED***

// UnixEpoch()
//
// Returns the `absl::Time` representing "1970-01-01 00:00:00.0 +0000".
constexpr Time UnixEpoch() ***REMOVED*** return Time(); ***REMOVED***

// UniversalEpoch()
//
// Returns the `absl::Time` representing "0001-01-01 00:00:00.0 +0000", the
// epoch of the ICU Universal Time Scale.
constexpr Time UniversalEpoch() ***REMOVED***
  // 719162 is the number of days from 0001-01-01 to 1970-01-01,
  // assuming the Gregorian calendar.
  return Time(time_internal::MakeDuration(-24 * 719162 * int64_t***REMOVED***3600***REMOVED***, 0U));
***REMOVED***

// InfiniteFuture()
//
// Returns an `absl::Time` that is infinitely far in the future.
constexpr Time InfiniteFuture() ***REMOVED***
  return Time(
...
constexpr Time InfinitePast() ***REMOVED***
  return Time(
...
//
//   absl::TimeZone lax;
//   if (!absl::LoadTimeZone("America/Los_Angeles", &lax)) ***REMOVED*** ... ***REMOVED***
//
//   // A unique civil time
...
//   if (!absl::LoadTimeZone("America/Los_Angeles", &seattle)) ***REMOVED*** ... ***REMOVED***
...
// over/underflow in ToTime***REMOVED***T,val,spec***REMOVED***() on 32-bit platforms.
...
// Output stream operator.
inline std::ostream& operator<<(std::ostream& os, Time t) ***REMOVED***
...
class TimeZone ***REMOVED***
 public:
  explicit TimeZone(cctz::time_zone tz) : cz_(tz) ***REMOVED******REMOVED***
  TimeZone() = default;  // UTC, but prefer UTCTimeZone() to be explicit.
  TimeZone(const TimeZone&) = default;
  TimeZone& operator=(const TimeZone&) = default;

  explicit operator cctz::time_zone() const ***REMOVED*** return cz_; ***REMOVED***

  std::string name() const ***REMOVED*** return cz_.name(); ***REMOVED***

 private:
  friend bool operator==(TimeZone a, TimeZone b) ***REMOVED*** return a.cz_ == b.cz_; ***REMOVED***
  friend bool operator!=(TimeZone a, TimeZone b) ***REMOVED*** return a.cz_ != b.cz_; ***REMOVED***
  friend std::ostream& operator<<(std::ostream& os, TimeZone tz) ***REMOVED***
    return os << tz.name();
  ***REMOVED***
...
inline bool LoadTimeZone(const std::string& name, TimeZone* tz) ***REMOVED***
  if (name == "localtime") ***REMOVED***
...
inline TimeZone FixedTimeZone(int seconds) ***REMOVED***
...
inline TimeZone UTCTimeZone() ***REMOVED*** return TimeZone(cctz::utc_time_zone()); ***REMOVED***
...
inline TimeZone LocalTimeZone() ***REMOVED*** return TimeZone(cctz::local_time_zone()); ***REMOVED***
...
// in time/duration.cc.
constexpr Duration MakeDuration(int64_t hi, uint32_t lo = 0) ***REMOVED***
  return Duration(hi, lo);
***REMOVED***

constexpr Duration MakeDuration(int64_t hi, int64_t lo) ***REMOVED***
...
constexpr Duration MakeNormalizedDuration(int64_t sec, int64_t ticks) ***REMOVED***
  return (ticks < 0) ? MakeDuration(sec - 1, ticks + kTicksPerSecond)
                     : MakeDuration(sec, ticks);
***REMOVED***
// Provide access to the Duration representation.
constexpr int64_t GetRepHi(Duration d) ***REMOVED*** return d.rep_hi_; ***REMOVED***
constexpr uint32_t GetRepLo(Duration d) ***REMOVED*** return d.rep_lo_; ***REMOVED***
constexpr bool IsInfiniteDuration(Duration d) ***REMOVED*** return GetRepLo(d) == ~0U; ***REMOVED***

// Returns an infinite Duration with the opposite sign.
// REQUIRES: IsInfiniteDuration(d)
constexpr Duration OppositeInfinity(Duration d) ***REMOVED***
  return GetRepHi(d) < 0
...
constexpr int64_t NegateAndSubtractOne(int64_t n) ***REMOVED***
  return (n < 0) ? -(n + 1) : (-n) - 1;
***REMOVED***
...
constexpr Time FromUnixDuration(Duration d) ***REMOVED*** return Time(d); ***REMOVED***
constexpr Duration ToUnixDuration(Time t) ***REMOVED*** return t.rep_; ***REMOVED***

template <std::intmax_t N>
constexpr absl::Duration FromInt64(int64_t v, std::ratio<1, N>) ***REMOVED***
  static_assert(0 < N && N <= 1000 * 1000 * 1000, "Unsupported ratio");
  // Subsecond ratios cannot overflow.
  return MakeNormalizedDuration(
      v / N, v % N * kTicksPerNanosecond * 1000 * 1000 * 1000 / N);
***REMOVED***
constexpr absl::Duration FromInt64(int64_t v, std::ratio<60>) ***REMOVED***
  return Minutes(v);
***REMOVED***
constexpr absl::Duration FromInt64(int64_t v, std::ratio<3600>) ***REMOVED***
  return Hours(v);
***REMOVED***

// IsValidRep64<T>(0) is true if the expression `int64_t***REMOVED***std::declval<T>()***REMOVED***` is
// valid. That is, if a T can be assigned to an int64_t without narrowing.
template <typename T>
constexpr auto IsValidRep64(int)
    -> decltype(int64_t***REMOVED***std::declval<T>()***REMOVED***, bool()) ***REMOVED***
  return true;
***REMOVED***
template <typename T>
constexpr auto IsValidRep64(char) -> bool ***REMOVED***
  return false;
***REMOVED***
...
constexpr absl::Duration FromChrono(
    const std::chrono::duration<Rep, Period>& d) ***REMOVED***
  static_assert(IsValidRep64<Rep>(0), "duration::rep is invalid");
  return FromInt64(int64_t***REMOVED***d.count()***REMOVED***, Period***REMOVED******REMOVED***);
***REMOVED***

template <typename Ratio>
int64_t ToInt64(absl::Duration d, Ratio) ***REMOVED***
  // Note: This may be used on MSVC, which may have a system_clock period of
  // std::ratio<1, 10 * 1000 * 1000>
  return ToInt64Seconds(d * Ratio::den / Ratio::num);
***REMOVED***
// Fastpath implementations for the 6 common duration units.
inline int64_t ToInt64(absl::Duration d, std::nano) ***REMOVED***
  return ToInt64Nanoseconds(d);
***REMOVED***
inline int64_t ToInt64(absl::Duration d, std::micro) ***REMOVED***
  return ToInt64Microseconds(d);
***REMOVED***
inline int64_t ToInt64(absl::Duration d, std::milli) ***REMOVED***
  return ToInt64Milliseconds(d);
***REMOVED***
inline int64_t ToInt64(absl::Duration d, std::ratio<1>) ***REMOVED***
  return ToInt64Seconds(d);
***REMOVED***
inline int64_t ToInt64(absl::Duration d, std::ratio<60>) ***REMOVED***
  return ToInt64Minutes(d);
***REMOVED***
inline int64_t ToInt64(absl::Duration d, std::ratio<3600>) ***REMOVED***
  return ToInt64Hours(d);
***REMOVED***

// Converts an absl::Duration to a chrono duration of type T.
template <typename T>
T ToChronoDuration(absl::Duration d) ***REMOVED***
  using Rep = typename T::rep;
  using Period = typename T::period;
  static_assert(IsValidRep64<Rep>(0), "duration::rep is invalid");
  if (time_internal::IsInfiniteDuration(d))
    return d < ZeroDuration() ? T::min() : T::max();
  const auto v = ToInt64(d, Period***REMOVED******REMOVED***);
  if (v > std::numeric_limits<Rep>::max()) return T::max();
  if (v < std::numeric_limits<Rep>::min()) return T::min();
  return T***REMOVED***v***REMOVED***;
***REMOVED***

***REMOVED***  // namespace time_internal

constexpr bool operator<(Duration lhs, Duration rhs) ***REMOVED***
...
constexpr Duration operator-(Duration d) ***REMOVED***
...
constexpr Duration Nanoseconds(int64_t n) ***REMOVED***
  return time_internal::MakeNormalizedDuration(
      n / (1000 * 1000 * 1000),
      n % (1000 * 1000 * 1000) * time_internal::kTicksPerNanosecond);
***REMOVED***

constexpr Duration Microseconds(int64_t n) ***REMOVED***
  return time_internal::MakeNormalizedDuration(
      n / (1000 * 1000),
      n % (1000 * 1000) * (1000 * time_internal::kTicksPerNanosecond));
***REMOVED***

constexpr Duration Milliseconds(int64_t n) ***REMOVED***
  return time_internal::MakeNormalizedDuration(
      n / 1000, n % 1000 * (1000 * 1000 * time_internal::kTicksPerNanosecond));
***REMOVED***

constexpr Duration Seconds(int64_t n) ***REMOVED*** return time_internal::MakeDuration(n); ***REMOVED***

constexpr Duration Minutes(int64_t n) ***REMOVED***
...
constexpr Duration Hours(int64_t n) ***REMOVED***
...
constexpr Duration InfiniteDuration() ***REMOVED***
  return time_internal::MakeDuration(std::numeric_limits<int64_t>::max(), ~0U);
***REMOVED***

constexpr Duration FromChrono(const std::chrono::nanoseconds& d) ***REMOVED***
  return time_internal::FromChrono(d);
***REMOVED***
constexpr Duration FromChrono(const std::chrono::microseconds& d) ***REMOVED***
  return time_internal::FromChrono(d);
***REMOVED***
constexpr Duration FromChrono(const std::chrono::milliseconds& d) ***REMOVED***
  return time_internal::FromChrono(d);
***REMOVED***
constexpr Duration FromChrono(const std::chrono::seconds& d) ***REMOVED***
  return time_internal::FromChrono(d);
***REMOVED***
constexpr Duration FromChrono(const std::chrono::minutes& d) ***REMOVED***
  return time_internal::FromChrono(d);
***REMOVED***
constexpr Duration FromChrono(const std::chrono::hours& d) ***REMOVED***
  return time_internal::FromChrono(d);
***REMOVED***

constexpr Time FromUnixNanos(int64_t ns) ***REMOVED***
  return time_internal::FromUnixDuration(Nanoseconds(ns));
***REMOVED***

constexpr Time FromUnixMicros(int64_t us) ***REMOVED***
  return time_internal::FromUnixDuration(Microseconds(us));
***REMOVED***

constexpr Time FromUnixMillis(int64_t ms) ***REMOVED***
  return time_internal::FromUnixDuration(Milliseconds(ms));
***REMOVED***

constexpr Time FromUnixSeconds(int64_t s) ***REMOVED***
  return time_internal::FromUnixDuration(Seconds(s));
***REMOVED***

constexpr Time FromTimeT(time_t t) ***REMOVED***
