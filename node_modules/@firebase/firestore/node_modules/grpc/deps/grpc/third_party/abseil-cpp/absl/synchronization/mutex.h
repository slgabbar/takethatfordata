...
class LOCKABLE Mutex ***REMOVED***
 public:
  ...
  void WriterLock() EXCLUSIVE_LOCK_FUNCTION() ***REMOVED*** this->Lock(); ***REMOVED***

  void WriterUnlock() UNLOCK_FUNCTION() ***REMOVED*** this->Unlock(); ***REMOVED***

  bool WriterTryLock() EXCLUSIVE_TRYLOCK_FUNCTION(true) ***REMOVED***
    return this->TryLock();
  ***REMOVED***
  ...
  void WriterLockWhen(const Condition &cond) EXCLUSIVE_LOCK_FUNCTION() ***REMOVED***
    this->LockWhen(cond);
  ***REMOVED***
  ...
  // simultaneously:
  //   - either `cond` is true or the ***REMOVED***timeout has expired, deadline has passed***REMOVED***
  //     and
  ...
  bool WriterLockWhenWithTimeout(const Condition &cond, absl::Duration timeout)
      EXCLUSIVE_LOCK_FUNCTION() ***REMOVED***
 ...
 private:
  ...
  synchronization_internal::MutexImpl *impl() ***REMOVED*** return impl_.get(); ***REMOVED***
  ...
  Mutex(const volatile Mutex * /*ignored*/) ***REMOVED******REMOVED***  // NOLINT(runtime/explicit)
...
//   Mutex lock_;
// ***REMOVED***;
class SCOPED_LOCKABLE MutexLock ***REMOVED***
 public:
  explicit MutexLock(Mutex *mu) EXCLUSIVE_LOCK_FUNCTION(mu) : mu_(mu) ***REMOVED***
    this->mu_->Lock();
  ***REMOVED***
  ~MutexLock() UNLOCK_FUNCTION() ***REMOVED*** this->mu_->Unlock(); ***REMOVED***
 private:
  Mutex *const mu_;
...
class SCOPED_LOCKABLE ReaderMutexLock ***REMOVED***
 public:
  explicit ReaderMutexLock(Mutex *mu) SHARED_LOCK_FUNCTION(mu)
      :  mu_(mu) ***REMOVED***
    mu->ReaderLock();
  ***REMOVED***
  ~ReaderMutexLock() UNLOCK_FUNCTION() ***REMOVED***
...
class SCOPED_LOCKABLE WriterMutexLock ***REMOVED***
 public:
  explicit WriterMutexLock(Mutex *mu) EXCLUSIVE_LOCK_FUNCTION(mu)
      : mu_(mu) ***REMOVED***
    mu->WriterLock();
  ***REMOVED***
  ~WriterMutexLock() UNLOCK_FUNCTION() ***REMOVED***
...
//
//   mu_.LockWhen(Condition(+[](const int* count) ***REMOVED*** return *count == 0; ***REMOVED***,
//         &count_));
//
...
class Condition ***REMOVED***
 public:
  ...
  //     Condition(+[](T* t) ***REMOVED*** return ...; ***REMOVED***, arg).
  //
  ...
  // Example:
  //
  //   auto reached = [this, current]() ***REMOVED***
  ...
  explicit Condition(const T *obj)
      : Condition(obj, static_cast<bool (T::*)() const>(&T::operator())) ***REMOVED******REMOVED***
...
//       mu.Lock();
//       while (!C) ***REMOVED*** cv->Wait(&mu); ***REMOVED***        // releases and reacquires mu
...
//      if (C) ***REMOVED*** cv->Signal(); ***REMOVED***
//      mu.Unlock();
//
...
class CondVar ***REMOVED***
 ...
 private:
#ifdef ABSL_INTERNAL_USE_NONPROD_MUTEX
  synchronization_internal::CondVarImpl *impl() ***REMOVED*** return impl_.get(); ***REMOVED***
  synchronization_internal::SynchronizationStorage<
...
class SCOPED_LOCKABLE MutexLockMaybe ***REMOVED***
 public:
  explicit MutexLockMaybe(Mutex *mu) EXCLUSIVE_LOCK_FUNCTION(mu)
      : mu_(mu) ***REMOVED*** if (this->mu_ != nullptr) ***REMOVED*** this->mu_->Lock(); ***REMOVED*** ***REMOVED***
  ~MutexLockMaybe() UNLOCK_FUNCTION() ***REMOVED***
    if (this->mu_ != nullptr) ***REMOVED*** this->mu_->Unlock(); ***REMOVED***
  ***REMOVED***
 private:
  Mutex *const mu_;
...
class SCOPED_LOCKABLE ReleasableMutexLock ***REMOVED***
 public:
  explicit ReleasableMutexLock(Mutex *mu) EXCLUSIVE_LOCK_FUNCTION(mu)
      : mu_(mu) ***REMOVED***
    this->mu_->Lock();
  ***REMOVED***
  ~ReleasableMutexLock() UNLOCK_FUNCTION() ***REMOVED***
    if (this->mu_ != nullptr) ***REMOVED*** this->mu_->Unlock(); ***REMOVED***
  ***REMOVED***
...
#ifdef ABSL_INTERNAL_USE_NONPROD_MUTEX
#else
inline CondVar::CondVar() : cv_(0) ***REMOVED******REMOVED***
#endif

// static
template <typename T>
bool Condition::CastAndCallMethod(const Condition *c) ***REMOVED***
...
// static
template <typename T>
bool Condition::CastAndCallFunction(const Condition *c) ***REMOVED***
...
inline Condition::Condition(bool (*func)(T *), T *arg)
    : eval_(&CastAndCallFunction<T>),
      ...
      method_(nullptr),
      arg_(const_cast<void *>(static_cast<const void *>(arg))) ***REMOVED******REMOVED***
...
inline Condition::Condition(const T *object,
    ...
    : eval_(&CastAndCallMethod<T>),
      function_(nullptr),
      method_(reinterpret_cast<InternalMethodType>(method)),
      arg_(reinterpret_cast<void *>(const_cast<T *>(object))) ***REMOVED******REMOVED***
...
enum class OnDeadlockCycle ***REMOVED***
