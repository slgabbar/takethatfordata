...
inline bool StrContains(absl::string_view haystack, absl::string_view needle) ***REMOVED***
...
inline bool StartsWith(absl::string_view text, absl::string_view prefix) ***REMOVED***
  return prefix.empty() ||
...
inline bool EndsWith(absl::string_view text, absl::string_view suffix) ***REMOVED***
  return suffix.empty() ||
