...
struct ExpectedCipher ***REMOVED***
  unsigned long id;
  int in_group_flag;
***REMOVED***;

struct CipherTest ***REMOVED***
...
static const CipherTest kCipherTests[] = ***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            ***REMOVED***TLS1_CK_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
        ***REMOVED***,
        false,
    ***REMOVED***,
    ...
    ***REMOVED***
        "kRSA+AESGCM+AES128",
        ***REMOVED***
            ***REMOVED***TLS1_CK_RSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
        ***REMOVED***,
        false,
    ***REMOVED***,
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            ***REMOVED***TLS1_CK_RSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_DHE_RSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
        ***REMOVED***,
        false,
    ***REMOVED***,
    ...
    ***REMOVED***
        ...
        "ECDHE-RSA-AES128-GCM-SHA256",
        ***REMOVED***
            ***REMOVED***TLS1_CK_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256, 1***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_128_GCM_SHA256, 0***REMOVED***,
        ***REMOVED***,
    ...
    ***REMOVED***
        // To simplify things, banish all but ***REMOVED***ECDHE_RSA,RSA***REMOVED*** x
        // ***REMOVED***CHACHA20,AES_256_CBC,AES_128_CBC***REMOVED*** x SHA1.
        ...
        "aRSA",
        ***REMOVED***
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_256_CBC_SHA, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256, 0***REMOVED***,
            ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_128_CBC_SHA, 0***REMOVED***,
            ***REMOVED***TLS1_CK_RSA_WITH_AES_128_SHA, 0***REMOVED***,
            ***REMOVED***TLS1_CK_RSA_WITH_AES_256_SHA, 0***REMOVED***,
        ***REMOVED***,
        false,
    ***REMOVED***,
    ...
    ***REMOVED***
        ...
        ***REMOVED***
            ***REMOVED***TLS1_CK_RSA_WITH_AES_128_SHA256, 0***REMOVED***,
        ***REMOVED***,
        false,
    ***REMOVED***,
...
static const char *kBadRules[] = ***REMOVED***
  // Invalid brackets.
...
static const char *kMustNotIncludeNull[] = ***REMOVED***
  "ALL",
  "DEFAULT",
  "HIGH",
  "FIPS",
...
static const CurveTest kCurveTests[] = ***REMOVED***
  ***REMOVED***
    "P-256",
    ***REMOVED*** SSL_CURVE_SECP256R1 ***REMOVED***,
  ***REMOVED***,
  ***REMOVED***
...
static const char *kBadCurvesLists[] = ***REMOVED***
  "",
  ":",
  "::",
  "P-256::X25519",
...
static void PrintCipherPreferenceList(ssl_cipher_preference_list_st *list) ***REMOVED***
  bool in_group = false;
  for (size_t i = 0; i < sk_SSL_CIPHER_num(list->ciphers); i++) ***REMOVED***
    const SSL_CIPHER *cipher = sk_SSL_CIPHER_value(list->ciphers, i);
    if (!in_group && list->in_group_flags[i]) ***REMOVED***
      fprintf(stderr, "\t[\n");
      in_group = true;
    ***REMOVED***
    fprintf(stderr, "\t");
...
static bool TestCipherRule(const CipherTest &t) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(TLS_method()));
  if (!ctx) ***REMOVED***
    return false;
  ***REMOVED***

  if (!SSL_CTX_set_cipher_list(ctx.get(), t.rule)) ***REMOVED***
    fprintf(stderr, "Error testing cipher rule '%s'\n", t.rule);
    return false;
  ***REMOVED***

  if (!SSL_CTX_set_strict_cipher_list(ctx.get(), t.rule) != t.strict_fail) ***REMOVED***
...
static bool TestRuleDoesNotIncludeNull(const char *rule) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(SSLv23_server_method()));
  if (!ctx) ***REMOVED***
    return false;
  ***REMOVED***
  if (!SSL_CTX_set_strict_cipher_list(ctx.get(), rule)) ***REMOVED***
    fprintf(stderr, "Error: cipher rule '%s' failed\n", rule);
    return false;
  ***REMOVED***
  for (size_t i = 0; i < sk_SSL_CIPHER_num(ctx->cipher_list->ciphers); i++) ***REMOVED***
    if (SSL_CIPHER_is_NULL(sk_SSL_CIPHER_value(ctx->cipher_list->ciphers, i))) ***REMOVED***
...
static bool TestCipherRules() ***REMOVED***
  for (const CipherTest &test : kCipherTests) ***REMOVED***
    if (!TestCipherRule(test)) ***REMOVED***
      return false;
    ***REMOVED***
  ***REMOVED***

  for (const char *rule : kBadRules) ***REMOVED***
    bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(SSLv23_server_method()));
    if (!ctx) ***REMOVED***
      return false;
    ***REMOVED***
    if (SSL_CTX_set_cipher_list(ctx.get(), rule)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (const char *rule : kMustNotIncludeNull) ***REMOVED***
    if (!TestRuleDoesNotIncludeNull(rule)) ***REMOVED***
      return false;
    ***REMOVED***
  ***REMOVED***
...
static bool TestCurveRule(const CurveTest &t) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(TLS_method()));
  if (!ctx) ***REMOVED***
    return false;
  ***REMOVED***

  if (!SSL_CTX_set1_curves_list(ctx.get(), t.rule)) ***REMOVED***
    fprintf(stderr, "Error testing curves list '%s'\n", t.rule);
    return false;
  ***REMOVED***

  // Compare the two lists.
  if (ctx->supported_group_list_len != t.expected.size()) ***REMOVED***
    fprintf(stderr, "Error testing curves list '%s': length\n", t.rule);
    return false;
  ***REMOVED***

  for (size_t i = 0; i < t.expected.size(); i++) ***REMOVED***
    if (t.expected[i] != ctx->supported_group_list[i]) ***REMOVED***
...
static bool TestCurveRules() ***REMOVED***
  for (const CurveTest &test : kCurveTests) ***REMOVED***
    if (!TestCurveRule(test)) ***REMOVED***
      return false;
    ***REMOVED***
  ***REMOVED***

  for (const char *rule : kBadCurvesLists) ***REMOVED***
    bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(SSLv23_server_method()));
    if (!ctx) ***REMOVED***
      return false;
    ***REMOVED***
    if (SSL_CTX_set1_curves_list(ctx.get(), rule)) ***REMOVED***
...
static bool DecodeBase64(std::vector<uint8_t> *out, const char *in) ***REMOVED***
  size_t len;
  if (!EVP_DecodedLength(&len, strlen(in))) ***REMOVED***
...
static bool TestSSL_SESSIONEncoding(const char *input_b64) ***REMOVED***
  const uint8_t *cptr;
  uint8_t *ptr;

  // Decode the input.
  std::vector<uint8_t> input;
  if (!DecodeBase64(&input, input_b64)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  uint8_t *encoded_raw;
  if (!SSL_SESSION_to_bytes(session.get(), &encoded_raw, &encoded_len)) ***REMOVED***
    fprintf(stderr, "SSL_SESSION_to_bytes failed\n");
    return false;
  ***REMOVED***
  encoded.reset(encoded_raw);
  if (encoded_len != input.size() ||
      OPENSSL_memcmp(input.data(), encoded.get(), input.size()) != 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!session || cptr != input.data() + input.size()) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (len < 0 || (size_t)len != input.size()) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (len < 0 || (size_t)len != input.size()) ***REMOVED***
    ...
    return false;
  ***REMOVED***
  if (ptr != encoded.get() + input.size()) ***REMOVED***
    fprintf(stderr, "i2d_SSL_SESSION did not advance ptr correctly\n");
    return false;
  ***REMOVED***
  if (OPENSSL_memcmp(input.data(), encoded.get(), input.size()) != 0) ***REMOVED***
...
static bool TestBadSSL_SESSIONEncoding(const char *input_b64) ***REMOVED***
  std::vector<uint8_t> input;
  if (!DecodeBase64(&input, input_b64)) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestDefaultVersion(uint16_t min_version, uint16_t max_version,
                               const SSL_METHOD *(*method)(void)) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(method()));
  if (!ctx) ***REMOVED***
    return false;
  ***REMOVED***
  if (ctx->min_version != min_version || ctx->max_version != max_version) ***REMOVED***
...
static bool CipherGetRFCName(std::string *out, uint16_t value) ***REMOVED***
  const SSL_CIPHER *cipher = SSL_get_cipher_by_value(value);
  if (cipher == NULL) ***REMOVED***
    return false;
  ***REMOVED***
...
typedef struct ***REMOVED***
  int id;
  const char *rfc_name;
***REMOVED*** CIPHER_RFC_NAME_TEST;

static const CIPHER_RFC_NAME_TEST kCipherRFCNameTests[] = ***REMOVED***
    ***REMOVED***SSL3_CK_RSA_DES_192_CBC3_SHA, "TLS_RSA_WITH_3DES_EDE_CBC_SHA"***REMOVED***,
    ***REMOVED***TLS1_CK_RSA_WITH_AES_128_SHA, "TLS_RSA_WITH_AES_128_CBC_SHA"***REMOVED***,
    ***REMOVED***TLS1_CK_DHE_RSA_WITH_AES_256_SHA, "TLS_DHE_RSA_WITH_AES_256_CBC_SHA"***REMOVED***,
    ***REMOVED***TLS1_CK_DHE_RSA_WITH_AES_256_SHA256,
     "TLS_DHE_RSA_WITH_AES_256_CBC_SHA256"***REMOVED***,
    ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_128_SHA256,
     "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256"***REMOVED***,
    ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_256_SHA384,
     "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384"***REMOVED***,
    ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_AES_128_GCM_SHA256,
     "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256"***REMOVED***,
    ***REMOVED***TLS1_CK_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,
     "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256"***REMOVED***,
    ***REMOVED***TLS1_CK_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,
     "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384"***REMOVED***,
    ***REMOVED***TLS1_CK_ECDHE_PSK_WITH_AES_128_CBC_SHA,
     "TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA"***REMOVED***,
    ***REMOVED***TLS1_CK_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256,
     "TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256"***REMOVED***,
    ***REMOVED***TLS1_CK_AES_256_GCM_SHA384, "TLS_AES_256_GCM_SHA384"***REMOVED***,
    ***REMOVED***TLS1_CK_AES_128_GCM_SHA256, "TLS_AES_128_GCM_SHA256"***REMOVED***,
    ***REMOVED***TLS1_CK_CHACHA20_POLY1305_SHA256, "TLS_CHACHA20_POLY1305_SHA256"***REMOVED***,
***REMOVED***;

static bool TestCipherGetRFCName(void) ***REMOVED***
  for (size_t i = 0;
       i < OPENSSL_ARRAY_SIZE(kCipherRFCNameTests); i++) ***REMOVED***
    const CIPHER_RFC_NAME_TEST *test = &kCipherRFCNameTests[i];
    std::string rfc_name;
    if (!CipherGetRFCName(&rfc_name, test->id & 0xffff)) ***REMOVED***
      fprintf(stderr, "SSL_CIPHER_get_rfc_name failed\n");
      return false;
    ***REMOVED***
    if (rfc_name != test->rfc_name) ***REMOVED***
...
static bssl::UniquePtr<SSL_SESSION> CreateSessionWithTicket(uint16_t version,
                                                            size_t ticket_len) ***REMOVED***
  std::vector<uint8_t> der;
  if (!DecodeBase64(&der, kOpenSSLSession)) ***REMOVED***
    return nullptr;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (session->tlsext_tick == nullptr) ***REMOVED***
    return nullptr;
  ***REMOVED***
...
static bool GetClientHello(SSL *ssl, std::vector<uint8_t> *out) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!BIO_mem_contents(bio.get(), &client_hello, &client_hello_len)) ***REMOVED***
    return false;
  ***REMOVED***
...
static size_t GetClientHelloLen(uint16_t max_version, uint16_t session_version,
  ...
  ***REMOVED***
  ...
  if (!ssl || !SSL_set_session(ssl.get(), session.get()) ||
      ...
      !SSL_set_max_proto_version(ssl.get(), max_version)) ***REMOVED***
    return 0;
  ***REMOVED***

  std::vector<uint8_t> client_hello;
  if (!GetClientHello(ssl.get(), &client_hello) ||
      client_hello.size() <= SSL3_RT_HEADER_LENGTH) ***REMOVED***
    return 0;
  ***REMOVED***
...
struct PaddingTest ***REMOVED***
  size_t input_len, padded_len;
***REMOVED***;

static const PaddingTest kPaddingTests[] = ***REMOVED***
    // ClientHellos of length below 0x100 do not require padding.
    ***REMOVED***0xfe, 0xfe***REMOVED***,
    ***REMOVED***0xff, 0xff***REMOVED***,
    // ClientHellos of length 0x100 through 0x1fb are padded up to 0x200.
    ***REMOVED***0x100, 0x200***REMOVED***,
    ***REMOVED***0x123, 0x200***REMOVED***,
    ***REMOVED***0x1fb, 0x200***REMOVED***,
    ...
    // extensions.)
    ***REMOVED***0x1fc, 0x201***REMOVED***,
    ***REMOVED***0x1fd, 0x202***REMOVED***,
    ***REMOVED***0x1fe, 0x203***REMOVED***,
    ***REMOVED***0x1ff, 0x204***REMOVED***,
    // Finally, larger ClientHellos need no padding.
    ***REMOVED***0x200, 0x200***REMOVED***,
    ***REMOVED***0x201, 0x201***REMOVED***,
***REMOVED***;

static bool TestPaddingExtension(uint16_t max_version,
                                 uint16_t session_version) ***REMOVED***
  // Sample a baseline length.
  size_t base_len = GetClientHelloLen(max_version, session_version, 1);
  if (base_len == 0) ***REMOVED***
    return false;
  ***REMOVED***

  for (const PaddingTest &test : kPaddingTests) ***REMOVED***
    if (base_len > test.input_len) ***REMOVED***
      fprintf(stderr,
    ...
    ***REMOVED***
    ...
    if (padded_len != test.padded_len) ***REMOVED***
      fprintf(stderr,
...
TEST(SSLTest, ClientCAList) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(TLS_method()));
  ASSERT_TRUE(ctx);
  bssl::UniquePtr<SSL> ssl(SSL_new(ctx.get()));
  ASSERT_TRUE(ssl);
...
static void AppendSession(SSL_SESSION *session, void *arg) ***REMOVED***
...
static bool ExpectCache(SSL_CTX *ctx,
                        const std::vector<SSL_SESSION*> &expected) ***REMOVED***
  // Check the linked list.
  SSL_SESSION *ptr = ctx->session_cache_head;
  for (SSL_SESSION *session : expected) ***REMOVED***
    if (ptr != session) ***REMOVED***
      return false;
    ***REMOVED***
    // TODO(davidben): This is an absurd way to denote the end of the list.
    if (ptr->next ==
        reinterpret_cast<SSL_SESSION *>(&ctx->session_cache_tail)) ***REMOVED***
      ptr = nullptr;
    ***REMOVED*** else ***REMOVED***
      ptr = ptr->next;
    ***REMOVED***
  ***REMOVED***
  if (ptr != nullptr) ***REMOVED***
    return false;
  ***REMOVED***
...
static bssl::UniquePtr<SSL_SESSION> CreateTestSession(uint32_t number) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ssl_ctx(SSL_CTX_new(TLS_method()));
  if (!ssl_ctx) ***REMOVED***
    return nullptr;
  ***REMOVED***
...
static bool TestInternalSessionCache() ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(TLS_method()));
  if (!ctx) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (const auto &session : sessions) ***REMOVED***
    if (!SSL_CTX_add_session(ctx.get(), session.get())) ***REMOVED***
      return false;
    ***REMOVED***
  ***REMOVED***

  // Only the last five should be in the list.
  std::vector<SSL_SESSION*> expected = ***REMOVED***
      sessions[9].get(),
      sessions[8].get(),
      sessions[7].get(),
      sessions[6].get(),
  ...
  ***REMOVED***
  ...
  if (!collision || !SSL_CTX_add_session(ctx.get(), collision.get())) ***REMOVED***
    return false;
  ***REMOVED***
  expected = ***REMOVED***
      collision.get(),
  ...
  ***REMOVED***
  ...
  if (!SSL_CTX_remove_session(ctx.get(), sessions[6].get())) ***REMOVED***
    return false;
  ***REMOVED***
  expected = ***REMOVED***
      collision.get(),
...
static uint16_t EpochFromSequence(uint64_t seq) ***REMOVED***
  return static_cast<uint16_t>(seq >> 48);
***REMOVED***

static bssl::UniquePtr<X509> GetTestCertificate() ***REMOVED***
...
static bssl::UniquePtr<EVP_PKEY> GetTestKey() ***REMOVED***
...
static bssl::UniquePtr<X509> GetECDSATestCertificate() ***REMOVED***
  static const char kCertPEM[] =
      "-----BEGIN CERTIFICATE-----\n"
...
static bssl::UniquePtr<EVP_PKEY> GetECDSATestKey() ***REMOVED***
  static const char kKeyPEM[] =
      "-----BEGIN PRIVATE KEY-----\n"
...
static bssl::UniquePtr<X509> GetChainTestCertificate() ***REMOVED***
  static const char kCertPEM[] =
      "-----BEGIN CERTIFICATE-----\n"
...
static bssl::UniquePtr<X509> GetChainTestIntermediate() ***REMOVED***
  static const char kCertPEM[] =
      "-----BEGIN CERTIFICATE-----\n"
...
static bssl::UniquePtr<EVP_PKEY> GetChainTestKey() ***REMOVED***
  static const char kKeyPEM[] =
      "-----BEGIN PRIVATE KEY-----\n"
...
static bool CompleteHandshakes(SSL *client, SSL *server) ***REMOVED***
  ...
  for (;;) ***REMOVED***
    ...
    if (client_err != SSL_ERROR_NONE &&
        ...
        client_err != SSL_ERROR_WANT_WRITE) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (server_err != SSL_ERROR_NONE &&
        ...
        server_err != SSL_ERROR_WANT_WRITE) ***REMOVED***
      fprintf(stderr, "Server error: %d\n", server_err);
      return false;
    ***REMOVED***

    if (client_ret == 1 && server_ret == 1) ***REMOVED***
      break;
    ***REMOVED***
  ***REMOVED***
...
static bool ConnectClientAndServer(bssl::UniquePtr<SSL> *out_client,
                                   ...
                                   SSL_SESSION *session) ***REMOVED***
  bssl::UniquePtr<SSL> client(SSL_new(client_ctx)), server(SSL_new(server_ctx));
  if (!client || !server) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  BIO *bio1, *bio2;
  if (!BIO_new_bio_pair(&bio1, 0, &bio2, 0)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  if (!CompleteHandshakes(client.get(), server.get())) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestSequenceNumber(bool is_dtls, const SSL_METHOD *method,
  ...
  if (!server_ctx || !client_ctx ||
      ...
      !SSL_CTX_set_max_proto_version(server_ctx.get(), version)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  if (!cert || !key || !SSL_CTX_use_certificate(server_ctx.get(), cert.get()) ||
      !SSL_CTX_use_PrivateKey(server_ctx.get(), key.get())) ***REMOVED***
    return false;
  ***REMOVED***

  bssl::UniquePtr<SSL> client, server;
  if (!ConnectClientAndServer(&client, &server, client_ctx.get(),
                              server_ctx.get(), nullptr /* no session */)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  if (SSL_read(client.get(), &byte, 1) > 0 ||
      SSL_read(server.get(), &byte, 1) > 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (is_dtls) ***REMOVED***
    ...
    if (EpochFromSequence(client_read_seq) != 1 ||
        ...
        EpochFromSequence(server_write_seq) != 1) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (client_write_seq <= server_read_seq ||
        server_write_seq <= client_read_seq) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (SSL_write(client.get(), &byte, 1) != 1 ||
      SSL_read(server.get(), &byte, 1) != 1) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (client_write_seq + 1 != SSL_get_write_sequence(client.get()) ||
      server_read_seq + 1 != SSL_get_read_sequence(server.get())) ***REMOVED***
...
static bool TestOneSidedShutdown(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  if (SSL_shutdown(client.get()) != 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (SSL_read(server.get(), &byte, 1) != 0 ||
      SSL_get_error(server.get(), 0) != SSL_ERROR_ZERO_RETURN) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (SSL_shutdown(server.get()) != 1 ||
      SSL_shutdown(client.get()) != 1) ***REMOVED***
...
TEST(SSLTest, SessionDuplication) ***REMOVED***
...
static void ExpectFDs(const SSL *ssl, int rfd, int wfd) ***REMOVED***
...
static int VerifySucceed(X509_STORE_CTX *store_ctx, void *arg) ***REMOVED*** return 1; ***REMOVED***
...
static bool TestGetPeerCertificate(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  if (!ctx ||
      ...
      !SSL_CTX_set_max_proto_version(ctx.get(), version)) ***REMOVED***
    return false;
  ***REMOVED***
  SSL_CTX_set_verify(
  ...
  ***REMOVED***
  ...
  if (sk_X509_num(SSL_get_peer_cert_chain(client.get())) != 1) ***REMOVED***
    fprintf(stderr, "Client peer chain was incorrect.\n");
    return false;
  ***REMOVED***

  if (sk_X509_num(SSL_get_peer_cert_chain(server.get())) != 0) ***REMOVED***
...
static bool TestRetainOnlySHA256OfCerts(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  if (!session->peer_sha256_valid) ***REMOVED***
...
static bool ClientHelloMatches(uint16_t version, const uint8_t *expected,
  ...
  ***REMOVED***
  std::vector<uint8_t> client_hello;
  if (!GetClientHello(ssl.get(), &client_hello)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  constexpr size_t kRandomOffset = 1 + 2 + 2 +  // record header
                                   ...
                                   2;           // client_version
  if (client_hello.size() < kRandomOffset + SSL3_RANDOM_SIZE) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (client_hello.size() != expected_len ||
      OPENSSL_memcmp(client_hello.data(), expected, expected_len) != 0) ***REMOVED***
    fprintf(stderr, "ClientHello for version %04x did not match:\n", version);
    fprintf(stderr, "Got:\n\t");
    for (size_t i = 0; i < client_hello.size(); i++) ***REMOVED***
      fprintf(stderr, "0x%02x, ", client_hello[i]);
    ***REMOVED***
    fprintf(stderr, "\nWanted:\n\t");
    for (size_t i = 0; i < expected_len; i++) ***REMOVED***
...
static bool TestClientHello() ***REMOVED***
  static const uint8_t kSSL3ClientHello[] = ***REMOVED***
    0x16,
    0x03, 0x00,
    0x00, 0x3f,
    0x01,
  ...
  ***REMOVED***;
  if (!ClientHelloMatches(SSL3_VERSION, kSSL3ClientHello,
                          sizeof(kSSL3ClientHello))) ***REMOVED***
    return false;
  ***REMOVED***

  static const uint8_t kTLS1ClientHello[] = ***REMOVED***
      0x16,
      0x03, 0x01,
      0x00, 0x5e,
      0x01,
  ...
  ***REMOVED***;
  if (!ClientHelloMatches(TLS1_VERSION, kTLS1ClientHello,
                          sizeof(kTLS1ClientHello))) ***REMOVED***
    return false;
  ***REMOVED***

  static const uint8_t kTLS11ClientHello[] = ***REMOVED***
      0x16,
      0x03, 0x01,
      0x00, 0x5e,
      0x01,
  ...
  ***REMOVED***;
  if (!ClientHelloMatches(TLS1_1_VERSION, kTLS11ClientHello,
                          sizeof(kTLS11ClientHello))) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  static const uint8_t kTLS12ClientHello[] = ***REMOVED***
  ...
  ***REMOVED***;
  if (!ClientHelloMatches(TLS1_2_VERSION, kTLS12ClientHello,
                          sizeof(kTLS12ClientHello))) ***REMOVED***
    return false;
  ***REMOVED***
...
static int SaveLastSession(SSL *ssl, SSL_SESSION *session) ***REMOVED***
...
static bool ExpectSessionReused(SSL_CTX *client_ctx, SSL_CTX *server_ctx,
  ...
  if (!ConnectClientAndServer(&client, &server, client_ctx,
                              server_ctx, session)) ***REMOVED***
    fprintf(stderr, "Failed to connect client and server.\n");
    return false;
  ***REMOVED***

  if (SSL_session_reused(client.get()) != SSL_session_reused(server.get())) ***REMOVED***
    fprintf(stderr, "Client and server were inconsistent.\n");
    return false;
  ***REMOVED***

  bool was_reused = !!SSL_session_reused(client.get());
  if (was_reused != reused) ***REMOVED***
...
static bssl::UniquePtr<SSL_SESSION> ExpectSessionRenewed(SSL_CTX *client_ctx,
  ...
  ***REMOVED***
  ...
  if (!SSL_session_reused(client.get())) ***REMOVED***
...
static int SwitchSessionIDContextSNI(SSL *ssl, int *out_alert, void *arg) ***REMOVED***
  static const uint8_t kContext[] = ***REMOVED***3***REMOVED***;

  if (!SSL_set_session_id_context(ssl, kContext, sizeof(kContext))) ***REMOVED***
...
static int SwitchSessionIDContextEarly(const SSL_CLIENT_HELLO *client_hello) ***REMOVED***
  static const uint8_t kContext[] = ***REMOVED***3***REMOVED***;

  if (!SSL_set_session_id_context(client_hello->ssl, kContext,
                                  sizeof(kContext))) ***REMOVED***
    return -1;
  ***REMOVED***
...
static bool TestSessionIDContext(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  static const uint8_t kContext1[] = ***REMOVED***1***REMOVED***;
  static const uint8_t kContext2[] = ***REMOVED***2***REMOVED***;
  ...
  ***REMOVED***
  ...
  if (!ExpectSessionReused(client_ctx.get(), server_ctx.get(), session.get(),
                           true /* expect session reused */)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!SSL_CTX_set_session_id_context(server_ctx.get(), kContext2,
                                      sizeof(kContext2))) ***REMOVED***
    return false;
  ***REMOVED***

  if (!ExpectSessionReused(client_ctx.get(), server_ctx.get(), session.get(),
                           false /* expect session not reused */)) ***REMOVED***
...
static void CurrentTimeCallback(const SSL *ssl, timeval *out_clock) ***REMOVED***
  *out_clock = g_current_time;
***REMOVED***

static void FrozenTimeCallback(const SSL *ssl, timeval *out_clock) ***REMOVED***
...
static int RenewTicketCallback(SSL *ssl, uint8_t *key_name, uint8_t *iv,
                               ...
                               int encrypt) ***REMOVED***
  static const uint8_t kZeros[16] = ***REMOVED***0***REMOVED***;

  if (encrypt) ***REMOVED***
    OPENSSL_memcpy(key_name, kZeros, sizeof(kZeros));
    RAND_bytes(iv, 16);
  ***REMOVED*** else if (OPENSSL_memcmp(key_name, kZeros, 16) != 0) ***REMOVED***
    return 0;
  ***REMOVED***

  if (!HMAC_Init_ex(hmac_ctx, kZeros, sizeof(kZeros), EVP_sha256(), NULL) ||
      !EVP_CipherInit_ex(ctx, EVP_aes_128_cbc(), NULL, kZeros, iv, encrypt)) ***REMOVED***
    return -1;
  ***REMOVED***
...
static bool GetServerTicketTime(long *out, const SSL_SESSION *session) ***REMOVED***
  if (session->tlsext_ticklen < 16 + 16 + SHA256_DIGEST_LENGTH) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  if (!EVP_DecryptInit_ex(ctx.get(), EVP_aes_128_cbc(), nullptr, kZeros, iv) ||
      ...
      !EVP_DecryptFinal_ex(ctx.get(), plaintext.get() + len1, &len2)) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestSessionTimeout(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  for (bool server_test : std::vector<bool>***REMOVED***false, true***REMOVED***) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (version == SSL3_VERSION) ***REMOVED***
      continue;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    long session_time = 0;
    if (server_test) ***REMOVED***
      if (!GetServerTicketTime(&session_time, new_session.get())) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (session_time != g_current_time.tv_sec) ***REMOVED***
      fprintf(stderr, "New session is not measured from issuance.\n");
      return false;
    ***REMOVED***

    if (version == TLS1_3_VERSION) ***REMOVED***
      ...
      ***REMOVED***
      ...
      if (!ExpectSessionReused(client_ctx.get(), server_ctx.get(),
                               new_session.get(),
                               false /* expect session ot reused */)) ***REMOVED***
      ...
      ***REMOVED***
      ...
      while (new_start_time < auth_end_time - 1000) ***REMOVED***
...
static int SwitchContext(SSL *ssl, int *out_alert, void *arg) ***REMOVED***
...
static bool TestSNICallback(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  if (!cert || !key || !cert2 || !key2) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  static const uint8_t kSCTList[] = ***REMOVED***0, 6, 0, 4, 5, 6, 7, 8***REMOVED***;
  static const uint8_t kOCSPResponse[] = ***REMOVED***1, 2, 3, 4***REMOVED***;
  ...
  if (!server_ctx || !server_ctx2 || !client_ctx ||
      ...
      !SSL_CTX_set_max_proto_version(server_ctx2.get(), version)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  bssl::UniquePtr<SSL> client, server;
  if (!ConnectClientAndServer(&client, &server, client_ctx.get(),
                              server_ctx.get(), nullptr)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!peer || X509_cmp(peer.get(), cert2.get()) != 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (Bytes(kSCTList) != Bytes(data, len)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (Bytes(kOCSPResponse) != Bytes(data, len)) ***REMOVED***
...
TEST(SSLTest, EarlyCallbackVersionSwitch) ***REMOVED***
  bssl::UniquePtr<X509> cert = GetTestCertificate();
  bssl::UniquePtr<EVP_PKEY> key = GetTestKey();
  bssl::UniquePtr<SSL_CTX> server_ctx(SSL_CTX_new(TLS_method()));
  bssl::UniquePtr<SSL_CTX> client_ctx(SSL_CTX_new(TLS_method()));
  ...
  SSL_CTX_set_select_certificate_cb(
      server_ctx.get(), [](const SSL_CLIENT_HELLO *client_hello) -> int ***REMOVED***
        if (!SSL_set_max_proto_version(client_hello->ssl, TLS1_2_VERSION)) ***REMOVED***
          return -1;
        ***REMOVED***
...
TEST(SSLTest, SetVersion) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(TLS_method()));
  ASSERT_TRUE(ctx);
...
static const char *GetVersionName(uint16_t version) ***REMOVED***
...
static bool TestVersion(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  if (SSL_version(client.get()) != version ||
      SSL_version(server.get()) != version) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (strcmp(version_name, SSL_get_version(client.get())) != 0 ||
      strcmp(version_name, SSL_get_version(server.get())) != 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (strcmp(version_name, client_name) != 0 ||
      strcmp(version_name, server_name) != 0) ***REMOVED***
    fprintf(stderr,
...
static bool TestALPNCipherAvailable(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  static const uint8_t kALPNProtos[] = ***REMOVED***0x03, 'f', 'o', 'o'***REMOVED***;
  ...
  ***REMOVED***
  ...
  if (!callback_state.second) ***REMOVED***
...
static bool TestSSLClearSessionResumption(bool is_dtls,
  ...
  ***REMOVED***
  ...
  if (SSL_session_reused(client.get()) ||
      SSL_session_reused(server.get())) ***REMOVED***
...
static bool ChainsEqual(STACK_OF(X509) *chain,
                         const std::vector<X509 *> &expected) ***REMOVED***
  if (sk_X509_num(chain) != expected.size()) ***REMOVED***
    return false;
  ***REMOVED***

  for (size_t i = 0; i < expected.size(); i++) ***REMOVED***
    if (X509_cmp(sk_X509_value(chain, i), expected[i]) != 0) ***REMOVED***
      return false;
    ***REMOVED***
  ***REMOVED***
...
static bool TestAutoChain(bool is_dtls, const SSL_METHOD *method,
  ...
  if (!cert || !intermediate || !key) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!ChainsEqual(SSL_get_peer_full_cert_chain(client.get()), ***REMOVED***cert.get()***REMOVED***)) ***REMOVED***
    fprintf(stderr, "Client-received chain did not match.\n");
    return false;
  ***REMOVED***

  if (!ChainsEqual(SSL_get_peer_full_cert_chain(server.get()), ***REMOVED***cert.get()***REMOVED***)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!ChainsEqual(SSL_get_peer_full_cert_chain(client.get()),
                   ***REMOVED***cert.get(), intermediate.get()***REMOVED***)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!ChainsEqual(SSL_get_peer_full_cert_chain(client.get()),
                   ***REMOVED***cert.get(), cert.get()***REMOVED***)) ***REMOVED***
    fprintf(stderr,
...
static bool ExpectBadWriteRetry() ***REMOVED***
  int err = ERR_get_error();
  if (ERR_GET_LIB(err) != ERR_LIB_SSL ||
      ERR_GET_REASON(err) != SSL_R_BAD_WRITE_RETRY) ***REMOVED***
...
static bool TestSSLWriteRetry(bool is_dtls, const SSL_METHOD *method,
  ...
  ***REMOVED***
  ...
  for (bool enable_partial_write : std::vector<bool>***REMOVED***false, true***REMOVED***) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (enable_partial_write) ***REMOVED***
    ...
    ***REMOVED***
    ...
    for (;;) ***REMOVED***
      ...
      if (ret <= 0) ***REMOVED***
        ...
        if (SSL_get_error(client.get(), ret) == SSL_ERROR_WANT_WRITE) ***REMOVED***
          break;
        ***REMOVED***
    ...
    ***REMOVED***
    ...
    // Drain the buffer.
    char buf[20];
    for (unsigned i = 0; i < count; i++) ***REMOVED***
      if (SSL_read(server.get(), buf, sizeof(buf)) != kChunkLen ||
          OPENSSL_memcmp(buf, "hello", kChunkLen) != 0) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (enable_partial_write) ***REMOVED***
      if (SSL_write(client.get(), data3, kChunkLen + 1) != kChunkLen ||
          SSL_write(client.get(), data3 + kChunkLen, 1) != 1) ***REMOVED***
        fprintf(stderr, "SSL_write retry failed.\n");
        return false;
      ***REMOVED***
    ***REMOVED*** else if (SSL_write(client.get(), data3, kChunkLen + 1) != kChunkLen + 1) ***REMOVED***
      fprintf(stderr, "SSL_write retry failed.\n");
      return false;
    ***REMOVED***
...
static bool ForEachVersion(bool (*test_func)(bool is_dtls,
                                             const SSL_METHOD *method,
                                             uint16_t version)) ***REMOVED***
  static uint16_t kTLSVersions[] = ***REMOVED***
      SSL3_VERSION,
      TLS1_VERSION,
      TLS1_1_VERSION,
      TLS1_2_VERSION,
// TLS 1.3 requires RSA-PSS, which is disabled for Android system builds.
  ...
  ***REMOVED***;
  ...
  static uint16_t kDTLSVersions[] = ***REMOVED***
      DTLS1_VERSION, DTLS1_2_VERSION,
  ***REMOVED***;

  for (uint16_t version : kTLSVersions) ***REMOVED***
    if (!test_func(false, TLS_method(), version)) ***REMOVED***
      fprintf(stderr, "Test failed at TLS version %04x.\n", version);
      return false;
    ***REMOVED***
  ***REMOVED***

  for (uint16_t version : kDTLSVersions) ***REMOVED***
    if (!test_func(true, DTLS_method(), version)) ***REMOVED***
...
TEST(SSLTest, AddChainCertHack) ***REMOVED***
...
TEST(SSLTest, GetCertificate) ***REMOVED***
  bssl::UniquePtr<SSL_CTX> ctx(SSL_CTX_new(TLS_method()));
  ASSERT_TRUE(ctx);
  bssl::UniquePtr<X509> cert = GetTestCertificate();
  ASSERT_TRUE(cert);
...
TEST(SSLTest, AllTests) ***REMOVED***
  if (!TestCipherRules() ||
      ...
      !ForEachVersion(TestSSLWriteRetry)) ***REMOVED***
