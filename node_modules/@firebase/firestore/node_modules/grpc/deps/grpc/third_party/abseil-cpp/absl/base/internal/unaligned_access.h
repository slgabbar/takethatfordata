...
inline uint16_t UnalignedLoad16(const void *p) ***REMOVED***
  return __sanitizer_unaligned_load16(p);
***REMOVED***

inline uint32_t UnalignedLoad32(const void *p) ***REMOVED***
  return __sanitizer_unaligned_load32(p);
***REMOVED***

inline uint64_t UnalignedLoad64(const void *p) ***REMOVED***
  return __sanitizer_unaligned_load64(p);
***REMOVED***

inline void UnalignedStore16(void *p, uint16_t v) ***REMOVED***
  __sanitizer_unaligned_store16(p, v);
***REMOVED***

inline void UnalignedStore32(void *p, uint32_t v) ***REMOVED***
  __sanitizer_unaligned_store32(p, v);
***REMOVED***

inline void UnalignedStore64(void *p, uint64_t v) ***REMOVED***
...
struct Unaligned16Struct ***REMOVED***
  uint16_t value;
  uint8_t dummy;  // To make the size non-power-of-two.
***REMOVED*** ABSL_ATTRIBUTE_PACKED;

struct Unaligned32Struct ***REMOVED***
  uint32_t value;
  uint8_t dummy;  // To make the size non-power-of-two.
***REMOVED*** ABSL_ATTRIBUTE_PACKED;
...
inline void UnalignedStore64(void *p, uint64_t v) ***REMOVED*** memcpy(p, &v, sizeof v); ***REMOVED***
...
inline void UnalignedStore16(void *p, uint16_t v) ***REMOVED*** memcpy(p, &v, sizeof v); ***REMOVED***

inline void UnalignedStore32(void *p, uint32_t v) ***REMOVED*** memcpy(p, &v, sizeof v); ***REMOVED***
