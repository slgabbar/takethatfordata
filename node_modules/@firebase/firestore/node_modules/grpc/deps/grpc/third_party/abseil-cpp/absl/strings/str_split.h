...
// function:
//
//   struct SimpleDelimiter ***REMOVED***
//     const char c_;
//     explicit SimpleDelimiter(char c) : c_(c) ***REMOVED******REMOVED***
//     absl::string_view Find(absl::string_view text, size_t pos) ***REMOVED***
...
//
class ByChar ***REMOVED***
 public:
  explicit ByChar(char c) : c_(c) ***REMOVED******REMOVED***
  absl::string_view Find(absl::string_view text, size_t pos) const;
...
struct SelectDelimiter ***REMOVED***
  using type = Delimiter;
***REMOVED***;

template <>
struct SelectDelimiter<char> ***REMOVED***
  using type = ByChar;
***REMOVED***;
template <>
struct SelectDelimiter<char*> ***REMOVED***
...
***REMOVED***;
template <>
struct SelectDelimiter<const char*> ***REMOVED***
  using type = ByString;
***REMOVED***;
template <>
struct SelectDelimiter<absl::string_view> ***REMOVED***
  using type = ByString;
***REMOVED***;
template <>
struct SelectDelimiter<std::string> ***REMOVED***
  using type = ByString;
***REMOVED***;

// Wraps another delimiter and sets a max number of matches for that delimiter.
template <typename Delimiter>
class MaxSplitsImpl ***REMOVED***
 public:
  MaxSplitsImpl(Delimiter delimiter, int limit)
      : delimiter_(delimiter), limit_(limit), count_(0) ***REMOVED******REMOVED***
  absl::string_view Find(absl::string_view text, size_t pos) ***REMOVED***
    if (count_++ == limit_) ***REMOVED***
...
MaxSplits(Delimiter delimiter, int limit) ***REMOVED***
  typedef
...
struct AllowEmpty ***REMOVED***
  bool operator()(absl::string_view) const ***REMOVED*** return true; ***REMOVED***
***REMOVED***;
...
// predicate.
struct SkipEmpty ***REMOVED***
  bool operator()(absl::string_view sp) const ***REMOVED*** return !sp.empty(); ***REMOVED***
***REMOVED***;
...
//   std::vector<std::string> v = absl::StrSplit(" a , ,,b,", ',', SkipEmpty());
//   // v[0] == " a ", v[1] == " ", v[2] == "b"
struct SkipWhitespace ***REMOVED***
  bool operator()(absl::string_view sp) const ***REMOVED***
...
//   for (const auto sv : absl::StrSplit("a,b,c", ',')) ***REMOVED***
...
//   // ***REMOVED*** "a" => "b=c", "d" => "e", "f" => "", "g" => "" ***REMOVED***
//   std::map<std::string, std::string> m;
//   for (absl::string_view sp : absl::StrSplit("a=b=c,d=e,f=,g", ',')) ***REMOVED***
...
//
//   absl::StrSplit(absl::string_view(""), '-');  // ***REMOVED***""***REMOVED***
//   absl::StrSplit(absl::string_view(), '-');    // ***REMOVED******REMOVED***, but should be ***REMOVED***""***REMOVED***
//
// Try not to depend on this distinction because the bug may one day be fixed.
template <typename Delimiter>
strings_internal::Splitter<
    typename strings_internal::SelectDelimiter<Delimiter>::type, AllowEmpty>
StrSplit(strings_internal::ConvertibleToStringView text, Delimiter d) ***REMOVED***
  using DelimiterType =
      typename strings_internal::SelectDelimiter<Delimiter>::type;
