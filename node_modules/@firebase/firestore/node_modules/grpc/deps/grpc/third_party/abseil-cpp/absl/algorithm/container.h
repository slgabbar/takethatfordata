...
namespace container_algorithm_internal ***REMOVED***
...
template <typename C>
ContainerIter<C> c_begin(C& c) ***REMOVED*** return begin(c); ***REMOVED***

template <typename C>
ContainerIter<C> c_end(C& c) ***REMOVED*** return end(c); ***REMOVED***

***REMOVED***  // namespace container_algorithm_internal
...
bool c_linear_search(const C& c, EqualityComparable&& value) ***REMOVED***
...
bool c_all_of(const C& c, Pred&& pred) ***REMOVED***
...
template <typename C, typename Pred>
bool c_any_of(const C& c, Pred&& pred) ***REMOVED***
...
template <typename C, typename Pred>
bool c_none_of(const C& c, Pred&& pred) ***REMOVED***
...
decay_t<Function> c_for_each(C&& c, Function&& f) ***REMOVED***
...
container_algorithm_internal::ContainerIter<C> c_find(C& c, T&& value) ***REMOVED***
...
template <typename C, typename Pred>
container_algorithm_internal::ContainerIter<C> c_find_if(C& c, Pred&& pred) ***REMOVED***
...
container_algorithm_internal::ContainerIter<Sequence1> c_find_end(
    Sequence1& sequence, Sequence2& subsequence) ***REMOVED***
...
container_algorithm_internal::ContainerIter<Sequence1> c_find_end(
    Sequence1& sequence, Sequence2& subsequence, BinaryPredicate&& pred) ***REMOVED***
  return std::find_end(container_algorithm_internal::c_begin(sequence),
                       container_algorithm_internal::c_end(sequence),
                       container_algorithm_internal::c_begin(subsequence),
                       container_algorithm_internal::c_end(subsequence),
...
container_algorithm_internal::ContainerIter<C1> c_find_first_of(
    C1& container, C2& options, BinaryPredicate&& pred) ***REMOVED***
  return std::find_first_of(container_algorithm_internal::c_begin(container),
                            container_algorithm_internal::c_end(container),
                            container_algorithm_internal::c_begin(options),
                            container_algorithm_internal::c_end(options),
...
container_algorithm_internal::ContainerIter<Sequence> c_adjacent_find(
    Sequence& sequence, BinaryPredicate&& pred) ***REMOVED***
  return std::adjacent_find(container_algorithm_internal::c_begin(sequence),
                            container_algorithm_internal::c_end(sequence),
                            std::forward<BinaryPredicate>(pred));
***REMOVED***
...
c_mismatch(C1& c1, C2& c2) ***REMOVED***
...
std::pair<container_algorithm_internal::ContainerIter<C1>,
          container_algorithm_internal::ContainerIter<C2>>
c_mismatch(C1& c1, C2& c2, BinaryPredicate&& pred) ***REMOVED***
  return std::mismatch(container_algorithm_internal::c_begin(c1),
                       container_algorithm_internal::c_end(c1),
                       container_algorithm_internal::c_begin(c2),
                       std::forward<BinaryPredicate>(pred));
...
template <typename C1, typename C2>
bool c_equal(const C1& c1, const C2& c2) ***REMOVED***
...
// the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate>
bool c_equal(const C1& c1, const C2& c2, BinaryPredicate&& pred) ***REMOVED***
  return ((c1.size() == c2.size()) &&
          std::equal(container_algorithm_internal::c_begin(c1),
                     container_algorithm_internal::c_end(c1),
                     container_algorithm_internal::c_begin(c2),
...
template <typename C1, typename C2>
bool c_is_permutation(const C1& c1, const C2& c2) ***REMOVED***
  using std::begin;
  using std::end;
  return c1.size() == c2.size() &&
...
// `==` as the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate>
bool c_is_permutation(const C1& c1, const C2& c2, BinaryPredicate&& pred) ***REMOVED***
  using std::begin;
  using std::end;
  return c1.size() == c2.size() &&
         std::is_permutation(begin(c1), end(c1), begin(c2),
...
container_algorithm_internal::ContainerIter<Sequence> c_search_n(
    Sequence& sequence, Size count, T&& value) ***REMOVED***
...
container_algorithm_internal::ContainerIter<Sequence> c_search_n(
    Sequence& sequence, Size count, T&& value, BinaryPredicate&& pred) ***REMOVED***
  return std::search_n(container_algorithm_internal::c_begin(sequence),
                       container_algorithm_internal::c_end(sequence), count,
                       std::forward<T>(value),
                       std::forward<BinaryPredicate>(pred));
...
OutputIterator c_copy(const InputSequence& input, OutputIterator output) ***REMOVED***
...
OutputIterator c_copy_n(const C& input, Size n, OutputIterator output) ***REMOVED***
...
BidirectionalIterator c_copy_backward(const C& src,
                                      BidirectionalIterator dest) ***REMOVED***
...
OutputIterator c_move(C& src, OutputIterator dest) ***REMOVED***
...
template <typename C, typename BidirectionalIterator>
BidirectionalIterator c_move_backward(C& src, BidirectionalIterator dest) ***REMOVED***
...
template <typename C1, typename C2>
container_algorithm_internal::ContainerIter<C2> c_swap_ranges(C1& c1, C2& c2) ***REMOVED***
...
void c_replace(Sequence& sequence, const T& old_value, const T& new_value) ***REMOVED***
...
void c_replace_if(C& c, Pred&& pred, T&& new_value) ***REMOVED***
...
template <typename C, typename T>
void c_fill(C& c, T&& value) ***REMOVED***
...
void c_fill_n(C& c, Size n, T&& value) ***REMOVED***
...
void c_generate(C& c, Generator&& gen) ***REMOVED***
...
// `value`.
template <typename C, typename OutputIterator, typename T>
OutputIterator c_remove_copy(const C& c, OutputIterator result, T&& value) ***REMOVED***
...
// values.
template <typename C, typename OutputIterator>
OutputIterator c_unique_copy(const C& c, OutputIterator result) ***REMOVED***
...
template <typename Sequence>
void c_reverse(Sequence& sequence) ***REMOVED***
...
template <typename C, typename OutputIterator>
OutputIterator c_reverse_copy(const C& sequence, OutputIterator result) ***REMOVED***
...
Iterator c_rotate(C& sequence, Iterator middle) ***REMOVED***
...
void c_shuffle(RandomAccessContainer& c, UniformRandomBitGenerator&& gen) ***REMOVED***
...
template <typename C, typename Pred>
bool c_is_partitioned(const C& c, Pred&& pred) ***REMOVED***
...
template <typename C, typename Pred>
container_algorithm_internal::ContainerIter<C> c_partition(C& c, Pred&& pred) ***REMOVED***
...
void c_sort(C& c, Compare&& comp) ***REMOVED***
  std::sort(container_algorithm_internal::c_begin(c),
            container_algorithm_internal::c_end(c),
...
// of equivalents.
template <typename C>
void c_stable_sort(C& c) ***REMOVED***
...
// default `operator<`.
template <typename C, typename Compare>
void c_stable_sort(C& c, Compare&& comp) ***REMOVED***
  std::stable_sort(container_algorithm_internal::c_begin(c),
                   container_algorithm_internal::c_end(c),
                   std::forward<Compare>(comp));
***REMOVED***
...
template <typename C>
bool c_is_sorted(const C& c) ***REMOVED***
...
// default `operator<`.
template <typename C, typename Compare>
bool c_is_sorted(const C& c, Compare&& comp) ***REMOVED***
  return std::is_sorted(container_algorithm_internal::c_begin(c),
                        container_algorithm_internal::c_end(c),
                        std::forward<Compare>(comp));
***REMOVED***
...
void c_partial_sort(
    ...
    container_algorithm_internal::ContainerIter<RandomAccessContainer> middle) ***REMOVED***
...
c_partial_sort_copy(const C& sequence, RandomAccessContainer& result) ***REMOVED***
...
template <typename C>
container_algorithm_internal::ContainerIter<C> c_is_sorted_until(C& c) ***REMOVED***
...
void c_nth_element(
    RandomAccessContainer& sequence,
    container_algorithm_internal::ContainerIter<RandomAccessContainer> nth) ***REMOVED***
...
container_algorithm_internal::ContainerIter<Sequence> c_lower_bound(
    Sequence& sequence, T&& value) ***REMOVED***
...
container_algorithm_internal::ContainerIter<Sequence> c_lower_bound(
    Sequence& sequence, T&& value, Compare&& comp) ***REMOVED***
  return std::lower_bound(container_algorithm_internal::c_begin(sequence),
                          container_algorithm_internal::c_end(sequence),
...
c_equal_range(Sequence& sequence, T&& value) ***REMOVED***
...
std::pair<container_algorithm_internal::ContainerIter<Sequence>,
          container_algorithm_internal::ContainerIter<Sequence>>
c_equal_range(Sequence& sequence, T&& value, Compare&& comp) ***REMOVED***
  return std::equal_range(container_algorithm_internal::c_begin(sequence),
                          container_algorithm_internal::c_end(sequence),
                          std::forward<T>(value), std::forward<Compare>(comp));
***REMOVED***
...
// 'value'.
template <typename Sequence, typename T>
bool c_binary_search(Sequence&& sequence, T&& value) ***REMOVED***
...
// the default `operator<`.
template <typename Sequence, typename T, typename Compare>
bool c_binary_search(Sequence&& sequence, T&& value, Compare&& comp) ***REMOVED***
  return std::binary_search(container_algorithm_internal::c_begin(sequence),
                            container_algorithm_internal::c_end(sequence),
                            std::forward<T>(value),
                            std::forward<Compare>(comp));
...
OutputIterator c_merge(const C1& c1, const C2& c2, OutputIterator result) ***REMOVED***
...
void c_inplace_merge(C& c,
                     container_algorithm_internal::ContainerIter<C> middle) ***REMOVED***
...
// container `c2`.
template <typename C1, typename C2>
bool c_includes(const C1& c1, const C2& c2) ***REMOVED***
...
bool c_includes(const C1& c1, const C2& c2, Compare&& comp) ***REMOVED***
  return std::includes(container_algorithm_internal::c_begin(c1),
                       container_algorithm_internal::c_end(c1),
                       container_algorithm_internal::c_begin(c2),
                       container_algorithm_internal::c_end(c2),
...
template <typename C1, typename C2, typename OutputIterator>
OutputIterator c_set_union(const C1& c1, const C2& c2, OutputIterator output) ***REMOVED***
...
template <typename C1, typename C2, typename OutputIterator, typename Compare>
OutputIterator c_set_intersection(const C1& c1, const C2& c2,
                                  OutputIterator output, Compare&& comp) ***REMOVED***
  return std::set_intersection(container_algorithm_internal::c_begin(c1),
                               container_algorithm_internal::c_end(c1),
                               container_algorithm_internal::c_begin(c2),
                               container_algorithm_internal::c_end(c2), output,
...
template <typename RandomAccessContainer>
void c_push_heap(RandomAccessContainer& sequence) ***REMOVED***
...
// `comp` other than `operator<`.
template <typename RandomAccessContainer, typename Compare>
void c_push_heap(RandomAccessContainer& sequence, Compare&& comp) ***REMOVED***
  std::push_heap(container_algorithm_internal::c_begin(sequence),
                 container_algorithm_internal::c_end(sequence),
                 std::forward<Compare>(comp));
***REMOVED***
...
template <typename RandomAccessContainer>
void c_pop_heap(RandomAccessContainer& sequence) ***REMOVED***
...
// `comp` other than `operator<`.
template <typename RandomAccessContainer, typename Compare>
void c_pop_heap(RandomAccessContainer& sequence, Compare&& comp) ***REMOVED***
  std::pop_heap(container_algorithm_internal::c_begin(sequence),
                container_algorithm_internal::c_end(sequence),
                std::forward<Compare>(comp));
***REMOVED***
...
template <typename RandomAccessContainer>
void c_make_heap(RandomAccessContainer& sequence) ***REMOVED***
...
// `comp` other than `operator<`
template <typename RandomAccessContainer, typename Compare>
void c_make_heap(RandomAccessContainer& sequence, Compare&& comp) ***REMOVED***
  std::make_heap(container_algorithm_internal::c_begin(sequence),
                 container_algorithm_internal::c_end(sequence),
                 std::forward<Compare>(comp));
***REMOVED***
...
template <typename RandomAccessContainer>
void c_sort_heap(RandomAccessContainer& sequence) ***REMOVED***
...
// `comp` other than `operator<`
template <typename RandomAccessContainer, typename Compare>
void c_sort_heap(RandomAccessContainer& sequence, Compare&& comp) ***REMOVED***
  std::sort_heap(container_algorithm_internal::c_begin(sequence),
                 container_algorithm_internal::c_end(sequence),
                 std::forward<Compare>(comp));
***REMOVED***
...
template <typename RandomAccessContainer>
bool c_is_heap(const RandomAccessContainer& sequence) ***REMOVED***
...
// `comp` other than `operator<`
template <typename RandomAccessContainer, typename Compare>
bool c_is_heap(const RandomAccessContainer& sequence, Compare&& comp) ***REMOVED***
  return std::is_heap(container_algorithm_internal::c_begin(sequence),
                      container_algorithm_internal::c_end(sequence),
                      std::forward<Compare>(comp));
***REMOVED***
...
template <typename RandomAccessContainer>
container_algorithm_internal::ContainerIter<RandomAccessContainer>
c_is_heap_until(RandomAccessContainer& sequence) ***REMOVED***
...
template <typename RandomAccessContainer, typename Compare>
container_algorithm_internal::ContainerIter<RandomAccessContainer>
c_is_heap_until(RandomAccessContainer& sequence, Compare&& comp) ***REMOVED***
  return std::is_heap_until(container_algorithm_internal::c_begin(sequence),
                            container_algorithm_internal::c_end(sequence),
                            std::forward<Compare>(comp));
***REMOVED***
...
container_algorithm_internal::ContainerIter<Sequence> c_min_element(
    Sequence& sequence, Compare&& comp) ***REMOVED***
  return std::min_element(container_algorithm_internal::c_begin(sequence),
                          container_algorithm_internal::c_end(sequence),
                          std::forward<Compare>(comp));
***REMOVED***
...
std::pair<container_algorithm_internal::ContainerIter<C>,
          container_algorithm_internal::ContainerIter<C>>
c_minmax_element(C& c, Compare&& comp) ***REMOVED***
  return std::minmax_element(container_algorithm_internal::c_begin(c),
                             container_algorithm_internal::c_end(c),
                             std::forward<Compare>(comp));
***REMOVED***
...
// ("a-z").
template <typename Sequence1, typename Sequence2>
bool c_lexicographical_compare(Sequence1&& sequence1, Sequence2&& sequence2) ***REMOVED***
...
// permutation.
template <typename C>
bool c_next_permutation(C& c) ***REMOVED***
...
// comparison using a `comp` operator instead of `operator<`.
template <typename C, typename Compare>
bool c_next_permutation(C& c, Compare&& comp) ***REMOVED***
  return std::next_permutation(container_algorithm_internal::c_begin(c),
                               container_algorithm_internal::c_end(c),
                               std::forward<Compare>(comp));
***REMOVED***
...
// permutation.
template <typename C>
bool c_prev_permutation(C& c) ***REMOVED***
...
// comparison using a `comp` operator instead of `operator<`.
template <typename C, typename Compare>
bool c_prev_permutation(C& c, Compare&& comp) ***REMOVED***
  return std::prev_permutation(container_algorithm_internal::c_begin(c),
                               container_algorithm_internal::c_end(c),
                               std::forward<Compare>(comp));
***REMOVED***
...
template <typename Sequence, typename T>
void c_iota(Sequence& sequence, T&& value) ***REMOVED***
...
template <typename Sequence, typename T>
decay_t<T> c_accumulate(const Sequence& sequence, T&& init) ***REMOVED***
...
decay_t<T> c_inner_product(const Sequence1& factors1, const Sequence2& factors2,
                           T&& sum, BinaryOp1&& op1, BinaryOp2&& op2) ***REMOVED***
  return std::inner_product(container_algorithm_internal::c_begin(factors1),
                            container_algorithm_internal::c_end(factors1),
                            container_algorithm_internal::c_begin(factors2),
...
OutputIt c_adjacent_difference(const InputSequence& input,
                               OutputIt output_first, BinaryOp&& op) ***REMOVED***
  return std::adjacent_difference(container_algorithm_internal::c_begin(input),
                                  container_algorithm_internal::c_end(input),
...
// the sequence.
template <typename InputSequence, typename OutputIt>
OutputIt c_partial_sum(const InputSequence& input, OutputIt output_first) ***REMOVED***
