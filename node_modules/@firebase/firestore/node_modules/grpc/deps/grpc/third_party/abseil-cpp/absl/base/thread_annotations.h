...
//
//   void foo() EXCLUSIVE_LOCKS_REQUIRED(mu1, mu2) ***REMOVED*** ... ***REMOVED***;
...
namespace thread_safety_analysis ***REMOVED***

// Takes a reference to a guarded data member, and returns an unguarded
// reference.
template <typename T>
inline const T& ts_unchecked_read(const T& v) NO_THREAD_SAFETY_ANALYSIS ***REMOVED***
  return v;
***REMOVED***

template <typename T>
inline T& ts_unchecked_read(T& v) NO_THREAD_SAFETY_ANALYSIS ***REMOVED***
  return v;
***REMOVED***

***REMOVED***  // namespace thread_safety_analysis
