...
const char* int_memmatch(const char* haystack, size_t haylen,
                         const char* needle, size_t neelen) ***REMOVED***
  if (0 == neelen) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (; haystack < hayend; ++haystack) ***REMOVED***
    ...
    if (hay == nee) ***REMOVED***
      if (++needle == needleend) ***REMOVED***
        return haystack + 1 - neelen;
      ***REMOVED***
    ***REMOVED*** else if (needle != needlestart) ***REMOVED***
...
inline const char* memmem(const char* phaystack, size_t haylen,
                          const char* pneedle, size_t needlelen) ***REMOVED***
