...
static inline void StaticAnnotateIgnoreReadsBegin(const char *file, int line)
    ATTRIBUTE_IGNORE_READS_BEGIN ***REMOVED*** (void)file; (void)line; ***REMOVED***
static inline void StaticAnnotateIgnoreReadsEnd(const char *file, int line)
    ATTRIBUTE_IGNORE_READS_END ***REMOVED*** (void)file; (void)line; ***REMOVED***
static inline void StaticAnnotateIgnoreWritesBegin(
    const char *file, int line) ***REMOVED*** (void)file; (void)line; ***REMOVED***
...
template <typename T>
inline T ANNOTATE_UNPROTECTED_READ(const volatile T &x) ***REMOVED*** /* NOLINT */
  ANNOTATE_IGNORE_READS_BEGIN();
  T res = x;
  ANNOTATE_IGNORE_READS_END();
  return res;
  ***REMOVED***
  ...
  #define ANNOTATE_BENIGN_RACE_STATIC(static_var, description)        \
    namespace ***REMOVED***                                                       \
      class static_var ## _annotator ***REMOVED***                                \
       public:                                                        \
        static_var ## _annotator() ***REMOVED***                                  \
...
#define ADDRESS_SANITIZER_REDZONE(name)         \
  struct ***REMOVED*** char x[8] __attribute__ ((aligned (8))); ***REMOVED*** name
#else
#define ANNOTATE_CONTIGUOUS_CONTAINER(beg, end, old_mid, new_mid)
#define ADDRESS_SANITIZER_REDZONE(name)
