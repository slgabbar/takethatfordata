...
int bio_ip_and_port_to_socket_and_addr(int *out_sock,
  ...
  ***REMOVED***
  ...
  for (cur = result; cur; cur = cur->ai_next) ***REMOVED***
    if ((size_t) cur->ai_addrlen > sizeof(struct sockaddr_storage)) ***REMOVED***
      continue;
    ***REMOVED***
...
int bio_socket_nbio(int sock, int on) ***REMOVED***
#if defined(OPENSSL_WINDOWS)
  u_long arg = on;
...
void bio_clear_socket_error(void) ***REMOVED******REMOVED***

int bio_sock_error(int sock) ***REMOVED***
  int error;
  socklen_t error_size = sizeof(error);

  if (getsockopt(sock, SOL_SOCKET, SO_ERROR, (char *)&error, &error_size) < 0) ***REMOVED***
    return 1;
  ***REMOVED***
  return error;
***REMOVED***
