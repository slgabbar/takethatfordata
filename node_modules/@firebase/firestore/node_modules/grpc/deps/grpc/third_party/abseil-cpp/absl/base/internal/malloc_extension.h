...
class SysAllocator ***REMOVED***
 public:
  SysAllocator() ***REMOVED***
  ***REMOVED***
...
class MallocExtension ***REMOVED***
  ...
  ***REMOVED***;
  ...
  static MallocExtension* instance() ***REMOVED***
    InitModuleOnce();
  ...
  ***REMOVED***;
  ...
  // Type used by GetProperties.  See comment on GetProperties.
  enum StatLevel ***REMOVED*** kSummary, kDetailed ***REMOVED***;
 ...
 private:
  ...
  static void InitModuleOnce() ***REMOVED***
...
class MallocExtensionWriter ***REMOVED***
 public:
  virtual ~MallocExtensionWriter() ***REMOVED******REMOVED***
  virtual void Write(const char* buf, int len) = 0;
 protected:
  MallocExtensionWriter() ***REMOVED******REMOVED***
...
// preserved.
class StringMallocExtensionWriter : public MallocExtensionWriter ***REMOVED***
 public:
  explicit StringMallocExtensionWriter(std::string* out) : out_(out) ***REMOVED******REMOVED***
  virtual void Write(const char* buf, int len) ***REMOVED***
    out_->append(buf, len);
  ***REMOVED***
