...
struct PerThreadSynch ***REMOVED***
  ...
  ThreadIdentity* thread_identity() ***REMOVED***
...
struct ThreadIdentity ***REMOVED***
  ...
  struct WaiterState ***REMOVED***
    char data[128];
  ***REMOVED*** waiter_state;

  // Used by PerThreadSem::***REMOVED***Get,Set***REMOVED***ThreadBlockedCounter().
...
inline ThreadIdentity* CurrentThreadIdentityIfPresent() ***REMOVED***
