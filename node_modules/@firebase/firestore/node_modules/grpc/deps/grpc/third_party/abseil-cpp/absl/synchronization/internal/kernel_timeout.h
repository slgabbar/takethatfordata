...
// Constructible from a absl::Time (for a timeout to be respected) or ***REMOVED******REMOVED***
// (for "no timeout".)
...
class KernelTimeout ***REMOVED***
 public:
  // A timeout that should expire at <t>.  Any value, in the full
  // InfinitePast() to InfiniteFuture() range, is valid here and will be
  // respected.
  explicit KernelTimeout(absl::Time t) : ns_(MakeNs(t)) ***REMOVED******REMOVED***
  // No timeout.
  KernelTimeout() : ns_(0) ***REMOVED******REMOVED***

  // A more explicit factory for those who prefer it.  Equivalent to ***REMOVED******REMOVED***.
  static KernelTimeout Never() ***REMOVED*** return ***REMOVED******REMOVED***; ***REMOVED***

  // We explicitly do not support other custom formats: timespec, int64_t nanos.
  // Unify on this and absl::Time, please.
  bool has_timeout() const ***REMOVED*** return ns_ != 0; ***REMOVED***
 ...
 private:
  ...
  static int64_t MakeNs(absl::Time t) ***REMOVED***
  ...
  ***REMOVED***
  ...
  struct timespec MakeAbsTimespec() ***REMOVED***
    int64_t n = ns_;
    ...
    ***REMOVED***
    ...
    int64_t seconds = std::min(n / kNanosPerSecond,
                             int64_t***REMOVED***std::numeric_limits<time_t>::max()***REMOVED***);
  ...
  ***REMOVED***
  ...
  DWORD InMillisecondsFromNow() const ***REMOVED***
    if (!has_timeout()) ***REMOVED***
      return INFINITE;
    ***REMOVED***
    ...
    if (ns_ >= now) ***REMOVED***
      ...
      if (ms_from_now > std::numeric_limits<DWORD>::max()) ***REMOVED***
        return INFINITE;
      ***REMOVED***
