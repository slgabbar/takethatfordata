...
struct AlphaNumFormatterImpl ***REMOVED***
  // This template is needed in order to support passing in a dereferenced
  // vector<bool>::iterator
  template <typename T>
  void operator()(std::string* out, const T& t) const ***REMOVED***
    StrAppend(out, AlphaNum(t));
  ***REMOVED***

  void operator()(std::string* out, const AlphaNum& t) const ***REMOVED***
    StrAppend(out, t);
  ***REMOVED***
***REMOVED***;
...
class PairFormatterImpl ***REMOVED***
 public:
  PairFormatterImpl(F1 f1, absl::string_view sep, F2 f2)
      : f1_(std::move(f1)), sep_(sep), f2_(std::move(f2)) ***REMOVED******REMOVED***

  template <typename T>
  void operator()(std::string* out, const T& p) ***REMOVED***
    f1_(out, p.first);
    out->append(sep_);
    f2_(out, p.second);
  ***REMOVED***
  ...
  template <typename T>
  void operator()(std::string* out, const T& p) const ***REMOVED***
    f1_(out, p.first);
    out->append(sep_);
    f2_(out, p.second);
  ***REMOVED***
...
class DereferenceFormatterImpl ***REMOVED***
 public:
  DereferenceFormatterImpl() : f_() ***REMOVED******REMOVED***
  explicit DereferenceFormatterImpl(Formatter&& f)
      : f_(std::forward<Formatter>(f)) ***REMOVED******REMOVED***
...
struct DefaultFormatter ***REMOVED***
  typedef AlphaNumFormatterImpl Type;
***REMOVED***;
template <>
struct DefaultFormatter<const char*> ***REMOVED***
  typedef AlphaNumFormatterImpl Type;
***REMOVED***;
template <>
struct DefaultFormatter<char*> ***REMOVED***
  typedef AlphaNumFormatterImpl Type;
***REMOVED***;
template <>
struct DefaultFormatter<std::string> ***REMOVED***
  typedef NoFormatter Type;
***REMOVED***;
template <>
struct DefaultFormatter<absl::string_view> ***REMOVED***
  typedef NoFormatter Type;
***REMOVED***;
template <typename ValueType>
struct DefaultFormatter<ValueType*> ***REMOVED***
...
struct DefaultFormatter<std::unique_ptr<ValueType>>
    : public DefaultFormatter<ValueType*> ***REMOVED******REMOVED***;
...
std::string JoinAlgorithm(Iterator start, Iterator end, absl::string_view s,
  ...
  for (Iterator it = start; it != end; ++it) ***REMOVED***
...
size_t GetResultSize(Iterator, Iterator, size_t, std::input_iterator_tag) ***REMOVED***
  return 0;
***REMOVED***
...
size_t GetResultSize(Iterator it, Iterator end, size_t separator_size,
                     std::forward_iterator_tag) ***REMOVED***
  assert(it != end);
  size_t length = it->size();
  while (++it != end) ***REMOVED***
...
***REMOVED***;
template <size_t N>
struct JoinTupleLoop<N, N> ***REMOVED***
  template <typename Tup, typename Formatter>
  void operator()(std::string*, const Tup&, absl::string_view, Formatter&&) ***REMOVED******REMOVED***
***REMOVED***;
...
template <typename Iterator>
std::string JoinRange(Iterator first, Iterator last, absl::string_view separator) ***REMOVED***
...
std::string JoinRange(const Range& range, absl::string_view separator) ***REMOVED***
  using std::begin;
  using std::end;
