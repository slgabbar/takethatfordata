...
//
//   If the input character is not an ASCII ***REMOVED***lower,upper***REMOVED***-case letter (including
...
namespace ascii_internal ***REMOVED***
...
***REMOVED***  // namespace ascii_internal

// ascii_isalpha()
//
// Determines whether the given character is an alphabetic character.
inline bool ascii_isalpha(unsigned char c) ***REMOVED***
...
inline bool ascii_isalnum(unsigned char c) ***REMOVED***
...
inline bool ascii_isspace(unsigned char c) ***REMOVED***
...
inline bool ascii_ispunct(unsigned char c) ***REMOVED***
...
inline bool ascii_isblank(unsigned char c) ***REMOVED***
...
inline bool ascii_iscntrl(unsigned char c) ***REMOVED***
...
// digit character (i.e. ***REMOVED***0-9***REMOVED*** or ***REMOVED***A-F***REMOVED***).
inline bool ascii_isxdigit(unsigned char c) ***REMOVED***
...
// digit character (i.e. ***REMOVED***0-9***REMOVED***).
inline bool ascii_isdigit(unsigned char c) ***REMOVED*** return c >= '0' && c <= '9'; ***REMOVED***

// ascii_isprint()
//
// Determines whether the given character is printable, including whitespace.
inline bool ascii_isprint(unsigned char c) ***REMOVED*** return c >= 32 && c < 127; ***REMOVED***

// ascii_isgraph()
//
// Determines whether the given character has a graphical representation.
inline bool ascii_isgraph(unsigned char c) ***REMOVED*** return c > 32 && c < 127; ***REMOVED***

// ascii_isupper()
//
// Determines whether the given character is uppercase.
inline bool ascii_isupper(unsigned char c) ***REMOVED*** return c >= 'A' && c <= 'Z'; ***REMOVED***

// ascii_islower()
//
// Determines whether the given character is lowercase.
inline bool ascii_islower(unsigned char c) ***REMOVED*** return c >= 'a' && c <= 'z'; ***REMOVED***

// ascii_isascii()
//
// Determines whether the given character is ASCII.
inline bool ascii_isascii(unsigned char c) ***REMOVED*** return c < 128; ***REMOVED***

// ascii_tolower()
//
// Returns an ASCII character, converting to lowercase if uppercase is
// passed. Note that character values > 127 are simply returned.
inline char ascii_tolower(unsigned char c) ***REMOVED***
...
ABSL_MUST_USE_RESULT inline std::string AsciiStrToLower(absl::string_view s) ***REMOVED***
  std::string result(s);
...
inline char ascii_toupper(unsigned char c) ***REMOVED***
...
ABSL_MUST_USE_RESULT inline std::string AsciiStrToUpper(absl::string_view s) ***REMOVED***
  std::string result(s);
...
inline void StripTrailingAsciiWhitespace(std::string* str) ***REMOVED***
  auto it = std::find_if_not(str->rbegin(), str->rend(), absl::ascii_isspace);
...
inline void StripAsciiWhitespace(std::string* str) ***REMOVED***
