...
class AtomicHook<ReturnType (*)(Args...)> ***REMOVED***
 public:
  using FnPtr = ReturnType (*)(Args...);

  constexpr AtomicHook() : hook_(kInitialValue) ***REMOVED******REMOVED***
  ...
  ***REMOVED***
  ...
  ReturnType operator()(CallArgs&&... args) const ***REMOVED***
  ...
  ***REMOVED***
  ...
  // registered.
  FnPtr Load() const ***REMOVED***
    FnPtr ptr = DoLoad();
    return (ptr == DummyFunction) ? nullptr : ptr;
  ***REMOVED***

 private:
  static ReturnType DummyFunction(Args...) ***REMOVED***
    return ReturnType();
  ***REMOVED***
...
#define ABSL_HAVE_WORKING_ATOMIC_POINTER 1
  ...
  FnPtr DoLoad() const ***REMOVED*** return hook_.load(std::memory_order_acquire); ***REMOVED***

  // Store the given value.  Returns false if a different value was already
  // stored to this object.
  bool DoStore(FnPtr fn) ***REMOVED***
    assert(fn);
