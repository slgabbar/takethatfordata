...
inline void MallocHook::InvokeNewHook(const void* ptr, size_t size) ***REMOVED***
  if (!absl::base_internal::new_hooks_.empty()) ***REMOVED***
    InvokeNewHookSlow(ptr, size);
  ***REMOVED***
***REMOVED***

inline void MallocHook::InvokeDeleteHook(const void* ptr) ***REMOVED***
  if (!absl::base_internal::delete_hooks_.empty()) ***REMOVED***
    InvokeDeleteHookSlow(ptr);
  ***REMOVED***
***REMOVED***

inline void MallocHook::InvokeSampledNewHook(
    const SampledAlloc* sampled_alloc) ***REMOVED***
  if (!absl::base_internal::sampled_new_hooks_.empty()) ***REMOVED***
    InvokeSampledNewHookSlow(sampled_alloc);
  ***REMOVED***
***REMOVED***

inline void MallocHook::InvokeSampledDeleteHook(AllocHandle handle) ***REMOVED***
  if (!absl::base_internal::sampled_delete_hooks_.empty()) ***REMOVED***
...
inline void MallocHook::InvokePreMmapHook(const void* start,
                                          ...
                                          int flags,
                                          int fd,
                                          off_t offset) ***REMOVED***
  if (!absl::base_internal::premmap_hooks_.empty()) ***REMOVED***
...
inline void MallocHook::InvokeMmapHook(const void* result,
                                       ...
                                       int fd,
                                       off_t offset) ***REMOVED***
  if (!absl::base_internal::mmap_hooks_.empty()) ***REMOVED***
...
inline bool MallocHook::InvokeMmapReplacement(const void* start,
                                              ...
                                              off_t offset,
                                              void** result) ***REMOVED***
  if (!absl::base_internal::mmap_replacement_.empty()) ***REMOVED***
...
inline void MallocHook::InvokeMunmapHook(const void* start, size_t size) ***REMOVED***
  if (!absl::base_internal::munmap_hooks_.empty()) ***REMOVED***
    InvokeMunmapHookSlow(start, size);
  ***REMOVED***
***REMOVED***

inline bool MallocHook::InvokeMunmapReplacement(
    const void* start, size_t size, int* result) ***REMOVED***
  if (!absl::base_internal::mmap_replacement_.empty()) ***REMOVED***
...
inline void MallocHook::InvokeMremapHook(const void* result,
                                         ...
                                         size_t new_size,
                                         int flags,
                                         const void* new_addr) ***REMOVED***
  if (!absl::base_internal::mremap_hooks_.empty()) ***REMOVED***
    InvokeMremapHookSlow(result, old_addr, old_size, new_size, flags, new_addr);
  ***REMOVED***
***REMOVED***

inline void MallocHook::InvokePreSbrkHook(ptrdiff_t increment) ***REMOVED***
  if (!absl::base_internal::presbrk_hooks_.empty() && increment != 0) ***REMOVED***
    InvokePreSbrkHookSlow(increment);
  ***REMOVED***
***REMOVED***

inline void MallocHook::InvokeSbrkHook(const void* result,
                                       ptrdiff_t increment) ***REMOVED***
  if (!absl::base_internal::sbrk_hooks_.empty() && increment != 0) ***REMOVED***
