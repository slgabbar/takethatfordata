...
// Example:
//
// std::string html_escaped = absl::StrReplaceAll(user_input, ***REMOVED***
//                                           ***REMOVED***"&", "&amp;"***REMOVED***,
//                                           ***REMOVED***"<", "&lt;"***REMOVED***,
//                                           ***REMOVED***">", "&gt;"***REMOVED***,
//                                           ***REMOVED***"\"", "&quot;"***REMOVED***,
...
//                                  ***REMOVED******REMOVED***"$count", absl::StrCat(5)***REMOVED***,
//                                   ***REMOVED***"$who", "Bob"***REMOVED***,
//                                   ***REMOVED***"#Noun", "Apples"***REMOVED******REMOVED***);
...
//   replacements.push_back(***REMOVED***"&", "&amp;"***REMOVED***);
//   replacements.push_back(***REMOVED***"<", "&lt;"***REMOVED***);
//   replacements.push_back(***REMOVED***">", "&gt;"***REMOVED***);
...
//   int count;
//   count = absl::StrReplaceAll(***REMOVED******REMOVED***"$count", absl::StrCat(5)***REMOVED***,
//                               ***REMOVED***"$who", "Bob"***REMOVED***,
//                               ***REMOVED***"#Noun", "Apples"***REMOVED******REMOVED***, &s);
//  EXPECT_EQ(count, 4);
//  EXPECT_EQ("Bob bought 5 Apples. Thanks Bob!", s);
int StrReplaceAll(
    std::initializer_list<std::pair<absl::string_view, absl::string_view>>
...
//   int count = absl::StrReplaceAll(***REMOVED******REMOVED***"&", "&amp;"***REMOVED***,
//                                    ***REMOVED***"<", "&lt;"***REMOVED***,
//                                    ***REMOVED***">", "&gt;"***REMOVED******REMOVED***, &s);
//  EXPECT_EQ(count, 2);
//  EXPECT_EQ("if (ptr &lt; &amp;foo)", s);
template <typename StrToStrMapping>
...
struct ViableSubstitution ***REMOVED***
  ...
  ViableSubstitution(absl::string_view old_str,
      ...
      : old(old_str), replacement(replacement_str), offset(offset_val) ***REMOVED******REMOVED***
  ...
  bool OccursBefore(const ViableSubstitution& y) const ***REMOVED***
...
std::vector<ViableSubstitution> FindSubstitutions(
    absl::string_view s, const StrToStrMapping& replacements) ***REMOVED***
  std::vector<ViableSubstitution> subs;
  subs.reserve(replacements.size());

  for (const auto& rep : replacements) ***REMOVED***
    using std::get;
    ...
    while (--index && subs[index - 1].OccursBefore(subs[index])) ***REMOVED***
...
template <typename StrToStrMapping>
std::string StrReplaceAll(absl::string_view s, const StrToStrMapping& replacements) ***REMOVED***
...
template <typename StrToStrMapping>
int StrReplaceAll(const StrToStrMapping& replacements, std::string* target) ***REMOVED***
