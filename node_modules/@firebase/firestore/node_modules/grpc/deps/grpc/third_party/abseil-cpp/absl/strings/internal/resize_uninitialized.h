...
struct HasResizeUninitialized : std::false_type ***REMOVED******REMOVED***;
template <typename T>
...
void ResizeUninit(string_type* s, size_t new_size, std::true_type) ***REMOVED***
  s->resize_uninitialized(new_size);
***REMOVED***
template <typename string_type>
void ResizeUninit(string_type* s, size_t new_size, std::false_type) ***REMOVED***
  s->resize(new_size);
***REMOVED***
...
template <typename string_type>
inline constexpr bool STLStringSupportsNontrashingResize(string_type*) ***REMOVED***
...
inline void STLStringResizeUninitialized(string_type* s, size_t new_size) ***REMOVED***
