...
static void PrintDataHex(const void *data, size_t len) ***REMOVED***
...
static bool TestPBKDF2(const void *password, size_t password_len,
                       ...
                       const uint8_t *expected_key) ***REMOVED***
  uint8_t key[64];

  if (key_len > sizeof(key)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (OPENSSL_memcmp(key, expected_key, key_len) != 0) ***REMOVED***
...
static bool TestEmptyPassword() ***REMOVED***
  const uint8_t kKey[] = ***REMOVED***0xa3, 0x3d, 0xdd, 0xc3, 0x04, 0x78, 0x18,
                          0x55, 0x15, 0x31, 0x1f, 0x87, 0x52, 0x89,
                          0x5d, 0x36, 0xea, 0x43, 0x63, 0xa2***REMOVED***;

  if (!TestPBKDF2(NULL, 0, "salt", 4, 1, EVP_sha1(), sizeof(kKey), kKey) ||
      !TestPBKDF2("", 0, "salt", 4, 1, EVP_sha1(), sizeof(kKey), kKey)) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestEmptySalt() ***REMOVED***
  const uint8_t kKey[] = ***REMOVED***0x8b, 0xc2, 0xf9, 0x16, 0x7a, 0x81, 0xcd, 0xcf,
                          0xad, 0x12, 0x35, 0xcd, 0x90, 0x47, 0xf1, 0x13,
                          0x62, 0x71, 0xc1, 0xf9, 0x78, 0xfc, 0xfc, 0xb3,
                          0x5e, 0x22, 0xdb, 0xea, 0xfa, 0x46, 0x34, 0xf6***REMOVED***;

  if (!TestPBKDF2("password", 8, NULL, 0, 2, EVP_sha256(), sizeof(kKey),
                  kKey) ||
      !TestPBKDF2("password", 8, "", 0, 2, EVP_sha256(), sizeof(kKey), kKey)) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestRFC6070Vectors() ***REMOVED***
  const uint8_t kKey1[] = ***REMOVED***0x0c, 0x60, 0xc8, 0x0f, 0x96, 0x1f, 0x0e,
                           0x71, 0xf3, 0xa9, 0xb5, 0x24, 0xaf, 0x60,
                           0x12, 0x06, 0x2f, 0xe0, 0x37, 0xa6***REMOVED***;
  const uint8_t kKey2[] = ***REMOVED***0xea, 0x6c, 0x01, 0x4d, 0xc7, 0x2d, 0x6f,
                           0x8c, 0xcd, 0x1e, 0xd9, 0x2a, 0xce, 0x1d,
                           0x41, 0xf0, 0xd8, 0xde, 0x89, 0x57***REMOVED***;
  const uint8_t kKey3[] = ***REMOVED***0x56, 0xfa, 0x6a, 0xa7, 0x55, 0x48, 0x09, 0x9d,
                           0xcc, 0x37, 0xd7, 0xf0, 0x34, 0x25, 0xe0, 0xc3***REMOVED***;
...
static bool TestSHA2() ***REMOVED***
  // This test was taken from:
  // http://stackoverflow.com/questions/5130513/pbkdf2-hmac-sha2-test-vectors.
  const uint8_t kKey1[] = ***REMOVED***0xae, 0x4d, 0x0c, 0x95, 0xaf, 0x6b, 0x46, 0xd3,
                           0x2d, 0x0a, 0xdf, 0xf9, 0x28, 0xf0, 0x6d, 0xd0,
                           0x2a, 0x30, 0x3f, 0x8e, 0xf3, 0xc2, 0x51, 0xdf,
                           0xd6, 0xe2, 0xd8, 0x5a, 0x95, 0x47, 0x4c, 0x43***REMOVED***;

  // This test was taken from:
  // http://stackoverflow.com/questions/15593184/pbkdf2-hmac-sha-512-test-vectors.
  const uint8_t kKey2[] = ***REMOVED***
      ...
      0x2b, 0xd4, 0xda, 0xea, 0x97, 0x24, 0xa3, 0xd3, 0xb8***REMOVED***;
  ...
  if (!TestPBKDF2("password", 8, "salt", 4, 2, EVP_sha256(), sizeof(kKey1),
      ...
      !TestPBKDF2("passwordPASSWORDpassword", 24,
                  ...
                  EVP_sha512(), sizeof(kKey2), kKey2)) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestZeroIterations() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (PKCS5_PBKDF2_HMAC(kPassword, password_len, kSalt, salt_len,
                        0 /* iterations */, digest, key_len, key)) ***REMOVED***
...
int main(void) ***REMOVED***
  ...
  if (!TestEmptyPassword()) ***REMOVED***
    fprintf(stderr, "TestEmptyPassword failed\n");
    return 1;
  ***REMOVED***

  if (!TestEmptySalt()) ***REMOVED***
    fprintf(stderr, "TestEmptySalt failed\n");
    return 1;
  ***REMOVED***

  if (!TestRFC6070Vectors()) ***REMOVED***
