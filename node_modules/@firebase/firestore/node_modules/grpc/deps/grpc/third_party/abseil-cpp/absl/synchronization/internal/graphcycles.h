...
struct GraphId ***REMOVED***
  uint64_t handle;

  bool operator==(const GraphId& x) const ***REMOVED*** return handle == x.handle; ***REMOVED***
  bool operator!=(const GraphId& x) const ***REMOVED*** return handle != x.handle; ***REMOVED***
***REMOVED***;

// Return an invalid graph id that will never be assigned by GraphCycles.
inline GraphId InvalidGraphId() ***REMOVED***
  return GraphId***REMOVED***0***REMOVED***;
***REMOVED***

class GraphCycles ***REMOVED***
 public:
  GraphCycles();
  ~GraphCycles();
