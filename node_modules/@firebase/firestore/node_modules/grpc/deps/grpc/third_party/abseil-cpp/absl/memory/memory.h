...
template <typename T>
std::unique_ptr<T> WrapUnique(T* ptr) ***REMOVED***
  static_assert(!std::is_array<T>::value, "array types are unsupported");
  static_assert(std::is_object<T>::value, "non-object types are unsupported");
  return std::unique_ptr<T>(ptr);
***REMOVED***

namespace memory_internal ***REMOVED***

// Traits to select proper overload and return type for `absl::make_unique<>`.
template <typename T>
struct MakeUniqueResult ***REMOVED***
  using scalar = std::unique_ptr<T>;
***REMOVED***;
template <typename T>
struct MakeUniqueResult<T[]> ***REMOVED***
  using array = std::unique_ptr<T[]>;
***REMOVED***;
template <typename T, size_t N>
struct MakeUniqueResult<T[N]> ***REMOVED***
  using invalid = void;
***REMOVED***;

***REMOVED***  // namespace memory_internal
...
template <typename T>
typename memory_internal::MakeUniqueResult<T>::array make_unique(size_t n) ***REMOVED***
...
template <typename T>
auto RawPtr(T&& ptr) -> decltype(&*ptr) ***REMOVED***
  // ptr is a forwarding reference to support Ts with non-const operators.
  return (ptr != nullptr) ? &*ptr : nullptr;
***REMOVED***
inline std::nullptr_t RawPtr(std::nullptr_t) ***REMOVED*** return nullptr; ***REMOVED***
...
std::shared_ptr<T> ShareUniquePtr(std::unique_ptr<T, D>&& ptr) ***REMOVED***
...
//
template <typename T>
std::weak_ptr<T> WeakenPtr(const std::shared_ptr<T>& ptr) ***REMOVED***
...
template <template <typename> class Extract, typename Obj, typename Default,
          typename>
struct ExtractOr ***REMOVED***
  using type = Default;
***REMOVED***;

template <template <typename> class Extract, typename Obj, typename Default>
struct ExtractOr<Extract, Obj, Default, void_t<Extract<Obj>>> ***REMOVED***
...
struct GetFirstArg<Class<T, Args...>> ***REMOVED***
  using type = T;
***REMOVED***;
...
template <typename T>
struct ElementType<T, void_t<typename T::element_type>> ***REMOVED***
...
template <template <typename...> class Class, typename T, typename... Args,
          typename U>
struct RebindFirstArg<Class<T, Args...>, U> ***REMOVED***
  using type = Class<U, Args...>;
***REMOVED***;

template <typename T, typename U, typename = void>
struct RebindPtr ***REMOVED***
  using type = typename RebindFirstArg<T, U>::type;
***REMOVED***;

template <typename T, typename U>
struct RebindPtr<T, U, void_t<typename T::template rebind<U>>> ***REMOVED***
  using type = typename T::template rebind<U>;
***REMOVED***;

template <typename T, typename U, typename = void>
struct RebindAlloc ***REMOVED***
  using type = typename RebindFirstArg<T, U>::type;
***REMOVED***;

template <typename T, typename U>
struct RebindAlloc<T, U, void_t<typename T::template rebind<U>::other>> ***REMOVED***
...
struct pointer_traits ***REMOVED***
  ...
  static pointer pointer_to(element_type& r) ***REMOVED***  // NOLINT(runtime/references)
...
template <typename T>
struct pointer_traits<T*> ***REMOVED***
  using pointer = T*;
  ...
  static pointer pointer_to(
      element_type& r) noexcept ***REMOVED***  // NOLINT(runtime/references)
...
struct allocator_traits ***REMOVED***
  ...
  ***REMOVED***
  ...
  static pointer allocate(Alloc& a, size_type n,  // NOLINT(runtime/references)
                          const_void_pointer hint) ***REMOVED***
  ...
  ***REMOVED***
  ...
  template <typename T>
  static void destroy(Alloc& a, T* p) ***REMOVED***  // NOLINT(runtime/references)
    destroy_impl(0, a, p);
  ***REMOVED***
  ...
  static size_type max_size(const Alloc& a) ***REMOVED*** return max_size_impl(0, a); ***REMOVED***

  // select_on_container_copy_construction(const Alloc& a):
  // Returns a.select_on_container_copy_construction() if possible.
  // If not possible, returns a.
  static Alloc select_on_container_copy_construction(const Alloc& a) ***REMOVED***
 ...
 private:
  ...
  static auto allocate_impl(int, A& a,  // NOLINT(runtime/references)
      ...
      -> decltype(a.allocate(n, hint)) ***REMOVED***
    return a.allocate(n, hint);
  ***REMOVED***
  static pointer allocate_impl(char, Alloc& a,  // NOLINT(runtime/references)
                               size_type n, const_void_pointer) ***REMOVED***
    return a.allocate(n);
  ***REMOVED***
  ...
  static auto construct_impl(int, A& a,  // NOLINT(runtime/references)
                             Args&&... args)
      -> decltype(a.construct(std::forward<Args>(args)...)) ***REMOVED***
    a.construct(std::forward<Args>(args)...);
  ***REMOVED***

  template <typename T, typename... Args>
  static void construct_impl(char, Alloc&, T* p, Args&&... args) ***REMOVED***
    ::new (static_cast<void*>(p)) T(std::forward<Args>(args)...);
  ***REMOVED***

  template <typename A, typename T>
  static auto destroy_impl(int, A& a,  // NOLINT(runtime/references)
                           T* p) -> decltype(a.destroy(p)) ***REMOVED***
    a.destroy(p);
  ***REMOVED***
  template <typename T>
  static void destroy_impl(char, Alloc&, T* p) ***REMOVED***
    p->~T();
  ***REMOVED***

  template <typename A>
  static auto max_size_impl(int, const A& a) -> decltype(a.max_size()) ***REMOVED***
    return a.max_size();
  ***REMOVED***
  static size_type max_size_impl(char, const Alloc&) ***REMOVED***
    return std::numeric_limits<size_type>::max() / sizeof(value_type);
  ***REMOVED***

  template <typename A>
  static auto select_on_container_copy_construction_impl(int, const A& a)
      -> decltype(a.select_on_container_copy_construction()) ***REMOVED***
    return a.select_on_container_copy_construction();
  ***REMOVED***
  static Alloc select_on_container_copy_construction_impl(char,
                                                          const Alloc& a) ***REMOVED***
    return a;
  ***REMOVED***
***REMOVED***;
...
struct allocator_is_nothrow
    : memory_internal::ExtractOrT<memory_internal::GetIsNothrow, Alloc,
                                  std::false_type> ***REMOVED******REMOVED***;

#if ABSL_ALLOCATOR_NOTHROW
template <typename T>
struct allocator_is_nothrow<std::allocator<T>> : std::true_type ***REMOVED******REMOVED***;
struct default_allocator_is_nothrow : std::true_type ***REMOVED******REMOVED***;
#else
struct default_allocator_is_nothrow : std::false_type ***REMOVED******REMOVED***;
#endif
