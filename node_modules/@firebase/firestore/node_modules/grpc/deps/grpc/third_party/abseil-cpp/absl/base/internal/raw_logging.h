...
#define ABSL_RAW_CHECK(condition, message)                             \
  do ***REMOVED***                                                                 \
    if (ABSL_PREDICT_FALSE(!(condition))) ***REMOVED***                            \
...
namespace raw_logging_internal ***REMOVED***
...
constexpr const char* Basename(const char* fname, int offset) ***REMOVED***
...
***REMOVED***  // namespace raw_logging_internal
