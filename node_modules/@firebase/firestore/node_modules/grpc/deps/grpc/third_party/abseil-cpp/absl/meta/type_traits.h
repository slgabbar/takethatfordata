...
namespace type_traits_internal ***REMOVED***
template <typename... Ts>
struct VoidTImpl ***REMOVED***
  using type = void;
***REMOVED***;
...
struct default_alignment_of_aligned_storage<Len,
                                            std::aligned_storage<Len, Align>> ***REMOVED***
  static constexpr size_t value = Align;
***REMOVED***;

***REMOVED***  // namespace type_traits_internal
...
struct conjunction<T, Ts...>
    : std::conditional<T::value, conjunction<Ts...>, T>::type ***REMOVED******REMOVED***;

template <typename T>
struct conjunction<T> : T ***REMOVED******REMOVED***;

template <>
struct conjunction<> : std::true_type ***REMOVED******REMOVED***;
...
struct disjunction<T, Ts...> :
      std::conditional<T::value, T, disjunction<Ts...>>::type ***REMOVED******REMOVED***;

template <typename T>
struct disjunction<T> : T ***REMOVED******REMOVED***;

template <>
struct disjunction<> : std::false_type ***REMOVED******REMOVED***;
...
template <typename T>
struct negation : std::integral_constant<bool, !T::value> ***REMOVED******REMOVED***;
...
struct is_trivially_destructible
    : std::integral_constant<bool, __has_trivial_destructor(T) &&
                                       std::is_destructible<T>::value> ***REMOVED***
...
struct is_trivially_default_constructible
    : std::integral_constant<bool,
                             __has_trivial_constructor(T) &&
                                 ...
                                 is_trivially_destructible<T>::value> ***REMOVED***
...
struct is_trivially_copy_assignable
    : std::integral_constant<bool, __has_trivial_assign(T) &&
                                       std::is_copy_assignable<T>::value> ***REMOVED***
