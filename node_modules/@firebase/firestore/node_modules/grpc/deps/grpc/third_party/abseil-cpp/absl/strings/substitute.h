...
namespace substitute_internal ***REMOVED***
...
class Arg ***REMOVED***
 public:
  ...
  Arg(char value)  // NOLINT(runtime/explicit)
      : piece_(scratch_, 1) ***REMOVED*** scratch_[0] = value; ***REMOVED***
  Arg(short value)  // NOLINT(runtime/explicit)
      : piece_(scratch_,
               numbers_internal::FastIntToBuffer(value, scratch_) - scratch_) ***REMOVED******REMOVED***
  ...
  Arg(float value)  // NOLINT(runtime/explicit)
      : piece_(scratch_, numbers_internal::SixDigitsToBuffer(value, scratch_)) ***REMOVED***
  ***REMOVED***
  Arg(double value)  // NOLINT(runtime/explicit)
      : piece_(scratch_, numbers_internal::SixDigitsToBuffer(value, scratch_)) ***REMOVED***
  ***REMOVED***
  Arg(bool value)  // NOLINT(runtime/explicit)
      : piece_(value ? "true" : "false") ***REMOVED******REMOVED***
...
constexpr int CalculateOneBit(const char* format) ***REMOVED***
  return (*format < '0' || *format > '9') ? 0 : (1 << (*format - '0'));
***REMOVED***

constexpr const char* SkipNumber(const char* format) ***REMOVED***
  return !*format ? format : (format + 1);
***REMOVED***

constexpr int PlaceholderBitmask(const char* format) ***REMOVED***
...
***REMOVED***  // namespace substitute_internal
...
//  ***REMOVED***
//
inline void SubstituteAndAppend(std::string* output, absl::string_view format) ***REMOVED***
  substitute_internal::SubstituteAndAppendArray(output, format, nullptr, 0);
***REMOVED***

inline void SubstituteAndAppend(std::string* output, absl::string_view format,
                                const substitute_internal::Arg& a0) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece()***REMOVED***;
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
                                ...
                                const substitute_internal::Arg& a1) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
                                ...
                                const substitute_internal::Arg& a2) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece(), a2.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
                                ...
                                const substitute_internal::Arg& a3) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece(), a2.piece(),
                                    a3.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
                                ...
                                const substitute_internal::Arg& a4) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece(), a2.piece(),
                                    a3.piece(), a4.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
                                ...
                                const substitute_internal::Arg& a5) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece(), a2.piece(),
                                    a3.piece(), a4.piece(), a5.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
                                ...
                                const substitute_internal::Arg& a6) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece(), a2.piece(),
...
inline void SubstituteAndAppend(
    ...
    const substitute_internal::Arg& a6, const substitute_internal::Arg& a7) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece(), a2.piece(),
                                    a3.piece(), a4.piece(), a5.piece(),
                                    a6.piece(), a7.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(
    ...
    const substitute_internal::Arg& a8) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***a0.piece(), a1.piece(), a2.piece(),
                                    a3.piece(), a4.piece(), a5.piece(),
                                    a6.piece(), a7.piece(), a8.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(
    ...
    const substitute_internal::Arg& a4, const substitute_internal::Arg& a5,
    const substitute_internal::Arg& a6, const substitute_internal::Arg& a7,
    const substitute_internal::Arg& a8, const substitute_internal::Arg& a9) ***REMOVED***
  const absl::string_view args[] = ***REMOVED***
      a0.piece(), a1.piece(), a2.piece(), a3.piece(), a4.piece(),
      a5.piece(), a6.piece(), a7.piece(), a8.piece(), a9.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
// Example:
//  template <typename... Args>
//  void VarMsg(absl::string_view format, const Args&... args) ***REMOVED***
//    std::string s = absl::Substitute(format, args...);

ABSL_MUST_USE_RESULT inline std::string Substitute(absl::string_view format) ***REMOVED***
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    absl::string_view format, const substitute_internal::Arg& a0) ***REMOVED***
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    absl::string_view format, const substitute_internal::Arg& a0,
    const substitute_internal::Arg& a1, const substitute_internal::Arg& a2) ***REMOVED***
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    absl::string_view format, const substitute_internal::Arg& a0,
    const substitute_internal::Arg& a1, const substitute_internal::Arg& a2,
    const substitute_internal::Arg& a3, const substitute_internal::Arg& a4) ***REMOVED***
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    ...
    const substitute_internal::Arg& a1, const substitute_internal::Arg& a2,
    const substitute_internal::Arg& a3, const substitute_internal::Arg& a4,
    const substitute_internal::Arg& a5, const substitute_internal::Arg& a6) ***REMOVED***
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    ...
    const substitute_internal::Arg& a3, const substitute_internal::Arg& a4,
    const substitute_internal::Arg& a5, const substitute_internal::Arg& a6,
    const substitute_internal::Arg& a7) ***REMOVED***
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    ...
    const substitute_internal::Arg& a3, const substitute_internal::Arg& a4,
    const substitute_internal::Arg& a5, const substitute_internal::Arg& a6,
    const substitute_internal::Arg& a7, const substitute_internal::Arg& a8) ***REMOVED***
  std::string result;
...
ABSL_MUST_USE_RESULT inline std::string Substitute(
    ...
    const substitute_internal::Arg& a5, const substitute_internal::Arg& a6,
    const substitute_internal::Arg& a7, const substitute_internal::Arg& a8,
    const substitute_internal::Arg& a9) ***REMOVED***
  std::string result;
