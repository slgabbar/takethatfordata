...
static grpc_error* slice_buffer_stream_pull(grpc_exec_ctx* exec_ctx,
                                            ...
                                            grpc_slice* slice) ***REMOVED***
  grpc_slice_buffer_stream* stream = (grpc_slice_buffer_stream*)byte_stream;
  if (stream->shutdown_error != GRPC_ERROR_NONE) ***REMOVED***
...
static const grpc_byte_stream_vtable slice_buffer_stream_vtable = ***REMOVED***
    slice_buffer_stream_next, slice_buffer_stream_pull,
    slice_buffer_stream_shutdown, slice_buffer_stream_destroy***REMOVED***;
...
void grpc_byte_stream_cache_init(grpc_byte_stream_cache* cache,
                                 grpc_byte_stream* underlying_stream) ***REMOVED***
...
void grpc_byte_stream_cache_destroy(grpc_exec_ctx* exec_ctx,
                                    grpc_byte_stream_cache* cache) ***REMOVED***
...
static grpc_error* caching_byte_stream_pull(grpc_exec_ctx* exec_ctx,
  ...
  if (stream->shutdown_error != GRPC_ERROR_NONE) ***REMOVED***
    return GRPC_ERROR_REF(stream->shutdown_error);
  ***REMOVED***
  if (stream->cursor < stream->cache->cache_buffer.count) ***REMOVED***
...
static const grpc_byte_stream_vtable caching_byte_stream_vtable = ***REMOVED***
    caching_byte_stream_next, caching_byte_stream_pull,
    caching_byte_stream_shutdown, caching_byte_stream_destroy***REMOVED***;
...
void grpc_caching_byte_stream_reset(grpc_caching_byte_stream* stream) ***REMOVED***
  stream->cursor = 0;
***REMOVED***
