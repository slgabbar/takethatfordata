...
typedef struct gpr_mpscq_node ***REMOVED***
  gpr_atm next;
***REMOVED*** gpr_mpscq_node;

// Actual queue type
typedef struct gpr_mpscq ***REMOVED***
  gpr_atm head;
...
typedef struct gpr_locked_mpscq ***REMOVED***
  gpr_mpscq queue;
  gpr_mu mu;
***REMOVED*** gpr_locked_mpscq;
