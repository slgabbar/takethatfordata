...
typedef enum ***REMOVED***
  ...
  GRPC_JSON_STATE_END
***REMOVED*** grpc_json_reader_state;
...
typedef struct grpc_json_reader_vtable ***REMOVED***
...
***REMOVED*** grpc_json_reader_vtable;

typedef struct grpc_json_reader ***REMOVED***
...
***REMOVED*** grpc_json_reader_status;
