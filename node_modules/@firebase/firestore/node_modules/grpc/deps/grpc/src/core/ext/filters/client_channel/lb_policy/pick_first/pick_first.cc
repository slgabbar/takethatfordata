...
***REMOVED*** pick_first_lb_policy;

static void pf_destroy(grpc_exec_ctx* exec_ctx, grpc_lb_policy* pol) ***REMOVED***
  ...
  if (grpc_lb_pick_first_trace.enabled()) ***REMOVED***
...
static void pf_shutdown_locked(grpc_exec_ctx* exec_ctx, grpc_lb_policy* pol) ***REMOVED***
...
static void start_picking_locked(grpc_exec_ctx* exec_ctx,
                                 pick_first_lb_policy* p) ***REMOVED***
  p->started_picking = true;
  if (p->subchannel_list != nullptr &&
      p->subchannel_list->num_subchannels > 0) ***REMOVED***
...
static void pf_exit_idle_locked(grpc_exec_ctx* exec_ctx, grpc_lb_policy* pol) ***REMOVED***
  pick_first_lb_policy* p = (pick_first_lb_policy*)pol;
...
static void pf_update_locked(grpc_exec_ctx* exec_ctx, grpc_lb_policy* policy,
  ...
  ***REMOVED*** else ***REMOVED***
    ...
    for (size_t i = 0; i < subchannel_list->num_subchannels; ++i) ***REMOVED***
      ...
      if (sd->subchannel == p->selected->subchannel) ***REMOVED***
        ...
        ***REMOVED***
        if (p->selected->connected_subchannel != nullptr) ***REMOVED***
...
static void pf_connectivity_changed_locked(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  ***REMOVED***
  ...
  if (p->selected == sd) ***REMOVED***
    ...
    if (sd->curr_connectivity_state != GRPC_CHANNEL_READY &&
        p->latest_pending_subchannel_list != nullptr) ***REMOVED***
      p->selected = nullptr;
      grpc_lb_subchannel_list_shutdown_and_unref(
    ...
    ***REMOVED*** else ***REMOVED***
      if (sd->curr_connectivity_state == GRPC_CHANNEL_TRANSIENT_FAILURE) ***REMOVED***
  ...
  ***REMOVED***
  ...
  switch (sd->curr_connectivity_state) ***REMOVED***
    case GRPC_CHANNEL_READY: ***REMOVED***
      // Case 2.  Promote p->latest_pending_subchannel_list to
      // p->subchannel_list.
      if (sd->subchannel_list == p->latest_pending_subchannel_list) ***REMOVED***
        GPR_ASSERT(p->subchannel_list != nullptr);
        grpc_lb_subchannel_list_shutdown_and_unref(exec_ctx, p->subchannel_list,
                                                   "finish_update");
        p->subchannel_list = p->latest_pending_subchannel_list;
    ...
    ***REMOVED***
    case GRPC_CHANNEL_TRANSIENT_FAILURE: ***REMOVED***
      ...
      ***REMOVED*** while (sd->subchannel == nullptr);
      // Case 1: Only set state to TRANSIENT_FAILURE if we've tried
      // all subchannels.
      if (sd->subchannel_list->checking_subchannel == 0 &&
          sd->subchannel_list == p->subchannel_list) ***REMOVED***
        grpc_connectivity_state_set(
            exec_ctx, &p->state_tracker, GRPC_CHANNEL_TRANSIENT_FAILURE,
    ...
    ***REMOVED***
    ...
    case GRPC_CHANNEL_IDLE: ***REMOVED***
      ...
      ***REMOVED***
      ...
      break;
    ***REMOVED***
    case GRPC_CHANNEL_SHUTDOWN: ***REMOVED***
      grpc_lb_subchannel_data_stop_connectivity_watch(exec_ctx, sd);
      grpc_lb_subchannel_data_unref_subchannel(exec_ctx, sd,
      ...
      do ***REMOVED***
        ...
        sd = &sd->subchannel_list
                  ->subchannels[sd->subchannel_list->checking_subchannel];
      ***REMOVED*** while (sd->subchannel == nullptr && sd != original_sd);
      if (sd == original_sd) ***REMOVED***
        grpc_lb_subchannel_list_unref_for_connectivity_watch(
...
static const grpc_lb_policy_vtable pick_first_lb_policy_vtable = ***REMOVED***
    pf_destroy,
    pf_shutdown_locked,
    pf_pick_locked,
    ...
    pf_update_locked***REMOVED***;

static void pick_first_factory_ref(grpc_lb_policy_factory* factory) ***REMOVED******REMOVED***

static void pick_first_factory_unref(grpc_lb_policy_factory* factory) ***REMOVED******REMOVED***
...
static const grpc_lb_policy_factory_vtable pick_first_factory_vtable = ***REMOVED***
    pick_first_factory_ref, pick_first_factory_unref, create_pick_first,
    "pick_first"***REMOVED***;

static grpc_lb_policy_factory pick_first_lb_policy_factory = ***REMOVED***
    &pick_first_factory_vtable***REMOVED***;

static grpc_lb_policy_factory* pick_first_lb_factory_create() ***REMOVED***
  return &pick_first_lb_policy_factory;
***REMOVED***

/* Plugin registration */

extern "C" void grpc_lb_policy_pick_first_init() ***REMOVED***
  grpc_register_lb_policy(pick_first_lb_factory_create());
***REMOVED***

extern "C" void grpc_lb_policy_pick_first_shutdown() ***REMOVED******REMOVED***
