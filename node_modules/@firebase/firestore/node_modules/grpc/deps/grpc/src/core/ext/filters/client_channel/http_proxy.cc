 ...
 */
static char* get_http_proxy_server(grpc_exec_ctx* exec_ctx, char** user_cred) ***REMOVED***
  ...
  if (uri == nullptr || uri->authority == nullptr) ***REMOVED***
    gpr_log(GPR_ERROR, "cannot parse value of 'http_proxy' env var");
    goto done;
  ***REMOVED***
  if (strcmp(uri->scheme, "http") != 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (authority_nstrs == 1) ***REMOVED***
    /* User cred not present in authority */
    proxy_name = authority_strs[0];
  ***REMOVED*** else if (authority_nstrs == 2) ***REMOVED***
    /* User cred found */
  ...
  ***REMOVED*** else ***REMOVED***
    /* Bad authority */
    for (size_t i = 0; i < authority_nstrs; i++) ***REMOVED***
...
static bool proxy_mapper_map_name(grpc_exec_ctx* exec_ctx,
  ...
  *name_to_resolve = get_http_proxy_server(exec_ctx, &user_cred);
  ...
  if (uri == nullptr || uri->path[0] == '\0') ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  if (no_proxy_str != nullptr) ***REMOVED***
    ...
    ***REMOVED*** else ***REMOVED***
      ...
      gpr_string_split(no_proxy_str, NO_PROXY_SEPARATOR, &no_proxy_hosts,
                       &num_no_proxy_hosts);
      for (size_t i = 0; i < num_no_proxy_hosts; i++) ***REMOVED***
...
static void proxy_mapper_destroy(grpc_proxy_mapper* mapper) ***REMOVED******REMOVED***

static const grpc_proxy_mapper_vtable proxy_mapper_vtable = ***REMOVED***
    proxy_mapper_map_name, proxy_mapper_map_address, proxy_mapper_destroy***REMOVED***;

static grpc_proxy_mapper proxy_mapper = ***REMOVED***&proxy_mapper_vtable***REMOVED***;

void grpc_register_http_proxy_mapper() ***REMOVED***
