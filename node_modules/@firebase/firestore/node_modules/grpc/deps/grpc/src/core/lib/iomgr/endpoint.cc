...
void grpc_endpoint_destroy(grpc_exec_ctx* exec_ctx, grpc_endpoint* ep) ***REMOVED***
  ep->vtable->destroy(exec_ctx, ep);
***REMOVED***

char* grpc_endpoint_get_peer(grpc_endpoint* ep) ***REMOVED***
  return ep->vtable->get_peer(ep);
***REMOVED***

int grpc_endpoint_get_fd(grpc_endpoint* ep) ***REMOVED*** return ep->vtable->get_fd(ep); ***REMOVED***

grpc_resource_user* grpc_endpoint_get_resource_user(grpc_endpoint* ep) ***REMOVED***
