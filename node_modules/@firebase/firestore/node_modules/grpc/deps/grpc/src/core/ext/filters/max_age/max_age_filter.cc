...
#define MAX_CONNECTION_AGE_INTEGER_OPTIONS \
  ***REMOVED*** DEFAULT_MAX_CONNECTION_AGE_MS, 1, INT_MAX ***REMOVED***
#define MAX_CONNECTION_IDLE_INTEGER_OPTIONS \
  ***REMOVED*** DEFAULT_MAX_CONNECTION_IDLE_MS, 1, INT_MAX ***REMOVED***
...
static void increase_call_count(grpc_exec_ctx* exec_ctx, channel_data* chand) ***REMOVED***
  if (gpr_atm_full_fetch_add(&chand->call_count, 1) == 0) ***REMOVED***
...
static void decrease_call_count(grpc_exec_ctx* exec_ctx, channel_data* chand) ***REMOVED***
  if (gpr_atm_full_fetch_add(&chand->call_count, -1) == 1) ***REMOVED***
...
static void channel_connectivity_changed(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  ***REMOVED*** else ***REMOVED***
    gpr_mu_lock(&chand->max_age_timer_mu);
    if (chand->max_age_timer_pending) ***REMOVED***
      grpc_timer_cancel(exec_ctx, &chand->max_age_timer);
      chand->max_age_timer_pending = false;
    ***REMOVED***
    if (chand->max_age_grace_timer_pending) ***REMOVED***
...
static grpc_millis
add_random_max_connection_age_jitter_and_convert_to_grpc_millis(int value) ***REMOVED***
...
static grpc_error* init_channel_elem(grpc_exec_ctx* exec_ctx,
  ...
  for (size_t i = 0; i < args->channel_args->num_args; ++i) ***REMOVED***
    if (0 == strcmp(args->channel_args->args[i].key,
                    GRPC_ARG_MAX_CONNECTION_AGE_MS)) ***REMOVED***
      const int value = grpc_channel_arg_get_integer(
          &args->channel_args->args[i], MAX_CONNECTION_AGE_INTEGER_OPTIONS);
      chand->max_connection_age =
          add_random_max_connection_age_jitter_and_convert_to_grpc_millis(
              value);
    ***REMOVED*** else if (0 == strcmp(args->channel_args->args[i].key,
                           GRPC_ARG_MAX_CONNECTION_AGE_GRACE_MS)) ***REMOVED***
      const int value = grpc_channel_arg_get_integer(
          &args->channel_args->args[i],
          ***REMOVED***DEFAULT_MAX_CONNECTION_AGE_GRACE_MS, 0, INT_MAX***REMOVED***);
      chand->max_connection_age_grace =
          value == INT_MAX ? GRPC_MILLIS_INF_FUTURE : value;
    ***REMOVED*** else if (0 == strcmp(args->channel_args->args[i].key,
                           GRPC_ARG_MAX_CONNECTION_IDLE_MS)) ***REMOVED***
      const int value = grpc_channel_arg_get_integer(
  ...
  ***REMOVED***
  ...
  if (chand->max_connection_age != GRPC_MILLIS_INF_FUTURE) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (chand->max_connection_idle != GRPC_MILLIS_INF_FUTURE) ***REMOVED***
    GRPC_CHANNEL_STACK_REF(chand->channel_stack,
                           "max_age start_max_idle_timer_after_init");
...
const grpc_channel_filter grpc_max_age_filter = ***REMOVED***
    grpc_call_next_op,
    grpc_channel_next_op,
    0, /* sizeof_call_data */
    init_call_elem,
...
extern "C" void grpc_max_age_filter_init(void) ***REMOVED***
  grpc_channel_init_register_stage(GRPC_SERVER_CHANNEL,
                                   GRPC_CHANNEL_INIT_BUILTIN_PRIORITY,
                                   maybe_add_max_age_filter, nullptr);
***REMOVED***

extern "C" void grpc_max_age_filter_shutdown(void) ***REMOVED******REMOVED***
