...
static struct timespec timespec_from_gpr(gpr_timespec gts) ***REMOVED***
  struct timespec rv;
  if (sizeof(time_t) < sizeof(int64_t)) ***REMOVED***
...
static gpr_timespec gpr_from_timespec(struct timespec ts,
                                      gpr_clock_type clock_type) ***REMOVED***
  /*
...
static const clockid_t clockid_for_gpr_clock[] = ***REMOVED***CLOCK_MONOTONIC,
                                                  CLOCK_REALTIME***REMOVED***;

void gpr_time_init(void) ***REMOVED*** gpr_precise_clock_init(); ***REMOVED***

static gpr_timespec now_impl(gpr_clock_type clock_type) ***REMOVED***
  struct timespec now;
  GPR_ASSERT(clock_type != GPR_TIMESPAN);
  if (clock_type == GPR_CLOCK_PRECISE) ***REMOVED***
    gpr_timespec ret;
...
void gpr_time_init(void) ***REMOVED***
  mach_timebase_info_data_t tb = ***REMOVED***0, 1***REMOVED***;
...
static gpr_timespec now_impl(gpr_clock_type clock) ***REMOVED***
  gpr_timespec now;
...
gpr_timespec gpr_now(gpr_clock_type clock_type) ***REMOVED***
#ifdef GPR_LOW_LEVEL_COUNTERS
...
void gpr_sleep_until(gpr_timespec until) ***REMOVED***
  gpr_timespec now;
  gpr_timespec delta;
  ...
  for (;;) ***REMOVED***
    ...
    if (gpr_time_cmp(until, now) <= 0) ***REMOVED***
      return;
    ***REMOVED***
