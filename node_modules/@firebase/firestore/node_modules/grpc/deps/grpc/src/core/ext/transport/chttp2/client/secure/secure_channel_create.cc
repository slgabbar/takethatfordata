...
static void client_channel_factory_ref(
    grpc_client_channel_factory* cc_factory) ***REMOVED******REMOVED***

static void client_channel_factory_unref(
    grpc_exec_ctx* exec_ctx, grpc_client_channel_factory* cc_factory) ***REMOVED******REMOVED***

static grpc_subchannel_args* get_secure_naming_subchannel_args(
    grpc_exec_ctx* exec_ctx, const grpc_subchannel_args* args) ***REMOVED***
  grpc_channel_credentials* channel_credentials =
      grpc_channel_credentials_find_in_args(args->args);
  if (channel_credentials == nullptr) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  if (grpc_security_connector_find_in_args(args->args) != nullptr) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  if (targets_info != nullptr) ***REMOVED***  // LB channel
    ...
    if (target_uri->path[0] != '\0') ***REMOVED***  // "path" may be empty
    ...
    ***REMOVED***
    if (target_name_to_check == nullptr) ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED***  // regular channel: the secure name is the original server URI.
    target_name_to_check = gpr_strdup(server_uri_path);
  ***REMOVED***
  ...
  if (security_status != GRPC_SECURITY_OK) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  GRPC_SECURITY_CONNECTOR_UNREF(exec_ctx, &subchannel_security_connector->base,
                                "lb_channel_create");
  if (new_args_from_connector != nullptr) ***REMOVED***
...
static grpc_subchannel* client_channel_factory_create_subchannel(
  ...
  if (subchannel_args == nullptr) ***REMOVED***
    gpr_log(
        GPR_ERROR,
...
static grpc_channel* client_channel_factory_create_channel(
  ...
  ***REMOVED***
  ...
  const char* to_remove[] = ***REMOVED***GRPC_ARG_SERVER_URI***REMOVED***;
...
static const grpc_client_channel_factory_vtable client_channel_factory_vtable =
    ***REMOVED***client_channel_factory_ref, client_channel_factory_unref,
     client_channel_factory_create_subchannel,
     client_channel_factory_create_channel***REMOVED***;

static grpc_client_channel_factory client_channel_factory = ***REMOVED***
    &client_channel_factory_vtable***REMOVED***;
...
grpc_channel* grpc_secure_channel_create(grpc_channel_credentials* creds,
  ...
  if (creds != nullptr) ***REMOVED***
    // Add channel args containing the client channel factory and channel
    // credentials.
    grpc_arg args_to_add[] = ***REMOVED***
        grpc_client_channel_factory_create_channel_arg(&client_channel_factory),
        grpc_channel_credentials_to_arg(creds)***REMOVED***;
    grpc_channel_args* new_args = grpc_channel_args_copy_and_add(
