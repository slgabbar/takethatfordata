...
static grpc_stream_compression_context identity_ctx = ***REMOVED***
    &grpc_stream_compression_identity_vtable***REMOVED***;

static void grpc_stream_compression_pass_through(grpc_slice_buffer* in,
                                                 grpc_slice_buffer* out,
                                                 size_t* output_size,
                                                 size_t max_output_size) ***REMOVED***
  if (max_output_size >= in->length) ***REMOVED***
...
const grpc_stream_compression_vtable grpc_stream_compression_identity_vtable = ***REMOVED***
    grpc_stream_compress_identity, grpc_stream_decompress_identity,
    grpc_stream_compression_context_create_identity,
    grpc_stream_compression_context_destroy_identity***REMOVED***;
