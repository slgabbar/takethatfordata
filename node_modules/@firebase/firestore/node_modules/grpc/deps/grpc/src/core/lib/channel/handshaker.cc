...
void grpc_handshaker_shutdown(grpc_exec_ctx* exec_ctx,
                              grpc_handshaker* handshaker, grpc_error* why) ***REMOVED***
...
struct grpc_handshake_manager ***REMOVED***
  gpr_mu mu;
  gpr_refcount refs;
  bool shutdown;
...
grpc_handshake_manager* grpc_handshake_manager_create() ***REMOVED***
...
void grpc_handshake_manager_pending_list_add(grpc_handshake_manager** head,
                                             grpc_handshake_manager* mgr) ***REMOVED***
...
void grpc_handshake_manager_pending_list_remove(grpc_handshake_manager** head,
                                                grpc_handshake_manager* mgr) ***REMOVED***
  if (mgr->next != nullptr) ***REMOVED***
    mgr->next->prev = mgr->prev;
  ***REMOVED***
  if (mgr->prev != nullptr) ***REMOVED***
...
void grpc_handshake_manager_pending_list_shutdown_all(
    grpc_exec_ctx* exec_ctx, grpc_handshake_manager* head, grpc_error* why) ***REMOVED***
...
static bool is_power_of_2(size_t n) ***REMOVED*** return (n & (n - 1)) == 0; ***REMOVED***
...
void grpc_handshake_manager_add(grpc_handshake_manager* mgr,
  ...
  if (mgr->count == 0) ***REMOVED***
    realloc_count = 2;
  ***REMOVED*** else if (mgr->count >= 2 && is_power_of_2(mgr->count)) ***REMOVED***
    realloc_count = mgr->count * 2;
  ***REMOVED***
  if (realloc_count > 0) ***REMOVED***
...
static void grpc_handshake_manager_unref(grpc_exec_ctx* exec_ctx,
                                         grpc_handshake_manager* mgr) ***REMOVED***
  if (gpr_unref(&mgr->refs)) ***REMOVED***
    for (size_t i = 0; i < mgr->count; ++i) ***REMOVED***
...
void grpc_handshake_manager_shutdown(grpc_exec_ctx* exec_ctx,
  ...
  if (!mgr->shutdown && mgr->index > 0) ***REMOVED***
    mgr->shutdown = true;
...
static void on_timeout(grpc_exec_ctx* exec_ctx, void* arg, grpc_error* error) ***REMOVED***
  grpc_handshake_manager* mgr = (grpc_handshake_manager*)arg;
  if (error == GRPC_ERROR_NONE) ***REMOVED***  // Timer fired, rather than being cancelled.
...
void grpc_handshake_manager_do_handshake(
    ...
    grpc_iomgr_cb_func on_handshake_done, void* user_data) ***REMOVED***
  gpr_mu_lock(&mgr->mu);
