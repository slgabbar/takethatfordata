...
class BdpEstimator ***REMOVED***
 public:
  explicit BdpEstimator(const char* name);
  ~BdpEstimator() ***REMOVED******REMOVED***

  int64_t EstimateBdp() const ***REMOVED*** return estimate_; ***REMOVED***
  double EstimateBandwidth() const ***REMOVED*** return bw_est_; ***REMOVED***

  void AddIncomingBytes(int64_t num_bytes) ***REMOVED*** accumulator_ += num_bytes; ***REMOVED***

  // Schedule a ping: call in response to receiving a true from
  // grpc_bdp_estimator_add_incoming_bytes once a ping has been scheduled by a
  // transport (but not necessarily started)
  void SchedulePing() ***REMOVED***
    if (grpc_bdp_estimator_trace.enabled()) ***REMOVED***
 ...
 private:
  enum class PingState ***REMOVED*** UNSCHEDULED, SCHEDULED, STARTED ***REMOVED***;
