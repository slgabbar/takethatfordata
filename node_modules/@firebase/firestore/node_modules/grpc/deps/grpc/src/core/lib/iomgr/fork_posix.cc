...
void grpc_prefork() ***REMOVED***
  if (!grpc_fork_support_enabled()) ***REMOVED***
    ...
    return;
  ***REMOVED***
  if (grpc_is_initialized()) ***REMOVED***
    ...
    if (!gpr_await_threads(
            gpr_time_add(gpr_now(GPR_CLOCK_REALTIME),
                         gpr_time_from_seconds(3, GPR_TIMESPAN)))) ***REMOVED***
      gpr_log(GPR_ERROR, "gRPC thread still active! Cannot fork!");
    ***REMOVED***
  ***REMOVED***
***REMOVED***

void grpc_postfork_parent() ***REMOVED***
  if (grpc_is_initialized()) ***REMOVED***
...
void grpc_postfork_child() ***REMOVED***
  if (grpc_is_initialized()) ***REMOVED***
    grpc_timer_manager_set_threading(true);
    grpc_exec_ctx exec_ctx = GRPC_EXEC_CTX_INIT;
    grpc_executor_set_threading(&exec_ctx, true);
...
void grpc_fork_handlers_auto_register() ***REMOVED***
  if (grpc_fork_support_enabled()) ***REMOVED***
