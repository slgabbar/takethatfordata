...
grpc_channel* grpc_lb_policy_grpclb_create_lb_channel(
    ...
    grpc_channel_args* args) ***REMOVED***
  ...
  if (channel_credentials != nullptr) ***REMOVED***
    ...
    static const char* keys_to_remove[] = ***REMOVED***GRPC_ARG_CHANNEL_CREDENTIALS***REMOVED***;
    grpc_channel_credentials* creds_sans_call_creds =
        grpc_channel_credentials_duplicate_without_call_credentials(
            channel_credentials);
    GPR_ASSERT(creds_sans_call_creds != nullptr);
    grpc_arg args_to_add[] = ***REMOVED***
        grpc_channel_credentials_to_arg(creds_sans_call_creds)***REMOVED***;
...
grpc_channel_args* grpc_lb_policy_grpclb_build_lb_channel_args(
  ...
  const grpc_arg to_add[] = ***REMOVED***
      grpc_lb_targets_info_create_channel_arg(targets_info),
      grpc_fake_resolver_response_generator_arg(response_generator)***REMOVED***;
  /* We remove:
   *
  ...
  static const char* keys_to_remove[] = ***REMOVED***
      GRPC_ARG_LB_POLICY_NAME, GRPC_ARG_LB_ADDRESSES, GRPC_ARG_SERVER_URI,
      GRPC_ARG_FAKE_RESOLVER_RESPONSE_GENERATOR***REMOVED***;
