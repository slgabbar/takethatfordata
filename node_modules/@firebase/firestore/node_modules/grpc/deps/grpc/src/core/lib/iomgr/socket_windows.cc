...
grpc_winsocket* grpc_winsocket_create(SOCKET socket, const char* name) ***REMOVED***
  char* final_name;
...
void grpc_winsocket_shutdown(grpc_winsocket* winsocket) ***REMOVED***
  ...
  if (winsocket->shutdown_called) ***REMOVED***
...
static void destroy(grpc_winsocket* winsocket) ***REMOVED***
  grpc_iomgr_unregister_object(&winsocket->iomgr_object);
  gpr_mu_destroy(&winsocket->state_mu);
  gpr_free(winsocket);
***REMOVED***

static bool check_destroyable(grpc_winsocket* winsocket) ***REMOVED***
  return winsocket->destroy_called == true &&
         winsocket->write_info.closure == NULL &&
         winsocket->read_info.closure == NULL;
***REMOVED***

void grpc_winsocket_destroy(grpc_winsocket* winsocket) ***REMOVED***
  gpr_mu_lock(&winsocket->state_mu);
...
static void socket_notify_on_iocp(grpc_exec_ctx* exec_ctx,
                                  ...
                                  grpc_winsocket_callback_info* info) ***REMOVED***
  GPR_ASSERT(info->closure == NULL);
  gpr_mu_lock(&socket->state_mu);
  if (info->has_pending_iocp) ***REMOVED***
