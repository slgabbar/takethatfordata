...
typedef struct grpc_closure_list ***REMOVED***
  grpc_closure* head;
  grpc_closure* tail;
***REMOVED*** grpc_closure_list;
...
typedef struct grpc_closure_scheduler_vtable ***REMOVED***
...
inline grpc_closure* grpc_closure_init(const char* file, int line,
                                       ...
                                       grpc_closure_scheduler* scheduler) ***REMOVED***
#else
...
namespace closure_impl ***REMOVED***

typedef struct ***REMOVED***
  grpc_iomgr_cb_func cb;
  void* cb_arg;
  grpc_closure wrapper;
***REMOVED*** wrapped_closure;
...
***REMOVED***  // namespace closure_impl
...
inline void grpc_closure_list_init(grpc_closure_list* closure_list) ***REMOVED***
...
inline void grpc_closure_list_fail_all(grpc_closure_list* list,
                                       grpc_error* forced_failure) ***REMOVED***
  for (grpc_closure* c = list->head; c != nullptr; c = c->next_data.next) ***REMOVED***
    if (c->error_data.error == GRPC_ERROR_NONE) ***REMOVED***
...
inline void grpc_closure_list_move(grpc_closure_list* src,
                                   grpc_closure_list* dst) ***REMOVED***
  if (src->head == nullptr) ***REMOVED***
    return;
  ***REMOVED***
  if (dst->head == nullptr) ***REMOVED***
    *dst = *src;
  ***REMOVED*** else ***REMOVED***
...
inline bool grpc_closure_list_empty(grpc_closure_list closure_list) ***REMOVED***
...
inline void grpc_closure_list_sched(const char* file, int line,
                                    ...
                                    grpc_closure_list* list) ***REMOVED***
#else
