...
struct grpc_lb_policy_factory ***REMOVED***
...
typedef struct grpc_lb_address ***REMOVED***
  grpc_resolved_address address;
  bool is_balancer;
  char* balancer_name; /* For secure naming. */
  void* user_data;
***REMOVED*** grpc_lb_address;

typedef struct grpc_lb_user_data_vtable ***REMOVED***
  void* (*copy)(void*);
  void (*destroy)(grpc_exec_ctx* exec_ctx, void*);
  int (*cmp)(void*, void*);
***REMOVED*** grpc_lb_user_data_vtable;

typedef struct grpc_lb_addresses ***REMOVED***
  size_t num_addresses;
  grpc_lb_address* addresses;
  const grpc_lb_user_data_vtable* user_data_vtable;
***REMOVED*** grpc_lb_addresses;
...
struct grpc_lb_policy_args ***REMOVED***
  grpc_client_channel_factory* client_channel_factory;
  grpc_channel_args* args;
  grpc_combiner* combiner;
***REMOVED***;

struct grpc_lb_policy_factory_vtable ***REMOVED***
