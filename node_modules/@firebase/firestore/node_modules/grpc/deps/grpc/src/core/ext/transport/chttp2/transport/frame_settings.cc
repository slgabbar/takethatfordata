      ...
      case GRPC_CHTTP2_SPS_ID0:
        if (cur == end) ***REMOVED***
          ...
          if (is_last) ***REMOVED***
            ...
            if (t->notify_on_receive_settings != nullptr) ***REMOVED***
        ...
        if (grpc_wire_id_to_setting_id(parser->id, &id)) ***REMOVED***
          ...
          ***REMOVED***
          if (id == GRPC_CHTTP2_SETTINGS_INITIAL_WINDOW_SIZE &&
            ...
            if (grpc_http_trace.enabled() || grpc_flowctl_trace.enabled()) ***REMOVED***
          ...
          ***REMOVED***
          ...
          if (grpc_http_trace.enabled()) ***REMOVED***
            gpr_log(GPR_DEBUG, "CHTTP2:%s:%s: got setting %s = %d",
                    ...
                    parser->value);
          ***REMOVED***
        ***REMOVED*** else if (grpc_http_trace.enabled()) ***REMOVED***
