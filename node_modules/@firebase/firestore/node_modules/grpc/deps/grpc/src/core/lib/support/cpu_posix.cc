...
static void init_ncpus() ***REMOVED***
  ncpus = sysconf(_SC_NPROCESSORS_ONLN);
  if (ncpus < 1 || ncpus > INT32_MAX) ***REMOVED***
    gpr_log(GPR_ERROR, "Cannot determine number of CPUs: assuming 1");
    ncpus = 1;
  ***REMOVED***
***REMOVED***

unsigned gpr_cpu_num_cores(void) ***REMOVED***
  static gpr_once once = GPR_ONCE_INIT;
  gpr_once_init(&once, init_ncpus);
  return (unsigned)ncpus;
***REMOVED***

static void delete_thread_id(void* value) ***REMOVED***
  if (value) ***REMOVED***
    gpr_free(value);
  ***REMOVED***
***REMOVED***

static void init_thread_id_key(void) ***REMOVED***
  pthread_key_create(&thread_id_key, delete_thread_id);
***REMOVED***

unsigned gpr_cpu_current_cpu(void) ***REMOVED***
