...
typedef struct ***REMOVED***
  ...
  size_t count;
  size_t capacity;
***REMOVED*** grpc_auth_property_array;

struct grpc_auth_context ***REMOVED***
...
typedef struct ***REMOVED***
  void* instance;
  void (*destroy)(void*);
***REMOVED*** grpc_security_context_extension;
...
***REMOVED*** grpc_client_security_context;
...
typedef struct ***REMOVED***
  grpc_auth_context* auth_context;
  grpc_security_context_extension extension;
***REMOVED*** grpc_server_security_context;
