...
static void ssl_log_where_info(const SSL* ssl, int where, int flag,
  ...
  if ((where & flag) && tsi_tracing_enabled.enabled()) ***REMOVED***
...
static tsi_result ssl_get_x509_common_name(X509* cert, unsigned char** utf8,
  ...
  if (subject_name == nullptr) ***REMOVED***
...
static tsi_result peer_from_x509(X509* cert, int include_certificate_type,
  ...
  ***REMOVED*** while (0);
  ...
  if (subject_alt_names != nullptr) ***REMOVED***
...
static tsi_result ssl_ctx_use_certificate_chain(SSL_CTX* context,
  ...
  do ***REMOVED***
    ...
    if (certificate == nullptr) ***REMOVED***
    ...
    ***REMOVED***
    while (1) ***REMOVED***
      ...
      if (certificate_authority == nullptr) ***REMOVED***
        ERR_clear_error();
        break; /* Done reading. */
      ***REMOVED***
...
static tsi_result ssl_ctx_use_private_key(SSL_CTX* context, const char* pem_key,
  ...
  do ***REMOVED***
    ...
    if (private_key == nullptr) ***REMOVED***
      result = TSI_INVALID_ARGUMENT;
      break;
    ***REMOVED***
...
static tsi_result populate_ssl_context(
  ...
  tsi_result result = TSI_OK;
  if (key_cert_pair != nullptr) ***REMOVED***
    if (key_cert_pair->cert_chain != nullptr) ***REMOVED***
      ...
      ***REMOVED***
    ***REMOVED***
    if (key_cert_pair->private_key != nullptr) ***REMOVED***
  ...
  ***REMOVED***
  if ((cipher_list != nullptr) &&
      !SSL_CTX_set_cipher_list(context, cipher_list)) ***REMOVED***
...
static void tsi_ssl_handshaker_factory_destroy(
  ...
  if (self->vtable != nullptr && self->vtable->destroy != nullptr) ***REMOVED***
...
static tsi_ssl_handshaker_factory_vtable handshaker_factory_vtable = ***REMOVED***nullptr***REMOVED***;
...
static tsi_result ssl_handshaker_process_bytes_from_peer(
  ...
  if (bytes == nullptr || bytes_size == nullptr || *bytes_size > INT_MAX) ***REMOVED***
    return TSI_INVALID_ARGUMENT;
  ***REMOVED***
  GPR_ASSERT(*bytes_size <= INT_MAX);
...
static tsi_result ssl_handshaker_extract_peer(tsi_handshaker* self,
  ...
  ***REMOVED***
  ...
  if (alpn_selected == nullptr) ***REMOVED***
    /* Try npn. */
...
static tsi_result ssl_handshaker_create_frame_protector(
  ...
  if (max_output_protected_frame_size != nullptr) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (protector_impl->buffer == nullptr) ***REMOVED***
    gpr_log(GPR_ERROR,
...
static tsi_result create_tsi_ssl_handshaker(SSL_CTX* ctx, int is_client,
  ...
  ***REMOVED***
  ...
  if (into_ssl == nullptr || from_ssl == nullptr) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (is_client) ***REMOVED***
    ...
    if (server_name_indication != nullptr) ***REMOVED***
...
static void tsi_ssl_server_handshaker_factory_destroy(
  ...
  for (i = 0; i < self->ssl_context_count; i++) ***REMOVED***
    if (self->ssl_contexts[i] != nullptr) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (self->ssl_context_x509_subject_names != nullptr) ***REMOVED***
...
static int does_entry_match_name(const char* entry, size_t entry_length,
  ...
  ***REMOVED***
  ...
  if ((dot == nullptr) || (dot == &name_subdomain[name_subdomain_length - 1])) ***REMOVED***
...
static int ssl_server_handshaker_factory_servername_callback(SSL* ssl, int* ap,
  ...
  if (servername == nullptr || strlen(servername) == 0) ***REMOVED***
    return SSL_TLSEXT_ERR_NOACK;
  ***REMOVED***
...
tsi_result tsi_create_ssl_client_handshaker_factory(
  ...
  *factory = nullptr;
  ...
  if (ssl_context == nullptr) ***REMOVED***
...
tsi_result tsi_create_ssl_server_handshaker_factory_ex(
  ...
  if (factory == nullptr) return TSI_INVALID_ARGUMENT;
  *factory = nullptr;
  if (num_key_cert_pairs == 0 || pem_key_cert_pairs == nullptr) ***REMOVED***
    return TSI_INVALID_ARGUMENT;
  ***REMOVED***
  ...
  if (impl->ssl_contexts == nullptr ||
      impl->ssl_context_x509_subject_names == nullptr) ***REMOVED***
    tsi_ssl_handshaker_factory_unref(&impl->base);
    return TSI_OUT_OF_RESOURCES;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (i = 0; i < num_key_cert_pairs; i++) ***REMOVED***
    do ***REMOVED***
      ...
      if (impl->ssl_contexts[i] == nullptr) ***REMOVED***
        gpr_log(GPR_ERROR, "Could not create ssl context.");
        result = TSI_OUT_OF_RESOURCES;
        break;
      ***REMOVED***
      ...
      if (pem_client_root_certs != nullptr) ***REMOVED***
...
int tsi_ssl_peer_matches_name(const tsi_peer* peer, const char* name) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (san_count == 0 && cn_property != nullptr && !like_ip) ***REMOVED***
