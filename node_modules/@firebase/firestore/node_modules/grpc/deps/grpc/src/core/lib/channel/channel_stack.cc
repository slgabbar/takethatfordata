...
/* Memory layouts.
   ...
   Channel stack is laid out as: ***REMOVED***
   ...
   ***REMOVED***
   ...
   Call stack is laid out as: ***REMOVED***
     grpc_call_stack stk;
     padding to GPR_MAX_ALIGNMENT
...
size_t grpc_channel_stack_size(const grpc_channel_filter** filters,
  ...
  for (i = 0; i < filter_count; i++) ***REMOVED***
...
grpc_channel_element* grpc_channel_stack_element(
    grpc_channel_stack* channel_stack, size_t index) ***REMOVED***
  return CHANNEL_ELEMS_FROM_STACK(channel_stack) + index;
***REMOVED***

grpc_channel_element* grpc_channel_stack_last_element(
    grpc_channel_stack* channel_stack) ***REMOVED***
...
grpc_error* grpc_channel_stack_init(
    ...
    const char* name, grpc_channel_stack* stack) ***REMOVED***
  size_t call_size =
      ROUND_UP_TO_ALIGNMENT_SIZE(sizeof(grpc_call_stack)) +
  ...
  for (i = 0; i < filter_count; i++) ***REMOVED***
    ...
    if (error != GRPC_ERROR_NONE) ***REMOVED***
      if (first_error == GRPC_ERROR_NONE) ***REMOVED***
        first_error = error;
...
void grpc_channel_stack_destroy(grpc_exec_ctx* exec_ctx,
                                grpc_channel_stack* stack) ***REMOVED***
...
grpc_error* grpc_call_stack_init(grpc_exec_ctx* exec_ctx,
                                 ...
                                 void* destroy_arg,
                                 const grpc_call_element_args* elem_args) ***REMOVED***
...
void grpc_call_stack_ignore_set_pollset_or_pollset_set(
    ...
    grpc_polling_entity* pollent) ***REMOVED******REMOVED***
...
grpc_call_stack* grpc_call_stack_from_top_element(grpc_call_element* elem) ***REMOVED***
