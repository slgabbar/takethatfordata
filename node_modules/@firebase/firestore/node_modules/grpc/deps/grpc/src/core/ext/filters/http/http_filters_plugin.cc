...
***REMOVED*** optional_filter;

static optional_filter compress_filter = ***REMOVED***
    &grpc_message_compress_filter, GRPC_ARG_ENABLE_PER_MESSAGE_COMPRESSION***REMOVED***;
...
extern "C" void grpc_http_filters_init(void) ***REMOVED***
...
extern "C" void grpc_http_filters_shutdown(void) ***REMOVED******REMOVED***
