...
grpc_millis BdpEstimator::CompletePing(grpc_exec_ctx* exec_ctx) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (accumulator_ > 2 * estimate_ / 3 && bw > bw_est_) ***REMOVED***
  ...
  ***REMOVED*** else if (inter_ping_delay_ < 10000) ***REMOVED***
    stable_estimate_count_++;
    if (stable_estimate_count_ >= 2) ***REMOVED***
      inter_ping_delay_ +=
          100 +
    ...
    ***REMOVED***
  ***REMOVED***
  if (start_inter_ping_delay != inter_ping_delay_) ***REMOVED***
    stable_estimate_count_ = 0;
    if (grpc_bdp_estimator_trace.enabled()) ***REMOVED***
