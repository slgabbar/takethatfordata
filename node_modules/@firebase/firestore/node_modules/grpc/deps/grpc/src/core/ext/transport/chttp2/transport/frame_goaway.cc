...
void grpc_chttp2_goaway_parser_init(grpc_chttp2_goaway_parser* p) ***REMOVED***
  p->debug_data = nullptr;
***REMOVED***

void grpc_chttp2_goaway_parser_destroy(grpc_chttp2_goaway_parser* p) ***REMOVED***
...
void grpc_chttp2_goaway_append(uint32_t last_stream_id, uint32_t error_code,
                               ...
                               grpc_slice_buffer* slice_buffer) ***REMOVED***
