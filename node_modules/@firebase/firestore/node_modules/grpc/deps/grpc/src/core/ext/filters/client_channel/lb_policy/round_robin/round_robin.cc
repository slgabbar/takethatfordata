...
static size_t get_next_ready_subchannel_index_locked(
  ...
  if (grpc_lb_round_robin_trace.enabled()) ***REMOVED***
    gpr_log(GPR_INFO,
...
static void shutdown_locked(grpc_exec_ctx* exec_ctx, round_robin_lb_policy* p,
  ...
  ***REMOVED***
  p->shutdown = true;
  pending_pick* pp;
  while ((pp = p->pending_picks) != nullptr) ***REMOVED***
...
static void update_state_counters_locked(grpc_lb_subchannel_data* sd) ***REMOVED***
...
static grpc_connectivity_state update_lb_connectivity_status_locked(
    grpc_exec_ctx* exec_ctx, grpc_lb_subchannel_data* sd, grpc_error* error) ***REMOVED***
    ...
    if (sd->curr_connectivity_state == GRPC_CHANNEL_READY) ***REMOVED***
      ...
      ***REMOVED***
      ...
      grpc_lb_subchannel_data* selected =
          &p->subchannel_list->subchannels[next_ready_index];
      if (p->pending_picks != nullptr) ***REMOVED***
      ...
      ***REMOVED***
      ...
      while ((pp = p->pending_picks)) ***REMOVED***
        ...
        *pp->target = GRPC_CONNECTED_SUBCHANNEL_REF(
        ...
        if (pp->user_data != nullptr) ***REMOVED***
...
static void rr_update_locked(grpc_exec_ctx* exec_ctx, grpc_lb_policy* policy,
  ...
  ***REMOVED***
  ...
  if (subchannel_list->num_subchannels == 0) ***REMOVED***
    grpc_connectivity_state_set(
        exec_ctx, &p->state_tracker, GRPC_CHANNEL_TRANSIENT_FAILURE,
...
extern "C" void grpc_lb_policy_round_robin_init() ***REMOVED***
  grpc_register_lb_policy(round_robin_lb_factory_create());
***REMOVED***

extern "C" void grpc_lb_policy_round_robin_shutdown() ***REMOVED******REMOVED***
