...
static void dns_ares_shutdown_locked(grpc_exec_ctx* exec_ctx,
  ...
  ***REMOVED***
  if (r->pending_request != nullptr) ***REMOVED***
    grpc_cancel_ares_request(exec_ctx, r->pending_request);
  ***REMOVED***
  if (r->next_completion != nullptr) ***REMOVED***
...
static bool value_in_json_array(grpc_json* array, const char* value) ***REMOVED***
  for (grpc_json* entry = array->child; entry != nullptr; entry = entry->next) ***REMOVED***
...
static char* choose_service_config(char* service_config_choice_json) ***REMOVED***
  ...
  if (choices_json == nullptr || choices_json->type != GRPC_JSON_ARRAY) ***REMOVED***
...
static void dns_ares_on_resolved_locked(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  if (r->lb_addresses != nullptr) ***REMOVED***
    ...
    if (r->service_config_json != nullptr) ***REMOVED***
      ...
      if (service_config_string != nullptr) ***REMOVED***
        ...
        if (service_config != nullptr) ***REMOVED***
          ...
          if (lb_policy_name != nullptr) ***REMOVED***
  ...
  ***REMOVED***
  if (r->resolved_result != nullptr) ***REMOVED***
...
static grpc_resolver* dns_ares_create(grpc_exec_ctx* exec_ctx,
  ...
  ***REMOVED***
  ...
  if (args->pollset_set != nullptr) ***REMOVED***
...
extern "C" void grpc_resolver_dns_ares_init(void) ***REMOVED***
  char* resolver = gpr_getenv("GRPC_DNS_RESOLVER");
  /* TODO(zyc): Turn on c-ares based resolver by default after the address
     sorter and the CNAME support are added. */
  if (resolver != nullptr && gpr_stricmp(resolver, "ares") == 0) ***REMOVED***
...
extern "C" void grpc_resolver_dns_ares_shutdown(void) ***REMOVED***
  char* resolver = gpr_getenv("GRPC_DNS_RESOLVER");
  if (resolver != nullptr && gpr_stricmp(resolver, "ares") == 0) ***REMOVED***
    grpc_ares_cleanup();
  ***REMOVED***
...
extern "C" void grpc_resolver_dns_ares_init(void) ***REMOVED******REMOVED***

extern "C" void grpc_resolver_dns_ares_shutdown(void) ***REMOVED******REMOVED***
