...
***REMOVED*** tsi_client_certificate_request_type;
...
typedef struct tsi_peer_property ***REMOVED***
  char* name;
  struct ***REMOVED***
    char* data;
    size_t length;
  ***REMOVED*** value;
***REMOVED*** tsi_peer_property;
...
/* --- tsi_handshaker objects ----
   ...
   ***REMOVED*** security_handshaker;
   ...
   void do_handshake(security_handshaker *h, ...) ***REMOVED***
   ...
   ***REMOVED***
   ...
   // do_handshake_next.
   void on_handshake_data_received_from_peer(void *user_data) ***REMOVED***
   ...
   ***REMOVED***
   ...
   void do_handshake_next(security_handshaker *h,
                          ...
                          size_t bytes_received_size) ***REMOVED***
   ...
   ***REMOVED***
   ...
   void on_handshake_next_done(
       ...
       size_t bytes_to_send_size, tsi_handshaker_result *result) ***REMOVED***
     security_handshaker *h = (security_handshaker *)user_data;
