...
static grpc_error* server_filter_incoming_metadata(grpc_exec_ctx* exec_ctx,
  ...
  if (b->idx.named.method != nullptr) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (b->idx.named.te != nullptr) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (b->idx.named.scheme != nullptr) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (b->idx.named.path == nullptr) ***REMOVED***
    add_error(error_name, &error,
              grpc_error_set_str(
                  GRPC_ERROR_CREATE_FROM_STATIC_STRING("Missing header"),
  ...
  ***REMOVED***
  ...
  if (b->idx.named.host != nullptr && b->idx.named.authority == nullptr) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (b->idx.named.authority == nullptr) ***REMOVED***
    add_error(
        error_name, &error,
        grpc_error_set_str(
            GRPC_ERROR_CREATE_FROM_STATIC_STRING("Missing header"),
...
static void hs_on_complete(grpc_exec_ctx* exec_ctx, void* user_data,
  ...
  if (calld->seen_path_with_query && calld->recv_message_ready != nullptr) ***REMOVED***
