...
void grpc_lb_policy_registry_init(void) ***REMOVED*** g_number_of_lb_policies = 0; ***REMOVED***

void grpc_lb_policy_registry_shutdown(void) ***REMOVED***
  int i;
  for (i = 0; i < g_number_of_lb_policies; i++) ***REMOVED***
    grpc_lb_policy_factory_unref(g_all_of_the_lb_policies[i]);
  ***REMOVED***
***REMOVED***

void grpc_register_lb_policy(grpc_lb_policy_factory* factory) ***REMOVED***
  int i;
  for (i = 0; i < g_number_of_lb_policies; i++) ***REMOVED***
...
static grpc_lb_policy_factory* lookup_factory(const char* name) ***REMOVED***
  int i;

  if (name == nullptr) return nullptr;

  for (i = 0; i < g_number_of_lb_policies; i++) ***REMOVED***
    if (0 == gpr_stricmp(name, g_all_of_the_lb_policies[i]->vtable->name)) ***REMOVED***
