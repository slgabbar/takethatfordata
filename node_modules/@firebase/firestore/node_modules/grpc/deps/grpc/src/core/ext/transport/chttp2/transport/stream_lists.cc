...
static const char* stream_list_id_string(grpc_chttp2_stream_list_id id) ***REMOVED***
  switch (id) ***REMOVED***
...
static bool stream_list_pop(grpc_chttp2_transport* t,
  ...
  ***REMOVED***
  *stream = s;
  if (s && grpc_trace_http2_stream_state.enabled()) ***REMOVED***
...
static void stream_list_remove(grpc_chttp2_transport* t, grpc_chttp2_stream* s,
  ...
  ***REMOVED***
  if (grpc_trace_http2_stream_state.enabled()) ***REMOVED***
