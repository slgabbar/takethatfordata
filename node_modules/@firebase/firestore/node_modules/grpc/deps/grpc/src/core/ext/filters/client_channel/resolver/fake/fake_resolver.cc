...
***REMOVED*** fake_resolver;

static void fake_resolver_destroy(grpc_exec_ctx* exec_ctx, grpc_resolver* gr) ***REMOVED***
...
static void fake_resolver_maybe_finish_next_locked(grpc_exec_ctx* exec_ctx,
                                                   fake_resolver* r) ***REMOVED***
  if (r->next_completion != nullptr && r->next_results != nullptr) ***REMOVED***
    *r->target_result =
...
static void fake_resolver_channel_saw_error_locked(grpc_exec_ctx* exec_ctx,
                                                   grpc_resolver* resolver) ***REMOVED***
  fake_resolver* r = (fake_resolver*)resolver;
  if (r->next_results == nullptr && r->results_upon_error != nullptr) ***REMOVED***
...
static const grpc_resolver_vtable fake_resolver_vtable = ***REMOVED***
    fake_resolver_destroy, fake_resolver_shutdown_locked,
    fake_resolver_channel_saw_error_locked, fake_resolver_next_locked***REMOVED***;

struct grpc_fake_resolver_response_generator ***REMOVED***
  fake_resolver* resolver;  // Set by the fake_resolver constructor to itself.
  gpr_refcount refcount;
***REMOVED***;

grpc_fake_resolver_response_generator*
grpc_fake_resolver_response_generator_create() ***REMOVED***
...
grpc_fake_resolver_response_generator_ref(
    grpc_fake_resolver_response_generator* generator) ***REMOVED***
...
void grpc_fake_resolver_response_generator_unref(
    grpc_fake_resolver_response_generator* generator) ***REMOVED***
  if (gpr_unref(&generator->refcount)) ***REMOVED***
    gpr_free(generator);
  ***REMOVED***
***REMOVED***

typedef struct set_response_closure_arg ***REMOVED***
  grpc_closure set_response_closure;
  grpc_fake_resolver_response_generator* generator;
  grpc_channel_args* next_response;
***REMOVED*** set_response_closure_arg;
...
static void set_response_closure_fn(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  if (r->next_results != nullptr) ***REMOVED***
    grpc_channel_args_destroy(exec_ctx, r->next_results);
  ***REMOVED***
  r->next_results = closure_arg->next_response;
  if (r->results_upon_error != nullptr) ***REMOVED***
    grpc_channel_args_destroy(exec_ctx, r->results_upon_error);
  ***REMOVED***
...
void grpc_fake_resolver_response_generator_set_response(
    ...
    grpc_channel_args* next_response) ***REMOVED***
...
static void* response_generator_arg_copy(void* p) ***REMOVED***
  return grpc_fake_resolver_response_generator_ref(
      (grpc_fake_resolver_response_generator*)p);
***REMOVED***

static void response_generator_arg_destroy(grpc_exec_ctx* exec_ctx, void* p) ***REMOVED***
  grpc_fake_resolver_response_generator_unref(
      (grpc_fake_resolver_response_generator*)p);
***REMOVED***

static int response_generator_cmp(void* a, void* b) ***REMOVED*** return GPR_ICMP(a, b); ***REMOVED***

static const grpc_arg_pointer_vtable response_generator_arg_vtable = ***REMOVED***
    response_generator_arg_copy, response_generator_arg_destroy,
    response_generator_cmp***REMOVED***;
...
grpc_fake_resolver_response_generator*
grpc_fake_resolver_get_response_generator(const grpc_channel_args* args) ***REMOVED***
  const grpc_arg* arg =
...
static void fake_resolver_factory_ref(grpc_resolver_factory* factory) ***REMOVED******REMOVED***

static void fake_resolver_factory_unref(grpc_resolver_factory* factory) ***REMOVED******REMOVED***
...
static char* fake_resolver_get_default_authority(grpc_resolver_factory* factory,
                                                 grpc_uri* uri) ***REMOVED***
  const char* path = uri->path;
  if (path[0] == '/') ++path;
  return gpr_strdup(path);
***REMOVED***

static const grpc_resolver_factory_vtable fake_resolver_factory_vtable = ***REMOVED***
    fake_resolver_factory_ref, fake_resolver_factory_unref,
    fake_resolver_create, fake_resolver_get_default_authority, "fake"***REMOVED***;

static grpc_resolver_factory fake_resolver_factory = ***REMOVED***
    &fake_resolver_factory_vtable***REMOVED***;

extern "C" void grpc_resolver_fake_init(void) ***REMOVED***
  grpc_register_resolver_type(&fake_resolver_factory);
***REMOVED***

extern "C" void grpc_resolver_fake_shutdown(void) ***REMOVED******REMOVED***
