...
static grpc_channel_credentials_vtable
    fake_transport_security_credentials_vtable = ***REMOVED***
        nullptr, fake_transport_security_create_security_connector, nullptr***REMOVED***;

static grpc_server_credentials_vtable
    fake_transport_security_server_credentials_vtable = ***REMOVED***
        nullptr, fake_transport_security_server_create_security_connector***REMOVED***;
...
grpc_arg grpc_fake_transport_expected_targets_arg(char* expected_targets) ***REMOVED***
...
const char* grpc_fake_transport_get_expected_targets(
  ...
  if (expected_target_arg != nullptr &&
      expected_target_arg->type == GRPC_ARG_STRING) ***REMOVED***
...
static grpc_call_credentials_vtable md_only_test_vtable = ***REMOVED***
    md_only_test_destruct, md_only_test_get_request_metadata,
    md_only_test_cancel_get_request_metadata***REMOVED***;

grpc_call_credentials* grpc_md_only_test_credentials_create(
    grpc_exec_ctx* exec_ctx, const char* md_key, const char* md_value,
    bool is_async) ***REMOVED***
