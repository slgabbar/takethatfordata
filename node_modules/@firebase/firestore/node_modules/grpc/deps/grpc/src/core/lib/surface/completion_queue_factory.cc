...
static grpc_completion_queue* default_create(
    ...
    const grpc_completion_queue_attributes* attr) ***REMOVED***
  return grpc_completion_queue_create_internal(attr->cq_completion_type,
                                               attr->cq_polling_type);
***REMOVED***

static grpc_completion_queue_factory_vtable default_vtable = ***REMOVED***default_create***REMOVED***;

static const grpc_completion_queue_factory g_default_cq_factory = ***REMOVED***
    "Default Factory", nullptr, &default_vtable***REMOVED***;
...
const grpc_completion_queue_factory* grpc_completion_queue_factory_lookup(
    const grpc_completion_queue_attributes* attributes) ***REMOVED***
...
grpc_completion_queue* grpc_completion_queue_create_for_next(void* reserved) ***REMOVED***
  GPR_ASSERT(!reserved);
  grpc_completion_queue_attributes attr = ***REMOVED***1, GRPC_CQ_NEXT,
                                           GRPC_CQ_DEFAULT_POLLING***REMOVED***;
  return g_default_cq_factory.vtable->create(&g_default_cq_factory, &attr);
***REMOVED***

grpc_completion_queue* grpc_completion_queue_create_for_pluck(void* reserved) ***REMOVED***
  GPR_ASSERT(!reserved);
  grpc_completion_queue_attributes attr = ***REMOVED***1, GRPC_CQ_PLUCK,
                                           GRPC_CQ_DEFAULT_POLLING***REMOVED***;
  return g_default_cq_factory.vtable->create(&g_default_cq_factory, &attr);
***REMOVED***
...
grpc_completion_queue* grpc_completion_queue_create(
    const grpc_completion_queue_factory* factory,
    const grpc_completion_queue_attributes* attr, void* reserved) ***REMOVED***
  GPR_ASSERT(!reserved);
