...
grpc_error* grpc_chttp2_data_parser_init(grpc_chttp2_data_parser* parser) ***REMOVED***
...
void grpc_chttp2_data_parser_destroy(grpc_exec_ctx* exec_ctx,
                                     grpc_chttp2_data_parser* parser) ***REMOVED***
  if (parser->parsing_frame != nullptr) ***REMOVED***
...
grpc_error* grpc_chttp2_data_parser_begin_frame(grpc_chttp2_data_parser* parser,
  ...
  if (flags & ~GRPC_CHTTP2_DATA_FLAG_END_STREAM) ***REMOVED***
    char* msg;
...
grpc_error* grpc_deframe_unprocessed_incoming_frames(
    ...
    grpc_byte_stream** stream_out) ***REMOVED***
  grpc_error* error = GRPC_ERROR_NONE;
  grpc_chttp2_transport* t = s->t;

  while (slices->count > 0) ***REMOVED***
    uint8_t* beg = nullptr;
    uint8_t* end = nullptr;
    uint8_t* cur = nullptr;
    ...
    ***REMOVED***
    ...
    switch (p->state) ***REMOVED***
      ...
      case GRPC_CHTTP2_DATA_FH_4:
        ...
        ++cur;
        message_flags = 0;
        if (p->is_frame_compressed) ***REMOVED***
        ...
        *stream_out = &p->parsing_frame->base;
        if (p->parsing_frame->remaining_bytes == 0) ***REMOVED***
          GRPC_ERROR_UNREF(grpc_chttp2_incoming_byte_stream_finished(
        ...
        ***REMOVED***
        grpc_slice_unref_internal(exec_ctx, slice);
        return GRPC_ERROR_NONE;
      case GRPC_CHTTP2_DATA_FRAME: ***REMOVED***
        GPR_ASSERT(p->parsing_frame != nullptr);
        ...
        ***REMOVED***
        ...
        if (remaining == p->frame_size) ***REMOVED***
          ...
          ***REMOVED***
          if (GRPC_ERROR_NONE !=
              (error = grpc_chttp2_incoming_byte_stream_finished(
                   exec_ctx, p->parsing_frame, GRPC_ERROR_NONE, true))) ***REMOVED***
            grpc_slice_unref_internal(exec_ctx, slice);
            return error;
          ***REMOVED***
          p->parsing_frame = nullptr;
          ...
          grpc_slice_unref_internal(exec_ctx, slice);
          return GRPC_ERROR_NONE;
        ***REMOVED*** else if (remaining < p->frame_size) ***REMOVED***
          s->stats.incoming.data_bytes += remaining;
          if (GRPC_ERROR_NONE != (error = grpc_chttp2_incoming_byte_stream_push(
                                      exec_ctx, p->parsing_frame,
                                      grpc_slice_sub(slice, (size_t)(cur - beg),
...
grpc_error* grpc_chttp2_data_parser_parse(grpc_exec_ctx* exec_ctx, void* parser,
  ...
  ***REMOVED*** else if (s->on_next) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (is_last && s->received_last_frame) ***REMOVED***
