...
grpc_lb_addresses* grpc_lb_addresses_create(
    size_t num_addresses, const grpc_lb_user_data_vtable* user_data_vtable) ***REMOVED***
...
grpc_lb_addresses* grpc_lb_addresses_copy(const grpc_lb_addresses* addresses) ***REMOVED***
  ...
  for (size_t i = 0; i < addresses->num_addresses; ++i) ***REMOVED***
    if (new_addresses->addresses[i].balancer_name != nullptr) ***REMOVED***
      new_addresses->addresses[i].balancer_name =
          gpr_strdup(new_addresses->addresses[i].balancer_name);
    ***REMOVED***
    if (new_addresses->addresses[i].user_data != nullptr) ***REMOVED***
...
int grpc_lb_addresses_cmp(const grpc_lb_addresses* addresses1,
                          const grpc_lb_addresses* addresses2) ***REMOVED***
  ...
  if (addresses1->user_data_vtable < addresses2->user_data_vtable) return -1;
  for (size_t i = 0; i < addresses1->num_addresses; ++i) ***REMOVED***
    ...
    if (retval != 0) return retval;
    if (addresses1->user_data_vtable != nullptr) ***REMOVED***
...
void grpc_lb_addresses_destroy(grpc_exec_ctx* exec_ctx,
                               grpc_lb_addresses* addresses) ***REMOVED***
  for (size_t i = 0; i < addresses->num_addresses; ++i) ***REMOVED***
...
static void* lb_addresses_copy(void* addresses) ***REMOVED***
  return grpc_lb_addresses_copy((grpc_lb_addresses*)addresses);
***REMOVED***
static void lb_addresses_destroy(grpc_exec_ctx* exec_ctx, void* addresses) ***REMOVED***
  grpc_lb_addresses_destroy(exec_ctx, (grpc_lb_addresses*)addresses);
***REMOVED***
static int lb_addresses_cmp(void* addresses1, void* addresses2) ***REMOVED***
  return grpc_lb_addresses_cmp((grpc_lb_addresses*)addresses1,
                               (grpc_lb_addresses*)addresses2);
***REMOVED***
static const grpc_arg_pointer_vtable lb_addresses_arg_vtable = ***REMOVED***
    lb_addresses_copy, lb_addresses_destroy, lb_addresses_cmp***REMOVED***;
...
void grpc_lb_policy_factory_ref(grpc_lb_policy_factory* factory) ***REMOVED***
  factory->vtable->ref(factory);
***REMOVED***

void grpc_lb_policy_factory_unref(grpc_lb_policy_factory* factory) ***REMOVED***
