...
gpr_mpscq_node* gpr_mpscq_pop(gpr_mpscq* q) ***REMOVED***
  bool empty;
  return gpr_mpscq_pop_and_check_end(q, &empty);
***REMOVED***

gpr_mpscq_node* gpr_mpscq_pop_and_check_end(gpr_mpscq* q, bool* empty) ***REMOVED***
  gpr_mpscq_node* tail = q->tail;
  gpr_mpscq_node* next = (gpr_mpscq_node*)gpr_atm_acq_load(&tail->next);
  if (tail == &q->stub) ***REMOVED***
...
void gpr_locked_mpscq_init(gpr_locked_mpscq* q) ***REMOVED***
  gpr_mpscq_init(&q->queue);
  gpr_mu_init(&q->mu);
***REMOVED***

void gpr_locked_mpscq_destroy(gpr_locked_mpscq* q) ***REMOVED***
  gpr_mpscq_destroy(&q->queue);
  gpr_mu_destroy(&q->mu);
***REMOVED***

bool gpr_locked_mpscq_push(gpr_locked_mpscq* q, gpr_mpscq_node* n) ***REMOVED***
  return gpr_mpscq_push(&q->queue, n);
***REMOVED***

gpr_mpscq_node* gpr_locked_mpscq_try_pop(gpr_locked_mpscq* q) ***REMOVED***
...
gpr_mpscq_node* gpr_locked_mpscq_pop(gpr_locked_mpscq* q) ***REMOVED***
  gpr_mu_lock(&q->mu);
  bool empty = false;
  gpr_mpscq_node* n;
  do ***REMOVED***
    n = gpr_mpscq_pop_and_check_end(&q->queue, &empty);
  ***REMOVED*** while (n == nullptr && !empty);
  gpr_mu_unlock(&q->mu);
  return n;
***REMOVED***
