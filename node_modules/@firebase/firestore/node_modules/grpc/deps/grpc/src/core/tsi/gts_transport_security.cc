...
gts_shared_resource* gts_get_shared_resource(void) ***REMOVED*** return &g_gts_resource; ***REMOVED***

extern "C" void grpc_tsi_gts_init() ***REMOVED***
  memset(&g_gts_resource, 0, sizeof(gts_shared_resource));
  gpr_mu_init(&g_gts_resource.mu);
***REMOVED***

extern "C" void grpc_tsi_gts_shutdown() ***REMOVED***
  gpr_mu_destroy(&g_gts_resource.mu);
  if (g_gts_resource.cq == nullptr) ***REMOVED***
    return;
  ***REMOVED***
