...
***REMOVED*** grpc_byte_stream_vtable;

struct grpc_byte_stream ***REMOVED***
  uint32_t length;
  uint32_t flags;
...
typedef struct grpc_slice_buffer_stream ***REMOVED***
  grpc_byte_stream base;
  grpc_slice_buffer* backing_buffer;
  size_t cursor;
  grpc_error* shutdown_error;
***REMOVED*** grpc_slice_buffer_stream;
...
***REMOVED*** grpc_byte_stream_cache;
...
typedef struct ***REMOVED***
  ...
  size_t cursor;
  grpc_error* shutdown_error;
***REMOVED*** grpc_caching_byte_stream;
