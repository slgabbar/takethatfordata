...
static void dns_on_resolved_locked(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  if (r->addresses != nullptr) ***REMOVED***
...
extern "C" void grpc_resolver_dns_native_init(void) ***REMOVED***
  char* resolver = gpr_getenv("GRPC_DNS_RESOLVER");
  if (resolver != nullptr && gpr_stricmp(resolver, "native") == 0) ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED***
    ...
    if (existing_factory == nullptr) ***REMOVED***
      gpr_log(GPR_DEBUG, "Using native dns resolver");
      grpc_register_resolver_type(dns_resolver_factory_create());
    ***REMOVED*** else ***REMOVED***
...
extern "C" void grpc_resolver_dns_native_shutdown(void) ***REMOVED******REMOVED***
