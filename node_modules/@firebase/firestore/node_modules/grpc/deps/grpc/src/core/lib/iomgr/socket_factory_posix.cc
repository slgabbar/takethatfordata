...
grpc_socket_factory* grpc_socket_factory_ref(grpc_socket_factory* factory) ***REMOVED***
  gpr_ref(&factory->refcount);
  return factory;
***REMOVED***

void grpc_socket_factory_unref(grpc_socket_factory* factory) ***REMOVED***
  if (gpr_unref(&factory->refcount)) ***REMOVED***
    factory->vtable->destroy(factory);
  ***REMOVED***
***REMOVED***

static void* socket_factory_arg_copy(void* p) ***REMOVED***
  return grpc_socket_factory_ref((grpc_socket_factory*)p);
***REMOVED***

static void socket_factory_arg_destroy(grpc_exec_ctx* exec_ctx, void* p) ***REMOVED***
  grpc_socket_factory_unref((grpc_socket_factory*)p);
***REMOVED***

static int socket_factory_cmp(void* a, void* b) ***REMOVED***
  return grpc_socket_factory_compare((grpc_socket_factory*)a,
                                     (grpc_socket_factory*)b);
***REMOVED***

static const grpc_arg_pointer_vtable socket_factory_arg_vtable = ***REMOVED***
    socket_factory_arg_copy, socket_factory_arg_destroy, socket_factory_cmp***REMOVED***;

grpc_arg grpc_socket_factory_to_arg(grpc_socket_factory* factory) ***REMOVED***
