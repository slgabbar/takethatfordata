...
static void httpcli_ssl_check_peer(grpc_exec_ctx* exec_ctx,
  ...
  if (c->secure_peer_name != nullptr &&
      !tsi_ssl_peer_matches_name(&peer, c->secure_peer_name)) ***REMOVED***
    char* msg;
...
static grpc_security_connector_vtable httpcli_ssl_vtable = ***REMOVED***
    httpcli_ssl_destroy, httpcli_ssl_check_peer, httpcli_ssl_cmp***REMOVED***;

static grpc_security_status httpcli_ssl_channel_security_connector_create(
    grpc_exec_ctx* exec_ctx, const char* pem_root_certs,
    const char* secure_peer_name, grpc_channel_security_connector** sc) ***REMOVED***
  tsi_result result = TSI_OK;
  grpc_httpcli_ssl_channel_security_connector* c;

  if (secure_peer_name != nullptr && pem_root_certs == nullptr) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  if (secure_peer_name != nullptr) ***REMOVED***
...
static void ssl_handshake(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  ***REMOVED***
  ...
  grpc_channel_args args = ***REMOVED***1, &channel_arg***REMOVED***;
...
const grpc_httpcli_handshaker grpc_httpcli_ssl = ***REMOVED***"https", ssl_handshake***REMOVED***;
