...
struct grpc_server_retry_throttle_data ***REMOVED***
  gpr_refcount refs;
...
static void get_replacement_throttle_data_if_needed(
    grpc_server_retry_throttle_data** throttle_data) ***REMOVED***
  while (true) ***REMOVED***
...
void grpc_server_retry_throttle_data_unref(
    grpc_server_retry_throttle_data* throttle_data) ***REMOVED***
  if (gpr_unref(&throttle_data->refs)) ***REMOVED***
    grpc_server_retry_throttle_data* replacement =
        (grpc_server_retry_throttle_data*)gpr_atm_acq_load(
            &throttle_data->replacement);
    if (replacement != nullptr) ***REMOVED***
...
static grpc_server_retry_throttle_data* grpc_server_retry_throttle_data_create(
    ...
    grpc_server_retry_throttle_data* old_throttle_data) ***REMOVED***
  ...
  if (old_throttle_data != nullptr) ***REMOVED***
...
static void* copy_server_name(void* key, void* unused) ***REMOVED***
  return gpr_strdup((const char*)key);
***REMOVED***

static long compare_server_name(void* key1, void* key2, void* unused) ***REMOVED***
  return strcmp((const char*)key1, (const char*)key2);
***REMOVED***

static void destroy_server_retry_throttle_data(void* value, void* unused) ***REMOVED***
  grpc_server_retry_throttle_data* throttle_data =
      (grpc_server_retry_throttle_data*)value;
  grpc_server_retry_throttle_data_unref(throttle_data);
***REMOVED***

static void* copy_server_retry_throttle_data(void* value, void* unused) ***REMOVED***
  grpc_server_retry_throttle_data* throttle_data =
      (grpc_server_retry_throttle_data*)value;
  return grpc_server_retry_throttle_data_ref(throttle_data);
***REMOVED***

static void destroy_server_name(void* key, void* unused) ***REMOVED*** gpr_free(key); ***REMOVED***

static const gpr_avl_vtable avl_vtable = ***REMOVED***
    destroy_server_name, copy_server_name, compare_server_name,
    destroy_server_retry_throttle_data, copy_server_retry_throttle_data***REMOVED***;
...
void grpc_retry_throttle_map_init() ***REMOVED***
  gpr_mu_init(&g_mu);
  g_avl = gpr_avl_create(&avl_vtable);
***REMOVED***

void grpc_retry_throttle_map_shutdown() ***REMOVED***
  gpr_mu_destroy(&g_mu);
  gpr_avl_unref(g_avl, nullptr);
***REMOVED***

grpc_server_retry_throttle_data* grpc_retry_throttle_map_get_data_for_server(
    const char* server_name, int max_milli_tokens, int milli_token_ratio) ***REMOVED***
  gpr_mu_lock(&g_mu);
  grpc_server_retry_throttle_data* throttle_data =
      (grpc_server_retry_throttle_data*)gpr_avl_get(g_avl, (char*)server_name,
                                                    nullptr);
  if (throttle_data == nullptr) ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED***
    if (throttle_data->max_milli_tokens != max_milli_tokens ||
        throttle_data->milli_token_ratio != milli_token_ratio) ***REMOVED***
