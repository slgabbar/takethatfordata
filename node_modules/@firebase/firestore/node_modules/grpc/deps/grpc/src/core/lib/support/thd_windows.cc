...
static void destroy_thread(struct thd_info* t) ***REMOVED***
  if (t->joinable) CloseHandle(t->join_event);
  gpr_free(t);
***REMOVED***

void gpr_thd_init(void) ***REMOVED******REMOVED***

/* Body of every thread started via gpr_thd_new. */
static DWORD WINAPI thread_body(void* v) ***REMOVED***
  g_thd_info = (struct thd_info*)v;
  g_thd_info->body(g_thd_info->arg);
  if (g_thd_info->joinable) ***REMOVED***
...
int gpr_thd_new(gpr_thd_id* t, void (*thd_body)(void* arg), void* arg,
  ...
  info->arg = arg;
  *t = 0;
  if (gpr_thd_options_is_joinable(options)) ***REMOVED***
    info->joinable = 1;
    info->join_event = CreateEvent(NULL, FALSE, FALSE, NULL);
    if (info->join_event == NULL) ***REMOVED***
      gpr_free(info);
      return 0;
    ***REMOVED***
  ***REMOVED*** else ***REMOVED***
...
gpr_thd_id gpr_thd_currentid(void) ***REMOVED*** return (gpr_thd_id)g_thd_info; ***REMOVED***

void gpr_thd_join(gpr_thd_id t) ***REMOVED***
