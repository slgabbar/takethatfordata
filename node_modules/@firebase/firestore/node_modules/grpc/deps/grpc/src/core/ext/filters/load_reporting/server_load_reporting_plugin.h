...
typedef enum grpc_load_reporting_source ***REMOVED***
...
***REMOVED*** grpc_load_reporting_source;

/** Call information to be passed to the provided LR callback. */
typedef struct grpc_load_reporting_call_data ***REMOVED***
...
***REMOVED*** grpc_load_reporting_call_data;
