...
static const grpc_resolver_vtable sockaddr_resolver_vtable = ***REMOVED***
    sockaddr_destroy, sockaddr_shutdown_locked,
    sockaddr_channel_saw_error_locked, sockaddr_next_locked***REMOVED***;
...
static void sockaddr_maybe_finish_next_locked(grpc_exec_ctx* exec_ctx,
                                              sockaddr_resolver* r) ***REMOVED***
  if (r->next_completion != nullptr && !r->published) ***REMOVED***
    r->published = true;
...
static void sockaddr_destroy(grpc_exec_ctx* exec_ctx, grpc_resolver* gr) ***REMOVED***
...
static char* ip_get_default_authority(grpc_uri* uri) ***REMOVED***
...
static grpc_resolver* sockaddr_create(grpc_exec_ctx* exec_ctx,
  ...
  ***REMOVED***
  ...
  for (size_t i = 0; i < addresses->num_addresses; i++) ***REMOVED***
    ...
    if (!parse(&ith_uri, &addresses->addresses[i].address)) ***REMOVED***
...
static void sockaddr_factory_ref(grpc_resolver_factory* factory) ***REMOVED******REMOVED***

static void sockaddr_factory_unref(grpc_resolver_factory* factory) ***REMOVED******REMOVED***
...
#define DECL_FACTORY(name)                                                  \
  ...
  ***REMOVED***                                                                         \
  static const grpc_resolver_factory_vtable name##_factory_vtable = ***REMOVED***       \
      sockaddr_factory_ref, sockaddr_factory_unref,                         \
      name##_factory_create_resolver, name##_get_default_authority, #name***REMOVED***; \
  static grpc_resolver_factory name##_resolver_factory = ***REMOVED***                  \
      &name##_factory_vtable***REMOVED***
...
extern "C" void grpc_resolver_sockaddr_init(void) ***REMOVED***
...
extern "C" void grpc_resolver_sockaddr_shutdown(void) ***REMOVED******REMOVED***
