...
static grpc_error* prepare_socket(SOCKET sock,
  ...
  ***REMOVED***
  ...
  if (bind(sock, (const struct sockaddr*)addr->addr, (int)addr->len) ==
      SOCKET_ERROR) ***REMOVED***
    error = GRPC_WSA_ERROR(WSAGetLastError(), "bind");
    goto failure;
  ***REMOVED***

  if (listen(sock, SOMAXCONN) == SOCKET_ERROR) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (getsockname(sock, (struct sockaddr*)sockname_temp.addr,
                  &sockname_temp_len) == SOCKET_ERROR) ***REMOVED***
...
static void decrement_active_ports_and_notify_locked(grpc_exec_ctx* exec_ctx,
                                                     grpc_tcp_listener* sp) ***REMOVED***
  sp->shutting_down = 0;
  GPR_ASSERT(sp->server->active_ports > 0);
  if (0 == --sp->server->active_ports) ***REMOVED***
...
static grpc_error* start_accept_locked(grpc_exec_ctx* exec_ctx,
                                       grpc_tcp_listener* port) ***REMOVED***
  ...
  if (port->shutting_down) ***REMOVED***
    return GRPC_ERROR_NONE;
  ***REMOVED***

  sock = WSASocket(AF_INET6, SOCK_STREAM, IPPROTO_TCP, NULL, 0,
                   WSA_FLAG_OVERLAPPED);
  if (sock == INVALID_SOCKET) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!success) ***REMOVED***
    ...
    if (last_error != ERROR_IO_PENDING) ***REMOVED***
...
static void on_accept(grpc_exec_ctx* exec_ctx, void* arg, grpc_error* error) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!wsa_success) ***REMOVED***
    if (!sp->shutting_down) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (0 == --sp->outstanding_calls) ***REMOVED***
