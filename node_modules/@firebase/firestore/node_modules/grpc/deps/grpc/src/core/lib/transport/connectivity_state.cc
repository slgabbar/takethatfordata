...
const char* grpc_connectivity_state_name(grpc_connectivity_state state) ***REMOVED***
...
void grpc_connectivity_state_destroy(grpc_exec_ctx* exec_ctx,
                                     grpc_connectivity_state_tracker* tracker) ***REMOVED***
  grpc_error* error;
  grpc_connectivity_state_watcher* w;
  while ((w = tracker->watchers)) ***REMOVED***
    tracker->watchers = w->next;

    if (GRPC_CHANNEL_SHUTDOWN != *w->current) ***REMOVED***
...
grpc_connectivity_state grpc_connectivity_state_check(
  ...
  if (grpc_connectivity_state_trace.enabled()) ***REMOVED***
...
grpc_connectivity_state grpc_connectivity_state_get(
    grpc_connectivity_state_tracker* tracker, grpc_error** error) ***REMOVED***
  grpc_connectivity_state cur =
      (grpc_connectivity_state)gpr_atm_no_barrier_load(
          &tracker->current_state_atm);
  if (grpc_connectivity_state_trace.enabled()) ***REMOVED***
...
bool grpc_connectivity_state_has_watchers(
    grpc_connectivity_state_tracker* connectivity_state) ***REMOVED***
  return connectivity_state->watchers != nullptr;
***REMOVED***

bool grpc_connectivity_state_notify_on_state_change(
    grpc_exec_ctx* exec_ctx, grpc_connectivity_state_tracker* tracker,
    grpc_connectivity_state* current, grpc_closure* notify) ***REMOVED***
  grpc_connectivity_state cur =
      (grpc_connectivity_state)gpr_atm_no_barrier_load(
          &tracker->current_state_atm);
  if (grpc_connectivity_state_trace.enabled()) ***REMOVED***
    if (current == nullptr) ***REMOVED***
  ...
  ***REMOVED***
  if (current == nullptr) ***REMOVED***
    ...
    if (w != nullptr && w->notify == notify) ***REMOVED***
    ...
    ***REMOVED***
    while (w != nullptr) ***REMOVED***
      ...
      if (rm_candidate != nullptr && rm_candidate->notify == notify) ***REMOVED***
        GRPC_CLOSURE_SCHED(exec_ctx, notify, GRPC_ERROR_CANCELLED);
        w->next = w->next->next;
...
void grpc_connectivity_state_set(grpc_exec_ctx* exec_ctx,
  ...
  ***REMOVED***
  ...
  while ((w = tracker->watchers) != nullptr) ***REMOVED***
    *w->current = state;
    tracker->watchers = w->next;
    if (grpc_connectivity_state_trace.enabled()) ***REMOVED***
