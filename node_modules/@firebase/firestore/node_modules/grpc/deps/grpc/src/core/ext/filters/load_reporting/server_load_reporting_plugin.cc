...
static bool is_load_reporting_enabled(const grpc_channel_args* a) ***REMOVED***
...
static bool maybe_add_server_load_reporting_filter(
  ...
  if (is_load_reporting_enabled(args) && !already_has_load_reporting_filter) ***REMOVED***
...
grpc_arg grpc_load_reporting_enable_arg() ***REMOVED***
...
extern "C" void grpc_server_load_reporting_plugin_init(void) ***REMOVED***
  grpc_channel_init_register_stage(GRPC_SERVER_CHANNEL, INT_MAX,
                                   maybe_add_server_load_reporting_filter,
                                   (void*)&grpc_server_load_reporting_filter);
***REMOVED***

extern "C" void grpc_server_load_reporting_plugin_shutdown() ***REMOVED******REMOVED***
