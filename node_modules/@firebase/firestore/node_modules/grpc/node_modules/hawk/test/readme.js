    ...
    describe('core', function () ***REMOVED***
        ...
        ***REMOVED***);
        ...
        it('should generate a normalized string protocol example', function (done) ***REMOVED***
            ...
            var normalized = Hawk.crypto.generateNormalizedString('header', ***REMOVED***
                credentials: credentials,
        ...
        ***REMOVED***);
        ...
        it('should generate a header protocol example (with payload)', function (done) ***REMOVED***
        ...
        ***REMOVED***);
        ...
        it('should generate a normalized string protocol example (with payload)', function (done) ***REMOVED***
