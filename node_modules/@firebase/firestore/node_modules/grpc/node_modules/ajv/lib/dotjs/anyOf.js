'use strict';
module.exports = function generate_anyOf(it, $keyword) ***REMOVED***
  var out = ' ';
  var $lvl = it.level;
  ...
  ***REMOVED***);
  if ($noEmptySchema) ***REMOVED***
    ...
    ***REMOVED*** else ***REMOVED***
      out += ' ***REMOVED******REMOVED*** ';
    ***REMOVED***
    out += ';  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ***REMOVED*** else ***REMOVED***  errors = ' + ($errs) + '; if (vErrors !== null) ***REMOVED*** if (' + ($errs) + ') vErrors.length = ' + ($errs) + '; else vErrors = null; ***REMOVED*** ';
