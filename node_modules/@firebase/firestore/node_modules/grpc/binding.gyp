  ...
  'target_defaults': ***REMOVED***
    ...
    ***REMOVED***,
    ...
    'conditions': [
      ...
      ***REMOVED***],
      ['grpc_alpine=="true"', ***REMOVED***
        'defines': [
          'GPR_MUSL_LIBC_COMPAT'
        ]
      ***REMOVED***],
      ['OS!="win" and runtime=="electron"', ***REMOVED***
        "defines": [
          'OPENSSL_NO_THREADS'
        ]
      ***REMOVED***],
      # This is the condition for using boringssl
      ['OS=="win" or runtime=="electron"', ***REMOVED***
        "include_dirs": [
      ...
      ***REMOVED***, ***REMOVED***
        'conditions': [
          ["target_arch=='ia32'", ***REMOVED***
             "include_dirs": [ "<(node_root_dir)/deps/openssl/config/piii" ]
          ***REMOVED***],
          ["target_arch=='x64'", ***REMOVED***
             "include_dirs": [ "<(node_root_dir)/deps/openssl/config/k8" ]
          ***REMOVED***],
          ["target_arch=='arm'", ***REMOVED***
             "include_dirs": [ "<(node_root_dir)/deps/openssl/config/arm" ]
          ***REMOVED***],
          ['grpc_alpn=="true"', ***REMOVED***
            'defines': [
      ...
      ***REMOVED***],
      ['OS == "win"', ***REMOVED***
        ...
        "msvs_settings": ***REMOVED***
          'VCCLCompilerTool': ***REMOVED***
