...
describe('Hash', function() ***REMOVED***
  function test(fn, cases) ***REMOVED***
    for (var i = 0; i < cases.length; i++) ***REMOVED***
      var msg = cases[i][0];
      var res = cases[i][1];
      var enc = cases[i][2];
  ...
  ***REMOVED***
  ...
  it('should support sha256', function() ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should support sha224', function() ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should support ripemd160', function() ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should support sha1', function() ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should support sha512', function() ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should support sha384', function() ***REMOVED***
