...
```javascript
Object.defineProperty(Function.prototype, 'partial', ***REMOVED*** value: require('es5-ext/function/#/partial'),
  configurable: true, enumerable: false, writable: true ***REMOVED***);
Object.defineProperty(Array.prototype, 'flatten', ***REMOVED*** value: require('es5-ext/array/#/flatten'),
  configurable: true, enumerable: false, writable: true ***REMOVED***);
Object.defineProperty(String.prototype, 'capitalize', ***REMOVED*** value: require('es5-ext/string/#/capitalize'),
  configurable: true, enumerable: false, writable: true ***REMOVED***);
```
...
_flatten(***REMOVED*** a: ***REMOVED*** b: 1 ***REMOVED***, c: ***REMOVED*** d: 1 ***REMOVED*** ***REMOVED***)  =def  ***REMOVED*** b: 1, d: 1 ***REMOVED***_
