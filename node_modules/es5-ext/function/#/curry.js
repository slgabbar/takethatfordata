...
curry = function self(fn, length, preArgs) ***REMOVED***
	return defineLength(function () ***REMOVED***
		var args = preArgs
		...
		return args.length === length ? apply.call(fn, this, args)
				: self(fn, length, args);
	***REMOVED***, preArgs ? length - preArgs.length : length);
***REMOVED***;

module.exports = function (/* Length*/) ***REMOVED***
