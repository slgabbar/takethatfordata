...
module.exports = function (t, a) ***REMOVED***
	var fn = function (raz, dwa) ***REMOVED***
		return raz + dwa;
	***REMOVED***;
	...
	a(t(***REMOVED******REMOVED***), "***REMOVED******REMOVED***", "Empty object");
	a(
		t(***REMOVED***
			raz: undefined,
			dwa: false,
			...
			osiem: ["foo", 32],
			dziewiec: ***REMOVED*** foo: "bar", dwa: 343 ***REMOVED***
		***REMOVED***),
		"***REMOVED***\"raz\":undefined,\"dwa\":false,\"trzy\":null,\"cztery\":\"raz\\\"ddwa\\ntrzy\"," +
			"\"piec\":" +
			String(fn) +
			",\"szesc\":/raz/g,\"siedem\":new Date(1234567),\"osiem\":[\"foo\",32]," +
			"\"dziewiec\":***REMOVED***\"foo\":\"bar\",\"dwa\":343***REMOVED******REMOVED***",
		"Rich object"
	);
***REMOVED***;
