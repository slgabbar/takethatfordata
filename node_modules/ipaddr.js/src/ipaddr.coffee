...
class ipaddr.IPv4
  ...
  toIPv4MappedAddress: ->
    return ipaddr.IPv6.parse "::ffff:#***REMOVED***@toString()***REMOVED***"
...
ipv4Regexes =
  fourOctet: new RegExp "^#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***$", 'i'
  longValue: new RegExp "^#***REMOVED***ipv4Part***REMOVED***$", 'i'
...
ipv6Regexes =
  ...
  native:       new RegExp "^(::)?(#***REMOVED***ipv6Part***REMOVED***)?([0-9a-f]+)?(::)?(#***REMOVED***zoneIndex***REMOVED***)?$", 'i'
  transitional: new RegExp "^((?:#***REMOVED***ipv6Part***REMOVED***)|(?:::)(?:#***REMOVED***ipv6Part***REMOVED***)?)" +
                           "#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***" +
                           "(#***REMOVED***zoneIndex***REMOVED***)?$", 'i'
...
expandIPv6 = (string, parts) ->
  ...
  return ***REMOVED*** parts: parts, zoneId: zoneId ***REMOVED***
...
ipaddr.IPv6.parser = (string) ->
  if ipv6Regexes['native'].test(string)
    ...
    if addr.parts
      ...
      return ***REMOVED*** parts: addr.parts, zoneId: addr.zoneId ***REMOVED***
...
ipaddr.IPv4.isValidFourPartDecimal = (string) ->
  if ipaddr.IPv4.isValid(string) and string.match(/^\d+(\.\d+)***REMOVED***3***REMOVED***$/)
    return true
  else
    return false
