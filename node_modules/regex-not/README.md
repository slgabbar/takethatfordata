...
```js
var re = not('foo');
console.log(re.test('foo', ***REMOVED***contains: true***REMOVED***));     //=> false
console.log(re.test('bar', ***REMOVED***contains: true***REMOVED***));     //=> true
console.log(re.test('foobar', ***REMOVED***contains: true***REMOVED***));  //=> false
console.log(re.test('barfoo', ***REMOVED***contains: true***REMOVED***));  //=> false
```
