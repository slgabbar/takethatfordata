...
<script>
    ...
    colors.addSequencer("america", function(letter, i, exploded) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    colors.addSequencer("random", (function() ***REMOVED***
        var available = ['bold', 'underline', 'italic', 'inverse', 'grey', 'yellow', 'red', 'green', 'blue', 'white', 'cyan', 'magenta'];

        return function(letter, i, exploded) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    stylesNormal.forEach(function (style) ***REMOVED***
