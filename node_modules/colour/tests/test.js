...
function a(s, code) ***REMOVED***
  return '\x1B[' + code.toString() + 'm' + s + '\x1B[39m';
***REMOVED***

function aE(s, color, code) ***REMOVED***
...
colors.setTheme(***REMOVED***error:'red'***REMOVED***);
...
assert.ok(s.rainbow);
stylesColors.forEach(function (color) ***REMOVED***
...
colors.mode = 'none';
stylesAll.forEach(function (style) ***REMOVED***
