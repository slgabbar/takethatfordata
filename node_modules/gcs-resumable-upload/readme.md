...
fs.createReadStream('titanic.mov')
  .pipe(upload(***REMOVED*** bucket: 'legally-owned-movies', file: 'titanic.mov' ***REMOVED***))
...
##### .on('error', function (err) ***REMOVED******REMOVED***)
...
##### .on('response', function (resp, metadata) ***REMOVED******REMOVED***)
...
##### .on('finish', function () ***REMOVED******REMOVED***)
