...
force output to be string with option `***REMOVED*** to: 'string' ***REMOVED***`.

```javascript
var pako = require('pako');

var test = ***REMOVED*** my: 'super', puper: [456, 567], awesome: 'pako' ***REMOVED***;

var binaryString = pako.deflate(JSON.stringify(test), ***REMOVED*** to: 'string' ***REMOVED***);

//
// Here you can do base64 encode, make xhr requests and so on.
//

var restored = JSON.parse(pako.inflate(binaryString, ***REMOVED*** to: 'string' ***REMOVED***));
```
