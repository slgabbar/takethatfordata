...
test('is-buffer tests', function (t) ***REMOVED***
  ...
  t.notOk(isBuffer(***REMOVED******REMOVED***), '***REMOVED******REMOVED***')
  t.notOk(isBuffer(function foo () ***REMOVED******REMOVED***), 'function foo () ***REMOVED******REMOVED***')
