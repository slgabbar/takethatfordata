...
test('buffer.write string should get parsed as number', function (t) ***REMOVED***
  var b = new B(64)
...
test('buffer.writeUInt8 a fractional number will get Math.floored', function (t) ***REMOVED***
...
test('writeUint8 with a negative number throws', function (t) ***REMOVED***
  var buf = new B(1)
...
test('hex of write***REMOVED***Uint,Int***REMOVED******REMOVED***8,16,32***REMOVED******REMOVED***LE,BE***REMOVED***', function (t) ***REMOVED***
  t.plan(2 * (2 * 2 * 2 + 2))
  var hex = [
  ...
  for (var i = 0; i < xs.length; i++) ***REMOVED***
    var x = xs[i]
    for (var j = 0; j < ys.length; j++) ***REMOVED***
      var y = ys[j]
      var endianesses = (y === 8) ? [''] : ['LE', 'BE']
      for (var k = 0; k < endianesses.length; k++) ***REMOVED***
        var z = endianesses[k]
...
test('hex of write***REMOVED***Uint,Int***REMOVED******REMOVED***8,16,32***REMOVED******REMOVED***LE,BE***REMOVED*** with overflow', function (t) ***REMOVED***
  if (!B.TYPED_ARRAY_SUPPORT) ***REMOVED***
  ...
  ***REMOVED***
  t.end()
***REMOVED***)
test('large values do not improperly roll over (ref #80)', function (t) ***REMOVED***
