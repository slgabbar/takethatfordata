...
test('base64: ignore whitespace', function (t) ***REMOVED***
  var text = '\n   YW9ldQ==  '
...
test('base64: strings without padding', function (t) ***REMOVED***
  t.equal((new B('YW9ldQ', 'base64').toString()), 'aoeu')
  t.end()
***REMOVED***)

test('base64: newline in utf8 -- should not be an issue', function (t) ***REMOVED***
  t.equal(
...
test('base64: newline in base64 -- should get stripped', function (t) ***REMOVED***
  t.equal(
...
test('base64: tab characters in base64 - should get stripped', function (t) ***REMOVED***
  t.equal(
...
test('base64: invalid non-alphanumeric characters -- should be stripped', function (t) ***REMOVED***
  t.equal(
    new B('!"#$%&\'()*,.:;<=>?@[\\]^`***REMOVED***|***REMOVED***~', 'base64').toString('utf8'),
    ''
  )
  t.end()
***REMOVED***)
