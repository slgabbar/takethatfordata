...
test('utf8 buffer to base64', function (t) ***REMOVED***
  t.equal(
...
test('utf8 buffer to hex', function (t) ***REMOVED***
  t.equal(
...
test('utf8 to utf8', function (t) ***REMOVED***
  t.equal(
...
test('utf16le to utf16', function (t) ***REMOVED***
  t.equal(
...
test('utf16le to hex', function (t) ***REMOVED***
  t.equal(
...
test('ascii buffer to base64', function (t) ***REMOVED***
  t.equal(
...
test('ascii buffer to hex', function (t) ***REMOVED***
  t.equal(
...
test('base64 buffer to utf8', function (t) ***REMOVED***
  t.equal(
...
test('hex buffer to utf8', function (t) ***REMOVED***
  t.equal(
...
test('base64 buffer to ascii', function (t) ***REMOVED***
  t.equal(
...
test('hex buffer to ascii', function (t) ***REMOVED***
  t.equal(
...
test('base64 buffer to binary', function (t) ***REMOVED***
  t.equal(
...
test('hex buffer to binary', function (t) ***REMOVED***
  t.equal(
...
test('utf8 to binary', function (t) ***REMOVED***
  /* jshint -W100 */
  t.equal(
...
test('utf8 replacement chars (1 byte sequence)', function (t) ***REMOVED***
  t.equal(
    new B([ 0x80 ]).toString(),
    '\uFFFD'
  )
...
test('utf8 replacement chars (2 byte sequences)', function (t) ***REMOVED***
  t.equal(
    new B([ 0xC7 ]).toString(),
    '\uFFFD'
  )
...
test('utf8 replacement chars (3 byte sequences)', function (t) ***REMOVED***
  t.equal(
    new B([ 0xE0 ]).toString(),
    '\uFFFD'
  )
...
test('utf8 replacement chars (4 byte sequences)', function (t) ***REMOVED***
  t.equal(
    new B([ 0xF4 ]).toString(),
    '\uFFFD'
  )
...
test('utf8 replacement chars on 256 random bytes', function (t) ***REMOVED***
  t.equal(
...
test('utf8 replacement chars for anything in the surrogate pair range', function (t) ***REMOVED***
  t.equal(
...
test('utf8 don\'t replace the replacement char', function (t) ***REMOVED***
  t.equal(
    new B('\uFFFD').toString(),
    '\uFFFD'
  )
