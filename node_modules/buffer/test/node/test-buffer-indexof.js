...
var longString = 'A';
for (var i = 66; i < 76; i++) ***REMOVED***  // from 'B' to 'K'
...
for (var i = 0; i < longBufferString.length - pattern.length; i += 7) ***REMOVED***
...
***REMOVED***
  ...
  for (var lengthIndex = 0; lengthIndex < lengths.length; lengthIndex++) ***REMOVED***
    for (var i = 0; i < indices.length; i++) ***REMOVED***
      var index = indices[i];
      var length = lengths[lengthIndex];

      if (index + length > 0x7F) ***REMOVED***
        length = 2 * length;
      ***REMOVED***

      if (index + length > 0x7FF) ***REMOVED***
        length = 3 * length;
      ***REMOVED***

      if (index + length > 0xFFFF) ***REMOVED***
        length = 4 * length;
      ***REMOVED***
...
assert.throws(function() ***REMOVED***
  b.indexOf(function() ***REMOVED*** ***REMOVED***);
***REMOVED***);
assert.throws(function() ***REMOVED***
  b.indexOf(***REMOVED******REMOVED***);
***REMOVED***);
assert.throws(function() ***REMOVED***
  b.indexOf([]);
***REMOVED***);
...
assert.equal(b.lastIndexOf('b', ***REMOVED******REMOVED***), 1);
...
function countBits(n) ***REMOVED***
  for (var count = 0; n > 0; count++) ***REMOVED***
    n = n & (n - 1); // remove top bit
  ***REMOVED***
  return count;
***REMOVED***
var parts = [];
for (var i = 0; i < 1000000; i++) ***REMOVED***
