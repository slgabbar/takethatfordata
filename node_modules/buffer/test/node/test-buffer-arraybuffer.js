...
assert.throws(function() ***REMOVED***
  function AB() ***REMOVED*** ***REMOVED***
  Object.setPrototypeOf(AB, ArrayBuffer);
  Object.setPrototypeOf(AB.prototype, ArrayBuffer.prototype);
  Buffer.from(new AB());
***REMOVED***, TypeError);

// write***REMOVED***Double,Float***REMOVED******REMOVED***LE,BE***REMOVED*** with noAssert should not crash, cf. #3766
...
***REMOVED***
  ...
  assert.throws(() => Buffer.from(ab.buffer, 6), (err) => ***REMOVED***
    assert(err instanceof RangeError);
    assert(/'offset' is out of bounds/.test(err.message));
    return true;
  ***REMOVED***);
  assert.throws(() => Buffer.from(ab.buffer, 3, 6), (err) => ***REMOVED***
    assert(err instanceof RangeError);
...
***REMOVED***
  ...
  assert.throws(() => Buffer(ab.buffer, 6), (err) => ***REMOVED***
    assert(err instanceof RangeError);
    assert(/'offset' is out of bounds/.test(err.message));
    return true;
  ***REMOVED***);
  assert.throws(() => Buffer(ab.buffer, 3, 6), (err) => ***REMOVED***
    assert(err instanceof RangeError);
    assert(/'length' is out of bounds/.test(err.message));
    return true;
  ***REMOVED***);
