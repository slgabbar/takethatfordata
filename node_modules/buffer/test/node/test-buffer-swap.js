...
for (var i = 0; i < buf8A.length; i++) ***REMOVED***
  buf8A[i] = i % 8;
...
for (var i = 0; i < buf10A.length; i++) ***REMOVED***
  buf10A[i] = i % 2;
***REMOVED***
for (var i = 1; i < buf11A.length; i++) ***REMOVED***
...
for (var i = 0; i < buf12A.length; i++) ***REMOVED***
  buf12A[i] = i % 4;
***REMOVED***
for (var i = 1; i < buf13A.length; i++) ***REMOVED***
...
for (var i = 0; i < buf14A.length; i++) ***REMOVED***
  buf14A[i] = i % 8;
***REMOVED***
for (var i = 1; i < buf15A.length; i++) ***REMOVED***
