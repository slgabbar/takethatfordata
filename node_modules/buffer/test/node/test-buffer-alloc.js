...
for (var [index, value] of e.entries()) ***REMOVED***
...
assert.equal(Buffer.from(***REMOVED***length: 3.3***REMOVED***).length, 3);
assert.equal(Buffer.from(***REMOVED***length: 'BAM'***REMOVED***).length, 0);
...
'ascii utf8 hex base64 latin1'.split(' ').forEach(function(enc) ***REMOVED***
...
[ 'utf9',
  ...
  ***REMOVED******REMOVED***,
  ...
  1,
  0,
  -1 ].forEach(function(enc) ***REMOVED***
...
assert.throws(() => ***REMOVED*** Buffer.allocUnsafe(1422561062959).toString('utf8');***REMOVED***);
...
***REMOVED***, /RangeError: 'offset' is out of bounds/);

// ParseArrayIndex() should reject values that don't fit in a 32 bits size_t.
assert.throws(() => ***REMOVED***
  var a = Buffer(1).fill(0);
  var b = Buffer(1).fill(0);
  a.copy(b, 0, 0x100000000, 0x100000001);
***REMOVED***), /out of range index/;
...
assert.throws(() => Buffer.alloc(***REMOVED*** valueOf: () => 1 ***REMOVED***),
