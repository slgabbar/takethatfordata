...
var common = ***REMOVED*** skip: function () ***REMOVED******REMOVED*** ***REMOVED***;
...
var e = Buffer(ui32);
for (var [key, value] of e.entries()) ***REMOVED***
...
//   console.log('copied %d bytes from b into c', copied);
  ...
  for (var i = 0; i < c.length; i++) ***REMOVED***
...
//   console.log('copied %d bytes from end of b into beginning of c', copied);
  ...
  for (var i = 0; i < Math.floor(c.length / 2); i++) ***REMOVED***
    assert.strictEqual(b[b.length - Math.floor(c.length / 2) + i], c[i]);
  ***REMOVED***
  for (var i = Math.floor(c.length / 2) + 1; i < c.length; i++) ***REMOVED***
...
assert.doesNotThrow(() => ***REMOVED*** b.copy(c, 0, 100, 10); ***REMOVED***);
...
assert.equal(rangeBuffer.toString('ascii', ***REMOVED******REMOVED***, 3), 'abc');
...
assert.equal(rangeBuffer.toString('ascii', 0, ***REMOVED******REMOVED***), '');
...
assert.equal(rangeBuffer.toString(***REMOVED***toString: function() ***REMOVED***
  return 'ascii';
***REMOVED******REMOVED***), 'abc');
...
***REMOVED***
  ...
  for (var i = 0; i < asciiString.length; i++) ***REMOVED***
...
for (var i = 0; i < Buffer.byteLength(utf8String); i++) ***REMOVED***
  assert.equal(sliceA[i], sliceB[i]);
***REMOVED***
...
['ucs2', 'ucs-2', 'utf16le', 'utf-16le'].forEach(function(encoding) ***REMOVED***
  ***REMOVED***
...
var arrayIsh = ***REMOVED***0: 0, 1: 1, 2: 2, 3: 3, length: 4***REMOVED***;
var g = new Buffer(arrayIsh);
assert.deepStrictEqual(g, new Buffer([0, 1, 2, 3]));
var strArrayIsh = ***REMOVED***0: '0', 1: '1', 2: '2', 3: '3', length: 4***REMOVED***;
...
function buildBuffer(data) ***REMOVED***
  if (Array.isArray(data)) ***REMOVED***
    var buffer = Buffer(data.length);
    data.forEach(function(v, k) ***REMOVED***
      buffer[k] = v;
    ***REMOVED***);
    return buffer;
  ***REMOVED***
...
assert.equal(Buffer(***REMOVED***length: 3.3***REMOVED***).length, 3);
assert.equal(Buffer(***REMOVED***length: 'BAM'***REMOVED***).length, 0);
...
'ascii utf8 hex base64 latin1 binary'.split(' ').forEach(function(enc) ***REMOVED***
...
[ 'hex',
  ...
  'ucs-2',
  'utf16le',
  'utf-16le' ].forEach(function(enc) ***REMOVED***
...
[ 'utf9',
  'utf-7',
  'Unicode-FTW',
  'new gnu gun' ].forEach(function(enc) ***REMOVED***
...
***REMOVED***
  ...
  assert.strictEqual(string, '***REMOVED***"type":"Buffer","data":[116,101,115,116]***REMOVED***');

  assert.deepStrictEqual(buffer, JSON.parse(string, function(key, value) ***REMOVED***
...
***REMOVED***
  ...
  assert.throws(function() ***REMOVED*** buf.readUInt8(0); ***REMOVED***, RangeError);
  assert.throws(function() ***REMOVED*** buf.readInt8(0); ***REMOVED***, RangeError);
***REMOVED***
...
[16, 32].forEach(function(bits) ***REMOVED***
  var buf = new Buffer(bits / 8 - 1);

  assert.throws(function() ***REMOVED*** buf['readUInt' + bits + 'BE'](0); ***REMOVED***,
                RangeError,
                'readUInt' + bits + 'BE');

  assert.throws(function() ***REMOVED*** buf['readUInt' + bits + 'LE'](0); ***REMOVED***,
                RangeError,
                'readUInt' + bits + 'LE');

  assert.throws(function() ***REMOVED*** buf['readInt' + bits + 'BE'](0); ***REMOVED***,
                RangeError,
                'readInt' + bits + 'BE()');

  assert.throws(function() ***REMOVED*** buf['readInt' + bits + 'LE'](0); ***REMOVED***,
                RangeError,
                'readInt' + bits + 'LE()');
***REMOVED***);
...
***REMOVED***
  ...
  assert.equal(buf.slice(-10, 10), '0123456789');
  for (var i = 0, s = buf.toString(); i < buf.length; ++i) ***REMOVED***
...
***REMOVED***
  ...
  a = a.map(function(_, i) ***REMOVED*** return i; ***REMOVED***);
  var b = Buffer(a);
  var c = Buffer(b);
  assert.strictEqual(b.length, a.length);
  assert.strictEqual(c.length, a.length);
  for (var i = 0, k = a.length; i < k; ++i) ***REMOVED***
...
assert.throws(function() ***REMOVED*** Buffer(1422561062959).toString('utf8'); ***REMOVED***);
...
***REMOVED***
  ...
  assert.deepStrictEqual(Buffer(***REMOVED*** length: -Buffer.poolSize ***REMOVED***), Buffer.from(''));
  assert.deepStrictEqual(Buffer(***REMOVED*** length: -100 ***REMOVED***), Buffer.from(''));
...
***REMOVED***
  ...
  for (var allocator of allocators) ***REMOVED***
    for (var size of sizes) ***REMOVED***
      try ***REMOVED***
        allocator(size);
