...
```js
omit(***REMOVED***a: 'a', b: 'b', c: 'c'***REMOVED***, 'a')
//=> ***REMOVED*** b: 'b', c: 'c' ***REMOVED***
```

Pass an array of `keys` to omit:

```js
omit(***REMOVED***a: 'a', b: 'b', c: 'c'***REMOVED***, ['a', 'c'])
//=> ***REMOVED*** b: 'b' ***REMOVED***
```
...
```js
omit(***REMOVED***a: 'a', b: 'b', c: 'c'***REMOVED***)
//=> ***REMOVED***a: 'a', b: 'b', c: 'c'***REMOVED***
```
...
```js
var res = omit(***REMOVED***a: 'a', b: 'b', c: 'c'***REMOVED***, function (val, key) ***REMOVED***
  return key === 'a';
***REMOVED***);
//=> ***REMOVED***a: 'a'***REMOVED***
```
...
var obj = ***REMOVED***a: 'a', b: 'b', c: fn***REMOVED***;

var res = omit(obj, ['a'], function (val, key) ***REMOVED***
