(function (global, factory) ***REMOVED***
  ...
  (factory((global.acorn = global.acorn || ***REMOVED******REMOVED***)));
...
var keywordTypes = ***REMOVED******REMOVED***
...
var DestructuringErrors = function DestructuringErrors() ***REMOVED***
...
pp$1.isFunction = function() ***REMOVED***
...
pp$1.parseSwitchStatement = function(node) ***REMOVED***
  ...
  for (var cur, sawDefault = false; this.type != tt.braceR;) ***REMOVED***
    if (this$1.type === tt._case || this$1.type === tt._default) ***REMOVED***
...
pp$1.parseLabeledStatement = function(node, maybeName, expr) ***REMOVED***
  ...
  for (var i$1 = this.labels.length - 1; i$1 >= 0; i$1--) ***REMOVED***
...
pp$1.parseBlock = function() ***REMOVED***
  var this$1 = this;
...
pp$1.parseVar = function(node, isFor, kind) ***REMOVED***
  ...
  for (;;) ***REMOVED***
    ...
    if (this$1.eat(tt.eq)) ***REMOVED***
      decl.init = this$1.parseMaybeAssign(isFor)
    ***REMOVED*** else if (kind === "const" && !(this$1.type === tt._in || (this$1.options.ecmaVersion >= 6 && this$1.isContextual("of")))) ***REMOVED***
      this$1.unexpected()
    ***REMOVED*** else if (decl.id.type != "Identifier" && !(isFor && (this$1.type === tt._in || this$1.isContextual("of")))) ***REMOVED***
...
pp$1.parseVarId = function(decl) ***REMOVED***
  ...
  while (!this.eat(tt.braceR)) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (!method.computed) ***REMOVED***
      var key = method.key;
      if (!isGenerator && !isAsync && key.type === "Identifier" && this$1.type !== tt.parenL && (key.name === "get" || key.name === "set")) ***REMOVED***
        isGetSet = true
...
pp$1.parseExport = function(node, exports) ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED*** // export ***REMOVED*** x, y as z ***REMOVED*** [from '...']
    ...
    ***REMOVED*** else ***REMOVED***
      ...
      for (var i = 0; i < node.specifiers.length; i++) ***REMOVED***
        if (this$1.keywords.test(node.specifiers[i].local.name) || this$1.reservedWords.test(node.specifiers[i].local.name)) ***REMOVED***
...
pp$1.checkPatternExport = function(exports, pat) ***REMOVED***
  ...
  if (type == "Identifier")
    ...
    for (var i$1 = 0; i$1 < pat.elements.length; ++i$1) ***REMOVED***
...
pp$2.toAssignable = function(node, isBinding) ***REMOVED***
  var this$1 = this;
  ...
  if (this.options.ecmaVersion >= 6 && node) ***REMOVED***
    ...
    case "ObjectExpression":
      ...
      for (var i = 0; i < node.properties.length; i++) ***REMOVED***
...
pp$2.parseRest = function(allowNonIdent) ***REMOVED***
  var node = this.startNode()
  this.next()
...
pp$2.parseBindingList = function(close, allowEmpty, allowTrailingComma, allowNonIdent) ***REMOVED***
  var this$1 = this;
  ...
  while (!this.eat(close)) ***REMOVED***
    ...
    if (allowEmpty && this$1.type === tt.comma) ***REMOVED***
      elts.push(null)
    ***REMOVED*** else if (allowTrailingComma && this$1.afterTrailingComma(close)) ***REMOVED***
      break
    ***REMOVED*** else if (this$1.type === tt.ellipsis) ***REMOVED***
...
pp$2.checkLVal = function(expr, isBinding, checkClashes) ***REMOVED***
  var this$1 = this;
  ...
  case "ArrayPattern":
    for (var i$1 = 0; i$1 < expr.elements.length; i$1++) ***REMOVED***
...
pp$3.checkPropClash = function(prop, propHash) ***REMOVED***
...
pp$3.parseExprOp = function(left, leftStartPos, leftStartLoc, minPrec, noIn) ***REMOVED***
  ...
  if (prec != null && (!noIn || this.type !== tt._in)) ***REMOVED***
...
pp$3.parseSubscripts = function(base, startPos, startLoc, noCalls) ***REMOVED***
  ...
  for (var computed;;) ***REMOVED***
    if ((computed = this$1.eat(tt.bracketL)) || this$1.eat(tt.dot)) ***REMOVED***
    ...
    ***REMOVED*** else if (!noCalls && this$1.eat(tt.parenL)) ***REMOVED***
      var refDestructuringErrors = new DestructuringErrors, oldYieldPos = this$1.yieldPos, oldAwaitPos = this$1.awaitPos
      this$1.yieldPos = 0
      this$1.awaitPos = 0
      var exprList = this$1.parseExprList(tt.parenR, this$1.options.ecmaVersion >= 8, false, refDestructuringErrors)
      if (maybeAsyncArrow && !this$1.canInsertSemicolon() && this$1.eat(tt.arrow)) ***REMOVED***
    ...
    ***REMOVED*** else if (this$1.type === tt.backQuote) ***REMOVED***
...
pp$3.parseExprAtom = function(refDestructuringErrors) ***REMOVED***
  ...
  case tt.name:
    ...
    if (canBeArrow && !this.canInsertSemicolon()) ***REMOVED***
      ...
      if (this.options.ecmaVersion >= 8 && id.name === "async" && this.type === tt.name) ***REMOVED***
        id = this.parseIdent()
...
pp$3.parseParenAndDistinguishExpression = function(canBeArrow) ***REMOVED***
  ...
  if (this.options.ecmaVersion >= 6) ***REMOVED***
    ...
    this.yieldPos = 0
    this.awaitPos = 0
    while (this.type !== tt.parenR) ***REMOVED***
      first ? first = false : this$1.expect(tt.comma)
      if (allowTrailingComma && this$1.afterTrailingComma(tt.parenR, true)) ***REMOVED***
        lastIsComma = true
        break
      ***REMOVED*** else if (this$1.type === tt.ellipsis) ***REMOVED***
        ...
        break
      ***REMOVED*** else ***REMOVED***
        if (this$1.type === tt.parenL && !innerParenStart) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (canBeArrow && !this.canInsertSemicolon() && this.eat(tt.arrow)) ***REMOVED***
...
pp$3.parseTemplateElement = function() ***REMOVED***
...
pp$3.parseTemplate = function() ***REMOVED***
  var this$1 = this;
  ...
  while (!this.eat(tt.braceR)) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (!isPattern && this$1.options.ecmaVersion >= 8 && !isGenerator && !prop.computed &&
        ...
        this$1.type !== tt.colon && !this$1.canInsertSemicolon()) ***REMOVED***
      isAsync = true
...
pp$3.parsePropertyValue = function(prop, isPattern, isGenerator, isAsync, startPos, startLoc, refDestructuringErrors) ***REMOVED***
  ...
  if (this.eat(tt.colon)) ***REMOVED***
    ...
    prop.kind = "init"
  ***REMOVED*** else if (this.options.ecmaVersion >= 6 && this.type === tt.parenL) ***REMOVED***
    if (isPattern) this.unexpected()
    prop.kind = "init"
    prop.method = true
    prop.value = this.parseMethod(isGenerator, isAsync)
  ***REMOVED*** else if (this.options.ecmaVersion >= 5 && !prop.computed && prop.key.type === "Identifier" &&
             (prop.key.name === "get" || prop.key.name === "set") &&
             (this.type != tt.comma && this.type != tt.braceR)) ***REMOVED***
  ...
  ***REMOVED*** else if (this.options.ecmaVersion >= 6 && !prop.computed && prop.key.type === "Identifier") ***REMOVED***
    ...
    ***REMOVED*** else if (this.type === tt.eq && refDestructuringErrors) ***REMOVED***
...
pp$3.parseFunctionBody = function(node, isArrowFunction) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (oldStrict || useStrict) ***REMOVED***
    this.strict = true
    if (node.id)
      this.checkLVal(node.id, true)
    this.checkParams(node)
    this.strict = oldStrict
  ***REMOVED*** else if (isArrowFunction || !this.isSimpleParamList(node.params)) ***REMOVED***
    this.checkParams(node)
  ***REMOVED***
***REMOVED***
...
pp$3.checkParams = function(node) ***REMOVED***
  var this$1 = this;
  ...
  while (!this.eat(close)) ***REMOVED***
    ...
    ***REMOVED*** else first = false
    ...
    if (allowEmpty && this$1.type === tt.comma)
      elt = null
    else if (this$1.type === tt.ellipsis) ***REMOVED***
...
pp$3.parseIdent = function(liberal) ***REMOVED***
  var node = this.startNode()
  ...
  ***REMOVED*** else if (liberal && this.type.keyword) ***REMOVED***
...
pp$3.parseYield = function() ***REMOVED***
  ...
  var node = this.startNode()
  this.next()
  if (this.type == tt.semi || this.canInsertSemicolon() || (this.type != tt.star && !this.type.startsExpr)) ***REMOVED***
    node.delegate = false
    node.argument = null
  ***REMOVED*** else ***REMOVED***
...
pp$5.startNode = function() ***REMOVED***
  return new Node(this, this.start, this.startLoc)
***REMOVED***

pp$5.startNodeAt = function(pos, loc) ***REMOVED***
...
pp$5.finishNode = function(node, type) ***REMOVED***
  return finishNodeAt.call(this, node, type, this.lastTokEnd, this.lastTokEndLoc)
***REMOVED***

// Finish node at given position

pp$5.finishNodeAt = function(node, type, pos, loc) ***REMOVED***
...
var TokContext = function TokContext(token, isExpr, preserveSpace, override) ***REMOVED***
  this.token = token
  this.isExpr = !!isExpr
...
var types = ***REMOVED***
  ...
  q_tmpl: new TokContext("`", true, true, function (p) ***REMOVED*** return p.readTmplToken(); ***REMOVED***),
  f_expr: new TokContext("function", true)
***REMOVED***

var pp$6 = Parser.prototype

pp$6.initialContext = function() ***REMOVED***
  return [types.b_stat]
***REMOVED***

pp$6.braceIsBlock = function(prevType) ***REMOVED***
...
pp$6.updateContext = function(prevType) ***REMOVED***
...
pp$7.getToken = function() ***REMOVED***
  this.next()
...
if (typeof Symbol !== "undefined")
  pp$7[Symbol.iterator] = function () ***REMOVED***
    var self = this
...
pp$7.curContext = function() ***REMOVED***
...
pp$7.nextToken = function() ***REMOVED***
...
pp$7.readToken = function(code) ***REMOVED***
...
pp$7.fullCharCodeAtPos = function() ***REMOVED***
...
pp$7.skipBlockComment = function() ***REMOVED***
  var this$1 = this;
...
pp$7.skipLineComment = function(startSkip) ***REMOVED***
  var this$1 = this;
...
pp$7.skipSpace = function() ***REMOVED***
  var this$1 = this;
...
pp$7.finishToken = function(type, val) ***REMOVED***
  this.end = this.pos
...
//
pp$7.readToken_dot = function() ***REMOVED***
  var next = this.input.charCodeAt(this.pos + 1)
...
pp$7.readToken_slash = function() ***REMOVED*** // '/'
  var next = this.input.charCodeAt(this.pos + 1)
...
pp$7.readToken_mult_modulo_exp = function(code) ***REMOVED*** // '%*'
  var next = this.input.charCodeAt(this.pos + 1)
  var size = 1
...
pp$7.readToken_pipe_amp = function(code) ***REMOVED*** // '|&'
  var next = this.input.charCodeAt(this.pos + 1)
...
pp$7.readToken_caret = function() ***REMOVED*** // '^'
  var next = this.input.charCodeAt(this.pos + 1)
  if (next === 61) return this.finishOp(tt.assign, 2)
  return this.finishOp(tt.bitwiseXOR, 1)
***REMOVED***

pp$7.readToken_plus_min = function(code) ***REMOVED*** // '+-'
  var next = this.input.charCodeAt(this.pos + 1)
...
pp$7.readToken_lt_gt = function(code) ***REMOVED*** // '<>'
  var next = this.input.charCodeAt(this.pos + 1)
  var size = 1
  if (next === code) ***REMOVED***
...
pp$7.readToken_eq_excl = function(code) ***REMOVED*** // '=!'
  var next = this.input.charCodeAt(this.pos + 1)
...
pp$7.getTokenFromCode = function(code) ***REMOVED***
  switch (code) ***REMOVED***
...
pp$7.finishOp = function(type, size) ***REMOVED***
...
pp$7.readRegexp = function() ***REMOVED***
  var this$1 = this;
...
pp$7.readInt = function(radix, len) ***REMOVED***
  var this$1 = this;
...
pp$7.readRadixNumber = function(radix) ***REMOVED***
  this.pos += 2 // 0x
...
pp$7.readNumber = function(startsWithDot) ***REMOVED***
...
pp$7.readCodePoint = function() ***REMOVED***
...
pp$7.readString = function(quote) ***REMOVED***
  var this$1 = this;
...
pp$7.readTmplToken = function() ***REMOVED***
  var this$1 = this;
  ...
  for (;;) ***REMOVED***
    ...
    if (ch === 96 || ch === 36 && this$1.input.charCodeAt(this$1.pos + 1) === 123) ***REMOVED*** // '`', '$***REMOVED***'
      if (this$1.pos === this$1.start && this$1.type === tt.template) ***REMOVED***
        if (ch === 36) ***REMOVED***
          this$1.pos += 2
...
pp$7.readEscapedChar = function(inTemplate) ***REMOVED***
...
pp$7.readHexChar = function(len) ***REMOVED***
  var codePos = this.pos
...
pp$7.readWord1 = function() ***REMOVED***
  var this$1 = this;
...
pp$7.readWord = function() ***REMOVED***
...
// to this module.
function addLooseExports(parse, Parser, plugins) ***REMOVED***
