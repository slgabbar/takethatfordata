(function (global, factory) ***REMOVED***
  ...
  (factory((global.acorn = global.acorn || ***REMOVED******REMOVED***, global.acorn.loose = global.acorn.loose || ***REMOVED******REMOVED***),global.acorn));
...
lp.readToken = function() ***REMOVED***
  ...
  for (;;) ***REMOVED***
    ...
    ***REMOVED*** catch(e) ***REMOVED***
      ...
      ***REMOVED***
      this$1.resetTo(pos)
      if (replace === true) replace = ***REMOVED***start: pos, end: pos, type: __acorn.tokTypes.name, value: "✖"***REMOVED***
      if (replace) ***REMOVED***
...
lp$1.parseClass = function(isStatement) ***REMOVED***
  ...
  while (!this.closes(__acorn.tokTypes.braceR, indent, line)) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (isDummy(method.key)) ***REMOVED*** if (isDummy(this$1.parseMaybeAssign())) this$1.next(); this$1.eat(__acorn.tokTypes.comma); continue ***REMOVED***
  ...
  while (!this.closes(__acorn.tokTypes.braceR, indent, line)) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (!prop.computed &&
        ...
        this$1.tok.type !== __acorn.tokTypes.colon && !this$1.canInsertSemicolon()) ***REMOVED***
      this$1.parsePropertyName(prop)
      isAsync = true
    ***REMOVED*** else ***REMOVED***
      isAsync = false
    ***REMOVED***
    if (isDummy(prop.key)) ***REMOVED*** if (isDummy(this$1.parseMaybeAssign())) this$1.next(); this$1.eat(__acorn.tokTypes.comma); continue ***REMOVED***
    ...
    ***REMOVED*** else if (this$1.options.ecmaVersion >= 5 && prop.key.type === "Identifier" &&
               ...
               (this$1.tok.type != __acorn.tokTypes.comma && this$1.tok.type != __acorn.tokTypes.braceR)) ***REMOVED***
