...
function makeTest(test) ***REMOVED***
  if (typeof test == "string")
    return function (type) ***REMOVED*** return type == test; ***REMOVED***
  else if (!test)
...
base.SwitchStatement = function (node, st, c) ***REMOVED***
  ...
  for (var i = 0; i < node.cases.length; ++i) ***REMOVED***
    var cs = node.cases[i]
...
base.ArrayPattern =  function (node, st, c) ***REMOVED***
  for (var i = 0; i < node.elements.length; ++i) ***REMOVED***
...
export ***REMOVED*** simple, ancestor, recursive, findNodeAt, findNodeAround, findNodeAfter, findNodeBefore, make, base ***REMOVED***;