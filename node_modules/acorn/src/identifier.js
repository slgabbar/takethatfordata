...
export const reservedWords = ***REMOVED***
...
function isInAstralSet(code, set) ***REMOVED***
  let pos = 0x10000
  for (let i = 0; i < set.length; i += 2) ***REMOVED***
    pos += set[i]
...
export function isIdentifierStart(code, astral) ***REMOVED***
...
export function isIdentifierChar(code, astral) ***REMOVED***
