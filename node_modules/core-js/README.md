...
var fn   = function()***REMOVED******REMOVED***
  , list = (function()***REMOVED***return arguments***REMOVED***)(1, 2, 3);

classof(***REMOVED******REMOVED***);                   // => 'Object'
classof(fn);                   // => 'Function'
classof([]);                   // => 'Array'
...
function Example()***REMOVED******REMOVED***
...
```js
// Before:
Object.defineProperty(target, 'c', ***REMOVED***
  enumerable: true,
  configurable: true,
...
// Simple inheritance:
function Vector2D(x, y)***REMOVED***
  this.x = x;
  this.y = y;
***REMOVED***
Object.define(Vector2D.prototype, ***REMOVED***
  get xy()***REMOVED***
    return Math.hypot(this.x, this.y);
  ***REMOVED***
***REMOVED***);
function Vector3D(x, y, z)***REMOVED***
  Vector2D.apply(this, arguments);
  this.z = z;
***REMOVED***
Vector3D.prototype = Object.make(Vector2D.prototype, ***REMOVED***
...
Dict();                    // => ***REMOVED***__proto__: null***REMOVED***
Dict(***REMOVED***a: 1, b: 2, c: 3***REMOVED***);  // => ***REMOVED***__proto__: null, a: 1, b: 2, c: 3***REMOVED***
Dict(map);                 // => ***REMOVED***__proto__: null, a: 1, b: 2, c: 3***REMOVED***
Dict([1, 2, 3].entries()); // => ***REMOVED***__proto__: null, 0: 1, 1: 2, 2: 3***REMOVED***

var dict = Dict(***REMOVED***a: 42***REMOVED***);
...
Dict.isDict(***REMOVED******REMOVED***);     // => false
...
```js
var dict = ***REMOVED***a: 1, b: 2, c: 3***REMOVED***;

for(var key of Dict.keys(dict))console.log(key); // => 'a', 'b', 'c'

for(var val of Dict.values(dict))console.log(val); // => 1, 2, 3

for(var [key, val] of Dict.entries(dict))***REMOVED***
  console.log(key); // => 'a', 'b', 'c'
  console.log(val); // => 1, 2, 3
***REMOVED***

new Map(Dict.entries(dict)); // => Map ***REMOVED***a: 1, b: 2, c: 3***REMOVED***
```
Basic dict operations for objects with prototype [*examples*](http://goo.gl/B28UnG):
```js
'q' in ***REMOVED***q: 1***REMOVED***;            // => true
'toString' in ***REMOVED******REMOVED***;         // => true

Dict.has(***REMOVED***q: 1***REMOVED***, 'q');    // => true
Dict.has(***REMOVED******REMOVED***, 'toString'); // => false

(***REMOVED***q: 1***REMOVED***)['q'];            // => 1
(***REMOVED******REMOVED***).toString;            // => function toString()***REMOVED*** [native code] ***REMOVED***

Dict.get(***REMOVED***q: 1***REMOVED***, 'q');    // => 1
Dict.get(***REMOVED******REMOVED***, 'toString'); // => undefined

var O = ***REMOVED******REMOVED***;
O['q'] = 1;
O['q'];         // => 1
O['__proto__'] = ***REMOVED***w: 2***REMOVED***;
O['__proto__']; // => ***REMOVED***w: 2***REMOVED***
O['w'];         // => 2
...
Dict.set(O, 'q', 1);
O['q'];         // => 1
Dict.set(O, '__proto__', ***REMOVED***w: 2***REMOVED***);
O['__proto__']; // => ***REMOVED***w: 2***REMOVED***
O['w'];         // => undefined
```
...
// => 1, 'a', ***REMOVED***a: 1, b: 2, c: 3***REMOVED***
// => 2, 'b', ***REMOVED***a: 1, b: 2, c: 3***REMOVED***
// => 3, 'c', ***REMOVED***a: 1, b: 2, c: 3***REMOVED***

Dict.map(dict, function(it)***REMOVED***
  return it * it;
***REMOVED***); // => ***REMOVED***a: 1, b: 4, c: 9***REMOVED***

Dict.mapPairs(dict, function(val, key)***REMOVED***
  if(key != 'b')return [key + key, val * val];
***REMOVED***); // => ***REMOVED***aa: 1, cc: 9***REMOVED***

Dict.filter(dict, function(it)***REMOVED***
  return it % 2;
***REMOVED***); // => ***REMOVED***a: 1, c: 3***REMOVED***

Dict.some(dict, function(it)***REMOVED***
  return it === 2;
***REMOVED***); // => true

Dict.every(dict, function(it)***REMOVED***
  return it === 2;
***REMOVED***); // => false

Dict.find(dict, function(it)***REMOVED***
  return it > 2;
***REMOVED***); // => 3
Dict.find(dict, function(it)***REMOVED***
  return it > 4;
...
Dict.findKey(dict, function(it)***REMOVED***
  return it > 2;
***REMOVED***); // => 'c'
Dict.findKey(dict, function(it)***REMOVED***
  return it > 4;
...
Dict.reduce(dict, function(memo, it)***REMOVED***
  return memo + it;
***REMOVED***);     // => 6
Dict.reduce(dict, function(memo, it)***REMOVED***
  return memo + it;
...
Array.from(10, function(it)***REMOVED***
  return this + it * it;
***REMOVED***, .42); // => [0.42, 1.42, 4.42, 9.42, 16.42, 25.42, 36.42, 49.42, 64.42, 81.42]
```
#### Escaping strings
...
```js
RegExp.escape('Hello, []***REMOVED******REMOVED***()*+?.\\^$|!'); // => 'Hello, \[\]\***REMOVED***\***REMOVED***\(\)\*\+\?\.\\\^\$\|!'
...
core.getIterator(***REMOVED******REMOVED***);   // TypeError: [object Object] is not iterable!
...
console.log(core.getIteratorMethod(***REMOVED******REMOVED***)); // undefined
```
