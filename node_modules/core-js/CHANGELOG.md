...
- Forced replacement of `String#***REMOVED***padStart, padEnd***REMOVED***` in Safari 10 because of [a bug](https://bugs.webkit.org/show_bug.cgi?id=161944), [#280](https://github.com/zloirock/core-js/issues/280)
...
- Fixed behavior `Object.***REMOVED***getOwnPropertySymbols, getOwnPropertyDescriptor***REMOVED***` and `Object#propertyIsEnumerable` on `Object.prototype`
...
- `String#***REMOVED***padStart, padEnd***REMOVED***` returns original string if filler is empty string, [TC39 meeting notes](https://github.com/rwaldron/tc39-notes/blob/master/es7/2016-03/march-29.md#stringprototypepadstartpadend)
...
##### 2.2.2 - 2016.04.06
- Added conversion `-0` to `+0` to `Array#***REMOVED***indexOf, lastIndexOf***REMOVED***`, [ES2016 fix](https://github.com/tc39/ecma262/pull/316)
- Added fixes for some `Math` methods in Tor Browser
- `Array.***REMOVED***from, of***REMOVED***` no longer calls prototype setters
...
- **Improvements**:
  ...
  - Additional validations for `Object.***REMOVED***defineProperty, getOwnPropertyDescriptor***REMOVED***` and `Reflect.defineProperty`
- **Bug Fixes**:
...
- Added implementations and fixes [Typed Arrays](https://github.com/zloirock/core-js#ecmascript-6-typed-arrays)-related features
  ...
  - `%TypedArray%.***REMOVED***for, of***REMOVED***`, `%TypedArray%#***REMOVED***copyWithin, every, fill, filter, find, findIndex, forEach, indexOf, includes, join, lastIndexOf, map, reduce, reduceRight, reverse, set, slice, some, sort, subarray, values, keys, entries, @@iterator, ...***REMOVED***`
...
- Added [`Math.***REMOVED***iaddh, isubh, imulh, umulh***REMOVED***`](https://github.com/zloirock/core-js#ecmascript-7-proposals), [proposal](https://gist.github.com/BrendanEich/4294d5c212a6d2254703)
...
- [`Promise`](https://github.com/zloirock/core-js#ecmascript-6-promise)
  ...
  - Removed usage `@@species` from `Promise.***REMOVED***all, race***REMOVED***`, [November TC39 meeting](https://github.com/rwaldron/tc39-notes/tree/master/es7/2015-11/nov-18.md#conclusionresolution-2)
...
- `***REMOVED***Map, Set***REMOVED***#forEach` non-generic, [#144](https://github.com/zloirock/core-js/issues/144)
...
* Fixed V8 and FF `Array#***REMOVED***values, @@iterator***REMOVED***.name`
...
* Fixed V8 ~ Chromium 40- bug - `Weak(Map|Set)#***REMOVED***delete, get, has***REMOVED***` should not throw errors [#124](https://github.com/zloirock/core-js/issues/124)
* Some other fixes and optimizations

##### 1.2.3 - 2015.10.23
* Fixed some problems related old V8 bug `Object('a').propertyIsEnumerable(0) // => false`, for example, `Object.assign(***REMOVED******REMOVED***, 'qwe')` from the last release
...
* One more `Object.***REMOVED***assign, values, entries***REMOVED***` fix for [**very** specific case](https://github.com/ljharb/proposal-object-values-entries/issues/5)
...
* Added correct [`IsRegExp`](http://www.ecma-international.org/ecma-262/6.0/#sec-isregexp) logic to [`String#***REMOVED***includes, startsWith, endsWith***REMOVED***`](https://github.com/zloirock/core-js/#ecmascript-6-string) and [`RegExp` constructor](https://github.com/zloirock/core-js/#ecmascript-6-regexp), `@@match` case, [example](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/match#Disabling_the_isRegExp_check)
...
* Fixed behavior with deleted in getters properties for `Object.***REMOVED***`[`assign`](https://github.com/zloirock/core-js/#ecmascript-6-object)`, `[`entries, values`](https://github.com/zloirock/core-js/#ecmascript-7-proposals)`***REMOVED***`, [example](http://goo.gl/iQE01c)
...
* Final cleaning non-standard features
  ...
  * Moved `Date#***REMOVED***format, formatUTC***REMOVED***` to [separate library](https://github.com/zloirock/dtf). Standard way for this - `ECMA-402`
  * Removed `Math` methods from `Number.prototype`. Slight sugar for simple `Math` methods calling
  * Removed `***REMOVED***Array#, Array, Dict***REMOVED***.turn`
  * Removed `core.global`
...
* Added correct [symbols](https://github.com/zloirock/core-js/#ecmascript-6-symbol) descriptors
  * Fixed behavior `Object.***REMOVED***assign, create, defineProperty, defineProperties, getOwnPropertyDescriptor, getOwnPropertyDescriptors***REMOVED***` with symbols
  * Added [single entry points](https://github.com/zloirock/core-js/#commonjs) for `Object.***REMOVED***create, defineProperty, defineProperties***REMOVED***`
...
* Removed non-standard undocumented methods `Symbol.***REMOVED***pure, set***REMOVED***`
...
* Added abstract references support:
  ...
  * Added `Dict.***REMOVED***...methods***REMOVED***[@@referenceGet]`
