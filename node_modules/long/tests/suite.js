...
var suite = ***REMOVED***
    ...
    ***REMOVED***,
    ...
    "isLong": function(test) ***REMOVED***
        var longVal = new Long(0xFFFFFFFF, 0x7FFFFFFF);
        test.strictEqual(Long.isLong(longVal), true);
        longVal = ***REMOVED***"__isLong__": true***REMOVED***;
        test.strictEqual(Long.isLong(longVal), true);
        test.done();
    ***REMOVED***,
    ...
    "toString": function(test) ***REMOVED***
    ...
    ***REMOVED***,
    ...
    "unsigned": ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "construct_negint": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "construct_highlow": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "construct_number": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "toSigned/Unsigned": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "max_unsigned_sub_max_signed": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "max_sub_max": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "zero_sub_signed": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "max_unsigned_div_max_signed": function(test) ***REMOVED***
        ...
        ***REMOVED***,
        ...
        "max_unsigned_div_max_unsigned": function(test) ***REMOVED***
            var longVal = Long.MAX_UNSIGNED_VALUE;
            test.strictEqual(longVal.div(longVal).toString(), '1');
            test.done();
        ***REMOVED***,
        
        "max_unsigned_div_neg_signed": function(test) ***REMOVED***
