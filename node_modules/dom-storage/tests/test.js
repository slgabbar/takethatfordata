(function () ***REMOVED***
  ...
  function runTest(storage) ***REMOVED***
  ...
  ***REMOVED***
  ...
  function runAll() ***REMOVED***
    var localStorage = new Storage(dbPath, ***REMOVED*** strict: false, ws: '  ' ***REMOVED***)
      , sessionStorage = new Storage(null, ***REMOVED*** strict: false ***REMOVED***)
      ;
    ...
    setTimeout(function () ***REMOVED***
      assert.deepEqual(***REMOVED*** a: 1 ***REMOVED***, JSON.parse(fs.readFileSync(dbPath)));
