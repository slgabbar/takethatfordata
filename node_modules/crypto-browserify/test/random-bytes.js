...
var randomBytesFunctions = ***REMOVED***
  randomBytes: require('randombytes'),
  pseudoRandomBytes: crypto.pseudoRandomBytes
***REMOVED***

for (var randomBytesName in randomBytesFunctions) ***REMOVED***
  ...
  test('get error message', function (t) ***REMOVED***
    try ***REMOVED***
  ...
  ***REMOVED***)
  ...
  test(randomBytesName, function (t) ***REMOVED***
    t.plan(5)
    t.equal(randomBytes(10).length, 10)
    t.ok(Buffer.isBuffer(randomBytes(10)))
    randomBytes(10, function (ex, bytes) ***REMOVED***
      t.error(ex)
  ...
  ***REMOVED***)
  ...
  test(randomBytesName + ' seem random', function (t) ***REMOVED***
    var L = 1000
    var b = randomBytes(L)

    var mean = [].reduce.call(b, function (a, b) ***REMOVED*** return a + b ***REMOVED***, 0) / L
