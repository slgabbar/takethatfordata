...
function testit (keys, message, scheme) ***REMOVED***
  var pub = keys.public
  var priv = keys.private
  test(message.toString(), function (t) ***REMOVED***
    t.test('js sign and verify', function (t) ***REMOVED***
      t.plan(t)
    ...
    ***REMOVED***)
    ...
    t.test('node sign and verify', function (t) ***REMOVED***
      t.plan(t)
    ...
    ***REMOVED***)
    ...
    t.test('node sign and js verify', function (t) ***REMOVED***
      t.plan(t)
      var mySign = nodeCrypto.createSign(scheme)
      var mySig = mySign.update(message).sign(priv)
      var myVer = ourCrypto.createVerify(scheme)
    ...
    ***REMOVED***)
    ...
    t.test('js sign and node verify', function (t) ***REMOVED***
      t.plan(t)
      var mySign = ourCrypto.createSign(scheme)
      var mySig = mySign.update(message).sign(priv)
      var myVer = nodeCrypto.createVerify(scheme)
