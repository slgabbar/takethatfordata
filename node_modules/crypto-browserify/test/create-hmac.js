...
function testLib (name, createHmac) ***REMOVED***
  algorithms.forEach(function (alg) ***REMOVED***
    test(name + ' hmac(' + alg + ')', function (t) ***REMOVED***
      run(0)
      function run (i) ***REMOVED***
        if (i >= vectors.length) ***REMOVED***
          return t.end()
        ***REMOVED***
        var input = vectors[i]
    ...
    ***REMOVED***)
    ...
    test('hmac(' + alg + ')', function (t) ***REMOVED***
      run(0)
      function run (i) ***REMOVED***
        if (i >= vectors.length) ***REMOVED***
          return t.end()
