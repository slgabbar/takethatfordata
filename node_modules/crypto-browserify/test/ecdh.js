...
mods.forEach(function (mod) ***REMOVED***
  test('createECDH: ' + mod + ' uncompressed', function (t) ***REMOVED***
    t.plan(2)
  ...
  ***REMOVED***)
  ...
  test('createECDH: ' + mod + ' compressed', function (t) ***REMOVED***
    t.plan(2)
    var dh1 = createECDH1(mod)
    dh1.generateKeys()
    var dh2 = createECDH2(mod)
  ...
  ***REMOVED***)
  ...
  test('createECDH: ' + mod + ' set stuff', function (t) ***REMOVED***
    t.plan(5)
    var dh1 = createECDH1(mod)
    var dh2 = createECDH2(mod)
    dh1.generateKeys()
