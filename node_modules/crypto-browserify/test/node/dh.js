...
test('diffie-hellman mod groups', function (t) ***REMOVED***
  [
    'modp1', 'modp2', 'modp5', 'modp14', 'modp15', 'modp16'
  ].forEach(function (mod) ***REMOVED***
    t.test(mod, function (t) ***REMOVED***
      t.plan(3)
...
test('diffie-hellman key lengths', function (t) ***REMOVED***
  [
    64, 65, 192
  ].forEach(function (len) ***REMOVED***
    t.test('' + len, function (t) ***REMOVED***
      t.plan(3)
