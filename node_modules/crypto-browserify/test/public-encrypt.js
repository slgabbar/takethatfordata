...
test('publicEncrypt/privateDecrypt', function (t) ***REMOVED***
  t.test('can decrypt', function (t) ***REMOVED***
    t.plan(2)
  ...
  ***REMOVED***)
  t.test('can round trip', function (t) ***REMOVED***
    t.plan(2)
...
test('privateEncrypt/publicDecrypt', function (t) ***REMOVED***
  t.test('can round trip', function (t) ***REMOVED***
    t.plan(2)
    var msg = 'this is a message'
    // note encryption is ranomized so can't test to see if they encrypt the same
