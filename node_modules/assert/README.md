...
```javascript
assert.throws(function() ***REMOVED*** throw new Error("Wrong value"); ***REMOVED***, Error);
```

Validate error message using RegExp:

```javascript
assert.throws(function() ***REMOVED*** throw new Error("Wrong value"); ***REMOVED***, /value/);
```
...
***REMOVED***, function(err) ***REMOVED***
    if ( (err instanceof Error) && /value/.test(err) ) ***REMOVED***
        return true;
    ***REMOVED***
