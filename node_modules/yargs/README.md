...
if (argv.ships > 3 && argv.distance < 53.5) ***REMOVED***
...
function WARN()  ***REMOVED*** VERBOSE_LEVEL >= 0 && console.log.apply(console, arguments); ***REMOVED***
function INFO()  ***REMOVED*** VERBOSE_LEVEL >= 1 && console.log.apply(console, arguments); ***REMOVED***
function DEBUG() ***REMOVED*** VERBOSE_LEVEL >= 2 && console.log.apply(console, arguments); ***REMOVED***
...
***
	...
	$ ./demand_count.js a b
	***REMOVED*** _: [ 'a', 'b' ], '$0': 'demand_count.js' ***REMOVED***

	$ ./demand_count.js a b c
	***REMOVED*** _: [ 'a', 'b', 'c' ], '$0': 'demand_count.js' ***REMOVED***
...
#!/usr/bin/env node
var argv = require('yargs')
    .default(***REMOVED*** x : 10, y : 10 ***REMOVED***)
    .argv
;
console.log(argv.x + argv.y);
````
...
var argv = require('yargs')
  ...
  .command('publish', 'shiver me timbers, should you be sharing all that', function (yargs, argv) ***REMOVED***
    argv = yargs.option('f', ***REMOVED***
      alias: 'force',
...
```js
var argv = require('yargs')
  .completion('completion', function(current, argv) ***REMOVED***
...
```js
var argv = require('yargs')
  .completion('completion', function(current, argv, done) ***REMOVED***
...
```js
var argv = require('yargs')
  .config('settings', function (configPath) ***REMOVED***
...
```js
var argv = require('yargs')
  .default('random', function randomValue() ***REMOVED***
...
`***REMOVED*** _: [], token: '-my-token', '$0': 'node test' ***REMOVED***`
...
if (command === 'hello') ***REMOVED***
  ...
  console.log('hello!');
***REMOVED*** else if (command === 'world')***REMOVED***
  yargs.reset()
    .usage('$0 world')
    .help('h')
...
undefined or to override a default you can do `--no-key`.
    ...
    ***REMOVED*** _: [], a: true, b: false, '$0': 'examples/reflect.js' ***REMOVED***
...
all the values in order.
    ...
    ***REMOVED*** _: [], x: [ 5, 8, 0 ], '$0': 'examples/reflect.js' ***REMOVED***
...
This lets you organize arguments into nested objects.
    ...
    ***REMOVED*** _: [],
      foo: ***REMOVED*** bar: ***REMOVED*** baz: 33 ***REMOVED***, quux: 5 ***REMOVED***,
      '$0': 'examples/reflect.js' ***REMOVED***
...
Short numeric `-n5` style arguments work too:
    ...
    ***REMOVED*** _: [], n: 123, m: 456, '$0': 'examples/reflect.js' ***REMOVED***
