...
To add a stack line:
```javascript
var JSONError = errorEx('JSONError', ***REMOVED***fileName: errorEx.line('in %s')***REMOVED***);
...
```javascript
var JSONError = errorEx('JSONError', ***REMOVED***fileName: errorEx.append('in %s')***REMOVED***);
...
var AdvancedError = errorEx('AdvancedError', ***REMOVED***
	foo: ***REMOVED***
		line: function (value, stack) ***REMOVED***
			if (value) ***REMOVED***
				return 'bar ' + value;
			***REMOVED***
			return null;
...
var FileError = errorEx('FileError', ***REMOVED***fileName: errorEx.line('in %s')***REMOVED***);
...
var SyntaxError = errorEx('SyntaxError', ***REMOVED***fileName: errorEx.append('in %s')***REMOVED***);
