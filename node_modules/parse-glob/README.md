...
```js
parseGlob('a/b/c/**/*.***REMOVED***yml,json***REMOVED***');
```

**Returns:**

```js
***REMOVED*** orig: 'a/b/c/**/*.***REMOVED***yml,json***REMOVED***',
  is:
   ***REMOVED*** glob: true,
     negated: false,
     extglob: false,
  ...
  glob: '**/*.***REMOVED***yml,json***REMOVED***',
  base: 'a/b/c',
  path:
   ***REMOVED*** dirname: 'a/b/c/**/',
     basename: '*.***REMOVED***yml,json***REMOVED***',
     filename: '*',
     extname: '.***REMOVED***yml,json***REMOVED***',
     ext: '***REMOVED***yml,json***REMOVED***' ***REMOVED*** ***REMOVED***
```
...
* `is`: an object with boolean information about the glob:
  ...
  - `braces`: true if it has braces (`***REMOVED***1..2***REMOVED***` or `.***REMOVED***txt,md***REMOVED***`)
