...
/* XHR API */
var xhrApi = module.exports = forge.xhr = forge.xhr || ***REMOVED******REMOVED***;
...
interface XMLHttpRequest ***REMOVED***
  // event handler
 ...
 */
xhrApi.init = function(options) ***REMOVED***
  ...
  _sp = net.createSocketPool(***REMOVED***
  ...
  ***REMOVED***);
  ...
  _client = http.createClient(***REMOVED***
    url: options.url || (
 ...
 */
xhrApi.cleanup = function() ***REMOVED***
  // destroy all clients
  for(var key in _clients) ***REMOVED***
    _clients[key].destroy();
  ***REMOVED***
  _clients = ***REMOVED******REMOVED***;
  _client = null;
 ...
 */
xhrApi.setCookie = function(cookie) ***REMOVED***
  ...
  if(cookie.domain) ***REMOVED***
    ...
    for(var key in _clients) ***REMOVED***
      ...
      if(http.withinCookieDomain(client.url, cookie) &&
        client.secure === cookie.secure) ***REMOVED***
 ...
 */
xhrApi.getCookie = function(name, path, domain) ***REMOVED***
  var rval = null;
  ...
  if(domain) ***REMOVED***
    ...
    for(var key in _clients) ***REMOVED***
      var client = _clients[key];
      if(http.withinCookieDomain(client.url, domain)) ***REMOVED***
        var cookie = client.getCookie(name, path);
        if(cookie !== null) ***REMOVED***
          if(rval === null) ***REMOVED***
            rval = cookie;
          ***REMOVED*** else if(!forge.util.isArray(rval)) ***REMOVED***
            rval = [rval, cookie];
          ***REMOVED*** else ***REMOVED***
            rval.push(cookie);
          ***REMOVED***
 ...
 */
xhrApi.removeCookie = function(name, path, domain) ***REMOVED***
  var rval = false;
  ...
  if(domain) ***REMOVED***
    ...
    for(var key in _clients) ***REMOVED***
      var client = _clients[key];
      if(http.withinCookieDomain(client.url, domain)) ***REMOVED***
        if(client.removeCookie(name, path)) ***REMOVED***
           rval = true;
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
 ...
 */
xhrApi.create = function(options) ***REMOVED***
  // set option defaults
  options = $.extend(***REMOVED***
    logWarningOnError: true,
    verbose: false,
    logError: function() ***REMOVED******REMOVED***,
    logWarning: function() ***REMOVED******REMOVED***,
    logDebug: function() ***REMOVED******REMOVED***,
    logVerbose: function() ***REMOVED******REMOVED***,
    url: null
  ...
  ***REMOVED*** else ***REMOVED***
    ...
    ***REMOVED***
    ...
    // find client
    if(url.full in _clients) ***REMOVED***
      // client found
      _state.client = _clients[url.full];
    ***REMOVED*** else ***REMOVED***
      // create client
      _state.client = http.createClient(***REMOVED***
        url: options.url,
        socketPool: _sp,
  ...
  ***REMOVED***
   ...
   */
  xhr.open = function(method, url, async, user, password) ***REMOVED***
    ...
    ***REMOVED***
    ...
    _state.request = http.createRequest(***REMOVED***
      method: method,
      path: url
    ***REMOVED***);
    ...
    if(xhr.onreadystatechange) ***REMOVED***
  ...
  ***REMOVED***;
   ...
   */
  xhr.setRequestHeader = function(header, value) ***REMOVED***
    // 1. if state is not OPENED or send flag is true, raise exception
    if(xhr.readyState != OPENED || _state.sendFlag) ***REMOVED***
  ...
  ***REMOVED***;
   ...
   */
  xhr.send = function(data) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if(data &&
      ...
      _state.request.method !== 'HEAD') ***REMOVED***
      // handle non-IE case
      if(typeof(XMLSerializer) !== 'undefined') ***REMOVED***
        if(data instanceof Document) ***REMOVED***
      ...
      ***REMOVED*** else ***REMOVED***
        ...
        if(typeof(data.xml) !== 'undefined') ***REMOVED***
    ...
    ***REMOVED***
    ...
    options.headerReady = function(e) ***REMOVED***
      ...
      if(xhr.onreadystatechange) ***REMOVED***
        xhr.onreadystatechange();
      ***REMOVED***
      if(!_state.response.aborted) ***REMOVED***
        // now loading body
      ...
      ***REMOVED***
    ***REMOVED***;
    options.bodyReady = function(e) ***REMOVED***
      xhr.readyState = DONE;
      ...
      ***REMOVED***
      ...
      var length = 0;
      if(e.response.body !== null) ***REMOVED***
      ...
      ***REMOVED***
    ***REMOVED***;
    options.error = function(e) ***REMOVED***
      var req = _state.request;
  ...
  ***REMOVED***;
  ...
  xhr.abort = function() ***REMOVED***
    ...
    if(xhr.readyState === DONE || xhr.readyState === UNSENT ||
     (xhr.readyState === OPENED && !_state.sendFlag)) ***REMOVED***
  ...
  ***REMOVED***;
   ...
   */
  xhr.getAllResponseHeaders = function() ***REMOVED***
    var rval = '';
    if(_state.response !== null) ***REMOVED***
      var fields = _state.response.fields;
      $.each(fields, function(name, array) ***REMOVED***
        $.each(array, function(i, value) ***REMOVED***
          rval += name + ': ' + value + '\r\n';
        ***REMOVED***);
      ***REMOVED***);
    ***REMOVED***
  ...
  ***REMOVED***;
   ...
   */
  xhr.getResponseHeader = function(header) ***REMOVED***
    var rval = null;
    if(_state.response !== null) ***REMOVED***
      if(header in _state.response.fields) ***REMOVED***
        rval = _state.response.fields[header];
        if(forge.util.isArray(rval)) ***REMOVED***
          rval = rval.join();
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
