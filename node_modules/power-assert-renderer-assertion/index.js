...
function AssertionRenderer () ***REMOVED***
    BaseRenderer.call(this);
***REMOVED***
inherits(AssertionRenderer, BaseRenderer);

AssertionRenderer.prototype.onStart = function (context) ***REMOVED***
    this.context = context;
    this.assertionLine = context.source.content;
***REMOVED***;

AssertionRenderer.prototype.onEnd = function () ***REMOVED***
    this.write('');
    this.write(this.assertionLine);
    var e = this.context.source.error;
    if (e && e instanceof SyntaxError) ***REMOVED***
...
AssertionRenderer.prototype.renderValueAt = function (idx, str) ***REMOVED***
    var row = createRow(stringWidth(this.assertionLine), ' ');
    replaceColumn(idx, row, str);
    this.write(row.join(''));
***REMOVED***;

function replaceColumn (columnIndex, row, str) ***REMOVED***
