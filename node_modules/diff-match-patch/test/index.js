...
function assertEquivalent(msg, expected, actual) ***REMOVED***
  if (typeof actual == 'undefined') ***REMOVED***
    // msg is optional.
    actual = expected;
    expected = msg;
    msg = 'Expected: \'' + expected + '\' Actual: \'' + actual + '\'';
  ***REMOVED***
  if (_equivalent(expected, actual)) ***REMOVED***
...
function _equivalent(a, b) ***REMOVED***
  if (a == b) ***REMOVED***
    return true;
  ***REMOVED***
  if (typeof a == 'object' && typeof b == 'object' && a !== null && b !== null) ***REMOVED***
    if (a.toString() != b.toString()) ***REMOVED***
      return false;
    ***REMOVED***
    for (var p in a) ***REMOVED***
      if (!_equivalent(a[p], b[p])) ***REMOVED***
        return false;
      ***REMOVED***
    ***REMOVED***
    for (var p in b) ***REMOVED***
      if (!_equivalent(a[p], b[p])) ***REMOVED***
        return false;
      ***REMOVED***
    ***REMOVED***
...
function diff_rebuildtexts(diffs) ***REMOVED***
...
function testDiffCommonPrefix() ***REMOVED***
...
function testDiffCommonSuffix() ***REMOVED***
...
function testDiffCommonOverlap() ***REMOVED***
...
function testDiffHalfMatch() ***REMOVED***
  // Detect a halfmatch.
  dmp.Diff_Timeout = 1;
  // No match.
...
function testDiffLinesToChars() ***REMOVED***
  function assertLinesToCharsResultEquals(a, b) ***REMOVED***
  ...
  ***REMOVED***
  ...
  assertLinesToCharsResultEquals(***REMOVED***chars1: '\x01\x02\x01', chars2: '\x02\x01\x02', lineArray: ['', 'alpha\n', 'beta\n']***REMOVED***, dmp.diff_linesToChars_('alpha\nbeta\nalpha\n', 'beta\nalpha\nbeta\n'));

  assertLinesToCharsResultEquals(***REMOVED***chars1: '', chars2: '\x01\x02\x03\x03', lineArray: ['', 'alpha\r\n', 'beta\r\n', '\r\n']***REMOVED***, dmp.diff_linesToChars_('', 'alpha\r\nbeta\r\n\r\n\r\n'));

  assertLinesToCharsResultEquals(***REMOVED***chars1: '\x01', chars2: '\x02', lineArray: ['', 'a', 'b']***REMOVED***, dmp.diff_linesToChars_('a', 'b'));

  // More than 256 to reveal any 8-bit limitations.
  var n = 300;
  var lineList = [];
  var charList = [];
  for (var x = 1; x < n + 1; x++) ***REMOVED***
    lineList[x - 1] = x + '\n';
  ...
  ***REMOVED***
  ...
  lineList.unshift('');
  assertLinesToCharsResultEquals(***REMOVED***chars1: chars, chars2: '', lineArray: lineList***REMOVED***, dmp.diff_linesToChars_(lines, ''));
***REMOVED***

function testDiffCharsToLines() ***REMOVED***
...
function testDiffCleanupMerge() ***REMOVED***
...
function testDiffCleanupSemanticLossless() ***REMOVED***
...
function testDiffCleanupSemantic() ***REMOVED***
...
function testDiffCleanupEfficiency() ***REMOVED***
...
function testDiffPrettyHtml() ***REMOVED***
  // Pretty print.
...
function testDiffDelta() ***REMOVED***
...
function testDiffXIndex() ***REMOVED***
...
function testDiffLevenshtein() ***REMOVED***
...
function testDiffBisect() ***REMOVED***
  // Normal.
  var a = 'cat';
  var b = 'map';
...
function testMatchAlphabet() ***REMOVED***
  // Initialise the bitmasks for Bitap.
  // Unique.
  assertEquivalent(***REMOVED***'a':4, 'b':2, 'c':1***REMOVED***, dmp.match_alphabet_('abc'));

  // Duplicates.
  assertEquivalent(***REMOVED***'a':37, 'b':18, 'c':8***REMOVED***, dmp.match_alphabet_('abcaba'));
***REMOVED***

function testMatchBitap() ***REMOVED***
  // Bitap algorithm.
...
function testMatchMain() ***REMOVED***
  // Full match.
  // Shortcut matches.
...
function testPatchFromText() ***REMOVED***
...
function testPatchToText() ***REMOVED***
  var strp = '@@ -21,18 +22,17 @@\n jump\n-s\n+ed\n  over \n-the\n+a\n  laz\n';
...
function testPatchAddContext() ***REMOVED***
  dmp.Patch_Margin = 4;
...
function testPatchMake() ***REMOVED***
  // Null case.
  ...
  // Character encoding.
  patches = dmp.patch_make('`1234567890-=[]\\;\',./', '~!@#$%^&*()_+***REMOVED******REMOVED***|:"<>?');
  assertEquals('@@ -1,21 +1,21 @@\n-%601234567890-=%5B%5D%5C;\',./\n+~!@#$%25%5E&*()_+%7B%7D%7C:%22%3C%3E?\n', dmp.patch_toText(patches));

  // Character decoding.
  diffs = [[DIFF_DELETE, '`1234567890-=[]\\;\',./'], [DIFF_INSERT, '~!@#$%^&*()_+***REMOVED******REMOVED***|:"<>?']];
  assertEquivalent(diffs, dmp.patch_fromText('@@ -1,21 +1,21 @@\n-%601234567890-=%5B%5D%5C;\',./\n+~!@#$%25%5E&*()_+%7B%7D%7C:%22%3C%3E?\n')[0].diffs);

  // Long string with repeats.
  text1 = '';
  for (var x = 0; x < 100; x++) ***REMOVED***
    text1 += 'abcdef';
  ***REMOVED***
  text2 = text1 + '123';
...
function testPatchSplitMax() ***REMOVED***
...
function testPatchAddPadding() ***REMOVED***
  // Both edges full.
...
function testPatchApply() ***REMOVED***
...
function assertEquals(msg, expected, actual) ***REMOVED***
  if (typeof actual == 'undefined') ***REMOVED***
    // msg is optional.
    actual = expected;
    expected = msg;
...
function assertTrue(msg, actual) ***REMOVED***
  if (typeof actual == 'undefined') ***REMOVED***
    // msg is optional.
    actual = msg;
...
function assertFalse(msg, actual) ***REMOVED***
  if (typeof actual == 'undefined') ***REMOVED***
    // msg is optional.
    actual = msg;
...
var tests = [
  ...
  for (var x = 0; x < tests.length; x++) ***REMOVED***
