...
tape.test("float", function(test) ***REMOVED***

    // default
    test.test(test.name + " - typed array", function(test) ***REMOVED***
        runTest(float, test);
    ***REMOVED***);

    // ieee754
    test.test(test.name + " - fallback", function(test) ***REMOVED***
        var F32 = global.Float32Array,
            F64 = global.Float64Array;
        delete global.Float32Array;
        delete global.Float64Array;
        runTest(float(***REMOVED******REMOVED***), test);
        global.Float32Array = F32;
        global.Float64Array = F64;
    ***REMOVED***);
***REMOVED***);

function runTest(float, test) ***REMOVED***
    ...
    test.test(test.name + " - using 32 bits", function(test) ***REMOVED***
        common.concat([
            3.4028234663852886e+38,
            1.1754943508222875e-38,
            1.1754946310819804e-39
        ])
        .forEach(function(value) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    test.test(test.name + " - using 64 bits", function(test) ***REMOVED***
        common.concat([
...
function checkValue(value, size, read, write, write_comp) ***REMOVED***
