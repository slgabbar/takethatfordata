...
tape.test("utf8", function(test) ***REMOVED***

    test.test(test.name + " - length", function(test) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    test.test(test.name + " - read", function(test) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    test.test(test.name + " - write", function(test) ***REMOVED***
