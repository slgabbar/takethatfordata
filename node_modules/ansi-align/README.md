...
Alias for `ansiAlign(text, ***REMOVED*** align: 'center' ***REMOVED***)`.

### `ansiAlign.right(text)`

Alias for `ansiAlign(text, ***REMOVED*** align: 'right' ***REMOVED***)`.

### `ansiAlign.left(text)`

Alias for `ansiAlign(text, ***REMOVED*** align: 'left' ***REMOVED***)`, which is a no-op.
