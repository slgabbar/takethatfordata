...
var serve = serveStatic('public/ftp', ***REMOVED***'index': ['index.html', 'index.htm']***REMOVED***)

// Create server
var server = http.createServer(function onRequest (req, res) ***REMOVED***
...
// Serve up public/ftp folder
var serve = serveStatic('public/ftp', ***REMOVED***
  'index': false,
  'setHeaders': setHeaders
***REMOVED***)

// Set header to force download
function setHeaders (res, path) ***REMOVED***
...
app.use(serveStatic('public/ftp', ***REMOVED***'index': ['default.html', 'default.htm']***REMOVED***))
app.listen(3000)
```
...
app.use(serveStatic(path.join(__dirname, 'public'), ***REMOVED***
  maxAge: '1d',
...
function setCustomCacheControl (res, path) ***REMOVED***
  if (serveStatic.mime.lookup(path) === 'text/html') ***REMOVED***
