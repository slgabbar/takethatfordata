...
```javascript
var logger = require('log-driver')(***REMOVED***
...
```javascript
var logger = require('log-driver')(***REMOVED*** level: "info" ***REMOVED***);
...
output clean):
```javascript
var logger = require('log-driver')(***REMOVED*** level: false ***REMOVED***);
```
