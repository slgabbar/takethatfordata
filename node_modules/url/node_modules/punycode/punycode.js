...
;(function(root) ***REMOVED***
	...
	***REMOVED*** else if (freeExports && freeModule) ***REMOVED***
		if (module.exports == freeExports) ***REMOVED*** // in Node.js or RingoJS v0.8.0+
			freeModule.exports = punycode;
		***REMOVED*** else ***REMOVED*** // in Narwhal or RingoJS v0.7.0-
			for (key in punycode) ***REMOVED***
				punycode.hasOwnProperty(key) && (freeExports[key] = punycode[key]);
			***REMOVED***
		***REMOVED***
	***REMOVED*** else ***REMOVED*** // in Rhino or a web browser
