...
* `query`: Either the 'params' portion of the query string, or a
  querystring-parsed object.
    ...
    Example: `'query=string'` or `***REMOVED***'query':'string'***REMOVED***`
...
`***REMOVED*** host: 'foo', pathname: '/bar' ***REMOVED***` rather than
`***REMOVED*** pathname: '//foo/bar' ***REMOVED***`. Defaults to `false`.
