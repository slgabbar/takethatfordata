 ...
 */
var InstanceIdInternals = /** @class */ (function () ***REMOVED***
    function InstanceIdInternals() ***REMOVED***
    ***REMOVED***
    /**
     ...
     */
    InstanceIdInternals.prototype.delete = function () ***REMOVED***
        // There are no resources to clean up
        return Promise.resolve(undefined);
    ***REMOVED***;
    return InstanceIdInternals;
***REMOVED***());
var InstanceId = /** @class */ (function () ***REMOVED***
    /**
     * @param ***REMOVED***Object***REMOVED*** app The app for this InstanceId service.
     * @constructor
     */
    function InstanceId(app) ***REMOVED***
    ...
    ***REMOVED***
     ...
     * Regulation (GDPR).
     *
     * @param ***REMOVED***string***REMOVED*** instanceId The instance ID to be deleted
     * @return ***REMOVED***Promise<void>***REMOVED*** A promise that resolves when the instance ID is successfully deleted.
     */
    InstanceId.prototype.deleteInstanceId = function (instanceId) ***REMOVED***
        return this.requestHandler.deleteInstanceId(instanceId)
            .then(function (result) ***REMOVED***
            // Return nothing on success
        ***REMOVED***);
    ***REMOVED***;
    Object.defineProperty(InstanceId.prototype, "app", ***REMOVED***
        /**
         * Returns the app associated with this InstanceId instance.
         *
         * @return ***REMOVED***FirebaseApp***REMOVED*** The app associated with this InstanceId instance.
         */
