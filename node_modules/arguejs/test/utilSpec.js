define(['argue', 'chai'], function(__, chai) ***REMOVED***
  ...
  describe('utilities', function() ***REMOVED***

    describe('getType', function() ***REMOVED***

      it('gives us the right types', function() ***REMOVED***
        ...
        should.equal(__.getType( function()***REMOVED******REMOVED*** ), Function);
        should.equal(__.getType( ***REMOVED***key:"value"***REMOVED***), Object);
    ...
    ***REMOVED***);
    ...
    describe('typeof', function() ***REMOVED***

      it('gives us the right names', function() ***REMOVED***
        ...
        should.equal(__.typeof( function()***REMOVED******REMOVED*** ), "Function");
        should.equal(__.typeof( ***REMOVED***key:"value"***REMOVED***), "Object");
    ...
    ***REMOVED***);
    ...
    describe('belongs', function() ***REMOVED***

      it('should not accept Null and Undefined types', function() ***REMOVED***
        //right:
      ...
      ***REMOVED***);
      ...
      it('should check when a instance is String typed', function() ***REMOVED***
        //right:
        ...
        expect(__.belongs(function()***REMOVED******REMOVED***, String)).to.be.false;
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, String)).to.be.false;
        expect(__.belongs(new Date(), String)).to.be.false;
        expect(__.belongs(new RegExp(), String)).to.be.false;

      ***REMOVED***);

      it('should check when a instance is Number typed', function() ***REMOVED***
        //right:
        ...
        expect(__.belongs(function()***REMOVED******REMOVED***, Number)).to.be.false;
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, Number)).to.be.false;
        expect(__.belongs(new Date(), Number)).to.be.false;
        expect(__.belongs(new RegExp(), Number)).to.be.false;

      ***REMOVED***);

      it('should check when a instance is Boolean typed', function() ***REMOVED***
        //right:
        ...
        expect(__.belongs(function()***REMOVED******REMOVED***, Boolean)).to.be.false;
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, Boolean)).to.be.false;
        expect(__.belongs(new Date(), Boolean)).to.be.false;
        expect(__.belongs(new RegExp(), Boolean)).to.be.false;

      ***REMOVED***);

      it('should check when a instance is Array typed', function() ***REMOVED***
        //right:
        ...
        expect(__.belongs(function()***REMOVED******REMOVED***, Array)).to.be.false;
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, Array)).to.be.false;
        expect(__.belongs(new Date(), Array)).to.be.false;
        expect(__.belongs(new RegExp(), Array)).to.be.false;

      ***REMOVED***);

      it('should check when a instance is Function typed', function() ***REMOVED***
        //right:
        expect(__.belongs(function()***REMOVED******REMOVED***, Function)).to.be.true;
        ...
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, Function)).to.be.false;
        expect(__.belongs(new Date(), Function)).to.be.false;
        expect(__.belongs(new RegExp(), Function)).to.be.false;

      ***REMOVED***);

      it('should check when a instance is Object typed', function() ***REMOVED***
        //right:
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, Object)).to.be.true;
        ...
        expect(__.belongs(function()***REMOVED******REMOVED***, Object)).to.be.false;
        expect(__.belongs(new Date(), Object)).to.be.false;
        expect(__.belongs(new RegExp(), Object)).to.be.false;

      ***REMOVED***);

      it('should check when a instance is Date typed', function() ***REMOVED***
        //right:
        ...
        expect(__.belongs(function()***REMOVED******REMOVED***, Date)).to.be.false;
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, Date)).to.be.false;
        expect(__.belongs(new RegExp(), Date)).to.be.false;

      ***REMOVED***);


      it('should check when a instance is RegExp typed', function() ***REMOVED***
        //right:
        ...
        expect(__.belongs(function()***REMOVED******REMOVED***, RegExp)).to.be.false;
        expect(__.belongs(***REMOVED***key:"value"***REMOVED***, RegExp)).to.be.false;
