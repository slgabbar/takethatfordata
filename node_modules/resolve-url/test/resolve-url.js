...
test("resolveUrl", function(t) ***REMOVED***
...
test("edge cases", function(t) ***REMOVED***
  ...
  var result
  t.doesNotThrow(
    function() ***REMOVED*** result = resolveUrl(accidentallyUndefined) ***REMOVED***,
    "undefined is still an argument"
  )
  t.ok(result.match(/\/undefined$/), "undefined is stringified")

  t.equal(
    resolveUrl("http://foo.org/test", undefined, ***REMOVED******REMOVED***, ["a/b"], null),
    "http://foo.org/a/null",
