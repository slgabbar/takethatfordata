declare module "grpc" ***REMOVED***
  import ***REMOVED*** Message, Service ***REMOVED*** from "protobufjs";
  import ***REMOVED*** Duplex, Readable, Writable ***REMOVED*** from "stream";
  import ***REMOVED*** SecureContext ***REMOVED*** from "tls";
   ...
   */
  export interface LoadObjectOptions ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   * A filename
   */
  export type Filename = string | ***REMOVED*** root: string, file: string ***REMOVED***;

  /**
   * Options for loading proto file as gRPC object
   */
  export interface LoadOptions ***REMOVED***
    /**
  ...
  ***REMOVED***
  ...
  export class Server ***REMOVED***
     ...
     */
    addService(service: Service, implementation: ***REMOVED*** [name: string]: handleCall ***REMOVED***): void;
     ...
     * for the provided service.
     */
    addProtoService(service: Service | ServiceDefinition, implementation: ***REMOVED*** [name: string]: handleCall ***REMOVED***): void;
  ...
  ***REMOVED***
   ...
   * @typedef ***REMOVED***Object.<string, grpc~MethodDefinition>***REMOVED*** grpc~ServiceDefinition
   */
  export interface ServiceDefinition ***REMOVED***
  ...
  ***REMOVED***
   ...
   */
  export interface MethodDefinition ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   */
  export class ServerUnaryCall ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   */
  export class ServerReadableStream extends Readable ***REMOVED***
    /**
     * Indicates if the call has been cancelled
     */
    cancelled: boolean;
  ...
  ***REMOVED***
   ...
   */
  export class ServerWriteableStream extends Writable ***REMOVED***
    /**
     * Indicates if the call has been cancelled
     */
    cancelled: boolean;
  ...
  ***REMOVED***
   ...
   */
  export class ServerDuplexStream extends Duplex ***REMOVED***
    private constructor();
  ...
  ***REMOVED***
   ...
   */
  export interface ServiceError extends Error ***REMOVED***
    /**
     * The error code, a key of ***REMOVED***@link grpc.status***REMOVED*** that is not `grpc.status.OK`
     */
    code?: status;
    /**
     * Trailing metadata sent with the status, if applicable
  ...
  ***REMOVED***
   ...
   */
  export class ServerCredentials ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   * how data is written.
   */
  export enum writeFlags ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   */
  export enum logVerbosity ***REMOVED***
    DEBUG,
    INFO,
    ERROR,
  ***REMOVED***
  ...
  ***REMOVED***;
   ...
   */
  export type metadataGenerator = (params: ***REMOVED*** service_url: string ***REMOVED***, callback: (error: Error | null, metadata?: Metadata) => void) => void;
   ...
   */
  export interface ChannelCredentials ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   * be created using the factory functions in `grpc.credentials`
   */
  export interface CallCredentials ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   */
  export interface GoogleOAuth2Client ***REMOVED***
  ...
  ***REMOVED***
   ...
   */
  export interface GenericClientOptions ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   * An EventEmitter. Used for unary calls.
   */
  export class ClientUnaryCall ***REMOVED***
    private constructor();
  ...
  ***REMOVED***
   ...
   * from the server side.
   */
  export class ClientReadableStream extends Readable ***REMOVED***
    private constructor();
  ...
  ***REMOVED***
   ...
   * the client side.
   */
  export class ClientWritableStream extends Writable ***REMOVED***
    private constructor();
     ...
     * @return As defined for [Writable]***REMOVED***@link external:Writable***REMOVED***
     */
  ...
  ***REMOVED***
   ...
   * duplex streaming.
   */
  export class ClientDuplexStream extends Duplex ***REMOVED***
    private constructor();
