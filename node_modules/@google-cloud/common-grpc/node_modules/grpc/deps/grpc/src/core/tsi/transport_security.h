...
***REMOVED*** tsi_frame_protector_vtable;

struct tsi_frame_protector ***REMOVED***
...
***REMOVED*** tsi_handshaker_vtable;

struct tsi_handshaker ***REMOVED***
...
***REMOVED*** tsi_handshaker_result_vtable;

struct tsi_handshaker_result ***REMOVED***
