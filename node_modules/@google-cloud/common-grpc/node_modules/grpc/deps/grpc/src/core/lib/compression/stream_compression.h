...
typedef struct grpc_stream_compression_context ***REMOVED***
  const grpc_stream_compression_vtable *vtable;
***REMOVED*** grpc_stream_compression_context;

typedef enum grpc_stream_compression_method ***REMOVED***
...
***REMOVED*** grpc_stream_compression_method;

typedef enum grpc_stream_compression_flush ***REMOVED***
  GRPC_STREAM_COMPRESSION_FLUSH_NONE = 0,
  GRPC_STREAM_COMPRESSION_FLUSH_SYNC,
  GRPC_STREAM_COMPRESSION_FLUSH_FINISH,
  GRPC_STREAM_COMPRESSION_FLUSH_COUNT
***REMOVED*** grpc_stream_compression_flush;

struct grpc_stream_compression_vtable ***REMOVED***
