...
size_t grpc_pollset_size() ***REMOVED*** return sizeof(grpc_pollset); ***REMOVED***

void dummy_timer_cb(uv_timer_t *handle) ***REMOVED******REMOVED***

void dummy_handle_close_cb(uv_handle_t *handle) ***REMOVED*** gpr_free(handle); ***REMOVED***
...
void grpc_pollset_global_shutdown(void) ***REMOVED***
  GRPC_UV_ASSERT_SAME_THREAD();
  gpr_mu_destroy(&grpc_polling_mu);
  uv_close((uv_handle_t *)dummy_uv_handle, dummy_handle_close_cb);
***REMOVED***

static void timer_run_cb(uv_timer_t *timer) ***REMOVED******REMOVED***

static void timer_close_cb(uv_handle_t *handle) ***REMOVED*** handle->data = (void *)1; ***REMOVED***
...
void grpc_pollset_shutdown(grpc_exec_ctx *exec_ctx, grpc_pollset *pollset,
  ...
  if (grpc_pollset_work_run_loop) ***REMOVED***
...
void grpc_pollset_destroy(grpc_exec_ctx *exec_ctx, grpc_pollset *pollset) ***REMOVED***
  ...
  if (grpc_pollset_work_run_loop) ***REMOVED***
    while (!pollset->timer.data) ***REMOVED***
      uv_run(uv_default_loop(), UV_RUN_NOWAIT);
    ***REMOVED***
  ***REMOVED***
***REMOVED***
