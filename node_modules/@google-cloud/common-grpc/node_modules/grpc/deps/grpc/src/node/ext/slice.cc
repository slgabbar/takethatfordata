...
namespace ***REMOVED***
void SliceFreeCallback(char *data, void *hint) ***REMOVED***
  grpc_slice *slice = reinterpret_cast<grpc_slice *>(hint);
  grpc_slice_unref(*slice);
  delete slice;
***REMOVED***

void string_destroy_func(void *user_data) ***REMOVED***
  delete reinterpret_cast<Nan::Utf8String *>(user_data);
***REMOVED***

void buffer_destroy_func(void *user_data) ***REMOVED***
  delete reinterpret_cast<PersistentValue *>(user_data);
***REMOVED***
***REMOVED***  // namespace

grpc_slice CreateSliceFromString(const Local<String> source) ***REMOVED***
...
grpc_slice CreateSliceFromBuffer(const Local<Value> source) ***REMOVED***
...
***REMOVED***
Local<String> CopyStringFromSlice(const grpc_slice slice) ***REMOVED***
...
Local<Value> CreateBufferFromSlice(const grpc_slice slice) ***REMOVED***
  Nan::EscapableHandleScope scope;
