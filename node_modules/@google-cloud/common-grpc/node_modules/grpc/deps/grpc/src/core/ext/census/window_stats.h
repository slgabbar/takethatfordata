...
/* Keep rolling sums of a user-defined statistic (containing a number of
   ...
   4 buckets.
    ...
    typedef struct my_stat ***REMOVED***
      double latency;
      int bytes;
    ***REMOVED*** my_stat;

    void add_my_stat(void* base, const void* addme) ***REMOVED***
    ...
    ***REMOVED***
    ...
    void add_proportion_my_stat(double p, void* base, const void* addme) ***REMOVED***
    ...
    ***REMOVED***
    ...
    const struct census_window_stats_stat_info kMyStatInfo
        = ***REMOVED*** sizeof(my_stat), NULL, add_my_stat, add_proportion_my_stat ***REMOVED***;
    gpr_timespec intervals[kNumIntervals] = ***REMOVED******REMOVED***60, 0***REMOVED***, ***REMOVED***3600, 0***REMOVED******REMOVED***;
    my_stat stat;
...
typedef struct census_window_stats_stat_info ***REMOVED***
...
***REMOVED*** census_window_stats_stat_info;
...
typedef struct census_window_stats_sum ***REMOVED***
  ...
  /* Sum for statistic */
  void *statistic;
***REMOVED*** census_window_stats_sums;
