...
/* Struct definitions */
typedef struct _google_trace_TraceContext ***REMOVED***
...
***REMOVED*** google_trace_TraceContext;

/* Default values for struct fields */

/* Initializer values for message structs */
#define google_trace_TraceContext_init_default   ***REMOVED***false, 0, false, 0, false, 0, false, 0***REMOVED***
#define google_trace_TraceContext_init_zero      ***REMOVED***false, 0, false, 0, false, 0, false, 0***REMOVED***
