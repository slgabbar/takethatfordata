...
void grpc_pid_controller_init(grpc_pid_controller *pid_controller,
                              grpc_pid_controller_args args) ***REMOVED***
...
void grpc_pid_controller_reset(grpc_pid_controller *pid_controller) ***REMOVED***
...
double grpc_pid_controller_update(grpc_pid_controller *pid_controller,
                                  double error, double dt) ***REMOVED***
...
double grpc_pid_controller_last(grpc_pid_controller *pid_controller) ***REMOVED***
