...
static grpc_call_credentials_vtable iam_vtable = ***REMOVED***
    iam_destruct, iam_get_request_metadata, iam_cancel_get_request_metadata***REMOVED***;

grpc_call_credentials *grpc_google_iam_credentials_create(
    const char *token, const char *authority_selector, void *reserved) ***REMOVED***
