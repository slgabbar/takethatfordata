...
typedef struct grpc_mdelem_data ***REMOVED***
  const grpc_slice key;
  const grpc_slice value;
  /* there is a private part to this in metadata.c */
***REMOVED*** grpc_mdelem_data;
...
***REMOVED*** grpc_mdelem_data_storage;

struct grpc_mdelem ***REMOVED***
...
#define GRPC_MAKE_MDELEM(data, storage) \
  ((grpc_mdelem)***REMOVED***((uintptr_t)(data)) | ((uintptr_t)storage)***REMOVED***)
