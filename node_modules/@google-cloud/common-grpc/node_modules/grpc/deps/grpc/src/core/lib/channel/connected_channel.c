...
typedef struct connected_channel_channel_data ***REMOVED***
...
typedef struct ***REMOVED***
  ...
  const char *reason;
***REMOVED*** callback_state;

typedef struct connected_channel_call_data ***REMOVED***
  grpc_call_combiner *call_combiner;
...
static void intercept_callback(call_data *calld, callback_state *state,
                               ...
                               grpc_closure **original_closure) ***REMOVED***
...
static void con_get_channel_info(grpc_exec_ctx *exec_ctx,
                                 grpc_channel_element *elem,
                                 const grpc_channel_info *channel_info) ***REMOVED******REMOVED***

const grpc_channel_filter grpc_connected_filter = ***REMOVED***
...
static void bind_transport(grpc_channel_stack *channel_stack,
                           grpc_channel_element *elem, void *t) ***REMOVED***
  channel_data *cd = (channel_data *)elem->channel_data;
...
grpc_stream *grpc_connected_channel_get_stream(grpc_call_element *elem) ***REMOVED***
  call_data *calld = (call_data *)elem->call_data;
