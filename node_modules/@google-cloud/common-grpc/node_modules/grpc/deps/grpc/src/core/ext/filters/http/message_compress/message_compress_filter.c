...
***REMOVED*** initial_metadata_state;
...
static bool skip_compression(grpc_call_element *elem, uint32_t flags,
                             bool has_compression_algorithm) ***REMOVED***
  call_data *calld = (call_data *)elem->call_data;
  channel_data *channeld = (channel_data *)elem->channel_data;

  if (flags & (GRPC_WRITE_NO_COMPRESS | GRPC_WRITE_INTERNAL_COMPRESS)) ***REMOVED***
    return true;
  ***REMOVED***
  if (has_compression_algorithm) ***REMOVED***
    if (calld->compression_algorithm == GRPC_COMPRESS_NONE) ***REMOVED***
      return true;
    ***REMOVED***
...
static grpc_error *process_send_initial_metadata(
    grpc_exec_ctx *exec_ctx, grpc_call_element *elem,
    grpc_metadata_batch *initial_metadata, bool *has_compression_algorithm) ***REMOVED***
  call_data *calld = (call_data *)elem->call_data;
  channel_data *channeld = (channel_data *)elem->channel_data;
  *has_compression_algorithm = false;
  ...
  if (initial_metadata->idx.named.grpc_internal_stream_encoding_request !=
    ...
    if (!grpc_stream_compression_algorithm_parse(
            GRPC_MDVALUE(md), &stream_compression_algorithm)) ***REMOVED***
    ...
    ***REMOVED***
    if (!GPR_BITGET(channeld->enabled_stream_compression_algorithms_bitset,
                    stream_compression_algorithm)) ***REMOVED***
      char *val = grpc_slice_to_c_string(GRPC_MDVALUE(md));
      gpr_log(
          GPR_ERROR,
    ...
    *has_compression_algorithm = true;
    ...
    if (initial_metadata->idx.named.grpc_internal_encoding_request != NULL) ***REMOVED***
      grpc_metadata_batch_remove(
          exec_ctx, initial_metadata,
          initial_metadata->idx.named.grpc_internal_encoding_request);
    ***REMOVED***
  ***REMOVED*** else if (initial_metadata->idx.named.grpc_internal_encoding_request !=
             NULL) ***REMOVED***
    grpc_mdelem md =
        initial_metadata->idx.named.grpc_internal_encoding_request->md;
    if (!grpc_compression_algorithm_parse(GRPC_MDVALUE(md),
                                          &calld->compression_algorithm)) ***REMOVED***
      char *val = grpc_slice_to_c_string(GRPC_MDVALUE(md));
      gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  if (stream_compression_algorithm != GRPC_STREAM_COMPRESS_NONE) ***REMOVED***
    error = grpc_metadata_batch_add_tail(
        exec_ctx, initial_metadata,
        &calld->stream_compression_algorithm_storage,
        grpc_stream_compression_encoding_mdelem(stream_compression_algorithm));
  ***REMOVED*** else if (calld->compression_algorithm != GRPC_COMPRESS_NONE) ***REMOVED***
    error = grpc_metadata_batch_add_tail(
  ...
  ***REMOVED***
  ...
  if (!initial_metadata->idx.named.accept_encoding) ***REMOVED***
    error = grpc_metadata_batch_add_tail(
...
static void fail_send_message_batch_in_call_combiner(grpc_exec_ctx *exec_ctx,
  ...
  if (calld->send_message_batch != NULL) ***REMOVED***
  ...
  while (grpc_byte_stream_next(
    ...
    ***REMOVED***
    if (calld->slices.length ==
        calld->send_message_batch->payload->send_message.send_message->length) ***REMOVED***
...
static void start_send_message_batch(grpc_exec_ctx *exec_ctx, void *arg,
                                     grpc_error *unused) ***REMOVED***
  grpc_call_element *elem = (grpc_call_element *)arg;
  call_data *calld = (call_data *)elem->call_data;
  if (skip_compression(
          elem,
          calld->send_message_batch->payload->send_message.send_message->flags,
          calld->send_initial_metadata_state == HAS_COMPRESSION_ALGORITHM)) ***REMOVED***
    send_message_batch_continue(exec_ctx, elem);
  ***REMOVED*** else ***REMOVED***
    continue_reading_send_message(exec_ctx, elem);
  ***REMOVED***
...
static void compress_start_transport_stream_op_batch(
  ...
  if (batch->cancel_stream) ***REMOVED***
    ...
    if (calld->send_message_batch != NULL) ***REMOVED***
      if (calld->send_initial_metadata_state == INITIAL_METADATA_UNSEEN) ***REMOVED***
      ...
      ***REMOVED***
    ***REMOVED***
  ***REMOVED*** else if (calld->cancel_error != GRPC_ERROR_NONE) ***REMOVED***
    grpc_transport_stream_op_batch_finish_with_failure(
...
static grpc_error *init_channel_elem(grpc_exec_ctx *exec_ctx,
  ...
  if (!GPR_BITGET(channeld->enabled_algorithms_bitset,
                  channeld->default_compression_algorithm)) ***REMOVED***
    gpr_log(GPR_DEBUG,
  ...
  ***REMOVED***
  ...
  if (!GPR_BITGET(channeld->enabled_stream_compression_algorithms_bitset,
                  channeld->default_stream_compression_algorithm)) ***REMOVED***
    gpr_log(GPR_DEBUG,
...
static void destroy_channel_elem(grpc_exec_ctx *exec_ctx,
                                 grpc_channel_element *elem) ***REMOVED******REMOVED***

const grpc_channel_filter grpc_message_compress_filter = ***REMOVED***
