...
static grpc_subchannel_args *get_secure_naming_subchannel_args(
  ...
  if (channel_credentials == NULL) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  if (grpc_security_connector_find_in_args(args->args) != NULL) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  if (targets_info != NULL) ***REMOVED***  // LB channel
    ...
    ***REMOVED***
    if (target_name_to_check == NULL) ***REMOVED***
  ...
  ***REMOVED***
  ...
  GRPC_SECURITY_CONNECTOR_UNREF(exec_ctx, &subchannel_security_connector->base,
                                "lb_channel_create");
  if (new_args_from_connector != NULL) ***REMOVED***
...
static grpc_subchannel *client_channel_factory_create_subchannel(
  ...
  if (subchannel_args == NULL) ***REMOVED***
    gpr_log(
        GPR_ERROR,
