 ...
 * @typedef ***REMOVED***(ClientUnaryCall|ClientReadableStream|
 *            ClientWritableStream|ClientDuplexStream)***REMOVED***
 *     grpc.Client~Call
 */
 ...
 * @param ***REMOVED***grpc~ChannelCredentials***REMOVED*** credentials Credentials to use to connect to
 *     the server
 ...
 * @param ***REMOVED***Client***REMOVED*** client
 * @return ***REMOVED***Channel***REMOVED*** The channel
 ...
 * @param ***REMOVED***Client***REMOVED*** client The client to wait on
