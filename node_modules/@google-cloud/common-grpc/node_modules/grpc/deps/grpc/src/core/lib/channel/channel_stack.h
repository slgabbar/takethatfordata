...
// the C++ API in src/cpp/common/channel_filter.***REMOVED***h,cc***REMOVED***
//////////////////////////////////////////////////////////////////////////////
...
typedef struct ***REMOVED***
  ...
  int is_first;
  int is_last;
***REMOVED*** grpc_channel_element_args;
...
/* A call_element tracks its filter, the filter requested memory within
   ...
   allocation */
struct grpc_call_element ***REMOVED***
  const grpc_channel_filter *filter;
  void *channel_data;
  void *call_data;
***REMOVED***;
...
struct grpc_channel_stack ***REMOVED***
...
struct grpc_call_stack ***REMOVED***
...
/* Ignore set pollset***REMOVED***_set***REMOVED*** - used by filters if they don't care about pollsets
 * at all. Does nothing. */
