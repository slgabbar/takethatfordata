...
static bool get_user_agent_mdelem(const grpc_metadata_batch* batch,
  ...
  if (batch->idx.named.user_agent != NULL) ***REMOVED***
...
void grpc_workaround_cronet_compression_filter_init(void) ***REMOVED***
...
void grpc_workaround_cronet_compression_filter_shutdown(void) ***REMOVED******REMOVED***
