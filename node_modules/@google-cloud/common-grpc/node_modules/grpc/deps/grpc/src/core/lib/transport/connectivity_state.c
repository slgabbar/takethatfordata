...
grpc_connectivity_state grpc_connectivity_state_check(
  ...
  if (GRPC_TRACER_ON(grpc_connectivity_state_trace)) ***REMOVED***
...
bool grpc_connectivity_state_notify_on_state_change(
  ...
  ***REMOVED***
  if (current == NULL) ***REMOVED***
    ...
    if (w != NULL && w->notify == notify) ***REMOVED***
    ...
    ***REMOVED***
    while (w != NULL) ***REMOVED***
      ...
      if (rm_candidate != NULL && rm_candidate->notify == notify) ***REMOVED***
        GRPC_CLOSURE_SCHED(exec_ctx, notify, GRPC_ERROR_CANCELLED);
        w->next = w->next->next;
...
void grpc_connectivity_state_set(grpc_exec_ctx *exec_ctx,
  ...
  ***REMOVED***
  ...
  while ((w = tracker->watchers) != NULL) ***REMOVED***
    *w->current = state;
    tracker->watchers = w->next;
    if (GRPC_TRACER_ON(grpc_connectivity_state_trace)) ***REMOVED***
