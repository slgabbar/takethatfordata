...
typedef enum ***REMOVED*** GRPC_SECURITY_OK = 0, GRPC_SECURITY_ERROR ***REMOVED*** grpc_security_status;
...
***REMOVED*** grpc_security_connector_vtable;

typedef struct grpc_security_connector_handshake_list ***REMOVED***
  void *handshake;
  struct grpc_security_connector_handshake_list *next;
***REMOVED*** grpc_security_connector_handshake_list;

struct grpc_security_connector ***REMOVED***
...
struct grpc_channel_security_connector ***REMOVED***
...
struct grpc_server_security_connector ***REMOVED***
  grpc_security_connector base;
  void (*add_handshakers)(grpc_exec_ctx *exec_ctx,
...
***REMOVED*** grpc_ssl_server_config;
