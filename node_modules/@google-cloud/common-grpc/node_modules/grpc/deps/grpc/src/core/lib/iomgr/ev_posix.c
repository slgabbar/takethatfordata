...
static const event_engine_factory g_factories[] = ***REMOVED***
    ***REMOVED***"epoll1", grpc_init_epoll1_linux***REMOVED***,
    ***REMOVED***"epollsig", grpc_init_epollsig_linux***REMOVED***,
    ***REMOVED***"poll", grpc_init_poll_posix***REMOVED***,
    ***REMOVED***"poll-cv", grpc_init_poll_cv_posix***REMOVED***,
    ***REMOVED***"epollex", grpc_init_epollex_linux***REMOVED***,
***REMOVED***;
...
void grpc_event_engine_init(void) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (size_t i = 0; g_event_engine == NULL && i < nstrings; i++) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (g_event_engine == NULL) ***REMOVED***
