...
***REMOVED*** grpc_chttp2_ping_closure_list;
...
***REMOVED*** grpc_chttp2_initiate_write_reason;
...
***REMOVED*** grpc_chttp2_ping_queue;
...
***REMOVED*** grpc_chttp2_repeated_ping_policy;
...
***REMOVED*** grpc_chttp2_repeated_ping_state;

typedef struct ***REMOVED***
  gpr_timespec last_ping_recv_time;
  int ping_strikes;
***REMOVED*** grpc_chttp2_server_ping_recv_state;
...
typedef enum ***REMOVED***
  ...
  GRPC_DTS_FRAME
***REMOVED*** grpc_chttp2_deframe_transport_state;

typedef struct ***REMOVED***
  grpc_chttp2_stream *head;
  grpc_chttp2_stream *tail;
***REMOVED*** grpc_chttp2_stream_list;

typedef struct ***REMOVED***
  grpc_chttp2_stream *next;
  grpc_chttp2_stream *prev;
***REMOVED*** grpc_chttp2_stream_link;
...
***REMOVED*** grpc_chttp2_setting_set;

typedef enum ***REMOVED***
  GRPC_CHTTP2_NO_GOAWAY_SEND,
  GRPC_CHTTP2_GOAWAY_SEND_SCHEDULED,
  GRPC_CHTTP2_GOAWAY_SENT,
***REMOVED*** grpc_chttp2_sent_goaway_state;

typedef struct grpc_chttp2_write_cb ***REMOVED***
  int64_t call_at_byte;
  grpc_closure *closure;
  struct grpc_chttp2_write_cb *next;
***REMOVED*** grpc_chttp2_write_cb;

/* forward declared in frame_data.h */
struct grpc_chttp2_incoming_byte_stream ***REMOVED***
...
***REMOVED*** grpc_chttp2_keepalive_state;
...
***REMOVED*** grpc_chttp2_transport_flowctl;

struct grpc_chttp2_transport ***REMOVED***
...
***REMOVED*** grpc_published_metadata_method;
...
***REMOVED*** grpc_chttp2_stream_flowctl;

struct grpc_chttp2_stream ***REMOVED***
...
***REMOVED*** grpc_chttp2_begin_write_result;
...
***REMOVED*** grpc_chttp2_flowctl_urgency;
...
typedef struct ***REMOVED***
  ...
  bool need_ping;
***REMOVED*** grpc_chttp2_flowctl_action;
