...
***REMOVED*** grpc_credentials_status;
...
***REMOVED*** grpc_channel_credentials_vtable;

struct grpc_channel_credentials ***REMOVED***
...
typedef struct ***REMOVED***
  grpc_mdelem *md;
  size_t size;
***REMOVED*** grpc_credentials_mdelem_array;
...
typedef struct ***REMOVED***
  ...
  void (*cancel_get_request_metadata)(grpc_exec_ctx *exec_ctx,
                                      ...
                                      grpc_credentials_mdelem_array *md_array,
                                      grpc_error *error);
***REMOVED*** grpc_call_credentials_vtable;

struct grpc_call_credentials ***REMOVED***
...
***REMOVED*** grpc_server_credentials_vtable;

struct grpc_server_credentials ***REMOVED***
...
***REMOVED*** grpc_credentials_metadata_request;
