...
static void fill_metadata(grpc_exec_ctx *exec_ctx, grpc_call_element *elem,
  ...
  if (!calld->filled_metadata.compare_exchange_strong(
          ...
          grpc_core::memory_order_relaxed)) ***REMOVED***
    return;
  ***REMOVED***
...
static void lame_start_transport_stream_op_batch(
  ...
  ***REMOVED*** else if (op->recv_trailing_metadata) ***REMOVED***
    fill_metadata(exec_ctx, elem,
...
static void lame_start_transport_op(grpc_exec_ctx *exec_ctx,
  ...
  if (op->on_connectivity_state_change) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (op->on_consumed != NULL) ***REMOVED***
...
extern "C" const grpc_channel_filter grpc_lame_filter = ***REMOVED***
...
grpc_channel *grpc_lame_client_channel_create(const char *target,
                                              grpc_status_code error_code,
                                              const char *error_message) ***REMOVED***
