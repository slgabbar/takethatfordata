...
static grpc_slice_refcount terminal_slice_refcount = ***REMOVED***NULL, NULL***REMOVED***;
static const grpc_slice terminal_slice = ***REMOVED***
    &terminal_slice_refcount, /* refcount */
    ***REMOVED******REMOVED***0, 0***REMOVED******REMOVED***                  /* data.refcounted */
***REMOVED***;
...
static void hpack_enc(grpc_exec_ctx *exec_ctx, grpc_chttp2_hpack_compressor *c,
  ...
  ***REMOVED***
  ...
  if (GRPC_TRACER_ON(grpc_http_trace) && !GRPC_MDELEM_IS_INTERNED(elem)) ***REMOVED***
    ...
    gpr_free(v);
  ***REMOVED***
  if (!GRPC_MDELEM_IS_INTERNED(elem)) ***REMOVED***
