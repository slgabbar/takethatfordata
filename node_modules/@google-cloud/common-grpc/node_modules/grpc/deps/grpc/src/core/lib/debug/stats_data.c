...
const char *grpc_stats_counter_name[GRPC_STATS_COUNTER_COUNT] = ***REMOVED***
...
***REMOVED***;
const char *grpc_stats_counter_doc[GRPC_STATS_COUNTER_COUNT] = ***REMOVED***
...
***REMOVED***;
const char *grpc_stats_histogram_name[GRPC_STATS_HISTOGRAM_COUNT] = ***REMOVED***
    "call_initial_size",
    ...
    "server_cqs_checked",
***REMOVED***;
const char *grpc_stats_histogram_doc[GRPC_STATS_HISTOGRAM_COUNT] = ***REMOVED***
...
***REMOVED***;
const int grpc_stats_table_0[65] = ***REMOVED***
    ...
    130273, 155159, 184799, 220100, 262144***REMOVED***;
const uint8_t grpc_stats_table_1[124] = ***REMOVED***
    ...
    51, 51, 52, 52, 53, 53, 54, 54, 55, 55, 56, 56, 57, 57, 58, 58***REMOVED***;
const int grpc_stats_table_2[129] = ***REMOVED***
    ...
    809, 834, 859, 885, 912, 939, 967, 996, 1024***REMOVED***;
const uint8_t grpc_stats_table_3[166] = ***REMOVED***
    ...
    91, 92, 92, 93, 94, 94, 95, 95, 96, 97, 97, 98, 98, 99***REMOVED***;
const int grpc_stats_table_4[65] = ***REMOVED***
    0,       1,       2,       3,       4,       6,       8,        11,
    ...
    16777216***REMOVED***;
const uint8_t grpc_stats_table_5[87] = ***REMOVED***
    ...
    49, 50, 51, 51, 52, 53, 53, 54, 55, 56, 56, 57, 58, 58, 59***REMOVED***;
const int grpc_stats_table_6[65] = ***REMOVED***
    ...
    418, 451, 486, 524, 565, 609, 656, 707, 762, 821, 884, 952, 1024***REMOVED***;
const uint8_t grpc_stats_table_7[102] = ***REMOVED***
    ...
    42, 42, 43, 44, 44, 45, 46, 46, 47, 48, 48, 49, 49, 50, 50, 51, 51***REMOVED***;
const int grpc_stats_table_8[9] = ***REMOVED***0, 1, 2, 4, 7, 13, 23, 39, 64***REMOVED***;
const uint8_t grpc_stats_table_9[9] = ***REMOVED***0, 0, 1, 2, 2, 3, 4, 4, 5***REMOVED***;
void grpc_stats_inc_call_initial_size(grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  ...
  ***REMOVED*** _val, _bkt;
  _val.dbl = value;
  if (_val.uint < 4651092515166879744ull) ***REMOVED***
    int bucket =
...
***REMOVED***
void grpc_stats_inc_poll_events_returned(grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  ...
  ***REMOVED*** _val, _bkt;
  _val.dbl = value;
  if (_val.uint < 4642789003353915392ull) ***REMOVED***
    int bucket =
...
***REMOVED***
void grpc_stats_inc_tcp_write_size(grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  ...
  ***REMOVED*** _val, _bkt;
  _val.dbl = value;
  if (_val.uint < 4683743612465315840ull) ***REMOVED***
    int bucket =
...
***REMOVED***
void grpc_stats_inc_tcp_write_iov_size(grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  value = GPR_CLAMP(value, 0, 1024);
  if (value < 13) ***REMOVED***
    GRPC_STATS_INC_HISTOGRAM((exec_ctx),
  ...
  ***REMOVED*** _val, _bkt;
  _val.dbl = value;
  if (_val.uint < 4637863191261478912ull) ***REMOVED***
    int bucket =
...
***REMOVED***
void grpc_stats_inc_tcp_read_size(grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  value = GPR_CLAMP(value, 0, 16777216);
  if (value < 5) ***REMOVED***
  ...
  ***REMOVED***
  GRPC_STATS_INC_HISTOGRAM((exec_ctx), GRPC_STATS_HISTOGRAM_TCP_READ_SIZE,
                           grpc_stats_histo_find_bucket_slow(
                               (exec_ctx), value, grpc_stats_table_4, 64));
***REMOVED***
void grpc_stats_inc_tcp_read_offer(grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  value = GPR_CLAMP(value, 0, 16777216);
  if (value < 5) ***REMOVED***
...
void grpc_stats_inc_http2_send_initial_metadata_per_write(
    grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  value = GPR_CLAMP(value, 0, 1024);
  if (value < 13) ***REMOVED***
    GRPC_STATS_INC_HISTOGRAM(
  ...
  ***REMOVED***
  GRPC_STATS_INC_HISTOGRAM((exec_ctx),
                           ...
                           grpc_stats_histo_find_bucket_slow(
                               (exec_ctx), value, grpc_stats_table_6, 64));
***REMOVED***
void grpc_stats_inc_server_cqs_checked(grpc_exec_ctx *exec_ctx, int value) ***REMOVED***
  ...
  ***REMOVED*** _val, _bkt;
  _val.dbl = value;
  if (_val.uint < 4625196817309499392ull) ***REMOVED***
    int bucket =
...
***REMOVED***
const int grpc_stats_histo_buckets[13] = ***REMOVED***64, 128, 64, 64, 64, 64, 64,
                                          64, 64,  64, 64, 64, 8***REMOVED***;
const int grpc_stats_histo_start[13] = ***REMOVED***0,   64,  192, 256, 320, 384, 448,
                                        512, 576, 640, 704, 768, 832***REMOVED***;
const int *const grpc_stats_histo_bucket_boundaries[13] = ***REMOVED***
    ...
    grpc_stats_table_8***REMOVED***;
void (*const grpc_stats_inc_histogram[13])(grpc_exec_ctx *exec_ctx, int x) = ***REMOVED***
    ...
    grpc_stats_inc_server_cqs_checked***REMOVED***;
