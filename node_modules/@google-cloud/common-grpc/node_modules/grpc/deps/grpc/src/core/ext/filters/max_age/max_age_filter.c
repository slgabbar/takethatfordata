...
#define MAX_CONNECTION_AGE_INTEGER_OPTIONS \
  (grpc_integer_options) ***REMOVED*** DEFAULT_MAX_CONNECTION_AGE_MS, 1, INT_MAX ***REMOVED***
#define MAX_CONNECTION_IDLE_INTEGER_OPTIONS \
  (grpc_integer_options) ***REMOVED*** DEFAULT_MAX_CONNECTION_IDLE_MS, 1, INT_MAX ***REMOVED***
...
static int add_random_max_connection_age_jitter(int value) ***REMOVED***
  ...
  for (size_t i = 0; i < args->channel_args->num_args; ++i) ***REMOVED***
    ...
    ***REMOVED*** else if (0 == strcmp(args->channel_args->args[i].key,
      ...
      const int value = grpc_channel_arg_get_integer(
          ...
          (grpc_integer_options)***REMOVED***DEFAULT_MAX_CONNECTION_AGE_GRACE_MS, 0,
                                 INT_MAX***REMOVED***);
      chand->max_connection_age_grace =
...
void grpc_max_age_filter_init(void) ***REMOVED***
  grpc_channel_init_register_stage(GRPC_SERVER_CHANNEL,
                                   GRPC_CHANNEL_INIT_BUILTIN_PRIORITY,
                                   maybe_add_max_age_filter, NULL);
***REMOVED***

void grpc_max_age_filter_shutdown(void) ***REMOVED******REMOVED***
