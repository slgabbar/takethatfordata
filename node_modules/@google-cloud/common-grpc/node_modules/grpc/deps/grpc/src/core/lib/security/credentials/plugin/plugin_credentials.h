...
typedef struct grpc_plugin_credentials_pending_request ***REMOVED***
  bool cancelled;
...
***REMOVED*** grpc_plugin_credentials_pending_request;

typedef struct grpc_plugin_credentials ***REMOVED***
  grpc_call_credentials base;
  grpc_metadata_credentials_plugin plugin;
  gpr_mu mu;
  grpc_plugin_credentials_pending_request *pending_requests;
***REMOVED*** grpc_plugin_credentials;
