...
static void httpcli_ssl_destroy(grpc_exec_ctx *exec_ctx,
  ...
  if (c->handshaker_factory != NULL) ***REMOVED***
...
static grpc_security_connector_vtable httpcli_ssl_vtable = ***REMOVED***
    httpcli_ssl_destroy, httpcli_ssl_check_peer***REMOVED***;
...
static grpc_security_status httpcli_ssl_channel_security_connector_create(
  ...
  if (secure_peer_name != NULL && pem_root_certs == NULL) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  ***REMOVED***
  ...
  if (secure_peer_name != NULL) ***REMOVED***
