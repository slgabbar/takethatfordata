...
CallCredentials::CallCredentials(grpc_call_credentials *credentials)
    : wrapped_credentials(credentials) ***REMOVED******REMOVED***

CallCredentials::~CallCredentials() ***REMOVED***
  grpc_call_credentials_release(wrapped_credentials);
***REMOVED***

void CallCredentials::Init(Local<Object> exports) ***REMOVED***
  HandleScope scope;
...
bool CallCredentials::HasInstance(Local<Value> val) ***REMOVED***
  HandleScope scope;
  return Nan::New(fun_tpl)->HasInstance(val);
***REMOVED***

Local<Value> CallCredentials::WrapStruct(grpc_call_credentials *credentials) ***REMOVED***
  EscapableHandleScope scope;
  const int argc = 1;
  if (credentials == NULL) ***REMOVED***
    return scope.Escape(Nan::Null());
  ***REMOVED***
  Local<Value> argv[argc] = ***REMOVED***
      Nan::New<External>(reinterpret_cast<void *>(credentials))***REMOVED***;
...
grpc_call_credentials *CallCredentials::GetWrappedCredentials() ***REMOVED***
  return wrapped_credentials;
***REMOVED***

NAN_METHOD(CallCredentials::New) ***REMOVED***
...
NAN_METHOD(CallCredentials::Compose) ***REMOVED***
  if (!CallCredentials::HasInstance(info.This())) ***REMOVED***
    return Nan::ThrowTypeError(
...
NAN_METHOD(CallCredentials::CreateFromPlugin) ***REMOVED***
...
NAN_METHOD(PluginCallback) ***REMOVED***
  ...
  ***REMOVED***
  if (!info[2]->IsObject()) ***REMOVED***
    return Nan::ThrowTypeError(
        "The callback's third argument must be an object");
  ***REMOVED***
  if (!info[3]->IsObject()) ***REMOVED***
    return Nan::ThrowTypeError(
  ...
  ***REMOVED***
  ...
  if (!CreateMetadataArray(Nan::To<Object>(info[2]).ToLocalChecked(), &array)) ***REMOVED***
...
NAUV_WORK_CB(SendPluginCallback) ***REMOVED***
...
void plugin_uv_close_cb(uv_handle_t *handle) ***REMOVED***
...
void plugin_destroy_state(void *ptr) ***REMOVED***
