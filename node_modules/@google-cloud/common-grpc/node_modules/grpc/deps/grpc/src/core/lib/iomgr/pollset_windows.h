...
***REMOVED*** grpc_pollset_worker_link_type;

typedef struct grpc_pollset_worker_link ***REMOVED***
  struct grpc_pollset_worker *next;
  struct grpc_pollset_worker *prev;
***REMOVED*** grpc_pollset_worker_link;

struct grpc_pollset;
typedef struct grpc_pollset grpc_pollset;

typedef struct grpc_pollset_worker ***REMOVED***
  gpr_cv cv;
  int kicked;
  struct grpc_pollset *pollset;
  grpc_pollset_worker_link links[GRPC_POLLSET_WORKER_LINK_TYPES];
***REMOVED*** grpc_pollset_worker;
