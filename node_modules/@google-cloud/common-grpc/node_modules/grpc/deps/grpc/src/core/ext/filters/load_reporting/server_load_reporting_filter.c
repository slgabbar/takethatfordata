...
static void on_initial_md_ready(grpc_exec_ctx *exec_ctx, void *user_data,
  ...
  if (err == GRPC_ERROR_NONE) ***REMOVED***
    if (calld->recv_initial_metadata->idx.named.path != NULL) ***REMOVED***
    ...
    ***REMOVED***
    if (calld->recv_initial_metadata->idx.named.lb_token != NULL) ***REMOVED***
...
static grpc_error *init_call_elem(grpc_exec_ctx *exec_ctx,
  ...
  grpc_load_reporting_call_data lr_call_data = ***REMOVED***GRPC_LR_POINT_CALL_CREATION,
                                                (intptr_t)chand->id,
                                                (intptr_t)calld->id,
                                                NULL,
                                                NULL,
...
static void destroy_call_elem(grpc_exec_ctx *exec_ctx, grpc_call_element *elem,
  ...
  /* TODO(dgq): do something with the data
  channel_data *chand = elem->channel_data;
  grpc_load_reporting_call_data lr_call_data = ***REMOVED***GRPC_LR_POINT_CALL_DESTRUCTION,
                                                (intptr_t)chand->id,
                                                (intptr_t)calld->id,
                                                final_info,
                                                calld->initial_md_string,
                                                calld->trailing_md_string,
                                                calld->service_method***REMOVED***;
  */

  if (calld->have_initial_md_string) ***REMOVED***
    grpc_slice_unref_internal(exec_ctx, calld->initial_md_string);
  ***REMOVED***
  if (calld->have_trailing_md_string) ***REMOVED***
    grpc_slice_unref_internal(exec_ctx, calld->trailing_md_string);
  ***REMOVED***
  if (calld->have_service_method) ***REMOVED***
...
static grpc_error *init_channel_elem(grpc_exec_ctx *exec_ctx,
  ...
  /* TODO(dgq): do something with the data
  grpc_load_reporting_call_data lr_call_data = ***REMOVED***GRPC_LR_POINT_CHANNEL_CREATION,
                                                (intptr_t)chand,
                                                0,
                                                NULL,
                                                NULL,
...
static void destroy_channel_elem(grpc_exec_ctx *exec_ctx,
  ...
  /* TODO(dgq): do something with the data
  channel_data *chand = elem->channel_data;
  grpc_load_reporting_call_data lr_call_data = ***REMOVED***
...
static grpc_filtered_mdelem lr_trailing_md_filter(grpc_exec_ctx *exec_ctx,
  ...
  grpc_call_element *elem = (grpc_call_element *)user_data;
  call_data *calld = (call_data *)elem->call_data;
  if (grpc_slice_eq(GRPC_MDKEY(md), GRPC_MDSTR_LB_COST_BIN)) ***REMOVED***
...
static void lr_start_transport_stream_op_batch(
  ...
  ***REMOVED*** else if (op->send_trailing_metadata) ***REMOVED***
    GRPC_LOG_IF_ERROR(
...
const grpc_channel_filter grpc_server_load_reporting_filter = ***REMOVED***
