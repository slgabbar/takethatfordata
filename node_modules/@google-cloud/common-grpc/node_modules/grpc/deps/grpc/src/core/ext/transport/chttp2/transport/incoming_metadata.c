...
void grpc_chttp2_incoming_metadata_buffer_init(
    grpc_chttp2_incoming_metadata_buffer *buffer, gpr_arena *arena) ***REMOVED***
  buffer->arena = arena;
...
void grpc_chttp2_incoming_metadata_buffer_destroy(
    grpc_exec_ctx *exec_ctx, grpc_chttp2_incoming_metadata_buffer *buffer) ***REMOVED***
...
grpc_error *grpc_chttp2_incoming_metadata_buffer_replace_or_add(
  ...
  for (grpc_linked_mdelem *l = buffer->batch.list.head; l != NULL;
       l = l->next) ***REMOVED***
    if (grpc_slice_eq(GRPC_MDKEY(l->md), GRPC_MDKEY(elem))) ***REMOVED***
...
void grpc_chttp2_incoming_metadata_buffer_set_deadline(
    grpc_chttp2_incoming_metadata_buffer *buffer, gpr_timespec deadline) ***REMOVED***
