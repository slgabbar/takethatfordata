...
bool grpc_channel_stack_type_is_client(grpc_channel_stack_type type) ***REMOVED***
  switch (type) ***REMOVED***
...
const char *grpc_channel_stack_type_string(grpc_channel_stack_type type) ***REMOVED***
  switch (type) ***REMOVED***
    case GRPC_CLIENT_CHANNEL:
