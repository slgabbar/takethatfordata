...
void gpr_backoff_init(gpr_backoff *backoff, int64_t initial_connect_timeout,
                      ...
                      int64_t min_timeout_millis, int64_t max_timeout_millis) ***REMOVED***
...
gpr_timespec gpr_backoff_begin(gpr_backoff *backoff, gpr_timespec now) ***REMOVED***
...
gpr_timespec gpr_backoff_step(gpr_backoff *backoff, gpr_timespec now) ***REMOVED***
...
void gpr_backoff_reset(gpr_backoff *backoff) ***REMOVED***
  backoff->current_timeout_millis = backoff->initial_connect_timeout;
***REMOVED***
