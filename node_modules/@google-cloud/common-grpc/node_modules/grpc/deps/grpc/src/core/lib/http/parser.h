...
typedef struct grpc_http_header ***REMOVED***
  char *key;
  char *value;
***REMOVED*** grpc_http_header;

typedef enum ***REMOVED***
  GRPC_HTTP_FIRST_LINE,
  GRPC_HTTP_HEADERS,
  GRPC_HTTP_BODY
***REMOVED*** grpc_http_parser_state;

typedef enum ***REMOVED***
  GRPC_HTTP_HTTP10,
  GRPC_HTTP_HTTP11,
  GRPC_HTTP_HTTP20,
***REMOVED*** grpc_http_version;

typedef enum ***REMOVED***
  GRPC_HTTP_RESPONSE,
  GRPC_HTTP_REQUEST,
***REMOVED*** grpc_http_type;

/* A request */
typedef struct grpc_http_request ***REMOVED***
  ...
  size_t body_length;
  char *body;
***REMOVED*** grpc_http_request;

/* A response */
typedef struct grpc_http_response ***REMOVED***
  /* HTTP status code */
  int status;
