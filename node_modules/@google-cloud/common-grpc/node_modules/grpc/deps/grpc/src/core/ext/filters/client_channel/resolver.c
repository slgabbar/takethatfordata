...
void grpc_resolver_ref(grpc_resolver *resolver, const char *file, int line,
  ...
  if (GRPC_TRACER_ON(grpc_trace_resolver_refcount)) ***REMOVED***
  ...
  ***REMOVED***
#else
void grpc_resolver_ref(grpc_resolver *resolver) ***REMOVED***
#endif
...
void grpc_resolver_unref(grpc_exec_ctx *exec_ctx, grpc_resolver *resolver,
                         const char *file, int line, const char *reason) ***REMOVED***
  if (GRPC_TRACER_ON(grpc_trace_resolver_refcount)) ***REMOVED***
    gpr_atm old_refs = gpr_atm_no_barrier_load(&resolver->refs.count);
    gpr_log(file, line, GPR_LOG_SEVERITY_DEBUG,
  ...
  ***REMOVED***
#else
void grpc_resolver_unref(grpc_exec_ctx *exec_ctx, grpc_resolver *resolver) ***REMOVED***
#endif
  if (gpr_unref(&resolver->refs)) ***REMOVED***
