 ...
 * EXAMPLE USAGE:
 *
 *  typedef struct string_item ***REMOVED***
...
typedef struct hm_item ***REMOVED***
  uint64_t key;
...
typedef struct hm_index ***REMOVED***
 ...
 * and false otherwise. */
__inline bool hm_index_compare(const hm_index *A, const hm_index *B) ***REMOVED***
