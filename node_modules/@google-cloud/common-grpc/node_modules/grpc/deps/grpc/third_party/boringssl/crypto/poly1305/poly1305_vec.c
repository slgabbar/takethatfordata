...
static const alignas(16) uint32_t poly1305_x64_sse2_message_mask[4] = ***REMOVED***
    (1 << 26) - 1, 0, (1 << 26) - 1, 0***REMOVED***;
static const alignas(16) uint32_t poly1305_x64_sse2_5[4] = ***REMOVED***5, 0, 5, 0***REMOVED***;
static const alignas(16) uint32_t poly1305_x64_sse2_1shl128[4] = ***REMOVED***
    (1 << 24), 0, (1 << 24), 0***REMOVED***;

static inline uint128_t add128(uint128_t a, uint128_t b) ***REMOVED*** return a + b; ***REMOVED***

static inline uint128_t add128_64(uint128_t a, uint64_t b) ***REMOVED*** return a + b; ***REMOVED***

static inline uint128_t mul64x64_128(uint64_t a, uint64_t b) ***REMOVED***
  return (uint128_t)a * b;
***REMOVED***

static inline uint64_t lo128(uint128_t a) ***REMOVED*** return (uint64_t)a; ***REMOVED***

static inline uint64_t shr128(uint128_t v, const int shift) ***REMOVED***
  return (uint64_t)(v >> shift);
***REMOVED***

static inline uint64_t shr128_pair(uint64_t hi, uint64_t lo, const int shift) ***REMOVED***
  return (uint64_t)((((uint128_t)hi << 64) | lo) >> shift);
***REMOVED***

typedef struct poly1305_power_t ***REMOVED***
  union ***REMOVED***
    xmmi v;
    uint64_t u[2];
    uint32_t d[4];
  ***REMOVED*** R20, R21, R22, R23, R24, S21, S22, S23, S24;
***REMOVED*** poly1305_power;

typedef struct poly1305_state_internal_t ***REMOVED***
...
***REMOVED*** poly1305_state_internal; /* 448 bytes total + 63 bytes for
                              alignment = 511 bytes raw */

static inline poly1305_state_internal *poly1305_aligned_state(
    poly1305_state *state) ***REMOVED***
  return (poly1305_state_internal *)(((uint64_t)state + 63) & ~63);
***REMOVED***

/* copy 0-63 bytes */
static inline void
poly1305_block_copy(uint8_t *dst, const uint8_t *src, size_t bytes) ***REMOVED***
...
/* zero 0-15 bytes */
static inline void poly1305_block_zero(uint8_t *dst, size_t bytes) ***REMOVED***
  if (bytes & 8) ***REMOVED***
    *(uint64_t *)dst = 0;
    dst += 8;
  ***REMOVED***
...
static inline size_t poly1305_min(size_t a, size_t b) ***REMOVED***
  return (a < b) ? a : b;
***REMOVED***

void CRYPTO_poly1305_init(poly1305_state *state, const uint8_t key[32]) ***REMOVED***
...
void CRYPTO_poly1305_update(poly1305_state *state, const uint8_t *m,
  ...
  if (!st->started) ***REMOVED***
    if ((st->leftover == 0) && (bytes > 32)) ***REMOVED***
    ...
    ***REMOVED*** else ***REMOVED***
      ...
      m += want;
      st->leftover += want;
      if ((st->leftover < 32) || (bytes == 0)) ***REMOVED***
        return;
      ***REMOVED***
  ...
  ***REMOVED***
  ...
  /* handle leftover */
  if (st->leftover) ***REMOVED***
    want = poly1305_min(64 - st->leftover, bytes);
    poly1305_block_copy(st->buffer + st->leftover, m, want);
    bytes -= want;
    m += want;
    st->leftover += want;
    if (st->leftover < 64) ***REMOVED***
      return;
    ***REMOVED***
...
void CRYPTO_poly1305_finish(poly1305_state *state, uint8_t mac[16]) ***REMOVED***
  poly1305_state_internal *st = poly1305_aligned_state(state);
