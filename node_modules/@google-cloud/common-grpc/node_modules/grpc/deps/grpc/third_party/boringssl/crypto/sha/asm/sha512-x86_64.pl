...
sub ROUND_00_15()
***REMOVED*** my ($i,$a,$b,$c,$d,$e,$f,$g,$h) = @_;
  my $STRIDE=$SZ;
...
# SIMD code paths
#
if ($SZ==4 && $shaext) ***REMOVED******REMOVED******REMOVED***
######################################################################
...
***REMOVED*** my $opcode = $AUTOLOAD; $opcode =~ s/.*:://;
  my $arg = pop;
    $arg = "\$$arg" if ($arg*1 eq $arg);
    $code .= "\t$opcode\t".join(',',$arg,reverse @_)."\n";
***REMOVED***

sub body_00_15 () ***REMOVED***
	(
	'($a,$b,$c,$d,$e,$f,$g,$h)=@ROT;'.
...
# SSSE3 code path
#
if ($SZ==4) ***REMOVED***	# SHA256 only
my @X = map("%xmm$_",(0..3));
my ($t0,$t1,$t2,$t3, $t4,$t5) = map("%xmm$_",(4..9));

$code.=<<___;
.type	$***REMOVED***func***REMOVED***_ssse3,\@function,3
.align	64
$***REMOVED***func***REMOVED***_ssse3:
.Lssse3_shortcut:
	mov	%rsp,%rax		# copy %rsp
	push	%rbx
	push	%rbp
...
my @insns = (&$body,&$body,&$body,&$body);	# 104 instructions
    ...
    if (0) ***REMOVED***
	foreach (Xupdate_256_SSSE3()) ***REMOVED***		# 36 instructions
	    eval;
	    eval(shift(@insns));
	    eval(shift(@insns));
	    eval(shift(@insns));
	***REMOVED***
    ***REMOVED*** else ***REMOVED***			# squeeze extra 4% on Westmere and 19% on Atom
	  eval(shift(@insns));	#@
	&movdqa		($t0,@X[1]);
	  eval(shift(@insns));
	  eval(shift(@insns));
    ...
    ***REMOVED***
	&paddd		($t2,@X[0]);
	  foreach (@insns) ***REMOVED*** eval; ***REMOVED***		# remaining instructions
	&movdqa		(16*$j."(%rsp)",$t2);
***REMOVED***

    for ($i=0,$j=0; $j<4; $j++) ***REMOVED***
    ...
    ***REMOVED***
    ...
    for ($i=0; $i<16; ) ***REMOVED***
	foreach(body_00_15()) ***REMOVED*** eval; ***REMOVED***
    ***REMOVED***
$code.=<<___;
	mov	$_ctx,$ctx
	mov	$a1,$A
...
.Lepilogue_ssse3:
	ret
.size	$***REMOVED***func***REMOVED***_ssse3,.-$***REMOVED***func***REMOVED***_ssse3
___
***REMOVED***

if ($avx) ***REMOVED******REMOVED***
######################################################################
# XOP code path
#
if ($SZ==8) ***REMOVED***	# SHA512 only
$code.=<<___;
.type	$***REMOVED***func***REMOVED***_xop,\@function,3
.align	64
$***REMOVED***func***REMOVED***_xop:
.Lxop_shortcut:
	mov	%rsp,%rax		# copy %rsp
	push	%rbx
	push	%rbp
...
.Lepilogue_xop:
	ret
.size	$***REMOVED***func***REMOVED***_xop,.-$***REMOVED***func***REMOVED***_xop
___
***REMOVED***
######################################################################
# AVX+shrd code path
#
local *ror = sub ***REMOVED*** &shrd(@_[0],@_) ***REMOVED***;

$code.=<<___;
.type	$***REMOVED***func***REMOVED***_avx,\@function,3
.align	64
$***REMOVED***func***REMOVED***_avx:
.Lavx_shortcut:
	mov	%rsp,%rax		# copy %rsp
	push	%rbx
	push	%rbp
...
sub AVX_256_00_47 () ***REMOVED***
my $j = shift;
my $body = shift;
my @X = @_;
my @insns = (&$body,&$body,&$body,&$body);	# 104 instructions

	foreach (Xupdate_256_AVX()) ***REMOVED***		# 29 instructions
	    eval;
	    eval(shift(@insns));
	    eval(shift(@insns));
	    eval(shift(@insns));
...
sub AVX_512_00_47 () ***REMOVED***
my $j = shift;
my $body = shift;
my @X = @_;
my @insns = (&$body,&$body);			# 52 instructions

	foreach (Xupdate_512_AVX()) ***REMOVED***		# 23 instructions
	    eval;
	    eval(shift(@insns));
	    eval(shift(@insns));
	***REMOVED***
...
.Lepilogue_avx:
	ret
.size	$***REMOVED***func***REMOVED***_avx,.-$***REMOVED***func***REMOVED***_avx
___

if ($avx>1) ***REMOVED******REMOVED***
######################################################################
# AVX2+BMI code path
#
...
$code.=<<___;
.type	$***REMOVED***func***REMOVED***_avx2,\@function,3
.align	64
$***REMOVED***func***REMOVED***_avx2:
.Lavx2_shortcut:
	mov	%rsp,%rax		# copy %rsp
	push	%rbx
	push	%rbp
...
***REMOVED***
    ...
    ***REMOVED***
	...
	foreach(bodyx_00_15()) ***REMOVED*** eval; ***REMOVED***
    ***REMOVED***
					***REMOVED*** else ***REMOVED***	# SHA512
    my @X = map("%ymm$_",(0..7));
...
.Lepilogue_avx2:
	ret
.size	$***REMOVED***func***REMOVED***_avx2,.-$***REMOVED***func***REMOVED***_avx2
___
***REMOVED******REMOVED***
...
___
$code.=<<___ if ($SZ==4 && $shaext);
	.rva	.LSEH_begin_$***REMOVED***func***REMOVED***_shaext
	.rva	.LSEH_end_$***REMOVED***func***REMOVED***_shaext
	.rva	.LSEH_info_$***REMOVED***func***REMOVED***_shaext
___
$code.=<<___ if ($SZ==4);
	.rva	.LSEH_begin_$***REMOVED***func***REMOVED***_ssse3
	.rva	.LSEH_end_$***REMOVED***func***REMOVED***_ssse3
	.rva	.LSEH_info_$***REMOVED***func***REMOVED***_ssse3
___
$code.=<<___ if ($avx && $SZ==8);
	.rva	.LSEH_begin_$***REMOVED***func***REMOVED***_xop
	.rva	.LSEH_end_$***REMOVED***func***REMOVED***_xop
	.rva	.LSEH_info_$***REMOVED***func***REMOVED***_xop
___
$code.=<<___ if ($avx);
	.rva	.LSEH_begin_$***REMOVED***func***REMOVED***_avx
	.rva	.LSEH_end_$***REMOVED***func***REMOVED***_avx
	.rva	.LSEH_info_$***REMOVED***func***REMOVED***_avx
___
$code.=<<___ if ($avx>1);
	.rva	.LSEH_begin_$***REMOVED***func***REMOVED***_avx2
	.rva	.LSEH_end_$***REMOVED***func***REMOVED***_avx2
	.rva	.LSEH_info_$***REMOVED***func***REMOVED***_avx2
___
$code.=<<___;
.section	.xdata
.align	8
...
___
$code.=<<___ if ($SZ==4 && $shaext);
.LSEH_info_$***REMOVED***func***REMOVED***_shaext:
	.byte	9,0,0,0
	.rva	shaext_handler
___
$code.=<<___ if ($SZ==4);
.LSEH_info_$***REMOVED***func***REMOVED***_ssse3:
	.byte	9,0,0,0
	.rva	se_handler
	.rva	.Lprologue_ssse3,.Lepilogue_ssse3	# HandlerData[]
___
$code.=<<___ if ($avx && $SZ==8);
.LSEH_info_$***REMOVED***func***REMOVED***_xop:
	.byte	9,0,0,0
	.rva	se_handler
	.rva	.Lprologue_xop,.Lepilogue_xop		# HandlerData[]
___
$code.=<<___ if ($avx);
.LSEH_info_$***REMOVED***func***REMOVED***_avx:
	.byte	9,0,0,0
	.rva	se_handler
	.rva	.Lprologue_avx,.Lepilogue_avx		# HandlerData[]
___
$code.=<<___ if ($avx>1);
.LSEH_info_$***REMOVED***func***REMOVED***_avx2:
	.byte	9,0,0,0
	.rva	se_handler
...
sub sha256op38 ***REMOVED***
    ...
    if (defined($opcodelet***REMOVED***$instr***REMOVED***) && @_[0] =~ /%xmm([0-7]),\s*%xmm([0-7])/) ***REMOVED***
      my @opcode=(0x0f,0x38);
	push @opcode,$opcodelet***REMOVED***$instr***REMOVED***;
