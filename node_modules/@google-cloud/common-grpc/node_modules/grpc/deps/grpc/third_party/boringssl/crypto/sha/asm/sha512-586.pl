...
&set_label("16_79_sse2",16);
    for ($j=0;$j<2;$j++) ***REMOVED***			# 2x unroll
...
sub BODY_00_15_ssse3 ***REMOVED***		# "phase-less" copy of BODY_00_15_sse2
	(
	'&movq	("mm1",$E)',				# %mm1 is sliding right
...
&set_label("00_47_ssse3",32);
    ...
    ***REMOVED***
    ...
    for ($j=0;$j<8;$j++) ***REMOVED***	# load next or same block
	my @insns = (&BODY_00_15_ssse3(),&BODY_00_15_ssse3());
