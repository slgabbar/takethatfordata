...
const AllTypes_opt_bytes_t AllTypes_opt_bytes_default = ***REMOVED***4, ***REMOVED***0x34,0x30,0x35,0x35***REMOVED******REMOVED***;
const MyEnum AllTypes_opt_enum_default = MyEnum_Second;


const pb_field_t SubMessage_fields[4] = ***REMOVED***
...
const pb_field_t EmptyMessage_fields[1] = ***REMOVED***
    PB_LAST_FIELD
***REMOVED***;

const pb_field_t Limits_fields[11] = ***REMOVED***
...
const pb_field_t AllTypes_fields[54] = ***REMOVED***
