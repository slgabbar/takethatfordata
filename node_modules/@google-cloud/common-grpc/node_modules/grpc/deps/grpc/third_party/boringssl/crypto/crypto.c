 ...
 * affected. */
uint32_t OPENSSL_ia32cap_P[4] = ***REMOVED***0***REMOVED***;
...
static void OPENSSL_CDECL do_library_init(void) ***REMOVED***
...
void CRYPTO_library_init(void) ***REMOVED***
...
int CRYPTO_is_confidential_build(void) ***REMOVED***
...
int CRYPTO_has_asm(void) ***REMOVED***
...
const char *SSLeay_version(int unused) ***REMOVED***
  return "BoringSSL";
***REMOVED***

unsigned long SSLeay(void) ***REMOVED***
  return OPENSSL_VERSION_NUMBER;
***REMOVED***

int CRYPTO_malloc_init(void) ***REMOVED***
  return 1;
***REMOVED***

void ENGINE_load_builtin_engines(void) ***REMOVED******REMOVED***

int ENGINE_register_all_complete(void) ***REMOVED***
  return 1;
***REMOVED***

void OPENSSL_load_builtin_modules(void) ***REMOVED******REMOVED***

int FIPS_mode(void) ***REMOVED*** return 0; ***REMOVED***
