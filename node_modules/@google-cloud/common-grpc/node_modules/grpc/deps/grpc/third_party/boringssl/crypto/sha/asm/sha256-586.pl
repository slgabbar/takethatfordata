...
sub off ***REMOVED*** &DWP(4*(((shift)-$i)&7),"esp"); ***REMOVED***

if (!$i386 && $unroll_after) ***REMOVED***
my @AH=($A,$K256);
...
&function_end_A();
***REMOVED***
						if (!$i386 && $xmm) ***REMOVED******REMOVED******REMOVED***
if ($shaext) ***REMOVED***
######################################################################
...
***REMOVED***
sub sha256rnds2	***REMOVED*** sha256op38(0xcb,@_); ***REMOVED***
sub sha256msg1	***REMOVED*** sha256op38(0xcc,@_); ***REMOVED***
sub sha256msg2	***REMOVED*** sha256op38(0xcd,@_); ***REMOVED***
...
my $insn;
	...
	foreach (Xupdate_AVX()) ***REMOVED***		# 31 instructions
	    eval;
	    eval(shift(@insns));
	    eval(shift(@insns));
