...
class FileTest ***REMOVED***
 public:
  explicit FileTest(const char *path);
  ~FileTest();

  // is_open returns true if the file was successfully opened.
  bool is_open() const ***REMOVED*** return file_ != nullptr; ***REMOVED***

  enum ReadResult ***REMOVED***
    kReadSuccess,
    kReadEOF,
    kReadError,
  ***REMOVED***;
  ...
  unsigned start_line() const ***REMOVED*** return start_line_; ***REMOVED***
