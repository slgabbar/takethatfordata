...
This is the way to get the size of the message without storing it anywhere::
 ...
 Person myperson = ...;
 pb_ostream_t sizestream = ***REMOVED***0***REMOVED***;
 ...
 ***REMOVED***
 ...
 pb_ostream_t stdoutstream = ***REMOVED***&callback, stdout, SIZE_MAX, 0***REMOVED***;
 ...
 ***REMOVED***
 ...
 pb_istream_t stdinstream = ***REMOVED***&callback, stdin, SIZE_MAX***REMOVED***;
...
repeated string name = 1 [(nanopb).max_size = 40, (nanopb).max_count = 5];      | size_t name_count;
                                                                                | char name[5][40];
required bytes data = 1 [(nanopb).max_size = 40];                               | typedef struct ***REMOVED***
                                                                                |    size_t size;
                                                                                |    pb_byte_t bytes[40];
                                                                                | ***REMOVED*** Person_data_t;
                                                                                | Person_data_t data;
...
generates this field description array for the structure *Person_PhoneNumber*::
 ...
 const pb_field_t Person_PhoneNumber_fields[3] = ***REMOVED***
...
Protocol Buffers supports `oneof`_ sections. Here is an example of ``oneof`` usage::
 ...
 message MsgType1 ***REMOVED***
     required int32 value = 1;
 ***REMOVED***

 message MsgType2 ***REMOVED***
     required bool value = 1;
 ***REMOVED***
 
 message MsgType3 ***REMOVED***
...
Nanopb will generate ``payload`` as a C union and add an additional field ``which_payload``::
  ...
  typedef struct _MyMessage ***REMOVED***
    uint32_t uid;
    uint32_t pid;
    uint32_t utime;
