...
***REMOVED***
    EmptyMessage emptymsg = ***REMOVED***0***REMOVED***;
    return pb_encode_tag_for_field(stream, field) &&
...
***REMOVED***
    SubMessage dummy = ***REMOVED***""***REMOVED***;
...
***REMOVED***
    Limits limits = ***REMOVED***0***REMOVED***;
...
***REMOVED***
    ...
    SubMessage  req_submsg      = ***REMOVED***"1016", 1016***REMOVED***;
    ...
    SubMessage  rep_submsg      = ***REMOVED***"2016", 2016, true, 2016***REMOVED***;
    ...
    SubMessage  opt_submsg      = ***REMOVED***"3056", 3056***REMOVED***;
    
    SubMessage  oneof_msg1      = ***REMOVED***"4059", 4059***REMOVED***;

    /* Bind callbacks for required fields */
    AllTypes alltypes = ***REMOVED******REMOVED******REMOVED***0***REMOVED******REMOVED******REMOVED***;
