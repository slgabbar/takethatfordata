...
static const uint8_t kKey[32] = ***REMOVED***
...
static const uint8_t kInput[] = ***REMOVED***
    ...
    0xac, 0x09, 0x01, 0xca,
***REMOVED***;
static const uint8_t kOutput[] = ***REMOVED***
...
TEST(ChaChaTest, TestVector) ***REMOVED***
  // Run the test with the test vector at all lengths.
  for (size_t len = 0; len <= sizeof(kInput); len++) ***REMOVED***
    SCOPED_TRACE(len);
