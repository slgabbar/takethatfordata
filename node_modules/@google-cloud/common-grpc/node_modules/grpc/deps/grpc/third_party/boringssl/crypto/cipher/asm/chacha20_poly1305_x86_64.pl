...
sub poly_stage3 ***REMOVED***
$code.="imulq $acc2, $t3
        add $acc0, $t2
        adc %rdx, $t3\n";
***REMOVED***

sub poly_reduce_stage ***REMOVED***
$code.="mov $t0, $acc0
        mov $t1, $acc1
        mov $t2, $acc2
        and \$3, $acc2
...
sub xor_stream_using_temp ***REMOVED***
...
sub emit_body ***REMOVED***
my ($n)=@_;
    for (my $i=0; $i < $n; $i++) ***REMOVED***
...
1:  \n";
            ...
            &emit_body(20);
            &poly_reduce_stage();
            foreach $l (@loop_body) ***REMOVED***$code.=$l."\n";***REMOVED***
            @loop_body = split /\n/, $chacha_body; $code.="
            dec $itr1
        jge 1b\n";
            &poly_add("0($itr2)");
...
sub finalize_state_avx2 ***REMOVED***
my ($n)=@_;
$code.=<<___ if ($n eq 4);
...
sub finish_stream_avx2 ***REMOVED***
my ($A, $B, $C, $D, $hlp)=@_;
$code.=<<___;
...
sub gen_chacha_round_avx2 ***REMOVED***
my ($rot1, $rot2, $shift)=@_;
my $round="";
