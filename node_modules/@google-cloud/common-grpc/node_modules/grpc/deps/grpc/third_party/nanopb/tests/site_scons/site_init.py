...
def add_nanopb_builders(env):
    ...
    run_test_builder = Builder(action = run_test,
                               suffix = '.output')
    env.Append(BUILDERS = ***REMOVED***'RunTest': run_test_builder***REMOVED***)
    ...
    decode_builder = Builder(generator = decode_actions,
                             suffix = '.decoded')
    env.Append(BUILDERS = ***REMOVED***'Decode': decode_builder***REMOVED***)    
    ...
    encode_builder = Builder(generator = encode_actions,
                             suffix = '.encoded')
    env.Append(BUILDERS = ***REMOVED***'Encode': encode_builder***REMOVED***)    
    ...
    compare_builder = Builder(action = compare_files,
                              suffix = '.equal')
    env.Append(BUILDERS = ***REMOVED***'Compare': compare_builder***REMOVED***)
    ...
    env.Append(BUILDERS = ***REMOVED***'Match': match_builder***REMOVED***)
