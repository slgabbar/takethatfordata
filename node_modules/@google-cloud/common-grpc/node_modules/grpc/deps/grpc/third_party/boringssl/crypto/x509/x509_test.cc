...
// |X509*|.
static bssl::UniquePtr<X509> CertFromPEM(const char *pem) ***REMOVED***
...
// |X509_CRL*|.
static bssl::UniquePtr<X509_CRL> CRLFromPEM(const char *pem) ***REMOVED***
  bssl::UniquePtr<BIO> bio(BIO_new_mem_buf(pem, strlen(pem)));
...
// |EVP_PKEY*|.
static bssl::UniquePtr<EVP_PKEY> PrivateKeyFromPEM(const char *pem) ***REMOVED***
...
static bssl::UniquePtr<STACK_OF(X509)> CertsToStack(
    const std::vector<X509 *> &certs) ***REMOVED***
  bssl::UniquePtr<STACK_OF(X509)> stack(sk_X509_new_null());
  if (!stack) ***REMOVED***
    return nullptr;
  ***REMOVED***
  for (auto cert : certs) ***REMOVED***
    if (!sk_X509_push(stack.get(), cert)) ***REMOVED***
      return nullptr;
    ***REMOVED***
    X509_up_ref(cert);
  ***REMOVED***
...
static bssl::UniquePtr<STACK_OF(X509_CRL)> CRLsToStack(
    const std::vector<X509_CRL *> &crls) ***REMOVED***
  bssl::UniquePtr<STACK_OF(X509_CRL)> stack(sk_X509_CRL_new_null());
  if (!stack) ***REMOVED***
    return nullptr;
  ***REMOVED***
  for (auto crl : crls) ***REMOVED***
    if (!sk_X509_CRL_push(stack.get(), crl)) ***REMOVED***
      return nullptr;
    ***REMOVED***
    X509_CRL_up_ref(crl);
  ***REMOVED***
...
static int Verify(X509 *leaf, const std::vector<X509 *> &roots,
                   ...
                   unsigned long flags,
                   bool use_additional_untrusted) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (use_additional_untrusted) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!X509_STORE_CTX_init(
          ...
          use_additional_untrusted ? nullptr : intermediates_stack.get())) ***REMOVED***
    return X509_V_ERR_UNSPECIFIED;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  ERR_clear_error();
  if (X509_verify_cert(ctx.get()) != 1) ***REMOVED***
...
static bool TestVerify() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (Verify(leaf.get(), empty, empty, empty_crls) !=
      X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY) ***REMOVED***
    fprintf(stderr, "Leaf verified with no roots!\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), empty, ***REMOVED***intermediate.get()***REMOVED***, empty_crls) !=
      X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY) ***REMOVED***
    fprintf(stderr, "Leaf verified with no roots!\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***intermediate.get()***REMOVED***, empty_crls) !=
      X509_V_OK) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (Verify(leaf.get(), ***REMOVED***cross_signing_root.get()***REMOVED***,
             ***REMOVED***intermediate.get(), root_cross_signed.get()***REMOVED***,
             empty_crls) != X509_V_OK) ***REMOVED***
    ERR_print_errors_fp(stderr);
    fprintf(stderr, "Cross-signed chain didn't verify.\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), ***REMOVED***cross_signing_root.get(), root.get()***REMOVED***,
             ***REMOVED***intermediate.get(), root_cross_signed.get()***REMOVED***,
             empty_crls) != X509_V_OK) ***REMOVED***
    ERR_print_errors_fp(stderr);
  ...
  ***REMOVED***
  ...
  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***,
             ***REMOVED***intermediate.get(), root_cross_signed.get()***REMOVED***,
             empty_crls) != X509_V_OK) ***REMOVED***
    ERR_print_errors_fp(stderr);
  ...
  ***REMOVED***
  ...
  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***,
             ***REMOVED***intermediate.get(), root_cross_signed.get()***REMOVED***, empty_crls,
  ...
  ***REMOVED***
  ...
  if (Verify(forgery.get(), ***REMOVED***intermediate_self_signed.get()***REMOVED***,
             ***REMOVED***leaf_no_key_usage.get()***REMOVED***,
             empty_crls) != X509_V_ERR_INVALID_CA) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (Verify(forgery.get(),
             ***REMOVED***intermediate_self_signed.get(), root_cross_signed.get()***REMOVED***,
             ***REMOVED***leaf_no_key_usage.get(), intermediate.get()***REMOVED***,
             empty_crls) != X509_V_ERR_INVALID_CA) ***REMOVED***
    fprintf(stderr, "Basic constraints weren't checked.\n");
    return false;
  ***REMOVED***
...
static bool TestCRL() ***REMOVED***
  ...
  if (!root ||
      ...
      !unknown_critical_crl2) ***REMOVED***
    fprintf(stderr, "Failed to parse certificates and CRLs.\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***root.get()***REMOVED***, ***REMOVED***basic_crl.get()***REMOVED***,
             X509_V_FLAG_CRL_CHECK) != X509_V_OK) ***REMOVED***
    fprintf(stderr, "Cert with CRL didn't verify.\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***root.get()***REMOVED***,
             ***REMOVED***basic_crl.get(), revoked_crl.get()***REMOVED***,
             X509_V_FLAG_CRL_CHECK) != X509_V_ERR_CERT_REVOKED) ***REMOVED***
    fprintf(stderr, "Revoked CRL wasn't checked.\n");
    return false;
  ***REMOVED***

  std::vector<X509_CRL *> empty_crls;
  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***root.get()***REMOVED***, empty_crls,
             X509_V_FLAG_CRL_CHECK) != X509_V_ERR_UNABLE_TO_GET_CRL) ***REMOVED***
    fprintf(stderr, "CRLs were not required.\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***root.get()***REMOVED***, ***REMOVED***bad_issuer_crl.get()***REMOVED***,
             X509_V_FLAG_CRL_CHECK) != X509_V_ERR_UNABLE_TO_GET_CRL) ***REMOVED***
    fprintf(stderr, "Bad CRL issuer was unnoticed.\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***root.get()***REMOVED***, ***REMOVED***known_critical_crl.get()***REMOVED***,
             X509_V_FLAG_CRL_CHECK) != X509_V_OK) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***root.get()***REMOVED***,
             ***REMOVED***unknown_critical_crl.get()***REMOVED***, X509_V_FLAG_CRL_CHECK) !=
      X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION) ***REMOVED***
    fprintf(stderr, "CRL with unknown critical extension was accepted.\n");
    return false;
  ***REMOVED***

  if (Verify(leaf.get(), ***REMOVED***root.get()***REMOVED***, ***REMOVED***root.get()***REMOVED***,
             ***REMOVED***unknown_critical_crl2.get()***REMOVED***, X509_V_FLAG_CRL_CHECK) !=
      X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION) ***REMOVED***
...
static bool TestPSS() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!X509_verify(cert.get(), pkey.get())) ***REMOVED***
...
static bool TestBadPSSParameters() ***REMOVED***
...
static bool SignatureRoundTrips(EVP_MD_CTX *md_ctx, EVP_PKEY *pkey) ***REMOVED***
  // Make a certificate like signed with |md_ctx|'s settings.'
  bssl::UniquePtr<X509> cert(CertFromPEM(kLeafPEM));
  if (!cert || !X509_sign_ctx(cert.get(), md_ctx)) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestSignCtx() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!EVP_DigestSignInit(md_ctx.get(), NULL, EVP_sha256(), NULL, pkey.get()) ||
      !SignatureRoundTrips(md_ctx.get(), pkey.get())) ***REMOVED***
...
static bool PEMToDER(bssl::UniquePtr<uint8_t> *out, size_t *out_len,
  ...
  ***REMOVED***
  ...
  uint8_t *data;
  long data_len;
  if (!PEM_read_bio(bio.get(), &name, &header, &data, &data_len)) ***REMOVED***
...
static bool TestFromBuffer() ***REMOVED***
  size_t data_len;
  bssl::UniquePtr<uint8_t> data;
  if (!PEMToDER(&data, &data_len, kRootCAPEM)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (enc_pointer < buf_pointer ||
      enc_pointer >= buf_pointer + CRYPTO_BUFFER_len(buf.get())) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (enc_pointer[0] != CBS_ASN1_SEQUENCE) ***REMOVED***
...
static bool TestFromBufferTrailingData() ***REMOVED***
  size_t data_len;
  bssl::UniquePtr<uint8_t> data;
  if (!PEMToDER(&data, &data_len, kRootCAPEM)) ***REMOVED***
    return false;
...
static bool TestFromBufferModified() ***REMOVED***
  size_t data_len;
  bssl::UniquePtr<uint8_t> data;
  if (!PEMToDER(&data, &data_len, kRootCAPEM)) ***REMOVED***
    return false;
  ...
  ***REMOVED***
  ...
  if (i2d_X509(root.get(), nullptr) != static_cast<long>(data_len)) ***REMOVED***
    fprintf(stderr,
...
static bool TestFromBufferReused() ***REMOVED***
  size_t data_len;
  bssl::UniquePtr<uint8_t> data;
  if (!PEMToDER(&data, &data_len, kRootCAPEM)) ***REMOVED***
    return false;
  ...
  ***REMOVED***
  ...
  if (!PEMToDER(&data2, &data2_len, kLeafPEM)) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  ***REMOVED***
  if (i2d_len != static_cast<long>(data2_len) ||
      OPENSSL_memcmp(data2.get(), i2d, i2d_len) != 0) ***REMOVED***
    fprintf(stderr, "TestFromBufferReused: i2d gave wrong result.\n");
    return false;
  ***REMOVED***

  if (root->buf != NULL) ***REMOVED***
...
static bool TestFailedParseFromBuffer() ***REMOVED***
  static const uint8_t kNonsense[] = ***REMOVED***1, 2, 3, 4, 5***REMOVED***;
  ...
  ***REMOVED***
  ...
  if (!buf_with_trailing_byte) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestPrintUTCTIME() ***REMOVED***
  static const struct ***REMOVED***
    const char *val, *want;
  ***REMOVED*** asn1_utctime_tests[] = ***REMOVED***
    ***REMOVED***"", "Bad time value"***REMOVED***,

    // Correct RFC 5280 form. Test years < 2000 and > 2000.
    ***REMOVED***"090303125425Z", "Mar  3 12:54:25 2009 GMT"***REMOVED***,
    ***REMOVED***"900303125425Z", "Mar  3 12:54:25 1990 GMT"***REMOVED***,
    ***REMOVED***"000303125425Z", "Mar  3 12:54:25 2000 GMT"***REMOVED***,

    // Correct form, bad values.
    ***REMOVED***"000000000000Z", "Bad time value"***REMOVED***,
    ***REMOVED***"999999999999Z", "Bad time value"***REMOVED***,

    // Missing components. Not legal RFC 5280, but permitted.
    ***REMOVED***"090303125425", "Mar  3 12:54:25 2009"***REMOVED***,
    ***REMOVED***"9003031254", "Mar  3 12:54:00 1990"***REMOVED***,
    ***REMOVED***"9003031254Z", "Mar  3 12:54:00 1990 GMT"***REMOVED***,

    // GENERALIZEDTIME confused for UTCTIME.
    ***REMOVED***"20090303125425Z", "Bad time value"***REMOVED***,

    // Legal ASN.1, but not legal RFC 5280.
    ***REMOVED***"9003031254+0800", "Bad time value"***REMOVED***,
    ***REMOVED***"9003031254-0800", "Bad time value"***REMOVED***,

    // Trailing garbage.
    ***REMOVED***"9003031254Z ", "Bad time value"***REMOVED***,
  ***REMOVED***;

  for (auto t : asn1_utctime_tests) ***REMOVED***
    ...
    // question.
    if (!ASN1_STRING_set(tm.get(), t.val, strlen(t.val))) ***REMOVED***
    ...
    ***REMOVED***
    ...
    size_t len;
    if (!BIO_mem_contents(bio.get(), &contents, &len)) ***REMOVED***
      fprintf(stderr, "BIO_mem_contents\n");
      return false;
    ***REMOVED***

    if (ok != (strcmp(t.want, "Bad time value") != 0)) ***REMOVED***
      fprintf(stderr, "ASN1_UTCTIME_print(%s): bad return value\n", t.val);
      return false;
    ***REMOVED***
    if (len != strlen(t.want) || memcmp(contents, t.want, len)) ***REMOVED***
