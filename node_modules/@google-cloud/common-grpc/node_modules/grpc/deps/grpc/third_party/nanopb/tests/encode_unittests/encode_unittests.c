...
***REMOVED***
    ...
    ***REMOVED***
        ...
        pb_ostream_t stream = ***REMOVED***&streamcallback, 0, SIZE_MAX, 0***REMOVED***;
    ...
    ***REMOVED***
        uint8_t buffer[30];
        pb_ostream_t s;
        pb_field_t field = ***REMOVED***10, PB_LTYPE_SVARINT***REMOVED***;
    ...
    ***REMOVED***
        ...
        pb_field_t field = ***REMOVED***1, PB_LTYPE_VARINT, 0, 0, sizeof(value)***REMOVED***;
    ...
    ***REMOVED***
        uint8_t buffer[30];
        pb_ostream_t s;
        struct ***REMOVED*** pb_size_t size; uint8_t bytes[5]; ***REMOVED*** value = ***REMOVED***5, ***REMOVED***'x', 'y', 'z', 'z', 'y'***REMOVED******REMOVED***;
    ...
    ***REMOVED***
        uint8_t buffer[10];
        pb_ostream_t s;
        IntegerArray msg = ***REMOVED***5, ***REMOVED***1, 2, 3, 4, 5***REMOVED******REMOVED***;
    ...
    ***REMOVED***
        uint8_t buffer[10];
        pb_ostream_t s;
        FloatArray msg = ***REMOVED***1, ***REMOVED***99.0f***REMOVED******REMOVED***;
    ...
    ***REMOVED***
        uint8_t buffer[10];
        pb_ostream_t s;
        IntegerContainer msg = ***REMOVED******REMOVED***5, ***REMOVED***1,2,3,4,5***REMOVED******REMOVED******REMOVED***;
    ...
    ***REMOVED***
        uint8_t buffer[32];
        pb_ostream_t s;
        BytesMessage msg = ***REMOVED******REMOVED***3, "xyz"***REMOVED******REMOVED***;
    ...
    ***REMOVED***
        ...
        pb_ostream_t s;
        StringMessage msg = ***REMOVED***"0123456789"***REMOVED***;
    ...
    ***REMOVED***
        ...
        char *strs[1] = ***REMOVED***NULL***REMOVED***;
        char zstr[] = "Z";
