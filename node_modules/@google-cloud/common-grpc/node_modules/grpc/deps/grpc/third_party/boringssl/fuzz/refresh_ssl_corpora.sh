...
minimize_corpus() ***REMOVED***
  local fuzzer="$1"
  local corpus="$2"

  echo "Minimizing $***REMOVED***corpus***REMOVED***"
  mv "$corpus" "$***REMOVED***corpus***REMOVED***_old"
  mkdir "$corpus"
  "$fuzzer" -max_len=50000 -merge=1 "$corpus" "$***REMOVED***corpus***REMOVED***_old"
  rm -Rf "$***REMOVED***corpus***REMOVED***_old"
***REMOVED***
...
"$fuzzer_mode_build_dir/fuzz/client" -max_len=50000 -merge=1 client_corpus "$***REMOVED***fuzzer_mode_transcripts***REMOVED***/tls/client"
"$fuzzer_mode_build_dir/fuzz/server" -max_len=50000 -merge=1 server_corpus "$***REMOVED***fuzzer_mode_transcripts***REMOVED***/tls/server"
"$no_fuzzer_mode_build_dir/fuzz/client" -max_len=50000 -merge=1 client_corpus_no_fuzzer_mode "$***REMOVED***no_fuzzer_mode_transcripts***REMOVED***/tls/client"
"$no_fuzzer_mode_build_dir/fuzz/server" -max_len=50000 -merge=1 server_corpus_no_fuzzer_mode "$***REMOVED***no_fuzzer_mode_transcripts***REMOVED***/tls/server"
