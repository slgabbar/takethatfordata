...
static const HKDFTestVector kTests[] = ***REMOVED***
  ***REMOVED***
    EVP_sha256,
    ***REMOVED***
  ...
  for (size_t i = 0; i < OPENSSL_ARRAY_SIZE(kTests); i++) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (!HKDF(buf, test->out_len, test->md_func(), test->ikm, test->ikm_len,
              test->salt, test->salt_len, test->info, test->info_len)) ***REMOVED***
