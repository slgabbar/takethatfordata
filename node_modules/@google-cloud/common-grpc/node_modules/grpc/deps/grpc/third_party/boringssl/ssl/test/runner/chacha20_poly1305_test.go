...
func TestChaChaQuarterRound(t *testing.T) ***REMOVED***
	state := [16]uint32***REMOVED***0x11111111, 0x01020304, 0x9b8d6f43, 0x01234567***REMOVED***
	chaChaQuarterRound(&state, 0, 1, 2, 3)

	a, b, c, d := state[0], state[1], state[2], state[3]
	if a != 0xea2a92f4 || b != 0xcb1cf8ce || c != 0x4581472e || d != 0x5881c4bb ***REMOVED***
		t.Errorf("Incorrect results: %x", state)
	***REMOVED***
***REMOVED***

// See RFC 7539, section 2.2.1.
func TestChaChaQuarterRoundState(t *testing.T) ***REMOVED***
	state := [16]uint32***REMOVED***
...
func TestChaCha20Block(t *testing.T) ***REMOVED***
	state := [16]uint32***REMOVED***
...
func decodeHexOrPanic(in string) []byte ***REMOVED***
...
var chaCha20Poly1305TestVectors = []struct ***REMOVED***
...
func TestChaCha20Poly1305(t *testing.T) ***REMOVED***
	for i, tt := range chaCha20Poly1305TestVectors ***REMOVED***
		...
		***REMOVED*** else if !bytes.Equal(out, input) ***REMOVED***
			t.Errorf("%d. Open gave %x, wanted %x", i, out, input)
		***REMOVED***

		out = aead.Seal(nil, nonce, input, ad)
		if !bytes.Equal(out, output) ***REMOVED***
