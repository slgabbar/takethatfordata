...
Suppose you put Google Test in directory `$***REMOVED***GTEST_DIR***REMOVED***`.  To build it,
create a library build target (or a project as called by Visual Studio
and Xcode) to compile

    $***REMOVED***GTEST_DIR***REMOVED***/src/gtest-all.cc

with `$***REMOVED***GTEST_DIR***REMOVED***/include` in the system header search path and `$***REMOVED***GTEST_DIR***REMOVED***`
in the normal header search path.  Assuming a Linux-like system and gcc,
something like the following will do:

    g++ -isystem $***REMOVED***GTEST_DIR***REMOVED***/include -I$***REMOVED***GTEST_DIR***REMOVED*** \
        -pthread -c $***REMOVED***GTEST_DIR***REMOVED***/src/gtest-all.cc
    ar -rv libgtest.a gtest-all.o

(We need `-pthread` as Google Test uses threads.)

Next, you should compile your test source file with
`$***REMOVED***GTEST_DIR***REMOVED***/include` in the system header search path, and link it
with gtest and any other necessary libraries:

    g++ -isystem $***REMOVED***GTEST_DIR***REMOVED***/include -pthread path/to/your_test.cc libgtest.a \
        -o your_test
...
following commands should succeed:
    ...
    cd $***REMOVED***GTEST_DIR***REMOVED***/make
    make
    ./sample1_unittest
...
workflow starts with:
    ...
    cd mybuild
    cmake $***REMOVED***GTEST_DIR***REMOVED***  # Generate native build scripts.

If you want to build Google Test's samples, you should replace the
last command with

    cmake -Dgtest_build_samples=ON $***REMOVED***GTEST_DIR***REMOVED***
...
New file `CMakeLists.txt.in`:
    ...
    ExternalProject_Add(googletest
      ...
      GIT_TAG           master
      SOURCE_DIR        "$***REMOVED***CMAKE_BINARY_DIR***REMOVED***/googletest-src"
      BINARY_DIR        "$***REMOVED***CMAKE_BINARY_DIR***REMOVED***/googletest-build"
      CONFIGURE_COMMAND ""
      BUILD_COMMAND     ""
      INSTALL_COMMAND   ""
      TEST_COMMAND      ""
...
Existing build's `CMakeLists.txt`:
    ...
    execute_process(COMMAND $***REMOVED***CMAKE_COMMAND***REMOVED*** -G "$***REMOVED***CMAKE_GENERATOR***REMOVED***" .
      RESULT_VARIABLE result
      WORKING_DIRECTORY $***REMOVED***CMAKE_BINARY_DIR***REMOVED***/googletest-download )
    if(result)
      message(FATAL_ERROR "CMake step for googletest failed: $***REMOVED***result***REMOVED***")
    endif()
    execute_process(COMMAND $***REMOVED***CMAKE_COMMAND***REMOVED*** --build .
      RESULT_VARIABLE result
      WORKING_DIRECTORY $***REMOVED***CMAKE_BINARY_DIR***REMOVED***/googletest-download )
    if(result)
      message(FATAL_ERROR "Build step for googletest failed: $***REMOVED***result***REMOVED***")
    endif()
    ...
    add_subdirectory($***REMOVED***CMAKE_BINARY_DIR***REMOVED***/googletest-src
                     $***REMOVED***CMAKE_BINARY_DIR***REMOVED***/googletest-build)

    # The gtest/gtest_main targets carry header search path
    # dependencies automatically when using CMake 2.8.11 or
    # later. Otherwise we have to add them here ourselves.
    if (CMAKE_VERSION VERSION_LESS 2.8.11)
      include_directories("$***REMOVED***gtest_SOURCE_DIR***REMOVED***/include")
    endif()
...
For that you can use CMake:
    ...
    mkdir mybuild
    cd mybuild
    cmake -Dgtest_build_tests=ON $***REMOVED***GTEST_DIR***REMOVED***
...
executable can be found:
    ...
    cmake -DPYTHON_EXECUTABLE=path/to/python -Dgtest_build_tests=ON $***REMOVED***GTEST_DIR***REMOVED***
