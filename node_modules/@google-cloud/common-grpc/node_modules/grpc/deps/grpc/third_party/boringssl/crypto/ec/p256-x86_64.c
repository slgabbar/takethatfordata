...
static const BN_ULONG ONE[P256_LIMBS] = ***REMOVED***
...
static unsigned booth_recode_w5(unsigned in) ***REMOVED***
  unsigned s, d;
...
static unsigned booth_recode_w7(unsigned in) ***REMOVED***
  unsigned s, d;
...
static void copy_conditional(BN_ULONG dst[P256_LIMBS],
                             const BN_ULONG src[P256_LIMBS], BN_ULONG move) ***REMOVED***
 ...
 * (check-sat)
 * */
static BN_ULONG is_not_zero(BN_ULONG in) ***REMOVED***
  in |= (0 - in);
  in >>= BN_BITS2 - 1;
  return in;
***REMOVED***
...
static void ecp_nistz256_mod_inverse_mont(BN_ULONG r[P256_LIMBS],
                                          const BN_ULONG in[P256_LIMBS]) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (i = 0; i < 31; i++) ***REMOVED***
    ecp_nistz256_sqr_mont(res, res);
  ***REMOVED***
  ecp_nistz256_mul_mont(res, res, in);

  for (i = 0; i < 32 * 4; i++) ***REMOVED***
    ecp_nistz256_sqr_mont(res, res);
  ***REMOVED***
...
static int ecp_nistz256_bignum_to_field_elem(BN_ULONG out[P256_LIMBS],
                                             const BIGNUM *in) ***REMOVED***
  if (in->top > P256_LIMBS) ***REMOVED***
    return 0;
  ***REMOVED***
...
static int ecp_nistz256_windowed_mul(const EC_GROUP *group, P256_POINT *r,
  ...
  if (BN_num_bits(p_scalar) > 256 || BN_is_negative(p_scalar)) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (mod == NULL) ***REMOVED***
      ...
      goto err;
    ***REMOVED***
    if (!BN_nnmod(mod, p_scalar, &group->order, ctx)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  int j;
  for (j = 0; j < p_scalar->top * BN_BYTES; j += BN_BYTES) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!ecp_nistz256_bignum_to_field_elem(row[1 - 1].X, &p->X) ||
      ...
      !ecp_nistz256_bignum_to_field_elem(row[1 - 1].Z, &p->Z)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  while (index >= 5) ***REMOVED***
    if (index != 255) ***REMOVED***
...
static int ecp_nistz256_points_mul(
    ...
    const EC_POINT *p_, const BIGNUM *p_scalar, BN_CTX *ctx) ***REMOVED***
  assert((p_ != NULL) == (p_scalar != NULL));

  static const unsigned kWindowSize = 7;
  static const unsigned kMask = (1 << (7 /* kWindowSize */ + 1)) - 1;

  alignas(32) union ***REMOVED***
    P256_POINT p;
    P256_POINT_AFFINE a;
  ***REMOVED*** t, p;
  ...
  if (g_scalar != NULL) ***REMOVED***
    ...
    ***REMOVED***
    ...
    uint8_t p_str[33] = ***REMOVED***0***REMOVED***;
    int i;
    for (i = 0; i < g_scalar->top * BN_BYTES; i += BN_BYTES) ***REMOVED***
    ...
    ***REMOVED***
    ...
    for (; i < (int) sizeof(p_str); i++) ***REMOVED***
      p_str[i] = 0;
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (p_scalar != NULL) ***REMOVED***
    P256_POINT *out = &t.p;
    if (p_is_infinity) ***REMOVED***
      out = &p.p;
    ***REMOVED***

    if (!ecp_nistz256_windowed_mul(group, out, p_, p_scalar, ctx)) ***REMOVED***
      goto err;
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!bn_set_words(&r->X, p.p.X, P256_LIMBS) ||
      ...
      !bn_set_words(&r->Z, p.p.Z, P256_LIMBS)) ***REMOVED***
    return 0;
  ***REMOVED***
...
static int ecp_nistz256_get_affine(const EC_GROUP *group, const EC_POINT *point,
                                   BIGNUM *x, BIGNUM *y, BN_CTX *ctx) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!ecp_nistz256_bignum_to_field_elem(point_x, &point->X) ||
      ...
      !ecp_nistz256_bignum_to_field_elem(point_z, &point->Z)) ***REMOVED***
    OPENSSL_PUT_ERROR(EC, EC_R_COORDINATES_OUT_OF_RANGE);
    return 0;
  ***REMOVED***
  ...
  if (x != NULL) ***REMOVED***
    ...
    if (!bn_set_words(x, x_aff, P256_LIMBS)) ***REMOVED***
      OPENSSL_PUT_ERROR(EC, ERR_R_MALLOC_FAILURE);
      return 0;
    ***REMOVED***
  ***REMOVED***
  ...
  if (y != NULL) ***REMOVED***
    ...
    if (!bn_set_words(y, y_aff, P256_LIMBS)) ***REMOVED***
      OPENSSL_PUT_ERROR(EC, ERR_R_MALLOC_FAILURE);
      return 0;
    ***REMOVED***
  ***REMOVED***
...
const EC_METHOD EC_GFp_nistz256_method = ***REMOVED***
