...
***REMOVED*** grpc_compression_algorithm;
...
***REMOVED*** grpc_stream_compression_algorithm;
...
***REMOVED*** grpc_compression_level;
...
***REMOVED*** grpc_stream_compression_level;

typedef struct grpc_compression_options ***REMOVED***
  ...
  struct grpc_compression_options_default_level ***REMOVED***
    int is_set;
    grpc_compression_level level;
  ***REMOVED*** default_level;
  ...
  struct grpc_stream_compression_options_default_level ***REMOVED***
    int is_set;
    grpc_stream_compression_level level;
  ***REMOVED*** default_stream_compression_level;

  /** The default message compression algorithm. It'll be used in the absence of
   * call specific settings. This option corresponds to the channel argument key
   * behind \a GRPC_COMPRESSION_CHANNEL_DEFAULT_ALGORITHM. */
  struct grpc_compression_options_default_algorithm ***REMOVED***
    int is_set;
    grpc_compression_algorithm algorithm;
  ***REMOVED*** default_algorithm;
   ...
   */
  struct grpc_stream_compression_options_default_algorithm ***REMOVED***
    int is_set;
    grpc_stream_compression_algorithm algorithm;
  ***REMOVED*** default_stream_compression_algorithm;

***REMOVED*** grpc_compression_options;
