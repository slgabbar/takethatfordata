...
struct gpr_gcc_thread_local ***REMOVED***
  intptr_t value;
  bool *inited;
***REMOVED***;
...
#define GPR_TLS_DECL(name)           \
  ...
  static __thread struct gpr_gcc_thread_local name = ***REMOVED***0, &(name##_inited)***REMOVED***
...
#define GPR_TLS_DECL(name) \
  static __thread struct gpr_gcc_thread_local name = ***REMOVED***0***REMOVED***
