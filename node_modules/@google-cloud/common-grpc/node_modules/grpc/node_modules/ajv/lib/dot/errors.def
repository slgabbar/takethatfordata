...
***REMOVED******REMOVED***## def.appendSchema:***REMOVED******REMOVED***?$isData***REMOVED******REMOVED***' + ***REMOVED******REMOVED***=$schemaValue***REMOVED******REMOVED******REMOVED******REMOVED***??***REMOVED******REMOVED******REMOVED******REMOVED***=$schema***REMOVED******REMOVED***'***REMOVED******REMOVED***?***REMOVED******REMOVED***#***REMOVED******REMOVED***
...
***REMOVED******REMOVED***## def._errorSchemas = ***REMOVED***
  ...
  constant:        "validate.schema***REMOVED******REMOVED***=$schemaPath***REMOVED******REMOVED***",
