'use strict';
module.exports = function generate_constant(it, $keyword) ***REMOVED***
  var out = ' ';
  var $lvl = it.level;
  ...
  ***REMOVED***
  ...
  if (it.createErrors !== false) ***REMOVED***
    out += ' ***REMOVED*** keyword: \'' + ('constant') + '\' , dataPath: (dataPath || \'\') + ' + (it.errorPath) + ' , schemaPath: ' + (it.util.toQuotedString($errSchemaPath)) + ' , params: ***REMOVED******REMOVED*** ';
