...
***REMOVED******REMOVED***## def.$dataCheckFormat:
  ***REMOVED******REMOVED***# def.$dataNotType:'string' ***REMOVED******REMOVED***
  (***REMOVED******REMOVED***? $unknownFormats === true || $allowUnknown ***REMOVED******REMOVED***
   ...
   ***REMOVED******REMOVED***?***REMOVED******REMOVED***
   (***REMOVED******REMOVED***=$format***REMOVED******REMOVED*** && !(typeof ***REMOVED******REMOVED***=$format***REMOVED******REMOVED*** == 'function'
...
***REMOVED******REMOVED***? $isData ***REMOVED******REMOVED***
  ***REMOVED******REMOVED*** var $format = 'format' + $lvl; ***REMOVED******REMOVED***
  var ***REMOVED******REMOVED***=$format***REMOVED******REMOVED*** = formats[***REMOVED******REMOVED***=$schemaValue***REMOVED******REMOVED***];
  var isObject***REMOVED******REMOVED***=$lvl***REMOVED******REMOVED*** = typeof ***REMOVED******REMOVED***=$format***REMOVED******REMOVED*** == 'object'
                          && !(***REMOVED******REMOVED***=$format***REMOVED******REMOVED*** instanceof RegExp)
                          && ***REMOVED******REMOVED***=$format***REMOVED******REMOVED***.validate;
  if (isObject***REMOVED******REMOVED***=$lvl***REMOVED******REMOVED***) ***REMOVED***
    ***REMOVED******REMOVED***? it.async***REMOVED******REMOVED***
...
***REMOVED******REMOVED***??***REMOVED******REMOVED***
  ...
  ***REMOVED******REMOVED***? !$format ***REMOVED******REMOVED***
    ***REMOVED******REMOVED***? $unknownFormats === true || ($allowUnknown && $unknownFormats.indexOf($schema) == -1) ***REMOVED******REMOVED***
