...
var Stream = require("stream").Stream
  ...
  , debug = process.env.DEBUG ? console.error : function () ***REMOVED******REMOVED***

function BlockStream (size, opt) ***REMOVED***
  this.writable = this.readable = true
  this._opt = opt || ***REMOVED******REMOVED***
  ...
  if (this._opt.nopad) this._zeroes = false
    ...
    for (var i = 0; i < this._chunkSize; i ++) ***REMOVED***
      this._zeroes[i] = 0
    ***REMOVED***
  ***REMOVED***
***REMOVED***
...
BlockStream.prototype.write = function (c) ***REMOVED***
  // debug("   BS write", c)
  ...
  ***REMOVED***
  ...
  if (this._bufferLength >= this._chunkSize) ***REMOVED***
...
BlockStream.prototype.pause = function () ***REMOVED***
  // debug("   BS pausing")
  this._paused = true
***REMOVED***

BlockStream.prototype.resume = function () ***REMOVED***
  // debug("   BS resume")
  this._paused = false
  return this._emitChunk()
***REMOVED***

BlockStream.prototype.end = function (chunk) ***REMOVED***
  // debug("end", chunk)
...
BlockStream.prototype.flush = function () ***REMOVED***
  this._emitChunk(true)
***REMOVED***

BlockStream.prototype._emitChunk = function (flush) ***REMOVED***
  // debug("emitChunk flush=%j emitting=%j paused=%j", flush, this._emitting, this._paused)

  // emit a <chunkSize> chunk
  if (flush && this._zeroes) ***REMOVED***
  ...
  ***REMOVED***
  ...
  while (this._bufferLength >= this._chunkSize &&
    ...
    while (outHas > 0 && (flush || !this._paused) ) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (flush && !this._zeroes && l) ***REMOVED***
    if (l === 1) ***REMOVED***
      if (this._offset) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if ((this._bufferLength === 0) && this._ended && !this._endEmitted) ***REMOVED***
