...
test('parse()', function (t) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    t.test('parses a mix of simple and explicit arrays', function (st) ***REMOVED***
        ...
        st.deepEqual(qs.parse('a[1]=b&a=c', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: ['b', 'c'] ***REMOVED***);
        st.deepEqual(qs.parse('a[]=b&a=c', ***REMOVED*** arrayLimit: 0 ***REMOVED***), ***REMOVED*** a: ['b', 'c'] ***REMOVED***);
        st.deepEqual(qs.parse('a[]=b&a=c'), ***REMOVED*** a: ['b', 'c'] ***REMOVED***);

        st.deepEqual(qs.parse('a=b&a[1]=c', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: ['b', 'c'] ***REMOVED***);
        st.deepEqual(qs.parse('a=b&a[]=c', ***REMOVED*** arrayLimit: 0 ***REMOVED***), ***REMOVED*** a: ['b', 'c'] ***REMOVED***);
        st.deepEqual(qs.parse('a=b&a[]=c'), ***REMOVED*** a: ['b', 'c'] ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    t.test('allows to specify array indices', function (st) ***REMOVED***
        ...
        st.deepEqual(qs.parse('a[1]=c', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: ['c'] ***REMOVED***);
        st.deepEqual(qs.parse('a[1]=c', ***REMOVED*** arrayLimit: 0 ***REMOVED***), ***REMOVED*** a: ***REMOVED*** 1: 'c' ***REMOVED*** ***REMOVED***);
        st.deepEqual(qs.parse('a[1]=c'), ***REMOVED*** a: ['c'] ***REMOVED***);
        st.end();
    ***REMOVED***);

    t.test('limits specific array indices to arrayLimit', function (st) ***REMOVED***
        st.deepEqual(qs.parse('a[20]=a', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: ['a'] ***REMOVED***);
        st.deepEqual(qs.parse('a[21]=a', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: ***REMOVED*** 21: 'a' ***REMOVED*** ***REMOVED***);
        st.end();
    ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    t.test('transforms arrays to objects', function (st) ***REMOVED***
        ...
        st.deepEqual(qs.parse('a[]=b&a[t]=u&a[hasOwnProperty]=c', ***REMOVED*** allowPrototypes: false ***REMOVED***), ***REMOVED*** a: ***REMOVED*** 0: 'b', t: 'u' ***REMOVED*** ***REMOVED***);
        st.deepEqual(qs.parse('a[]=b&a[t]=u&a[hasOwnProperty]=c', ***REMOVED*** allowPrototypes: true ***REMOVED***), ***REMOVED*** a: ***REMOVED*** 0: 'b', t: 'u', hasOwnProperty: 'c' ***REMOVED*** ***REMOVED***);
        st.deepEqual(qs.parse('a[]=b&a[hasOwnProperty]=c&a[x]=y', ***REMOVED*** allowPrototypes: false ***REMOVED***), ***REMOVED*** a: ***REMOVED*** 0: 'b', x: 'y' ***REMOVED*** ***REMOVED***);
        st.deepEqual(qs.parse('a[]=b&a[hasOwnProperty]=c&a[x]=y', ***REMOVED*** allowPrototypes: true ***REMOVED***), ***REMOVED*** a: ***REMOVED*** 0: 'b', hasOwnProperty: 'c', x: 'y' ***REMOVED*** ***REMOVED***);
        st.end();
    ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    t.test('allows for empty strings in arrays', function (st) ***REMOVED***
        ...
        st.deepEqual(
            qs.parse('a[0]=b&a[1]&a[2]=c&a[19]=', ***REMOVED*** strictNullHandling: true, arrayLimit: 20 ***REMOVED***),
            ***REMOVED*** a: ['b', null, 'c', ''] ***REMOVED***,
            'with arrayLimit 20 + array indices: null then empty string works'
        );
        st.deepEqual(
            qs.parse('a[]=b&a[]&a[]=c&a[]=', ***REMOVED*** strictNullHandling: true, arrayLimit: 0 ***REMOVED***),
            ***REMOVED*** a: ['b', null, 'c', ''] ***REMOVED***,
    ...
    ***REMOVED***);
    ...
    t.test('compacts sparse arrays', function (st) ***REMOVED***
        st.deepEqual(qs.parse('a[10]=1&a[2]=2', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: ['2', '1'] ***REMOVED***);
        st.deepEqual(qs.parse('a[1][b][2][c]=1', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: [***REMOVED*** b: [***REMOVED*** c: '1' ***REMOVED***] ***REMOVED***] ***REMOVED***);
        st.deepEqual(qs.parse('a[1][2][3][c]=1', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: [[[***REMOVED*** c: '1' ***REMOVED***]]] ***REMOVED***);
        st.deepEqual(qs.parse('a[1][2][3][c][1]=1', ***REMOVED*** arrayLimit: 20 ***REMOVED***), ***REMOVED*** a: [[[***REMOVED*** c: ['1'] ***REMOVED***]]] ***REMOVED***);
        st.end();
    ***REMOVED***);
    ...
    ***REMOVED***);
    ...
    t.test('parses null objects correctly', ***REMOVED*** skip: !Object.create ***REMOVED***, function (st) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    t.test('does not allow overwriting prototype properties', function (st) ***REMOVED***
        st.deepEqual(qs.parse('a[hasOwnProperty]=b', ***REMOVED*** allowPrototypes: false ***REMOVED***), ***REMOVED******REMOVED***);
        st.deepEqual(qs.parse('hasOwnProperty=b', ***REMOVED*** allowPrototypes: false ***REMOVED***), ***REMOVED******REMOVED***);

        st.deepEqual(
            qs.parse('toString', ***REMOVED*** allowPrototypes: false ***REMOVED***),
            ***REMOVED******REMOVED***,
            'bare "toString" results in ***REMOVED******REMOVED***'
        );
    ...
    ***REMOVED***);
    ...
    t.test('can allow overwriting prototype properties', function (st) ***REMOVED***
        st.deepEqual(qs.parse('a[hasOwnProperty]=b', ***REMOVED*** allowPrototypes: true ***REMOVED***), ***REMOVED*** a: ***REMOVED*** hasOwnProperty: 'b' ***REMOVED*** ***REMOVED***);
        st.deepEqual(qs.parse('hasOwnProperty=b', ***REMOVED*** allowPrototypes: true ***REMOVED***), ***REMOVED*** hasOwnProperty: 'b' ***REMOVED***);

        st.deepEqual(
            qs.parse('toString', ***REMOVED*** allowPrototypes: true ***REMOVED***),
            ***REMOVED*** toString: '' ***REMOVED***,
            'bare "toString" results in ***REMOVED*** toString: "" ***REMOVED***'
        );

        st.end();
    ***REMOVED***);

    t.test('params starting with a closing bracket', function (st) ***REMOVED***
        st.deepEqual(qs.parse(']=toString'), ***REMOVED*** ']': 'toString' ***REMOVED***);
        st.deepEqual(qs.parse(']]=toString'), ***REMOVED*** ']]': 'toString' ***REMOVED***);
        st.deepEqual(qs.parse(']hello]=toString'), ***REMOVED*** ']hello]': 'toString' ***REMOVED***);
        st.end();
    ***REMOVED***);

    t.test('params starting with a starting bracket', function (st) ***REMOVED***
        st.deepEqual(qs.parse('[=toString'), ***REMOVED*** '[': 'toString' ***REMOVED***);
        st.deepEqual(qs.parse('[[=toString'), ***REMOVED*** '[[': 'toString' ***REMOVED***);
        st.deepEqual(qs.parse('[hello[=toString'), ***REMOVED*** '[hello[': 'toString' ***REMOVED***);
        st.end();
    ***REMOVED***);
    ...
    t.test('add keys to objects', function (st) ***REMOVED***
        st.deepEqual(
            qs.parse('a[b]=c&a=d'),
            ***REMOVED*** a: ***REMOVED*** b: 'c', d: true ***REMOVED*** ***REMOVED***,
        ...
        st.deepEqual(
            qs.parse('a[b]=c&a=toString', ***REMOVED*** allowPrototypes: true ***REMOVED***),
            ***REMOVED*** a: ***REMOVED*** b: 'c', toString: true ***REMOVED*** ***REMOVED***,
            'can overwrite prototype with allowPrototypes true'
        );

        st.deepEqual(
            qs.parse('a[b]=c&a=toString', ***REMOVED*** plainObjects: true ***REMOVED***),
            ***REMOVED*** a: ***REMOVED*** b: 'c', toString: true ***REMOVED*** ***REMOVED***,
    ...
    ***REMOVED***);
    ...
    t.test('can return null objects', ***REMOVED*** skip: !Object.create ***REMOVED***, function (st) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    t.test('throws error with wrong decoder', function (st) ***REMOVED***
        st.throws(function () ***REMOVED***
            qs.parse(***REMOVED******REMOVED***, ***REMOVED*** decoder: 'string' ***REMOVED***);
