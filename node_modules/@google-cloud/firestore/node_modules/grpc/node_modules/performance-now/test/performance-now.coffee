...
describe "now", ->
  ...
  it "shows that at least 990 ms has passed after a timeout of 1 second", (done) ->
    ...
    delay 1000, ->
      b = now()
      diff = b - a
      return done new Error "Diff (#***REMOVED***diff***REMOVED***) lower than 990." if diff < 990
      return done null
  ...
  it "shows that not more than 1020 ms has passed after a timeout of 1 second", (done) ->
    ...
    delay 1000, ->
      b = now()
      diff = b - a
      return done new Error "Diff (#***REMOVED***diff***REMOVED***) higher than 1020." if diff > 1020
      return done null        