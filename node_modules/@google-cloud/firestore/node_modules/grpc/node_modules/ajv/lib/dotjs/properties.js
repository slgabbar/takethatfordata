'use strict';
module.exports = function generate_properties(it, $keyword) ***REMOVED***
  var out = ' ';
  var $lvl = it.level;
    ...
    if ($someProperties) ***REMOVED***
      ...
      ***REMOVED***
      if ($pPropertyKeys.length) ***REMOVED***
        ...
        ***REMOVED***
      ***REMOVED***
      if (it.opts.v5 && $pgPropertyKeys && $pgPropertyKeys.length) ***REMOVED***
        ...
        if (it.util.schemaHasRules($sch, it.RULES.all)) ***REMOVED***
          ...
          ***REMOVED*** else ***REMOVED***
            if ($requiredHash && $requiredHash[$propertyKey]) ***REMOVED***
              out += ' if (' + ($useData) + ' === undefined) ***REMOVED*** ' + ($nextValid) + ' = false; ';
              var $currentErrorPath = it.errorPath,
            ...
            ***REMOVED*** else ***REMOVED***
              if ($breakOnError) ***REMOVED***
                out += ' if (' + ($useData) + ' === undefined) ***REMOVED*** ' + ($nextValid) + ' = true; ***REMOVED*** else ***REMOVED*** ';
              ***REMOVED*** else ***REMOVED***
                out += ' if (' + ($useData) + ' !== undefined) ***REMOVED*** ';
              ***REMOVED***
            ***REMOVED***
            out += ' ' + ($code) + ' ***REMOVED*** ';
          ***REMOVED***
    ...
    if (arr6) ***REMOVED***
      ...
      while (i6 < l6) ***REMOVED***
        ...
        if (it.util.schemaHasRules($sch, it.RULES.all)) ***REMOVED***
          ...
          out += ' var pgPropCount' + ($lvl) + ' = 0; for (var ' + ($key) + ' in ' + ($data) + ') ***REMOVED***  ';
          if ($ownProperties) ***REMOVED***
            out += ' if (!Object.prototype.hasOwnProperty.call(' + ($data) + ', ' + ($key) + ')) continue; ';
          ***REMOVED***
