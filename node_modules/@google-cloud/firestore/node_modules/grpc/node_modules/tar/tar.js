...
var fieldEnds = ***REMOVED******REMOVED***
  , fieldOffs = ***REMOVED******REMOVED***
  , fe = 0
for (var i = 0; i < f; i ++) ***REMOVED***
  fieldOffs[i] = fe
  fieldEnds[i] = (fe += fieldSize[i])
***REMOVED***

// build a translation table of field paths.
Object.keys(fields).forEach(function (f) ***REMOVED***
...
Object.keys(types).forEach(function (t) ***REMOVED***
  types[types[t]] = types[types[t]] || t
***REMOVED***)

// values for the mode field
var modes =
  ***REMOVED*** suid: 04000 // set uid on extraction
...
Object.keys(modes).forEach(function (t) ***REMOVED***
