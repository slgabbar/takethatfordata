...
class CallCredentials : public Nan::ObjectWrap ***REMOVED***
 public:
...
typedef struct plugin_callback_data ***REMOVED***
  const char *service_url;
  grpc_credentials_plugin_metadata_cb cb;
  void *user_data;
***REMOVED*** plugin_callback_data;

typedef struct plugin_state ***REMOVED***
  Nan::Callback *callback;
  std::queue<plugin_callback_data *> *pending_callbacks;
  uv_mutex_t plugin_mutex;
  // async.data == this
  uv_async_t plugin_async;
***REMOVED*** plugin_state;
