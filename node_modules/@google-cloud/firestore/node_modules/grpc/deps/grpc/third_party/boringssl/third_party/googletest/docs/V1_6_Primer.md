...
for (int i = 0; i < x.size(); ++i) ***REMOVED***
...
```
TEST(test_case_name, test_name) ***REMOVED***
 ... test body ...
***REMOVED***
```
...
TEST(FactorialTest, HandlesZeroInput) ***REMOVED***
  EXPECT_EQ(1, Factorial(0));
***REMOVED***

// Tests factorial of positive numbers.
TEST(FactorialTest, HandlesPositiveInput) ***REMOVED***
...
```
TEST_F(test_case_name, test_name) ***REMOVED***
 ... test body ...
***REMOVED***
```
...
```
class QueueTest : public ::testing::Test ***REMOVED***
 protected:
...
```
TEST_F(QueueTest, IsEmptyInitially) ***REMOVED***
  EXPECT_EQ(0, q0_.size());
***REMOVED***

TEST_F(QueueTest, DequeueWorks) ***REMOVED***
  int* n = q0_.Dequeue();
  EXPECT_EQ(NULL, n);
...
TEST_F(FooTest, MethodBarDoesAbc) ***REMOVED***
...
TEST_F(FooTest, DoesXyz) ***REMOVED***
...
```
__declspec(dllexport) int PullInMyLibrary() ***REMOVED*** return 0; ***REMOVED***
```
