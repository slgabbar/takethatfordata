...
static const uint8_t kNullPassword[] = ***REMOVED***
...
static const uint8_t kNullPasswordNSS[] = ***REMOVED***
...
static const uint8_t kEmptyPasswordOpenSSL[] = ***REMOVED***
...
static bool TestDecrypt(const uint8_t *der, size_t der_len,
  ...
  if (sig.get() == NULL || data != der + der_len) ***REMOVED***
...
static bool TestRoundTrip(int pbe_nid, const EVP_CIPHER *cipher,
                          ...
                          size_t salt_len, int iterations) ***REMOVED***
  static const uint8_t kSampleKey[] = ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (len < 0 ||
      ...
      OPENSSL_memcmp(encoded, kSampleKey, sizeof(kSampleKey)) != 0) ***REMOVED***
...
int main(int argc, char **argv) ***REMOVED***
  ...
  if (!TestDecrypt(kDER, sizeof(kDER), "testing") ||
      ...
      !TestRoundTrip(-1, EVP_rc2_cbc(), "password", nullptr, 0, 10)) ***REMOVED***
    return 1;
  ***REMOVED***
