...
static bool TestX25519() ***REMOVED***
  /* Taken from https://tools.ietf.org/html/rfc7748#section-5.2 */
  static const uint8_t kScalar1[32] = ***REMOVED***
      0xa5, 0x46, 0xe3, 0x6b, 0xf0, 0x52, 0x7c, 0x9d, 0x3b, 0x16, 0x15,
      0x4b, 0x82, 0x46, 0x5e, 0xdd, 0x62, 0x14, 0x4c, 0x0a, 0xc1, 0xfc,
      0x5a, 0x18, 0x50, 0x6a, 0x22, 0x44, 0xba, 0x44, 0x9a, 0xc4,
  ***REMOVED***;
  static const uint8_t kPoint1[32] = ***REMOVED***
  ...
  ***REMOVED***;
  ...
  static const uint8_t kExpected1[32] = ***REMOVED***
      0xc3, 0xda, 0x55, 0x37, 0x9d, 0xe9, 0xc6, 0x90, 0x8e, 0x94, 0xea,
      0x4d, 0xf2, 0x8d, 0x08, 0x4f, 0x32, 0xec, 0xcf, 0x03, 0x49, 0x1c,
      0x71, 0xf7, 0x54, 0xb4, 0x07, 0x55, 0x77, 0xa2, 0x85, 0x52,
  ***REMOVED***;
  if (OPENSSL_memcmp(kExpected1, out, sizeof(out)) != 0) ***REMOVED***
    fprintf(stderr, "X25519 test one failed.\n");
    return false;
  ***REMOVED***

  static const uint8_t kScalar2[32] = ***REMOVED***
  ...
  ***REMOVED***;
  static const uint8_t kPoint2[32] = ***REMOVED***
  ...
  ***REMOVED***;
  ...
  static const uint8_t kExpected2[32] = ***REMOVED***
  ...
  ***REMOVED***;
  if (OPENSSL_memcmp(kExpected2, out, sizeof(out)) != 0) ***REMOVED***
...
static bool TestX25519SmallOrder() ***REMOVED***
  static const uint8_t kSmallOrderPoint[32] = ***REMOVED***
  ...
  ***REMOVED***;
  ...
  if (X25519(out, private_key, kSmallOrderPoint)) ***REMOVED***
...
static bool TestX25519Iterated() ***REMOVED***
  /* Taken from https://tools.ietf.org/html/rfc7748#section-5.2 */
  uint8_t scalar[32] = ***REMOVED***9***REMOVED***, point[32] = ***REMOVED***9***REMOVED***, out[32];
  ...
  ***REMOVED***
  ...
  static const uint8_t kExpected[32] = ***REMOVED***
  ...
  ***REMOVED***;
  ...
  if (OPENSSL_memcmp(kExpected, scalar, sizeof(kExpected)) != 0) ***REMOVED***
