...
bn_mul_mont_gather5:
.cfi_startproc
	mov	$***REMOVED***num***REMOVED***d,$***REMOVED***num***REMOVED***d
	mov	%rsp,%rax
.cfi_def_cfa_register	%rax
	test	\$7,$***REMOVED***num***REMOVED***d
	jnz	.Lmul_enter
___
$code.=<<___ if ($addx);
...
$code.=<<___;
	...
	movdqa	%xmm4,%xmm3
___
for($k=0;$k<$STRIDE/16-4;$k+=4) ***REMOVED***
$code.=<<___;
	paddd	%xmm1,%xmm2
...
.Louter:
	...
	pxor	%xmm5,%xmm5
___
for($k=0;$k<$STRIDE/16;$k+=4) ***REMOVED***
$code.=<<___;
...
.Lmul4x_prologue:
	...
	.byte	0x67
	shl	\$3,$***REMOVED***num***REMOVED***d		# convert $num to bytes
...
$code.=<<___;
	...
	movdqa	%xmm4,%xmm3
___
for($i=0;$i<$STRIDE/16-4;$i+=4) ***REMOVED***
$code.=<<___;
	paddd	%xmm1,%xmm2
	pcmpeqd	%xmm5,%xmm1		# compare to 3,2
...
.Louter4x:
	...
	pxor	%xmm5,%xmm5
___
for($i=0;$i<$STRIDE/16;$i+=4) ***REMOVED***
$code.=<<___;
...
***REMOVED******REMOVED******REMOVED***

if ($addx) ***REMOVED******REMOVED******REMOVED***
