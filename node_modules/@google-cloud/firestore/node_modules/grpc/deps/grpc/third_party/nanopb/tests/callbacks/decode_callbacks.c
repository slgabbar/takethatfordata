...
***REMOVED***
    uint8_t buffer[1024] = ***REMOVED***0***REMOVED***;
...
***REMOVED***
     ...
     */
    TestMessage testmessage = ***REMOVED******REMOVED******REMOVED***NULL***REMOVED******REMOVED******REMOVED***;
    ...
    testmessage.submsg.stringvalue.arg = "submsg ***REMOVED***\n  stringvalue: \"%s\"\n";
