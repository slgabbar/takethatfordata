...
***REMOVED***
    ...
    ***REMOVED***
        uint8_t buffer[20];
        pb_istream_t stream = ***REMOVED***&stream_callback, NULL, 20***REMOVED***;
    ...
    ***REMOVED***
        ...
        pb_field_t f = ***REMOVED***1, PB_LTYPE_VARINT, 0, 0, 4, 0, 0***REMOVED***;
        uint32_t d;
    ...
    ***REMOVED***
        pb_istream_t s;
        pb_field_t f = ***REMOVED***1, PB_LTYPE_SVARINT, 0, 0, 4, 0, 0***REMOVED***;
        int32_t d;
    ...
    ***REMOVED***
        pb_istream_t s;
        pb_field_t f = ***REMOVED***1, PB_LTYPE_SVARINT, 0, 0, 8, 0, 0***REMOVED***;
        uint64_t d;
    ...
    ***REMOVED***
        pb_istream_t s;
        pb_field_t f = ***REMOVED***1, PB_LTYPE_FIXED32, 0, 0, 4, 0, 0***REMOVED***;
        float d;
    ...
    ***REMOVED***
        pb_istream_t s;
        pb_field_t f = ***REMOVED***1, PB_LTYPE_FIXED64, 0, 0, 8, 0, 0***REMOVED***;
        double d;
    ...
    ***REMOVED***
        pb_istream_t s;
        struct ***REMOVED*** pb_size_t size; uint8_t bytes[5]; ***REMOVED*** d;
        pb_field_t f = ***REMOVED***1, PB_LTYPE_BYTES, 0, 0, sizeof(d), 0, 0***REMOVED***;
    ...
    ***REMOVED***
        pb_istream_t s;
        pb_field_t f = ***REMOVED***1, PB_LTYPE_STRING, 0, 0, 5, 0, 0***REMOVED***;
        char d[5];
    ...
    ***REMOVED***
        pb_istream_t s;
        CallbackArray dest;
        struct ***REMOVED*** pb_size_t size; uint8_t bytes[10]; ***REMOVED*** ref;
    ...
    ***REMOVED***
        pb_istream_t s;
        IntegerContainer dest = ***REMOVED******REMOVED***0***REMOVED******REMOVED***;
    ...
    ***REMOVED***
        pb_istream_t s = ***REMOVED***0***REMOVED***;
        void *data = NULL;
