...
typedef struct ***REMOVED*** uint64_t v[5]; ***REMOVED*** fe25519;
...
static void fe25519_setint(fe25519 *r, unsigned v) ***REMOVED***
  r->v[0] = v;
  r->v[1] = 0;
  r->v[2] = 0;
  r->v[3] = 0;
...
static void fe25519_pack(unsigned char r[32], const fe25519 *x) ***REMOVED***
  fe25519 t;
  t = *x;
...
static void fe25519_unpack(fe25519 *r, const uint8_t x[32]) ***REMOVED***
  r->v[0] = x[0];
...
static void fe25519_invert(fe25519 *r, const fe25519 *x) ***REMOVED***
  fe25519 z2;
  fe25519 z9;
  fe25519 z11;
  fe25519 z2_5_0;
...
static void mladder(fe25519 *xr, fe25519 *zr, const uint8_t s[32]) ***REMOVED***
  fe25519 work[5];
