...
static void exit_handler(void) ***REMOVED***
  if (failure_enabled && current_malloc_count > malloc_number_to_fail) ***REMOVED***
    _exit(88);
  ***REMOVED***
***REMOVED***

static void cpp_new_handler() ***REMOVED***
  // Return to try again. It won't fail a second time.
  return;
***REMOVED***

// should_fail_allocation returns true if the current allocation should fail.
static bool should_fail_allocation() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (should_fail && break_on_fail) ***REMOVED***
    raise(SIGTRAP);
  ***REMOVED***
  return should_fail;
***REMOVED***
...
void *malloc(size_t size) ***REMOVED***
  if (should_fail_allocation()) ***REMOVED***
    errno = ENOMEM;
    return NULL;
  ***REMOVED***
...
void *calloc(size_t num_elems, size_t size) ***REMOVED***
  if (should_fail_allocation()) ***REMOVED***
    errno = ENOMEM;
    return NULL;
  ***REMOVED***
...
void *realloc(void *ptr, size_t size) ***REMOVED***
  if (should_fail_allocation()) ***REMOVED***
    errno = ENOMEM;
    return NULL;
  ***REMOVED***
