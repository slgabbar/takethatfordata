...
// omitted.
static const uint8_t kECKeyWithoutPublic[] = ***REMOVED***
...
static const uint8_t kECKeySpecifiedCurve[] = ***REMOVED***
...
// padding.
static const uint8_t kECKeyMissingZeros[] = ***REMOVED***
...
// padding.
static const uint8_t kECKeyWithZeros[] = ***REMOVED***
...
static bool EncodeECPrivateKey(std::vector<uint8_t> *out, const EC_KEY *key) ***REMOVED***
  bssl::ScopedCBB cbb;
  uint8_t *der;
  size_t der_len;
...
TEST(ECTest, ZeroPadding) ***REMOVED***
...
TEST(ECTest, SpecifiedCurve) ***REMOVED***
...
TEST(ECTest, ArbitraryCurve) ***REMOVED***
  ...
  ***REMOVED***;
  static const uint8_t kA[] = ***REMOVED***
      0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc,
  ***REMOVED***;
  static const uint8_t kB[] = ***REMOVED***
      0x5a, 0xc6, 0x35, 0xd8, 0xaa, 0x3a, 0x93, 0xe7, 0xb3, 0xeb, 0xbd,
      0x55, 0x76, 0x98, 0x86, 0xbc, 0x65, 0x1d, 0x06, 0xb0, 0xcc, 0x53,
      0xb0, 0xf6, 0x3b, 0xce, 0x3c, 0x3e, 0x27, 0xd2, 0x60, 0x4b,
  ***REMOVED***;
  static const uint8_t kX[] = ***REMOVED***
      0x6b, 0x17, 0xd1, 0xf2, 0xe1, 0x2c, 0x42, 0x47, 0xf8, 0xbc, 0xe6,
      0xe5, 0x63, 0xa4, 0x40, 0xf2, 0x77, 0x03, 0x7d, 0x81, 0x2d, 0xeb,
      0x33, 0xa0, 0xf4, 0xa1, 0x39, 0x45, 0xd8, 0x98, 0xc2, 0x96,
  ***REMOVED***;
  static const uint8_t kY[] = ***REMOVED***
      0x4f, 0xe3, 0x42, 0xe2, 0xfe, 0x1a, 0x7f, 0x9b, 0x8e, 0xe7, 0xeb,
      0x4a, 0x7c, 0x0f, 0x9e, 0x16, 0x2b, 0xce, 0x33, 0x57, 0x6b, 0x31,
      0x5e, 0xce, 0xcb, 0xb6, 0x40, 0x68, 0x37, 0xbf, 0x51, 0xf5,
  ***REMOVED***;
  static const uint8_t kOrder[] = ***REMOVED***
...
class ECCurveTest : public testing::TestWithParam<EC_builtin_curve> ***REMOVED******REMOVED***;

TEST_P(ECCurveTest, SetAffine) ***REMOVED***
  // Generate an EC_KEY.
...
TEST_P(ECCurveTest, AddingEqualPoints) ***REMOVED***
  bssl::UniquePtr<EC_KEY> key(EC_KEY_new_by_curve_name(GetParam().nid));
  ASSERT_TRUE(key);
  ASSERT_TRUE(EC_KEY_generate_key(key.get()));
...
TEST_P(ECCurveTest, MulZero) ***REMOVED***
...
static std::vector<EC_builtin_curve> AllCurves() ***REMOVED***
...
static std::string CurveToString(
    const testing::TestParamInfo<EC_builtin_curve> &params) ***REMOVED***
