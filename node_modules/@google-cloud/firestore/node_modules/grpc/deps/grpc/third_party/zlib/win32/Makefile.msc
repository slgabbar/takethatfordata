...
***REMOVED***$(TOP)***REMOVED***.c.obj:
	$(CC) -c $(WFLAGS) $(CFLAGS) $<

***REMOVED***$(TOP)/test***REMOVED***.c.obj:
	$(CC) -c -I$(TOP) $(WFLAGS) $(CFLAGS) $<

***REMOVED***$(TOP)/contrib/masmx64***REMOVED***.c.obj:
	$(CC) -c $(WFLAGS) $(CFLAGS) $<

***REMOVED***$(TOP)/contrib/masmx64***REMOVED***.asm.obj:
	$(AS) -c $(ASFLAGS) $<

***REMOVED***$(TOP)/contrib/masmx86***REMOVED***.asm.obj:
	$(AS) -c $(ASFLAGS) $<
