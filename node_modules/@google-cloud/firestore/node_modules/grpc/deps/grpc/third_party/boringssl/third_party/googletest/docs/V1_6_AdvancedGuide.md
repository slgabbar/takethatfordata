...
bool MutuallyPrime(int m, int n) ***REMOVED*** ... ***REMOVED***
const int a = 3;
const int b = 4;
const int c = 10;
```
...
int SmallestPrimeCommonDivisor(int m, int n) ***REMOVED*** ... ***REMOVED***
...
class Bar ***REMOVED*** ... ***REMOVED***;  // We want Google Test to be able to print instances of this.

// It's important that the << operator is defined in the SAME
// namespace that defines Bar.  C++'s look-up rules rely on that.
::std::ostream& operator<<(::std::ostream& os, const Bar& bar) ***REMOVED***
...
class Bar ***REMOVED*** ... ***REMOVED***;

// It's important that PrintTo() is defined in the SAME
// namespace that defines Bar.  C++'s look-up rules rely on that.
void PrintTo(const Bar& bar, ::std::ostream* os) ***REMOVED***
...
```
TEST(My*DeathTest*, Foo) ***REMOVED***
  // This death test uses a compound statement.
  ASSERT_DEATH(***REMOVED*** int n = 5; Foo(&n); ***REMOVED***, "Error on line .* of Foo()");
***REMOVED***
TEST(MyDeathTest, NormalExit) ***REMOVED***
  EXPECT_EXIT(NormalExit(), ::testing::ExitedWithCode(0), "Success");
***REMOVED***
TEST(MyDeathTest, KillMyself) ***REMOVED***
...
```
class FooTest : public ::testing::Test ***REMOVED*** ... ***REMOVED***;

typedef FooTest FooDeathTest;

TEST_F(FooTest, DoesThis) ***REMOVED***
  // normal test
***REMOVED***

TEST_F(FooDeathTest, DoesThat) ***REMOVED***
  // death test
***REMOVED***
```
...
(`"x***REMOVED***5,7***REMOVED***"`), among others. Below is what we do support (`A` denotes a
...
```
TEST(MyDeathTest, TestOne) ***REMOVED***
  ::testing::FLAGS_gtest_death_test_style = "threadsafe";
  // This test is run in the "threadsafe" style:
  ASSERT_DEATH(ThisShouldDie(), "");
***REMOVED***

TEST(MyDeathTest, TestTwo) ***REMOVED***
...
```
10: void Sub1(int n) ***REMOVED***
11:   EXPECT_EQ(1, Bar(n));
12:   EXPECT_EQ(2, Bar(n + 1));
13: ***REMOVED***
14:
15: TEST(FooTest, Bar) ***REMOVED***
16:   ***REMOVED***
...
int i;
EXPECT_NO_FATAL_FAILURE(***REMOVED***
  i = Bar();
***REMOVED***);
```
...
```
TEST_F(WidgetUsageTest, MinAndMaxWidgets) ***REMOVED***
...
TEST_F(FooTest, Test1) ***REMOVED***
  ... you can refer to shared_resource here ...
***REMOVED***
TEST_F(FooTest, Test2) ***REMOVED***
  ... you can refer to shared_resource here ...
***REMOVED***
```
...
```
TEST(MyCodeTest, TestFoo) ***REMOVED***
  // A code to test foo().
***REMOVED***
```
...
```
void TestFooHelper(bool flag_value) ***REMOVED***
  flag = flag_value;
  // A code to test foo().
***REMOVED***

TEST(MyCodeTest, TestFooo) ***REMOVED***
  TestFooHelper(false);
  TestFooHelper(true);
***REMOVED***
```
...
class BarTest : public BaseTest,
                public ::testing::WithParamInterface<const char*> ***REMOVED***
  ...
***REMOVED***;
```
...
| `Range(begin, end[, step])` | Yields values `***REMOVED***begin, begin+step, begin+step+step, ...***REMOVED***`. The values do not include `end`. `step` defaults to 1. |
|:----------------------------|:------------------------------------------------------------------------------------------------------------------|
...
```
TYPED_TEST(FooTest, DoesBlah) ***REMOVED***
...
TYPED_TEST(FooTest, HasPropertyA) ***REMOVED*** ... ***REMOVED***
```
...
```
TYPED_TEST_P(FooTest, DoesBlah) ***REMOVED***
  // Inside a test, refer to TypeParam to get the type parameter.
  TypeParam n = 0;
  ...
***REMOVED***

TYPED_TEST_P(FooTest, HasPropertyA) ***REMOVED*** ... ***REMOVED***
```
...
// foo_test.cc
...
TEST(FooTest, BarReturnsZeroOnNull) ***REMOVED***
  Foo foo;
...
```
  class MinimalistPrinter : public ::testing::EmptyTestEventListener ***REMOVED***
    // Called before a test starts.
    virtual void OnTestStart(const ::testing::TestInfo& test_info) ***REMOVED***
    ...
    ***REMOVED***
    ...
    virtual void OnTestPartResult(
        const ::testing::TestPartResult& test_part_result) ***REMOVED***
      printf("%s in %s:%d\n%s\n",
    ...
    ***REMOVED***
    ...
    virtual void OnTestEnd(const ::testing::TestInfo& test_info) ***REMOVED***
...
TEST(FooTest, DISABLED_DoesAbc) ***REMOVED*** ... ***REMOVED***

class DISABLED_BarTest : public ::testing::Test ***REMOVED*** ... ***REMOVED***;

// Tests that Bar does Xyz.
TEST_F(DISABLED_BarTest, DoesXyz) ***REMOVED*** ... ***REMOVED***
```
...
```
TEST(MathTest, Addition) ***REMOVED*** ... ***REMOVED***
TEST(MathTest, Subtraction) ***REMOVED*** ... ***REMOVED***
TEST(LogicTest, NonContradiction) ***REMOVED*** ... ***REMOVED***
```
