...
static const uint8_t kTagOverflow[] = ***REMOVED***
    0x1f, 0xff, 0xff, 0xff, 0xff, 0x7f, 0x01, 0x00,
***REMOVED***;

static bool TestLargeTags() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!obj || obj->type != 128 || obj->value.asn1_string->length != 1 ||
      obj->value.asn1_string->data[0] != 0) ***REMOVED***
