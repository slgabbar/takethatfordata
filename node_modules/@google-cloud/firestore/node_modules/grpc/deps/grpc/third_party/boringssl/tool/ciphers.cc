...
bool Ciphers(const std::vector<std::string> &args) ***REMOVED***
  if (args.size() != 1) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!SSL_CTX_set_strict_cipher_list(ctx.get(), ciphers_string.c_str())) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (size_t i = 0; i < sk_SSL_CIPHER_num(ciphers); i++) ***REMOVED***
    ...
    if (in_group && !last_in_group) ***REMOVED***
      printf("[\n  ");
    ***REMOVED*** else if (last_in_group) ***REMOVED***
      printf("  ");
    ***REMOVED***
