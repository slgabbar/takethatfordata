...
```
TEST(Time, Flies_Like_An_Arrow) ***REMOVED*** ... ***REMOVED***
TEST(Time_Flies, Like_An_Arrow) ***REMOVED*** ... ***REMOVED***
```
...
```
try ***REMOVED*** ... ASSERT_TRUE(...) ... ***REMOVED***
catch (...) ***REMOVED*** ... ***REMOVED***
```
...
TEST_F(FooTest, DoesThis) ***REMOVED*** ... ***REMOVED***
```
or
```
typedef ::testing::Test FooTest;

TEST_F(FooTest, DoesThat) ***REMOVED*** ... ***REMOVED***
```
...
```
    ...
    for (int i = 1; i <= count; i++) ***REMOVED***
      ASSERT_DEATH(***REMOVED***
...
class FooTest : public BaseTest ***REMOVED***
  protected:
...
```
class FooTest : public BaseTest ***REMOVED******REMOVED***;

TEST_F(FooTest, Abc) ***REMOVED*** ... ***REMOVED***
TEST_F(FooTest, Def) ***REMOVED*** ... ***REMOVED***

class BarTest : public BaseTest ***REMOVED******REMOVED***;

TEST_F(BarTest, Abc) ***REMOVED*** ... ***REMOVED***
TEST_F(BarTest, Def) ***REMOVED*** ... ***REMOVED***
```
...
class FooTest : public ::testing::Test ***REMOVED***
 protected:
  ...
  void Test1() ***REMOVED***...***REMOVED*** // This accesses private members of class Foo.
  void Test2() ***REMOVED***...***REMOVED*** // So does this one.
***REMOVED***;
...
class FooTest : public ::testing::Test ***REMOVED***
 protected:
  ...
  T1 get_private_member1(Foo* obj) ***REMOVED***
...
class TestableYourClass : public YourClass ***REMOVED***
  ...
 public: using YourClass::DoSomethingReturningInt; // changes access rights
  ...
***REMOVED***;

TEST_F(YourClassTest, DoSomethingTest) ***REMOVED***
...
// foo.cc
bool Foo::Func(int n) ***REMOVED*** ... ***REMOVED***
...
namespace internal ***REMOVED***
  bool Func(int n) ***REMOVED*** ... ***REMOVED***
***REMOVED***
...
TEST(MyDeathTest, FunctionCall) ***REMOVED***
  ASSERT_DEATH(Xyz(5), "Xyz failed");
***REMOVED***

// Or a complex expression that references variables and functions.
TEST(MyDeathTest, ComplexExpression) ***REMOVED***
...
TEST(MyDeathTest, InsideLoop) ***REMOVED***
...
TEST(MyDeathTest, CompoundStatement) ***REMOVED***
...
```
TEST_F(FooTest, AbcDeathTest) ***REMOVED*** ... ***REMOVED***
TEST_F(FooTest, Uvw) ***REMOVED*** ... ***REMOVED***

TEST_F(BarTest, DefDeathTest) ***REMOVED*** ... ***REMOVED***
TEST_F(BarTest, Xyz) ***REMOVED*** ... ***REMOVED***
```
...
TEST_F(FooDeathTest, Uvw) ***REMOVED*** ... EXPECT_DEATH(...) ... ***REMOVED***
TEST_F(FooDeathTest, Xyz) ***REMOVED*** ... ASSERT_DEATH(...) ... ***REMOVED***
```
...
```
  GTEST_TEST(SomeTest, DoesThis) ***REMOVED*** ... ***REMOVED***
```
instead of
```
  TEST(SomeTest, DoesThis) ***REMOVED*** ... ***REMOVED***
```
...
TEST(CoolTest, DoSomething) ***REMOVED***
  SUCCEED();
***REMOVED***
...
```
namespace foo ***REMOVED***
class CoolTest : public ::testing::Test ***REMOVED******REMOVED***;  // Fixture foo::CoolTest
TEST_F(CoolTest, DoSomething) ***REMOVED***
  SUCCEED();
***REMOVED***
***REMOVED***  // namespace foo

namespace bar ***REMOVED***
class CoolTest : public ::testing::Test ***REMOVED******REMOVED***;  // Fixture: bar::CoolTest
TEST_F(CoolTest, DoSomething) ***REMOVED***
  SUCCEED();
***REMOVED***
***REMOVED***  // namespace foo
