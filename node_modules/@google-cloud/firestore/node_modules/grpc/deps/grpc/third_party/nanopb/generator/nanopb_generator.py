...
class Enum:
    ...
    def __str__(self):
        result = 'typedef enum _%s ***REMOVED***\n' % self.names
    ...
    def get_initializer(self, null_init, inner_init_only = False):
        ...
        if self.pbtype == 'MESSAGE':
            ...
            if self.pbtype == 'STRING':
                ...
                if self.inline:
                    inner_init = '***REMOVED***0***REMOVED***'
                else:
                    inner_init = '***REMOVED***0, ***REMOVED***0***REMOVED******REMOVED***'
            ...
            if self.pbtype == 'STRING':
                ...
                if len(data) == 0:
                    ...
                    if self.inline:
                        inner_init = '***REMOVED***%s***REMOVED***' % ','.join(data)
                    else:
                        inner_init = '***REMOVED***%d, ***REMOVED***%s***REMOVED******REMOVED***' % (len(data), ','.join(data))
        ...
        if self.allocation == 'STATIC':
            ...
            if self.pbtype == 'EXTENSION':
                ...
                outer_init = '***REMOVED******REMOVED***NULL***REMOVED***, NULL***REMOVED***'
...
class OneOf(Field):
    ...
    def get_initializer(self, null_init):
        return '0, ***REMOVED***' + self.fields[0].get_initializer(null_init) + '***REMOVED***'
...
class Message:
    ...
    def __str__(self):
        result = 'typedef struct _%s ***REMOVED***\n' % self.name
    ...
    def get_initializer(self, null_init):
        ...
        return '***REMOVED***' + ', '.join(parts) + '***REMOVED***'
    ...
    def fields_definition(self):
        result = 'const pb_field_t %s_fields[%d] = ***REMOVED***\n' % (self.name, self.count_all_fields() + 1)
...
def sort_dependencies(messages):
    ...
    message_by_name = ***REMOVED******REMOVED***
...
class ProtoFile:
    def __init__(self, fdesc, file_options):
        ...
        self.dependencies = ***REMOVED******REMOVED***
        self.parse()
...
def process_file(filename, fdesc, options, other_files = ***REMOVED******REMOVED***):
    ...
    Returns a dict:
        ***REMOVED***'headername': Name of header file,
    ...
    return ***REMOVED***'headername': headername, 'headerdata': headerdata,
            'sourcename': sourcename, 'sourcedata': sourcedata***REMOVED***
