...
int main(int argc, char **argv) ***REMOVED***
  ...
  if (count != 1) ***REMOVED***
    ...
    return 1;
  ***REMOVED***
  if (!CRYPTO_refcount_dec_and_test_zero(&count) || count != 0) ***REMOVED***
