...
enum client_hs_state_t ***REMOVED***
...
static enum ssl_hs_wait_t do_process_hello_retry_request(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
  if (ssl->s3->tmp.message_type != SSL3_MT_HELLO_RETRY_REQUEST) ***REMOVED***
  ...
  ***REMOVED***
  ...
  const SSL_EXTENSION_TYPE ext_types[] = ***REMOVED***
      ***REMOVED***TLSEXT_TYPE_key_share, &have_key_share, &key_share***REMOVED***,
      ***REMOVED***TLSEXT_TYPE_cookie, &have_cookie, &cookie***REMOVED***,
  ***REMOVED***;

  uint8_t alert = SSL_AD_DECODE_ERROR;
  if (!ssl_parse_extensions(&extensions, &alert, ext_types,
                            OPENSSL_ARRAY_SIZE(ext_types),
                            0 /* reject unknown */)) ***REMOVED***
    ssl3_send_alert(ssl, SSL3_AL_FATAL, alert);
    return ssl_hs_error;
  ***REMOVED***

  if (have_cookie) ***REMOVED***
    CBS cookie_value;
    if (!CBS_get_u16_length_prefixed(&cookie, &cookie_value) ||
        CBS_len(&cookie_value) == 0 ||
        CBS_len(&cookie) != 0) ***REMOVED***
      OPENSSL_PUT_ERROR(SSL, SSL_R_DECODE_ERROR);
      ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_DECODE_ERROR);
      return ssl_hs_error;
    ***REMOVED***

    if (!CBS_stow(&cookie_value, &hs->cookie, &hs->cookie_len)) ***REMOVED***
      return ssl_hs_error;
    ***REMOVED***
  ***REMOVED***

  if (have_key_share) ***REMOVED***
    uint16_t group_id;
    if (!CBS_get_u16(&key_share, &group_id) || CBS_len(&key_share) != 0) ***REMOVED***
      OPENSSL_PUT_ERROR(SSL, SSL_R_DECODE_ERROR);
      ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_DECODE_ERROR);
      return ssl_hs_error;
    ***REMOVED***
    ...
    int found = 0;
    for (size_t i = 0; i < groups_len; i++) ***REMOVED***
      if (groups[i] == group_id) ***REMOVED***
        found = 1;
        break;
      ***REMOVED***
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (SSL_ECDH_CTX_get_id(&hs->ecdh_ctx) == group_id) ***REMOVED***
      ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_ILLEGAL_PARAMETER);
      OPENSSL_PUT_ERROR(SSL, SSL_R_WRONG_CURVE);
      return ssl_hs_error;
    ***REMOVED***
...
static enum ssl_hs_wait_t do_send_second_client_hello(SSL_HANDSHAKE *hs) ***REMOVED***
...
static enum ssl_hs_wait_t do_process_server_hello(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
  ...
  ***REMOVED***
  ...
  if (server_wire_version != ssl->version) ***REMOVED***
    ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_DECODE_ERROR);
  ...
  ***REMOVED***
  ...
  if (SSL_CIPHER_get_min_version(cipher) > ssl3_protocol_version(ssl) ||
      SSL_CIPHER_get_max_version(cipher) < ssl3_protocol_version(ssl)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  const SSL_EXTENSION_TYPE ext_types[] = ***REMOVED***
      ***REMOVED***TLSEXT_TYPE_key_share, &have_key_share, &key_share***REMOVED***,
      ***REMOVED***TLSEXT_TYPE_pre_shared_key, &have_pre_shared_key, &pre_shared_key***REMOVED***,
      ***REMOVED***TLSEXT_TYPE_short_header, &have_short_header, &short_header***REMOVED***,
  ***REMOVED***;
  ...
  ***REMOVED***
  ...
  if (have_pre_shared_key) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (ssl->session->cipher->algorithm_prf != cipher->algorithm_prf) ***REMOVED***
  ...
  ***REMOVED*** else if (!ssl_get_new_session(hs, 0)) ***REMOVED***
    ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_INTERNAL_ERROR);
    return ssl_hs_error;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!tls13_init_key_schedule(hs)) ***REMOVED***
    return ssl_hs_error;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!ssl_ext_key_share_parse_serverhello(hs, &dhe_secret, &dhe_secret_len,
                                           &alert, &key_share)) ***REMOVED***
    ssl3_send_alert(ssl, SSL3_AL_FATAL, alert);
    return ssl_hs_error;
  ***REMOVED***

  if (!tls13_advance_key_schedule(hs, dhe_secret, dhe_secret_len)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (have_short_header) ***REMOVED***
    if (CBS_len(&short_header) != 0) ***REMOVED***
      OPENSSL_PUT_ERROR(SSL, SSL_R_DECODE_ERROR);
      ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_DECODE_ERROR);
      return ssl_hs_error;
    ***REMOVED***

    if (!ssl->ctx->short_header_enabled) ***REMOVED***
      OPENSSL_PUT_ERROR(SSL, SSL_R_UNEXPECTED_EXTENSION);
      ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_UNSUPPORTED_EXTENSION);
      return ssl_hs_error;
    ***REMOVED***
...
static enum ssl_hs_wait_t do_process_encrypted_extensions(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
  if (!ssl_check_message_type(ssl, SSL3_MT_ENCRYPTED_EXTENSIONS)) ***REMOVED***
    return ssl_hs_error;
  ***REMOVED***

  CBS cbs;
  CBS_init(&cbs, ssl->init_msg, ssl->init_num);
  if (!ssl_parse_serverhello_tlsext(hs, &cbs)) ***REMOVED***
...
static enum ssl_hs_wait_t do_process_certificate_request(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
  ...
  ***REMOVED***
  ...
  if (ssl->s3->tmp.message_type != SSL3_MT_CERTIFICATE_REQUEST) ***REMOVED***
...
static enum ssl_hs_wait_t do_process_server_certificate(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
...
static enum ssl_hs_wait_t do_process_server_finished(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
  if (!ssl_check_message_type(ssl, SSL3_MT_FINISHED) ||
      ...
      !tls13_derive_application_secrets(hs)) ***REMOVED***
    return ssl_hs_error;
  ***REMOVED***
...
static enum ssl_hs_wait_t do_send_client_certificate(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
  ...
  ***REMOVED***
  ...
  if (!ssl_auto_chain_if_needed(ssl) ||
      !tls13_add_certificate(hs)) ***REMOVED***
    return ssl_hs_error;
  ***REMOVED***
...
static enum ssl_hs_wait_t do_complete_second_flight(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL *const ssl = hs->ssl;
  ...
  ***REMOVED***
  ...
  if (!tls13_add_finished(hs)) ***REMOVED***
    return ssl_hs_error;
  ***REMOVED***
...
enum ssl_hs_wait_t tls13_client_handshake(SSL_HANDSHAKE *hs) ***REMOVED***
...
int tls13_process_new_session_ticket(SSL *ssl) ***REMOVED***
  int ret = 0;
  ...
  ***REMOVED***
  ...
  if (server_timeout > LONG_MAX) ***REMOVED***
    server_timeout = LONG_MAX;
  ***REMOVED***
#endif
  if (session->timeout > (long)server_timeout) ***REMOVED***
  ...
  ***REMOVED***
  ...
  CBS early_data_info;
  const SSL_EXTENSION_TYPE ext_types[] = ***REMOVED***
      ***REMOVED***TLSEXT_TYPE_ticket_early_data_info, &have_early_data_info,
       &early_data_info***REMOVED***,
  ***REMOVED***;

  uint8_t alert = SSL_AD_DECODE_ERROR;
  if (!ssl_parse_extensions(&extensions, &alert, ext_types,
                            OPENSSL_ARRAY_SIZE(ext_types),
                            1 /* ignore unknown */)) ***REMOVED***
    ssl3_send_alert(ssl, SSL3_AL_FATAL, alert);
    goto err;
  ***REMOVED***

  if (have_early_data_info && ssl->ctx->enable_early_data) ***REMOVED***
    if (!CBS_get_u32(&early_data_info, &session->ticket_max_early_data) ||
        CBS_len(&early_data_info) != 0) ***REMOVED***
      ssl3_send_alert(ssl, SSL3_AL_FATAL, SSL_AD_DECODE_ERROR);
      OPENSSL_PUT_ERROR(SSL, SSL_R_DECODE_ERROR);
      goto err;
    ***REMOVED***
  ***REMOVED***
  ...
  if (ssl->ctx->new_session_cb != NULL &&
      ssl->ctx->new_session_cb(ssl, session)) ***REMOVED***
...
void ssl_clear_tls13_state(SSL_HANDSHAKE *hs) ***REMOVED***
  SSL_ECDH_CTX_cleanup(&hs->ecdh_ctx);
