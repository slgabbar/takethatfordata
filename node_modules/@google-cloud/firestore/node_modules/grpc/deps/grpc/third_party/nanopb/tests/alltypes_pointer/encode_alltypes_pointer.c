...
***REMOVED***
    ...
    PB_BYTES_ARRAY_T(4) req_bytes = ***REMOVED***4, ***REMOVED***'1', '0', '1', '5'***REMOVED******REMOVED***;
    static int32_t req_substuff   = 1016;
    SubMessage  req_submsg        = ***REMOVED***"1016", &req_substuff***REMOVED***;
    MyEnum      req_enum          = MyEnum_Truth;
    EmptyMessage req_emptymsg     = ***REMOVED***0***REMOVED***;
    
    int32_t     end               = 1099;

    /* Values for repeated fields */
    int32_t     rep_int32[5]      = ***REMOVED***0, 0, 0, 0, -2001***REMOVED***;
    int64_t     rep_int64[5]      = ***REMOVED***0, 0, 0, 0, -2002***REMOVED***;
    uint32_t    rep_uint32[5]     = ***REMOVED***0, 0, 0, 0, 2003***REMOVED***;
    uint64_t    rep_uint64[5]     = ***REMOVED***0, 0, 0, 0, 2004***REMOVED***;
    int32_t     rep_sint32[5]     = ***REMOVED***0, 0, 0, 0, -2005***REMOVED***;
    int64_t     rep_sint64[5]     = ***REMOVED***0, 0, 0, 0, -2006***REMOVED***;
    bool        rep_bool[5]       = ***REMOVED***false, false, false, false, true***REMOVED***;
    uint32_t    rep_fixed32[5]    = ***REMOVED***0, 0, 0, 0, 2008***REMOVED***;
    int32_t     rep_sfixed32[5]   = ***REMOVED***0, 0, 0, 0, -2009***REMOVED***;
    float       rep_float[5]      = ***REMOVED***0, 0, 0, 0, 2010.0f***REMOVED***;
    uint64_t    rep_fixed64[5]    = ***REMOVED***0, 0, 0, 0, 2011***REMOVED***;
    int64_t     rep_sfixed64[5]   = ***REMOVED***0, 0, 0, 0, -2012***REMOVED***;
    double      rep_double[5]     = ***REMOVED***0, 0, 0, 0, 2013.0f***REMOVED***;
    char*       rep_string[5]     = ***REMOVED***"", "", "", "", "2014"***REMOVED***;
    static PB_BYTES_ARRAY_T(4) rep_bytes_4 = ***REMOVED***4, ***REMOVED***'2', '0', '1', '5'***REMOVED******REMOVED***;
    pb_bytes_array_t *rep_bytes[5]= ***REMOVED***NULL, NULL, NULL, NULL, (pb_bytes_array_t*)&rep_bytes_4***REMOVED***;
    static int32_t rep_sub2zero   = 0;
    static int32_t rep_substuff2  = 2016;
    static uint32_t rep_substuff3 = 2016;
    SubMessage  rep_submsg[5]     = ***REMOVED******REMOVED***"", &rep_sub2zero***REMOVED***,
                                     ***REMOVED***"", &rep_sub2zero***REMOVED***,
                                     ***REMOVED***"", &rep_sub2zero***REMOVED***,
                                     ***REMOVED***"", &rep_sub2zero***REMOVED***,
                                     ***REMOVED***"2016", &rep_substuff2, &rep_substuff3***REMOVED******REMOVED***;
    MyEnum      rep_enum[5]       = ***REMOVED***0, 0, 0, 0, MyEnum_Truth***REMOVED***;
    EmptyMessage rep_emptymsg[5]  = ***REMOVED******REMOVED***0***REMOVED***, ***REMOVED***0***REMOVED***, ***REMOVED***0***REMOVED***, ***REMOVED***0***REMOVED***, ***REMOVED***0***REMOVED******REMOVED***;
    ...
    PB_BYTES_ARRAY_T(4) opt_bytes = ***REMOVED***4, ***REMOVED***'3', '0', '5', '5'***REMOVED******REMOVED***;
    static int32_t opt_substuff   = 3056;
    SubMessage  opt_submsg        = ***REMOVED***"3056", &opt_substuff***REMOVED***;
    MyEnum      opt_enum          = MyEnum_Truth;
    EmptyMessage opt_emptymsg     = ***REMOVED***0***REMOVED***;

    static int32_t oneof_substuff = 4059;
    SubMessage  oneof_msg1        = ***REMOVED***"4059", &oneof_substuff***REMOVED***;
    ...
    Limits req_limits = ***REMOVED***&int32_min,    &int32_max,
                         &uint32_min,   &uint32_max,
                         &int64_min,    &int64_max,
                         &uint64_min,   &uint64_max,
                         &enum_min,     &enum_max***REMOVED***;

    /* Initialize the message struct with pointers to the fields. */
    AllTypes alltypes = ***REMOVED***0***REMOVED***;
