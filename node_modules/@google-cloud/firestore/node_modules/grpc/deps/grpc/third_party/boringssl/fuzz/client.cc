...
static const uint8_t kALPNProtocols[] = ***REMOVED***
    0x01, 'a', 0x02, 'a', 'a', 0x03, 'a', 'a', 'a',
***REMOVED***;

static const uint8_t kP256KeyPKCS8[] = ***REMOVED***
...
struct GlobalState ***REMOVED***
  GlobalState() : ctx(SSL_CTX_new(SSLv23_method())) ***REMOVED***
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *buf, size_t len) ***REMOVED***
  ...
  if (SSL_do_handshake(client) == 1) ***REMOVED***
    // Keep reading application data until error or EOF.
    uint8_t tmp[1024];
    for (;;) ***REMOVED***
      if (SSL_read(client, tmp, sizeof(tmp)) <= 0) ***REMOVED***
        break;
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
