...
ChaCha20_neon:
	...
	ldp	@d[0],@d[1],[@x[0]]		// load sigma
	ld1	***REMOVED***@K[0]***REMOVED***,[@x[0]],#16
	ldp	@d[2],@d[3],[$key]		// load key
	ldp	@d[4],@d[5],[$key,#16]
	ld1	***REMOVED***@K[1],@K[2]***REMOVED***,[$key]
	ldp	@d[6],@d[7],[$ctr]		// load counter
	ld1	***REMOVED***@K[3]***REMOVED***,[$ctr]
	ld1	***REMOVED***$ONE***REMOVED***,[@x[0]]
#ifdef	__ARMEB__
	rev64	@K[0],@K[0]
	ror	@d[2],@d[2],#32
	ror	@d[3],@d[3],#32
...
$code.=<<___;
	...
	rev	@x[14],@x[14]
#endif
	ld1.8	***REMOVED***$T0-$T3***REMOVED***,[$inp],#64
	eor	@x[0],@x[0],@x[1]
	eor	@x[2],@x[2],@x[3]
	eor	@x[4],@x[4],@x[5]
	eor	@x[6],@x[6],@x[7]
	...
	st1.8	***REMOVED***$A0-$D0***REMOVED***,[$out],#64
	ld1.8	***REMOVED***$A0-$D0***REMOVED***,[$inp],#64

	eor	$A1,$A1,$T0
	eor	$B1,$B1,$T1
	eor	$C1,$C1,$T2
	eor	$D1,$D1,$T3
	st1.8	***REMOVED***$A1-$D1***REMOVED***,[$out],#64

	eor	$A2,$A2,$A0
	eor	$B2,$B2,$B0
	eor	$C2,$C2,$C0
	eor	$D2,$D2,$D0
	st1.8	***REMOVED***$A2-$D2***REMOVED***,[$out],#64
...
.Ltail_neon:
	...
	st1.8	***REMOVED***$A2-$D2***REMOVED***,[sp]
	b	.Last_neon

.Less_than_128:
	st1.8	***REMOVED***$A0-$D0***REMOVED***,[sp]
	b	.Last_neon
.Less_than_192:
	st1.8	***REMOVED***$A1-$D1***REMOVED***,[sp]
	b	.Last_neon
...
$code.=<<___;
	...
	ld1.8	***REMOVED***$A1-$D1***REMOVED***,[$inp],#64
	eor	$A2,$A2,$A0
	 ldp	@K[0],@K[1],[sp,#0]
	eor	$B2,$B2,$B0
	 ldp	@K[2],@K[3],[sp,#32]
	...
	ld1.8	***REMOVED***$A2-$D2***REMOVED***,[$inp],#64
	eor	$A3,$A3,$A1
	eor	$B3,$B3,$B1
	eor	$C3,$C3,$C1
	eor	$D3,$D3,$D1
	st1.8	***REMOVED***$A3-$D3***REMOVED***,[$out],#64

	ld1.8	***REMOVED***$A3-$D3***REMOVED***,[$inp],#64
	eor	$A4,$A4,$A2
	eor	$B4,$B4,$B2
	eor	$C4,$C4,$C2
	eor	$D4,$D4,$D2
	st1.8	***REMOVED***$A4-$D4***REMOVED***,[$out],#64
	...
	eor	$C5,$C5,$C3
	eor	$D5,$D5,$D3
	st1.8	***REMOVED***$A5-$D5***REMOVED***,[$out],#64
