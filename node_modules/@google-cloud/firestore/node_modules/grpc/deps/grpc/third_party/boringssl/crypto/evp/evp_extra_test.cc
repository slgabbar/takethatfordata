...
static const uint8_t kExampleRSAKeyDER[] = ***REMOVED***
...
static const uint8_t kExampleDSAKeyDER[] = ***REMOVED***
...
static const uint8_t kMsg[] = ***REMOVED***1, 2, 3, 4***REMOVED***;

static const uint8_t kSignature[] = ***REMOVED***
...
// PrivateKeyInfo.
static const uint8_t kExampleRSAKeyPKCS8[] = ***REMOVED***
...
// structure.
static const uint8_t kExampleECKeyDER[] = ***REMOVED***
...
// PrivateKeyInfo.
static const uint8_t kExampleECKeyPKCS8[] = ***REMOVED***
...
// the curve OID.
static const uint8_t kExampleECKeySpecifiedCurvePKCS8[] = ***REMOVED***
...
static const uint8_t kExampleBadECKeyDER[] = ***REMOVED***
...
static const uint8_t kExampleBadECKeyDER2[] = ***REMOVED***
    0x30, 0x77, 0x02, 0x01, 0x01, 0x04, 0x20, 0x07, 0x0f, 0x08, 0x72, 0x7a,
    0xd4, 0xa0, 0x4a, 0x9c, 0xdd, 0x59, 0xc9, 0x4d, 0x89, 0x68, 0x77, 0x08,
    0xb5, 0x6f, 0xc9, 0x5d, 0x30, 0x77, 0x0e, 0xe8, 0xd1, 0xc9, 0xce, 0x0a,
...
static const uint8_t kInvalidPrivateKey[] = ***REMOVED***
...
static bssl::UniquePtr<EVP_PKEY> LoadExampleRSAKey() ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!pkey || !EVP_PKEY_set1_RSA(pkey.get(), rsa.get())) ***REMOVED***
    return nullptr;
  ***REMOVED***
  return pkey;
***REMOVED***

static bool TestEVP_DigestSignInit(void) ***REMOVED***
  bssl::UniquePtr<EVP_PKEY> pkey = LoadExampleRSAKey();
  bssl::ScopedEVP_MD_CTX md_ctx;
  if (!pkey ||
      !EVP_DigestSignInit(md_ctx.get(), NULL, EVP_sha256(), NULL, pkey.get()) ||
      !EVP_DigestSignUpdate(md_ctx.get(), kMsg, sizeof(kMsg))) ***REMOVED***
    return false;
  ***REMOVED***
  // Determine the size of the signature.
  size_t sig_len = 0;
  if (!EVP_DigestSignFinal(md_ctx.get(), NULL, &sig_len)) ***REMOVED***
    return false;
  ***REMOVED***
  // Sanity check for testing.
  if (sig_len != (size_t)EVP_PKEY_size(pkey.get())) ***REMOVED***
  ...
  ***REMOVED***
  ...
  sig.resize(sig_len);
  if (!EVP_DigestSignFinal(md_ctx.get(), sig.data(), &sig_len)) ***REMOVED***
    return false;
  ***REMOVED***
  sig.resize(sig_len);
  ...
  if (!EVP_DigestVerifyInit(md_ctx.get(), NULL, EVP_sha256(), NULL,
      ...
      !EVP_DigestVerifyFinal(md_ctx.get(), sig.data(), sig_len)) ***REMOVED***
    return false;
  ***REMOVED***
...
static bool TestEVP_DigestVerifyInit(void) ***REMOVED***
  bssl::UniquePtr<EVP_PKEY> pkey = LoadExampleRSAKey();
  bssl::ScopedEVP_MD_CTX md_ctx;
  if (!pkey ||
      !EVP_DigestVerifyInit(md_ctx.get(), NULL, EVP_sha256(), NULL,
                            pkey.get()) ||
      !EVP_DigestVerifyUpdate(md_ctx.get(), kMsg, sizeof(kMsg)) ||
      !EVP_DigestVerifyFinal(md_ctx.get(), kSignature, sizeof(kSignature))) ***REMOVED***
    return false;
  ***REMOVED***
  return true;
***REMOVED***

static bool TestVerifyRecover() ***REMOVED***
  bssl::UniquePtr<EVP_PKEY> pkey = LoadExampleRSAKey();
  if (!pkey) ***REMOVED***
    return false;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  const uint8_t kDummyHash[32] = ***REMOVED***0***REMOVED***;
  uint8_t sig[2048/8];
  ...
  ***REMOVED***
  ...
  if (!EVP_PKEY_verify_recover_init(ctx.get()) ||
      ...
      !EVP_PKEY_verify_recover(ctx.get(), nullptr, &out_len, sig, sig_len)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (out_len != sizeof(kDummyHash)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (OPENSSL_memcmp(recovered.data(), kDummyHash, sizeof(kDummyHash)) != 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (out_len != kExpectedASN1Size) ***REMOVED***
...
static bool TestEVP_PKCS82PKEY(void) ***REMOVED***
  ...
  if (!p8inf || derp != kExampleBadECKeyDER + sizeof(kExampleBadECKeyDER)) ***REMOVED***
...
static bool TestEVPMarshalEmptyPublicKey(void) ***REMOVED***
  bssl::UniquePtr<EVP_PKEY> empty(EVP_PKEY_new());
  if (!empty) ***REMOVED***
    return false;
  ***REMOVED***
  bssl::ScopedCBB cbb;
  if (EVP_marshal_public_key(cbb.get(), empty.get())) ***REMOVED***
    fprintf(stderr, "Marshalled empty public key.\n");
    return false;
  ***REMOVED***
  if (ERR_GET_REASON(ERR_peek_last_error()) != EVP_R_UNSUPPORTED_ALGORITHM) ***REMOVED***
...
static bool Testd2i_PrivateKey(void) ***REMOVED***
  const uint8_t *derp = kExampleRSAKeyDER;
  bssl::UniquePtr<EVP_PKEY> pkey(d2i_PrivateKey(EVP_PKEY_RSA, nullptr, &derp,
                                     sizeof(kExampleRSAKeyDER)));
  if (!pkey || derp != kExampleRSAKeyDER + sizeof(kExampleRSAKeyDER)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!pkey || derp != kExampleDSAKeyDER + sizeof(kExampleDSAKeyDER)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!pkey || derp != kExampleRSAKeyPKCS8 + sizeof(kExampleRSAKeyPKCS8)) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!pkey || derp != kExampleECKeyDER + sizeof(kExampleECKeyDER)) ***REMOVED***
...
int main() ***REMOVED***
  ...
  if (!TestEVP_DigestSignInit()) ***REMOVED***
    fprintf(stderr, "EVP_DigestSignInit failed\n");
    ERR_print_errors_fp(stderr);
    return 1;
  ***REMOVED***

  if (!TestEVP_DigestVerifyInit()) ***REMOVED***
    fprintf(stderr, "EVP_DigestVerifyInit failed\n");
    ERR_print_errors_fp(stderr);
    return 1;
  ***REMOVED***

  if (!TestVerifyRecover()) ***REMOVED***
    fprintf(stderr, "EVP_PKEY_verify_recover failed\n");
    ERR_print_errors_fp(stderr);
    return 1;
  ***REMOVED***

  if (!Testd2i_AutoPrivateKey()) ***REMOVED***
    fprintf(stderr, "Testd2i_AutoPrivateKey failed\n");
    ERR_print_errors_fp(stderr);
    return 1;
  ***REMOVED***

  if (!TestEVP_PKCS82PKEY()) ***REMOVED***
    fprintf(stderr, "TestEVP_PKCS82PKEY failed\n");
    ERR_print_errors_fp(stderr);
    return 1;
  ***REMOVED***

  if (!TestEVPMarshalEmptyPublicKey()) ***REMOVED***
    fprintf(stderr, "TestEVPMarshalEmptyPublicKey failed\n");
    ERR_print_errors_fp(stderr);
    return 1;
  ***REMOVED***

  if (!Testd2i_PrivateKey()) ***REMOVED***
