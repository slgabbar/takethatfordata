...
typedef struct grpc_auth_property_iterator ***REMOVED***
  const grpc_auth_context *ctx;
  size_t index;
  const char *name;
***REMOVED*** grpc_auth_property_iterator;

/** value, if not NULL, is guaranteed to be NULL terminated. */
typedef struct grpc_auth_property ***REMOVED***
  char *name;
  char *value;
  size_t value_length;
***REMOVED*** grpc_auth_property;
...
***REMOVED*** grpc_ssl_pem_key_cert_pair;
...
typedef struct ***REMOVED***
  ...
  void *reserved;
***REMOVED*** grpc_auth_metadata_context;
...
typedef struct ***REMOVED***
  ...
  const char *type;
***REMOVED*** grpc_metadata_credentials_plugin;
...
typedef struct ***REMOVED***
  ...
  void (*destroy)(void *state);
  void *state;
***REMOVED*** grpc_auth_metadata_processor;
