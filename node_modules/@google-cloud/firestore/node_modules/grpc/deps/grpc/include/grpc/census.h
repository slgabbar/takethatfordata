...
typedef struct ***REMOVED***
  ...
  int index;
  char *kvm;
***REMOVED*** census_context_iterator;
...
enum census_trace_mask_values ***REMOVED***
...
/**
  ...
  as an argument to census_start_***REMOVED***client,server***REMOVED***_rpc_op(). NB: for correct
