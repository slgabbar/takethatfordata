...
static void alarm_ref(grpc_alarm *alarm) ***REMOVED*** gpr_ref(&alarm->refs); ***REMOVED***

static void alarm_unref(grpc_alarm *alarm) ***REMOVED***
  if (gpr_unref(&alarm->refs)) ***REMOVED***
    grpc_exec_ctx exec_ctx = GRPC_EXEC_CTX_INIT;
    if (alarm->cq != NULL) ***REMOVED***
...
static void alarm_ref_dbg(grpc_alarm *alarm, const char *reason,
  ...
  if (GRPC_TRACER_ON(grpc_trace_alarm_refcount)) ***REMOVED***
...
static void alarm_cb(grpc_exec_ctx *exec_ctx, void *arg, grpc_error *error) ***REMOVED***
  grpc_alarm *alarm = (grpc_alarm *)arg;
...
grpc_alarm *grpc_alarm_create(void *reserved) ***REMOVED***
...
void grpc_alarm_set(grpc_alarm *alarm, grpc_completion_queue *cq,
                    gpr_timespec deadline, void *tag, void *reserved) ***REMOVED***
  grpc_exec_ctx exec_ctx = GRPC_EXEC_CTX_INIT;
...
void grpc_alarm_cancel(grpc_alarm *alarm, void *reserved) ***REMOVED***
  grpc_exec_ctx exec_ctx = GRPC_EXEC_CTX_INIT;
  grpc_timer_cancel(&exec_ctx, &alarm->alarm);
  grpc_exec_ctx_finish(&exec_ctx);
***REMOVED***

void grpc_alarm_destroy(grpc_alarm *alarm, void *reserved) ***REMOVED***
