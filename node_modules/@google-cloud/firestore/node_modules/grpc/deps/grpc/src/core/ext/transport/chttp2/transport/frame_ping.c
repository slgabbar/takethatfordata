...
grpc_slice grpc_chttp2_ping_create(uint8_t ack, uint64_t opaque_8bytes) ***REMOVED***
...
grpc_error *grpc_chttp2_ping_parser_begin_frame(grpc_chttp2_ping_parser *parser,
  ...
  if (flags & 0xfe || length != 8) ***REMOVED***
    char *msg;
...
grpc_error *grpc_chttp2_ping_parser_parse(grpc_exec_ctx *exec_ctx, void *parser,
  ...
  while (p->byte != 8 && cur != end) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (p->byte == 8) ***REMOVED***
    ...
    ***REMOVED*** else ***REMOVED***
      ...
      ***REMOVED***
      if (!g_disable_ping_ack) ***REMOVED***
        if (t->ping_ack_count == t->ping_ack_capacity) ***REMOVED***
...
void grpc_set_disable_ping_ack(bool disable_ping_ack) ***REMOVED***
