...
static void start_timer_if_needed(grpc_exec_ctx* exec_ctx,
  ...
  if (gpr_time_cmp(deadline, gpr_inf_future(GPR_CLOCK_MONOTONIC)) == 0) ***REMOVED***
    return;
  ***REMOVED***
  grpc_deadline_state* deadline_state = (grpc_deadline_state*)elem->call_data;
  grpc_closure* closure = NULL;
  switch (deadline_state->timer_state) ***REMOVED***
...
static void cancel_timer_if_needed(grpc_exec_ctx* exec_ctx,
                                   grpc_deadline_state* deadline_state) ***REMOVED***
  if (deadline_state->timer_state == GRPC_DEADLINE_STATE_PENDING) ***REMOVED***
...
struct start_timer_after_init_state ***REMOVED***
...
static void start_timer_after_init(grpc_exec_ctx* exec_ctx, void* arg,
  ...
  if (!state->in_call_combiner) ***REMOVED***
...
void grpc_deadline_state_reset(grpc_exec_ctx* exec_ctx, grpc_call_element* elem,
                               gpr_timespec new_deadline) ***REMOVED***
  grpc_deadline_state* deadline_state = (grpc_deadline_state*)elem->call_data;
  cancel_timer_if_needed(exec_ctx, deadline_state);
...
typedef struct base_call_data ***REMOVED***
  grpc_deadline_state deadline_state;
***REMOVED*** base_call_data;

// Additional call data used only for the server filter.
typedef struct server_call_data ***REMOVED***
...
const grpc_channel_filter grpc_client_deadline_filter = ***REMOVED***
...
const grpc_channel_filter grpc_server_deadline_filter = ***REMOVED***
...
bool grpc_deadline_checking_enabled(const grpc_channel_args* channel_args) ***REMOVED***
...
void grpc_deadline_filter_init(void) ***REMOVED***
...
void grpc_deadline_filter_shutdown(void) ***REMOVED******REMOVED***
