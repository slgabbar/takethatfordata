...
static void extract_and_annotate_method_tag(grpc_metadata_batch *md,
  ...
  for (m = md->list.head; m != NULL; m = m->next) ***REMOVED***
    if (grpc_slice_eq(GRPC_MDKEY(m->md), GRPC_MDSTR_PATH)) ***REMOVED***
      /* Add method tag here */
    ***REMOVED***
  ***REMOVED***
***REMOVED***
...
const grpc_channel_filter grpc_client_census_filter = ***REMOVED***
    ...
    "census-client"***REMOVED***;

const grpc_channel_filter grpc_server_census_filter = ***REMOVED***
