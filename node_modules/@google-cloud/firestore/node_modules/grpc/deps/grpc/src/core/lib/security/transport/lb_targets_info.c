...
static void *targets_info_copy(void *p) ***REMOVED*** return grpc_slice_hash_table_ref(p); ***REMOVED***
static void targets_info_destroy(grpc_exec_ctx *exec_ctx, void *p) ***REMOVED***
  grpc_slice_hash_table_unref(exec_ctx, p);
***REMOVED***
static int targets_info_cmp(void *a, void *b) ***REMOVED***
  return grpc_slice_hash_table_cmp(a, b);
***REMOVED***
static const grpc_arg_pointer_vtable server_to_balancer_names_vtable = ***REMOVED***
    targets_info_copy, targets_info_destroy, targets_info_cmp***REMOVED***;

grpc_arg grpc_lb_targets_info_create_channel_arg(
    grpc_slice_hash_table *targets_info) ***REMOVED***
...
grpc_slice_hash_table *grpc_lb_targets_info_find_in_args(
  ...
  if (targets_info_arg != NULL) ***REMOVED***
