...
#if defined(__i386__)
static void gpr_get_cycle_counter(int64_t int *clk) ***REMOVED***
  int64_t int ret;
...
static void gpr_get_cycle_counter(int64_t *clk) ***REMOVED***
  uint64_t low, high;
...
void gpr_precise_clock_init(void) ***REMOVED***
  time_t start;
  int64_t end_cycle;
...
void gpr_precise_clock_now(gpr_timespec *clk) ***REMOVED***
  int64_t counter;
  double secs;
...
void gpr_precise_clock_init(void) ***REMOVED******REMOVED***
