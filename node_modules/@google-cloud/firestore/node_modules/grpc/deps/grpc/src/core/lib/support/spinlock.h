...
typedef struct ***REMOVED*** gpr_atm atm; ***REMOVED*** gpr_spinlock;

#define GPR_SPINLOCK_INITIALIZER ((gpr_spinlock)***REMOVED***0***REMOVED***)
...
#define gpr_spinlock_lock(lock) \
  do ***REMOVED***                          \
  ***REMOVED*** while (!gpr_spinlock_trylock((lock)))
