...
void grpc_bdp_estimator_init(grpc_bdp_estimator *estimator, const char *name) ***REMOVED***
...
void grpc_bdp_estimator_add_incoming_bytes(grpc_bdp_estimator *estimator,
                                           int64_t num_bytes) ***REMOVED***
  estimator->accumulator += num_bytes;
***REMOVED***

bool grpc_bdp_estimator_need_ping(const grpc_bdp_estimator *estimator) ***REMOVED***
  switch (estimator->ping_state) ***REMOVED***
...
void grpc_bdp_estimator_schedule_ping(grpc_bdp_estimator *estimator) ***REMOVED***
  if (GRPC_TRACER_ON(grpc_bdp_estimator_trace)) ***REMOVED***
...
void grpc_bdp_estimator_start_ping(grpc_bdp_estimator *estimator) ***REMOVED***
  if (GRPC_TRACER_ON(grpc_bdp_estimator_trace)) ***REMOVED***
...
void grpc_bdp_estimator_complete_ping(grpc_bdp_estimator *estimator) ***REMOVED***
  gpr_timespec dt_ts =
