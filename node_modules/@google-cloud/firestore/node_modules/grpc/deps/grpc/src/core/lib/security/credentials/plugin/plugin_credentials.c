...
static void plugin_destruct(grpc_exec_ctx *exec_ctx,
  ...
  gpr_mu_destroy(&c->mu);
  if (c->plugin.state != NULL && c->plugin.destroy != NULL) ***REMOVED***
...
static void plugin_md_request_metadata_ready(void *request,
  ...
  if (GRPC_TRACER_ON(grpc_plugin_credentials_trace)) ***REMOVED***
    gpr_log(GPR_INFO,
  ...
  ***REMOVED*** else if (GRPC_TRACER_ON(grpc_plugin_credentials_trace)) ***REMOVED***
    gpr_log(GPR_INFO,
...
static bool plugin_get_request_metadata(grpc_exec_ctx *exec_ctx,
  ...
  if (c->plugin.get_metadata != NULL) ***REMOVED***
    ...
    gpr_mu_lock(&c->mu);
    if (c->pending_requests != NULL) ***REMOVED***
...
static void plugin_cancel_get_request_metadata(
  ...
  for (grpc_plugin_credentials_pending_request *pending_request =
           c->pending_requests;
       pending_request != NULL; pending_request = pending_request->next) ***REMOVED***
