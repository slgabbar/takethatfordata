...
static void server_connection_state_unref(
  ...
  if (gpr_unref(&connection_state->refs)) ***REMOVED***
    if (connection_state->transport != NULL) ***REMOVED***
...
static void on_handshake_done(grpc_exec_ctx *exec_ctx, void *arg,
  ...
  if (error != GRPC_ERROR_NONE || connection_state->svr_state->shutdown) ***REMOVED***
    ...
    if (error == GRPC_ERROR_NONE && args->endpoint != NULL) ***REMOVED***
  ...
  connection_state->deadline = gpr_time_add(
      ...
      gpr_time_from_millis(
          grpc_channel_arg_get_integer(
              timeout_arg,
              (grpc_integer_options)***REMOVED***120 * GPR_MS_PER_SEC, 1, INT_MAX***REMOVED***),
          GPR_TIMESPAN));
