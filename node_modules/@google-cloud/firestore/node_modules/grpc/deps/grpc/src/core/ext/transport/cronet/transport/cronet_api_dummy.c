...
bidirectional_stream* bidirectional_stream_create(
    ...
    bidirectional_stream_callback* callback) ***REMOVED***
  GPR_ASSERT(0);
  return NULL;
***REMOVED***

int bidirectional_stream_destroy(bidirectional_stream* stream) ***REMOVED***
  GPR_ASSERT(0);
  return 0;
***REMOVED***
...
int bidirectional_stream_start(bidirectional_stream* stream, const char* url,
                               ...
                               bool end_of_stream) ***REMOVED***
  GPR_ASSERT(0);
  return 0;
***REMOVED***

int bidirectional_stream_read(bidirectional_stream* stream, char* buffer,
                              int capacity) ***REMOVED***
  GPR_ASSERT(0);
  return 0;
***REMOVED***

int bidirectional_stream_write(bidirectional_stream* stream, const char* buffer,
                               int count, bool end_of_stream) ***REMOVED***
  GPR_ASSERT(0);
  return 0;
***REMOVED***

void bidirectional_stream_cancel(bidirectional_stream* stream) ***REMOVED***
  GPR_ASSERT(0);
***REMOVED***

void bidirectional_stream_disable_auto_flush(bidirectional_stream* stream,
                                             bool disable_auto_flush) ***REMOVED***
  GPR_ASSERT(0);
***REMOVED***

void bidirectional_stream_delay_request_headers_until_flush(
    bidirectional_stream* stream, bool delay_headers_until_flush) ***REMOVED***
  GPR_ASSERT(0);
***REMOVED***

void bidirectional_stream_flush(bidirectional_stream* stream) ***REMOVED*** GPR_ASSERT(0); ***REMOVED***
