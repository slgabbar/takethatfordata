...
tsi_result tsi_handshaker_result_create_zero_copy_grpc_protector(
  ...
  if (exec_ctx == NULL || self == NULL || self->vtable == NULL ||
      protector == NULL) ***REMOVED***
    return TSI_INVALID_ARGUMENT;
  ***REMOVED***
  if (self->vtable->create_zero_copy_grpc_protector == NULL) ***REMOVED***
...
tsi_result tsi_zero_copy_grpc_protector_protect(
  ...
  if (exec_ctx == NULL || self == NULL || self->vtable == NULL ||
      unprotected_slices == NULL || protected_slices == NULL) ***REMOVED***
    return TSI_INVALID_ARGUMENT;
  ***REMOVED***
...
tsi_result tsi_zero_copy_grpc_protector_unprotect(
  ...
  if (exec_ctx == NULL || self == NULL || self->vtable == NULL ||
      protected_slices == NULL || unprotected_slices == NULL) ***REMOVED***
    return TSI_INVALID_ARGUMENT;
  ***REMOVED***
