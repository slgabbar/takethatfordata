...
void grpc_census_call_set_context(grpc_call *call, census_context *context) ***REMOVED***
  GRPC_API_TRACE("grpc_census_call_set_context(call=%p, census_context=%p)", 2,
                 (call, context));
  if (census_enabled() == CENSUS_FEATURE_NONE) ***REMOVED***
    return;
  ***REMOVED***
...
census_context *grpc_census_call_get_context(grpc_call *call) ***REMOVED***
