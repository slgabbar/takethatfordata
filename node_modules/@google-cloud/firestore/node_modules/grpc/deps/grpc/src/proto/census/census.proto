...
// google/protobuf/***REMOVED***duration,timestamp***REMOVED***.proto. Ideally, we would be able to
...
message Resource ***REMOVED***
  ...
  ***REMOVED***
  ...
  //     prefix: -9
  //     numerator: SECS
  message MeasurementUnit ***REMOVED***
    int32 prefix = 1;
...
message AggregationDescriptor ***REMOVED***
  enum AggregationType ***REMOVED***
  ...
  ***REMOVED***
  ...
  message BucketBoundaries ***REMOVED***
    // The values must be monotonically increasing.
    repeated double bounds = 1;
  ***REMOVED***

  // For Interval stats, describe the size of each window.
  message IntervalBoundaries ***REMOVED***
