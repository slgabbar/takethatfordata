...
static void remove_from_storage(struct stream_obj *s,
  ...
  if (s->storage.head == NULL || oas == NULL) ***REMOVED***
    return;
  ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED***
    for (curr = s->storage.head; curr != NULL; curr = curr->next) ***REMOVED***
      if (curr->next == oas) ***REMOVED***
        ...
        gpr_free(oas);
        break;
      ***REMOVED*** else if (curr->next == NULL) ***REMOVED***
...
static void execute_from_storage(grpc_exec_ctx *exec_ctx, stream_obj *s) ***REMOVED***
  gpr_mu_lock(&s->mu);
  for (struct op_and_state *curr = s->storage.head; curr != NULL;) ***REMOVED***
