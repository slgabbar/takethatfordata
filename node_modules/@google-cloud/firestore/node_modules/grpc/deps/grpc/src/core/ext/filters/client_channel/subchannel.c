...
#ifndef NDEBUG
  if (GRPC_TRACER_ON(grpc_trace_stream_refcount)) ***REMOVED***
    ...
    for (size_t i = 0; i < c->args->num_args; i++) ***REMOVED***
      if (0 == strcmp(c->args->args[i].key,
        ...
        initial_backoff_ms = min_backoff_ms = max_backoff_ms =
            grpc_channel_arg_get_integer(
                &c->args->args[i],
                (grpc_integer_options)***REMOVED***initial_backoff_ms, 100, INT_MAX***REMOVED***);
      ***REMOVED*** else if (0 == strcmp(c->args->args[i].key,
        ...
        min_backoff_ms = grpc_channel_arg_get_integer(
            &c->args->args[i],
            (grpc_integer_options)***REMOVED***min_backoff_ms, 100, INT_MAX***REMOVED***);
      ***REMOVED*** else if (0 == strcmp(c->args->args[i].key,
                             GRPC_ARG_MAX_RECONNECT_BACKOFF_MS)) ***REMOVED***
        fixed_reconnect_backoff = false;
        max_backoff_ms = grpc_channel_arg_get_integer(
            &c->args->args[i],
            (grpc_integer_options)***REMOVED***max_backoff_ms, 100, INT_MAX***REMOVED***);
      ***REMOVED*** else if (0 == strcmp(c->args->args[i].key,
...
static void maybe_start_connecting_locked(grpc_exec_ctx *exec_ctx,
  ...
  ***REMOVED***
  ...
  if (GET_CONNECTED_SUBCHANNEL(c, no_barrier) != NULL) ***REMOVED***
...
void grpc_subchannel_notify_on_state_change(
  ...
  ***REMOVED*** else ***REMOVED***
    ...
    GRPC_CLOSURE_INIT(&w->closure, on_external_state_watcher_done, w,
                      grpc_schedule_on_exec_ctx);
    if (interested_parties != NULL) ***REMOVED***
...
grpc_error *grpc_connected_subchannel_create_call(
  ...
  *call = (grpc_subchannel_call *)gpr_arena_alloc(
  ...
  const grpc_call_element_args call_args = ***REMOVED***
      ...
      .arena = args->arena,
      .call_combiner = args->call_combiner***REMOVED***;
