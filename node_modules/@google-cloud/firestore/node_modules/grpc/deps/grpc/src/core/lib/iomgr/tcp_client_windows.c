...
static void on_alarm(grpc_exec_ctx *exec_ctx, void *acp, grpc_error *error) ***REMOVED***
...
static void on_connect(grpc_exec_ctx *exec_ctx, void *acp, grpc_error *error) ***REMOVED***
  async_connect *ac = acp;
...
static void tcp_client_connect_impl(
    ...
    const grpc_resolved_address *addr, gpr_timespec deadline) ***REMOVED***
...
failure:
  ...
  ***REMOVED*** else if (sock != INVALID_SOCKET) ***REMOVED***
    closesocket(sock);
  ***REMOVED***
