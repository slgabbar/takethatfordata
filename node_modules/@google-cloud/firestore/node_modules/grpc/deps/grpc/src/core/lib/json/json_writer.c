...
static void json_writer_output_char(grpc_json_writer *writer, char c) ***REMOVED***
...
static void json_writer_output_string_with_len(grpc_json_writer *writer,
                                               const char *str, size_t len) ***REMOVED***
...
void grpc_json_writer_init(grpc_json_writer *writer, int indent,
                           grpc_json_writer_vtable *vtable, void *userdata) ***REMOVED***
...
static void json_writer_output_indent(grpc_json_writer *writer) ***REMOVED***
  ...
  if (writer->got_key) ***REMOVED***
    json_writer_output_char(writer, ' ');
    return;
  ***REMOVED***

  while (spaces >= (sizeof(spacesstr) - 1)) ***REMOVED***
...
static void json_writer_value_end(grpc_json_writer *writer) ***REMOVED***
  if (writer->container_empty) ***REMOVED***
...
static void json_writer_escape_utf16(grpc_json_writer *writer, uint16_t utf16) ***REMOVED***
...
static void json_writer_escape_string(grpc_json_writer *writer,
  ...
  for (;;) ***REMOVED***
    ...
    ***REMOVED*** else ***REMOVED***
      ...
      int i;
      int valid = 1;
      if ((c & 0xe0) == 0xc0) ***REMOVED***
        utf32 = c & 0x1f;
        extra = 1;
      ***REMOVED*** else if ((c & 0xf0) == 0xe0) ***REMOVED***
        utf32 = c & 0x0f;
        extra = 2;
      ***REMOVED*** else if ((c & 0xf8) == 0xf0) ***REMOVED***
        utf32 = c & 0x07;
        extra = 3;
      ***REMOVED*** else ***REMOVED***
        break;
      ***REMOVED***
      for (i = 0; i < extra; i++) ***REMOVED***
        utf32 <<= 6;
        c = (uint8_t)(*string++);
        /* Breaks out and bail on any invalid UTF-8 sequence, including \0. */
        if ((c & 0xc0) != 0x80) ***REMOVED***
          valid = 0;
          break;
        ***REMOVED***
        utf32 |= c & 0x3f;
...
void grpc_json_writer_container_begins(grpc_json_writer *writer,
  ...
  json_writer_output_char(writer, type == GRPC_JSON_OBJECT ? '***REMOVED***' : '[');
  writer->container_empty = 1;
  writer->got_key = 0;
  writer->depth++;
***REMOVED***
...
void grpc_json_writer_object_key(grpc_json_writer *writer, const char *string) ***REMOVED***
...
void grpc_json_writer_value_raw(grpc_json_writer *writer, const char *string) ***REMOVED***
  if (!writer->got_key) json_writer_value_end(writer);
  json_writer_output_indent(writer);
...
void grpc_json_writer_value_raw_with_len(grpc_json_writer *writer,
                                         const char *string, size_t len) ***REMOVED***
  if (!writer->got_key) json_writer_value_end(writer);
  json_writer_output_indent(writer);
