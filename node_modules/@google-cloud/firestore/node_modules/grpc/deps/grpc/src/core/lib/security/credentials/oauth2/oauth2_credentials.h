...
typedef struct ***REMOVED***
  ...
  char *client_secret;
  char *refresh_token;
***REMOVED*** grpc_auth_refresh_token;
...
typedef struct grpc_oauth2_pending_get_request_metadata ***REMOVED***
  grpc_credentials_mdelem_array *md_array;
  grpc_closure *on_request_metadata;
  grpc_polling_entity *pollent;
  struct grpc_oauth2_pending_get_request_metadata *next;
***REMOVED*** grpc_oauth2_pending_get_request_metadata;
...
typedef struct ***REMOVED***
  ...
  grpc_polling_entity pollent;
***REMOVED*** grpc_oauth2_token_fetcher_credentials;

// Google refresh token credentials.
typedef struct ***REMOVED***
  grpc_oauth2_token_fetcher_credentials base;
  grpc_auth_refresh_token refresh_token;
***REMOVED*** grpc_google_refresh_token_credentials;

// Access token credentials.
typedef struct ***REMOVED***
  grpc_call_credentials base;
  grpc_mdelem access_token_md;
***REMOVED*** grpc_access_token_credentials;
