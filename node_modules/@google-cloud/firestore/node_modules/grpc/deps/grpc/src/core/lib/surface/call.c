...
static received_status unpack_received_status(gpr_atm atm) ***REMOVED***
  return (atm & 1) == 0
             ? (received_status)***REMOVED***.is_set = false, .error = GRPC_ERROR_NONE***REMOVED***
             : (received_status)***REMOVED***.is_set = true,
                                 .error = (grpc_error *)(atm & ~(gpr_atm)1)***REMOVED***;
***REMOVED***
...
grpc_error *grpc_call_create(grpc_exec_ctx *exec_ctx,
  ...
  ***REMOVED***
  ...
  if (args->parent != NULL) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (pc->first_child == NULL) ***REMOVED***
      pc->first_child = call;
  ...
  ***REMOVED***
  ...
  grpc_call_element_args call_args = ***REMOVED***
      ...
      .arena = call->arena,
      .call_combiner = &call->call_combiner***REMOVED***;
  ...
  ***REMOVED***
  if (args->pollset_set_alternative != NULL) ***REMOVED***
...
void grpc_call_set_completion_queue(grpc_exec_ctx *exec_ctx, grpc_call *call,
  ...
  if (grpc_polling_entity_pollset_set(&call->pollent) != NULL) ***REMOVED***
...
static void destroy_call(grpc_exec_ctx *exec_ctx, void *call,
  ...
  ***REMOVED***
  if (c->receiving_stream != NULL) ***REMOVED***
...
static bool get_final_status_from(
    ...
    void *set_value_user_data, grpc_slice *details) ***REMOVED***
...
static void get_final_status(grpc_call *call,
  ...
  ***REMOVED***
  if (GRPC_TRACER_ON(grpc_call_error_trace)) ***REMOVED***
    ...
    for (i = 0; i < STATUS_SOURCE_COUNT; i++) ***REMOVED***
      if (status[i].is_set &&
        ...
        if (get_final_status_from(call, status[i].error, allow_ok_status != 0,
                                  set_value, set_value_user_data, details)) ***REMOVED***
          return;
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
...
static void set_status_from_error(grpc_exec_ctx *exec_ctx, grpc_call *call,
  ...
  if (!gpr_atm_rel_cas(&call->status[source],
                       pack_received_status((received_status)***REMOVED***
                           .is_set = false, .error = GRPC_ERROR_NONE***REMOVED***),
                       pack_received_status((received_status)***REMOVED***
                           .is_set = true, .error = error***REMOVED***))) ***REMOVED***
...
static void set_encodings_accepted_by_peer(grpc_exec_ctx *exec_ctx,
  ...
  if (accepted_user_data != NULL) ***REMOVED***
    call->encodings_accepted_by_peer =
...
static void publish_app_metadata(grpc_call *call, grpc_metadata_batch *b,
  ...
  ***REMOVED***
  for (grpc_linked_mdelem *l = b->list.head; l != NULL; l = l->next) ***REMOVED***
...
static void recv_initial_filter(grpc_exec_ctx *exec_ctx, grpc_call *call,
  ...
  if (b->idx.named.content_encoding != NULL) ***REMOVED***
    if (b->idx.named.grpc_encoding != NULL) ***REMOVED***
      gpr_log(GPR_ERROR,
  ...
  ***REMOVED*** else if (b->idx.named.grpc_encoding != NULL) ***REMOVED***
    ...
    grpc_metadata_batch_remove(exec_ctx, b, b->idx.named.grpc_encoding);
  ***REMOVED***
  if (b->idx.named.grpc_accept_encoding != NULL) ***REMOVED***
  ...
  ***REMOVED***
  if (b->idx.named.accept_encoding != NULL) ***REMOVED***
...
static void recv_trailing_filter(grpc_exec_ctx *exec_ctx, void *args,
  ...
  if (b->idx.named.grpc_status != NULL) ***REMOVED***
    ...
    if (b->idx.named.grpc_message != NULL) ***REMOVED***
...
static void receiving_slice_ready(grpc_exec_ctx *exec_ctx, void *bctlp,
  ...
  ***REMOVED***
  ...
  if (error != GRPC_ERROR_NONE) ***REMOVED***
    if (GRPC_TRACER_ON(grpc_trace_operation_failures)) ***REMOVED***
...
static void process_data_after_md(grpc_exec_ctx *exec_ctx,
                                  batch_control *bctl) ***REMOVED***
  grpc_call *call = bctl->call;
  if (call->receiving_stream == NULL) ***REMOVED***
    *call->receiving_buffer = NULL;
    call->receiving_message = 0;
    finish_batch_step(exec_ctx, bctl);
  ***REMOVED*** else ***REMOVED***
  ...
  if (call->incoming_stream_compression_algorithm !=
    ...
    ***REMOVED***
    ...
    if (!GPR_BITGET(call->stream_encodings_accepted_by_peer,
      ...
      if (GRPC_TRACER_ON(grpc_compression_trace)) ***REMOVED***
        const char *algo_name = NULL;
...
static void receiving_initial_metadata_ready(grpc_exec_ctx *exec_ctx,
  ...
  ***REMOVED***
  ...
  while (true) ***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED***
  if (saved_rsr_closure != NULL) ***REMOVED***
      ...
      ***REMOVED***
      case GRPC_OP_SEND_MESSAGE: ***REMOVED***
        if (!are_write_flags_valid(op->flags)) ***REMOVED***
          ...
          goto done_with_error;
        ***REMOVED***
        if (op->data.send_message.send_message == NULL) ***REMOVED***
      ...
      ***REMOVED***
      case GRPC_OP_SEND_STATUS_FROM_SERVER: ***REMOVED***
        ...
        ***REMOVED***
          ...
          ***REMOVED***
          if (op->data.send_status_from_server.status_details != NULL) ***REMOVED***
