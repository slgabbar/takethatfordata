...
typedef struct grpc_uv_tcp_connect ***REMOVED***
...
static void uv_tc_on_connect(uv_connect_t *req, int status) ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED***
    ...
    if (status == UV_ECANCELED) ***REMOVED***
      error =
          grpc_error_set_str(error, GRPC_ERROR_STR_OS_ERROR,
