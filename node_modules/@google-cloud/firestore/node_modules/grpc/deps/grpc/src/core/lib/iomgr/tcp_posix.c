...
static void done_poller(grpc_exec_ctx *exec_ctx, void *bp,
  ...
  if (GRPC_TRACER_ON(grpc_tcp_trace)) ***REMOVED***
  ...
  if (old_count == 0) ***REMOVED***
    ...
    ***REMOVED***
    ...
    GRPC_CLOSURE_SCHED(
        ...
        GRPC_ERROR_NONE);
  ***REMOVED*** else ***REMOVED***
    while ((p = (backup_poller *)gpr_atm_acq_load(&g_backup_poller)) == NULL) ***REMOVED***
...
static bool tcp_flush(grpc_exec_ctx *exec_ctx, grpc_tcp *tcp,
  ...
  for (;;) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (tcp->outgoing_slice_idx == tcp->outgoing_buffer->count) ***REMOVED***
...
static const grpc_endpoint_vtable vtable = ***REMOVED***
