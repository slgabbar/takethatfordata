...
census_timestamp census_start_rpc_op_timestamp(void) ***REMOVED***
  census_timestamp ct;
...
census_context *census_start_client_rpc_op(
    ...
    const census_timestamp *start_time) ***REMOVED***
  return NULL;
***REMOVED***
...
census_context *census_start_server_rpc_op(
    ...
    const census_rpc_name_info *rpc_name_info, const char *peer, int trace_mask,
    census_timestamp *start_time) ***REMOVED***
  return NULL;
***REMOVED***

census_context *census_start_op(census_context *context, const char *family,
                                const char *name, int trace_mask) ***REMOVED***
  return NULL;
***REMOVED***

void census_end_op(census_context *context, int status) ***REMOVED******REMOVED***
