...
static char *stream_list_id_string(grpc_chttp2_stream_list_id id) ***REMOVED***
  switch (id) ***REMOVED***
...
static bool stream_list_empty(grpc_chttp2_transport *t,
                              grpc_chttp2_stream_list_id id) ***REMOVED***
...
static bool stream_list_pop(grpc_chttp2_transport *t,
  ...
  ***REMOVED***
  *stream = s;
  if (s && GRPC_TRACER_ON(grpc_trace_http2_stream_state)) ***REMOVED***
...
bool grpc_chttp2_list_have_writing_streams(grpc_chttp2_transport *t) ***REMOVED***
