...
/* Struct definitions */
typedef struct _grpc_lb_v1_ClientStatsPerToken ***REMOVED***
    pb_callback_t load_balance_token;
    bool has_num_calls;
    int64_t num_calls;
/* @@protoc_insertion_point(struct:grpc_lb_v1_ClientStatsPerToken) */
***REMOVED*** grpc_lb_v1_ClientStatsPerToken;

typedef struct _grpc_lb_v1_Duration ***REMOVED***
    bool has_seconds;
    int64_t seconds;
    bool has_nanos;
    int32_t nanos;
/* @@protoc_insertion_point(struct:grpc_lb_v1_Duration) */
***REMOVED*** grpc_lb_v1_Duration;

typedef struct _grpc_lb_v1_InitialLoadBalanceRequest ***REMOVED***
    bool has_name;
    char name[128];
/* @@protoc_insertion_point(struct:grpc_lb_v1_InitialLoadBalanceRequest) */
***REMOVED*** grpc_lb_v1_InitialLoadBalanceRequest;

typedef PB_BYTES_ARRAY_T(16) grpc_lb_v1_Server_ip_address_t;
typedef struct _grpc_lb_v1_Server ***REMOVED***
    bool has_ip_address;
...
***REMOVED*** grpc_lb_v1_Server;

typedef struct _grpc_lb_v1_Timestamp ***REMOVED***
    bool has_seconds;
    int64_t seconds;
    bool has_nanos;
    int32_t nanos;
/* @@protoc_insertion_point(struct:grpc_lb_v1_Timestamp) */
***REMOVED*** grpc_lb_v1_Timestamp;

typedef struct _grpc_lb_v1_ClientStats ***REMOVED***
    bool has_timestamp;
...
***REMOVED*** grpc_lb_v1_ClientStats;

typedef struct _grpc_lb_v1_InitialLoadBalanceResponse ***REMOVED***
...
***REMOVED*** grpc_lb_v1_InitialLoadBalanceResponse;

typedef struct _grpc_lb_v1_ServerList ***REMOVED***
    pb_callback_t servers;
    bool has_expiration_interval;
    grpc_lb_v1_Duration expiration_interval;
/* @@protoc_insertion_point(struct:grpc_lb_v1_ServerList) */
***REMOVED*** grpc_lb_v1_ServerList;

typedef struct _grpc_lb_v1_LoadBalanceRequest ***REMOVED***
...
***REMOVED*** grpc_lb_v1_LoadBalanceRequest;

typedef struct _grpc_lb_v1_LoadBalanceResponse ***REMOVED***
...
***REMOVED*** grpc_lb_v1_LoadBalanceResponse;

/* Default values for struct fields */

/* Initializer values for message structs */
#define grpc_lb_v1_Duration_init_default         ***REMOVED***false, 0, false, 0***REMOVED***
#define grpc_lb_v1_Timestamp_init_default        ***REMOVED***false, 0, false, 0***REMOVED***
#define grpc_lb_v1_LoadBalanceRequest_init_default ***REMOVED***false, grpc_lb_v1_InitialLoadBalanceRequest_init_default, false, grpc_lb_v1_ClientStats_init_default***REMOVED***
#define grpc_lb_v1_InitialLoadBalanceRequest_init_default ***REMOVED***false, ""***REMOVED***
#define grpc_lb_v1_ClientStatsPerToken_init_default ***REMOVED******REMOVED******REMOVED***NULL***REMOVED***, NULL***REMOVED***, false, 0***REMOVED***
#define grpc_lb_v1_ClientStats_init_default      ***REMOVED***false, grpc_lb_v1_Timestamp_init_default, false, 0, false, 0, false, 0, false, 0, ***REMOVED******REMOVED***NULL***REMOVED***, NULL***REMOVED******REMOVED***
#define grpc_lb_v1_LoadBalanceResponse_init_default ***REMOVED***false, grpc_lb_v1_InitialLoadBalanceResponse_init_default, false, grpc_lb_v1_ServerList_init_default***REMOVED***
#define grpc_lb_v1_InitialLoadBalanceResponse_init_default ***REMOVED***false, "", false, grpc_lb_v1_Duration_init_default***REMOVED***
#define grpc_lb_v1_ServerList_init_default       ***REMOVED******REMOVED******REMOVED***NULL***REMOVED***, NULL***REMOVED***, false, grpc_lb_v1_Duration_init_default***REMOVED***
#define grpc_lb_v1_Server_init_default           ***REMOVED***false, ***REMOVED***0, ***REMOVED***0***REMOVED******REMOVED***, false, 0, false, "", false, 0***REMOVED***
#define grpc_lb_v1_Duration_init_zero            ***REMOVED***false, 0, false, 0***REMOVED***
#define grpc_lb_v1_Timestamp_init_zero           ***REMOVED***false, 0, false, 0***REMOVED***
#define grpc_lb_v1_LoadBalanceRequest_init_zero  ***REMOVED***false, grpc_lb_v1_InitialLoadBalanceRequest_init_zero, false, grpc_lb_v1_ClientStats_init_zero***REMOVED***
#define grpc_lb_v1_InitialLoadBalanceRequest_init_zero ***REMOVED***false, ""***REMOVED***
#define grpc_lb_v1_ClientStatsPerToken_init_zero ***REMOVED******REMOVED******REMOVED***NULL***REMOVED***, NULL***REMOVED***, false, 0***REMOVED***
#define grpc_lb_v1_ClientStats_init_zero         ***REMOVED***false, grpc_lb_v1_Timestamp_init_zero, false, 0, false, 0, false, 0, false, 0, ***REMOVED******REMOVED***NULL***REMOVED***, NULL***REMOVED******REMOVED***
#define grpc_lb_v1_LoadBalanceResponse_init_zero ***REMOVED***false, grpc_lb_v1_InitialLoadBalanceResponse_init_zero, false, grpc_lb_v1_ServerList_init_zero***REMOVED***
#define grpc_lb_v1_InitialLoadBalanceResponse_init_zero ***REMOVED***false, "", false, grpc_lb_v1_Duration_init_zero***REMOVED***
#define grpc_lb_v1_ServerList_init_zero          ***REMOVED******REMOVED******REMOVED***NULL***REMOVED***, NULL***REMOVED***, false, grpc_lb_v1_Duration_init_zero***REMOVED***
#define grpc_lb_v1_Server_init_zero              ***REMOVED***false, ***REMOVED***0, ***REMOVED***0***REMOVED******REMOVED***, false, 0, false, "", false, 0***REMOVED***
