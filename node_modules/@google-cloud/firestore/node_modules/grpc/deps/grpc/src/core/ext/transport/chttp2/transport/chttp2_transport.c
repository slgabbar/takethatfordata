...
static void destruct_transport(grpc_exec_ctx *exec_ctx,
                               grpc_chttp2_transport *t) ***REMOVED***
  size_t i;
  ...
  for (i = 0; i < STREAM_LIST_COUNT; i++) ***REMOVED***
...
void grpc_chttp2_unref_transport(grpc_exec_ctx *exec_ctx,
                                 ...
                                 const char *file, int line) ***REMOVED***
  if (GRPC_TRACER_ON(grpc_trace_chttp2_refcount)) ***REMOVED***
...
void grpc_chttp2_ref_transport(grpc_chttp2_transport *t) ***REMOVED*** gpr_ref(&t->refs); ***REMOVED***
#endif
...
static void init_transport(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
                           ...
                           grpc_endpoint *ep, bool is_client) ***REMOVED***
  size_t i;
  int j;
  ...
  grpc_pid_controller_init(
      ...
      (grpc_pid_controller_args)***REMOVED***.gain_p = 4,
                                 .gain_i = 8,
                                 .gain_d = 0,
                                 .initial_control_value = log2(DEFAULT_WINDOW),
                                 .min_control_value = -1,
                                 .max_control_value = 25,
                                 .integral_range = 10***REMOVED***);
  ...
  for (i = 0; i < GRPC_CHTTP2_NUM_SETTINGS; i++) ***REMOVED***
    for (j = 0; j < GRPC_NUM_SETTING_SETS; j++) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (channel_args) ***REMOVED***
    for (i = 0; i < channel_args->num_args; i++) ***REMOVED***
      if (0 == strcmp(channel_args->args[i].key,
                      GRPC_ARG_HTTP2_INITIAL_SEQUENCE_NUMBER)) ***REMOVED***
        const grpc_integer_options options = ***REMOVED***-1, 0, INT_MAX***REMOVED***;
        const int value =
            grpc_channel_arg_get_integer(&channel_args->args[i], options);
        if (value >= 0) ***REMOVED***
          if ((t->next_stream_id & 1) != (value & 1)) ***REMOVED***
          ...
          ***REMOVED***
        ***REMOVED***
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_HTTP2_HPACK_TABLE_SIZE_ENCODER)) ***REMOVED***
        const grpc_integer_options options = ***REMOVED***-1, 0, INT_MAX***REMOVED***;
        const int value =
            grpc_channel_arg_get_integer(&channel_args->args[i], options);
        if (value >= 0) ***REMOVED***
        ...
        ***REMOVED***
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_HTTP2_MAX_PINGS_WITHOUT_DATA)) ***REMOVED***
        t->ping_policy.max_pings_without_data = grpc_channel_arg_get_integer(
            &channel_args->args[i],
            (grpc_integer_options)***REMOVED***g_default_max_pings_without_data, 0,
                                   INT_MAX***REMOVED***);
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_HTTP2_MAX_PING_STRIKES)) ***REMOVED***
        t->ping_policy.max_ping_strikes = grpc_channel_arg_get_integer(
            &channel_args->args[i],
            (grpc_integer_options)***REMOVED***g_default_max_ping_strikes, 0, INT_MAX***REMOVED***);
      ***REMOVED*** else if (0 ==
                 strcmp(
                     channel_args->args[i].key,
                     GRPC_ARG_HTTP2_MIN_SENT_PING_INTERVAL_WITHOUT_DATA_MS)) ***REMOVED***
        t->ping_policy.min_sent_ping_interval_without_data =
            gpr_time_from_millis(
                grpc_channel_arg_get_integer(
                    &channel_args->args[i],
                    (grpc_integer_options)***REMOVED***
      ...
      ***REMOVED*** else if (0 ==
                 strcmp(
                     channel_args->args[i].key,
                     GRPC_ARG_HTTP2_MIN_RECV_PING_INTERVAL_WITHOUT_DATA_MS)) ***REMOVED***
        t->ping_policy.min_recv_ping_interval_without_data =
            gpr_time_from_millis(
                ...
                GPR_TIMESPAN);
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_HTTP2_WRITE_BUFFER_SIZE)) ***REMOVED***
        t->write_buffer_size = (uint32_t)grpc_channel_arg_get_integer(
            &channel_args->args[i],
            (grpc_integer_options)***REMOVED***0, 0, MAX_WRITE_BUFFER_SIZE***REMOVED***);
      ***REMOVED*** else if (0 ==
                 strcmp(channel_args->args[i].key, GRPC_ARG_HTTP2_BDP_PROBE)) ***REMOVED***
        t->flow_control.enable_bdp_probe = grpc_channel_arg_get_integer(
            &channel_args->args[i], (grpc_integer_options)***REMOVED***1, 0, 1***REMOVED***);
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_KEEPALIVE_TIME_MS)) ***REMOVED***
        const int value = grpc_channel_arg_get_integer(
            &channel_args->args[i],
            (grpc_integer_options)***REMOVED***t->is_client
      ...
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_KEEPALIVE_TIMEOUT_MS)) ***REMOVED***
        const int value = grpc_channel_arg_get_integer(
            &channel_args->args[i],
            (grpc_integer_options)***REMOVED***t->is_client
        ...
        t->keepalive_timeout = value == INT_MAX
                                   ...
                                   : gpr_time_from_millis(value, GPR_TIMESPAN);
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_KEEPALIVE_PERMIT_WITHOUT_CALLS)) ***REMOVED***
        t->keepalive_permit_without_calls =
            (uint32_t)grpc_channel_arg_get_integer(
                &channel_args->args[i], (grpc_integer_options)***REMOVED***0, 0, 1***REMOVED***);
      ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                             GRPC_ARG_OPTIMIZATION_TARGET)) ***REMOVED***
        if (channel_args->args[i].type != GRPC_ARG_STRING) ***REMOVED***
          gpr_log(GPR_ERROR, "%s should be a string",
                  GRPC_ARG_OPTIMIZATION_TARGET);
        ***REMOVED*** else if (0 == strcmp(channel_args->args[i].value.string, "blend")) ***REMOVED***
          t->opt_target = GRPC_CHTTP2_OPTIMIZE_FOR_LATENCY;
        ***REMOVED*** else if (0 == strcmp(channel_args->args[i].value.string, "latency")) ***REMOVED***
          t->opt_target = GRPC_CHTTP2_OPTIMIZE_FOR_LATENCY;
        ***REMOVED*** else if (0 ==
                   strcmp(channel_args->args[i].value.string, "throughput")) ***REMOVED***
        ...
        ***REMOVED***
      ***REMOVED*** else ***REMOVED***
        static const struct ***REMOVED***
          const char *channel_arg_name;
          grpc_chttp2_setting_id setting_id;
          grpc_integer_options integer_options;
          bool availability[2] /* server, client */;
        ***REMOVED*** settings_map[] = ***REMOVED***
            ***REMOVED***GRPC_ARG_MAX_CONCURRENT_STREAMS,
             GRPC_CHTTP2_SETTINGS_MAX_CONCURRENT_STREAMS,
             ***REMOVED***-1, 0, INT32_MAX***REMOVED***,
             ***REMOVED***true, false***REMOVED******REMOVED***,
            ***REMOVED***GRPC_ARG_HTTP2_HPACK_TABLE_SIZE_DECODER,
             GRPC_CHTTP2_SETTINGS_HEADER_TABLE_SIZE,
             ***REMOVED***-1, 0, INT32_MAX***REMOVED***,
             ***REMOVED***true, true***REMOVED******REMOVED***,
            ***REMOVED***GRPC_ARG_MAX_METADATA_SIZE,
             GRPC_CHTTP2_SETTINGS_MAX_HEADER_LIST_SIZE,
             ***REMOVED***-1, 0, INT32_MAX***REMOVED***,
             ***REMOVED***true, true***REMOVED******REMOVED***,
            ***REMOVED***GRPC_ARG_HTTP2_MAX_FRAME_SIZE,
             GRPC_CHTTP2_SETTINGS_MAX_FRAME_SIZE,
             ***REMOVED***-1, 16384, 16777215***REMOVED***,
             ***REMOVED***true, true***REMOVED******REMOVED***,
            ***REMOVED***GRPC_ARG_HTTP2_ENABLE_TRUE_BINARY,
             GRPC_CHTTP2_SETTINGS_GRPC_ALLOW_TRUE_BINARY_METADATA,
             ***REMOVED***1, 0, 1***REMOVED***,
             ***REMOVED***true, true***REMOVED******REMOVED***,
            ***REMOVED***GRPC_ARG_HTTP2_STREAM_LOOKAHEAD_BYTES,
             GRPC_CHTTP2_SETTINGS_INITIAL_WINDOW_SIZE,
             ***REMOVED***-1, 5, INT32_MAX***REMOVED***,
             ***REMOVED***true, true***REMOVED******REMOVED******REMOVED***;
        for (j = 0; j < (int)GPR_ARRAY_SIZE(settings_map); j++) ***REMOVED***
          if (0 == strcmp(channel_args->args[i].key,
                          settings_map[j].channel_arg_name)) ***REMOVED***
            if (!settings_map[j].availability[is_client]) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (gpr_time_cmp(t->keepalive_time, gpr_inf_future(GPR_TIMESPAN)) != 0) ***REMOVED***
...
static void destroy_transport(grpc_exec_ctx *exec_ctx, grpc_transport *gt) ***REMOVED***
...
static void close_transport_locked(grpc_exec_ctx *exec_ctx,
                                   ...
                                   grpc_error *error) ***REMOVED***
  if (!t->closed) ***REMOVED***
    if (!grpc_error_has_clear_grpc_status(error)) ***REMOVED***
      error = grpc_error_set_int(error, GRPC_ERROR_INT_GRPC_STATUS,
                                 GRPC_STATUS_UNAVAILABLE);
    ***REMOVED***
    if (t->write_state != GRPC_CHTTP2_WRITE_STATE_IDLE) ***REMOVED***
      if (t->close_transport_on_writes_finished == NULL) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (t->ping_state.is_delayed_ping_timer_set) ***REMOVED***
      grpc_timer_cancel(exec_ctx, &t->ping_state.delayed_ping_timer);
    ***REMOVED***
    switch (t->keepalive_state) ***REMOVED***
    ...
    ***REMOVED***
    ...
    while (grpc_chttp2_list_pop_writable_stream(t, &s)) ***REMOVED***
      GRPC_CHTTP2_STREAM_UNREF(exec_ctx, s, "chttp2_writing:close");
    ***REMOVED***
    end_all_the_calls(exec_ctx, t, GRPC_ERROR_REF(error));
    cancel_pings(exec_ctx, t, GRPC_ERROR_REF(error));
  ***REMOVED***
  if (t->notify_on_receive_settings != NULL) ***REMOVED***
...
#ifndef NDEBUG
void grpc_chttp2_stream_ref(grpc_chttp2_stream *s, const char *reason) ***REMOVED***
...
***REMOVED***
#else
void grpc_chttp2_stream_ref(grpc_chttp2_stream *s) ***REMOVED***
  grpc_stream_ref(s->refcount);
***REMOVED***
void grpc_chttp2_stream_unref(grpc_exec_ctx *exec_ctx, grpc_chttp2_stream *s) ***REMOVED***
...
static int init_stream(grpc_exec_ctx *exec_ctx, grpc_transport *gt,
                       ...
                       const void *server_data, gpr_arena *arena) ***REMOVED***
...
static void destroy_stream_locked(grpc_exec_ctx *exec_ctx, void *sp,
  ...
  ***REMOVED***
  ...
  for (int i = 0; i < STREAM_LIST_COUNT; i++) ***REMOVED***
    if (s->included[i]) ***REMOVED***
...
static void destroy_stream(grpc_exec_ctx *exec_ctx, grpc_transport *gt,
  ...
  if (s->stream_compression_ctx != NULL) ***REMOVED***
    grpc_stream_compression_context_destroy(s->stream_compression_ctx);
    s->stream_compression_ctx = NULL;
  ***REMOVED***
  if (s->stream_decompression_ctx != NULL) ***REMOVED***
...
grpc_chttp2_stream *grpc_chttp2_parsing_accept_stream(grpc_exec_ctx *exec_ctx,
                                                      grpc_chttp2_transport *t,
                                                      uint32_t id) ***REMOVED***
  if (t->channel_callback.accept_stream == NULL) ***REMOVED***
    return NULL;
  ***REMOVED***
...
static const char *write_state_name(grpc_chttp2_write_state st) ***REMOVED***
  switch (st) ***REMOVED***
...
static void set_write_state(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
                            grpc_chttp2_write_state st, const char *reason) ***REMOVED***
  GRPC_CHTTP2_IF_TRACING(gpr_log(GPR_DEBUG, "W:%p %s state %s -> %s [%s]", t,
                                 t->is_client ? "CLIENT" : "SERVER",
                                 write_state_name(t->write_state),
                                 write_state_name(st), reason));
  t->write_state = st;
  if (st == GRPC_CHTTP2_WRITE_STATE_IDLE) ***REMOVED***
...
static void inc_initiate_write_reason(
    grpc_exec_ctx *exec_ctx, grpc_chttp2_initiate_write_reason reason) ***REMOVED***
...
void grpc_chttp2_initiate_write(grpc_exec_ctx *exec_ctx,
                                grpc_chttp2_transport *t,
                                grpc_chttp2_initiate_write_reason reason) ***REMOVED***
  GPR_TIMER_BEGIN("grpc_chttp2_initiate_write", 0);

  switch (t->write_state) ***REMOVED***
    case GRPC_CHTTP2_WRITE_STATE_IDLE:
...
void grpc_chttp2_mark_stream_writable(grpc_exec_ctx *exec_ctx,
                                      grpc_chttp2_transport *t,
                                      grpc_chttp2_stream *s) ***REMOVED***
  if (!t->closed && grpc_chttp2_list_add_writable_stream(t, s)) ***REMOVED***
...
static grpc_closure_scheduler *write_scheduler(grpc_chttp2_transport *t,
  ...
  if (!t->is_first_write_in_batch) ***REMOVED***
  ...
  ***REMOVED***
  /* equivalently, if it's a partial write, we *know* we're going to be taking a
     ...
     immediately */
  if (partial_write) ***REMOVED***
    return grpc_executor_scheduler(GRPC_EXECUTOR_SHORT);
  ***REMOVED***
  switch (t->opt_target) ***REMOVED***
...
static const char *begin_writing_desc(bool partial, bool inlined) ***REMOVED***
  switch (WRITE_STATE_TUPLE_TO_INT(partial, inlined)) ***REMOVED***
...
static void write_action_begin_locked(grpc_exec_ctx *exec_ctx, void *gt,
  ...
  ***REMOVED***
  if (r.writing) ***REMOVED***
    if (r.partial) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (scheduler != grpc_schedule_on_exec_ctx) ***REMOVED***
...
static void write_action(grpc_exec_ctx *exec_ctx, void *gt, grpc_error *error) ***REMOVED***
  grpc_chttp2_transport *t = (grpc_chttp2_transport *)gt;
...
static void write_action_end_locked(grpc_exec_ctx *exec_ctx, void *tp,
  ...
  ***REMOVED***
  ...
  if (t->sent_goaway_state == GRPC_CHTTP2_GOAWAY_SEND_SCHEDULED) ***REMOVED***
    t->sent_goaway_state = GRPC_CHTTP2_GOAWAY_SENT;
    if (grpc_chttp2_stream_map_size(&t->stream_map) == 0) ***REMOVED***
      close_transport_locked(
...
static void queue_setting_update(grpc_exec_ctx *exec_ctx,
                                 grpc_chttp2_transport *t,
                                 grpc_chttp2_setting_id id, uint32_t value) ***REMOVED***
  const grpc_chttp2_setting_parameters *sp =
      &grpc_chttp2_settings_parameters[id];
  uint32_t use_value = GPR_CLAMP(value, sp->min_value, sp->max_value);
  if (use_value != value) ***REMOVED***
    gpr_log(GPR_INFO, "Requested parameter %s clamped from %d to %d", sp->name,
            value, use_value);
  ***REMOVED***
  if (use_value != t->settings[GRPC_LOCAL_SETTINGS][id]) ***REMOVED***
...
void grpc_chttp2_add_incoming_goaway(grpc_exec_ctx *exec_ctx,
                                     ...
                                     grpc_slice goaway_text) ***REMOVED***
  ...
  if (t->is_client && goaway_error == GRPC_HTTP2_ENHANCE_YOUR_CALM &&
      grpc_slice_str_cmp(goaway_text, "too_many_pings") == 0) ***REMOVED***
    gpr_log(GPR_ERROR,
  ...
  while (t->next_stream_id <= MAX_CLIENT_STREAM_ID &&
         grpc_chttp2_stream_map_size(&t->stream_map) <
             t->settings[GRPC_PEER_SETTINGS]
                        [GRPC_CHTTP2_SETTINGS_MAX_CONCURRENT_STREAMS] &&
         grpc_chttp2_list_pop_waiting_for_concurrency(t, &s)) ***REMOVED***
    ...
    if (t->next_stream_id >= MAX_CLIENT_STREAM_ID) ***REMOVED***
      connectivity_state_set(
          exec_ctx, t, GRPC_CHANNEL_TRANSIENT_FAILURE,
...
static grpc_closure *add_closure_barrier(grpc_closure *closure) ***REMOVED***
  closure->next_data.scratch += CLOSURE_BARRIER_FIRST_REF_BIT;
  return closure;
***REMOVED***

static void null_then_run_closure(grpc_exec_ctx *exec_ctx,
                                  grpc_closure **closure, grpc_error *error) ***REMOVED***
...
void grpc_chttp2_complete_closure_step(grpc_exec_ctx *exec_ctx,
                                       ...
                                       grpc_error *error, const char *desc) ***REMOVED***
  grpc_closure *closure = *pclosure;
  *pclosure = NULL;
  if (closure == NULL) ***REMOVED***
    GRPC_ERROR_UNREF(error);
    return;
  ***REMOVED***
  closure->next_data.scratch -= CLOSURE_BARRIER_FIRST_REF_BIT;
  if (GRPC_TRACER_ON(grpc_http_trace)) ***REMOVED***
  ...
  ***REMOVED***
  if (error != GRPC_ERROR_NONE) ***REMOVED***
    if (closure->error_data.error == GRPC_ERROR_NONE) ***REMOVED***
  ...
  ***REMOVED***
  if (closure->next_data.scratch < CLOSURE_BARRIER_FIRST_REF_BIT) ***REMOVED***
    if (closure->next_data.scratch & CLOSURE_BARRIER_STATS_BIT) ***REMOVED***
      grpc_transport_move_stats(&s->stats, s->collecting_stats);
      s->collecting_stats = NULL;
    ***REMOVED***
    if ((t->write_state == GRPC_CHTTP2_WRITE_STATE_IDLE) ||
        !(closure->next_data.scratch & CLOSURE_BARRIER_MAY_COVER_WRITE)) ***REMOVED***
...
static bool contains_non_ok_status(grpc_metadata_batch *batch) ***REMOVED***
  if (batch->idx.named.grpc_status != NULL) ***REMOVED***
...
static void maybe_become_writable_due_to_send_msg(grpc_exec_ctx *exec_ctx,
  ...
  if (s->id != 0 && (!s->write_buffering ||
                     s->flow_controlled_buffer.length > t->write_buffer_size)) ***REMOVED***
    grpc_chttp2_mark_stream_writable(exec_ctx, t, s);
    grpc_chttp2_initiate_write(exec_ctx, t,
...
static void continue_fetching_send_locked(grpc_exec_ctx *exec_ctx,
                                          ...
                                          grpc_chttp2_stream *s) ***REMOVED***
  for (;;) ***REMOVED***
    if (s->fetching_send_message == NULL) ***REMOVED***
      /* Stream was cancelled before message fetch completed */
      abort(); /* TODO(ctiller): what cleanup here? */
      return;  /* early out */
    ***REMOVED***
    if (s->fetched_send_message_length == s->fetching_send_message->length) ***REMOVED***
      grpc_byte_stream_destroy(exec_ctx, s->fetching_send_message);
      int64_t notify_offset = s->next_message_end_offset;
      if (notify_offset <= s->flow_controlled_bytes_written) ***REMOVED***
      ...
      ***REMOVED***
      ...
      return; /* early out */
    ***REMOVED*** else if (grpc_byte_stream_next(exec_ctx, s->fetching_send_message,
                                     UINT32_MAX, &s->complete_fetch_locked)) ***REMOVED***
...
static void do_nothing(grpc_exec_ctx *exec_ctx, void *arg, grpc_error *error) ***REMOVED******REMOVED***

static void log_metadata(const grpc_metadata_batch *md_batch, uint32_t id,
                         bool is_client, bool is_initial) ***REMOVED***
...
static void perform_stream_op_locked(grpc_exec_ctx *exec_ctx, void *stream_op,
  ...
  if (op->send_initial_metadata) ***REMOVED***
    ...
    if (op_payload->send_initial_metadata.send_initial_metadata->idx.named
        ...
        grpc_stream_compression_method_parse(
            ...
            true, &s->stream_compression_method) == 0) ***REMOVED***
    ...
    ***REMOVED***
    if (metadata_size > metadata_peer_limit) ***REMOVED***
      grpc_chttp2_cancel_stream(
          exec_ctx, t, s,
          grpc_error_set_int(
              grpc_error_set_int(
    ...
    ***REMOVED*** else ***REMOVED***
      if (contains_non_ok_status(s->send_initial_metadata)) ***REMOVED***
        s->seen_error = true;
      ***REMOVED***
      if (!s->write_closed) ***REMOVED***
        if (t->is_client) ***REMOVED***
          if (!t->closed) ***REMOVED***
            GPR_ASSERT(s->id == 0);
        ...
        ***REMOVED*** else ***REMOVED***
          ...
          if (!(op->send_message &&
                (op->payload->send_message.send_message->flags &
                 GRPC_WRITE_BUFFER_HINT))) ***REMOVED***
      ...
      ***REMOVED***
    ***REMOVED***
    if (op_payload->send_initial_metadata.peer_string != NULL) ***REMOVED***
  ...
  if (op->send_message) ***REMOVED***
    ...
    ***REMOVED*** else ***REMOVED***
      ...
      s->next_message_end_offset = s->flow_controlled_bytes_written +
                                   ...
                                   (int64_t)len;
      if (flags & GRPC_WRITE_BUFFER_HINT) ***REMOVED***
    ...
    if (metadata_size > metadata_peer_limit) ***REMOVED***
      grpc_chttp2_cancel_stream(
          ...
          grpc_error_set_int(
              ...
              GRPC_ERROR_INT_GRPC_STATUS, GRPC_STATUS_RESOURCE_EXHAUSTED));
    ***REMOVED*** else ***REMOVED***
      if (contains_non_ok_status(s->send_trailing_metadata)) ***REMOVED***
        s->seen_error = true;
      ***REMOVED***
      if (s->write_closed) ***REMOVED***
      ...
      ***REMOVED*** else if (s->id != 0) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (op->recv_initial_metadata) ***REMOVED***
    ...
    if (op_payload->recv_initial_metadata.peer_string != NULL) ***REMOVED***
...
static void cancel_pings(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
  ...
  for (size_t i = 0; i < GRPC_CHTTP2_PING_TYPE_COUNT; i++) ***REMOVED***
    grpc_chttp2_ping_queue *pq = &t->ping_queues[i];
    for (size_t j = 0; j < GRPC_CHTTP2_PCL_COUNT; j++) ***REMOVED***
...
static void send_ping_locked(
    ...
    grpc_chttp2_ping_type ping_type, grpc_closure *on_initiate,
    grpc_closure *on_ack,
    grpc_chttp2_initiate_write_reason initiate_write_reason) ***REMOVED***
  grpc_chttp2_ping_queue *pq = &t->ping_queues[ping_type];
  grpc_closure_list_append(&pq->lists[GRPC_CHTTP2_PCL_INITIATE], on_initiate,
                           GRPC_ERROR_NONE);
  if (grpc_closure_list_append(&pq->lists[GRPC_CHTTP2_PCL_NEXT], on_ack,
                               GRPC_ERROR_NONE)) ***REMOVED***
...
void grpc_chttp2_ack_ping(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
  ...
  ***REMOVED***
  ...
  if (!grpc_closure_list_empty(pq->lists[GRPC_CHTTP2_PCL_NEXT])) ***REMOVED***
    grpc_chttp2_initiate_write(exec_ctx, t,
...
void grpc_chttp2_add_ping_strike(grpc_exec_ctx *exec_ctx,
  ...
  if (++t->ping_recv_state.ping_strikes > t->ping_policy.max_ping_strikes &&
      t->ping_policy.max_ping_strikes != 0) ***REMOVED***
...
void grpc_chttp2_maybe_complete_recv_initial_metadata(grpc_exec_ctx *exec_ctx,
  ...
  if (s->recv_initial_metadata_ready != NULL &&
      s->published_metadata[0] != GRPC_METADATA_NOT_PUBLISHED) ***REMOVED***
    if (s->seen_error) ***REMOVED***
      grpc_slice_buffer_reset_and_unref_internal(exec_ctx, &s->frame_storage);
      if (!s->pending_byte_stream) ***REMOVED***
...
void grpc_chttp2_maybe_complete_recv_message(grpc_exec_ctx *exec_ctx,
  ...
  if (s->recv_message_ready != NULL) ***REMOVED***
    *s->recv_message = NULL;
    if (s->final_metadata_requested && s->seen_error) ***REMOVED***
      grpc_slice_buffer_reset_and_unref_internal(exec_ctx, &s->frame_storage);
      if (!s->pending_byte_stream) ***REMOVED***
        grpc_slice_buffer_reset_and_unref_internal(
            exec_ctx, &s->unprocessed_incoming_frames_buffer);
    ...
    ***REMOVED***
    if (!s->pending_byte_stream) ***REMOVED***
      while (s->unprocessed_incoming_frames_buffer.length > 0 ||
             s->frame_storage.length > 0) ***REMOVED***
        if (s->unprocessed_incoming_frames_buffer.length == 0) ***REMOVED***
          grpc_slice_buffer_swap(&s->unprocessed_incoming_frames_buffer,
                                 &s->frame_storage);
          s->unprocessed_incoming_frames_decompressed = false;
        ***REMOVED***
        if (!s->unprocessed_incoming_frames_decompressed) ***REMOVED***
          GPR_ASSERT(s->decompressed_data_buffer.length == 0);
          bool end_of_context;
          if (!s->stream_decompression_ctx) ***REMOVED***
          ...
          ***REMOVED*** else ***REMOVED***
            ...
            if (s->decompressed_header_bytes == GRPC_HEADER_SIZE_IN_BYTES) ***REMOVED***
              s->decompressed_header_bytes = 0;
            ***REMOVED***
            error = grpc_deframe_unprocessed_incoming_frames(
                exec_ctx, &s->data_parser, s, &s->decompressed_data_buffer,
                NULL, s->recv_message);
            if (end_of_context) ***REMOVED***
        ...
        ***REMOVED***
        if (error != GRPC_ERROR_NONE) ***REMOVED***
          ...
          grpc_slice_buffer_reset_and_unref_internal(
              exec_ctx, &s->unprocessed_incoming_frames_buffer);
          break;
        ***REMOVED*** else if (*s->recv_message != NULL) ***REMOVED***
          break;
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
    if (error == GRPC_ERROR_NONE && *s->recv_message != NULL) ***REMOVED***
      null_then_run_closure(exec_ctx, &s->recv_message_ready, GRPC_ERROR_NONE);
    ***REMOVED*** else if (s->published_metadata[1] != GRPC_METADATA_NOT_PUBLISHED) ***REMOVED***
      *s->recv_message = NULL;
      null_then_run_closure(exec_ctx, &s->recv_message_ready, GRPC_ERROR_NONE);
    ***REMOVED***
    GRPC_ERROR_UNREF(error);
  ...
  if (s->recv_trailing_metadata_finished != NULL && s->read_closed &&
    ...
    ***REMOVED***
    ...
    if (s->read_closed && s->frame_storage.length > 0 && !pending_data &&
        !s->seen_error && s->recv_trailing_metadata_finished != NULL) ***REMOVED***
      ...
      ***REMOVED***
      if (!grpc_stream_decompress(s->stream_decompression_ctx,
                                  ...
                                  GRPC_HEADER_SIZE_IN_BYTES, &end_of_context)) ***REMOVED***
        grpc_slice_buffer_reset_and_unref_internal(exec_ctx, &s->frame_storage);
        grpc_slice_buffer_reset_and_unref_internal(
            exec_ctx, &s->unprocessed_incoming_frames_buffer);
        s->seen_error = true;
    ...
    ***REMOVED***
    if (s->read_closed && s->frame_storage.length == 0 && !pending_data &&
        s->recv_trailing_metadata_finished != NULL) ***REMOVED***
      grpc_chttp2_incoming_metadata_buffer_publish(
...
static void remove_stream(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
                          uint32_t id, grpc_error *error) ***REMOVED***
  grpc_chttp2_stream *s =
      (grpc_chttp2_stream *)grpc_chttp2_stream_map_delete(&t->stream_map, id);
  GPR_ASSERT(s);
  if (t->incoming_stream == s) ***REMOVED***
    t->incoming_stream = NULL;
    grpc_chttp2_parsing_become_skip_parser(exec_ctx, t);
  ***REMOVED***
  if (s->pending_byte_stream) ***REMOVED***
    if (s->on_next != NULL) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (grpc_chttp2_stream_map_size(&t->stream_map) == 0) ***REMOVED***
    post_benign_reclaimer(exec_ctx, t);
    if (t->sent_goaway_state == GRPC_CHTTP2_GOAWAY_SENT) ***REMOVED***
      close_transport_locked(
          exec_ctx, t,
          GRPC_ERROR_CREATE_REFERENCING_FROM_STATIC_STRING(
    ...
    ***REMOVED***
  ***REMOVED***
  if (grpc_chttp2_list_remove_writable_stream(t, s)) ***REMOVED***
...
void grpc_chttp2_cancel_stream(grpc_exec_ctx *exec_ctx,
                               ...
                               grpc_error *due_to_error) ***REMOVED***
  if (!t->is_client && !s->sent_trailing_metadata &&
      grpc_error_has_clear_grpc_status(due_to_error)) ***REMOVED***
    close_from_api(exec_ctx, t, s, due_to_error);
    return;
  ***REMOVED***

  if (!s->read_closed || !s->write_closed) ***REMOVED***
    if (s->id != 0) ***REMOVED***
      grpc_http2_error_code http_error;
    ...
    ***REMOVED***
  ***REMOVED***
  if (due_to_error != GRPC_ERROR_NONE && !s->seen_error) ***REMOVED***
    s->seen_error = true;
  ***REMOVED***
...
void grpc_chttp2_fake_status(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
                             grpc_chttp2_stream *s, grpc_error *error) ***REMOVED***
  grpc_status_code status;
  grpc_slice slice;
  grpc_error_get_status(error, s->deadline, &status, &slice, NULL);

  if (status != GRPC_STATUS_OK) ***REMOVED***
    s->seen_error = true;
  ***REMOVED***
  ...
  if (s->published_metadata[1] == GRPC_METADATA_NOT_PUBLISHED ||
    ...
    if (!GRPC_SLICE_IS_EMPTY(slice)) ***REMOVED***
      GRPC_LOG_IF_ERROR(
          "add_status_message",
          grpc_chttp2_incoming_metadata_buffer_replace_or_add(
              exec_ctx, &s->metadata_buffer[1],
...
static void add_error(grpc_error *error, grpc_error **refs, size_t *nrefs) ***REMOVED***
  if (error == GRPC_ERROR_NONE) return;
  for (size_t i = 0; i < *nrefs; i++) ***REMOVED***
    if (error == refs[i]) ***REMOVED***
      return;
    ***REMOVED***
  ***REMOVED***
  refs[*nrefs] = error;
...
static grpc_error *removal_error(grpc_error *extra_error, grpc_chttp2_stream *s,
                                 const char *master_error_msg) ***REMOVED***
  grpc_error *refs[3];
  size_t nrefs = 0;
...
void grpc_chttp2_mark_stream_closed(grpc_exec_ctx *exec_ctx,
                                    ...
                                    int close_writes, grpc_error *error) ***REMOVED***
  if (s->read_closed && s->write_closed) ***REMOVED***
    /* already closed */
    grpc_chttp2_maybe_complete_recv_trailing_metadata(exec_ctx, t, s);
    GRPC_ERROR_UNREF(error);
  ...
  ***REMOVED***
  ...
  if (close_reads && !s->read_closed) ***REMOVED***
    s->read_closed_error = GRPC_ERROR_REF(error);
    s->read_closed = true;
    closed_read = true;
  ***REMOVED***
  if (close_writes && !s->write_closed) ***REMOVED***
  ...
  ***REMOVED***
  if (s->read_closed && s->write_closed) ***REMOVED***
    ...
    ***REMOVED***
    if (overall_error != GRPC_ERROR_NONE) ***REMOVED***
      grpc_chttp2_fake_status(exec_ctx, t, s, overall_error);
    ***REMOVED***
  ***REMOVED***
  if (closed_read) ***REMOVED***
    for (int i = 0; i < 2; i++) ***REMOVED***
      if (s->published_metadata[i] == GRPC_METADATA_NOT_PUBLISHED) ***REMOVED***
...
static void close_from_api(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
  ...
  if (!s->sent_initial_metadata) ***REMOVED***
...
typedef struct ***REMOVED***
  ...
  grpc_error *error;
  grpc_chttp2_transport *t;
***REMOVED*** cancel_stream_cb_args;

static void cancel_stream_cb(void *user_data, uint32_t key, void *stream) ***REMOVED***
...
static void end_all_the_calls(grpc_exec_ctx *exec_ctx, grpc_chttp2_transport *t,
                              grpc_error *error) ***REMOVED***
  cancel_stream_cb_args args = ***REMOVED***exec_ctx, error, t***REMOVED***;
...
void grpc_chttp2_act_on_flowctl_action(grpc_exec_ctx *exec_ctx,
                                       ...
                                       grpc_chttp2_transport *t,
                                       grpc_chttp2_stream *s) ***REMOVED***
  switch (action.send_stream_update) ***REMOVED***
    ...
    case GRPC_CHTTP2_FLOWCTL_QUEUE_UPDATE:
      ...
      break;
  ***REMOVED***
  switch (action.send_transport_update) ***REMOVED***
    case GRPC_CHTTP2_FLOWCTL_NO_ACTION_NEEDED:
      break;
    case GRPC_CHTTP2_FLOWCTL_UPDATE_IMMEDIATELY:
      grpc_chttp2_initiate_write(
    ...
    case GRPC_CHTTP2_FLOWCTL_QUEUE_UPDATE:
      break;
  ***REMOVED***
  if (action.send_setting_update != GRPC_CHTTP2_FLOWCTL_NO_ACTION_NEEDED) ***REMOVED***
    if (action.initial_window_size > 0) ***REMOVED***
      queue_setting_update(exec_ctx, t,
                           GRPC_CHTTP2_SETTINGS_INITIAL_WINDOW_SIZE,
                           (uint32_t)action.initial_window_size);
    ***REMOVED***
    if (action.max_frame_size > 0) ***REMOVED***
      queue_setting_update(exec_ctx, t, GRPC_CHTTP2_SETTINGS_MAX_FRAME_SIZE,
                           (uint32_t)action.max_frame_size);
    ***REMOVED***
    if (action.send_setting_update == GRPC_CHTTP2_FLOWCTL_UPDATE_IMMEDIATELY) ***REMOVED***
      grpc_chttp2_initiate_write(exec_ctx, t,
                                 GRPC_CHTTP2_INITIATE_WRITE_SEND_SETTINGS);
    ***REMOVED***
  ***REMOVED***
  if (action.need_ping) ***REMOVED***
...
static grpc_error *try_http_parsing(grpc_exec_ctx *exec_ctx,
  ...
  for (; i < t->read_buffer.count && parse_error == GRPC_ERROR_NONE; i++) ***REMOVED***
    parse_error =
        grpc_http_parser_parse(&parser, t->read_buffer.slices[i], NULL);
  ***REMOVED***
  if (parse_error == GRPC_ERROR_NONE &&
      (parse_error = grpc_http_parser_eof(&parser)) == GRPC_ERROR_NONE) ***REMOVED***
...
static void read_action_locked(grpc_exec_ctx *exec_ctx, void *tp,
  ...
  ***REMOVED***
  ...
  if (!t->closed) ***REMOVED***
    ...
    size_t i = 0;
    grpc_error *errors[3] = ***REMOVED***GRPC_ERROR_REF(error), GRPC_ERROR_NONE,
                             GRPC_ERROR_NONE***REMOVED***;
    for (; i < t->read_buffer.count && errors[1] == GRPC_ERROR_NONE; i++) ***REMOVED***
    ...
    ***REMOVED***
    if (errors[1] != GRPC_ERROR_NONE) ***REMOVED***
      errors[2] = try_http_parsing(exec_ctx, t);
      GRPC_ERROR_UNREF(error);
      error = GRPC_ERROR_CREATE_REFERENCING_FROM_STATIC_STRING(
          "Failed parsing HTTP/2", errors, GPR_ARRAY_SIZE(errors));
    ***REMOVED***
    for (i = 0; i < GPR_ARRAY_SIZE(errors); i++) ***REMOVED***
      GRPC_ERROR_UNREF(errors[i]);
    ***REMOVED***
    GPR_TIMER_END("reading_action.parse", 0);

    GPR_TIMER_BEGIN("post_parse_locked", 0);
    if (t->flow_control.initial_window_update != 0) ***REMOVED***
      if (t->flow_control.initial_window_update > 0) ***REMOVED***
        grpc_chttp2_stream *s;
        while (grpc_chttp2_list_pop_stalled_by_stream(t, &s)) ***REMOVED***
          grpc_chttp2_mark_stream_writable(exec_ctx, t, s);
          grpc_chttp2_initiate_write(
              exec_ctx, t,
...
static void start_bdp_ping_locked(grpc_exec_ctx *exec_ctx, void *tp,
  ...
  ***REMOVED***
  ...
  if (t->keepalive_state == GRPC_CHTTP2_KEEPALIVE_STATE_WAITING) ***REMOVED***
    grpc_timer_cancel(exec_ctx, &t->keepalive_ping_timer);
  ***REMOVED***
...
void grpc_chttp2_config_default_keepalive_args(grpc_channel_args *args,
                                               bool is_client) ***REMOVED***
  size_t i;
  if (args) ***REMOVED***
    for (i = 0; i < args->num_args; i++) ***REMOVED***
      if (0 == strcmp(args->args[i].key, GRPC_ARG_KEEPALIVE_TIME_MS)) ***REMOVED***
        const int value = grpc_channel_arg_get_integer(
            &args->args[i],
            (grpc_integer_options)***REMOVED***g_default_client_keepalive_time_ms, 1,
                                   INT_MAX***REMOVED***);
        if (is_client) ***REMOVED***
        ...
        ***REMOVED***
      ***REMOVED*** else if (0 ==
                 strcmp(args->args[i].key, GRPC_ARG_KEEPALIVE_TIMEOUT_MS)) ***REMOVED***
        const int value = grpc_channel_arg_get_integer(
            &args->args[i],
            (grpc_integer_options)***REMOVED***g_default_client_keepalive_timeout_ms, 0,
                                   INT_MAX***REMOVED***);
        if (is_client) ***REMOVED***
        ...
        ***REMOVED***
      ***REMOVED*** else if (0 == strcmp(args->args[i].key,
                             GRPC_ARG_KEEPALIVE_PERMIT_WITHOUT_CALLS)) ***REMOVED***
        g_default_keepalive_permit_without_calls =
            (uint32_t)grpc_channel_arg_get_integer(
                &args->args[i],
                (grpc_integer_options)***REMOVED***g_default_keepalive_permit_without_calls,
                                       0, 1***REMOVED***);
      ***REMOVED*** else if (0 ==
                 strcmp(args->args[i].key, GRPC_ARG_HTTP2_MAX_PING_STRIKES)) ***REMOVED***
      ...
      ***REMOVED*** else if (0 == strcmp(args->args[i].key,
        ...
        g_default_max_pings_without_data = grpc_channel_arg_get_integer(
            &args->args[i], (grpc_integer_options)***REMOVED***
                                g_default_max_pings_without_data, 0, INT_MAX***REMOVED***);
      ***REMOVED*** else if (0 ==
                 strcmp(
                     args->args[i].key,
                     GRPC_ARG_HTTP2_MIN_SENT_PING_INTERVAL_WITHOUT_DATA_MS)) ***REMOVED***
...
static void init_keepalive_ping_locked(grpc_exec_ctx *exec_ctx, void *arg,
  ...
  if (t->destroying || t->closed) ***REMOVED***
    t->keepalive_state = GRPC_CHTTP2_KEEPALIVE_STATE_DYING;
  ***REMOVED*** else if (error == GRPC_ERROR_NONE) ***REMOVED***
    if (t->keepalive_permit_without_calls ||
        grpc_chttp2_stream_map_size(&t->stream_map) > 0) ***REMOVED***
...
static void finish_keepalive_ping_locked(grpc_exec_ctx *exec_ctx, void *arg,
                                         grpc_error *error) ***REMOVED***
  grpc_chttp2_transport *t = (grpc_chttp2_transport *)arg;
  if (t->keepalive_state == GRPC_CHTTP2_KEEPALIVE_STATE_PINGING) ***REMOVED***
    if (error == GRPC_ERROR_NONE) ***REMOVED***
      t->keepalive_state = GRPC_CHTTP2_KEEPALIVE_STATE_WAITING;
      grpc_timer_cancel(exec_ctx, &t->keepalive_watchdog_timer);
      GRPC_CHTTP2_REF_TRANSPORT(t, "init keepalive ping");
...
static void keepalive_watchdog_fired_locked(grpc_exec_ctx *exec_ctx, void *arg,
  ...
  ***REMOVED*** else ***REMOVED***
    ...
    if (error != GRPC_ERROR_CANCELLED) ***REMOVED***
...
static void connectivity_state_set(grpc_exec_ctx *exec_ctx,
                                   grpc_chttp2_transport *t,
                                   grpc_connectivity_state state,
                                   grpc_error *error, const char *reason) ***REMOVED***
  GRPC_CHTTP2_IF_TRACING(
...
static void set_pollset(grpc_exec_ctx *exec_ctx, grpc_transport *gt,
                        grpc_stream *gs, grpc_pollset *pollset) ***REMOVED***
  grpc_chttp2_transport *t = (grpc_chttp2_transport *)gt;
  grpc_endpoint_add_to_pollset(exec_ctx, t->ep, pollset);
***REMOVED***

static void set_pollset_set(grpc_exec_ctx *exec_ctx, grpc_transport *gt,
                            grpc_stream *gs, grpc_pollset_set *pollset_set) ***REMOVED***
  grpc_chttp2_transport *t = (grpc_chttp2_transport *)gt;
...
static void incoming_byte_stream_unref(grpc_exec_ctx *exec_ctx,
                                       grpc_chttp2_incoming_byte_stream *bs) ***REMOVED***
  if (gpr_unref(&bs->refs)) ***REMOVED***
    gpr_free(bs);
  ***REMOVED***
***REMOVED***
...
static void incoming_byte_stream_next_locked(grpc_exec_ctx *exec_ctx,
  ...
  ***REMOVED***
  ...
  if (s->frame_storage.length > 0) ***REMOVED***
    grpc_slice_buffer_swap(&s->frame_storage,
                           &s->unprocessed_incoming_frames_buffer);
    s->unprocessed_incoming_frames_decompressed = false;
    GRPC_CLOSURE_SCHED(exec_ctx, bs->next_action.on_complete, GRPC_ERROR_NONE);
  ***REMOVED*** else if (s->byte_stream_error != GRPC_ERROR_NONE) ***REMOVED***
    GRPC_CLOSURE_SCHED(exec_ctx, bs->next_action.on_complete,
                       GRPC_ERROR_REF(s->byte_stream_error));
    if (s->data_parser.parsing_frame != NULL) ***REMOVED***
      incoming_byte_stream_unref(exec_ctx, s->data_parser.parsing_frame);
      s->data_parser.parsing_frame = NULL;
    ***REMOVED***
  ***REMOVED*** else if (s->read_closed) ***REMOVED***
    if (bs->remaining_bytes != 0) ***REMOVED***
      s->byte_stream_error =
...
static bool incoming_byte_stream_next(grpc_exec_ctx *exec_ctx,
                                      ...
                                      grpc_closure *on_complete) ***REMOVED***
    ...
    if (!s->unprocessed_incoming_frames_decompressed) ***REMOVED***
      ...
      ***REMOVED***
      if (!grpc_stream_decompress(s->stream_decompression_ctx,
                                  &s->unprocessed_incoming_frames_buffer,
                                  &s->decompressed_data_buffer, NULL,
                                  MAX_SIZE_T, &end_of_context)) ***REMOVED***
        error =
...
static void incoming_byte_stream_destroy(grpc_exec_ctx *exec_ctx,
                                         grpc_byte_stream *byte_stream) ***REMOVED***
...
grpc_error *grpc_chttp2_incoming_byte_stream_push(
    grpc_exec_ctx *exec_ctx, grpc_chttp2_incoming_byte_stream *bs,
    grpc_slice slice, grpc_slice *slice_out) ***REMOVED***
  grpc_chttp2_stream *s = bs->stream;

  if (bs->remaining_bytes < GRPC_SLICE_LENGTH(slice)) ***REMOVED***
    grpc_error *error =
...
grpc_error *grpc_chttp2_incoming_byte_stream_finished(
    grpc_exec_ctx *exec_ctx, grpc_chttp2_incoming_byte_stream *bs,
    grpc_error *error, bool reset_on_error) ***REMOVED***
  grpc_chttp2_stream *s = bs->stream;
  ...
  if (error == GRPC_ERROR_NONE) ***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED***
  if (error != GRPC_ERROR_NONE && reset_on_error) ***REMOVED***
    GRPC_CLOSURE_SCHED(exec_ctx, &s->reset_byte_stream, GRPC_ERROR_REF(error));
  ***REMOVED***
  incoming_byte_stream_unref(exec_ctx, bs);
  return error;
...
static const grpc_byte_stream_vtable grpc_chttp2_incoming_byte_stream_vtable = ***REMOVED***
    incoming_byte_stream_next, incoming_byte_stream_pull,
    incoming_byte_stream_shutdown, incoming_byte_stream_destroy***REMOVED***;
...
grpc_chttp2_incoming_byte_stream *grpc_chttp2_incoming_byte_stream_create(
    ...
    uint32_t frame_size, uint32_t flags) ***REMOVED***
...
static void post_benign_reclaimer(grpc_exec_ctx *exec_ctx,
                                  grpc_chttp2_transport *t) ***REMOVED***
  if (!t->benign_reclaimer_registered) ***REMOVED***
...
static void post_destructive_reclaimer(grpc_exec_ctx *exec_ctx,
                                       grpc_chttp2_transport *t) ***REMOVED***
  if (!t->destructive_reclaimer_registered) ***REMOVED***
...
static void benign_reclaimer_locked(grpc_exec_ctx *exec_ctx, void *arg,
  ...
  if (error == GRPC_ERROR_NONE &&
     ...
     * disconnect cleanly */
    if (GRPC_TRACER_ON(grpc_resource_quota_trace)) ***REMOVED***
    ...
    ***REMOVED***
    send_goaway(exec_ctx, t,
                grpc_error_set_int(
                    ...
                    GRPC_ERROR_INT_HTTP2_ERROR, GRPC_HTTP2_ENHANCE_YOUR_CALM));
  ***REMOVED*** else if (error == GRPC_ERROR_NONE &&
             GRPC_TRACER_ON(grpc_resource_quota_trace)) ***REMOVED***
    gpr_log(GPR_DEBUG,
...
static void destructive_reclaimer_locked(grpc_exec_ctx *exec_ctx, void *arg,
  ...
  if (error == GRPC_ERROR_NONE && n > 0) ***REMOVED***
    grpc_chttp2_stream *s =
...
static grpc_endpoint *chttp2_get_endpoint(grpc_exec_ctx *exec_ctx,
                                          grpc_transport *t) ***REMOVED***
  return ((grpc_chttp2_transport *)t)->ep;
***REMOVED***

static const grpc_transport_vtable vtable = ***REMOVED***sizeof(grpc_chttp2_stream),
                                             "chttp2",
                                             init_stream,
                                             set_pollset,
                                             set_pollset_set,
                                             ...
                                             destroy_stream,
                                             destroy_transport,
                                             chttp2_get_endpoint***REMOVED***;

static const grpc_transport_vtable *get_vtable(void) ***REMOVED*** return &vtable; ***REMOVED***
...
void grpc_chttp2_transport_start_reading(
    ...
    grpc_slice_buffer *read_buffer, grpc_closure *notify_on_receive_settings) ***REMOVED***
  grpc_chttp2_transport *t = (grpc_chttp2_transport *)transport;
  GRPC_CHTTP2_REF_TRANSPORT(
      t, "reading_action"); /* matches unref inside reading_action */
  if (read_buffer != NULL) ***REMOVED***
