...
const pb_field_t grpc_lb_v1_Duration_fields[3] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_Timestamp_fields[3] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_LoadBalanceRequest_fields[3] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_InitialLoadBalanceRequest_fields[2] = ***REMOVED***
    PB_FIELD(  1, STRING  , OPTIONAL, STATIC  , FIRST, grpc_lb_v1_InitialLoadBalanceRequest, name, name, 0),
    PB_LAST_FIELD
***REMOVED***;

const pb_field_t grpc_lb_v1_ClientStatsPerToken_fields[3] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_ClientStats_fields[7] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_LoadBalanceResponse_fields[3] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_InitialLoadBalanceResponse_fields[3] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_ServerList_fields[3] = ***REMOVED***
...
const pb_field_t grpc_lb_v1_Server_fields[5] = ***REMOVED***
