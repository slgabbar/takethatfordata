...
typedef struct grpc_linked_mdelem ***REMOVED***
  grpc_mdelem md;
  struct grpc_linked_mdelem *next;
  struct grpc_linked_mdelem *prev;
  void *reserved;
***REMOVED*** grpc_linked_mdelem;

typedef struct grpc_mdelem_list ***REMOVED***
  size_t count;
  size_t default_count;  // Number of default keys.
  grpc_linked_mdelem *head;
  grpc_linked_mdelem *tail;
***REMOVED*** grpc_mdelem_list;

typedef struct grpc_metadata_batch ***REMOVED***
...
typedef struct ***REMOVED***
  grpc_error *error;
  grpc_mdelem md;
***REMOVED*** grpc_filtered_mdelem;

#define GRPC_FILTERED_ERROR(error) \
  ((grpc_filtered_mdelem)***REMOVED***(error), GRPC_MDNULL***REMOVED***)
#define GRPC_FILTERED_MDELEM(md) ((grpc_filtered_mdelem)***REMOVED***GRPC_ERROR_NONE, (md)***REMOVED***)
#define GRPC_FILTERED_REMOVE() \
  ((grpc_filtered_mdelem)***REMOVED***GRPC_ERROR_NONE, GRPC_MDNULL***REMOVED***)
