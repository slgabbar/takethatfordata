...
#ifndef NDEBUG
void grpc_stream_ref(grpc_stream_refcount *refcount, const char *reason) ***REMOVED***
  ...
  ***REMOVED***
#else
void grpc_stream_ref(grpc_stream_refcount *refcount) ***REMOVED***
#endif
...
void grpc_stream_unref(grpc_exec_ctx *exec_ctx,
                       grpc_stream_refcount *refcount) ***REMOVED***
#endif
  if (gpr_unref(&refcount->refs)) ***REMOVED***
    if (exec_ctx->flags & GRPC_EXEC_CTX_FLAG_THREAD_RESOURCE_LOOP) ***REMOVED***
      /* Ick.
...
static void slice_stream_ref(void *p) ***REMOVED***
#ifndef NDEBUG
...
static void slice_stream_unref(grpc_exec_ctx *exec_ctx, void *p) ***REMOVED***
#ifndef NDEBUG
...
grpc_slice grpc_slice_from_stream_owned_buffer(grpc_stream_refcount *refcount,
                                               void *buffer, size_t length) ***REMOVED***
...
static const grpc_slice_refcount_vtable stream_ref_slice_vtable = ***REMOVED***
    .ref = slice_stream_ref,
    .unref = slice_stream_unref,
    .eq = grpc_slice_default_eq_impl,
    .hash = grpc_slice_default_hash_impl***REMOVED***;

#ifndef NDEBUG
void grpc_stream_ref_init(grpc_stream_refcount *refcount, int initial_refs,
                          grpc_iomgr_cb_func cb, void *cb_arg,
                          const char *object_type) ***REMOVED***
  refcount->object_type = object_type;
#else
void grpc_stream_ref_init(grpc_stream_refcount *refcount, int initial_refs,
                          grpc_iomgr_cb_func cb, void *cb_arg) ***REMOVED***
#endif
...
static void move64(uint64_t *from, uint64_t *to) ***REMOVED***
  *to += *from;
  *from = 0;
***REMOVED***

void grpc_transport_move_one_way_stats(grpc_transport_one_way_stats *from,
                                       grpc_transport_one_way_stats *to) ***REMOVED***
...
void grpc_transport_set_pops(grpc_exec_ctx *exec_ctx, grpc_transport *transport,
  ...
  if ((pollset = grpc_polling_entity_pollset(pollent)) != NULL) ***REMOVED***
    transport->vtable->set_pollset(exec_ctx, transport, stream, pollset);
  ***REMOVED*** else if ((pollset_set = grpc_polling_entity_pollset_set(pollent)) != NULL) ***REMOVED***
...
void grpc_transport_stream_op_batch_finish_with_failure(
    ...
    grpc_error *error, grpc_call_combiner *call_combiner) ***REMOVED***
  if (batch->send_message) ***REMOVED***
    grpc_byte_stream_destroy(exec_ctx,
                             batch->payload->send_message.send_message);
  ***REMOVED***
  if (batch->recv_message) ***REMOVED***
...
grpc_transport_op *grpc_make_transport_op(grpc_closure *on_complete) ***REMOVED***
...
***REMOVED*** made_transport_stream_op;
