...
***REMOVED*** tsi_adapter_handshaker_result;
...
static void adapter_result_destroy(tsi_handshaker_result *self) ***REMOVED***
  tsi_adapter_handshaker_result *impl = (tsi_adapter_handshaker_result *)self;
...
static const tsi_handshaker_result_vtable result_vtable = ***REMOVED***
...
static tsi_result tsi_adapter_create_handshaker_result(
    ...
    size_t unused_bytes_size, tsi_handshaker_result **handshaker_result) ***REMOVED***
  if (wrapped == NULL || (unused_bytes_size > 0 && unused_bytes == NULL)) ***REMOVED***
...
***REMOVED*** tsi_adapter_handshaker;
...
static tsi_result adapter_get_result(tsi_handshaker *self) ***REMOVED***
  return tsi_handshaker_get_result(tsi_adapter_handshaker_get_wrapped(self));
***REMOVED***

static tsi_result adapter_extract_peer(tsi_handshaker *self, tsi_peer *peer) ***REMOVED***
...
static void adapter_destroy(tsi_handshaker *self) ***REMOVED***
...
static tsi_result adapter_next(
  ...
  if ((received_bytes_size > 0 && received_bytes == NULL) ||
      ...
      handshaker_result == NULL) ***REMOVED***
    return TSI_INVALID_ARGUMENT;
  ***REMOVED***
...
tsi_handshaker *tsi_create_adapter_handshaker(tsi_handshaker *wrapped) ***REMOVED***
...
tsi_handshaker *tsi_adapter_handshaker_get_wrapped(tsi_handshaker *adapter) ***REMOVED***
