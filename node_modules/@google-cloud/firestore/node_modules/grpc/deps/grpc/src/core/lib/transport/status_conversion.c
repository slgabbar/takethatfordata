...
grpc_http2_error_code grpc_status_to_http2_error(grpc_status_code status) ***REMOVED***
...
grpc_status_code grpc_http2_status_to_grpc_status(int status) ***REMOVED***
  switch (status) ***REMOVED***
...
int grpc_status_to_http2_status(grpc_status_code status) ***REMOVED*** return 200; ***REMOVED***
