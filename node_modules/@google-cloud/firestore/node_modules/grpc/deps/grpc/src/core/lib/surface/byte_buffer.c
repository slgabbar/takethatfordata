...
grpc_byte_buffer *grpc_raw_compressed_byte_buffer_create(
    ...
    grpc_compression_algorithm compression) ***REMOVED***
  size_t i;
  grpc_byte_buffer *bb =
...
grpc_byte_buffer *grpc_raw_byte_buffer_from_reader(
    grpc_byte_buffer_reader *reader) ***REMOVED***
  grpc_byte_buffer *bb =
      (grpc_byte_buffer *)gpr_malloc(sizeof(grpc_byte_buffer));
  grpc_slice slice;
  bb->type = GRPC_BB_RAW;
  ...
  while (grpc_byte_buffer_reader_next(reader, &slice)) ***REMOVED***
    grpc_slice_buffer_add(&bb->data.raw.slice_buffer, slice);
  ***REMOVED***
  return bb;
***REMOVED***

grpc_byte_buffer *grpc_byte_buffer_copy(grpc_byte_buffer *bb) ***REMOVED***
  switch (bb->type) ***REMOVED***
    case GRPC_BB_RAW:
...
void grpc_byte_buffer_destroy(grpc_byte_buffer *bb) ***REMOVED***
  if (!bb) return;
...
size_t grpc_byte_buffer_length(grpc_byte_buffer *bb) ***REMOVED***
  switch (bb->type) ***REMOVED***
    case GRPC_BB_RAW:
