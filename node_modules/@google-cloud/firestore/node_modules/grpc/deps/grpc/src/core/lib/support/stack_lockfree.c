...
struct lockfree_node_contents ***REMOVED***
...
typedef union lockfree_node ***REMOVED***
  gpr_atm atm;
  struct lockfree_node_contents contents;
***REMOVED*** lockfree_node;
...
struct gpr_stack_lockfree ***REMOVED***
  lockfree_node *entries;
  lockfree_node head; /* An atomic entry describing curr head */
***REMOVED***;

gpr_stack_lockfree *gpr_stack_lockfree_create(size_t entries) ***REMOVED***
...
void gpr_stack_lockfree_destroy(gpr_stack_lockfree *stack) ***REMOVED***
  gpr_free_aligned(stack->entries);
  gpr_free(stack);
***REMOVED***

int gpr_stack_lockfree_push(gpr_stack_lockfree *stack, int entry) ***REMOVED***
  lockfree_node head;
  ...
  ***REMOVED*** while (!gpr_atm_rel_cas(&(stack->head.atm), head.atm, newhead.atm));
  /* Use rel_cas above to make sure that entry index is set properly */
  return head.contents.index == INVALID_ENTRY_INDEX;
***REMOVED***

int gpr_stack_lockfree_pop(gpr_stack_lockfree *stack) ***REMOVED***
  lockfree_node head;
  lockfree_node newhead;

  do ***REMOVED***
    head.atm = gpr_atm_acq_load(&(stack->head.atm));
    if (head.contents.index == INVALID_ENTRY_INDEX) ***REMOVED***
      return -1;
    ***REMOVED***
    newhead.atm =
        gpr_atm_no_barrier_load(&(stack->entries[head.contents.index].atm));

  ***REMOVED*** while (!gpr_atm_no_barrier_cas(&(stack->head.atm), head.atm, newhead.atm));
