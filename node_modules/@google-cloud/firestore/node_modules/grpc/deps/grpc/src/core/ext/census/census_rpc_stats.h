...
struct census_rpc_stats ***REMOVED***
  uint64_t cnt;
...
typedef struct census_per_method_rpc_stats ***REMOVED***
  const char *method;
...
***REMOVED*** census_per_method_rpc_stats;

typedef struct census_aggregated_rpc_stats ***REMOVED***
  int num_entries;
  census_per_method_rpc_stats *stats;
***REMOVED*** census_aggregated_rpc_stats;
