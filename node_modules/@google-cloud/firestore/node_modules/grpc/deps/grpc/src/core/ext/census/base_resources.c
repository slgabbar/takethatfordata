...
void define_base_resources() ***REMOVED***
  google_census_Resource_BasicUnit numerator =
      google_census_Resource_BasicUnit_SECS;
  resource r = ***REMOVED***(char *)"client_rpc_latency",             // name
                (char *)"Client RPC latency in seconds",  // description
                0,                                        // prefix
                1,                                        // n_numerators
                &numerator,                               // numerators
                0,                                        // n_denominators
                NULL***REMOVED***;                                    // denominators
  define_resource(&r);
  r = (resource)***REMOVED***(char *)"server_rpc_latency",             // name
