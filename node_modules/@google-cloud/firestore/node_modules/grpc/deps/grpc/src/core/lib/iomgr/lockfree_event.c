...
void grpc_lfev_init(gpr_atm *state) ***REMOVED***
  gpr_atm_no_barrier_store(state, CLOSURE_NOT_READY);
***REMOVED***

void grpc_lfev_destroy(gpr_atm *state) ***REMOVED***
  gpr_atm curr = gpr_atm_no_barrier_load(state);
  if (curr & FD_SHUTDOWN_BIT) ***REMOVED***
...
bool grpc_lfev_is_shutdown(gpr_atm *state) ***REMOVED***
  gpr_atm curr = gpr_atm_no_barrier_load(state);
  return (curr & FD_SHUTDOWN_BIT) != 0;
***REMOVED***

void grpc_lfev_notify_on(grpc_exec_ctx *exec_ctx, gpr_atm *state,
                         grpc_closure *closure, const char *variable) ***REMOVED***
  while (true) ***REMOVED***
    gpr_atm curr = gpr_atm_no_barrier_load(state);
    ...
    ***REMOVED***
    switch (curr) ***REMOVED***
      case CLOSURE_NOT_READY: ***REMOVED***
        /* CLOSURE_NOT_READY -> <closure>.
           ...
           barrier. */
        if (gpr_atm_rel_cas(state, CLOSURE_NOT_READY, (gpr_atm)closure)) ***REMOVED***
      ...
      ***REMOVED***
      ...
      case CLOSURE_READY: ***REMOVED***
        ...
        if (gpr_atm_no_barrier_cas(state, CLOSURE_READY, CLOSURE_NOT_READY)) ***REMOVED***
      ...
      ***REMOVED***
      ...
      default: ***REMOVED***
        ...
        if ((curr & FD_SHUTDOWN_BIT) > 0) ***REMOVED***
...
bool grpc_lfev_set_shutdown(grpc_exec_ctx *exec_ctx, gpr_atm *state,
                            grpc_error *shutdown_err) ***REMOVED***
    ...
    ***REMOVED***
    switch (curr) ***REMOVED***
      ...
      case CLOSURE_NOT_READY:
        ...
        if (gpr_atm_full_cas(state, curr, new_state)) ***REMOVED***
      ...
      ***REMOVED***
      ...
      case CLOSURE_NOT_READY: ***REMOVED***
        /* No barrier required as we're transitioning to a state that does not
           involve a closure */
        if (gpr_atm_no_barrier_cas(state, CLOSURE_NOT_READY, CLOSURE_READY)) ***REMOVED***
          return; /* early out */
        ***REMOVED***
        break; /* retry */
      ***REMOVED***
      ...
      default: ***REMOVED***
        ...
        ***REMOVED***
        ...
        else if (gpr_atm_full_cas(state, curr, CLOSURE_NOT_READY)) ***REMOVED***
