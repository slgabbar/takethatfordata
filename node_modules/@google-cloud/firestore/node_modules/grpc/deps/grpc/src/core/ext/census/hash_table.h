...
typedef union ***REMOVED***
  uint64_t val;
  void *ptr;
***REMOVED*** census_ht_key;

typedef enum census_ht_key_type ***REMOVED***
  CENSUS_HT_UINT64 = 0,
  CENSUS_HT_POINTER = 1
***REMOVED*** census_ht_key_type;

typedef struct census_ht_option ***REMOVED***
  /* Type of hash key */
...
typedef struct census_ht_kv ***REMOVED***
  census_ht_key k;
  void *v;
***REMOVED*** census_ht_kv;
