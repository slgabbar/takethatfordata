...
static const grpc_resolver_vtable dns_resolver_vtable = ***REMOVED***
    dns_destroy, dns_shutdown_locked, dns_channel_saw_error_locked,
    dns_next_locked***REMOVED***;
...
static void dns_on_resolved_locked(grpc_exec_ctx *exec_ctx, void *arg,
  ...
  r->resolving = false;
  if (r->addresses != NULL) ***REMOVED***
    grpc_lb_addresses *addresses = grpc_lb_addresses_create(
        r->addresses->naddrs, NULL /* user_data_vtable */);
    for (size_t i = 0; i < r->addresses->naddrs; ++i) ***REMOVED***
...
static void dns_destroy(grpc_exec_ctx *exec_ctx, grpc_resolver *gr) ***REMOVED***
...
static void dns_factory_ref(grpc_resolver_factory *factory) ***REMOVED******REMOVED***

static void dns_factory_unref(grpc_resolver_factory *factory) ***REMOVED******REMOVED***
...
static const grpc_resolver_factory_vtable dns_factory_vtable = ***REMOVED***
    dns_factory_ref, dns_factory_unref, dns_factory_create_resolver,
    dns_factory_get_default_host_name, "dns"***REMOVED***;
static grpc_resolver_factory dns_resolver_factory = ***REMOVED***&dns_factory_vtable***REMOVED***;

static grpc_resolver_factory *dns_resolver_factory_create() ***REMOVED***
  return &dns_resolver_factory;
***REMOVED***

void grpc_resolver_dns_native_init(void) ***REMOVED***
  char *resolver = gpr_getenv("GRPC_DNS_RESOLVER");
  if (resolver != NULL && gpr_stricmp(resolver, "native") == 0) ***REMOVED***
  ...
  ***REMOVED*** else ***REMOVED***
    ...
    if (existing_factory == NULL) ***REMOVED***
      gpr_log(GPR_DEBUG, "Using native dns resolver");
      grpc_register_resolver_type(dns_resolver_factory_create());
    ***REMOVED*** else ***REMOVED***
...
void grpc_resolver_dns_native_shutdown(void) ***REMOVED******REMOVED***
