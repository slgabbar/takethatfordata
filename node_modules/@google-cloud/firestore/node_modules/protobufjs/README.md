...
* **Message.decode**(reader: `Reader|Uint8Array`): `Message`<br />
  ...
  ***REMOVED*** catch (e) ***REMOVED***
      if (e instanceof protobuf.util.ProtocolError) ***REMOVED***
...
* **Message.create**(properties: `Object`): `Message`<br />
  ...
  ```js
  var message = AwesomeMessage.create(***REMOVED*** awesomeField: "AwesomeString" ***REMOVED***);
  ```
...
* **Message.fromObject**(object: `Object`): `Message`<br />
  ...
  ```js
  var message = AwesomeMessage.fromObject(***REMOVED*** awesomeField: 42 ***REMOVED***);
...
* **Message.toObject**(message: `Message` [, options: `ConversionOptions`]): `Object`<br />
  ...
  ```js
  var object = AwesomeMessage.toObject(message, ***REMOVED***
...
message AwesomeMessage ***REMOVED***
    string awesome_field = 1; // becomes awesomeField
***REMOVED***
```

```js
protobuf.load("awesome.proto", function(err, root) ***REMOVED***
    if (err)
        throw err;
    ...
    // Exemplary payload
    var payload = ***REMOVED*** awesomeField: "AwesomeString" ***REMOVED***;
...
***REMOVED***
  "nested": ***REMOVED***
    "AwesomeMessage": ***REMOVED***
      "fields": ***REMOVED***
        "awesomeField": ***REMOVED***
          "type": "string",
          "id": 1
        ***REMOVED***
      ***REMOVED***
...
```js
protobuf.load("awesome.json", function(err, root) ***REMOVED***
    if (err) throw err;
...
function AwesomeMessage(properties) ***REMOVED***
...
AwesomeMessage.customStaticMethod = function() ***REMOVED*** ... ***REMOVED***;
AwesomeMessage.prototype.customInstanceMethod = function() ***REMOVED*** ... ***REMOVED***;
...
service Greeter ***REMOVED***
    rpc SayHello (HelloRequest) returns (HelloReply) ***REMOVED******REMOVED***
***REMOVED***
...
greeter.sayHello(***REMOVED*** name: 'you' ***REMOVED***, function(err, response) ***REMOVED***
...
```js
greeter.sayHello(***REMOVED*** name: 'you' ***REMOVED***)
...
```ts
import ***REMOVED*** load ***REMOVED*** from "protobufjs"; // respectively "./node_modules/protobufjs"

load("awesome.proto", function(err, root) ***REMOVED***
  if (err)
    throw err;
  ...
  let message = AwesomeMessage.create(***REMOVED*** awesomeField: "hello" ***REMOVED***);
  console.log(`message = $***REMOVED***JSON.stringify(message)***REMOVED***`);

  let buffer = AwesomeMessage.encode(message).finish();
  console.log(`buffer = $***REMOVED***Array.prototype.toString.call(buffer)***REMOVED***`);

  let decoded = AwesomeMessage.decode(buffer);
  console.log(`decoded = $***REMOVED***JSON.stringify(decoded)***REMOVED***`);
***REMOVED***);
```
...
```ts
import ***REMOVED*** AwesomeMessage ***REMOVED*** from "./bundle.js";
...
```ts
import ***REMOVED*** Message, Type, Field, OneOf ***REMOVED*** from "protobufjs/light"; // respectively "./node_modules/protobufjs/light.js"

export class AwesomeSubMessage extends Message<AwesomeSubMessage> ***REMOVED***
...
export enum AwesomeEnum ***REMOVED***
  ONE = 1,
  TWO = 2
***REMOVED***

@Type.d("SuperAwesomeMessage")
export class AwesomeMessage extends Message<AwesomeMessage> ***REMOVED***
...
// example code
let message = new AwesomeMessage(***REMOVED*** awesomeField: "hello" ***REMOVED***);
let buffer  = AwesomeMessage.encode(message).finish();
let decoded = AwesomeMessage.decode(buffer);
```
...
* **MapField.d&lt;T extends ***REMOVED*** [key: string]: any ***REMOVED***>(fieldId: `number`, fieldKeyType: `string`, fieldValueType. `string | Constructor<***REMOVED******REMOVED***>`)**<br />
...
```js
protobuf.load("bundle.json", function(err, root) ***REMOVED***
    ...
***REMOVED***);
```
...
pbjs.main([ "--target", "json-module", "path/to/myproto.proto" ], function(err, output) ***REMOVED***
    if (err)
        throw err;
