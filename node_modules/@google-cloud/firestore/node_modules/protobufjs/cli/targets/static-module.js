...
function static_module_target(root, options, callback) ***REMOVED***
    require("./static")(root, options, function(err, output) ***REMOVED***
        if (err) ***REMOVED***
            callback(err);
            return;
        ***REMOVED***
        try ***REMOVED***
            output = util.wrap(output, protobuf.util.merge(***REMOVED*** dependency: "protobufjs/minimal" ***REMOVED***, options));
