...
message ApiConfigHandler ***REMOVED***
...
message ErrorHandler ***REMOVED***
  // Error codes.
  enum ErrorCode ***REMOVED***
...
message UrlMap ***REMOVED***
  // Redirect codes.
  enum RedirectHttpResponseCode ***REMOVED***
...
// them.
message StaticFilesHandler ***REMOVED***
...
message ScriptHandler ***REMOVED***
  // Path to the script from the application root directory.
  string script_path = 1;
***REMOVED***

// Uses Google Cloud Endpoints to handle requests.
message ApiEndpointHandler ***REMOVED***
  // Path to the script from the application root directory.
  string script_path = 1;
***REMOVED***
