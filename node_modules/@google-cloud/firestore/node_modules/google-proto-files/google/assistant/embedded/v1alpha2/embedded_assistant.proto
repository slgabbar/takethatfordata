...
service EmbeddedAssistant ***REMOVED***
...
// `audio_out` messages.
message AudioOutConfig ***REMOVED***
...
message AssistResponse ***REMOVED***
  // Indicates the type of event.
  enum EventType ***REMOVED***
    // No event specified.
...
//    above are specified.
message DeviceLocation ***REMOVED***
  oneof type ***REMOVED***
