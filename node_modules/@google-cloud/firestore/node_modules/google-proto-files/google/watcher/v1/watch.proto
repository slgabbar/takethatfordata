...
//
// Example: a calendar entry may have elements named ***REMOVED*** "starttime", "endtime",
// "attendees" ***REMOVED*** with corresponding values or it may have a single element name
...
// see [google.rpc.Code][].
service Watcher ***REMOVED***
  // Start a streaming RPC to get watch information from the server.
  rpc Watch(Request) returns (stream ChangeBatch) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/watch" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message ChangeBatch ***REMOVED***
  // A list of Change messages.
  repeated Change changes = 1;
***REMOVED***

// A Change indicates the most recent state of an element.
message Change ***REMOVED***
