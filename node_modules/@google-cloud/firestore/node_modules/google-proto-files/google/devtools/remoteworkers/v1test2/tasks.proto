...
service Tasks ***REMOVED***
  ...
  // the bots.
  rpc GetTask(GetTaskRequest) returns (Task) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1test2/***REMOVED***name=**/tasks/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // UpdateTaskResult updates the result.
  rpc UpdateTaskResult(UpdateTaskResultRequest) returns (TaskResult) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v1test2/***REMOVED***name=**/tasks/*/result***REMOVED***" body: "result" ***REMOVED***;
  ***REMOVED***
  ...
  rpc AddTaskLog(AddTaskLogRequest) returns (AddTaskLogResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1test2/***REMOVED***name=**/tasks/****REMOVED***:addLog" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message UpdateTaskResultRequest ***REMOVED***
...
message AddTaskLogRequest ***REMOVED***
...
message AddTaskLogResponse ***REMOVED***
