...
// take the form "projects/***REMOVED***project_id***REMOVED***". This is referred to below as "the farm
// resource."
service Bots ***REMOVED***
  ...
  rpc CreateBotSession(CreateBotSessionRequest) returns (BotSession) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1test2/***REMOVED***parent=*****REMOVED***/botSessions" body: "bot_session" ***REMOVED***;
  ***REMOVED***
  ...
  rpc UpdateBotSession(UpdateBotSessionRequest) returns (BotSession) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v1test2/***REMOVED***name=**/botSessions/****REMOVED***" body: "bot_session" ***REMOVED***;
  ***REMOVED***
  ...
  rpc PostBotEventTemp(PostBotEventTempRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1test2/***REMOVED***name=**/botSessions/****REMOVED***:postEvent" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message Lease ***REMOVED***
  ...
  // interface, this field might be projects/***REMOVED***projectid***REMOVED***/tasks/***REMOVED***taskid***REMOVED***.
  ...
  // projects/***REMOVED***projectid***REMOVED***/locations/***REMOVED***locationid***REMOVED***/queues/***REMOVED***queueid***REMOVED***. That queue
...
message AdminTemp ***REMOVED***
  // Possible administration actions.
  enum Command ***REMOVED***
    // Illegal value.
    UNSPECIFIED = 0;
...
message CreateBotSessionRequest ***REMOVED***
  // The farm resource.
  string parent = 1;
...
message UpdateBotSessionRequest ***REMOVED***
...
message PostBotEventTempRequest ***REMOVED***
  // Types of bot events.
  enum Type ***REMOVED***
    // Illegal value.
    UNSPECIFIED = 0;
