...
service PublishBuildEvent ***REMOVED***
  ...
  rpc PublishLifecycleEvent(PublishLifecycleEventRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/lifecycleEvents:publish" body: "*" ***REMOVED***;
  ***REMOVED***

  // Publish build tool events belonging to the same stream to a backend job
  // using bidirectional streaming.
  rpc PublishBuildToolEventStream(stream OrderedBuildEvent) returns (stream PublishBuildToolEventStreamResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/events:publish" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message PublishLifecycleEventRequest ***REMOVED***
  ...
  ***REMOVED***
  ...
  // type) hasn't been published after this duration from when ***REMOVED***build_event***REMOVED***
...
message PublishBuildToolEventStreamResponse ***REMOVED***
...
message OrderedBuildEvent ***REMOVED***
...
message PublishBuildToolEventStreamRequest ***REMOVED***
