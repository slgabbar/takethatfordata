...
message BuildEvent ***REMOVED***
  ...
  ***REMOVED***
  ...
  message InvocationAttemptFinished ***REMOVED***
  ...
  ***REMOVED***
  ...
  message BuildFinished ***REMOVED***
    // Final status of the build.
    BuildStatus status = 1;
  ***REMOVED***

  // Textual output written to standard output or standard error.
  message ConsoleOutput ***REMOVED***
  ...
  ***REMOVED***
  ...
  message BuildComponentStreamFinished ***REMOVED***
    // How did the event stream finish.
    enum FinishType ***REMOVED***
...
message StreamId ***REMOVED***
  ...
  ***REMOVED***
  ...
  // It should be the same as ***REMOVED***invocation***REMOVED*** (below) during the migration.
...
enum ConsoleOutputStream ***REMOVED***
