...
service ProfilerService ***REMOVED***
  ...
  rpc CreateProfile(CreateProfileRequest) returns (Profile) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2/projects/***REMOVED***deployment.project_id***REMOVED***/profiles" body: "*" ***REMOVED***;
  ***REMOVED***

  // UpdateProfile updates the profile bytes and labels on the profile resource
  // created in the online mode.
  rpc UpdateProfile(UpdateProfileRequest) returns (Profile) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v2/***REMOVED***profile.name=projects/*/profiles/****REMOVED***" body: "profile" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message CreateProfileRequest ***REMOVED***
  // Deployment details.
...
message UpdateProfileRequest ***REMOVED***
  // Profile to update
  Profile profile = 1;
***REMOVED***
...
message Deployment ***REMOVED***
  ...
  // Validation regex: `^[a-z][-a-z0-9:.]***REMOVED***4,61***REMOVED***[a-z0-9]$`.
  string project_id = 1;
  ...
  // Validation regex: `^[a-z]([-a-z0-9_.]***REMOVED***0,253***REMOVED***[a-z0-9])?$`.
  string target = 2;

  // Labels identify the deployment within the user universe and same target.
  // Validation regex for label names: `^[a-z0-9]([a-z0-9-]***REMOVED***0,61***REMOVED***[a-z0-9])?$`.
