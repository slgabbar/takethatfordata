...
service ReportErrorsService ***REMOVED***
  ...
  rpc ReportErrorEvent(ReportErrorEventRequest) returns (ReportErrorEventResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta1/***REMOVED***project_name=projects/****REMOVED***/events:report" body: "event" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// A request for reporting an individual error event.
message ReportErrorEventRequest ***REMOVED***
...
message ReportErrorEventResponse ***REMOVED***

***REMOVED***

// An error event which is reported to the Error Reporting system.
message ReportedErrorEvent ***REMOVED***
