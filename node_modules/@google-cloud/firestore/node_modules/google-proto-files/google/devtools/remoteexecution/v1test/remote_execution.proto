...
service Execution ***REMOVED***
  ...
  // `"blobs/***REMOVED***hash***REMOVED***/***REMOVED***size***REMOVED***"` indicating the digest of the missing blob.
  rpc Execute(ExecuteRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1test/***REMOVED***instance_name=*****REMOVED***/actions:execute" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
// information about when the client should retry the request; clients SHOULD
// respect the information provided.
service ActionCache ***REMOVED***
  // Retrieve a cached execution result.
  //
  // Errors:
  // * `NOT_FOUND`: The requested `ActionResult` is not in the cache.
  rpc GetActionResult(GetActionResultRequest) returns (ActionResult) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1test/***REMOVED***instance_name=*****REMOVED***/actionResults/***REMOVED***action_digest.hash***REMOVED***/***REMOVED***action_digest.size_bytes***REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  //   entry to the cache.
  rpc UpdateActionResult(UpdateActionResultRequest) returns (ActionResult) ***REMOVED***
    option (google.api.http) = ***REMOVED*** put: "/v1test/***REMOVED***instance_name=*****REMOVED***/actionResults/***REMOVED***action_digest.hash***REMOVED***/***REMOVED***action_digest.size_bytes***REMOVED***" body: "action_result" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
// `resource_name` is `***REMOVED***instance_name***REMOVED***/uploads/***REMOVED***uuid***REMOVED***/blobs/***REMOVED***hash***REMOVED***/***REMOVED***size***REMOVED***`,
...
// `***REMOVED***instance***REMOVED***/uploads/***REMOVED***uuid***REMOVED***/blobs/***REMOVED***hash***REMOVED***/***REMOVED***size***REMOVED***/foo/bar/baz.cc`. Anything
...
// the `resource_name` becomes `uploads/***REMOVED***uuid***REMOVED***/blobs/***REMOVED***hash***REMOVED***/***REMOVED***size***REMOVED***`.
//
...
// a `resource_name` of `"***REMOVED***instance_name***REMOVED***/blobs/***REMOVED***hash***REMOVED***/***REMOVED***size***REMOVED***"`, where
...
// information about when the client should retry the request; clients SHOULD
// respect the information provided.
service ContentAddressableStorage ***REMOVED***
  ...
  rpc FindMissingBlobs(FindMissingBlobsRequest) returns (FindMissingBlobsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1test/***REMOVED***instance_name=*****REMOVED***/blobs:findMissing" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  // provided data.
  rpc BatchUpdateBlobs(BatchUpdateBlobsRequest) returns (BatchUpdateBlobsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1test/***REMOVED***instance_name=*****REMOVED***/blobs:batchUpdate" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  rpc GetTree(GetTreeRequest) returns (GetTreeResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1test/***REMOVED***instance_name=*****REMOVED***/blobs/***REMOVED***root_digest.hash***REMOVED***/***REMOVED***root_digest.size_bytes***REMOVED***:getTree" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message Command ***REMOVED***
  ...
  // environment.
  message EnvironmentVariable ***REMOVED***
    // The variable name.
    string name = 1;
...
message OutputDirectory ***REMOVED***
...
message ExecuteRequest ***REMOVED***
...
message ExecuteResponse ***REMOVED***
...
// field][google.longrunning.Operation.response] of the
// [Operation][google.longrunning.Operation].
message ExecuteOperationMetadata ***REMOVED***
...
message GetActionResultRequest ***REMOVED***
  // The instance of the execution system to operate against. A server may
  // support multiple instances of the execution system (with their own workers,
  // storage, caches, etc.). The server MAY require use of this field to select
  // between them in an implementation-defined fashion, otherwise it can be
...
message UpdateActionResultRequest ***REMOVED***
  // The instance of the execution system to operate against. A server may
  // support multiple instances of the execution system (with their own workers,
  // storage, caches, etc.). The server MAY require use of this field to select
  // between them in an implementation-defined fashion, otherwise it can be
...
message FindMissingBlobsRequest ***REMOVED***
  // The instance of the execution system to operate against. A server may
  // support multiple instances of the execution system (with their own workers,
  // storage, caches, etc.). The server MAY require use of this field to select
  // between them in an implementation-defined fashion, otherwise it can be
...
// [ContentAddressableStorage.FindMissingBlobs][google.devtools.remoteexecution.v1test.ContentAddressableStorage.FindMissingBlobs].
message FindMissingBlobsResponse ***REMOVED***
...
message UpdateBlobRequest ***REMOVED***
...
// A request message for
// [ContentAddressableStorage.BatchUpdateBlobs][google.devtools.remoteexecution.v1test.ContentAddressableStorage.BatchUpdateBlobs].
message BatchUpdateBlobsRequest ***REMOVED***
  // The instance of the execution system to operate against. A server may
  // support multiple instances of the execution system (with their own workers,
  // storage, caches, etc.). The server MAY require use of this field to select
  // between them in an implementation-defined fashion, otherwise it can be
...
// A response message for
// [ContentAddressableStorage.BatchUpdateBlobs][google.devtools.remoteexecution.v1test.ContentAddressableStorage.BatchUpdateBlobs].
message BatchUpdateBlobsResponse ***REMOVED***
...
message GetTreeRequest ***REMOVED***
  // The instance of the execution system to operate against. A server may
  // support multiple instances of the execution system (with their own workers,
  // storage, caches, etc.). The server MAY require use of this field to select
  // between them in an implementation-defined fashion, otherwise it can be
...
// A response message for
// [ContentAddressableStorage.GetTree][google.devtools.remoteexecution.v1test.ContentAddressableStorage.GetTree].
message GetTreeResponse ***REMOVED***
...
message RequestMetadata ***REMOVED***
