...
message ManagedService ***REMOVED***
...
message ConfigFile ***REMOVED***
  enum FileType ***REMOVED***
    // Unknown file type.
...
message ConfigRef ***REMOVED***
  // Resource name of a service config. It must have the following
  // format: "services/***REMOVED***service name***REMOVED***/configs/***REMOVED***config id***REMOVED***".
  string name = 1;
***REMOVED***
...
message Rollout ***REMOVED***
  ...
  //       traffic_percent_strategy ***REMOVED***
  //         percentages: ***REMOVED***
  ...
  //       ***REMOVED***
  //     ***REMOVED***
  message TrafficPercentStrategy ***REMOVED***
  ...
  ***REMOVED***
  ...
  message DeleteServiceStrategy ***REMOVED***

  ***REMOVED***

  // Status of a Rollout.
  enum RolloutStatus ***REMOVED***
    // No status specified.
