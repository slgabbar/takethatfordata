...
service QuotaController ***REMOVED***
  ...
  rpc AllocateQuota(AllocateQuotaRequest) returns (AllocateQuotaResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/services/***REMOVED***service_name***REMOVED***:allocateQuota" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// Request message for the AllocateQuota method.
message AllocateQuotaRequest ***REMOVED***
...
message QuotaOperation ***REMOVED***
  // Supported quota modes.
  enum QuotaMode ***REMOVED***
...
message AllocateQuotaResponse ***REMOVED***
