...
service ServiceController ***REMOVED***
  ...
  rpc Check(CheckRequest) returns (CheckResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/services/***REMOVED***service_name***REMOVED***:check" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  // on the specified service. For more information, see
  // [Google Cloud IAM](https://cloud.google.com/iam).
  rpc Report(ReportRequest) returns (ReportResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/services/***REMOVED***service_name***REMOVED***:report" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// Request message for the Check method.
message CheckRequest ***REMOVED***
...
message CheckResponse ***REMOVED***
  message CheckInfo ***REMOVED***
    // Consumer info of this check.
    ConsumerInfo consumer_info = 2;
  ***REMOVED***

  // `ConsumerInfo` provides information about the consumer project.
  message ConsumerInfo ***REMOVED***
