...
//     service Messaging ***REMOVED***
//       rpc GetMessage(GetMessageRequest) returns (Message) ***REMOVED***
//         option (google.api.http).get = "/v1/messages/***REMOVED***message_id***REMOVED***";
//       ***REMOVED***
//     ***REMOVED***
//     message GetMessageRequest ***REMOVED***
//       message SubMessage ***REMOVED***
...
//
// If a variable contains exactly one path segment, such as `"***REMOVED***var***REMOVED***"` or
// `"***REMOVED***var=****REMOVED***"`, when such a variable is expanded into a URL path, all characters
// except `[-_.~0-9a-zA-Z]` are percent-encoded. Such variables show up in the
// Discovery Document as `***REMOVED***var***REMOVED***`.
//
// If a variable contains one or more path segments, such as `"***REMOVED***var=foo/****REMOVED***"`
// or `"***REMOVED***var=*****REMOVED***"`, when such a variable is expanded into a URL path, all
// characters except `[-_.~/0-9a-zA-Z]` are percent-encoded. Such variables
// show up in the Discovery Document as `***REMOVED***+var***REMOVED***`.
//
