...
// availability.
message UptimeCheckConfig ***REMOVED***
  // The resource submessage for group checks. It can be used instead of a
  // monitored resource, when multiple resources are being monitored.
  message ResourceGroup ***REMOVED***
  ...
  ***REMOVED***
  ...
  message ContentMatcher ***REMOVED***
    // String content to match
    string content = 1;
  ***REMOVED***

  // Nimbus InternalCheckers.
  message InternalChecker ***REMOVED***
  ...
  ***REMOVED***
  ...
  oneof check_request_type ***REMOVED***
...
enum UptimeCheckRegion ***REMOVED***
...
enum GroupResourceType ***REMOVED***
