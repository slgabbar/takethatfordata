...
// the request.
//
service Datastore ***REMOVED***
  // Looks up entities by key.
  rpc Lookup(LookupRequest) returns (LookupResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta3/projects/***REMOVED***project_id***REMOVED***:lookup" body: "*" ***REMOVED***;
  ***REMOVED***

  // Queries for entities.
  rpc RunQuery(RunQueryRequest) returns (RunQueryResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta3/projects/***REMOVED***project_id***REMOVED***:runQuery" body: "*" ***REMOVED***;
  ***REMOVED***

  // Begins a new transaction.
  rpc BeginTransaction(BeginTransactionRequest) returns (BeginTransactionResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta3/projects/***REMOVED***project_id***REMOVED***:beginTransaction" body: "*" ***REMOVED***;
  ***REMOVED***

  // Commits a transaction, optionally creating, deleting or modifying some
  // entities.
  rpc Commit(CommitRequest) returns (CommitResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta3/projects/***REMOVED***project_id***REMOVED***:commit" body: "*" ***REMOVED***;
  ***REMOVED***

  // Rolls back a transaction.
  rpc Rollback(RollbackRequest) returns (RollbackResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta3/projects/***REMOVED***project_id***REMOVED***:rollback" body: "*" ***REMOVED***;
  ***REMOVED***

  // Allocates IDs for the given keys, which is useful for referencing an entity
  // before it is inserted.
  rpc AllocateIds(AllocateIdsRequest) returns (AllocateIdsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta3/projects/***REMOVED***project_id***REMOVED***:allocateIds" body: "*" ***REMOVED***;
  ***REMOVED***

  // Prevents the supplied keys' IDs from being auto-allocated by Cloud
  // Datastore.
  rpc ReserveIds(ReserveIdsRequest) returns (ReserveIdsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta3/projects/***REMOVED***project_id***REMOVED***:reserveIds" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// The request for [Datastore.Lookup][google.datastore.v1beta3.Datastore.Lookup].
message LookupRequest ***REMOVED***
...
message LookupResponse ***REMOVED***
...
// (an empty message).
message RollbackResponse ***REMOVED***
...
message CommitRequest ***REMOVED***
  ...
  ***REMOVED***
  ...
  oneof transaction_selector ***REMOVED***
...
message AllocateIdsRequest ***REMOVED***
  // The ID of the project against which to make the request.
  string project_id = 8;
...
message AllocateIdsResponse ***REMOVED***
...
message ReserveIdsRequest ***REMOVED***
  // The ID of the project against which to make the request.
  string project_id = 8;
...
message ReserveIdsResponse ***REMOVED***

***REMOVED***

// A mutation to apply to an entity.
message Mutation ***REMOVED***
  ...
  ***REMOVED***
  ...
  oneof conflict_detection_strategy ***REMOVED***
...
message MutationResult ***REMOVED***
...
message ReadOptions ***REMOVED***
  // The possible values for read consistencies.
  enum ReadConsistency ***REMOVED***
    // Unspecified. This value must not be used.
  ...
  ***REMOVED***
  ...
  oneof consistency_type ***REMOVED***
...
message TransactionOptions ***REMOVED***
  // Options specific to read / write transactions.
  message ReadWrite ***REMOVED***
    // The transaction identifier of the transaction being retried.
    bytes previous_transaction = 1;
  ***REMOVED***

  // Options specific to read-only transactions.
  message ReadOnly ***REMOVED***
