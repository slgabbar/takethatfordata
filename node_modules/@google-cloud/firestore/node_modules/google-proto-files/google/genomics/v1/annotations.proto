...
service AnnotationServiceV1 ***REMOVED***
  ...
  rpc CreateAnnotationSet(CreateAnnotationSetRequest) returns (AnnotationSet) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/annotationsets" body: "annotation_set" ***REMOVED***;
  ***REMOVED***

  // Gets an annotation set. Caller must have READ permission for
  // the associated dataset.
  rpc GetAnnotationSet(GetAnnotationSetRequest) returns (AnnotationSet) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/annotationsets/***REMOVED***annotation_set_id***REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Updates an annotation set. The update must respect all mutability
  // restrictions and other invariants described on the annotation set resource.
  // Caller must have WRITE permission for the associated dataset.
  rpc UpdateAnnotationSet(UpdateAnnotationSetRequest) returns (AnnotationSet) ***REMOVED***
    option (google.api.http) = ***REMOVED*** put: "/v1/annotationsets/***REMOVED***annotation_set_id***REMOVED***" body: "annotation_set" ***REMOVED***;
  ***REMOVED***

  // Deletes an annotation set. Caller must have WRITE permission
  // for the associated annotation set.
  rpc DeleteAnnotationSet(DeleteAnnotationSetRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v1/annotationsets/***REMOVED***annotation_set_id***REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  rpc SearchAnnotationSets(SearchAnnotationSetsRequest) returns (SearchAnnotationSetsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/annotationsets/search" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  rpc CreateAnnotation(CreateAnnotationRequest) returns (Annotation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/annotations" body: "annotation" ***REMOVED***;
  ***REMOVED***
  ...
  rpc BatchCreateAnnotations(BatchCreateAnnotationsRequest) returns (BatchCreateAnnotationsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/annotations:batchCreate" body: "*" ***REMOVED***;
  ***REMOVED***

  // Gets an annotation. Caller must have READ permission
  // for the associated annotation set.
  rpc GetAnnotation(GetAnnotationRequest) returns (Annotation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/annotations/***REMOVED***annotation_id***REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Updates an annotation. Caller must have
  // WRITE permission for the associated dataset.
  rpc UpdateAnnotation(UpdateAnnotationRequest) returns (Annotation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** put: "/v1/annotations/***REMOVED***annotation_id***REMOVED***" body: "annotation" ***REMOVED***;
  ***REMOVED***

  // Deletes an annotation. Caller must have WRITE permission for
  // the associated annotation set.
  rpc DeleteAnnotation(DeleteAnnotationRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v1/annotations/***REMOVED***annotation_id***REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  rpc SearchAnnotations(SearchAnnotationsRequest) returns (SearchAnnotationsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/annotations/search" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message VariantAnnotation ***REMOVED***
  message ClinicalCondition ***REMOVED***
  ...
  ***REMOVED***
  ...
  enum ClinicalSignificance ***REMOVED***
...
message Transcript ***REMOVED***
  ...
  ***REMOVED***
  ...
  message CodingSequence ***REMOVED***
...
message CreateAnnotationSetRequest ***REMOVED***
  // The annotation set to create.
  AnnotationSet annotation_set = 1;
***REMOVED***

message GetAnnotationSetRequest ***REMOVED***
  // The ID of the annotation set to be retrieved.
  string annotation_set_id = 1;
***REMOVED***

message UpdateAnnotationSetRequest ***REMOVED***
...
message DeleteAnnotationSetRequest ***REMOVED***
  // The ID of the annotation set to be deleted.
  string annotation_set_id = 1;
***REMOVED***

message SearchAnnotationSetsRequest ***REMOVED***
...
message SearchAnnotationSetsResponse ***REMOVED***
...
message CreateAnnotationRequest ***REMOVED***
  // The annotation to be created.
  Annotation annotation = 1;
***REMOVED***

message BatchCreateAnnotationsRequest ***REMOVED***
...
message BatchCreateAnnotationsResponse ***REMOVED***
...
message GetAnnotationRequest ***REMOVED***
  // The ID of the annotation to be retrieved.
  string annotation_id = 1;
***REMOVED***

message UpdateAnnotationRequest ***REMOVED***
...
message DeleteAnnotationRequest ***REMOVED***
  // The ID of the annotation to be deleted.
  string annotation_id = 1;
***REMOVED***

message SearchAnnotationsRequest ***REMOVED***
...
message SearchAnnotationsResponse ***REMOVED***
