...
service StreamingReadService ***REMOVED***
  // Returns a stream of all the reads matching the search request, ordered
  // by reference name, position, and ID.
  rpc StreamReads(StreamReadsRequest) returns (stream StreamReadsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/reads:stream" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// The Readstore. A data store for DNA sequencing Reads.
service ReadServiceV1 ***REMOVED***
  ...
  // and position)
  rpc ImportReadGroupSets(ImportReadGroupSetsRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/readgroupsets:import" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  // for caveats.
  rpc ExportReadGroupSet(ExportReadGroupSetRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/readgroupsets/***REMOVED***read_group_set_id***REMOVED***:export" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  rpc SearchReadGroupSets(SearchReadGroupSetsRequest) returns (SearchReadGroupSetsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/readgroupsets/search" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  rpc UpdateReadGroupSet(UpdateReadGroupSetRequest) returns (ReadGroupSet) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v1/readgroupsets/***REMOVED***read_group_set_id***REMOVED***" body: "read_group_set" ***REMOVED***;
  ***REMOVED***
  ...
  // [Fundamentals of Google
  // Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
  rpc DeleteReadGroupSet(DeleteReadGroupSetRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v1/readgroupsets/***REMOVED***read_group_set_id***REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  // [Fundamentals of Google
  // Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
  rpc GetReadGroupSet(GetReadGroupSetRequest) returns (ReadGroupSet) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/readgroupsets/***REMOVED***read_group_set_id***REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  // set.
  rpc ListCoverageBuckets(ListCoverageBucketsRequest) returns (ListCoverageBucketsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/readgroupsets/***REMOVED***read_group_set_id***REMOVED***/coveragebuckets" ***REMOVED***;
  ***REMOVED***
  ...
  rpc SearchReads(SearchReadsRequest) returns (SearchReadsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/reads/search" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// The read group set search request.
message SearchReadGroupSetsRequest ***REMOVED***
...
message SearchReadGroupSetsResponse ***REMOVED***
...
message ImportReadGroupSetsRequest ***REMOVED***
  enum PartitionStrategy ***REMOVED***
...
message ImportReadGroupSetsResponse ***REMOVED***
  // IDs of the read group sets that were created.
  repeated string read_group_set_ids = 1;
***REMOVED***

// The read group set export request.
message ExportReadGroupSetRequest ***REMOVED***
...
message UpdateReadGroupSetRequest ***REMOVED***
...
message DeleteReadGroupSetRequest ***REMOVED***
  // The ID of the read group set to be deleted. The caller must have WRITE
  // permissions to the dataset associated with this read group set.
  string read_group_set_id = 1;
***REMOVED***

message GetReadGroupSetRequest ***REMOVED***
  // The ID of the read group set.
  string read_group_set_id = 1;
***REMOVED***

message ListCoverageBucketsRequest ***REMOVED***
...
message CoverageBucket ***REMOVED***
...
message ListCoverageBucketsResponse ***REMOVED***
...
message SearchReadsRequest ***REMOVED***
...
message SearchReadsResponse ***REMOVED***
...
message StreamReadsRequest ***REMOVED***
...
message StreamReadsResponse ***REMOVED***
  repeated Read alignments = 1;
***REMOVED***
