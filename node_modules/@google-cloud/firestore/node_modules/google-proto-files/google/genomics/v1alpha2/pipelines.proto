...
service PipelinesV1Alpha2 ***REMOVED***
  ...
  rpc CreatePipeline(CreatePipelineRequest) returns (Pipeline) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1alpha2/pipelines" body: "pipeline" ***REMOVED***;
  ***REMOVED***
  ...
  rpc RunPipeline(RunPipelineRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1alpha2/pipelines:run" body: "*" ***REMOVED***;
  ***REMOVED***

  // Retrieves a pipeline based on ID.
  //
  // Caller must have READ permission to the project.
  rpc GetPipeline(GetPipelineRequest) returns (Pipeline) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha2/pipelines/***REMOVED***pipeline_id***REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Lists pipelines.
  //
  // Caller must have READ permission to the project.
  rpc ListPipelines(ListPipelinesRequest) returns (ListPipelinesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha2/pipelines" ***REMOVED***;
  ***REMOVED***

  // Deletes a pipeline based on ID.
  //
  // Caller must have WRITE permission to the project.
  rpc DeletePipeline(DeletePipelineRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v1alpha2/pipelines/***REMOVED***pipeline_id***REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Gets controller configuration information. Should only be called
  // by VMs created by the Pipelines Service and not by end users.
  rpc GetControllerConfig(GetControllerConfigRequest) returns (ControllerConfig) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha2/pipelines:getControllerConfig" ***REMOVED***;
  ***REMOVED***

  // Sets status of a given operation. Any new timestamps (as determined by
  // description) are appended to TimestampEvents. Should only be called by VMs
  // created by the Pipelines Service and not by end users.
  rpc SetOperationStatus(SetOperationStatusRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** put: "/v1alpha2/pipelines:setOperationStatus" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// Describes a Compute Engine resource that is being managed by a running
// [pipeline][google.genomics.v1alpha2.Pipeline].
message ComputeEngine ***REMOVED***
...
message RuntimeMetadata ***REMOVED***
...
message CreatePipelineRequest ***REMOVED***
  // The pipeline to create. Should not have `pipelineId` populated.
  Pipeline pipeline = 1;
***REMOVED***

// The pipeline run arguments.
message RunPipelineArgs ***REMOVED***
...
// must be specified.
message RunPipelineRequest ***REMOVED***
  oneof pipeline ***REMOVED***
...
message GetPipelineRequest ***REMOVED***
...
// indicate offset.
message ListPipelinesRequest ***REMOVED***
...
// request.
message ListPipelinesResponse ***REMOVED***
...
message DeletePipelineRequest ***REMOVED***
...
// by VMs created by the Pipelines Service and not by end users.
message GetControllerConfigRequest ***REMOVED***
...
message ControllerConfig ***REMOVED***
  message RepeatedString ***REMOVED***
...
// execution.
message TimestampEvent ***REMOVED***
...
// created by the Pipelines Service and not by end users.
message SetOperationStatusRequest ***REMOVED***
  string operation_id = 1;
...
message ServiceAccount ***REMOVED***
...
message LoggingOptions ***REMOVED***
...
message PipelineResources ***REMOVED***
  // A Google Compute Engine disk resource specification.
  message Disk ***REMOVED***
...
//
// ```
// ***REMOVED***name: "input_file", localCopy: ***REMOVED***path: "file.txt", disk: "pd1"***REMOVED******REMOVED***
// ```
//
// where `disk` is defined in the `PipelineResources` object as:
//
// ```
// ***REMOVED***name: "pd1", mountPoint: "/mnt/disk/"***REMOVED***
// ```
//
...
message PipelineParameter ***REMOVED***
  // LocalCopy defines how a remote file should be copied to and from the VM.
  message LocalCopy ***REMOVED***
...
message DockerExecutor ***REMOVED***
