...
service DlpService ***REMOVED***
  ...
  rpc InspectContent(InspectContentRequest) returns (InspectContentResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta1/content:inspect" body: "*" ***REMOVED***;
  ***REMOVED***

  // Redacts potentially sensitive info from a list of strings.
  // This method has limits on input size, processing time, and output size.
  rpc RedactContent(RedactContentRequest) returns (RedactContentResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta1/content:redact" body: "*" ***REMOVED***;
  ***REMOVED***

  // De-identifies potentially sensitive info from a list of strings.
  // This method has limits on input size and output size.
  rpc DeidentifyContent(DeidentifyContentRequest) returns (DeidentifyContentResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta1/content:deidentify" body: "*" ***REMOVED***;
  ***REMOVED***

  // Schedules a job scanning content in a Google Cloud Platform data
  // repository.
  rpc CreateInspectOperation(CreateInspectOperationRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta1/inspect/operations" body: "*" ***REMOVED***;
  ***REMOVED***

  // Schedules a job to compute risk analysis metrics over content in a Google
  // Cloud Platform repository.
  rpc AnalyzeDataSourceRisk(AnalyzeDataSourceRiskRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta1/dataSource:analyze" body: "*" ***REMOVED***;
  ***REMOVED***

  // Returns list of results for given inspect operation result set id.
  rpc ListInspectFindings(ListInspectFindingsRequest) returns (ListInspectFindingsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta1/***REMOVED***name=inspect/results/****REMOVED***/findings" ***REMOVED***;
  ***REMOVED***

  // Returns sensitive information types for given category.
  rpc ListInfoTypes(ListInfoTypesRequest) returns (ListInfoTypesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta1/rootCategories/***REMOVED***category=****REMOVED***/infoTypes" ***REMOVED***;
  ***REMOVED***

  // Returns the list of root categories of sensitive information.
  rpc ListRootCategories(ListRootCategoriesRequest) returns (ListRootCategoriesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta1/rootCategories" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message OperationConfig ***REMOVED***
...
message RedactContentRequest ***REMOVED***
  message ReplaceConfig ***REMOVED***
...
message RedactContentResponse ***REMOVED***
...
// repository.
message CreateInspectOperationRequest ***REMOVED***
  // Configuration for the inspector.
  InspectConfig inspect_config = 1;
...
message InspectOperationMetadata ***REMOVED***
...
message InspectOperationResult ***REMOVED***
  // The server-assigned name, which is only unique within the same service that
  // originally returns it. If you use the default HTTP mapping, the
  // `name` should have the format of `inspect/results/***REMOVED***id***REMOVED***`.
  string name = 1;
***REMOVED***

// Request for the list of results in a given inspect operation.
message ListInspectFindingsRequest ***REMOVED***
  // Identifier of the results set returned as metadata of
  // the longrunning operation created by a call to InspectDataSource.
  // Should be in the format of `inspect/results/***REMOVED***id***REMOVED***`.
  string name = 1;
...
message ListInspectFindingsResponse ***REMOVED***
  // The results.
...
message CategoryDescription ***REMOVED***
...
message ListRootCategoriesRequest ***REMOVED***
...
message ListRootCategoriesResponse ***REMOVED***
...
// for risk analysis.
message RiskAnalysisOperationMetadata ***REMOVED***
  // The time which this request was started.
...
// request.
message RiskAnalysisOperationResult ***REMOVED***
...
message DeidentificationSummary ***REMOVED***
