...
message CustomInfoType ***REMOVED***
  ...
  message Dictionary ***REMOVED***
    // Message defining a list of words or phrases to search for in the data.
    message WordList ***REMOVED***
...
message Projection ***REMOVED***
  // The property to project.
  PropertyReference property = 1;
***REMOVED***

// Options defining a data set within Google Cloud Datastore.
message DatastoreOptions ***REMOVED***
  // A partition ID identifies a grouping of entities. The grouping is always
  // by project and namespace, however the namespace ID may be empty.
...
message CloudStorageOptions ***REMOVED***
  // Set of files to scan.
  message FileSet ***REMOVED***
...
message CloudStoragePath ***REMOVED***
  // The url, in the format of `gs://bucket/<path>`.
  string path = 1;
***REMOVED***

// Options defining BigQuery table and row identifiers.
message BigQueryOptions ***REMOVED***
...
message CloudStorageKey ***REMOVED***
  // Path to the file.
  string file_path = 1;
