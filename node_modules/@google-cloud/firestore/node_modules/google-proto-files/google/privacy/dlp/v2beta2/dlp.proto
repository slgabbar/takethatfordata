...
service DlpService ***REMOVED***
  // Finds potentially sensitive info in content.
  // This method has limits on input size, processing time, and output size.
  // [How-to guide for text](/dlp/docs/inspecting-text), [How-to guide for
  // images](/dlp/docs/inspecting-images)
  rpc InspectContent(InspectContentRequest) returns (InspectContentResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=projects/****REMOVED***/content:inspect" body: "*" ***REMOVED***;
  ***REMOVED***

  // Redacts potentially sensitive info from an image.
  // This method has limits on input size, processing time, and output size.
  // [How-to guide](/dlp/docs/redacting-sensitive-data-images)
  rpc RedactImage(RedactImageRequest) returns (RedactImageResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=projects/****REMOVED***/image:redact" body: "*" ***REMOVED***;
  ***REMOVED***

  // De-identifies potentially sensitive info from a ContentItem.
  // This method has limits on input size and output size.
  // [How-to guide](/dlp/docs/deidentify-sensitive-data)
  rpc DeidentifyContent(DeidentifyContentRequest) returns (DeidentifyContentResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=projects/****REMOVED***/content:deidentify" body: "*" ***REMOVED***;
  ***REMOVED***

  // Re-identify content that has been de-identified.
  rpc ReidentifyContent(ReidentifyContentRequest) returns (ReidentifyContentResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=projects/****REMOVED***/content:reidentify" body: "*" ***REMOVED***;
  ***REMOVED***

  // Schedules a job scanning content in a Google Cloud Platform data
  // repository. [How-to guide](/dlp/docs/inspecting-storage)
  rpc InspectDataSource(InspectDataSourceRequest) returns (DlpJob) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=projects/****REMOVED***/dataSource:inspect" body: "*" ***REMOVED***;
  ***REMOVED***

  // Schedules a job to compute risk analysis metrics over content in a Google
  // Cloud Platform repository. [How-to guide***REMOVED***(/dlp/docs/compute-risk-analysis)
  rpc AnalyzeDataSourceRisk(AnalyzeDataSourceRiskRequest) returns (DlpJob) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=projects/****REMOVED***/dataSource:analyze" body: "*" ***REMOVED***;
  ***REMOVED***

  // Returns sensitive information types DLP supports.
  rpc ListInfoTypes(ListInfoTypesRequest) returns (ListInfoTypesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta2/infoTypes" ***REMOVED***;
  ***REMOVED***

  // Creates an inspect template for re-using frequently used configuration
  // for inspecting content, images, and storage.
  rpc CreateInspectTemplate(CreateInspectTemplateRequest) returns (InspectTemplate) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=organizations/****REMOVED***/inspectTemplates" body: "*" ***REMOVED***;
  ***REMOVED***

  // Updates the inspect template.
  rpc UpdateInspectTemplate(UpdateInspectTemplateRequest) returns (InspectTemplate) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v2beta2/***REMOVED***name=organizations/*/inspectTemplates/****REMOVED***" body: "*" ***REMOVED***;
  ***REMOVED***

  // Gets an inspect template.
  rpc GetInspectTemplate(GetInspectTemplateRequest) returns (InspectTemplate) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta2/***REMOVED***name=organizations/*/inspectTemplates/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Lists inspect templates.
  rpc ListInspectTemplates(ListInspectTemplatesRequest) returns (ListInspectTemplatesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta2/***REMOVED***parent=organizations/****REMOVED***/inspectTemplates" ***REMOVED***;
  ***REMOVED***

  // Deletes inspect templates.
  rpc DeleteInspectTemplate(DeleteInspectTemplateRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v2beta2/***REMOVED***name=organizations/*/inspectTemplates/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Creates an Deidentify template for re-using frequently used configuration
  // for Deidentifying content, images, and storage.
  rpc CreateDeidentifyTemplate(CreateDeidentifyTemplateRequest) returns (DeidentifyTemplate) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***parent=organizations/****REMOVED***/deidentifyTemplates" body: "*" ***REMOVED***;
  ***REMOVED***

  // Updates the inspect template.
  rpc UpdateDeidentifyTemplate(UpdateDeidentifyTemplateRequest) returns (DeidentifyTemplate) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v2beta2/***REMOVED***name=organizations/*/deidentifyTemplates/****REMOVED***" body: "*" ***REMOVED***;
  ***REMOVED***

  // Gets an inspect template.
  rpc GetDeidentifyTemplate(GetDeidentifyTemplateRequest) returns (DeidentifyTemplate) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta2/***REMOVED***name=organizations/*/deidentifyTemplates/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Lists inspect templates.
  rpc ListDeidentifyTemplates(ListDeidentifyTemplatesRequest) returns (ListDeidentifyTemplatesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta2/***REMOVED***parent=organizations/****REMOVED***/deidentifyTemplates" ***REMOVED***;
  ***REMOVED***

  // Deletes inspect templates.
  rpc DeleteDeidentifyTemplate(DeleteDeidentifyTemplateRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v2beta2/***REMOVED***name=organizations/*/deidentifyTemplates/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Lists DlpJobs that match the specified filter in the request.
  rpc ListDlpJobs(ListDlpJobsRequest) returns (ListDlpJobsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta2/***REMOVED***parent=projects/****REMOVED***/dlpJobs" ***REMOVED***;
  ***REMOVED***

  // Gets the latest state of a long-running DlpJob.
  rpc GetDlpJob(GetDlpJobRequest) returns (DlpJob) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v2beta2/***REMOVED***name=projects/*/dlpJobs/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Deletes a long-running DlpJob. This method indicates that the client is
  // no longer interested in the DlpJob result. The job will be cancelled if
  // possible.
  rpc DeleteDlpJob(DeleteDlpJobRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v2beta2/***REMOVED***name=projects/*/dlpJobs/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Starts asynchronous cancellation on a long-running DlpJob.  The server
  // makes a best effort to cancel the DlpJob, but success is not
  // guaranteed.
  rpc CancelDlpJob(CancelDlpJobRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v2beta2/***REMOVED***name=projects/*/dlpJobs/****REMOVED***:cancel" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
// used.
message InspectConfig ***REMOVED***
  message FindingLimits ***REMOVED***
    // Max findings configuration per infoType, per content item or long
    // running DlpJob.
    message InfoTypeLimit ***REMOVED***
...
message TableLocation ***REMOVED***
  // The zero-based index of the row where the finding is located.
  int64 row_index = 1;
***REMOVED***

// Generic half-open interval [start, end)
message Range ***REMOVED***
...
message RedactImageRequest ***REMOVED***
  // Configuration for determining how redaction of images should occur.
  message ImageRedactionConfig ***REMOVED***
    // Type of information to redact from images.
    oneof target ***REMOVED***
...
message RedactImageResponse ***REMOVED***
...
message DeidentifyContentRequest ***REMOVED***
  // The parent resource name, for example projects/my-project-id.
  string parent = 1;
...
message DeidentifyContentResponse ***REMOVED***
...
message ReidentifyContentRequest ***REMOVED***
...
message ReidentifyContentResponse ***REMOVED***
...
message InspectContentRequest ***REMOVED***
  // The parent resource name, for example projects/my-project-id.
  string parent = 1;
...
message InspectContentResponse ***REMOVED***
  // The findings.
...
// repository.
message InspectDataSourceRequest ***REMOVED***
  // The parent resource name, for example projects/my-project-id.
  string parent = 1;
...
message OutputStorageConfig ***REMOVED***
  oneof type ***REMOVED***
...
message InfoTypeStatistics ***REMOVED***
...
message InspectDataSourceDetails ***REMOVED***
  message RequestedOptions ***REMOVED***
...
message InfoTypeDescription ***REMOVED***
...
message ListInfoTypesRequest ***REMOVED***
...
message RiskAnalysisJobConfig ***REMOVED***
...
message PrivacyMetric ***REMOVED***
  // Compute numerical stats over an individual column, including
  // min, max, and quantiles.
  message NumericalStatsConfig ***REMOVED***
  ...
  ***REMOVED***
  ...
  message CategoricalStatsConfig ***REMOVED***
  ...
  ***REMOVED***
  ...
  message KAnonymityConfig ***REMOVED***
  ...
  ***REMOVED***
  ...
  message LDiversityConfig ***REMOVED***
  ...
  ***REMOVED***
  ...
  message KMapEstimationConfig ***REMOVED***
    // A column with a semantic tag attached.
    message TaggedField ***REMOVED***
    ...
    ***REMOVED***
    ...
    message AuxiliaryTable ***REMOVED***
      // A quasi-identifier column has a custom_tag, used to know which column
      // in the data corresponds to which column in the statistical model.
      message QuasiIdField ***REMOVED***
        FieldId field = 1;
...
message AnalyzeDataSourceRiskDetails ***REMOVED***
  // Result of the numerical stats computation.
  message NumericalStatsResult ***REMOVED***
  ...
  ***REMOVED***
  ...
  message CategoricalStatsResult ***REMOVED***
    message CategoricalStatsHistogramBucket ***REMOVED***
  ...
  ***REMOVED***
  ...
  message KAnonymityResult ***REMOVED***
    // The set of columns' values that share the same ldiversity value
    message KAnonymityEquivalenceClass ***REMOVED***
    ...
    ***REMOVED***
    ...
    message KAnonymityHistogramBucket ***REMOVED***
  ...
  ***REMOVED***
  ...
  message LDiversityResult ***REMOVED***
    // The set of columns' values that share the same ldiversity value.
    message LDiversityEquivalenceClass ***REMOVED***
    ...
    ***REMOVED***
    ...
    message LDiversityHistogramBucket ***REMOVED***
  ...
  ***REMOVED***
  ...
  message KMapEstimationResult ***REMOVED***
    // A tuple of values for the quasi-identifier columns.
    message KMapEstimationQuasiIdValues ***REMOVED***
    ...
    ***REMOVED***
    ...
    message KMapEstimationHistogramBucket ***REMOVED***
      // Always positive.
    ...
    ***REMOVED***
    ...
    //   ***REMOVED***min_anonymity: 1, max_anonymity: 1, frequency: 17***REMOVED***
    //   ***REMOVED***min_anonymity: 2, max_anonymity: 3, frequency: 42***REMOVED***
    //   ***REMOVED***min_anonymity: 5, max_anonymity: 10, frequency: 99***REMOVED***
...
message ValueFrequency ***REMOVED***
...
message DeidentifyConfig ***REMOVED***
  oneof transformation ***REMOVED***
...
message PrimitiveTransformation ***REMOVED***
  oneof transformation ***REMOVED***
...
message TimePartConfig ***REMOVED***
  enum TimePart ***REMOVED***
...
message CryptoHashConfig ***REMOVED***
  // The key used by the hash function.
  CryptoKey crypto_key = 1;
***REMOVED***

// Replace each input value with a given `Value`.
message ReplaceValueConfig ***REMOVED***
  // Value to replace it with.
  Value new_value = 1;
***REMOVED***

// Replace each matching finding with the name of the info_type.
message ReplaceWithInfoTypeConfig ***REMOVED***
...
message RedactConfig ***REMOVED***

***REMOVED***

// Characters to skip when doing deidentification of a value. These will be left
// alone and skipped.
message CharsToIgnore ***REMOVED***
  enum CommonCharsToIgnore ***REMOVED***
    ...
    // US Punctuation, one of !"#$%&'()*+,-./:;<=>?@[\]^_`***REMOVED***|***REMOVED***~
    PUNCTUATION = 4;
...
// **3.
message CharacterMaskConfig ***REMOVED***
...
message FixedSizeBucketingConfig ***REMOVED***
...
message BucketingConfig ***REMOVED***
...
message CryptoReplaceFfxFpeConfig ***REMOVED***
  // These are commonly used subsets of the alphabet that the FFX mode
  // natively supports. In the algorithm, the alphabet is selected using
  // the "radix". Therefore each corresponds to particular radix.
  enum FfxCommonNativeAlphabet ***REMOVED***
...
message CryptoKey ***REMOVED***
  oneof source ***REMOVED***
...
message TransientCryptoKey ***REMOVED***
...
message UnwrappedCryptoKey ***REMOVED***
...
// dlp.kms.encrypt
message KmsWrappedCryptoKey ***REMOVED***
...
// info_type.
message InfoTypeTransformations ***REMOVED***
  // A transformation to apply to text that is identified as a specific
  // info_type.
  message InfoTypeTransformation ***REMOVED***
...
message FieldTransformation ***REMOVED***
...
// table.
message RecordTransformations ***REMOVED***
...
// true.
message RecordSuppression ***REMOVED***
...
// a field.
message RecordCondition ***REMOVED***
  ...
  ***REMOVED***
  ...
  message Conditions ***REMOVED***
    repeated Condition conditions = 1;
  ***REMOVED***

  // An expression, consisting or an operator and conditions.
  message Expressions ***REMOVED***
    enum LogicalOperator ***REMOVED***
...
message TransformationOverview ***REMOVED***
...
// will be set.
message TransformationSummary ***REMOVED***
  // A collection that informs the user the number of times a particular
  // `TransformationResultCode` and error details occurred.
  message SummaryResult ***REMOVED***
    int64 count = 1;
  ...
  ***REMOVED***
  ...
  enum TransformationResultCode ***REMOVED***
...
// InspectConfig.
message InspectTemplate ***REMOVED***
...
message DeidentifyTemplate ***REMOVED***
  // The template name. Output only.
  //
  // The template will have one of the following formats:
...
message CreateInspectTemplateRequest ***REMOVED***
...
message UpdateInspectTemplateRequest ***REMOVED***
...
message GetInspectTemplateRequest ***REMOVED***
...
message ListInspectTemplatesRequest ***REMOVED***
  // The parent resource name, for example projects/my-project-id or
  // organizations/my-org-id.
  string parent = 1;
...
message ListInspectTemplatesResponse ***REMOVED***
...
message DeleteInspectTemplateRequest ***REMOVED***
  // Resource name of the organization and inspectTemplate to be deleted, for
  // example `organizations/433245324/inspectTemplates/432452342`.
  string name = 1;
***REMOVED***

message InspectJobConfig ***REMOVED***
  // The data to scan.
...
message DlpJob ***REMOVED***
  enum JobState ***REMOVED***
...
message GetDlpJobRequest ***REMOVED***
  // The name of the DlpJob resource.
  string name = 1;
***REMOVED***

// The request message for listing DLP jobs.
message ListDlpJobsRequest ***REMOVED***
  // The parent resource name, for example projects/my-project-id.
  string parent = 4;
...
message ListDlpJobsResponse ***REMOVED***
...
message CancelDlpJobRequest ***REMOVED***
  // The name of the DlpJob resource to be cancelled.
  string name = 1;
***REMOVED***

// The request message for deleting a DLP job.
message DeleteDlpJobRequest ***REMOVED***
  // The name of the DlpJob resource to be deleted.
  string name = 1;
***REMOVED***

// Request message for CreateDeidentifyTemplate.
message CreateDeidentifyTemplateRequest ***REMOVED***
  // The parent resource name, for example projects/my-project-id or
  // organizations/my-org-id.
  string parent = 1;
...
message UpdateDeidentifyTemplateRequest ***REMOVED***
...
message GetDeidentifyTemplateRequest ***REMOVED***
...
message ListDeidentifyTemplatesRequest ***REMOVED***
  // The parent resource name, for example projects/my-project-id or
  // organizations/my-org-id.
  string parent = 1;
...
message ListDeidentifyTemplatesResponse ***REMOVED***
...
message DeleteDeidentifyTemplateRequest ***REMOVED***
...
enum InfoTypeSupportedBy ***REMOVED***
...
enum RelationalOperator ***REMOVED***
