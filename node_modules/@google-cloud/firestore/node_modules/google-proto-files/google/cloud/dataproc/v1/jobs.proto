...
service JobController ***REMOVED***
  ...
  rpc SubmitJob(SubmitJobRequest) returns (Job) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/projects/***REMOVED***project_id***REMOVED***/regions/***REMOVED***region***REMOVED***/jobs:submit" body: "*" ***REMOVED***;
  ***REMOVED***

  // Gets the resource representation for a job in a project.
  rpc GetJob(GetJobRequest) returns (Job) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/projects/***REMOVED***project_id***REMOVED***/regions/***REMOVED***region***REMOVED***/jobs/***REMOVED***job_id***REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Lists regions/***REMOVED***region***REMOVED***/jobs in a project.
  rpc ListJobs(ListJobsRequest) returns (ListJobsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/projects/***REMOVED***project_id***REMOVED***/regions/***REMOVED***region***REMOVED***/jobs" ***REMOVED***;
  ***REMOVED***

  // Updates a job in a project.
  rpc UpdateJob(UpdateJobRequest) returns (Job) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v1/projects/***REMOVED***project_id***REMOVED***/regions/***REMOVED***region***REMOVED***/jobs/***REMOVED***job_id***REMOVED***" body: "job" ***REMOVED***;
  ***REMOVED***

  // Starts a job cancellation request. To access the job resource
  // after cancellation, call
  // [regions/***REMOVED***region***REMOVED***/jobs.list](/dataproc/docs/reference/rest/v1/projects.regions.jobs/list) or
  // [regions/***REMOVED***region***REMOVED***/jobs.get](/dataproc/docs/reference/rest/v1/projects.regions.jobs/get).
  rpc CancelJob(CancelJobRequest) returns (Job) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/projects/***REMOVED***project_id***REMOVED***/regions/***REMOVED***region***REMOVED***/jobs/***REMOVED***job_id***REMOVED***:cancel" body: "*" ***REMOVED***;
  ***REMOVED***

  // Deletes the job from the project. If the job is active, the delete fails,
  // and the response returns `FAILED_PRECONDITION`.
  rpc DeleteJob(DeleteJobRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v1/projects/***REMOVED***project_id***REMOVED***/regions/***REMOVED***region***REMOVED***/jobs/***REMOVED***job_id***REMOVED***" ***REMOVED***;
  ***REMOVED***
***REMOVED***
