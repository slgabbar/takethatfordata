...
service VideoIntelligenceService ***REMOVED***
  // Performs asynchronous video annotation. Progress and results can be
  // retrieved through the `google.longrunning.Operations` interface.
  // `Operation.metadata` contains `AnnotateVideoProgress` (progress).
  // `Operation.response` contains `AnnotateVideoResponse` (results).
  rpc AnnotateVideo(AnnotateVideoRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta2/videos:annotate" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// Video annotation request.
message AnnotateVideoRequest ***REMOVED***
...
// Config for LABEL_DETECTION.
message LabelDetectionConfig ***REMOVED***
...
// Config for SHOT_CHANGE_DETECTION.
message ShotChangeDetectionConfig ***REMOVED***
...
// Config for EXPLICIT_CONTENT_DETECTION.
message ExplicitContentDetectionConfig ***REMOVED***
...
// Config for FACE_DETECTION.
message FaceDetectionConfig ***REMOVED***
...
// Label annotation.
message LabelAnnotation ***REMOVED***
  // Detected entity.
  Entity entity = 1;
...
message ExplicitContentFrame ***REMOVED***
  // Time-offset, relative to the beginning of the video, corresponding to the
  // video frame for this location.
  google.protobuf.Duration time_offset = 1;
...
message ExplicitContentAnnotation ***REMOVED***
...
// Range: [0, 1].
message NormalizedBoundingBox ***REMOVED***
  // Left X coordinate.
  float left = 1;
...
message FaceSegment ***REMOVED***
  // Video segment where a face was detected.
  VideoSegment segment = 1;
***REMOVED***

// Video frame level annotation results for face detection.
message FaceFrame ***REMOVED***
...
// Face annotation.
message FaceAnnotation ***REMOVED***
...
message VideoAnnotationResults ***REMOVED***
...
message AnnotateVideoResponse ***REMOVED***
  // Annotation results for all videos specified in `AnnotateVideoRequest`.
  repeated VideoAnnotationResults annotation_results = 1;
***REMOVED***

// Annotation progress for a single video.
message VideoAnnotationProgress ***REMOVED***
  // Video file location in
  // [Google Cloud Storage](https://cloud.google.com/storage/).
  string input_uri = 1;
...
enum LabelDetectionMode ***REMOVED***
  // Unspecified.
