...
message Device ***REMOVED***
  ...
  // `projects/p1/locations/us-central1/registries/registry0/devices/***REMOVED***num_id***REMOVED***`.
...
message DeviceRegistry ***REMOVED***
...
message EventNotificationConfig ***REMOVED***
...
// The configuration for notification of new states received from the device.
message StateNotificationConfig ***REMOVED***
  // A Cloud Pub/Sub topic name. For example,
  // `projects/myProject/topics/deviceEvents`.
  string pubsub_topic_name = 1;
***REMOVED***
...
message RegistryCredential ***REMOVED***
  // The credential data. Reserved for expansion in the future.
  oneof credential ***REMOVED***
...
message X509CertificateDetails ***REMOVED***
...
message PublicKeyCertificate ***REMOVED***
...
message DeviceCredential ***REMOVED***
  // The credential data. Reserved for expansion in the future.
  oneof credential ***REMOVED***
...
message PublicKeyCredential ***REMOVED***
...
enum PublicKeyCertificateFormat ***REMOVED***
