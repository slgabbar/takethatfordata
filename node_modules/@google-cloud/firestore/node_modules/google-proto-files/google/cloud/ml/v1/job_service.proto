...
service JobService ***REMOVED***
  ...
  rpc CreateJob(CreateJobRequest) returns (Job) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/***REMOVED***parent=projects/****REMOVED***/jobs" body: "job" ***REMOVED***;
  ***REMOVED***

  // Lists the jobs in the project.
  rpc ListJobs(ListJobsRequest) returns (ListJobsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/***REMOVED***parent=projects/****REMOVED***/jobs" ***REMOVED***;
  ***REMOVED***

  // Describes a job.
  rpc GetJob(GetJobRequest) returns (Job) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/***REMOVED***name=projects/*/jobs/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Cancels a running job.
  rpc CancelJob(CancelJobRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/***REMOVED***name=projects/*/jobs/****REMOVED***:cancel" body: "*" ***REMOVED***;
  ***REMOVED***
***REMOVED***
