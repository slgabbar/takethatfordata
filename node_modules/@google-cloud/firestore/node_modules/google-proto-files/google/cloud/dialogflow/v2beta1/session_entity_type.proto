...
//
// #
service SessionEntityTypes ***REMOVED***
  // Returns the list of all session entity types in the specified session.
  rpc ListSessionEntityTypes(ListSessionEntityTypesRequest)
      returns (ListSessionEntityTypesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v2beta1/***REMOVED***parent=projects/*/agent/sessions/****REMOVED***/entityTypes"
    ***REMOVED***;
  ***REMOVED***

  // Retrieves the specified session entity type.
  rpc GetSessionEntityType(GetSessionEntityTypeRequest)
      returns (SessionEntityType) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v2beta1/***REMOVED***name=projects/*/agent/sessions/*/entityTypes/****REMOVED***"
    ***REMOVED***;
  ***REMOVED***
  ...
  rpc CreateSessionEntityType(CreateSessionEntityTypeRequest)
      returns (SessionEntityType) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v2beta1/***REMOVED***parent=projects/*/agent/sessions/****REMOVED***/entityTypes"
  ...
  ***REMOVED***
  ...
  rpc UpdateSessionEntityType(UpdateSessionEntityTypeRequest)
    ...
    option (google.api.http) = ***REMOVED***
      patch:
          "/v2beta1/***REMOVED***session_entity_type.name=projects/*/agent/sessions/*/"
          "entityTypes/****REMOVED***"
      body: "session_entity_type"
    ***REMOVED***;
  ***REMOVED***
  ...
  rpc DeleteSessionEntityType(DeleteSessionEntityTypeRequest)
    ...
    option (google.api.http) = ***REMOVED***
      delete: "/v2beta1/***REMOVED***name=projects/*/agent/sessions/*/entityTypes/****REMOVED***"
    ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message SessionEntityType ***REMOVED***
  // The types of modifications for a session entity type.
  enum EntityOverrideMode ***REMOVED***
...
message ListSessionEntityTypesRequest ***REMOVED***
...
// [SessionEntityTypes.ListSessionEntityTypes][google.cloud.dialogflow.v2beta1.SessionEntityTypes.ListSessionEntityTypes].
message ListSessionEntityTypesResponse ***REMOVED***
...
message GetSessionEntityTypeRequest ***REMOVED***
...
message CreateSessionEntityTypeRequest ***REMOVED***
...
message UpdateSessionEntityTypeRequest ***REMOVED***
...
message DeleteSessionEntityTypeRequest ***REMOVED***
