...
// #
service Intents ***REMOVED***
  // Returns the list of all intents in the specified agent.
  rpc ListIntents(ListIntentsRequest) returns (ListIntentsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v2beta1/***REMOVED***parent=projects/*/agent***REMOVED***/intents"
    ***REMOVED***;
  ***REMOVED***

  // Retrieves the specified intent.
  rpc GetIntent(GetIntentRequest) returns (Intent) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v2beta1/***REMOVED***name=projects/*/agent/intents/****REMOVED***"
    ***REMOVED***;
  ***REMOVED***

  // Creates an intent in the specified agent.
  rpc CreateIntent(CreateIntentRequest) returns (Intent) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v2beta1/***REMOVED***parent=projects/*/agent***REMOVED***/intents"
      body: "intent"
    ***REMOVED***;
  ***REMOVED***

  // Updates the specified intent.
  rpc UpdateIntent(UpdateIntentRequest) returns (Intent) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      patch: "/v2beta1/***REMOVED***intent.name=projects/*/agent/intents/****REMOVED***"
      body: "intent"
    ***REMOVED***;
  ***REMOVED***

  // Deletes the specified intent.
  rpc DeleteIntent(DeleteIntentRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      delete: "/v2beta1/***REMOVED***name=projects/*/agent/intents/****REMOVED***"
    ***REMOVED***;
  ***REMOVED***
  ...
  rpc BatchUpdateIntents(BatchUpdateIntentsRequest)
      returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v2beta1/***REMOVED***parent=projects/*/agent***REMOVED***/intents:batchUpdate"
      body: "*"
    ***REMOVED***;
  ***REMOVED***
  ...
  rpc BatchDeleteIntents(BatchDeleteIntentsRequest)
      returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v2beta1/***REMOVED***parent=projects/*/agent***REMOVED***/intents:batchDelete"
      body: "*"
    ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
message Intent ***REMOVED***
  ...
  message TrainingPhrase ***REMOVED***
  ...
  ***REMOVED***
  ...
  message Message ***REMOVED***
    ...
    ***REMOVED***
    ...
    message SimpleResponse ***REMOVED***
    ...
    ***REMOVED***
    ...
    // `SimpleResponse`.
    message SimpleResponses ***REMOVED***
      // Required. The list of simple responses.
      repeated SimpleResponse simple_responses = 1;
    ***REMOVED***

    // The basic card message. Useful for displaying information.
    message BasicCard ***REMOVED***
      // The button object that appears at the bottom of a card.
      message Button ***REMOVED***
        // Opens the given URI.
        message OpenUriAction ***REMOVED***
    ...
    ***REMOVED***
    ...
    message LinkOutSuggestion ***REMOVED***
    ...
    ***REMOVED***
    ...
    message CarouselSelect ***REMOVED***
    ...
    ***REMOVED***
    ...
    // dialog.
    message SelectItemInfo ***REMOVED***
  ...
  ***REMOVED***
  ...
  message FollowupIntentInfo ***REMOVED***
...
message ListIntentsRequest ***REMOVED***
...
// [Intents.ListIntents][google.cloud.dialogflow.v2beta1.Intents.ListIntents].
message ListIntentsResponse ***REMOVED***
...
message GetIntentRequest ***REMOVED***
...
message CreateIntentRequest ***REMOVED***
...
message UpdateIntentRequest ***REMOVED***
...
message DeleteIntentRequest ***REMOVED***
...
message BatchUpdateIntentsRequest ***REMOVED***
  // Required. The name of the agent to update or create intents in.
  // Format: `projects/<Project ID>/agent`.
  string parent = 1;

  // Required. The source of the intent batch.
  oneof intent_batch ***REMOVED***
...
// The response message for
// [Intents.BatchUpdateIntents][google.cloud.dialogflow.v2beta1.Intents.BatchUpdateIntents].
message BatchUpdateIntentsResponse ***REMOVED***
...
message BatchDeleteIntentsRequest ***REMOVED***
