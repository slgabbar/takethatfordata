...
service Sessions ***REMOVED***
  ...
  rpc DetectIntent(DetectIntentRequest) returns (DetectIntentResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v2beta1/***REMOVED***session=projects/*/agent/sessions/****REMOVED***:detectIntent"
      body: "*"
    ***REMOVED***;
  ***REMOVED***
...
message DetectIntentRequest ***REMOVED***
...
message DetectIntentResponse ***REMOVED***
...
message QueryParameters ***REMOVED***
...
message StreamingDetectIntentRequest ***REMOVED***
...
message StreamingDetectIntentResponse ***REMOVED***
  // The unique identifier of the response. It can be used to
  // locate a response in the training example set or for reporting issues.
  string response_id = 1;
...
message InputAudioConfig ***REMOVED***
...
// language input. For instance, input `<event: ***REMOVED*** name: “welcome_event”,
// parameters: ***REMOVED*** name: “Sam” ***REMOVED*** ***REMOVED***>` can trigger a personalized welcome response.
// The parameter `name` may be used by the agent in the response:
// `“Hello #welcome_event.name! What can I do for you today?”`.
message EventInput ***REMOVED***
