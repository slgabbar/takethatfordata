...
// transition.
message AuditData ***REMOVED***
  // Request data for each BigQuery method.
  oneof request ***REMOVED***
...
// Table insert request.
message TableInsertRequest ***REMOVED***
  // The new table.
  Table resource = 1;
***REMOVED***

// Table update request.
message TableUpdateRequest ***REMOVED***
  // The table to be updated.
  Table resource = 1;
***REMOVED***

// Table insert response.
message TableInsertResponse ***REMOVED***
  // Final state of the inserted table.
  Table resource = 1;
***REMOVED***

// Table update response.
message TableUpdateResponse ***REMOVED***
  // Final state of the updated table.
  Table resource = 1;
***REMOVED***

// Dataset list request.
message DatasetListRequest ***REMOVED***
  // Whether to list all datasets, including hidden ones.
  bool list_all = 1;
***REMOVED***

// Dataset insert request.
message DatasetInsertRequest ***REMOVED***
  // The dataset to be inserted.
  Dataset resource = 1;
***REMOVED***

// Dataset insert response.
message DatasetInsertResponse ***REMOVED***
  // Final state of the inserted dataset.
  Dataset resource = 1;
***REMOVED***

// Dataset update request.
message DatasetUpdateRequest ***REMOVED***
  // The dataset to be updated.
  Dataset resource = 1;
***REMOVED***

// Dataset update response.
message DatasetUpdateResponse ***REMOVED***
  // Final state of the updated dataset.
  Dataset resource = 1;
***REMOVED***

// Job insert request.
message JobInsertRequest ***REMOVED***
  // Job insert request.
  Job resource = 1;
***REMOVED***

// Job insert response.
message JobInsertResponse ***REMOVED***
  // Job insert response.
  Job resource = 1;
***REMOVED***

// Job query request.
message JobQueryRequest ***REMOVED***
  // The query.
  string query = 1;
...
// Job query response.
message JobQueryResponse ***REMOVED***
...
message JobGetQueryResultsRequest ***REMOVED***
...
message JobGetQueryResultsResponse ***REMOVED***
...
message JobQueryDoneResponse ***REMOVED***
...
message JobCompletedEvent ***REMOVED***
  // Name of the event.
  string event_name = 1;
...
// Table data-list request.
message TableDataListRequest ***REMOVED***
  // Starting row offset.
  uint64 start_row = 1;
...
message TableViewDefinition ***REMOVED***
...
// for more details on individual fields.
message JobConfiguration ***REMOVED***
...
message TableDefinition ***REMOVED***
