...
message AuditLog ***REMOVED***
  ...
  // one AuthorizationInfo element for each ***REMOVED***resource, permission***REMOVED*** tuple.
...
message AuthenticationInfo ***REMOVED***
  // The email address of the authenticated user making the request.
  string principal_email = 1;
***REMOVED***

// Authorization information for the operation.
message AuthorizationInfo ***REMOVED***
