...
service CloudSupport ***REMOVED***
  ...
  rpc GetSupportAccount(GetSupportAccountRequest) returns (google.cloud.support.common.SupportAccount) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha1/***REMOVED***name=supportAccounts/****REMOVED***" ***REMOVED***;
  ***REMOVED***

  // Retrieves the list of accounts the current authenticated user has access
  // to.
  rpc ListSupportAccounts(ListSupportAccountsRequest) returns (ListSupportAccountsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha1/supportAccounts" ***REMOVED***;
  ***REMOVED***
  ...
  rpc GetCase(GetCaseRequest) returns (google.cloud.support.common.Case) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha1/***REMOVED***name=supportAccounts/*/cases/****REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  rpc ListCases(ListCasesRequest) returns (ListCasesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha1/***REMOVED***name=supportAccounts/****REMOVED***/cases" ***REMOVED***;
  ***REMOVED***

  // Lists all comments from a case.
  rpc ListComments(ListCommentsRequest) returns (ListCommentsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha1/***REMOVED***name=supportAccounts/*/cases/****REMOVED***/comments" ***REMOVED***;
  ***REMOVED***
  ...
  rpc CreateCase(CreateCaseRequest) returns (google.cloud.support.common.Case) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1alpha1/***REMOVED***parent=supportAccounts/****REMOVED***/cases" body: "case" ***REMOVED***;
  ***REMOVED***

  // Updates a support case. Only a small set of details (priority, subject and
  // cc_address) can be update after a case is created.
  rpc UpdateCase(UpdateCaseRequest) returns (google.cloud.support.common.Case) ***REMOVED***
    option (google.api.http) = ***REMOVED*** patch: "/v1alpha1/***REMOVED***case.name=supportAccounts/*/cases/****REMOVED***" body: "case" ***REMOVED***;
  ***REMOVED***

  // Adds a new comment to a case.
  rpc CreateComment(CreateCommentRequest) returns (google.cloud.support.common.Comment) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1alpha1/***REMOVED***name=supportAccounts/*/cases/****REMOVED***/comments" body: "comment" ***REMOVED***;
  ***REMOVED***

  // Retrieves the taxonomy of product categories and components to be used
  // while creating a support case.
  rpc GetIssueTaxonomy(GetIssueTaxonomyRequest) returns (google.cloud.support.common.IssueTaxonomy) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1alpha1:getIssueTaxonomy" ***REMOVED***;
  ***REMOVED***
***REMOVED***

// The request message for `GetSupportAccount`.
message GetSupportAccountRequest ***REMOVED***
...
message ListSupportAccountsRequest ***REMOVED***
...
message ListSupportAccountsResponse ***REMOVED***
...
message GetCaseRequest ***REMOVED***
...
message ListCasesRequest ***REMOVED***
...
message ListCasesResponse ***REMOVED***
  // A list of cases.
...
message UpdateCaseRequest ***REMOVED***
...
message CreateCommentRequest ***REMOVED***
...
message GetIssueTaxonomyRequest ***REMOVED***
***REMOVED***
