...
message SupportAccount ***REMOVED***
  ...
  ***REMOVED***
  ...
  // `supportAccounts/***REMOVED***account_id***REMOVED***`.
  // Output only.
  string name = 1;
...
message Case ***REMOVED***
  ...
  ***REMOVED***
  ...
  // `supportAccounts/***REMOVED***account_id***REMOVED***/cases/***REMOVED***case_id***REMOVED***`
  string name = 1;
...
message CustomerIssue ***REMOVED***
  // The status of a customer issue.
  enum IssueState ***REMOVED***
...
message Comment ***REMOVED***
  ...
  // `supportAccounts/***REMOVED***account_id***REMOVED***/cases/***REMOVED***case_id***REMOVED***/***REMOVED***comment_id***REMOVED***`.
  // Output only.
  string name = 4;
***REMOVED***
