...
service Speech ***REMOVED***
  ...
  rpc SyncRecognize(SyncRecognizeRequest) returns (SyncRecognizeResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta1/speech:syncrecognize" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  rpc AsyncRecognize(AsyncRecognizeRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1beta1/speech:asyncrecognize" body: "*" ***REMOVED***;
  ***REMOVED***
...
message SyncRecognizeRequest ***REMOVED***
...
message AsyncRecognizeRequest ***REMOVED***
  // *Required* Provides information to the recognizer that specifies how to
  // process the request.
  RecognitionConfig config = 1;
...
// messages.
message SyncRecognizeResponse ***REMOVED***
...
message AsyncRecognizeResponse ***REMOVED***
  // *Output-only* Sequential list of transcription results corresponding to
  // sequential portions of audio.
  repeated SpeechRecognitionResult results = 2;
***REMOVED***
...
// `GetOperation` call of the `google::longrunning::Operations` service.
message AsyncRecognizeMetadata ***REMOVED***
...
//
// 2. results ***REMOVED*** alternatives ***REMOVED*** transcript: "tube" ***REMOVED*** stability: 0.01 ***REMOVED***
//    result_index: 0
//
// 3. results ***REMOVED*** alternatives ***REMOVED*** transcript: "to be a" ***REMOVED*** stability: 0.01 ***REMOVED***
//    result_index: 0
//
// 4. results ***REMOVED*** alternatives ***REMOVED*** transcript: "to be" ***REMOVED*** stability: 0.9 ***REMOVED***
//    results ***REMOVED*** alternatives ***REMOVED*** transcript: " or not to be" ***REMOVED*** stability: 0.01 ***REMOVED***
//    result_index: 0
//
// 5. results ***REMOVED*** alternatives ***REMOVED*** transcript: "to be or not to be"
//                             confidence: 0.92 ***REMOVED***
//              alternatives ***REMOVED*** transcript: "to bee or not to bee" ***REMOVED***
//              is_final: true ***REMOVED***
//    result_index: 0
//
// 6. results ***REMOVED*** alternatives ***REMOVED*** transcript: " that's" ***REMOVED*** stability: 0.01 ***REMOVED***
//    result_index: 1
//
// 7. results ***REMOVED*** alternatives ***REMOVED*** transcript: " that is" ***REMOVED*** stability: 0.9 ***REMOVED***
...
//
// 9. results ***REMOVED*** alternatives ***REMOVED*** transcript: " that is the question"
