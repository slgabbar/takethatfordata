...
message ColumnRange ***REMOVED***
  // The name of the column family within which this range falls.
  string family_name = 1;

  // The column qualifier at which to start the range (within `column_family`).
  // If neither field is set, interpreted as the empty string, inclusive.
  oneof start_qualifier ***REMOVED***
    // Used when giving an inclusive lower bound for the range.
...
message TimestampRange ***REMOVED***
...
message ValueRange ***REMOVED***
  // The value at which to start the range.
  // If neither field is set, interpreted as the empty string, inclusive.
  oneof start_value ***REMOVED***
    // Used when giving an inclusive lower bound for the range.
...
message Mutation ***REMOVED***
  ...
  ***REMOVED***
  ...
  message DeleteFromColumn ***REMOVED***
  ...
  ***REMOVED***
  ...
  message DeleteFromFamily ***REMOVED***
    // The name of the family from which cells should be deleted.
    // Must match `[-_.a-zA-Z0-9]+`
    string family_name = 1;
  ***REMOVED***
  ...
  message DeleteFromRow ***REMOVED***

  ***REMOVED***

  // Which of the possible Mutation types to apply.
  oneof mutation ***REMOVED***
    // Set a cell's value.
    SetCell set_cell = 1;
...
// specified column.
message ReadModifyWriteRule ***REMOVED***
