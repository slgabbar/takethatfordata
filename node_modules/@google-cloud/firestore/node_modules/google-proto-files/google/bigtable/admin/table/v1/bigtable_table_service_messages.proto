...
message CreateTableRequest ***REMOVED***
  ...
  //  * Key assignment:
  //    - Tablet 1 [, apple)                => ***REMOVED***"a"***REMOVED***.
  //    - Tablet 2 [apple, customer_1)      => ***REMOVED***"apple", "custom"***REMOVED***.
  //    - Tablet 3 [customer_1, customer_2) => ***REMOVED***"customer_1"***REMOVED***.
  //    - Tablet 4 [customer_2, other)      => ***REMOVED***"customer_2"***REMOVED***.
  //    - Tablet 5 [other, )                => ***REMOVED***"other", "zz"***REMOVED***.
  repeated string initial_split_keys = 4;
***REMOVED***

message ListTablesRequest ***REMOVED***
  // The unique name of the cluster for which tables should be listed.
  string name = 1;
***REMOVED***

message ListTablesResponse ***REMOVED***
  // The tables present in the requested cluster.
  // At present, only the names of the tables are populated.
  repeated Table tables = 1;
***REMOVED***

message GetTableRequest ***REMOVED***
  // The unique name of the requested table.
  string name = 1;
***REMOVED***

message DeleteTableRequest ***REMOVED***
  // The unique name of the table to be deleted.
  string name = 1;
***REMOVED***

message RenameTableRequest ***REMOVED***
...
message CreateColumnFamilyRequest ***REMOVED***
...
message DeleteColumnFamilyRequest ***REMOVED***
  // The unique name of the column family to be deleted.
  string name = 1;
***REMOVED***

message BulkDeleteRowsRequest ***REMOVED***
