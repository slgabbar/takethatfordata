...
message Table ***REMOVED***
  enum TimestampGranularity ***REMOVED***
    MILLIS = 0;
  ***REMOVED***
...
message ColumnFamily ***REMOVED***
  ...
  //   PROP = "version() >", NUM32
  //        | "age() >", NUM64, [ UNIT ] ;
  //   NUM32 = non-zero-digit ***REMOVED*** digit ***REMOVED*** ;    (* # NUM32 <= 2^32 - 1 *)
  //   NUM64 = non-zero-digit ***REMOVED*** digit ***REMOVED*** ;    (* # NUM64 <= 2^63 - 1 *)
...
message GcRule ***REMOVED***
  // A GcRule which deletes cells matching all of the given rules.
  message Intersection ***REMOVED***
    // Only delete cells which would be deleted by every element of `rules`.
    repeated GcRule rules = 1;
  ***REMOVED***

  // A GcRule which deletes cells matching any of the given rules.
  message Union ***REMOVED***
