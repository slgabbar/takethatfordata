...
service BigtableClusterService ***REMOVED***
  // Lists the supported zones for the given project.
  rpc ListZones(ListZonesRequest) returns (ListZonesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/***REMOVED***name=projects/****REMOVED***/zones" ***REMOVED***;
  ***REMOVED***

  // Gets information about a particular cluster.
  rpc GetCluster(GetClusterRequest) returns (Cluster) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/***REMOVED***name=projects/*/zones/*/clusters/****REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  rpc ListClusters(ListClustersRequest) returns (ListClustersResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED*** get: "/v1/***REMOVED***name=projects/****REMOVED***/aggregated/clusters" ***REMOVED***;
  ***REMOVED***
  ...
  rpc CreateCluster(CreateClusterRequest) returns (Cluster) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/***REMOVED***name=projects/*/zones/****REMOVED***/clusters" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  // [Cluster][google.bigtable.admin.cluster.v1.Cluster], if successful.
  rpc UpdateCluster(Cluster) returns (Cluster) ***REMOVED***
    option (google.api.http) = ***REMOVED*** put: "/v1/***REMOVED***name=projects/*/zones/*/clusters/****REMOVED***" body: "*" ***REMOVED***;
  ***REMOVED***
  ...
  rpc DeleteCluster(DeleteClusterRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED*** delete: "/v1/***REMOVED***name=projects/*/zones/*/clusters/****REMOVED***" ***REMOVED***;
  ***REMOVED***
  ...
  // [Cluster][google.bigtable.admin.cluster.v1.Cluster], if successful.
  rpc UndeleteCluster(UndeleteClusterRequest) returns (google.longrunning.Operation) ***REMOVED***
    option (google.api.http) = ***REMOVED*** post: "/v1/***REMOVED***name=projects/*/zones/*/clusters/****REMOVED***:undelete" body: "" ***REMOVED***;
  ***REMOVED***
***REMOVED***
