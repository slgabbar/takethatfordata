...
declare namespace FirebaseFirestore ***REMOVED***
  /**
  ...
  export class Firestore ***REMOVED***
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/firestore/***REMOVED***
     */
  ...
  ***REMOVED***
   ...
   */
  export interface Precondition ***REMOVED***
    /**
  ...
  ***REMOVED***
   ...
   * `updates()`, and `creates()`.
   */
  export class WriteResult ***REMOVED***
    private constructor();
...
declare module '@google-cloud/firestore' ***REMOVED***
