 ...
 *
 * @private
 * @param ***REMOVED***function***REMOVED*** handler A handler than matches the API of `setTimeout()`.
 */
function setTimeoutHandler(handler) ***REMOVED***
...
class ExponentialBackoff ***REMOVED***
  /**
   * @param ***REMOVED***number=***REMOVED*** options.initialDelayMs Optional override for the initial
   * retry delay.
   * @param ***REMOVED***number=***REMOVED*** options.backoffFactor Optional override for the
   * exponential backoff factor.
   * @param ***REMOVED***number=***REMOVED*** options.maxDelayMs Optional override for the maximum
   * retry delay.
   * @param ***REMOVED***number=***REMOVED*** options.jitterFactor Optional override to control the
  ...
  ***REMOVED***
   ...
   *
   * @private
   * @return ***REMOVED***Promise.<void>***REMOVED*** A Promise that resolves when the current delay
   * elapsed.
   */
  backoffAndWait() ***REMOVED***
    // First schedule using the current base (which may be 0 and should be
    // honored as such).
    const delayWithJitterMs = this._currentBaseMs + this._jitterDelayMs();
    if (this._currentBaseMs > 0) ***REMOVED***
      Firestore.log(
        'ExponentialBackoff.backoffAndWait',
        `Backing off for $***REMOVED***delayWithJitterMs***REMOVED*** ms ` +
          `(base delay: $***REMOVED***this._currentBaseMs***REMOVED*** ms)`
      );
    ***REMOVED***
    ...
    if (this._currentBaseMs < this._initialDelayMs) ***REMOVED***
      this._currentBaseMs = this._initialDelayMs;
    ***REMOVED***
    if (this._currentBaseMs > this._maxDelayMs) ***REMOVED***
      this._currentBaseMs = this._maxDelayMs;
    ***REMOVED***
  ...
  ***REMOVED***
   ...
   *
   * @private
   * @returns ***REMOVED***number***REMOVED*** The jitter to apply based on the current delay.
   */
  _jitterDelayMs() ***REMOVED***
