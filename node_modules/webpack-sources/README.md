...
``` js
Source.prototype.sourceAndMap(options: Object) -> ***REMOVED***
	code: String,
	map: Object
***REMOVED***
```
...
OriginalSource tries to create column mappings if requested, by splitting the source code at typical statement borders (`;`, `***REMOVED***`, `***REMOVED***`).
