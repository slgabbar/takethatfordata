...
* `returns` *****REMOVED***String***REMOVED*****: String with placeholders.  
...
* `str` *****REMOVED***String***REMOVED*****: String with placeholders    
* `returns` *****REMOVED***String***REMOVED***** `str`: String with original tokens.  
