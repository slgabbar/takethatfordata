...
getter(obj, 'bar.baz', function() ***REMOVED***
  return 'qux';
***REMOVED***);
...
getter(obj, ['beep', 'boop'], function() ***REMOVED***
  return 'bop';
***REMOVED***);
...
* `obj` *****REMOVED***Object***REMOVED*****: Object to add property to.
* `prop` *****REMOVED***String|Array***REMOVED*****: Property string or array to add.
* `getter` *****REMOVED***Function***REMOVED*****: Getter function to add as a property.
