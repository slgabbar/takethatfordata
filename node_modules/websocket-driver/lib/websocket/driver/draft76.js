...
var numberFromKey = function(key) ***REMOVED***
  return parseInt(key.match(/[0-9]/g).join(''), 10);
***REMOVED***;

var spacesInKey = function(key) ***REMOVED***
  return key.match(/ /g).length;
***REMOVED***;


var Draft76 = function(request, url, options) ***REMOVED***
...
var instance = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  _handshakeResponse: function() ***REMOVED***
    ...
    if (number1 % spaces1 !== 0 || number2 % spaces2 !== 0) ***REMOVED***
  ...
  ***REMOVED***,
  ...
  _handshakeSignature: function() ***REMOVED***
  ...
  ***REMOVED***,
  ...
  _sendHandshakeBody: function() ***REMOVED***
