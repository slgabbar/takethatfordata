...
server.on('upgrade', function(request, socket, body) ***REMOVED***
  ...
  driver.messages.on('data', function(message) ***REMOVED***
...
var server = net.createServer(function(connection) ***REMOVED***
  var driver = websocket.server();

  driver.on('connect', function() ***REMOVED***
    if (websocket.isWebSocket(driver)) ***REMOVED***
      driver.start();
  ...
  ***REMOVED***);
  ...
  driver.on('close', function() ***REMOVED*** connection.end() ***REMOVED***);
  connection.on('error', function() ***REMOVED******REMOVED***);
...
tcp.on('connect', function() ***REMOVED***
  driver.start();
***REMOVED***);
...
tcp.pipe(proxy).pipe(tcp, ***REMOVED***end: false***REMOVED***);

tcp.on('connect', function() ***REMOVED***
  proxy.start();
***REMOVED***);

proxy.on('connect', function() ***REMOVED***
...
```js
proxy.on('error', function(error) ***REMOVED***
...
#### `driver.on('open', function(event) ***REMOVED******REMOVED***)`

Adds a callback to execute when the socket becomes open.

#### `driver.on('message', function(event) ***REMOVED******REMOVED***)`
...
#### `driver.on('pong', function(event) ***REMOVED******REMOVED***)`
...
`driver.ping(message, function() ***REMOVED*** ... ***REMOVED***)` callback.
...
#### `driver.ping(string = '', function() ***REMOVED******REMOVED***)`
