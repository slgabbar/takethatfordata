...
var arePropertyDescriptorsSupported = function () ***REMOVED***
	...
	try ***REMOVED***
		Object.defineProperty(obj, 'x', ***REMOVED*** value: obj ***REMOVED***);
		return obj.x === obj;
...
test('defineProperties', function (dt) ***REMOVED***

	dt.test('with descriptor support', ***REMOVED*** skip: !descriptorsSupported ***REMOVED***, function (t) ***REMOVED***
		var getDescriptor = function (value) ***REMOVED***
			return ***REMOVED***
				configurable: true,
				enumerable: false,
				value: value,
		...
		***REMOVED***, 'existing properties were not overridden');
		...
		define(obj, ***REMOVED***
			...
			c: 4
		***REMOVED***, ***REMOVED***
			a: function () ***REMOVED*** return true; ***REMOVED***,
			b: function () ***REMOVED*** return false; ***REMOVED***
		***REMOVED***);
		t.deepEqual(obj, ***REMOVED***
			b: 2,
			c: 3
	...
	***REMOVED***);
	...
	dt.test('without descriptor support', ***REMOVED*** skip: descriptorsSupported ***REMOVED***, function (t) ***REMOVED***
		var obj = ***REMOVED***
			a: 1,
			b: 2,
			c: 3
...
test('symbols', ***REMOVED*** skip: !hasSymbols ***REMOVED***, function (t) ***REMOVED***
	...
	var properties = ***REMOVED*** a: aValue ***REMOVED***;
