...
```
 ...
 - `start`: *****REMOVED***String|Number***REMOVED***** the number or letter to start with
 - `end`: *****REMOVED***String|Number***REMOVED***** the number or letter to end with
 - `step`: *****REMOVED***String|Number***REMOVED***** optionally pass the step to use. works for letters or numbers.
 ...
 - `fn`: *****REMOVED***Function***REMOVED***** optionally [pass a function](#custom-function) to modify each character 
...
```js
range('a', 'e', function (val, isNumber, pad, i) ***REMOVED***
  if (!isNumber) ***REMOVED***
