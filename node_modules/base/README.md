...
* `config` *****REMOVED***Object***REMOVED*****: If supplied, this object is passed to [cache-base](https://github.com/jonschlinkert/cache-base) to merge onto the the instance upon instantiation.
* `options` *****REMOVED***Object***REMOVED*****: If supplied, this object is used to initialize the `base.options` object.

**Example**

```js
// initialize with `config` and `options`
var app = new Base(***REMOVED***isApp: true***REMOVED***, ***REMOVED***abc: true***REMOVED***);
app.set('foo', 'bar');
...
* `name` *****REMOVED***String***REMOVED*****: The plugin name.
* `register` *****REMOVED***Boolean***REMOVED*****: If the plugin if not already registered, to record it as being registered pass `true` as the second argument.
* `returns` *****REMOVED***Boolean***REMOVED*****: Returns true if a plugin is already registered.
...
* `fn` *****REMOVED***Function***REMOVED*****: plugin function to call
* `returns` *****REMOVED***Object***REMOVED*****: Returns the item instance for chaining.
...
* `key` *****REMOVED***String***REMOVED*****: The name of the property to define.
* `value` *****REMOVED***any***REMOVED*****
* `returns` *****REMOVED***Object***REMOVED*****: Returns the instance for chaining.

**Example**

```js
// arbitrary `render` function using lodash `template`
app.define('render', function(str, locals) ***REMOVED***
...
* `returns` *****REMOVED***Object***REMOVED*****: Returns the `base` instance for chaining.

**Example**

```js
app.mixin('foo', function() ***REMOVED***
  // do stuff
***REMOVED***);
```
...
* `fn` *****REMOVED***Function***REMOVED*****: Plugin function to use on each instance.
* `returns` *****REMOVED***Object***REMOVED*****: Returns the `Base` constructor for chaining
...
* `Ctor` *****REMOVED***Function***REMOVED*****: constructor to extend
* `methods` *****REMOVED***Object***REMOVED*****: Optional prototype properties to mix in.
* `returns` *****REMOVED***Object***REMOVED*****: Returns the `Base` constructor for chaining
...
* `fn` *****REMOVED***Function***REMOVED*****: Function to call
* `returns` *****REMOVED***Object***REMOVED*****: Returns the `Base` constructor for chaining

**Example**

```js
Base.mixin(function(proto) ***REMOVED***
  proto.foo = function(msg) ***REMOVED***
    return 'foo ' + msg;
  ***REMOVED***;
***REMOVED***);
```
...
* `Child` *****REMOVED***Function***REMOVED*****: Constructor function of a child class
* `returns` *****REMOVED***Object***REMOVED*****: Returns the `Base` constructor for chaining
...
* `Receiver` *****REMOVED***Function***REMOVED*****: Receiving (child) constructor
* `Provider` *****REMOVED***Function***REMOVED*****: Providing (parent) constructor
* `returns` *****REMOVED***Object***REMOVED*****: Returns the `Base` constructor for chaining
