...
* `list` *****REMOVED***String|Array***REMOVED*****: List of strings to perform matches against. This is often a list of file paths.
* `patterns` *****REMOVED***String|Array***REMOVED*****: One or more [glob paterns](#features) to use for matching.
* `options` *****REMOVED***Object***REMOVED*****: Any [supported options](#options) may be passed
...
nm(['a/b.js', 'a/c.md'], '*.js', ***REMOVED***matchBase: true***REMOVED***);
//=> ['a/b.js']
```
...
console.log(nm(files, '[a-c]*', ***REMOVED***bash: false***REMOVED***));
```
...
nm.match(['a/b/c', 'a/b/c'], '**', ***REMOVED***nodupes: false***REMOVED***);
//=> ['a/b/c', 'a/b/c']
```
...
nm(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**', ***REMOVED***noglobstar: true***REMOVED***);
//=> ['a/b']
```
...
var res = nm.create('abc/*.js', ***REMOVED***sourcemap: true***REMOVED***);
console.log(res.map);
// ***REMOVED*** version: 3,
//   sources: [ 'string' ],
//   names: [],
...
var res = nm.compile(ast, ***REMOVED***sourcemap: true***REMOVED***);
console.log(res.map);
// ***REMOVED*** version: 3,
//   sources: [ 'string' ],
//   names: [],
...
nm.match(['abc', 'a\\*c'], 'a\\*c', ***REMOVED***unescape: true***REMOVED***);
//=> ['a*c']
```
...
nm.match(['a\\b\\c'], ***REMOVED***unixify: false***REMOVED***);
//=> ['a\\b\\c']
```
...
* [brace expansion](https://github.com/jonschlinkert/braces) (e.g. `***REMOVED***a,b,c***REMOVED***`)
...
| [braces](https://github.com/jonschlinkert/braces) | Braces | `***REMOVED***a,b,c***REMOVED***` | [Brace expansion](https://www.gnu.org/software/bash/manual/html_node/Brace-Expansion.html) |
