...
updateNotifier(***REMOVED***pkg***REMOVED***).notify();
```
...
const notifier = updateNotifier(***REMOVED***pkg***REMOVED***);
...
```js
const notifier = updateNotifier(***REMOVED***
	pkg,
	updateCheckInterval: 1000 * 60 * 60 * 24 * 7 // 1 week
***REMOVED***);

if (notifier.update) ***REMOVED***
	console.log(`Update available: $***REMOVED***notifier.update.latest***REMOVED***`);
***REMOVED***
```
...
Type: `Object`<br>
Default: `***REMOVED***padding: 1, margin: 1, align: 'center', borderColor: 'yellow', borderStyle: 'round'***REMOVED***` *(See screenshot)*
