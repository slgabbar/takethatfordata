...
var deflate = ***REMOVED***
  outgoing: function(message, callback) ***REMOVED***
    zlib.deflateRaw(message.data, function(error, result) ***REMOVED***
      message.rsv1 = true;
      message.data = result;
  ...
  ***REMOVED***,
  ...
  incoming: function(message, callback) ***REMOVED***
...
deflate.outgoing(***REMOVED***data: large***REMOVED***, function() ***REMOVED***
  console.log(1, 'large');
***REMOVED***);

deflate.outgoing(***REMOVED***data: small***REMOVED***, function() ***REMOVED***
  console.log(2, 'small');
***REMOVED***);
...
var stream  = require('stream'),
    session = new stream.Transform(***REMOVED***objectMode: true***REMOVED***);

session._transform = function(message, _, callback) ***REMOVED***
  var self = this;
  deflate.outgoing(message, function(error, result) ***REMOVED***
    self.push(result);
    callback();
  ***REMOVED***);
***REMOVED***;
...
functor.call(***REMOVED***data: large***REMOVED***, function() ***REMOVED***
  console.log(1, 'large');
***REMOVED***);

functor.call(***REMOVED***data: small***REMOVED***, function() ***REMOVED***
  console.log(2, 'small');
***REMOVED***);
