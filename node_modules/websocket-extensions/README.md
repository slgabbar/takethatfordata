...
```js
exts.processIncomingMessage(message, function(error, msg) ***REMOVED***
...
```js
exts.processOutgoingMessage(message, function(error, msg) ***REMOVED***
...
```js
exts.close(function() ***REMOVED******REMOVED***)
```
...
ext.createServerSession([
  ***REMOVED***server_no_context_takeover: true, server_max_window_bits: 8***REMOVED***,
  ***REMOVED***server_max_window_bits: 15***REMOVED***
]);
```
...
// e.g.  -> ***REMOVED***server_max_window_bits: 8***REMOVED***
```
...
```js
session.processIncomingMessage(message, function(error, msg) ***REMOVED*** ... ***REMOVED***)
```
...
```js
session.processOutgoingMessage(message, function(error, msg) ***REMOVED*** ... ***REMOVED***)
```
