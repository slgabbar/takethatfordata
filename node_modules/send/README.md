...
var server = http.createServer(function onRequest (req, res) ***REMOVED***
  send(req, parseUrl(req).pathname, ***REMOVED***index: false, root: '/www/example.com/public'***REMOVED***)
...
function directory (res, path) ***REMOVED***
  var stream = this

  // redirect to trailing slash for consistent url
  if (!stream.hasTrailingSlash()) ***REMOVED***
    return stream.redirect(path)
  ***REMOVED***

  // get directory list
  fs.readdir(path, function onReaddir (err, list) ***REMOVED***
...
var server = http.createServer(function onRequest (req, res) ***REMOVED***
  ...
  ***REMOVED***
  ...
  // your custom headers
  function headers (res, path, stat) ***REMOVED***
  ...
  ***REMOVED***
  ...
  send(req, parseUrl(req).pathname, ***REMOVED***root: '/www/example.com/public'***REMOVED***)
  .on('error', error)
