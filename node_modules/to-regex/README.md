...
console.log(toRegex('foo', ***REMOVED***negate: true***REMOVED***));
//=> /^(?:(?:(?!^(?:foo)$).)*)$/

console.log(toRegex('foo', ***REMOVED***contains: true***REMOVED***));
//=> /(?:foo)/

console.log(toRegex(['foo', 'bar'], ***REMOVED***negate: true***REMOVED***));
//=> /^(?:(?:(?!^(?:(?:foo)|(?:bar))$).)*)$/

console.log(toRegex(['foo', 'bar'], ***REMOVED***negate: true, contains: true***REMOVED***));
//=> /^(?:(?:(?!(?:(?:foo)|(?:bar))).)*)$/
```
...
```js
var toRegex = require('to-regex');
console.log(toRegex('foo', ***REMOVED***nocase: true***REMOVED***));
//=> /^(?:foo)$/i
```
...
```js
var toRegex = require('to-regex');
console.log(toRegex('foo', ***REMOVED***flags: 'gm'***REMOVED***));
//=> /^(?:foo)$/gm
console.log(toRegex('foo', ***REMOVED***flags: 'gmi', nocase: true***REMOVED***)); //<= handles redundancy
//=> /^(?:foo)$/gmi
```
...
```js
toRegex('foo', ***REMOVED***cache: false***REMOVED***);
```
