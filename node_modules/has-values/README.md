...
hasValue(***REMOVED***a: 'a'***REMOVED******REMOVED***);
//=> true

hasValue(***REMOVED******REMOVED***);
hasValue(***REMOVED***foo: undefined***REMOVED***);
//=> false

hasValue(***REMOVED***foo: null***REMOVED***);
//=> true
...
```js
function isEmpty(o, isZero) ***REMOVED***
