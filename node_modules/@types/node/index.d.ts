...
interface MapConstructor ***REMOVED*** ***REMOVED***
interface WeakMapConstructor ***REMOVED*** ***REMOVED***
interface SetConstructor ***REMOVED*** ***REMOVED***
interface WeakSetConstructor ***REMOVED*** ***REMOVED***

// Forward-declare needed types from lib.es2015.d.ts (in case users are using `--lib es5`)
interface Iterable<T> ***REMOVED*** ***REMOVED***
interface Iterator<T> ***REMOVED***
    next(value?: any): IteratorResult<T>;
***REMOVED***
interface IteratorResult<T> ***REMOVED*** ***REMOVED***
interface SymbolConstructor ***REMOVED***
    readonly iterator: symbol;
***REMOVED***
declare var Symbol: SymbolConstructor;

// Node.js ESNEXT support
interface String ***REMOVED***
...
declare namespace setTimeout ***REMOVED***
...
declare namespace setImmediate ***REMOVED***
...
interface NodeRequireFunction ***REMOVED***
/* tslint:disable-next-line:callable-types */
    (id: string): any;
***REMOVED***

interface NodeRequire extends NodeRequireFunction ***REMOVED***
...
interface NodeExtensions ***REMOVED***
...
declare var SlowBuffer: ***REMOVED***
...
interface Buffer extends NodeBuffer ***REMOVED*** ***REMOVED***
 ...
 */
declare var Buffer: ***REMOVED***
    /**
     * Allocates a new buffer containing the given ***REMOVED***str***REMOVED***.
     *
    ...
    new(str: string, encoding?: string): Buffer;
    /**
     * Allocates a new buffer of ***REMOVED***size***REMOVED*** octets.
     *
     * @param size count of octets to allocate.
     */
    new(size: number): Buffer;
    /**
     * Allocates a new buffer containing the given ***REMOVED***array***REMOVED*** of octets.
     *
     ...
     * the given ***REMOVED***ArrayBuffer***REMOVED***.
     *
     *
    ...
    new(array: any[]): Buffer;
    /**
     * Copies the passed ***REMOVED***buffer***REMOVED*** data onto a new ***REMOVED***Buffer***REMOVED*** instance.
     *
    ...
    prototype: Buffer;
    /**
     * Allocates a new Buffer using an ***REMOVED***array***REMOVED*** of octets.
     */
    from(array: any[]): Buffer;
    /**
     * When passed a reference to the .buffer property of a TypedArray instance,
     * the newly created Buffer will share the same allocated memory as the TypedArray.
     * The optional ***REMOVED***byteOffset***REMOVED*** and ***REMOVED***length***REMOVED*** arguments specify a memory range
     * within the ***REMOVED***arrayBuffer***REMOVED*** that will be shared by the Buffer.
     *
     * @param arrayBuffer The .buffer property of a TypedArray or a new ArrayBuffer()
     */
    from(arrayBuffer: ArrayBuffer, byteOffset?: number, length?: number): Buffer;
    /**
     * Copies the passed ***REMOVED***buffer***REMOVED*** data onto a new Buffer instance.
     */
    from(buffer: Buffer): Buffer;
    /**
     * Creates a new Buffer containing the given JavaScript string ***REMOVED***str***REMOVED***.
     * If provided, the ***REMOVED***encoding***REMOVED*** parameter identifies the character encoding.
     * If not provided, ***REMOVED***encoding***REMOVED*** defaults to 'utf8'.
     */
    from(str: string, encoding?: string): Buffer;
    /**
     * Returns true if ***REMOVED***obj***REMOVED*** is a Buffer
     *
     * @param obj object to test.
     */
    isBuffer(obj: any): obj is Buffer;
    /**
     * Returns true if ***REMOVED***encoding***REMOVED*** is a valid encoding argument.
    ...
    /**
     * Allocates a new buffer of ***REMOVED***size***REMOVED*** octets, leaving memory not initialized, so the contents
    ...
    /**
     * Allocates a new non-pooled buffer of ***REMOVED***size***REMOVED*** octets, leaving memory not initialized, so the contents
     * of the newly created Buffer are unknown and may contain sensitive data.
     *
     * @param size count of octets to allocate
     */
...
declare namespace NodeJS ***REMOVED***
    export interface InspectOptions ***REMOVED***
        showHidden?: boolean;
        depth?: number | null;
        colors?: boolean;
    ...
    ***REMOVED***
    ...
    export interface ConsoleConstructor ***REMOVED***
        prototype: Console;
        new(stdout: WritableStream, stderr?: WritableStream): Console;
    ***REMOVED***

    export interface CallSite ***REMOVED***
        /**
         * Value of "this"
         */
        getThis(): any;
    ...
    ***REMOVED***
    ...
    export interface ErrnoException extends Error ***REMOVED***
        errno?: number;
        code?: string;
        path?: string;
        syscall?: string;
    ...
    ***REMOVED***
    ...
    export interface ReadableStream extends EventEmitter ***REMOVED***
        readable: boolean;
        ...
        resume(): this;
        isPaused(): boolean;
        pipe<T extends WritableStream>(destination: T, options?: ***REMOVED*** end?: boolean; ***REMOVED***): T;
    ...
    ***REMOVED***
    ...
    export interface WritableStream extends EventEmitter ***REMOVED***
        writable: boolean;
    ...
    ***REMOVED***
    ...
    export interface ReadWriteStream extends ReadableStream, WritableStream ***REMOVED*** ***REMOVED***

    export interface Events extends EventEmitter ***REMOVED*** ***REMOVED***

    export interface Domain extends Events ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface MemoryUsage ***REMOVED***
        rss: number;
        heapTotal: number;
        heapUsed: number;
    ***REMOVED***

    export interface CpuUsage ***REMOVED***
        user: number;
        system: number;
    ***REMOVED***

    export interface ProcessVersions ***REMOVED***
        http_parser: string;
        node: string;
        v8: string;
        ares: string;
    ...
    ***REMOVED***
    ...
    export interface Socket extends ReadWriteStream ***REMOVED***
        isTTY?: true;
    ***REMOVED***

    export interface ProcessEnv ***REMOVED***
        [key: string]: string | undefined;
    ***REMOVED***

    export interface WriteStream extends Socket ***REMOVED***
        columns?: number;
        rows?: number;
    ...
    ***REMOVED***
    export interface ReadStream extends Socket ***REMOVED***
        isRaw?: boolean;
    ...
    ***REMOVED***
    ...
    export interface Process extends EventEmitter ***REMOVED***
        stdout: WriteStream;
        stderr: WriteStream;
        stdin: ReadStream;
        openStdin(): Socket;
    ...
    ***REMOVED***
    ...
    export interface Global ***REMOVED***
        Array: typeof Array;
    ...
    ***REMOVED***
    ...
    export interface Timer ***REMOVED***
        ref(): void;
        unref(): void;
    ***REMOVED***

    class Module ***REMOVED***
        static runMain(): void;
...
interface IterableIterator<T> ***REMOVED*** ***REMOVED***

/**
 * @deprecated
 */
interface NodeBuffer extends Uint8Array ***REMOVED***
    write(string: string, offset?: number, length?: number, encoding?: string): number;
    toString(encoding?: string, start?: number, end?: number): string;
    toJSON(): ***REMOVED*** type: 'Buffer', data: any[] ***REMOVED***;
...
*                                               *
************************************************/
declare module "buffer" ***REMOVED***
    export var INSPECT_MAX_BYTES: number;
    var BuffType: typeof Buffer;
    var SlowBuffType: typeof SlowBuffer;
    export ***REMOVED*** BuffType as Buffer, SlowBuffType as SlowBuffer ***REMOVED***;
***REMOVED***

declare module "querystring" ***REMOVED***
    export interface StringifyOptions ***REMOVED***
        encodeURIComponent?: Function;
    ***REMOVED***

    export interface ParseOptions ***REMOVED***
        maxKeys?: number;
        decodeURIComponent?: Function;
    ***REMOVED***

    interface ParsedUrlQuery ***REMOVED*** [key: string]: string | string[]; ***REMOVED***

    export function stringify<T>(obj: T, sep?: string, eq?: string, options?: StringifyOptions): string;
    export function parse(str: string, sep?: string, eq?: string, options?: ParseOptions): ParsedUrlQuery;
    export function parse<T extends ***REMOVED******REMOVED***>(str: string, sep?: string, eq?: string, options?: ParseOptions): T;
    export function escape(str: string): string;
    export function unescape(str: string): string;
***REMOVED***

declare module "events" ***REMOVED***
    class internal extends NodeJS.EventEmitter ***REMOVED*** ***REMOVED***

    namespace internal ***REMOVED***
        export class EventEmitter extends internal ***REMOVED***
...
declare module "http" ***REMOVED***
    ...
    export interface IncomingHttpHeaders ***REMOVED***
        'accept'?: string;
    ...
    ***REMOVED***
    ...
    export interface OutgoingHttpHeaders ***REMOVED***
        [header: string]: number | string | string[] | undefined;
    ***REMOVED***

    export interface ClientRequestArgs ***REMOVED***
        protocol?: string;
        host?: string;
        hostname?: string;
        family?: number;
    ...
    ***REMOVED***
    ...
    export class Server extends net.Server ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export class ServerRequest extends IncomingMessage ***REMOVED***
        connection: net.Socket;
    ***REMOVED***

    // https://github.com/nodejs/node/blob/master/lib/_http_outgoing.js
    export class OutgoingMessage extends stream.Writable ***REMOVED***
        upgrading: boolean;
    ...
    ***REMOVED***
    ...
    export class ServerResponse extends OutgoingMessage ***REMOVED***
        statusCode: number;
    ...
    ***REMOVED***
    ...
    export class ClientRequest extends OutgoingMessage ***REMOVED***
        connection: net.Socket;
        socket: net.Socket;
        aborted: number;
    ...
    ***REMOVED***
    ...
    export class IncomingMessage extends stream.Readable ***REMOVED***
        ...
        rawHeaders: string[];
        trailers: ***REMOVED*** [key: string]: string | undefined ***REMOVED***;
        rawTrailers: string[];
        setTimeout(msecs: number, callback: () => void): this;
        /**
    ...
    ***REMOVED***
     ...
     * @deprecated Use IncomingMessage
     */
    export class ClientResponse extends IncomingMessage ***REMOVED*** ***REMOVED***

    export interface AgentOptions ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    export var STATUS_CODES: ***REMOVED***
    ...
    ***REMOVED***;
    ...
    export interface RequestOptions extends ClientRequestArgs ***REMOVED*** ***REMOVED***
...
declare module "cluster" ***REMOVED***
    import * as child from "child_process";
    import * as events from "events";
    import * as net from "net";

    // interfaces
    export interface ClusterSettings ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Address ***REMOVED***
        address: string;
        port: number;
        addressType: number | "udp4" | "udp6";  // 4, 6, -1, "udp4", "udp6"
    ***REMOVED***

    export class Worker extends events.EventEmitter ***REMOVED***
        id: number;
    ...
    ***REMOVED***
    ...
    export interface Cluster extends events.EventEmitter ***REMOVED***
        Worker: Worker;
...
declare module "zlib" ***REMOVED***
    import * as stream from "stream";

    export interface ZlibOptions ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Zlib ***REMOVED***
        readonly bytesRead: number;
        close(callback?: () => void): void;
        flush(kind?: number | (() => void), callback?: () => void): void;
    ***REMOVED***

    export interface ZlibParams ***REMOVED***
        params(level: number, strategy: number, callback: () => void): void;
    ***REMOVED***

    export interface ZlibReset ***REMOVED***
        reset(): void;
    ***REMOVED***

    export interface Gzip extends stream.Transform, Zlib ***REMOVED*** ***REMOVED***
    export interface Gunzip extends stream.Transform, Zlib ***REMOVED*** ***REMOVED***
    export interface Deflate extends stream.Transform, Zlib, ZlibReset, ZlibParams ***REMOVED*** ***REMOVED***
    export interface Inflate extends stream.Transform, Zlib, ZlibReset ***REMOVED*** ***REMOVED***
    export interface DeflateRaw extends stream.Transform, Zlib, ZlibReset, ZlibParams ***REMOVED*** ***REMOVED***
    export interface InflateRaw extends stream.Transform, Zlib, ZlibReset ***REMOVED*** ***REMOVED***
    export interface Unzip extends stream.Transform, Zlib ***REMOVED*** ***REMOVED***
    ...
    export namespace constants ***REMOVED***
...
declare module "os" ***REMOVED***
    export interface CpuInfo ***REMOVED***
        model: string;
        speed: number;
        times: ***REMOVED***
            user: number;
    ...
    ***REMOVED***
    ...
    export interface NetworkInterfaceBase ***REMOVED***
        address: string;
        netmask: string;
        mac: string;
        internal: boolean;
    ***REMOVED***
    ...
    export interface NetworkInterfaceInfoIPv4 extends NetworkInterfaceBase ***REMOVED***
        family: "IPv4";
    ***REMOVED***

    export interface NetworkInterfaceInfoIPv6 extends NetworkInterfaceBase ***REMOVED***
        family: "IPv6";
        scopeid: number;
    ***REMOVED***
    ...
    export function networkInterfaces(): ***REMOVED*** [index: string]: NetworkInterfaceInfo[] ***REMOVED***;
    export function homedir(): string;
    export function userInfo(options?: ***REMOVED*** encoding: string ***REMOVED***): ***REMOVED*** username: string, uid: number, gid: number, shell: any, homedir: string ***REMOVED***;
    export var constants: ***REMOVED***
...
declare module "https" ***REMOVED***
    ...
    export interface ServerOptions ***REMOVED***
        pfx?: any;
        key?: any;
        passphrase?: string;
        cert?: any;
    ...
    ***REMOVED***
    ...
    export interface RequestOptions extends http.RequestOptions ***REMOVED***
        pfx?: any;
        key?: any;
        passphrase?: string;
        cert?: any;
    ...
    ***REMOVED***
    ...
    export interface AgentOptions extends http.AgentOptions, tls.ConnectionOptions ***REMOVED***
        rejectUnauthorized?: boolean;
        maxCachedSessions?: number;
    ***REMOVED***

    export class Agent extends http.Agent ***REMOVED***
        constructor(options?: AgentOptions);
    ***REMOVED***

    export class Server extends tls.Server ***REMOVED***
        setTimeout(callback: () => void): this;
        setTimeout(msecs?: number, callback?: () => void): this;
        timeout: number;
        keepAliveTimeout: number;
...
declare module "punycode" ***REMOVED***
    export function decode(string: string): string;
    export function encode(string: string): string;
    export function toUnicode(domain: string): string;
    export function toASCII(domain: string): string;
    export var ucs2: ucs2;
    interface ucs2 ***REMOVED***
...
declare module "repl" ***REMOVED***
    import * as stream from "stream";
    import * as readline from "readline";

    export interface ReplOptions ***REMOVED***
        prompt?: string;
    ...
    ***REMOVED***
    ...
    export interface REPLServer extends readline.ReadLine ***REMOVED***
        context: any;
        inputStream: NodeJS.ReadableStream;
        outputStream: NodeJS.WritableStream;

        defineCommand(keyword: string, cmd: Function | ***REMOVED*** help: string, action: Function ***REMOVED***): void;
    ...
    ***REMOVED***
    ...
    export class Recoverable extends SyntaxError ***REMOVED***
        err: Error;
...
declare module "readline" ***REMOVED***
    import * as events from "events";
    import * as stream from "stream";

    export interface Key ***REMOVED***
        sequence?: string;
        name?: string;
        ctrl?: boolean;
        meta?: boolean;
    ...
    ***REMOVED***
    ...
    export interface ReadLine extends events.EventEmitter ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ReadLineOptions ***REMOVED***
        input: NodeJS.ReadableStream;
        output?: NodeJS.WritableStream;
...
declare module "vm" ***REMOVED***
    export interface Context ***REMOVED*** ***REMOVED***
    export interface ScriptOptions ***REMOVED***
        filename?: string;
        lineOffset?: number;
        columnOffset?: number;
    ...
    ***REMOVED***
    export interface RunningScriptOptions ***REMOVED***
        filename?: string;
        lineOffset?: number;
        columnOffset?: number;
        displayErrors?: boolean;
...
declare module "child_process" ***REMOVED***
    import * as events from "events";
    import * as stream from "stream";
    import * as net from "net";

    export interface ChildProcess extends events.EventEmitter ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface MessageOptions ***REMOVED***
        keepOpen?: boolean;
    ***REMOVED***

    export interface SpawnOptions ***REMOVED***
        cwd?: string;
        env?: any;
        stdio?: any;
        detached?: boolean;
    ...
    ***REMOVED***
    ...
    export interface ExecOptions ***REMOVED***
        cwd?: string;
        env?: any;
        shell?: string;
        timeout?: number;
    ...
    ***REMOVED***
    ...
    export interface ExecOptionsWithStringEncoding extends ExecOptions ***REMOVED***
        encoding: BufferEncoding;
    ***REMOVED***

    export interface ExecOptionsWithBufferEncoding extends ExecOptions ***REMOVED***
    ...
    ***REMOVED***
    ...
    export function exec(command: string, options: ***REMOVED*** encoding: "buffer" | null ***REMOVED*** & ExecOptions, callback?: (error: Error | null, stdout: Buffer, stderr: Buffer) => void): ChildProcess;

    // `options` with well known `encoding` means stdout/stderr are definitely `string`.
    export function exec(command: string, options: ***REMOVED*** encoding: BufferEncoding ***REMOVED*** & ExecOptions, callback?: (error: Error | null, stdout: string, stderr: string) => void): ChildProcess;

    // `options` with an `encoding` whose type is `string` means stdout/stderr could either be `Buffer` or `string`.
    // There is no guarantee the `encoding` is unknown as `string` is a superset of `BufferEncoding`.
    export function exec(command: string, options: ***REMOVED*** encoding: string ***REMOVED*** & ExecOptions, callback?: (error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void): ChildProcess;
    ...
    export function exec(command: string, options: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecOptions) | undefined | null, callback?: (error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void): ChildProcess;

    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace exec ***REMOVED***
        export function __promisify__(command: string): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(command: string, options: ***REMOVED*** encoding: "buffer" | null ***REMOVED*** & ExecOptions): Promise<***REMOVED*** stdout: Buffer, stderr: Buffer ***REMOVED***>;
        export function __promisify__(command: string, options: ***REMOVED*** encoding: BufferEncoding ***REMOVED*** & ExecOptions): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(command: string, options: ExecOptions): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(command: string, options?: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecOptions) | null): Promise<***REMOVED*** stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
    ***REMOVED***

    export interface ExecFileOptions ***REMOVED***
        cwd?: string;
        env?: any;
        timeout?: number;
        maxBuffer?: number;
        ...
        windowsVerbatimArguments?: boolean;
    ***REMOVED***
    export interface ExecFileOptionsWithStringEncoding extends ExecFileOptions ***REMOVED***
        encoding: BufferEncoding;
    ***REMOVED***
    export interface ExecFileOptionsWithBufferEncoding extends ExecFileOptions ***REMOVED***
        encoding: 'buffer' | null;
    ***REMOVED***
    export interface ExecFileOptionsWithOtherEncoding extends ExecFileOptions ***REMOVED***
        encoding: string;
    ***REMOVED***

    export function execFile(file: string): ChildProcess;
    export function execFile(file: string, options: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): ChildProcess;
    export function execFile(file: string, args: string[] | undefined | null): ChildProcess;
    export function execFile(file: string, args: string[] | undefined | null, options: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): ChildProcess;
    ...
    // fallback if nothing else matches. Worst case is always `string | Buffer`.
    export function execFile(file: string, options: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null, callback: ((error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void) | undefined | null): ChildProcess;
    export function execFile(file: string, args: string[] | undefined | null, options: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null, callback: ((error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void) | undefined | null): ChildProcess;

    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace execFile ***REMOVED***
        export function __promisify__(file: string): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptionsWithBufferEncoding): Promise<***REMOVED*** stdout: Buffer, stderr: Buffer ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptionsWithBufferEncoding): Promise<***REMOVED*** stdout: Buffer, stderr: Buffer ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptionsWithStringEncoding): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptionsWithStringEncoding): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptionsWithOtherEncoding): Promise<***REMOVED*** stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptionsWithOtherEncoding): Promise<***REMOVED*** stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptions): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptions): Promise<***REMOVED*** stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, options: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): Promise<***REMOVED*** stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: (***REMOVED*** encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): Promise<***REMOVED*** stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
    ***REMOVED***

    export interface ForkOptions ***REMOVED***
        cwd?: string;
        env?: any;
        execPath?: string;
        execArgv?: string[];
    ...
    ***REMOVED***
    ...
    export interface SpawnSyncOptions ***REMOVED***
        cwd?: string;
        input?: string | Buffer;
        stdio?: any;
        env?: any;
        ...
        windowsVerbatimArguments?: boolean;
    ***REMOVED***
    export interface SpawnSyncOptionsWithStringEncoding extends SpawnSyncOptions ***REMOVED***
        encoding: BufferEncoding;
    ***REMOVED***
    export interface SpawnSyncOptionsWithBufferEncoding extends SpawnSyncOptions ***REMOVED***
        encoding: string; // specify `null`.
    ***REMOVED***
    export interface SpawnSyncReturns<T> ***REMOVED***
        pid: number;
        output: string[];
        stdout: T;
        stderr: T;
    ...
    ***REMOVED***
    ...
    export interface ExecSyncOptions ***REMOVED***
        cwd?: string;
        input?: string | Buffer;
        stdio?: any;
        env?: any;
        ...
        encoding?: string;
    ***REMOVED***
    export interface ExecSyncOptionsWithStringEncoding extends ExecSyncOptions ***REMOVED***
        encoding: BufferEncoding;
    ***REMOVED***
    export interface ExecSyncOptionsWithBufferEncoding extends ExecSyncOptions ***REMOVED***
        encoding: string; // specify `null`.
    ***REMOVED***
    ...
    export interface ExecFileSyncOptions ***REMOVED***
        cwd?: string;
        input?: string | Buffer;
        stdio?: any;
        env?: any;
        ...
        encoding?: string;
    ***REMOVED***
    export interface ExecFileSyncOptionsWithStringEncoding extends ExecFileSyncOptions ***REMOVED***
        encoding: BufferEncoding;
    ***REMOVED***
    export interface ExecFileSyncOptionsWithBufferEncoding extends ExecFileSyncOptions ***REMOVED***
        encoding: string; // specify `null`.
    ***REMOVED***
...
declare module "url" ***REMOVED***
    import ***REMOVED*** ParsedUrlQuery ***REMOVED*** from 'querystring';

    export interface UrlObjectCommon ***REMOVED***
        auth?: string;
        hash?: string;
        host?: string;
        hostname?: string;
    ...
    ***REMOVED***
    ...
    // Input to `url.format`
    export interface UrlObject extends UrlObjectCommon ***REMOVED***
        port?: string | number;
        query?: string | null | ***REMOVED*** [key: string]: any ***REMOVED***;
    ***REMOVED***

    // Output of `url.parse`
    export interface Url extends UrlObjectCommon ***REMOVED***
        port?: string;
        query?: string | null | ParsedUrlQuery;
    ***REMOVED***

    export interface UrlWithParsedQuery extends Url ***REMOVED***
        query: ParsedUrlQuery;
    ***REMOVED***

    export interface UrlWithStringQuery extends Url ***REMOVED***
        query: string | null;
    ***REMOVED***
    ...
    export interface URLFormatOptions ***REMOVED***
        auth?: boolean;
        fragment?: boolean;
        search?: boolean;
        unicode?: boolean;
    ***REMOVED***
    ...
    export class URLSearchParams implements Iterable<[string, string]> ***REMOVED***
        constructor(init?: URLSearchParams | string | ***REMOVED*** [key: string]: string | string[] | undefined ***REMOVED*** | Iterable<[string, string]> | Array<[string, string]>);
...
declare module "dns" ***REMOVED***
    // Supported getaddrinfo flags.
    export const ADDRCONFIG: number;
    export const V4MAPPED: number;

    export interface LookupOptions ***REMOVED***
        family?: number;
        hints?: number;
        all?: boolean;
    ***REMOVED***

    export interface LookupOneOptions extends LookupOptions ***REMOVED***
        all?: false;
    ***REMOVED***

    export interface LookupAllOptions extends LookupOptions ***REMOVED***
        all: true;
    ***REMOVED***

    export interface LookupAddress ***REMOVED***
        address: string;
        family: number;
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace lookup ***REMOVED***
        export function __promisify__(hostname: string, options: LookupAllOptions): Promise<***REMOVED*** address: LookupAddress[] ***REMOVED***>;
        export function __promisify__(hostname: string, options?: LookupOneOptions | number): Promise<***REMOVED*** address: string, family: number ***REMOVED***>;
        export function __promisify__(hostname: string, options?: LookupOptions | number): Promise<***REMOVED*** address: string | LookupAddress[], family?: number ***REMOVED***>;
    ***REMOVED***

    export interface ResolveOptions ***REMOVED***
        ttl: boolean;
    ***REMOVED***

    export interface ResolveWithTtlOptions extends ResolveOptions ***REMOVED***
        ttl: true;
    ***REMOVED***

    export interface RecordWithTtl ***REMOVED***
        address: string;
        ttl: number;
    ***REMOVED***

    export interface MxRecord ***REMOVED***
        priority: number;
        exchange: string;
    ***REMOVED***

    export interface NaptrRecord ***REMOVED***
        flags: string;
        service: string;
        regexp: string;
        replacement: string;
    ...
    ***REMOVED***
    ...
    export interface SoaRecord ***REMOVED***
        nsname: string;
        hostmaster: string;
        serial: number;
        refresh: number;
    ...
    ***REMOVED***
    ...
    export interface SrvRecord ***REMOVED***
        priority: number;
        weight: number;
        port: number;
        name: string;
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace resolve ***REMOVED***
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace resolve4 ***REMOVED***
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace resolve6 ***REMOVED***
        export function __promisify__(hostname: string): Promise<string[]>;
        export function __promisify__(hostname: string, options: ResolveWithTtlOptions): Promise<RecordWithTtl[]>;
        export function __promisify__(hostname: string, options?: ResolveOptions): Promise<string[] | RecordWithTtl[]>;
    ***REMOVED***
...
declare module "net" ***REMOVED***
    ...
    export interface SocketConstructorOpts ***REMOVED***
        fd?: number;
    ...
    ***REMOVED***
    ...
    export interface TcpSocketConnectOpts ***REMOVED***
        port: number;
        host?: string;
        localAddress?: string;
        localPort?: number;
    ...
    ***REMOVED***
    ...
    export interface IpcSocketConnectOpts ***REMOVED***
        path: string;
    ***REMOVED***

    export type SocketConnectOpts = TcpSocketConnectOpts | IpcSocketConnectOpts;

    export class Socket extends stream.Duplex ***REMOVED***
        ...
        address(): ***REMOVED*** port: number; family: string; address: string; ***REMOVED***;
        unref(): void;
        ref(): void;
    ...
    ***REMOVED***
    ...
    export interface ListenOptions ***REMOVED***
        port?: number;
        host?: string;
        backlog?: number;
        path?: string;
    ...
    ***REMOVED***
    ...
    export class Server extends events.EventEmitter ***REMOVED***
        constructor(connectionListener?: (socket: Socket) => void);
        constructor(options?: ***REMOVED*** allowHalfOpen?: boolean, pauseOnConnect?: boolean ***REMOVED***, connectionListener?: (socket: Socket) => void);
    ...
    ***REMOVED***
    ...
    export interface TcpNetConnectOpts extends TcpSocketConnectOpts, SocketConstructorOpts ***REMOVED***
        timeout?: number;
    ***REMOVED***

    export interface IpcNetConnectOpts extends IpcSocketConnectOpts, SocketConstructorOpts ***REMOVED***
        timeout?: number;
    ***REMOVED***
    ...
    export function createServer(options?: ***REMOVED*** allowHalfOpen?: boolean, pauseOnConnect?: boolean ***REMOVED***, connectionListener?: (socket: Socket) => void): Server;
...
declare module "dgram" ***REMOVED***
    import * as events from "events";
    import * as dns from "dns";

    interface RemoteInfo ***REMOVED***
        address: string;
        family: string;
        port: number;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    interface SocketOptions ***REMOVED***
        type: SocketType;
        reuseAddr?: boolean;
    ...
    ***REMOVED***
    ...
    export class Socket extends events.EventEmitter ***REMOVED***
...
declare module "fs" ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface FSWatcher extends events.EventEmitter ***REMOVED***
        close(): void;
    ...
    ***REMOVED***
    ...
    export class ReadStream extends stream.Readable ***REMOVED***
        close(): void;
        destroy(): void;
        bytesRead: number;
        path: string | Buffer;
    ...
    ***REMOVED***
    ...
    export class WriteStream extends stream.Writable ***REMOVED***
        close(): void;
        bytesWritten: number;
        path: string | Buffer;
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace rename ***REMOVED***
        /**
         * Asynchronous rename(2) - Change the name or location of a file or directory.
         * @param oldPath A path to a file. If a URL is provided, it must use the `file:` protocol.
         * URL support is _experimental_.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace truncate ***REMOVED***
        /**
         * Asynchronous truncate(2) - Truncate a file to a specified length.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param len If not specified, defaults to `0`.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace ftruncate ***REMOVED***
        /**
         * Asynchronous ftruncate(2) - Truncate a file to a specified length.
         * @param fd A file descriptor.
         * @param len If not specified, defaults to `0`.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace chown ***REMOVED***
        /**
         * Asynchronous chown(2) - Change ownership of a file.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace fchown ***REMOVED***
        /**
         * Asynchronous fchown(2) - Change ownership of a file.
         * @param fd A file descriptor.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace lchown ***REMOVED***
        /**
         * Asynchronous lchown(2) - Change ownership of a file. Does not dereference symbolic links.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace chmod ***REMOVED***
        /**
         * Asynchronous chmod(2) - Change permissions of a file.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace fchmod ***REMOVED***
        /**
         * Asynchronous fchmod(2) - Change permissions of a file.
         * @param fd A file descriptor.
         * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace lchmod ***REMOVED***
        /**
         * Asynchronous lchmod(2) - Change permissions of a file. Does not dereference symbolic links.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace fstat ***REMOVED***
        /**
         * Asynchronous fstat(2) - Get file status.
         * @param fd A file descriptor.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace lstat ***REMOVED***
        /**
         * Asynchronous lstat(2) - Get file status. Does not dereference symbolic links.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace symlink ***REMOVED***
        /**
         * Asynchronous symlink(2) - Create a new symbolic link to an existing file.
         * @param target A path to an existing file. If a URL is provided, it must use the `file:` protocol.
         * @param path A path to the new symlink. If a URL is provided, it must use the `file:` protocol.
    ...
    ***REMOVED***
     ...
     */
    export function readlink(path: PathLike, options: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException, linkString: string) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlink(path: PathLike, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer", callback: (err: NodeJS.ErrnoException, linkString: Buffer) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlink(path: PathLike, options: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException, linkString: string | Buffer) => void): void;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace readlink ***REMOVED***
        /**
         * Asynchronous readlink(2) - read value of a symbolic link.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options?: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): Promise<string>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer"): Promise<Buffer>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options?: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | null): Promise<string | Buffer>;
    ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlinkSync(path: PathLike, options?: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlinkSync(path: PathLike, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer"): Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlinkSync(path: PathLike, options?: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | null): string | Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpath(path: PathLike, options: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException, resolvedPath: string) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpath(path: PathLike, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer", callback: (err: NodeJS.ErrnoException, resolvedPath: Buffer) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpath(path: PathLike, options: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException, resolvedPath: string | Buffer) => void): void;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace realpath ***REMOVED***
        /**
         * Asynchronous realpath(3) - return the canonicalized absolute pathname.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
    ...
    ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpathSync(path: PathLike, options?: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpathSync(path: PathLike, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer"): Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpathSync(path: PathLike, options?: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | null): string | Buffer;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace unlink ***REMOVED***
        /**
         * Asynchronous unlink(2) - delete a name and possibly the file it refers to.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace rmdir ***REMOVED***
        /**
         * Asynchronous rmdir(2) - delete a directory.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace mkdir ***REMOVED***
        /**
         * Asynchronous mkdir(2) - create a directory.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param mode A file mode. If a string is passed, it is parsed as an octal integer. If not specified, defaults to `0o777`.
    ...
    ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtemp(prefix: string, options: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException, folder: string) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtemp(prefix: string, options: "buffer" | ***REMOVED*** encoding: "buffer" ***REMOVED***, callback: (err: NodeJS.ErrnoException, folder: Buffer) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtemp(prefix: string, options: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException, folder: string | Buffer) => void): void;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace mkdtemp ***REMOVED***
        /**
         * Asynchronously creates a unique temporary directory.
         * Generates six random characters to be appended behind a required prefix to create a unique temporary directory.
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(prefix: string, options?: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): Promise<string>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(prefix: string, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer"): Promise<Buffer>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(prefix: string, options?: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | null): Promise<string | Buffer>;
    ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtempSync(prefix: string, options?: ***REMOVED*** encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtempSync(prefix: string, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer"): Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtempSync(prefix: string, options?: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | null): string | Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdir(path: PathLike, options: ***REMOVED*** encoding: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException, files: string[]) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdir(path: PathLike, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer", callback: (err: NodeJS.ErrnoException, files: Buffer[]) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdir(path: PathLike, options: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException, files: Array<string | Buffer>) => void): void;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace readdir ***REMOVED***
        /**
         * Asynchronous readdir(3) - read a directory.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options: "buffer" | ***REMOVED*** encoding: "buffer" ***REMOVED***): Promise<Buffer[]>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options?: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | null): Promise<Array<string | Buffer>>;
    ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdirSync(path: PathLike, options?: ***REMOVED*** encoding: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string[];
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdirSync(path: PathLike, options: ***REMOVED*** encoding: "buffer" ***REMOVED*** | "buffer"): Buffer[];
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdirSync(path: PathLike, options?: ***REMOVED*** encoding?: string | null ***REMOVED*** | string | null): Array<string | Buffer>;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace close ***REMOVED***
        /**
         * Asynchronous close(2) - close a file descriptor.
         * @param fd A file descriptor.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace utimes ***REMOVED***
        /**
         * Asynchronously change file timestamps of the file referenced by the supplied path.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * @param atime The last access time. If a string is provided, it will be coerced to number.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace futimes ***REMOVED***
        /**
         * Asynchronously change file timestamps of the file referenced by the supplied file descriptor.
         * @param fd A file descriptor.
         * @param atime The last access time. If a string is provided, it will be coerced to number.
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace fsync ***REMOVED***
        /**
         * Asynchronous fsync(2) - synchronize a file's in-core state with the underlying storage device.
         * @param fd A file descriptor.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace write ***REMOVED***
        /**
         * Asynchronously writes `buffer` to the file referenced by the supplied file descriptor.
         * @param fd A file descriptor.
         * @param offset The part of the buffer to be written. If not supplied, defaults to `0`.
         ...
         * @param position The offset from the beginning of the file where this data should be written. If not supplied, defaults to the current position.
         */
        export function __promisify__<TBuffer extends Buffer | Uint8Array>(fd: number, buffer?: TBuffer, offset?: number, length?: number, position?: number | null): Promise<***REMOVED*** bytesWritten: number, buffer: TBuffer ***REMOVED***>;
         ...
         * @param encoding The expected string encoding.
         */
        export function __promisify__(fd: number, string: any, position?: number | null, encoding?: string | null): Promise<***REMOVED*** bytesWritten: number, buffer: string ***REMOVED***>;
    ***REMOVED***
    ...
    export namespace read ***REMOVED***
         ...
         * @param position The offset from the beginning of the file from which data should be read. If `null`, data will be read from the current position.
         */
        export function __promisify__<TBuffer extends Buffer | Uint8Array>(fd: number, buffer: TBuffer, offset: number, length: number, position: number | null): Promise<***REMOVED*** bytesRead: number, buffer: TBuffer ***REMOVED***>;
    ***REMOVED***
     ...
     */
    export function readFile(path: PathLike | number, options: ***REMOVED*** encoding?: null; flag?: string; ***REMOVED*** | undefined | null, callback: (err: NodeJS.ErrnoException, data: Buffer) => void): void;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFile(path: PathLike | number, options: ***REMOVED*** encoding: string; flag?: string; ***REMOVED*** | string, callback: (err: NodeJS.ErrnoException, data: string) => void): void;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFile(path: PathLike | number, options: ***REMOVED*** encoding?: string | null; flag?: string; ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException, data: string | Buffer) => void): void;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace readFile ***REMOVED***
        /**
         * Asynchronously reads the entire contents of a file.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * If a file descriptor is provided, the underlying file will _not_ be closed automatically.
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        export function __promisify__(path: PathLike | number, options?: ***REMOVED*** encoding?: null; flag?: string; ***REMOVED*** | null): Promise<Buffer>;
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        export function __promisify__(path: PathLike | number, options: ***REMOVED*** encoding: string; flag?: string; ***REMOVED*** | string): Promise<string>;
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        export function __promisify__(path: PathLike | number, options?: ***REMOVED*** encoding?: string | null; flag?: string; ***REMOVED*** | string | null): Promise<string | Buffer>;
    ***REMOVED***
     ...
     */
    export function readFileSync(path: PathLike | number, options?: ***REMOVED*** encoding?: null; flag?: string; ***REMOVED*** | null): Buffer;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFileSync(path: PathLike | number, options: ***REMOVED*** encoding: string; flag?: string; ***REMOVED*** | string): string;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFileSync(path: PathLike | number, options?: ***REMOVED*** encoding?: string | null; flag?: string; ***REMOVED*** | string | null): string | Buffer;
     ...
     */
    export function writeFile(path: PathLike | number, data: any, options: ***REMOVED*** encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException) => void): void;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace writeFile ***REMOVED***
        /**
         * Asynchronously writes data to a file, replacing the file if it already exists.
         * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
         * URL support is _experimental_.
         ...
         * If `flag` is not supplied, the default of `'w'` is used.
         */
        export function __promisify__(path: PathLike | number, data: any, options?: ***REMOVED*** encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | null): Promise<void>;
    ***REMOVED***
     ...
     * If `flag` is not supplied, the default of `'w'` is used.
     */
    export function writeFileSync(path: PathLike | number, data: any, options?: ***REMOVED*** encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | null): void;
     ...
     */
    export function appendFile(file: PathLike | number, data: any, options: ***REMOVED*** encoding?: string | null, mode?: string | number, flag?: string ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException) => void): void;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace appendFile ***REMOVED***
        /**
         * Asynchronously append data to a file, creating the file if it does not exist.
         * @param file A path to a file. If a URL is provided, it must use the `file:` protocol.
         * URL support is _experimental_.
         ...
         * If `flag` is not supplied, the default of `'a'` is used.
         */
        export function __promisify__(file: PathLike | number, data: any, options?: ***REMOVED*** encoding?: string | null, mode?: string | number, flag?: string ***REMOVED*** | string | null): Promise<void>;
    ***REMOVED***
     ...
     * If `flag` is not supplied, the default of `'a'` is used.
     */
    export function appendFileSync(file: PathLike | number, data: any, options?: ***REMOVED*** encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | null): void;

    /**
     * Watch for changes on `filename`. The callback `listener` will be called each time the file is accessed.
     */
    export function watchFile(filename: PathLike, options: ***REMOVED*** persistent?: boolean; interval?: number; ***REMOVED*** | undefined, listener: (curr: Stats, prev: Stats) => void): void;
     ...
     */
    export function watch(filename: PathLike, options: ***REMOVED*** encoding?: BufferEncoding | null, persistent?: boolean, recursive?: boolean ***REMOVED*** | BufferEncoding | undefined | null, listener?: (event: string, filename: string) => void): FSWatcher;
     ...
     * If `recursive` is not supplied, the default of `false` is used.
     */
    export function watch(filename: PathLike, options: ***REMOVED*** encoding: "buffer", persistent?: boolean, recursive?: boolean ***REMOVED*** | "buffer", listener?: (event: string, filename: Buffer) => void): FSWatcher;
     ...
     * If `recursive` is not supplied, the default of `false` is used.
     */
    export function watch(filename: PathLike, options: ***REMOVED*** encoding?: string | null, persistent?: boolean, recursive?: boolean ***REMOVED*** | string | null, listener?: (event: string, filename: string | Buffer) => void): FSWatcher;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace exists ***REMOVED***
        /**
         * @param path A path to a file or directory. If a URL is provided, it must use the `file:` protocol.
         * URL support is _experimental_.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace access ***REMOVED***
        /**
         * Asynchronously tests a user's permissions for the file specified by path.
         * @param path A path to a file or directory. If a URL is provided, it must use the `file:` protocol.
         * URL support is _experimental_.
    ...
    ***REMOVED***
     ...
     * URL support is _experimental_.
     */
    export function createReadStream(path: PathLike, options?: string | ***REMOVED***
        flags?: string;
        encoding?: string;
        fd?: number;
        mode?: number;
    ...
    ***REMOVED***): ReadStream;
     ...
     * URL support is _experimental_.
     */
    export function createWriteStream(path: PathLike, options?: string | ***REMOVED***
        flags?: string;
        encoding?: string;
        fd?: number;
        mode?: number;
    ...
    ***REMOVED***): WriteStream;
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace fdatasync ***REMOVED***
        /**
         * Asynchronous fdatasync(2) - synchronize a file's in-core state with storage device.
         * @param fd A file descriptor.
         */
    ...
    ***REMOVED***
    ...
    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace copyFile ***REMOVED***
        /**
         * Asynchronously copies src to dest. By default, dest is overwritten if it already exists.
         * No arguments other than a possible exception are given to the callback function.
         * Node.js makes no guarantees about the atomicity of the copy operation.
...
declare module "path" ***REMOVED***
     ...
     */
    export interface ParsedPath ***REMOVED***
        /**
        ...
        name: string;
    ***REMOVED***
    export interface FormatInputPathObject ***REMOVED***
        /**
         * The root of the path such as '/' or 'c:\'
         */
        root?: string;
    ...
    ***REMOVED***
     ...
     *
     * Starting from leftmost ***REMOVED***from***REMOVED*** paramter, resolves ***REMOVED***to***REMOVED*** to an absolute path.
     *
     * If ***REMOVED***to***REMOVED*** isn't already absolute, ***REMOVED***from***REMOVED*** arguments are prepended in right to left order, until an absolute path is found. If after using all ***REMOVED***from***REMOVED*** paths still no absolute path is found, the current working directory is used as well. The resulting path is normalized, and trailing slashes are removed unless the path gets resolved to the root directory.
     *
...
declare module "string_decoder" ***REMOVED***
    export interface NodeStringDecoder ***REMOVED***
        write(buffer: Buffer): string;
        end(buffer?: Buffer): string;
    ***REMOVED***
    export var StringDecoder: ***REMOVED***
        new(encoding?: string): NodeStringDecoder;
    ***REMOVED***;
***REMOVED***

declare module "tls" ***REMOVED***
    ...
    export interface Certificate ***REMOVED***
        /**
         * Country code.
         */
        C: string;
    ...
    ***REMOVED***
    ...
    export interface PeerCertificate ***REMOVED***
        subject: Certificate;
        issuer: Certificate;
        subjectaltname: string;
        infoAccess: ***REMOVED*** [index: string]: string[] | undefined ***REMOVED***;
        modulus: string;
        exponent: string;
        valid_from: string;
        valid_to: string;
    ...
    ***REMOVED***
    ...
    export interface DetailedPeerCertificate extends PeerCertificate ***REMOVED***
        issuerCertificate: DetailedPeerCertificate;
    ***REMOVED***

    export interface CipherNameAndProtocol ***REMOVED***
        /**
         * The cipher name.
         */
        name: string;
    ...
    ***REMOVED***
    ...
    export class TLSSocket extends net.Socket ***REMOVED***
        /**
         * Construct a new tls.TLSSocket object from an existing TCP socket.
         */
        constructor(socket: net.Socket, options?: ***REMOVED***
            /**
    ...
    ***REMOVED***
    ...
    export interface TlsOptions ***REMOVED***
        host?: string;
        port?: number;
        pfx?: string | Buffer[];
    ...
    ***REMOVED***
    ...
    export interface ConnectionOptions extends SecureContextOptions ***REMOVED***
        host?: string;
        port?: number;
    ...
    ***REMOVED***
    ...
    export class Server extends net.Server ***REMOVED***
        addContext(hostName: string, credentials: ***REMOVED***
            key: string;
            cert: string;
            ca: string;
        ***REMOVED***): void;
    ...
    ***REMOVED***
    ...
    export interface ClearTextStream extends stream.Duplex ***REMOVED***
        authorized: boolean;
        authorizationError: Error;
    ...
    ***REMOVED***
    ...
    export interface SecurePair ***REMOVED***
        encrypted: any;
        cleartext: any;
    ***REMOVED***

    export interface SecureContextOptions ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface SecureContext ***REMOVED***
        context: any;
    ***REMOVED***
...
declare module "crypto" ***REMOVED***
    ...
    ***REMOVED***;
    ...
    export interface CredentialDetails ***REMOVED***
        pfx: string;
        key: string;
        passphrase: string;
        cert: string;
        ...
        ciphers: string;
    ***REMOVED***
    export interface Credentials ***REMOVED*** context?: any; ***REMOVED***
    ...
    export interface Hash extends NodeJS.ReadWriteStream ***REMOVED***
    ...
    ***REMOVED***
    export interface Hmac extends NodeJS.ReadWriteStream ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Cipher extends NodeJS.ReadWriteStream ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Decipher extends NodeJS.ReadWriteStream ***REMOVED***
        update(data: Buffer | DataView): Buffer;
    ...
    ***REMOVED***
    ...
    export interface Signer extends NodeJS.WritableStream ***REMOVED***
        ...
        sign(private_key: string | ***REMOVED*** key: string; passphrase: string ***REMOVED***): Buffer;
        sign(private_key: string | ***REMOVED*** key: string; passphrase: string ***REMOVED***, output_format: HexBase64Latin1Encoding): string;
    ***REMOVED***
    export function createVerify(algorith: string): Verify;
    export interface Verify extends NodeJS.WritableStream ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface DiffieHellman ***REMOVED***
        generateKeys(): Buffer;
    ...
    ***REMOVED***
    ...
    export interface RsaPublicKey ***REMOVED***
        key: string;
        padding?: number;
    ***REMOVED***
    export interface RsaPrivateKey ***REMOVED***
        key: string;
        passphrase?: string;
        padding?: number;
    ***REMOVED***
...
declare module "stream" ***REMOVED***
    import * as events from "events";

    class internal extends events.EventEmitter ***REMOVED***
        pipe<T extends NodeJS.WritableStream>(destination: T, options?: ***REMOVED*** end?: boolean; ***REMOVED***): T;
    ***REMOVED***

    namespace internal ***REMOVED***
        export class Stream extends internal ***REMOVED*** ***REMOVED***

        export interface ReadableOptions ***REMOVED***
            highWaterMark?: number;
            encoding?: string;
            objectMode?: boolean;
        ...
        ***REMOVED***
        ...
        export class Readable extends Stream implements NodeJS.ReadableStream ***REMOVED***
            readable: boolean;
        ...
        ***REMOVED***
        ...
        export interface WritableOptions ***REMOVED***
            highWaterMark?: number;
            decodeStrings?: boolean;
            objectMode?: boolean;
            write?: (chunk: string | Buffer, encoding: string, callback: Function) => any;
            writev?: (chunks: Array<***REMOVED*** chunk: string | Buffer, encoding: string ***REMOVED***>, callback: Function) => any;
            destroy?: (error?: Error) => any;
            final?: (callback: (error?: Error) => void) => void;
        ***REMOVED***

        export class Writable extends Stream implements NodeJS.WritableStream ***REMOVED***
            writable: boolean;
            constructor(opts?: WritableOptions);
            _write(chunk: any, encoding: string, callback: (err?: Error) => void): void;
            _writev?(chunks: Array<***REMOVED***chunk: any, encoding: string***REMOVED***>, callback: (err?: Error) => void): void;
            _destroy(err: Error, callback: Function): void;
            _final(callback: Function): void;
        ...
        ***REMOVED***
        ...
        export interface DuplexOptions extends ReadableOptions, WritableOptions ***REMOVED***
            allowHalfOpen?: boolean;
        ...
        ***REMOVED***
        ...
        export class Duplex extends Readable implements Writable ***REMOVED***
            writable: boolean;
        ...
        ***REMOVED***
        ...
        export interface TransformOptions extends DuplexOptions ***REMOVED***
            transform?: (chunk: string | Buffer, encoding: string, callback: Function) => any;
            flush?: (callback: Function) => any;
        ***REMOVED***

        export class Transform extends Duplex ***REMOVED***
            constructor(opts?: TransformOptions);
            _transform(chunk: any, encoding: string, callback: Function): void;
            destroy(error?: Error): void;
        ***REMOVED***

        export class PassThrough extends Transform ***REMOVED*** ***REMOVED***
    ***REMOVED***

    export = internal;
***REMOVED***

declare module "util" ***REMOVED***
    export interface InspectOptions extends NodeJS.InspectOptions ***REMOVED*** ***REMOVED***
    ...
    ***REMOVED***;
    ...
    export interface CustomPromisify<TCustom extends Function> extends Function ***REMOVED***
    ...
    ***REMOVED***
    ...
    export namespace promisify ***REMOVED***
        const custom: symbol;
    ***REMOVED***
***REMOVED***

declare module "assert" ***REMOVED***
    function internal(value: any, message?: string): void;
    namespace internal ***REMOVED***
        export class AssertionError implements Error ***REMOVED***
            name: string;
            message: string;
            actual: any;
            expected: any;
...
declare module "tty" ***REMOVED***
    import * as net from "net";

    export function isatty(fd: number): boolean;
    export interface ReadStream extends net.Socket ***REMOVED***
        isRaw: boolean;
        setRawMode(mode: boolean): void;
        isTTY: boolean;
    ***REMOVED***
    export interface WriteStream extends net.Socket ***REMOVED***
        columns: number;
        rows: number;
        isTTY: boolean;
    ***REMOVED***
...
declare module "domain" ***REMOVED***
    import * as events from "events";

    export class Domain extends events.EventEmitter implements NodeJS.Domain ***REMOVED***
        run(fn: Function): void;
...
declare module "constants" ***REMOVED***
...
declare module "module" ***REMOVED***
    export = NodeJS.Module;
***REMOVED***

declare module "process" ***REMOVED***
    export = process;
***REMOVED***

// tslint:disable-next-line:no-declare-current-package
declare module "v8" ***REMOVED***
    interface HeapSpaceInfo ***REMOVED***
        space_name: string;
        space_size: number;
...
declare module "timers" ***REMOVED***
    ...
    ***REMOVED***
    ...
    export namespace setImmediate ***REMOVED***
        export function __promisify__(): Promise<void>;
        export function __promisify__<T>(value: T): Promise<T>;
    ***REMOVED***
...
declare module "console" ***REMOVED***
    export = console;
***REMOVED***
 ...
 */
declare module "async_hooks" ***REMOVED***
    /**
    ...
    export interface HookCallbacks ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    export interface AsyncHook ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    export class AsyncResource ***REMOVED***
        /**
...
declare module "http2" ***REMOVED***
    ...
    import ***REMOVED*** IncomingHttpHeaders, OutgoingHttpHeaders ***REMOVED*** from "http";
    export ***REMOVED*** IncomingHttpHeaders, OutgoingHttpHeaders ***REMOVED*** from "http";

    // Http2Stream

    export interface StreamPriorityOptions ***REMOVED***
        exclusive?: boolean;
        parent?: number;
        weight?: number;
        silent?: boolean;
    ***REMOVED***
    ...
    export interface StreamState ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ServerStreamResponseOptions ***REMOVED***
        endStream?: boolean;
        getTrailers?: (trailers: OutgoingHttpHeaders) => void;
    ***REMOVED***

    export interface StatOptions ***REMOVED***
        offset: number;
        length: number;
    ***REMOVED***

    export interface ServerStreamFileResponseOptions ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ServerStreamFileResponseOptionsWithError extends ServerStreamFileResponseOptions ***REMOVED***
        onError?: (err: NodeJS.ErrnoException) => void;
    ***REMOVED***

    export interface Http2Stream extends stream.Duplex ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ClientHttp2Stream extends Http2Stream ***REMOVED***
        addListener(event: string, listener: (...args: any[]) => void): this;
    ...
    ***REMOVED***
    ...
    export interface ServerHttp2Stream extends Http2Stream ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Settings ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ClientSessionRequestOptions ***REMOVED***
        endStream?: boolean;
        exclusive?: boolean;
        parent?: number;
        weight?: number;
    ...
    ***REMOVED***
    ...
    export interface SessionShutdownOptions ***REMOVED***
        graceful?: boolean;
        errorCode?: number;
        lastStreamID?: number;
    ...
    ***REMOVED***
    ...
    export interface SessionState ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Http2Session extends events.EventEmitter ***REMOVED***
        destroy(): void;
        readonly destroyed: boolean;
    ...
    ***REMOVED***
    ...
    export interface ClientHttp2Session extends Http2Session ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ServerHttp2Session extends Http2Session ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface SessionOptions ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface SecureClientSessionOptions extends ClientSessionOptions, tls.ConnectionOptions ***REMOVED*** ***REMOVED***
    export interface SecureServerSessionOptions extends ServerSessionOptions, tls.TlsOptions ***REMOVED*** ***REMOVED***

    export interface ServerOptions extends ServerSessionOptions ***REMOVED***
        allowHTTP1?: boolean;
    ***REMOVED***

    export interface SecureServerOptions extends SecureServerSessionOptions ***REMOVED***
        allowHTTP1?: boolean;
    ***REMOVED***

    export interface Http2Server extends net.Server ***REMOVED***
        addListener(event: string, listener: (...args: any[]) => void): this;
    ...
    ***REMOVED***
    ...
    export interface Http2SecureServer extends tls.Server ***REMOVED***
        addListener(event: string, listener: (...args: any[]) => void): this;
        addListener(event: "request", listener: (request: Http2ServerRequest, response: Http2ServerResponse) => void): this;
        addListener(event: "sessionError", listener: (err: Error) => void): this;
        addListener(event: "socketError", listener: (err: Error) => void): this;
    ...
    ***REMOVED***
    ...
    export interface Http2ServerRequest extends stream.Readable ***REMOVED***
        headers: IncomingHttpHeaders;
        httpVersion: string;
        method: string;
        rawHeaders: string[];
    ...
    ***REMOVED***
    ...
    export interface Http2ServerResponse extends events.EventEmitter ***REMOVED***
...
declare module "perf_hooks" ***REMOVED***
    export interface PerformanceEntry ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    export interface PerformanceNodeTiming extends PerformanceEntry ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    export interface Performance ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    export interface PerformanceObserverEntryList ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    export class PerformanceObserver ***REMOVED***
         ...
         * @param options
         */
        observe(options: ***REMOVED*** entryTypes: string[], buffered?: boolean ***REMOVED***): void;
    ***REMOVED***
