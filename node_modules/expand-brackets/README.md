...
* `pattern` *****REMOVED***String***REMOVED*****: the pattern to convert
* `options` *****REMOVED***Object***REMOVED*****: optionally supply an options object
* `returns` *****REMOVED***String***REMOVED*****: returns a string that can be used to create a regex
...
* `arr` *****REMOVED***Array***REMOVED*****: Array of strings to match
* `pattern` *****REMOVED***String***REMOVED*****: POSIX character class pattern(s)
* `options` *****REMOVED***Object***REMOVED*****
...
* `pattern` *****REMOVED***String***REMOVED*****: Poxis pattern
...
```js
var res = brackets('[:alpha:]', ***REMOVED***sourcemap: true***REMOVED***);
...
* `[:punct:]`: Punctuation and symbols. (`[!"#$%&'()*+, -./:;<=>?@ [\]^_``***REMOVED***|***REMOVED***~]`)
