 ...
 * @param ***REMOVED***Object.<string,*>***REMOVED*** properties Additional properties to set
 * @constructor
 */
var Sandbox = function(properties) ***REMOVED***
    this.Int8Array = function() ***REMOVED******REMOVED***;
    this.Uint8Array = function() ***REMOVED******REMOVED***;
    this.Int16Array = function() ***REMOVED******REMOVED***;
    this.Uint16Array = function() ***REMOVED******REMOVED***;
    this.Int32Array = function() ***REMOVED******REMOVED***;
    this.Uint32Array = function() ***REMOVED******REMOVED***;
    this.Float32Array = function() ***REMOVED******REMOVED***;
    this.Float64Array = function() ***REMOVED******REMOVED***;
    this.DataView = function() ***REMOVED******REMOVED***;
    for (var i in properties) ***REMOVED***
        this[i] = properties[i];
    ***REMOVED***
    this.console = ***REMOVED***
        log: function(s) ***REMOVED***
            console.log(s);
        ***REMOVED***
    ***REMOVED***;
***REMOVED***;

function makeSuite(ByteBuffer) ***REMOVED***
    var type = ByteBuffer.type(), // Buffer or ArrayBuffer
        accessor = ByteBuffer.accessor(),
        Long = ByteBuffer.Long;
    var suite = ***REMOVED******REMOVED***;
    
    suite.init = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.base = ***REMOVED******REMOVED***;
    
    suite.base.allocate = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.base.clone = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.base.assert = function(test) ***REMOVED***
        var bb = new ByteBuffer();
    ...
    ***REMOVED***;
    ...
    suite.wrap = ***REMOVED******REMOVED***;
    
    if (type === Buffer) ***REMOVED***
        suite.wrap.Buffer = function(test) ***REMOVED***
    ...
    ***REMOVED***
    ...
    suite.wrap.ArrayBuffer = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.wrap.Uint8Array = function(test) ***REMOVED***
        // Full view
    ...
    ***REMOVED***;
    ...
    suite.wrap.Array = function(test) ***REMOVED***
        var arr = [1,255,-1];
    ...
    ***REMOVED***;
    ...
    suite.wrap.ByteBuffer = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.wrap.string = function(test) ***REMOVED***
        var bb = ByteBuffer.wrap("\u0061\u0062");
        test.equal(bb.toDebug(), "<61 62>");
        test.done();
    ***REMOVED***;
       
    suite.encodings = ***REMOVED******REMOVED***;
    
    suite.encodings.UTF8 = function(test) ***REMOVED***
        ["aäöüß€b", ""].forEach(function(str) ***REMOVED***
            var bb = ByteBuffer.wrap(str, "utf8"); // Calls ByteBuffer#fromUTF8
            test.strictEqual(bb.toUTF8(), str);
            if (str.length > 2) ***REMOVED***
                bb.offset = 1;
    ...
    ***REMOVED***;
    ...
    suite.encodings.debug = function(test) ***REMOVED***
        ["60<61 62]63", "<60 61 62 63]", "|", "|61", "<61>", "!12"].forEach(function(str) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.encodings.binary = function(test) ***REMOVED***
        ["\x61\x62\x63\x64", "", "  "].forEach(function(str) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.encodings.hex = function(test) ***REMOVED***
        ["61626364", "61", ""].forEach(function(str) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.encodings.base64 = function(test) ***REMOVED***
        ["", "YWI=", "YWJjZGVmZw==", "YWJjZGVmZ2g=", "YWJjZGVmZ2hp"].forEach(function(str) ***REMOVED***
            var bb = ByteBuffer.wrap(str, "base64"); // Calls ByteBuffer#fromBase64
            test.strictEqual(bb.toBase64(), str);
            if (str.length > 8) ***REMOVED***
                bb.offset = 3;
    ...
    ***REMOVED***;
    ...
    suite.methods = ***REMOVED******REMOVED***;
    
    suite.methods.concat = function(test) ***REMOVED***
        var bbs = [
            new ArrayBuffer(1),
    ...
    ***REMOVED***;
    ...
    suite.methods.resize = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.ensureCapacity = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.slice = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.flip = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.mark = function(test) ***REMOVED***
        var bb = ByteBuffer.wrap('\x12\x34\x56\x78');
        test.equal(bb.offset, 0);
        test.equal(bb.limit, 4);
    ...
    ***REMOVED***;
    ...
    suite.methods.reset = function(test) ***REMOVED***
        var bb = ByteBuffer.wrap('\x12\x34\x56\x78');
        bb.reset();
        test.equal(bb.offset, 0);
        test.equal(bb.limit, 4);
    ...
    ***REMOVED***;
    ...
    suite.methods.copy = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.copyTo = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.compact = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.reverse = function(test) ***REMOVED***
        var bb = ByteBuffer.wrap("\x12\x34\x56\x78");
        bb.reverse(1, 3);
    ...
    ***REMOVED***;
    ...
    suite.methods.append = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.methods.prepend = function(test) ***REMOVED***
        var bb = ByteBuffer.wrap("\x12\x34"),
    ...
    ***REMOVED***;
    ...
    suite.methods.prependTo = function(test) ***REMOVED***
        var bb = ByteBuffer.wrap("\x12\x34"),
            bb2 = ByteBuffer.wrap("\x56\x78");
    ...
    ***REMOVED***;
    ...
    suite.methods.remaining = function(test) ***REMOVED***
        var bb = ByteBuffer.wrap("\x12\x34");
    ...
    ***REMOVED***;
    ...
    suite.methods.skip = function(test) ***REMOVED***
        ...
        ***REMOVED***);
        test.strictEqual(bb.offset, 3);
        bb.noAssert = true;
        test.doesNotThrow(function() ***REMOVED***
            bb.skip(1);
        ***REMOVED***);
    ...
    ***REMOVED***;
    ...
    suite.methods.order = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.types = ***REMOVED******REMOVED***;
    
    types.forEach(function(type) ***REMOVED***
        var name = type[0],
            ...
            be = type[5],
            le = "";
        for (var i=be.length; i>0; i-=2) ***REMOVED***
            le += be.substr(i-2, 2);
        ***REMOVED***
        suite.types[name.toLowerCase()] = function(test) ***REMOVED***
            var bb = new ByteBuffer(size);
            // Relative BE (always LE for varints)
            test.strictEqual(bb["write"+name](input), bb);
            bb.flip();
            var val = bb["read"+name]();
            if (output instanceof Long) ***REMOVED***
            ...
            ***REMOVED***
            test.throws(function() ***REMOVED*** // OOB
                bb.offset = bb.capacity() - size + 1;
                bb["read"+name](input);
            ***REMOVED***);
            test.doesNotThrow(function() ***REMOVED*** // OOB, automatic resizing * 2
                bb["write"+name](input);
            ***REMOVED***);
            ...
            if (output instanceof Long) ***REMOVED***
                if (!varint)
                    ...
                    test.deepEqual(val, ***REMOVED***value: output, length: size***REMOVED***);
            ***REMOVED*** else ***REMOVED***
                if (!varint)
                    test.strictEqual(val, output);
                else
    ...
    ***REMOVED***);
    ...
    suite.types.bitset = function(test) ***REMOVED***
      var bb = new ByteBuffer(2),
          arr;

      function run(data) ***REMOVED***
        bb.reset();
        bb.writeBitSet(data);
        bb.reset();
      ...
      ***REMOVED***;
      ...
      bb.reset();
      bb.writeBitSet([,null,"",0,42,"hello world",new Date(0),***REMOVED******REMOVED***,[]]);
      bb.reset();
    ...
    ***REMOVED***;
    ...
    suite.types.calculateVarint = function(test) ***REMOVED***
        ...
        ***REMOVED***
        ...
        for (i=0; i<values.length; i++) ***REMOVED***
            test.equal(ByteBuffer.calculateVarint64(values[i][0]), values[i][1]);
        ***REMOVED***
        test.done();
    ***REMOVED***;
    
    suite.types.zigZagVarint = function(test) ***REMOVED***
        var Long = ByteBuffer.Long;
        var values = [
            [ 0, 0],
            [-1, 1],
    ...
    ***REMOVED***;
    ...
    suite.types.utf8string = function(test) ***REMOVED***        
        var bb = new ByteBuffer(2);
        // Aliases
    ...
    ***REMOVED***;
    ...
    suite.types.istring = function(test) ***REMOVED***
        var bb = new ByteBuffer(2);
        ...
        test.deepEqual(bb.readIString(0), ***REMOVED***"string": "ab", "length": 6***REMOVED***);
    ...
    ***REMOVED***;
    ...
    suite.types.vstring = function(test) ***REMOVED***
        var bb = new ByteBuffer(2);
        ...
        test.deepEqual(bb.readVString(0), ***REMOVED***"string": "ab", "length": 3***REMOVED***);
        test.equal(bb.toString("debug").substr(0, 10), "<02 61 62>");
    ...
    ***REMOVED***;
    ...
    suite.types.cstring = function(test) ***REMOVED***
        var bb = new ByteBuffer(2);
        bb.writeCString("a");
        test.equal(bb.capacity(), 2);
        ...
        test.deepEqual(bb.readCString(0), ***REMOVED***"string": "ab", "length": 3***REMOVED***);
        test.equal(bb.toString("debug").substr(0, 10), "<61 62 00>");
    ...
    ***REMOVED***;
    ...
    suite.convert = ***REMOVED******REMOVED***;
    
    suite.convert.toHex = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.convert.toBase64 = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.convert.toBinary = function(test) ***REMOVED***
        var bb = new ByteBuffer(5);
    ...
    ***REMOVED***;
    ...
    suite.convert.toString = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.convert.toBuffer = function(test) ***REMOVED***
        var bb = new ByteBuffer(2);
    ...
    ***REMOVED***;
    ...
    suite.convert.toArrayBuffer = function(test) ***REMOVED***
        var bb = new ByteBuffer(3);
        if (type === ArrayBuffer) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.misc = ***REMOVED******REMOVED***;
    
    suite.misc.pbjsi19 = function(test) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    suite.misc.NaN = function(test) ***REMOVED***
        var bb = new ByteBuffer(4);
    ...
    ***REMOVED***;
    ...
    suite.debug = ***REMOVED******REMOVED***;

    suite.debug.printDebug = function(test) ***REMOVED***
        var bb = new ByteBuffer(3);
        function callMe() ***REMOVED*** callMe.called = true; ***REMOVED***
    ...
    ***REMOVED***;
    ...
    if (type === ArrayBuffer) ***REMOVED***
        suite.debug.printDebugVisual = function(test) ***REMOVED***
