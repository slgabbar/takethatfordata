...
(function(global, factory) ***REMOVED***
    ...
    /* CommonJS */ else if (typeof require === 'function' && typeof module === "object" && module && module["exports"])
        module['exports'] = (function() ***REMOVED***
            var Long; try ***REMOVED*** Long = require("long"); ***REMOVED*** catch (e) ***REMOVED******REMOVED***
            return factory(Long);
        ***REMOVED***)();
    /* Global */ else
        (global["dcodeIO"] = global["dcodeIO"] || ***REMOVED******REMOVED***)["ByteBuffer"] = factory(global["dcodeIO"]["Long"]);

***REMOVED***)(this, function(Long) ***REMOVED***
    "use strict";
    ...
    ***REMOVED***;
     ...
     * @function
     * @param ***REMOVED***!ByteBuffer|!ArrayBuffer|!Uint8Array|string***REMOVED*** source Data to write. If `source` is a ByteBuffer, its offsets
    ...
    ***REMOVED***;
     ...
     * @param ***REMOVED***!ByteBuffer|string|!ArrayBuffer***REMOVED*** source Data to prepend. If `source` is a ByteBuffer, its offset will be
    ...
    ***REMOVED***;
    ...
    var lxiv = function() ***REMOVED***
         ...
         * @param ***REMOVED***!function():number|null***REMOVED*** src Bytes source as a function returning the next byte respectively `null` if
         *  there are no more bytes left.
         * @param ***REMOVED***!function(number)***REMOVED*** dst Characters destination as a function successively called with each encoded char
         *  code.
         */
        lxiv.encode = function(src, dst) ***REMOVED***
            var b, t;
            while ((b = src()) !== null) ***REMOVED***
                dst(aout[(b>>2)&0x3f]);
                t = (b&0x3)<<4;
                if ((b = src()) !== null) ***REMOVED***
                    t |= (b>>4)&0xf;
        ...
        ***REMOVED***;
         ...
         * @throws ***REMOVED***Error***REMOVED*** If a character code is invalid
         */
        lxiv.decode = function(src, dst) ***REMOVED***
            var c, t1, t2;
            function fail(c) ***REMOVED***
                throw Error("Illegal character code: "+c);
            ***REMOVED***
            while ((c = src()) !== null) ***REMOVED***
                t1 = ain[c];
                if (typeof t1 === 'undefined') fail(c);
                if ((c = src()) !== null) ***REMOVED***
                    t2 = ain[c];
        ...
        ***REMOVED***;
         ...
         * @returns ***REMOVED***boolean***REMOVED*** `true` if valid, otherwise `false`
         */
        lxiv.test = function(str) ***REMOVED***
            return /^(?:[A-Za-z0-9+/]***REMOVED***4***REMOVED***)*(?:[A-Za-z0-9+/]***REMOVED***2***REMOVED***==|[A-Za-z0-9+/]***REMOVED***3***REMOVED***=)?$/.test(str);
        ***REMOVED***;
