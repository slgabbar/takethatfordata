...
(function(global, factory) ***REMOVED***
    ...
    /* Global */ else
        (global["dcodeIO"] = global["dcodeIO"] || ***REMOVED******REMOVED***)["ProtoBuf"] = factory(global["dcodeIO"]["ByteBuffer"]);

***REMOVED***)(this, function(ByteBuffer, isCommonJS) ***REMOVED***
    "use strict";
    ...
    ***REMOVED***)();
     ...
     * @type ***REMOVED***!Object.&lt;string,!RegExp>***REMOVED***
     * @expose
     */
    ProtoBuf.Lang = ***REMOVED***

        // Characters always ending a statement
        DELIM: /[\s\***REMOVED***\***REMOVED***=;:\[\],'"\(\)&lt;>]/g,
    ...
    ***REMOVED***;
     ...
     * @expose
     */
    ProtoBuf.DotProto = (function(ProtoBuf, Lang) ***REMOVED***
        "use strict";
    ...
    ***REMOVED***)(ProtoBuf, ProtoBuf.Lang);

    /**
     * @alias ProtoBuf.Reflect
     * @expose
     */
    ProtoBuf.Reflect = (function(ProtoBuf) ***REMOVED***
        "use strict";
         ...
         * @param ***REMOVED***?ProtoBuf.Reflect.T***REMOVED*** parent Parent object
         * @param ***REMOVED***string***REMOVED*** name Object name
         */
        var T = function(builder, parent, name) ***REMOVED***

            /**
             * Builder reference.
             * @type ***REMOVED***!ProtoBuf.Builder***REMOVED***
             * @expose
             */
            ...
            /**
             * Parent object.
             * @type ***REMOVED***?ProtoBuf.Reflect.T***REMOVED***
             * @expose
             */
            this.parent = parent;
        ...
        ***REMOVED***;
         ...
         * @returns ***REMOVED***string***REMOVED*** Fully qualified name as of ".PATH.TO.THIS"
         * @expose
         */
        TPrototype.fqn = function() ***REMOVED***
            var name = this.name,
                ptr = this;
            do ***REMOVED***
                ptr = ptr.parent;
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***boolean=***REMOVED*** includeClass Set to true to include the class name. Defaults to false.
         * @return String representation
         * @expose
         */
        TPrototype.toString = function(includeClass) ***REMOVED***
            return (includeClass ? this.className + " " : "") + this.fqn();
        ***REMOVED***;

        /**
         * Builds this type.
         * @throws ***REMOVED***Error***REMOVED*** If this type cannot be built directly
         * @expose
         */
        TPrototype.build = function() ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder***REMOVED*** builder Builder reference
         * @param ***REMOVED***!ProtoBuf.Reflect.Namespace***REMOVED*** parent Parent message or namespace
         * @param ***REMOVED***string***REMOVED*** name Message name
         * @param ***REMOVED***Object.&lt;string,*>=***REMOVED*** options Message options
         * @param ***REMOVED***boolean=***REMOVED*** isGroup `true` if this is a legacy group
         * @param ***REMOVED***string?***REMOVED*** syntax The syntax level of this definition (e.g., proto3)
         * @constructor
         * @extends ProtoBuf.Reflect.Namespace
         */
        var Message = function(builder, parent, name, options, isGroup, syntax) ***REMOVED***
            ...
            /**
             * Extensions range.
             * @type ***REMOVED***!Array.&lt;number>|undefined***REMOVED***
             * @expose
             */
             ...
             * @type ***REMOVED***?function(new:ProtoBuf.Builder.Message)***REMOVED***
             * @expose
             */
            this.clazz = null;
            ...
            /**
             * Cached fields.
             * @type ***REMOVED***?Array.&lt;!ProtoBuf.Reflect.Message.Field>***REMOVED***
             * @private
             */
            this._fields = null;
            ...
            /**
             * Cached fields by id.
             * @type ***REMOVED***?Object.&lt;number,!ProtoBuf.Reflect.Message.Field>***REMOVED***
             * @private
             */
             ...
             * @type ***REMOVED***?Object.&lt;string,!ProtoBuf.Reflect.Message.Field>***REMOVED***
             * @private
             */
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***boolean=***REMOVED*** rebuild Whether to rebuild or not, defaults to false
         * @return ***REMOVED***ProtoBuf.Reflect.Message***REMOVED*** Message class
         * @throws ***REMOVED***Error***REMOVED*** If the message cannot be built
         * @expose
         */
        MessagePrototype.build = function(rebuild) ***REMOVED***
            if (this.clazz &amp;&amp; !rebuild)
                return this.clazz;

            // Create the runtime Message class in its own scope
            var clazz = (function(ProtoBuf, T) ***REMOVED***
            ...
            ***REMOVED***)(ProtoBuf, this);
            ...
            this._fieldsByName = ***REMOVED******REMOVED***;
            this._oneofsByName = ***REMOVED******REMOVED***;
            for (var i=0, k=this.children.length, child; i&lt;k; i++) ***REMOVED***
                child = this.children[i];
                if (child instanceof Enum || child instanceof Message || child instanceof Service) ***REMOVED***
                    if (clazz.hasOwnProperty(child.name))
                        throw Error("Illegal reflect child of "+this.toString(true)+": "+child.toString(true)+" cannot override static property '"+child.name+"'");
                    clazz[child.name] = child.build();
                ***REMOVED*** else if (child instanceof Message.Field)
                    child.build(),
                    this._fields.push(child),
                    this._fieldsById[child.id] = child,
                    this._fieldsByName[child.name] = child;
                else if (child instanceof Message.OneOf) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder.Message***REMOVED*** message Runtime message to encode
         * @param ***REMOVED***ByteBuffer***REMOVED*** buffer ByteBuffer to write to
         * @param ***REMOVED***boolean=***REMOVED*** noVerify Whether to not verify field values, defaults to `false`
         * @return ***REMOVED***ByteBuffer***REMOVED*** The ByteBuffer for chaining
         * @throws ***REMOVED***Error***REMOVED*** If required fields are missing or the message cannot be encoded for another reason
         * @expose
         */
        MessagePrototype.encode = function(message, buffer, noVerify) ***REMOVED***
            var fieldMissing = null,
                field;
            for (var i=0, k=this._fields.length, val; i&lt;k; ++i) ***REMOVED***
                field = this._fields[i];
                val = message[field.name];
                if (field.required &amp;&amp; val === null) ***REMOVED***
                    if (fieldMissing === null)
                        fieldMissing = field;
                ***REMOVED*** else
                    field.encode(noVerify ? val : field.verifyValue(val), buffer, message);
            ***REMOVED***
            if (fieldMissing !== null) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder.Message***REMOVED*** message Runtime message to encode
         * @returns ***REMOVED***number***REMOVED*** Byte length
         * @throws ***REMOVED***Error***REMOVED*** If required fields are missing or the message cannot be calculated for another reason
         * @expose
         */
        MessagePrototype.calculate = function(message) ***REMOVED***
            for (var n=0, i=0, k=this._fields.length, field, val; i&lt;k; ++i) ***REMOVED***
                field = this._fields[i];
                val = message[field.name];
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***number***REMOVED*** expectedId Expected GROUPEND id
         * @param ***REMOVED***!ByteBuffer***REMOVED*** buf ByteBuffer
         * @returns ***REMOVED***boolean***REMOVED*** `true` if a value as been skipped, `false` if the end has been reached
         * @throws ***REMOVED***Error***REMOVED*** If it wasn't possible to find the end of the group (buffer overrun or end tag mismatch)
         * @inner
         */
        function skipTillGroupEnd(expectedId, buf) ***REMOVED***
        ...
        ***REMOVED***
         ...
         * @param ***REMOVED***ByteBuffer***REMOVED*** buffer ByteBuffer to decode from
         * @param ***REMOVED***number=***REMOVED*** length Message length. Defaults to decode all remaining data.
         * @param ***REMOVED***number=***REMOVED*** expectedGroupEndId Expected GROUPEND id if this is a legacy group
         * @return ***REMOVED***ProtoBuf.Builder.Message***REMOVED*** Decoded message
         * @throws ***REMOVED***Error***REMOVED*** If the message cannot be decoded
         * @expose
         */
        MessagePrototype.decode = function(buffer, length, expectedGroupEndId) ***REMOVED***
            if (typeof length !== 'number')
                length = -1;
            var start = buffer.offset,
                msg = new (this.clazz)(),
                tag, wireType, id, field;
            while (buffer.offset &lt; start+length || (length === -1 &amp;&amp; buffer.remaining() > 0)) ***REMOVED***
                tag = buffer.readVarint32();
                wireType = tag &amp; 0x07;
                id = tag >>> 3;
                if (wireType === ProtoBuf.WIRE_TYPES.ENDGROUP) ***REMOVED***
                    if (id !== expectedGroupEndId)
                        throw Error("Illegal group end indicator for "+this.toString(true)+": "+id+" ("+(expectedGroupEndId ? expectedGroupEndId+" expected" : "not a group")+")");
                    break;
                ***REMOVED***
                if (!(field = this._fieldsById[id])) ***REMOVED***
                    ...
                    switch (wireType) ***REMOVED***
                        ...
                        case ProtoBuf.WIRE_TYPES.LDELIM:
                            ...
                            break;
                        case ProtoBuf.WIRE_TYPES.STARTGROUP:
                            while (skipTillGroupEnd(id, buffer)) ***REMOVED******REMOVED***
                            break;
                        default:
                    ...
                    ***REMOVED***
                    continue;
                ***REMOVED***
                if (field.repeated &amp;&amp; !field.options["packed"]) ***REMOVED***
                    msg[field.name].push(field.decode(wireType, buffer));
                ***REMOVED*** else if (field.map) ***REMOVED***
                    var keyval = field.decode(wireType, buffer);
                    msg[field.name].set(keyval[0], keyval[1]);
                ***REMOVED*** else ***REMOVED***
                    msg[field.name] = field.decode(wireType, buffer);
                    if (field.oneof) ***REMOVED*** // Field is part of an OneOf (not a virtual OneOf field)
            ...
            ***REMOVED***
            ...
            for (var i=0, k=this._fields.length; i&lt;k; ++i) ***REMOVED***
                field = this._fields[i];
                if (msg[field.name] === null) ***REMOVED***
                    if (this.syntax === "proto3") ***REMOVED*** // Proto3 sets default values by specification
                        msg[field.name] = field.defaultValue;
                    ***REMOVED*** else if (field.required) ***REMOVED***
                        var err = Error("Missing at least one required field for " + this.toString(true) + ": " + field.name);
                        err["decoded"] = msg; // Still expose what we got
                        throw(err);
                    ***REMOVED*** else if (ProtoBuf.populateDefaults &amp;&amp; field.defaultValue !== null)
                        msg[field.name] = field.defaultValue;
                ***REMOVED***
            ***REMOVED***
            return msg;
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder***REMOVED*** builder Builder reference
         * @param ***REMOVED***!ProtoBuf.Reflect.Message***REMOVED*** message Message reference
         * @param ***REMOVED***string***REMOVED*** rule Rule, one of requried, optional, repeated
         * @param ***REMOVED***string?***REMOVED*** keytype Key data type, if any.
         * @param ***REMOVED***string***REMOVED*** type Data type, e.g. int32
         * @param ***REMOVED***string***REMOVED*** name Field name
         * @param ***REMOVED***number***REMOVED*** id Unique field id
         * @param ***REMOVED***Object.&lt;string,*>=***REMOVED*** options Options
         * @param ***REMOVED***!ProtoBuf.Reflect.Message.OneOf=***REMOVED*** oneof Enclosing OneOf
         * @param ***REMOVED***string?***REMOVED*** syntax The syntax level of this definition (e.g., proto3)
         * @constructor
         * @extends ProtoBuf.Reflect.T
         */
        var Field = function(builder, message, rule, keytype, type, name, id, options, oneof, syntax) ***REMOVED***
             ...
             * @type ***REMOVED***string|***REMOVED***name: string, wireType: number***REMOVED***|null***REMOVED***
             * @expose
             */
             ...
             * @type ***REMOVED***string|***REMOVED***name: string, wireType: number***REMOVED******REMOVED***
             * @expose
             */
            this.type = type;
            ...
            /**
             * Enclosing OneOf.
             * @type ***REMOVED***?ProtoBuf.Reflect.Message.OneOf***REMOVED***
             * @expose
             */
             ...
             * @type ***REMOVED***ProtoBuf.Element***REMOVED***
             * @expose
             */
            this.element = null;
        ...
        ***REMOVED***;
         ...
         * @expose
         */
        FieldPrototype.build = function() ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED*******REMOVED*** value Value to check
         * @param ***REMOVED***boolean=***REMOVED*** skipRepeated Whether to skip the repeated value check or not. Defaults to false.
         * @return ***REMOVED*******REMOVED*** Verified, maybe adjusted, value
         * @throws ***REMOVED***Error***REMOVED*** If the value cannot be set for this field
         * @expose
         */
        FieldPrototype.verifyValue = function(value, skipRepeated) ***REMOVED***
            skipRepeated = skipRepeated || false;
            var self = this;
            function fail(val, msg) ***REMOVED***
                throw Error("Illegal value for "+self.toString(true)+" of type "+self.type.name+": "+val+" ("+msg+")");
            ***REMOVED***
            if (value === null) ***REMOVED*** // NULL values for optional fields
                if (this.required)
            ...
            ***REMOVED***
            var i;
            if (this.repeated &amp;&amp; !skipRepeated) ***REMOVED*** // Repeated values as arrays
                ...
                return res;
            ***REMOVED***
            if (this.map &amp;&amp; !skipRepeated) ***REMOVED*** // Map values as objects
                if (!(value instanceof ProtoBuf.Map)) ***REMOVED***
                    // If not already a Map, attempt to convert.
                    if (!(value instanceof Object)) ***REMOVED***
                        fail(typeof value,
        ...
        ***REMOVED***;
         ...
         * value.
         * @param ***REMOVED*******REMOVED*** value Verified field value
         * @param ***REMOVED***!ProtoBuf.Builder.Message***REMOVED*** message Runtime message
         * @return ***REMOVED***boolean***REMOVED*** Whether the field will be present on the wire
         */
        FieldPrototype.hasWirePresence = function(value, message) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder.Message***REMOVED*** message Runtime message
         * @return ***REMOVED***ByteBuffer***REMOVED*** The ByteBuffer for chaining
         * @throws ***REMOVED***Error***REMOVED*** If the field cannot be encoded
         * @expose
         */
        FieldPrototype.encode = function(value, buffer, message) ***REMOVED***
            if (this.type === null || typeof this.type !== 'object')
                throw Error("[INTERNAL] Unresolved type in "+this.toString(true)+": "+this.type);
            if (value === null || (this.repeated &amp;&amp; value.length == 0))
                return buffer; // Optional omitted
            try ***REMOVED***
                if (this.repeated) ***REMOVED***
                    var i;
                    // "Only repeated fields of primitive numeric types (types which use the varint, 32-bit, or 64-bit wire
                    // types) can be declared 'packed'."
                    if (this.options["packed"] &amp;&amp; ProtoBuf.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) ***REMOVED***
                        ...
                        if (varintLen > 1) ***REMOVED*** // We need to move the contents
                    ...
                    ***REMOVED*** else ***REMOVED***
                        ...
                        for (i=0; i&lt;value.length; i++)
                            ...
                            this.element.encodeValue(this.id, value[i], buffer);
                    ***REMOVED***
                ***REMOVED*** else if (this.map) ***REMOVED***
                    // Write out each map entry as a submessage.
                    value.forEach(function(val, key, m) ***REMOVED***
                    ...
                    ***REMOVED***, this);
                ***REMOVED*** else ***REMOVED***
                    if (this.hasWirePresence(value, message)) ***REMOVED***
                        buffer.writeVarint32((this.id &lt;&lt; 3) | this.type.wireType);
        ...
        ***REMOVED***;
         ...
         * @expose
         */
        FieldPrototype.calculate = function(value, message) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***number***REMOVED*** wireType Leading wire type
         * @param ***REMOVED***ByteBuffer***REMOVED*** buffer ByteBuffer to decode from
         * @param ***REMOVED***boolean=***REMOVED*** skipRepeated Whether to skip the repeated check or not. Defaults to false.
         * @return ***REMOVED*******REMOVED*** Decoded value: array for packed repeated fields, [key, value] for
         *             map fields, or an individual value otherwise.
         * @throws ***REMOVED***Error***REMOVED*** If the field cannot be decoded
         * @expose
         */
        FieldPrototype.decode = function(wireType, buffer, skipRepeated) ***REMOVED***
            var value, nBytes;
            ...
            if (wireType == ProtoBuf.WIRE_TYPES.LDELIM &amp;&amp; this.repeated &amp;&amp; this.options["packed"] &amp;&amp; ProtoBuf.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) ***REMOVED***
                if (!skipRepeated) ***REMOVED***
                    nBytes = buffer.readVarint32();
            ...
            ***REMOVED***
            ...
            if (this.map) ***REMOVED***
                ...
                while (msgbuf.remaining() > 0) ***REMOVED***
                    var tag = msgbuf.readVarint32();
                    wireType = tag &amp; 0x07;
                    var id = tag >>> 3;
                    if (id === 1) ***REMOVED***
                        key = this.keyElement.decode(msgbuf, wireType, id);
                    ***REMOVED*** else if (id === 2) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         */
        var ExtensionField = function(builder, message, rule, type, name, id, options) ***REMOVED***
            Field.call(this, builder, message, rule, /* keytype = */ null, type, name, id, options);

            /**
             * Extension reference.
             * @type ***REMOVED***!ProtoBuf.Reflect.Extension***REMOVED***
             * @expose
             */
            this.extension;
        ***REMOVED***;
         ...
         * @extends ProtoBuf.Reflect.T
         */
        var OneOf = function(builder, message, name) ***REMOVED***
            T.call(this, builder, message, name);
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder***REMOVED*** builder Builder reference
         * @param ***REMOVED***!ProtoBuf.Reflect.T***REMOVED*** parent Parent Reflect object
         * @param ***REMOVED***string***REMOVED*** name Enum name
         * @param ***REMOVED***Object.&lt;string,*>=***REMOVED*** options Enum options
         * @param ***REMOVED***string?***REMOVED*** syntax The syntax level (e.g., proto3)
         * @constructor
         * @extends ProtoBuf.Reflect.Namespace
         */
        var Enum = function(builder, parent, name, options, syntax) ***REMOVED***
            Namespace.call(this, builder, parent, name, options, syntax);
            ...
            /**
             * Runtime enum object.
             * @type ***REMOVED***Object.&lt;string,number>|null***REMOVED***
             * @expose
             */
            this.object = null;
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder.Enum***REMOVED*** enm Runtime enum
         * @param ***REMOVED***number***REMOVED*** value Enum value
         * @returns ***REMOVED***?string***REMOVED*** Name or `null` if not present
         * @expose
         */
        Enum.getName = function(enm, value) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***boolean***REMOVED*** rebuild Whether to rebuild or not, defaults to false
         * @returns ***REMOVED***!Object.&lt;string,number>***REMOVED***
         * @expose
         */
        EnumPrototype.build = function(rebuild) ***REMOVED***
            ...
            if (Object.defineProperty)
                Object.defineProperty(enm, '$options', ***REMOVED***
                    "value": this.buildOpt(),
                    "enumerable": false
                ***REMOVED***);
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder***REMOVED*** builder Builder reference
         * @param ***REMOVED***!ProtoBuf.Reflect.Enum***REMOVED*** enm Enum reference
         * @param ***REMOVED***string***REMOVED*** name Field name
         * @param ***REMOVED***number***REMOVED*** id Unique field id
         * @constructor
         * @extends ProtoBuf.Reflect.T
         */
        var Value = function(builder, enm, name, id) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Reflect.T***REMOVED*** parent Parent object
         * @param ***REMOVED***string***REMOVED*** name Object name
         * @param ***REMOVED***!ProtoBuf.Reflect.Message.Field***REMOVED*** field Extension field
         */
        var Extension = function(builder, parent, name, field) ***REMOVED***
            T.call(this, builder, parent, name);

            /**
             * Extended message field.
             * @type ***REMOVED***!ProtoBuf.Reflect.Message.Field***REMOVED***
             * @expose
             */
            this.field = field;
        ***REMOVED***;
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Builder***REMOVED*** builder Builder reference
         * @param ***REMOVED***!ProtoBuf.Reflect.Service***REMOVED*** svc Service
         * @param ***REMOVED***string***REMOVED*** name Method name
         * @param ***REMOVED***Object.&lt;string,*>=***REMOVED*** options Options
         * @constructor
         * @extends ProtoBuf.Reflect.T
         */
        var Method = function(builder, svc, name, options) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!ProtoBuf.Reflect.Service***REMOVED*** svc Service
         * @param ***REMOVED***string***REMOVED*** name Method name
         * @param ***REMOVED***string***REMOVED*** request Request message name
         * @param ***REMOVED***string***REMOVED*** response Response message name
         * @param ***REMOVED***boolean***REMOVED*** request_stream Whether requests are streamed
         * @param ***REMOVED***boolean***REMOVED*** response_stream Whether responses are streamed
         * @param ***REMOVED***Object.&lt;string,*>=***REMOVED*** options Options
         * @constructor
         * @extends ProtoBuf.Reflect.Service.Method
         */
        var RPCMethod = function(builder, svc, name, request, response, request_stream, response_stream, options) ***REMOVED***
    ...
    ***REMOVED***)(ProtoBuf);
     ...
     * @expose
     */
    ProtoBuf.Builder = (function(ProtoBuf, Lang, Reflect) ***REMOVED***
        "use strict";
         ...
         * @constructor
         */
        var Builder = function(options) ***REMOVED***

            /**
             * Namespace.
             * @type ***REMOVED***ProtoBuf.Reflect.Namespace***REMOVED***
             * @expose
             */
             ...
             * @type ***REMOVED***Object.&lt;string,ProtoBuf.Builder.Message|Object>|null***REMOVED***
             * @expose
             */
            this.result = null;
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!Object***REMOVED*** def
         * @returns ***REMOVED***boolean***REMOVED***
         * @expose
         */
        Builder.isMessage = function(def) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @expose
         */
        Builder.isMessageField = function(def) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @expose
         */
        Builder.isEnum = function(def) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @expose
         */
        Builder.isService = function(def) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @expose
         */
        Builder.isExtend = function(def) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @returns ***REMOVED***!ProtoBuf.Builder***REMOVED*** this
         * @expose
         */
        BuilderPrototype.reset = function() ***REMOVED***
            this.ptr = this.ns;
            return this;
        ***REMOVED***;
         ...
         * @return ***REMOVED***!ProtoBuf.Builder***REMOVED*** this
         * @expose
         */
        BuilderPrototype.define = function(namespace) ***REMOVED***
            if (typeof namespace !== 'string' || !Lang.TYPEREF.test(namespace))
                throw Error("illegal namespace: "+namespace);
            namespace.split(".").forEach(function(part) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***!Array.&lt;!Object>***REMOVED*** defs Messages, enums or services to create
         * @returns ***REMOVED***!ProtoBuf.Builder***REMOVED*** this
         * @throws ***REMOVED***Error***REMOVED*** If a message definition is invalid
         * @expose
         */
        BuilderPrototype.create = function(defs) ***REMOVED***
            if (!defs)
            ...
            ***REMOVED***
            ...
            while (stack.length > 0) ***REMOVED***
                ...
                while (defs.length > 0) ***REMOVED***
                    var def = defs.shift(); // Namespaces always contain an array of messages, enums and services

                    if (Builder.isMessage(def)) ***REMOVED***
                        var obj = new Reflect.Message(this, this.ptr, def["name"], def["options"], def["isGroup"], def["syntax"]);

                        // Create OneOfs
                        var oneofs = ***REMOVED******REMOVED***;
                        if (def["oneofs"])
                            Object.keys(def["oneofs"]).forEach(function(name) ***REMOVED***
                                obj.addChild(oneofs[name] = new Reflect.Message.OneOf(this, obj, name));
                            ***REMOVED***, this);

                        // Create fields
                        if (def["fields"])
                            def["fields"].forEach(function(fld) ***REMOVED***
                        ...
                        var subObj = [];
                        if (def["enums"])
                            def["enums"].forEach(function(enm) ***REMOVED***
                                subObj.push(enm);
                            ***REMOVED***);
                        if (def["messages"])
                            def["messages"].forEach(function(msg) ***REMOVED***
                                subObj.push(msg);
                            ***REMOVED***);
                        if (def["services"])
                            def["services"].forEach(function(svc) ***REMOVED***
                                subObj.push(svc);
                            ***REMOVED***);

                        // Set extension ranges
                        if (def["extensions"]) ***REMOVED***
                    ...
                    ***REMOVED*** else if (Builder.isEnum(def)) ***REMOVED***

                        obj = new Reflect.Enum(this, this.ptr, def["name"], def["options"], def["syntax"]);
                        def["values"].forEach(function(val) ***REMOVED***
                            obj.addChild(new Reflect.Enum.Value(this, obj, val["name"], val["id"]));
                        ***REMOVED***, this);
                        this.ptr.addChild(obj);

                    ***REMOVED*** else if (Builder.isService(def)) ***REMOVED***

                        obj = new Reflect.Service(this, this.ptr, def["name"], def["options"]);
                        Object.keys(def["rpc"]).forEach(function(name) ***REMOVED***
                            var mtd = def["rpc"][name];
                            obj.addChild(new Reflect.Service.RPCMethod(this, obj, name, mtd["request"], mtd["response"], !!mtd["request_stream"], !!mtd["response_stream"], mtd["options"]));
                        ***REMOVED***, this);
                        this.ptr.addChild(obj);

                    ***REMOVED*** else if (Builder.isExtend(def)) ***REMOVED***
                        ...
                        if (obj) ***REMOVED***
                            def["fields"].forEach(function(fld) ***REMOVED***
                                ...
                                if (obj.extensions) ***REMOVED***
                                    var valid = false;
                                    obj.extensions.forEach(function(range) ***REMOVED***
                        ...
                        ***REMOVED*** else if (!/\.?google\.protobuf\./.test(def["ref"])) // Silently skip internal extensions
        ...
        ***REMOVED***;
         ...
         * @inner
         */
        function propagateSyntax(parent) ***REMOVED***
            if (parent['messages']) ***REMOVED***
                parent['messages'].forEach(function(child) ***REMOVED***
                    child["syntax"] = parent["syntax"];
                    propagateSyntax(child);
                ***REMOVED***);
            ***REMOVED***
            if (parent['enums']) ***REMOVED***
                parent['enums'].forEach(function(child) ***REMOVED***
                    child["syntax"] = parent["syntax"];
                ***REMOVED***);
            ***REMOVED***
        ***REMOVED***
         ...
         * @param ***REMOVED***Object.&lt;string,*>***REMOVED*** json Parsed import
         * @param ***REMOVED***(string|***REMOVED***root: string, file: string***REMOVED***)=***REMOVED*** filename Imported file name
         * @returns ***REMOVED***!ProtoBuf.Builder***REMOVED*** this
         * @throws ***REMOVED***Error***REMOVED*** If the definition or file cannot be imported
         * @expose
         */
        BuilderPrototype["import"] = function(json, filename) ***REMOVED***
            var delim = '/';

            // Make sure to skip duplicate imports

            if (typeof filename === 'string') ***REMOVED***
            ...
            ***REMOVED*** else if (typeof filename === 'object') ***REMOVED*** // Object with root, file.
            ...
            ***REMOVED***
            ...
            if (json['imports'] &amp;&amp; json['imports'].length > 0) ***REMOVED***
                var importRoot,
                    resetRoot = false;

                if (typeof filename === 'object') ***REMOVED*** // If an import root is specified, override
                ...
                ***REMOVED*** else if (typeof filename === 'string') ***REMOVED***

                    if (this.importRoot) // If import root is overridden, use it
                        importRoot = this.importRoot;
                    else ***REMOVED*** // Otherwise compute from filename
                        if (filename.indexOf("/") >= 0) ***REMOVED*** // Unix
                            importRoot = filename.replace(/\/[^\/]*$/, "");
                            if (/* /file.proto */ importRoot === "")
                                importRoot = "/";
                        ***REMOVED*** else if (filename.indexOf("\\") >= 0) ***REMOVED*** // Windows
                            importRoot = filename.replace(/\\[^\\]*$/, "");
                            delim = '\\';
                        ***REMOVED*** else
                            importRoot = ".";
                ...
                ***REMOVED*** else
                ...
                for (var i=0; i&lt;json['imports'].length; i++) ***REMOVED***
                    if (typeof json['imports'][i] === 'string') ***REMOVED*** // Import file
                        if (!importRoot)
                    ...
                    ***REMOVED*** else // Import structure
                        if (!filename)
                            this["import"](json['imports'][i]);
                        else if (/\.(\w+)$/.test(filename)) // With extension: Append _importN to the name portion to make it unique
                            this["import"](json['imports'][i], filename.replace(/^(.+)\.(\w+)$/, function($0, $1, $2) ***REMOVED*** return $1+"_import"+i+"."+$2; ***REMOVED***));
            ...
            ***REMOVED***
            ...
            var base = this.ptr;
            if (json['options'])
                Object.keys(json['options']).forEach(function(key) ***REMOVED***
        ...
        ***REMOVED***;
         ...
         * @throws ***REMOVED***Error***REMOVED*** If a type cannot be resolved
         * @returns ***REMOVED***!ProtoBuf.Builder***REMOVED*** this
         * @expose
         */
        BuilderPrototype.resolveAll = function() ***REMOVED***
            // Resolve all reflected objects
            var res;
            if (this.ptr == null || typeof this.ptr.type === 'object')
                return this; // Done (already resolved)

            if (this.ptr instanceof Reflect.Namespace) ***REMOVED*** // Resolve children

                this.ptr.children.forEach(function(child) ***REMOVED***
                    this.ptr = child;
                    this.resolveAll();
                ***REMOVED***, this);

            ***REMOVED*** else if (this.ptr instanceof Reflect.Message.Field) ***REMOVED*** // Resolve type

                if (!Lang.TYPE.test(this.ptr.type)) ***REMOVED***
                    ...
                    if (res instanceof Reflect.Enum) ***REMOVED***
            ...
            ***REMOVED*** else if (this.ptr instanceof ProtoBuf.Reflect.Service.Method) ***REMOVED***

                if (this.ptr instanceof ProtoBuf.Reflect.Service.RPCMethod) ***REMOVED***
                ...
                ***REMOVED*** else // Should not happen as nothing else is implemented
        ...
        ***REMOVED***;
         ...
         * @param ***REMOVED***(string|Array.&lt;string>)=***REMOVED*** path Specifies what to return. If omitted, the entire namespace will be returned.
         * @returns ***REMOVED***!ProtoBuf.Builder.Message|!Object.&lt;string,*>***REMOVED***
         * @throws ***REMOVED***Error***REMOVED*** If a type could not be resolved
         * @expose
         */
        BuilderPrototype.build = function(path) ***REMOVED***
            this.reset();
            if (!this.resolved)
                this.resolveAll(),
                this.resolved = true,
        ...
        ***REMOVED***;
        ...
        /**
         * Similar to ***REMOVED***@link ProtoBuf.Builder#build***REMOVED***, but looks up the internal reflection descriptor.
         * @param ***REMOVED***string=***REMOVED*** path Specifies what to return. If omitted, the entire namespace wiil be returned.
         * @param ***REMOVED***boolean=***REMOVED*** excludeNonNamespace Excludes non-namespace types like fields, defaults to `false`
         * @returns ***REMOVED***?ProtoBuf.Reflect.T***REMOVED*** Reflection descriptor or `null` if not found
         */
        BuilderPrototype.lookup = function(path, excludeNonNamespace) ***REMOVED***
            return path ? this.ns.resolve(path, excludeNonNamespace) : this.ns;
        ***REMOVED***;

        /**
         * Returns a string representation of this object.
         * @return ***REMOVED***string***REMOVED*** String representation as of "Builder"
         * @expose
         */
        BuilderPrototype.toString = function() ***REMOVED***
            return "Builder";
        ***REMOVED***;
         ...
         */
        Builder.Message = function() ***REMOVED******REMOVED***;

        /**
         * @alias ProtoBuf.Builder.Enum
         */
        Builder.Enum = function() ***REMOVED******REMOVED***;

        /**
         * @alias ProtoBuf.Builder.Message
         */
        Builder.Service = function() ***REMOVED******REMOVED***;

        return Builder;

    ***REMOVED***)(ProtoBuf, ProtoBuf.Lang, ProtoBuf.Reflect);
