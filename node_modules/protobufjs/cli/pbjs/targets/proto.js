 ...
 * @function
 * @param ***REMOVED***!ProtoBuf.Builder***REMOVED*** builder Builder
 * @param ***REMOVED***!Object.<string,*>=***REMOVED*** options Options
 * @returns ***REMOVED***string***REMOVED***
 */
var proto = module.exports = function(builder, options) ***REMOVED***
    ...
    function trim() ***REMOVED***
        out[out.length-1] = out[out.length-1].replace(/\n***REMOVED***2,***REMOVED***$/, "\n");
    ***REMOVED***

    // Builds a set of top level options
    function buildOptions(opt, indent) ***REMOVED***
        var keys;
    ...
    ***REMOVED***
    ...
    function buildNamespace(ns, indent) ***REMOVED***
        ns.getChildren(ProtoBuf.Reflect.Enum).forEach(function(enm) ***REMOVED***
            buildEnum(enm, indent);
        ***REMOVED***);
        ns.getChildren(ProtoBuf.Reflect.Message).forEach(function(msg) ***REMOVED***
        ...
        ***REMOVED***);
        ...
        if (exts !== null) ***REMOVED***
            Object.keys(exts).forEach(function(extFqn) ***REMOVED***
                var extMsg = ns.resolve(extFqn),
                    extFields = exts[extFqn];
                if (!options.min)
                    out.push(indent);
                out.push("extend ", ns.qn(extMsg), options.min ? "***REMOVED***" : " ***REMOVED***\n");
                extFields.forEach(function(extField) ***REMOVED***
                    buildMessageField(ns, extField, indent+"    ", false);
                ***REMOVED***);
                if (!options.min)
                    out.push(indent);
                out.push(options.min ? "***REMOVED***" : "***REMOVED***\n\n");
            ***REMOVED***);
        ***REMOVED***
        ns.getChildren(ProtoBuf.Reflect.Service).forEach(function(svc) ***REMOVED***
            buildService(svc, indent);
        ***REMOVED***);
        ns.getChildren(ProtoBuf.Reflect.Namespace).forEach(function(innerNs) ***REMOVED***
            if (innerNs.className !== "Namespace")
                return;
            if (!options.min)
                out.push(indent);
            out.push("message ", innerNs.name, options.min ? "***REMOVED***" : " ***REMOVED***\n");
    ...
    ***REMOVED***
    ...
    // Builds a message
    function buildMessage(msg, indent) ***REMOVED***
        if (!msg.isGroup) ***REMOVED***
            if (!options.min)
                out.push(indent);
        ...
        ***REMOVED***
        ...
        var n = 0, oneofFields = [];
        msg.getChildren(ProtoBuf.Reflect.Message.OneOf).forEach(function(oneof) ***REMOVED***
            if (!options.min)
                out.push(indent, "    ");
            out.push("oneof ", oneof.name, options.min ? "***REMOVED***" : " ***REMOVED***\n");
            oneof.fields.forEach(function(fld) ***REMOVED***
            ...
            ***REMOVED***);
            ...
            out.push(options.min ? "***REMOVED***" : "***REMOVED***\n");
        ***REMOVED***);
        msg.getChildren(ProtoBuf.Reflect.Message.Field).forEach(function(fld) ***REMOVED***
        ...
        ***REMOVED***);
        if (n > 0 && !options.min)
            out[out.length-1] += "\n";
        if (msg.extensions) ***REMOVED*** // array of ranges
            if (!options.min)
                out.push(indent, "    ");
            out.push("extensions ");
            msg.extensions.forEach(function(range, index) ***REMOVED***
                if (index > 0)
    ...
    ***REMOVED***
    ...
    function buildMessageField(msg, fld, indent, isOneOf) ***REMOVED***
        var isGroup = false;
        if (!options.min)
            out.push(indent);
        if (!isOneOf)
            out.push(fld.required ? "required " : (fld.repeated ? "repeated " : "optional "));
        if (fld.resolvedType !== null) ***REMOVED***
            if (fld.resolvedType instanceof ProtoBuf.Reflect.Message && fld.resolvedType.isGroup) ***REMOVED***
    ...
    ***REMOVED***
    ...
    // Builds an enum
    function buildEnum(enm, indent) ***REMOVED***
        if (!options.min)
            out.push(indent);
        out.push("enum ", enm.name, options.min ? "***REMOVED***" : " ***REMOVED***\n");
        buildOptions(enm.options, indent+"    ");
        enm.getChildren(ProtoBuf.Reflect.Enum.Value).forEach(function(val) ***REMOVED***
            if (!options.min)
                out.push(indent, "    ");
    ...
    ***REMOVED***
    ...
    // Builds a service
    function buildService(svc, indent) ***REMOVED***
        if (!options.min)
            out.push(indent);
        out.push("service ", svc.name, options.min ? "***REMOVED***" : " ***REMOVED***\n");
        buildOptions(svc.options, indent+"    ");
        svc.getChildren(ProtoBuf.Reflect.Service.RPCMethod).forEach(function(rpc) ***REMOVED***
            if (!options.min)
                out.push(indent+"    ");
 ...
 * @param ***REMOVED*******REMOVED*** v Value
 * @returns ***REMOVED***string***REMOVED*** Dot proto value
 */
