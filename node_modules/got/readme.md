...
got('todomvc.com', ***REMOVED***
	agent: tunnel.httpOverHttp(***REMOVED***
		proxy: ***REMOVED***
			host: 'localhost'
		***REMOVED***
	***REMOVED***)
...
got(url, ***REMOVED***
	headers: oauth.toHeader(oauth.authorize(***REMOVED***url, method: 'GET'***REMOVED***, token)),
	json: true
***REMOVED***);
```
...
got('todomvc.com', ***REMOVED***
	headers: ***REMOVED***
		'user-agent': `my-module/$***REMOVED***pkg.version***REMOVED*** (https://github.com/username/my-module)`
	***REMOVED***
***REMOVED***);
```
