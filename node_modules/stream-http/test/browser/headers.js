...
test('headers', function (t) ***REMOVED***
	http.get(***REMOVED***
	...
	***REMOVED***, function (res) ***REMOVED***
		var rawHeaders = []
		for (var i = 0; i < res.rawHeaders.length; i += 2) ***REMOVED***
...
test('arrays of headers', function (t) ***REMOVED***
	http.get(***REMOVED***
...
test('content-type response header', function (t) ***REMOVED***
	http.get('/testHeaders', function (res) ***REMOVED***
...
test('content-type response header with forced streaming', function (t) ***REMOVED***
	http.get(***REMOVED***
		path: '/testHeaders',
		mode: 'prefer-streaming'
	***REMOVED***, function (res) ***REMOVED***
		if (wrongMimeType) ***REMOVED***
