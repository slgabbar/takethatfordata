...
* regex for matching `1` through `555` => `/([1-9]|[1-9][0-9]|[1-4][0-9]***REMOVED***2***REMOVED***|5[0-4][0-9]|55[0-5])/` (maybe not...)
* regex for matching `0001` through `5555` => `/(0***REMOVED***3***REMOVED***[1-9]|0***REMOVED***2***REMOVED***[1-9][0-9]|0[1-9][0-9]***REMOVED***2***REMOVED***|[1-4][0-9]***REMOVED***3***REMOVED***|5[0-4][0-9]***REMOVED***2***REMOVED***|55[0-4][0-9]|555[0-5])/` (okay, I get the point!)
