...
function printTree(tree) ***REMOVED***
  if(!tree) ***REMOVED***
    return []
  ***REMOVED***
...
function print(t) ***REMOVED***
  console.log(util.inspect(printTree(t.root), ***REMOVED***depth:12***REMOVED***))
***REMOVED***

//Ensures the red black axioms are satisfied by tree
function checkTree(tree, t) ***REMOVED***
  if(!tree.root) ***REMOVED***
    return
  ***REMOVED***
...
tape("insert()", function(t) ***REMOVED***
  var t1 = makeTree()
  
  var u = t1
  var arr = []
  for(var i=20; i>=0; --i) ***REMOVED***
    var x = i
  ...
  ***REMOVED***
  for(var i=-20; i<0; ++i) ***REMOVED***
    ...
    checkTree(u, t)
    checkTree(next, t)
    arr.sort(function(a,b) ***REMOVED*** return a-b ***REMOVED***)
    var ptr = 0
    u.forEach(function(k,v) ***REMOVED***
      t.equals(k, arr[ptr++])
    ***REMOVED***)
  ...
  ***REMOVED***
  ...
  var start = u.begin
  for(var i=-20, j=0; j<=40; ++i, ++j) ***REMOVED***
...
tape("foreach", function(t) ***REMOVED***
  var u = iota(31).reduce(function(u, k, v) ***REMOVED***
    return u.insert(k, v)
  ***REMOVED***, makeTree())
  ...
  ***REMOVED***)
  ...
  visit_keys = []
  visit_vals = []
  t.equals(u.forEach(function(k,v) ***REMOVED***
    if(k === 5) ***REMOVED***
      return 1000
    ***REMOVED***
    visit_keys.push(k)
...
function compareIterators(a, b, t) ***REMOVED***
...
tape("iterators", function(t) ***REMOVED***
  var u = iota(20).reduce(function(u, k, v) ***REMOVED***
    return u.insert(k, v)
  ***REMOVED***, makeTree())
...
tape("remove()", function(t) ***REMOVED***

  var sz = [1, 2,  10, 20, 23, 31, 32, 33]
  for(var n=0; n<sz.length; ++n) ***REMOVED***
    var c = sz[n]
    var u = iota(c).reduce(function(u, k, v) ***REMOVED***
      return u.insert(k, v)
    ***REMOVED***, makeTree())
...
tape("update()", function(t) ***REMOVED***
  var arr = [0, 1, 2, 3, 4, 5, 6 ]
  var u = arr.reduce(function(u, k, v) ***REMOVED***
    return u.insert(k, v)
  ***REMOVED***, makeTree())
  for(var iter=u.begin; iter.hasNext; iter.next()) ***REMOVED***
    var p = iter.value
...
tape("keys and values", function(t) ***REMOVED***

  var original_keys = [ "potato", "sock", "foot", "apple", "newspaper", "gameboy" ]
  var original_values = [ 42, 10, false, "!!!", ***REMOVED******REMOVED***, null ]

  var u = makeTree()
  for(var i=0; i<original_keys.length; ++i) ***REMOVED***
    u = u.insert(original_keys[i], original_values[i])
  ***REMOVED***

  var zipped = iota(6).map(function(i) ***REMOVED***
    return [ original_keys[i], original_values[i] ]
  ***REMOVED***)

  zipped.sort(function(a,b) ***REMOVED***
    if(a[0] < b[0]) ***REMOVED*** return -1 ***REMOVED***
    if(a[0] > b[0]) ***REMOVED*** return 1 ***REMOVED***
    return 0
  ***REMOVED***)

  var keys = zipped.map(function(v) ***REMOVED*** return v[0] ***REMOVED***)
  var values = zipped.map(function(v) ***REMOVED*** return v[1] ***REMOVED***)
...
tape("searching", function(t) ***REMOVED***
  ...
  ***REMOVED***, makeTree())
  ...
  for(var i=0; i<arr.length; ++i) ***REMOVED***
    if(arr[i] !== arr[i-1] && arr[i] !== arr[i+1]) ***REMOVED***
...
tape("slab-sequence", function(t) ***REMOVED***
...
tape("slab-sequence-2", function(t) ***REMOVED***
