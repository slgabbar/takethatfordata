(function() ***REMOVED***
  ...
  describe('ES6 class', function() ***REMOVED***
    it('declaration name creates class scope', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("class Derived extends Base ***REMOVED***\n    constructor() ***REMOVED***\n    ***REMOVED***\n***REMOVED***\nnew Derived();");
    ...
    ***REMOVED***);
    it('declaration name creates class scope', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("class Base ***REMOVED***\n    constructor() ***REMOVED***\n    ***REMOVED***\n***REMOVED***\nlet foo = new Base();");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      expect(scopeManager.scopes).to.have.length(3);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    it('expression name creates class scope#1', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("(class Derived extends Base ***REMOVED***\n    constructor() ***REMOVED***\n    ***REMOVED***\n***REMOVED***);");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
    ...
    ***REMOVED***);
    it('expression name creates class scope#2', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("(class extends Base ***REMOVED***\n    constructor() ***REMOVED***\n    ***REMOVED***\n***REMOVED***);");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      expect(scopeManager.scopes).to.have.length(3);
      ...
      return expect(scope.block.type).to.be.equal('FunctionExpression');
    ***REMOVED***);
    return it('computed property key may refer variables', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    var yuyushiki = 42;\n    (class ***REMOVED***\n        [yuyushiki]() ***REMOVED***\n        ***REMOVED***\n\n        [yuyushiki + 40]() ***REMOVED***\n        ***REMOVED***\n    ***REMOVED***);\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
