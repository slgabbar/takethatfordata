(function() ***REMOVED***
  ...
  describe('export declaration', function() ***REMOVED***
    it('should create vairable bindings', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export var v;", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
    ...
    ***REMOVED***);
    it('should create function declaration bindings', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export default function f()***REMOVED******REMOVED***;", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
      ...
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    it('should export function expression', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export default function()***REMOVED******REMOVED***;", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
      ...
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    it('should export literal', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export default 42;", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
      ...
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    it('should refer exported references#1', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export ***REMOVED***x***REMOVED***;", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
    ...
    ***REMOVED***);
    it('should refer exported references#2', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export ***REMOVED***v as x***REMOVED***;", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
    ...
    ***REMOVED***);
    it('should not refer exported references from other source#1', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export ***REMOVED***x***REMOVED*** from \"mod\";", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
      ...
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    it('should not refer exported references from other source#2', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export ***REMOVED***v as x***REMOVED*** from \"mod\";", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
      ...
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    return it('should not refer exported references from other source#3', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("export * from \"mod\";", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
