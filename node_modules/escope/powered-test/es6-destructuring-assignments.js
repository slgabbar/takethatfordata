(function() ***REMOVED***
  ...
  describe('ES6 destructuring assignments', function() ***REMOVED***
    it('Pattern in var in ForInStatement', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    for (var [a, b, c] in array);\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
    ...
    ***REMOVED***);
    it('ArrayPattern in var', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    var [a, b, c] = array;\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      ...
      return expect(scope.references[3].isWrite()).to.be["false"];
    ***REMOVED***);
    it('SpreadElement in var', function() ***REMOVED***
      ...
      ***REMOVED***);
      ...
      for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) ***REMOVED***
        name = _ref[index];
        expect(scope.variables[index].name).to.be.equal(name);
      ***REMOVED***
      expect(scope.references).to.have.length(6);
      _ref1 = ['a', 'b', 'c', 'd', 'rest'];
      for (index = _j = 0, _len1 = _ref1.length; _j < _len1; index = ++_j) ***REMOVED***
        name = _ref1[index];
    ...
    ***REMOVED***);
    it('ObjectPattern in var', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    var ***REMOVED***\n        shorthand,\n        key: value,\n        hello: ***REMOVED***\n            world\n        ***REMOVED***\n    ***REMOVED*** = object;\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      ...
      return expect(scope.references[3].isWrite()).to.be["false"];
    ***REMOVED***);
    it('complex pattern in var', function() ***REMOVED***
      var ast, globalScope, index, name, scope, scopeManager, _i, _j, _len, _len1, _ref, _ref1;
      ast = harmony.parse("(function () ***REMOVED***\n    var ***REMOVED***\n        shorthand,\n        key: [ a, b, c, d, e ],\n        hello: ***REMOVED***\n            world\n        ***REMOVED***\n    ***REMOVED*** = object;\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
    ...
    ***REMOVED***);
    it('ArrayPattern in AssignmentExpression', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    [a, b, c] = array;\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      ...
      expect(scope.implicit.left.map((function(_this) ***REMOVED***
        return function(ref) ***REMOVED***
          return ref.identifier.name;
        ***REMOVED***;
      ***REMOVED***)(this))).to.deep.equal(['a', 'b', 'c', 'array']);
      scope = scopeManager.scopes[1];
      expect(scope.type).to.be.equal('function');
      ...
      return expect(scope.references[3].isWrite()).to.be["false"];
    ***REMOVED***);
    it('SpreadElement in AssignmentExpression', function() ***REMOVED***
      ...
      ***REMOVED***);
      ...
      expect(scope.implicit.left.map((function(_this) ***REMOVED***
        return function(ref) ***REMOVED***
          return ref.identifier.name;
        ***REMOVED***;
      ***REMOVED***)(this))).to.deep.equal(['a', 'b', 'rest', 'array']);
      scope = scopeManager.scopes[1];
      expect(scope.type).to.be.equal('function');
      expect(scope.variables).to.have.length(1);
      expect(scope.variables[0].name).to.be.equal('arguments');
      ...
      ***REMOVED***);
      ...
      expect(scope.implicit.left.map((function(_this) ***REMOVED***
        return function(ref) ***REMOVED***
          return ref.identifier.name;
        ***REMOVED***;
      ***REMOVED***)(this))).to.deep.equal(['a', 'b', 'c', 'd', 'rest', 'array']);
      scope = scopeManager.scopes[1];
      expect(scope.type).to.be.equal('function');
      expect(scope.variables).to.have.length(1);
      expect(scope.variables[0].name).to.be.equal('arguments');
      ...
      ***REMOVED***
      ...
      return expect(scope.references[5].isWrite()).to.be["false"];
    ***REMOVED***);
    it('ObjectPattern in AssignmentExpression', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    (***REMOVED***\n        shorthand,\n        key: value,\n        hello: ***REMOVED***\n            world\n        ***REMOVED***\n    ***REMOVED***) = object;\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      ...
      expect(scope.implicit.left.map((function(_this) ***REMOVED***
        return function(ref) ***REMOVED***
          return ref.identifier.name;
        ***REMOVED***;
      ***REMOVED***)(this))).to.deep.equal(['shorthand', 'value', 'world', 'object']);
      scope = scopeManager.scopes[1];
      expect(scope.type).to.be.equal('function');
      expect(scope.variables).to.have.length(1);
      expect(scope.variables[0].name).to.be.equal('arguments');
      ...
      return expect(scope.references[3].isWrite()).to.be["false"];
    ***REMOVED***);
    it('complex pattern in AssignmentExpression', function() ***REMOVED***
      var ast, globalScope, index, name, scope, scopeManager, _i, _len, _ref;
      ast = harmony.parse("(function () ***REMOVED***\n    (***REMOVED***\n        shorthand,\n        key: [ a, b, c, d, e ],\n        hello: ***REMOVED***\n            world\n        ***REMOVED***\n    ***REMOVED***) = object;\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      ...
      expect(scope.implicit.left.map((function(_this) ***REMOVED***
        return function(ref) ***REMOVED***
          return ref.identifier.name;
        ***REMOVED***;
      ***REMOVED***)(this))).to.deep.equal(['shorthand', 'a', 'b', 'c', 'd', 'e', 'world', 'object']);
      scope = scopeManager.scopes[1];
      expect(scope.type).to.be.equal('function');
      expect(scope.variables).to.have.length(1);
      expect(scope.variables[0].name).to.be.equal('arguments');
      ...
      ***REMOVED***
      ...
      return expect(scope.references[7].isWrite()).to.be["false"];
    ***REMOVED***);
    it('ArrayPattern in parameters', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function ([a, b, c]) ***REMOVED***\n***REMOVED***(array));");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      expect(scopeManager.scopes).to.have.length(2);
    ...
    ***REMOVED***);
    it('SpreadElement in parameters', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function ([a, b, ...rest], ...rest2) ***REMOVED***\n***REMOVED***(array));");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      expect(scopeManager.scopes).to.have.length(2);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    it('ObjectPattern in parameters', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("(function (***REMOVED***\n        shorthand,\n        key: value,\n        hello: ***REMOVED***\n            world\n        ***REMOVED***\n    ***REMOVED***) ***REMOVED***\n***REMOVED***(object));");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    return it('complex pattern in parameters', function() ***REMOVED***
      var ast, globalScope, index, name, scope, scopeManager, _i, _len, _ref;
      ast = harmony.parse("(function (***REMOVED***\n        shorthand,\n        key: [ a, b, c, d, e ],\n        hello: ***REMOVED***\n            world\n        ***REMOVED***\n    ***REMOVED***) ***REMOVED***\n***REMOVED***(object));");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
