(function() ***REMOVED***
  ...
  describe('label', function() ***REMOVED***
    it('should not create variables', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = esprima.parse("function bar() ***REMOVED*** q: for(;;) ***REMOVED*** break q; ***REMOVED*** ***REMOVED***");
    ...
    ***REMOVED***);
    return it('should count child node references', function() ***REMOVED***
      var ast, globalScope, scopeManager;
      ast = esprima.parse("var foo = 5;\n\nlabel: while (true) ***REMOVED***\n  console.log(foo);\n  break;\n***REMOVED***");
      scopeManager = escope.analyze(ast);
