(function() ***REMOVED***
  ...
  describe('optimistic', function() ***REMOVED***
    it('direct call to eval', function() ***REMOVED***
      var ast, scopes;
      ast = esprima.parse("function outer() ***REMOVED***\n    eval(str);\n    var i = 20;\n    function inner() ***REMOVED***\n        i;\n    ***REMOVED***\n***REMOVED***");
      scopes = escope.analyze(ast, ***REMOVED***
        optimistic: true
      ***REMOVED***).scopes;
      return expect(scopes.map(function(scope) ***REMOVED***
        return scope.variables.map(function(variable) ***REMOVED***
          return variable.name;
        ***REMOVED***);
      ***REMOVED***)).to.be.eql([['outer'], ['arguments', 'i', 'inner'], ['arguments']]);
    ***REMOVED***);
    return it('with statement', function() ***REMOVED***
      var ast, scopes;
      ast = esprima.parse("function outer() ***REMOVED***\n    eval(str);\n    var i = 20;\n    with (obj) ***REMOVED***\n        i;\n    ***REMOVED***\n***REMOVED***");
      scopes = escope.analyze(ast, ***REMOVED***
        optimistic: true
      ***REMOVED***).scopes;
      return expect(scopes.map(function(scope) ***REMOVED***
        return scope.variables.map(function(variable) ***REMOVED***
          return variable.name;
        ***REMOVED***);
      ***REMOVED***)).to.be.eql([['outer'], ['arguments', 'i'], []]);
    ***REMOVED***);
  ***REMOVED***);
