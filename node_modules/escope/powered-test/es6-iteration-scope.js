(function() ***REMOVED***
  ...
  describe('ES6 iteration scope', function() ***REMOVED***
    it('let materialize iteration scope for ForInStatement#1', function() ***REMOVED***
      var ast, iterScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    let i = 20;\n    for (let i in i) ***REMOVED***\n        console.log(i);\n    ***REMOVED***\n***REMOVED***());");
    ...
    ***REMOVED***);
    it('let materialize iteration scope for ForInStatement#2', function() ***REMOVED***
      var ast, iterScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    let i = 20;\n    for (let ***REMOVED*** i, j, k ***REMOVED*** in i) ***REMOVED***\n        console.log(i);\n    ***REMOVED***\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      expect(scopeManager.scopes).to.have.length(5);
      ...
      return expect(scope.references[1].resolved).to.be.equal(iterScope.variables[0]);
    ***REMOVED***);
    return it('let materialize iteration scope for ForStatement#2', function() ***REMOVED***
      var ast, functionScope, iterScope, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    let i = 20;\n    let obj = ***REMOVED******REMOVED***;\n    for (let ***REMOVED*** i, j, k ***REMOVED*** = obj; i < okok; ++i) ***REMOVED***\n        console.log(i, j, k);\n    ***REMOVED***\n***REMOVED***());");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
