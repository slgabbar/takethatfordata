(function() ***REMOVED***
  ...
  describe('import declaration', function() ***REMOVED***
    it('should import names from source', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("import v from \"mod\";", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
    ...
    ***REMOVED***);
    it('should import namespaces', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("import * as ns from \"mod\";", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
      ...
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    it('should import insided names#1', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("import ***REMOVED***x***REMOVED*** from \"mod\";", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
      ...
      ***REMOVED***);
      ...
      return expect(scope.references).to.have.length(0);
    ***REMOVED***);
    return it('should import insided names#2', function() ***REMOVED***
      var ast, globalScope, scope, scopeManager;
      ast = harmony.parse("import ***REMOVED***x as v***REMOVED*** from \"mod\";", ***REMOVED***
        sourceType: 'module'
      ***REMOVED***);
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6,
