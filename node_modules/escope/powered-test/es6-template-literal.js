(function() ***REMOVED***
  ...
  describe('ES6 template literal', function() ***REMOVED***
    return it('refer variables', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("(function () ***REMOVED***\n    let i, j, k;\n    function testing() ***REMOVED*** ***REMOVED***\n    let template = testing`testing $***REMOVED***i***REMOVED*** and $***REMOVED***j***REMOVED***`\n    return template;\n***REMOVED***());");
