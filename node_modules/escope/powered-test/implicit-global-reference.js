(function() ***REMOVED***
  ...
  describe('implicit global reference', function() ***REMOVED***
    it('assignments global scope', function() ***REMOVED***
      var ast, scopes;
      ast = esprima.parse("var x = 20;\nx = 300;");
      scopes = escope.analyze(ast).scopes;
      expect(scopes.map(function(scope) ***REMOVED***
        return scope.variables.map(function(variable) ***REMOVED***
          return variable.defs.map(function(def) ***REMOVED***
            return def.type;
          ***REMOVED***);
        ***REMOVED***);
      ***REMOVED***)).to.be.eql([[['Variable']]]);
      return expect(scopes[0].implicit.variables.map(function(variable) ***REMOVED***
        return variable.name;
      ***REMOVED***)).to.be.eql([]);
    ***REMOVED***);
    it('assignments global scope without definition', function() ***REMOVED***
      var ast, scopes;
      ...
      ***REMOVED***)).to.be.eql(['x']);
    ***REMOVED***);
    it('assignments global scope without definition eval', function() ***REMOVED***
      var ast, scopes;
      ast = esprima.parse("function inner() ***REMOVED***\n    eval(str);\n    x = 300;\n***REMOVED***");
      scopes = escope.analyze(ast).scopes;
      expect(scopes.map(function(scope) ***REMOVED***
        return scope.variables.map(function(variable) ***REMOVED***
          return variable.defs.map(function(def) ***REMOVED***
          ...
          ***REMOVED***);
        ***REMOVED***);
      ***REMOVED***)).to.be.eql([[['FunctionName']], [[]]]);
      return expect(scopes[0].implicit.variables.map(function(variable) ***REMOVED***
        return variable.name;
      ***REMOVED***)).to.be.eql([]);
    ***REMOVED***);
    it('assignment leaks', function() ***REMOVED***
      var ast, scopes;
      ast = esprima.parse("function outer() ***REMOVED***\n    x = 20;\n***REMOVED***");
      scopes = escope.analyze(ast).scopes;
      expect(scopes.map(function(scope) ***REMOVED***
        return scope.variables.map(function(variable) ***REMOVED***
          return variable.name;
        ***REMOVED***);
      ***REMOVED***)).to.be.eql([['outer'], ['arguments']]);
      return expect(scopes[0].implicit.variables.map(function(variable) ***REMOVED***
        return variable.name;
      ***REMOVED***)).to.be.eql(['x']);
    ***REMOVED***);
    it('assignment doesn\'t leak', function() ***REMOVED***
      var ast, scopes;
      ...
      expect(scopes.map(function(scope) ***REMOVED***
        return scope.variables.map(function(variable) ***REMOVED***
          return variable.name;
        ***REMOVED***);
      ***REMOVED***)).to.be.eql([['outer'], ['arguments', 'inner', 'x'], ['arguments']]);
      return expect(scopes[0].implicit.variables.map(function(variable) ***REMOVED***
        return variable.name;
      ***REMOVED***)).to.be.eql([]);
    ***REMOVED***);
    it('for-in-statement leaks', function() ***REMOVED***
      var ast, scopes;
      ast = esprima.parse("function outer() ***REMOVED***\n    for (x in y) ***REMOVED*** ***REMOVED***\n***REMOVED***");
      scopes = escope.analyze(ast).scopes;
      expect(scopes.map(function(scope) ***REMOVED***
        return scope.variables.map(function(variable) ***REMOVED***
          return variable.name;
      ...
      ***REMOVED***)).to.be.eql(['x']);
    ***REMOVED***);
    return it('for-in-statement doesn\'t leaks', function() ***REMOVED***
      var ast, scopes;
      ast = esprima.parse("function outer() ***REMOVED***\n    function inner() ***REMOVED***\n        for (x in y) ***REMOVED*** ***REMOVED***\n    ***REMOVED***\n    var x;\n***REMOVED***");
      scopes = escope.analyze(ast).scopes;
      expect(scopes.map(function(scope) ***REMOVED***
