(function() ***REMOVED***
  ...
  describe('ES6 catch', function() ***REMOVED***
    return it('takes binding pattern', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("try ***REMOVED***\n***REMOVED*** catch (***REMOVED*** a, b, c, d ***REMOVED***) ***REMOVED***\n    let e = 20;\n    a;\n    b;\n    let c = 30;\n    c;\n    d;\n***REMOVED***");
