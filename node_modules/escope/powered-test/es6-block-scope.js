(function() ***REMOVED***
  ...
  describe('ES6 block scope', function() ***REMOVED***
    it('let is materialized in ES6 block scope#1', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("***REMOVED***\n    let i = 20;\n    i;\n***REMOVED***");
    ...
    ***REMOVED***);
    it('let is materialized in ES6 block scope#2', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("***REMOVED***\n    let i = 20;\n    var i = 20;\n    i;\n***REMOVED***");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
    ...
    ***REMOVED***);
    it('function delaration is materialized in ES6 block scope', function() ***REMOVED***
      var ast, scope, scopeManager;
    ...
    ***REMOVED***);
    it('let is not hoistable#1', function() ***REMOVED***
    ...
    ***REMOVED***);
    return it('let is not hoistable#2', function() ***REMOVED***
