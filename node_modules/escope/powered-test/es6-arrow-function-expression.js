(function() ***REMOVED***
  ...
  describe('ES6 arrow function expression', function() ***REMOVED***
    it('materialize scope for arrow function expression', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("var arrow = () => ***REMOVED***\n    let i = 0;\n    var j = 20;\n    console.log(i);\n***REMOVED***");
    ...
    ***REMOVED***);
    return it('generate bindings for parameters', function() ***REMOVED***
      var ast, scope, scopeManager;
      ast = harmony.parse("var arrow = (a, b, c, d) => ***REMOVED***\n***REMOVED***");
      scopeManager = escope.analyze(ast, ***REMOVED***
        ecmaVersion: 6
      ***REMOVED***);
      expect(scopeManager.scopes).to.have.length(2);
