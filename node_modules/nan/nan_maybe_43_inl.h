...
inline
MaybeLocal<v8::String> ToDetailString(v8::Local<v8::Value> val) ***REMOVED***
...
inline
MaybeLocal<v8::Uint32> ToArrayIndex(v8::Local<v8::Value> val) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline
Maybe<bool> Equals(v8::Local<v8::Value> a, v8::Local<v8::Value>(b)) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
...
inline
MaybeLocal<v8::Object> NewInstance(v8::Local<v8::Function> h) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline
MaybeLocal<v8::Object> NewInstance(v8::Local<v8::ObjectTemplate> h) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
  return scope.Escape(h->NewInstance(isolate->GetCurrentContext())
                          .FromMaybe(v8::Local<v8::Object>()));
...
inline MaybeLocal<v8::Function> GetFunction(
    v8::Local<v8::FunctionTemplate> t) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline Maybe<bool> Set(
  ...
  , v8::Local<v8::Value> value) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
...
inline
MaybeLocal<v8::Value> Get(v8::Local<v8::Object> obj, uint32_t index) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline Maybe<bool> Has(
    v8::Local<v8::Object> obj
  , v8::Local<v8::String> key) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
  return obj->Has(isolate->GetCurrentContext(), key);
***REMOVED***

inline Maybe<bool> Has(v8::Local<v8::Object> obj, uint32_t index) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
...
inline
Maybe<bool> Delete(v8::Local<v8::Object> obj, uint32_t index) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
...
inline
MaybeLocal<v8::Array> GetPropertyNames(v8::Local<v8::Object> obj) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline
MaybeLocal<v8::Array> GetOwnPropertyNames(v8::Local<v8::Object> obj) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline Maybe<bool> SetPrototype(
    v8::Local<v8::Object> obj
  , v8::Local<v8::Value> prototype) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
...
inline MaybeLocal<v8::String> ObjectProtoToString(
    v8::Local<v8::Object> obj) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline MaybeLocal<v8::Value> CallAsConstructor(
    v8::Local<v8::Object> obj
  , int argc, v8::Local<v8::Value> argv[]) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
  return scope.Escape(
...
inline
MaybeLocal<v8::String> GetSourceLine(v8::Local<v8::Message> msg) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::EscapableHandleScope scope(isolate);
...
inline Maybe<int> GetLineNumber(v8::Local<v8::Message> msg) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
  return msg->GetLineNumber(isolate->GetCurrentContext());
***REMOVED***

inline Maybe<int> GetStartColumn(v8::Local<v8::Message> msg) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
  return msg->GetStartColumn(isolate->GetCurrentContext());
***REMOVED***

inline Maybe<int> GetEndColumn(v8::Local<v8::Message> msg) ***REMOVED***
  v8::Isolate *isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
...
inline MaybeLocal<v8::Object> CloneElementAt(
  ...
  v8::Local<v8::Object> obj;
  if (!array->Get(context, index).ToLocal(&elem)) ***REMOVED***
    return scope.Escape(obj);
  ***REMOVED***
  if (!elem->ToObject(context).ToLocal(&obj)) ***REMOVED***
