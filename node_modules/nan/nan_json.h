...
class JSON ***REMOVED***
  ...
  ***REMOVED***
  ...
  inline
  Nan::MaybeLocal<v8::Value> Parse(v8::Local<v8::String> json_string) ***REMOVED***
  ...
  ***REMOVED***
  ...
  inline
  Nan::MaybeLocal<v8::String> Stringify(v8::Local<v8::Object> json_object) ***REMOVED***
    Nan::EscapableHandleScope scope;
  ...
  ***REMOVED***
  ...
  Nan::MaybeLocal<v8::String> Stringify(v8::Local<v8::Object> json_object,
    v8::Local<v8::String> gap) ***REMOVED***
    Nan::EscapableHandleScope scope;
    Nan::MaybeLocal<v8::String> result =
#if NAN_JSON_H_NEED_STRINGIFY
...
#if NAN_JSON_H_NEED_PARSE
  inline v8::Local<v8::Value> parse(v8::Local<v8::Value> arg) ***REMOVED***
...
#if NAN_JSON_H_NEED_STRINGIFY
  inline v8::Local<v8::Value> stringify(v8::Local<v8::Value> arg) ***REMOVED***
