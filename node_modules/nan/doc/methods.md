...
```c++
template<typename T> class FunctionCallbackInfo ***REMOVED***
 public:
...
```c++
template<typename T> class PropertyCallbackInfo : public PropertyCallbackInfoBase<T> ***REMOVED***
 public:
  ReturnValue<T> GetReturnValue() const;
  v8::Isolate* GetIsolate() const;
...
```c++
void EmptyArray(const Nan::FunctionCallbackInfo<v8::Value>& info) ***REMOVED***
...
```c++
template<typename T> class ReturnValue ***REMOVED***
 public:
  // Handle setters
...
```c++
void MethodName(const Nan::FunctionCallbackInfo<v8::Value>& info) ***REMOVED***
  ...
***REMOVED***
```
...
```c++
// .h:
class Foo : public Nan::ObjectWrap ***REMOVED***
  ...
...
// .cc:
void Foo::Bar(const Nan::FunctionCallbackInfo<v8::Value>& info) ***REMOVED***
  ...
***REMOVED***

void Foo::Baz(const Nan::FunctionCallbackInfo<v8::Value>& info) ***REMOVED***
  ...
***REMOVED***
```
...
void GetterName(v8::Local<v8::String> property,
                const Nan::PropertyCallbackInfo<v8::Value>& info) ***REMOVED***
  ...
***REMOVED***
```
...
void SetterName(v8::Local<v8::String> property,
                ...
                const Nan::PropertyCallbackInfo<void>& info) ***REMOVED***
  ...
***REMOVED***
```
