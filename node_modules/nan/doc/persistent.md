...
```c++
template<typename T> class PersistentBase ***REMOVED***
 public:
  /**
...
```c++
template<typename T> class NonCopyablePersistentTraits ***REMOVED***
 public:
...
```c++
template<typename T>
class CopyablePersistentTraits ***REMOVED***
 public:
...
template<typename T, typename M> class Persistent : public PersistentBase<T> ***REMOVED***
 public:
 /**
...
```c++
template<typename T> class Global : public PersistentBase<T> ***REMOVED***
 public:
  /**
...
```c++
template<typename T> class WeakCallbackInfo ***REMOVED***
 public:
...
```c++
void weakCallback(const WeakCallbackInfo<int> &data) ***REMOVED***
...
```c++
enum class WeakCallbackType ***REMOVED*** kParameter, kInternalFields ***REMOVED***;
```
