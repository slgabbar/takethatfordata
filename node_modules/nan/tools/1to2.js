...
fs.readFile(__dirname + '/package.json', 'utf8', function (err, data) ***REMOVED***
  if (err) ***REMOVED***
    throw err;
  ***REMOVED***
  ...
  if (!process.argv.slice(2).length) ***REMOVED***
...
groups.push([2, ['((', [
      ...
      'NAN_INDEX_DELETER',
      'NAN_INDEX_QUERY'].join('|'), ')\\([^\\)]*\\)\\s*\\***REMOVED***)\\s*NanScope\\(\\)\\s*;'].join('')]);
...
function replace() ***REMOVED***
	/* simple expressions */
      ...
      ***REMOVED***
      ...
      switch (arguments[groups[1][0]]) ***REMOVED***
     ...
     /* remove unnecessary NanScope() */
      switch (arguments[groups[5][0]]) ***REMOVED***
        case 'NAN_GETTER':
        case 'NAN_METHOD':
        case 'NAN_SETTER':
      ...
      ***REMOVED***
      ...
      /* Value converstion */
      switch (arguments[groups[6][0]]) ***REMOVED***
        case 'Boolean':
        case 'Int32':
        case 'Integer':
        case 'Number':
      ...
      ***REMOVED***
      ...
      switch (arguments[groups[7][0]]) ***REMOVED***
        case 'BooleanValue':
      ...
      ***REMOVED***
      ...
      if (arguments[groups[10][0]] === 'NanMakeWeakPersistent') ***REMOVED***
        return arguments[groups[10][0] + 1] + '.SetWeak(';
      ***REMOVED***

      /* These return Maybes, the upper ones take no arguments */
      switch (arguments[groups[11][0]]) ***REMOVED***
        case 'GetEndColumn':
        case 'GetFunction':
        case 'GetLineNumber':
      ...
      ***REMOVED***
      ...
      switch (arguments[groups[12][0]]) ***REMOVED***
        case 'Date':
        case 'String':
        case 'RegExp':
      ...
      ***REMOVED***
      ...
      if (arguments[groups[13][0]] === 'Equals') ***REMOVED***
...
function processFile(file) ***REMOVED***
  fs.readFile(file, ***REMOVED***encoding: 'utf8'***REMOVED***, function (err, data) ***REMOVED***
    if (err) ***REMOVED***
      throw err;
    ***REMOVED***

    /* run replacement twice, might need more runs */
    fs.writeFile(file, data.replace(master, replace).replace(master, replace), function (err) ***REMOVED***
      if (err) ***REMOVED***
        throw err;
      ***REMOVED***
    ***REMOVED***);
...
for (i = 2, length = process.argv.length; i < length; i++) ***REMOVED***
  glob(process.argv[i], function (err, matches) ***REMOVED***
    if (err) ***REMOVED***
      throw err;
    ***REMOVED***
