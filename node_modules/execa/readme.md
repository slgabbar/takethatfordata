...
execa('echo', ['unicorns']).then(result => ***REMOVED***
...
execa.shell('echo unicorns').then(result => ***REMOVED***
	console.log(result.stdout);
	//=> 'unicorns'
***REMOVED***);

// example of catching an error
execa.shell('exit 3').catch(error => ***REMOVED***
	console.log(error);
	/*
	***REMOVED***
...
getStream(stream).then(value => ***REMOVED***
