...
* `prop` *****REMOVED***String***REMOVED*****: The property name to use for storing values.
* `returns` *****REMOVED***Function***REMOVED*****: Returns a custom `Cache` constructor
...
* `cache` *****REMOVED***Object***REMOVED*****: Optionally pass an object to initialize with.
...
* `key` *****REMOVED***String***REMOVED*****: The name of the property to get. Dot-notation may be used.
* `returns` *****REMOVED***any***REMOVED*****: Returns the value of `key`
...
* `key` *****REMOVED***String|Array***REMOVED*****: Property name or array of property names.
* `returns` *****REMOVED***Object***REMOVED*****: Returns the instance for chaining.
...
* `method` *****REMOVED***String***REMOVED*****: The name of the `base` method to call.
* `val` *****REMOVED***Object|Array***REMOVED*****: The object or array to iterate over.
* `returns` *****REMOVED***Object***REMOVED*****: Returns the instance for chaining.
