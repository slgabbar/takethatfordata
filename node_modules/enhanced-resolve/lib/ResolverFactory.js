...
exports.createResolver = function(options) ***REMOVED***
	...
	var cachePredicate = options.cachePredicate || function() ***REMOVED***
		return true;
	***REMOVED***;
	...
	***REMOVED***
	...
	modules = mergeFilteredToArray([].concat(modules), function(item) ***REMOVED***
		return !isAbsolutePath(item);
	***REMOVED***);

	mainFields = mainFields.map(function(item) ***REMOVED***
	...
	***REMOVED***);
	...
	if(typeof alias === "object" && !Array.isArray(alias)) ***REMOVED***
		alias = Object.keys(alias).map(function(key) ***REMOVED***
	...
	***REMOVED***
	...
	if(unsafeCache && typeof unsafeCache !== "object") ***REMOVED***
		unsafeCache = ***REMOVED******REMOVED***;
	***REMOVED***

	//// pipeline ////

	// resolve
	if(unsafeCache) ***REMOVED***
	...
	***REMOVED***
	...
	// described-resolve
	alias.forEach(function(item) ***REMOVED***
		plugins.push(new AliasPlugin("described-resolve", item, "resolve"));
	***REMOVED***);
	plugins.push(new ConcordModulesPlugin("described-resolve", ***REMOVED******REMOVED***, "resolve"));
	aliasFields.forEach(function(item) ***REMOVED***
	...
	***REMOVED***);
	...
	// raw-module
	moduleExtensions.forEach(function(item) ***REMOVED***
	...
	***REMOVED***);
	...
	// module
	modules.forEach(function(item) ***REMOVED***
	...
	***REMOVED*** else ***REMOVED***
		...
		// existing-directory
		plugins.push(new ConcordMainPlugin("existing-directory", ***REMOVED******REMOVED***, "resolve"));
		mainFields.forEach(function(item) ***REMOVED***
			plugins.push(new MainFieldPlugin("existing-directory", item, "resolve"));
		***REMOVED***);
		mainFiles.forEach(function(item) ***REMOVED***
		...
		***REMOVED***);
		...
		plugins.push(new ConcordExtensionsPlugin("raw-file", ***REMOVED******REMOVED***, "file"));
		extensions.forEach(function(item) ***REMOVED***
		...
		***REMOVED***);
		plugins.push(new ConcordModulesPlugin("file", ***REMOVED******REMOVED***, "resolve"));
		aliasFields.forEach(function(item) ***REMOVED***
...
function mergeFilteredToArray(array, filter) ***REMOVED***
	return array.reduce(function(array, item) ***REMOVED***
		if(filter(item)) ***REMOVED***
			var lastElement = array[array.length - 1];
			if(Array.isArray(lastElement)) ***REMOVED***
...
function isAbsolutePath(path) ***REMOVED***
