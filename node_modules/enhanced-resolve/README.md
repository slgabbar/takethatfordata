...
const ***REMOVED***
  ...
  ResolverFactory
***REMOVED*** = require('enhanced-resolve');

// create a resolver
const myResolver = ResolverFactory.createResolver(***REMOVED***
...
const context = ***REMOVED******REMOVED***;
const lookupStartPath = '/Users/webpack/some/root/dir';
const request = './path/to-look-up.js';
myResolver.resolve(***REMOVED******REMOVED***, lookupStartPath, request, (err/*Error*/, filepath/*string*/) => ***REMOVED***
...
| cachePredicate           | function() ***REMOVED*** return true ***REMOVED***; | A function which decides whether a request should be cached or not. An object is passed to the function with `path` and `request` properties. |
...
### Plugin Boilerplate
```js
class MyResolverPlugin ***REMOVED***
  constructor(source, target) ***REMOVED***
    this.source = source;
    this.target = target;
  ***REMOVED***
