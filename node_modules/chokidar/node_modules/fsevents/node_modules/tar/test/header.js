...
tap.test("parsing", function (t) ***REMOVED***
  Object.keys(headers).forEach(function (name) ***REMOVED***
    var h = headers[name]
...
tap.test("encoding", function (t) ***REMOVED***
  Object.keys(headers).forEach(function (name) ***REMOVED***
    var h = headers[name]
...
tap.test("parseNumeric tests", function (t) ***REMOVED***
  var parseNumeric = TarHeader.parseNumeric
    , numbers =
      ***REMOVED*** "303737373737373700": 2097151
      ...
      , "ffffffffffff1544c5": -15383354 ***REMOVED***
  Object.keys(numbers).forEach(function (n) ***REMOVED***
