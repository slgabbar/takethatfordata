...
## 0.6.39
 ...
 - Support for node v9
 - Support for versioning on `***REMOVED***libc***REMOVED***` to allow binaries to work on non-glic linux systems like alpine linux
...
## 0.6.0
 ...
 - BREAKING: node odd releases like v0.11.x now use `major.minor.patch` for `***REMOVED***node_abi***REMOVED***` instead of `NODE_MODULE_VERSION` (#124)
