...
var bOpts = ***REMOVED******REMOVED***;
if (standalone) bOpts.standalone = standalone;

browserify(bOpts)
.require(path.join(packageDir, json.main), ***REMOVED***expose: json.name***REMOVED***)
.bundle(function (err, buf) ***REMOVED***
  if (err) ***REMOVED***
  ...
  ***REMOVED***;
  if (compress) ***REMOVED***
    ...
    for (var i=0; i<compressOpts.length; ++i) ***REMOVED***
