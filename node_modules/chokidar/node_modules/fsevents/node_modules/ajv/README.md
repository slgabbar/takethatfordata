...
```javascript
var Ajv = require('ajv');
var ajv = new Ajv(); // options can be passed, e.g. ***REMOVED***allErrors: true***REMOVED***
...
var schema = ***REMOVED***
  "properties": ***REMOVED***
    "smaller": ***REMOVED***
      "type": "number",
      "maximum": ***REMOVED*** "$data": "1/larger" ***REMOVED***
    ***REMOVED***,
    "larger": ***REMOVED*** "type": "number" ***REMOVED***
  ***REMOVED***
***REMOVED***;
...
***REMOVED***
  "$merge": ***REMOVED***
    "source": ***REMOVED***
      "type": "object",
      "properties": ***REMOVED*** "p": ***REMOVED*** "type": "string" ***REMOVED*** ***REMOVED***,
      "additionalProperties": false
    ***REMOVED***,
    "with": ***REMOVED***
      "properties": ***REMOVED*** "q": ***REMOVED*** "type": "number" ***REMOVED*** ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
```
...
***REMOVED***
  "$patch": ***REMOVED***
    ...
    ***REMOVED***,
    "with": [
      ***REMOVED*** "op": "add", "path": "/properties/q", "value": ***REMOVED*** "type": "number" ***REMOVED*** ***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
...
***REMOVED***
  "type": "object",
  "properties": ***REMOVED***
    "p": ***REMOVED*** "type": "string" ***REMOVED***,
    "q": ***REMOVED*** "type": "number" ***REMOVED***
  ***REMOVED***,
  "additionalProperties": false
***REMOVED***
```
...
```javascript
ajv.addKeyword('range', ***REMOVED*** type: 'number', compile: function (sch, parentSchema) ***REMOVED***
  var min = sch[0];
  var max = sch[1];

  return parentSchema.exclusiveRange === true
          ? function (data) ***REMOVED*** return data > min && data < max; ***REMOVED***
          : function (data) ***REMOVED*** return data >= min && data <= max; ***REMOVED***
***REMOVED*** ***REMOVED***);

var schema = ***REMOVED*** "range": [2, 4], "exclusiveRange": true ***REMOVED***;
var validate = ajv.compile(schema);
...
```javascript
var ajv = new Ajv(***REMOVED*** loadSchema: loadSchema ***REMOVED***);

ajv.compileAsync(schema, function (err, validate) ***REMOVED***
	if (err) return;
	var valid = validate(data);
***REMOVED***);

function loadSchema(uri, callback) ***REMOVED***
	request.json(uri, function(err, res, body) ***REMOVED***
...
```javascript
/**
 * without "async" and "transpile" options (or with option ***REMOVED***async: true***REMOVED***)
...
ajv.addKeyword('idExists', ***REMOVED***
  async: true,
  type: 'number',
...
function checkIdExists(schema, data) ***REMOVED***
  return knex(schema.table)
  .select('id')
  .where('id', data)
  .then(function (rows) ***REMOVED***
...
var schema = ***REMOVED***
  ...
  "properties": ***REMOVED***
    "userId": ***REMOVED***
      "type": "integer",
      "idExists": ***REMOVED*** "table": "users" ***REMOVED***
    ***REMOVED***,
    "postId": ***REMOVED***
      "type": "integer",
      "idExists": ***REMOVED*** "table": "posts" ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***;
...
validate(***REMOVED*** userId: 1, postId: 19 ***REMOVED***))
.then(function (valid) ***REMOVED***
...
```javascript
var ajv = new Ajv(***REMOVED*** /* async: 'es7', */ transpile: 'nodent' ***REMOVED***);
...
```javascript
var ajv = new Ajv(***REMOVED*** /* async: 'es7', */ transpile: 'regenerator' ***REMOVED***);
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
```
...
```javascript
var ajv = new Ajv(***REMOVED*** async: 'es7', transpile: transpileFunc ***REMOVED***);
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
```
...
```javascript
var ajv = new Ajv(***REMOVED*** removeAdditional: true ***REMOVED***);
var schema = ***REMOVED***
  "additionalProperties": false,
  "properties": ***REMOVED***
    "foo": ***REMOVED*** "type": "number" ***REMOVED***,
    "bar": ***REMOVED***
      "additionalProperties": ***REMOVED*** "type": "number" ***REMOVED***,
      "properties": ***REMOVED***
        "baz": ***REMOVED*** "type": "string" ***REMOVED***
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
...
console.log(data); // ***REMOVED*** "foo": 0, "bar": ***REMOVED*** "baz": "abc", "additional2": 2 ***REMOVED***
```
...
With the option `removeAdditional: true` the validation will pass for the object `***REMOVED*** "foo": "abc"***REMOVED***` but will fail for the object `***REMOVED***"bar": 1***REMOVED***`. It happens because while the first subschema in `oneOf` is validated, the property `bar` is removed because it is an additional property according to the standard (because it is not included in `properties` keyword in the same schema).
...
***REMOVED***
  ...
  ***REMOVED***,
  "additionalProperties": false,
  "oneOf": [
    ***REMOVED*** "required": [ "foo" ] ***REMOVED***,
    ***REMOVED*** "required": [ "bar" ] ***REMOVED***
  ]
***REMOVED***
```
...
```javascript
var ajv = new Ajv(***REMOVED*** useDefaults: true ***REMOVED***);
var schema = ***REMOVED***
  "type": "object",
  "properties": ***REMOVED***
    "foo": ***REMOVED*** "type": "number" ***REMOVED***,
    "bar": ***REMOVED*** "type": "string", "default": "baz" ***REMOVED***
  ***REMOVED***,
  "required": [ "foo", "bar" ]
***REMOVED***;

var data = ***REMOVED*** "foo": 1 ***REMOVED***;

var validate = ajv.compile(schema);

console.log(validate(data)); // true
console.log(data); // ***REMOVED*** "foo": 1, "bar": "baz" ***REMOVED***
```
...
var schema = ***REMOVED***
  "type": "array",
  "items": [
    ***REMOVED*** "type": "number" ***REMOVED***,
    ***REMOVED*** "type": "string", "default": "foo" ***REMOVED***
  ]
***REMOVED***
...
```javascript
var ajv = new Ajv(***REMOVED*** useDefaults: 'shared' ***REMOVED***);

var schema = ***REMOVED***
  properties: ***REMOVED***
    foo: ***REMOVED***
      default: ***REMOVED*** bar: 1 ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
...
console.log(validate(data)); // true
console.log(data); // ***REMOVED*** foo: ***REMOVED*** bar: 1 ***REMOVED*** ***REMOVED***

data.foo.bar = 2;

var data2 = ***REMOVED******REMOVED***;
console.log(validate(data2)); // true
console.log(data2); // ***REMOVED*** foo: ***REMOVED*** bar: 2 ***REMOVED*** ***REMOVED***
```
...
```javascript
var ajv = new Ajv(***REMOVED*** coerceTypes: true ***REMOVED***);
var schema = ***REMOVED***
  "type": "object",
  "properties": ***REMOVED***
    "foo": ***REMOVED*** "type": "number" ***REMOVED***,
    "bar": ***REMOVED*** "type": "boolean" ***REMOVED***
  ***REMOVED***,
  "required": [ "foo", "bar" ]
***REMOVED***;

var data = ***REMOVED*** "foo": "1", "bar": "false" ***REMOVED***;

var validate = ajv.compile(schema);

console.log(validate(data)); // true
console.log(data); // ***REMOVED*** "foo": 1, "bar": false ***REMOVED***
```

Example 2 (array coercions):

```javascript
var ajv = new Ajv(***REMOVED*** coerceTypes: 'array' ***REMOVED***);
var schema = ***REMOVED***
  "properties": ***REMOVED***
    "foo": ***REMOVED*** "type": "array", "items": ***REMOVED*** "type": "number" ***REMOVED*** ***REMOVED***,
    "bar": ***REMOVED*** "type": "boolean" ***REMOVED***
  ***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  schemas:          ***REMOVED******REMOVED***,
  // referenced schema options:
  missingRefs:      true,
  extendRefs:       true,
  loadSchema:       undefined, // function(uri, cb) ***REMOVED*** /* ... */ cb(err, schema); ***REMOVED***,
