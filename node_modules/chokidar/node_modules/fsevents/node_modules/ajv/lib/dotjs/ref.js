'use strict';
module.exports = function generate_ref(it, $keyword) ***REMOVED***
  var out = ' ';
  var $lvl = it.level;
    ...
    ***REMOVED***
    ...
    if ($async) ***REMOVED***
      ...
      if ($breakOnError) ***REMOVED***
        out += 'var ' + ($valid) + ' =';
      ***REMOVED***
      out += ' ' + (it.yieldAwait) + ' ' + (__callValidate) + '; ***REMOVED*** catch (e) ***REMOVED*** if (!(e instanceof ValidationError)) throw e; if (vErrors === null) vErrors = e.errors; else vErrors = vErrors.concat(e.errors); errors = vErrors.length; ***REMOVED*** ';
      if ($breakOnError) ***REMOVED***
