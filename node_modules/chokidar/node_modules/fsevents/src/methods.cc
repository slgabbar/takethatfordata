...
void FSEvents::emitEvent(const char *path, UInt32 flags, UInt64 id) ***REMOVED***
  if (!handler) return;
...
NAN_METHOD(FSEvents::New) ***REMOVED***
...
NAN_METHOD(FSEvents::Stop) ***REMOVED***
...
NAN_METHOD(FSEvents::Start) ***REMOVED***
  FSEvents* fse = node::ObjectWrap::Unwrap<FSEvents>(info.This());
  fse->asyncStart();
  fse->threadStart();
