...
/**
 * Gets the ***REMOVED***@link firebase.messaging.Messaging `Messaging`***REMOVED*** service for the
 * default app or a given app.
 *
 * `firebase.messaging()` can be called with no arguments to access the default
 * app's ***REMOVED***@link firebase.messaging.Messaging `Messaging`***REMOVED*** service or as
 * `firebase.messaging(app)` to access the
 * ***REMOVED***@link firebase.messaging.Messaging `Messaging`***REMOVED*** service associated with a
 * specific app.
 *
 ...
 *
 * @namespace
 * @param ***REMOVED***!firebase.app.App=***REMOVED*** app The app to create a Messaging service for.
 *     If not passed, uses the default app.
 *
 * @return ***REMOVED***!firebase.messaging.Messaging***REMOVED***
 */
firebase.messaging = function(app) ***REMOVED******REMOVED***;
 ...
 * @return ***REMOVED***!firebase.messaging.Messaging***REMOVED***
 */
firebase.app.App.prototype.messaging = function() ***REMOVED******REMOVED***;

/**
 * The Firebase Messaging service interface.
 *
 * Do not call this constructor directly. Instead, use
 * ***REMOVED***@link firebase.messaging `firebase.messaging()`***REMOVED***.
 *
 * See
 * ***REMOVED***@link
 *   https://firebase.google.com/docs/cloud-messaging/js/client
 *   Set Up a JavaScript Firebase Cloud Messaging Client App***REMOVED***
 * for a full guide on how to use the Firebase Messaging service.
 *
 * @interface
 */
firebase.messaging.Messaging = function() ***REMOVED******REMOVED***;
 ...
 *
 * @return ***REMOVED***firebase.Promise***REMOVED*** The promise resolves if permission is
 *   granted. Otherwise, the promise is rejected with an error.
 */
firebase.messaging.Messaging.prototype.requestPermission = function() ***REMOVED******REMOVED***;
 ...
 *
 * @return ***REMOVED***firebase.Promise<string>***REMOVED*** The promise resolves if an FCM token can
 *   be retrieved. This method returns null if the current origin does not have
 *   permission to show notifications.
 */
firebase.messaging.Messaging.prototype.getToken = function() ***REMOVED******REMOVED***;
 ...
 * to get a new token.
 *
 * @param ***REMOVED***!firebase.Observer<Object, void>|!function(!Object)***REMOVED***
 *     nextOrObserver This function, or observer object with `next` defined,
 *     is called when a token refresh has occurred.
 * @return ***REMOVED***firebase.Unsubscribe***REMOVED*** To stop listening for token
 ...
 * @return ***REMOVED***firebase.Unsubscribe***REMOVED*** To stop listening for messages
 *    execute this returned function.
 */
firebase.messaging.Messaging.prototype.onMessage = function(nextOrObserver) ***REMOVED******REMOVED***;

/**
 * To forceably stop a registration token from being used, delete it
 * by calling this method.
 *
 * @param ***REMOVED***!string***REMOVED*** token The token to delete.
 * @return ***REMOVED***firebase.Promise***REMOVED*** The promise resolves when the token has been
 *   successfully deleted.
 */
firebase.messaging.Messaging.prototype.deleteToken = function(token) ***REMOVED******REMOVED***;
 ...
 *
 * @param ***REMOVED***!function(!Object)***REMOVED*** callback The function to handle the push message.
 */
