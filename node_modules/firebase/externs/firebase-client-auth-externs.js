 ...
 *     (***REMOVED***@link firebase.auth.AuthCredential***REMOVED***) fields are also provided. You can
 *     recover from this error by signing in with that credential directly via
 *     ***REMOVED***@link firebase.auth.Auth#signInWithCredential***REMOVED***.</dd>
 ...
 *     (***REMOVED***@link firebase.auth.AuthCredential***REMOVED***) fields are also provided.
 *     You have to link the credential to the existing user with that email if
 *     you wish to continue signing in with that credential. To do so, call
 *     ***REMOVED***@link firebase.auth.Auth#fetchProvidersForEmail***REMOVED***, sign in to
 *     <code>error.email</code> via one of the providers returned and then
 *     ***REMOVED***@link firebase.User#linkWithCredential***REMOVED*** the original credential to that
 ...
 *     ***REMOVED***@link firebase.User#linkWithCredential***REMOVED*** to prevent the user from signing
 ...
 * user.reauthenticateWithPopup(provider).then(function(result) ***REMOVED***
 *   // The firebase.User instance:
 *   var user = result.user;
 *   // The Facebook firebase.auth.AuthCredential containing the Facebook
 *   // access token:
 ...
 * @return ***REMOVED***!firebase.Promise<!firebase.auth.UserCredential>***REMOVED***
 */
firebase.User.prototype.reauthenticateWithPopup = function(provider) ***REMOVED******REMOVED***;
 ...
 * @return ***REMOVED***!firebase.Promise<void>***REMOVED***
 */
firebase.User.prototype.reauthenticateWithRedirect = function(provider) ***REMOVED******REMOVED***;
...
/**
 * An ***REMOVED***@link https://www.google.com/recaptcha/ reCAPTCHA***REMOVED***-based application
 * verifier.
 * @param ***REMOVED***!Element|string***REMOVED*** container The reCAPTCHA container parameter. This
 ...
 * @param ***REMOVED***?Object=***REMOVED*** parameters The optional reCAPTCHA parameters. Check the
 ...
 * @param ***REMOVED***?firebase.app.App=***REMOVED*** app The corresponding Firebase app. If none is
 ...
 *     thrown.
 * @constructor
 * @implements ***REMOVED***firebase.auth.ApplicationVerifier***REMOVED***
 */
firebase.auth.RecaptchaVerifier = function(container, parameters, app) ***REMOVED******REMOVED***;
 ...
 */
firebase.auth.RecaptchaVerifier.prototype.clear = function() ***REMOVED******REMOVED***;

/**
 * Renders the reCAPTCHA widget on the page.
 * @return ***REMOVED***!firebase.Promise<number>***REMOVED*** A Promise that resolves with the
 *     reCAPTCHA widget ID.
 */
firebase.auth.RecaptchaVerifier.prototype.render = function() ***REMOVED******REMOVED***;

/**
 * Waits for the user to solve the reCAPTCHA and resolves with the reCAPTCHA
 * token.
 * @return ***REMOVED***!firebase.Promise<string>***REMOVED*** A Promise for the reCAPTCHA token.
 */
firebase.auth.RecaptchaVerifier.prototype.verify = function() ***REMOVED******REMOVED***;
