 ...
 * Version: $***REMOVED***JSCORE_VERSION***REMOVED***
 *
...
/**
 * Gets the ***REMOVED***@link firebase.database.Database `Database`***REMOVED*** service for the
 * default app or a given app.
 *
 * `firebase.database()` can be called with no arguments to access the default
 * app's ***REMOVED***@link firebase.database.Database `Database`***REMOVED*** service or as
 * `firebase.database(app)` to access the
 * ***REMOVED***@link firebase.database.Database `Database`***REMOVED*** service associated with a
 * specific app.
 *
 ...
 *
 * @namespace
 * @param ***REMOVED***!firebase.app.App=***REMOVED*** app Optional app whose Database service to
 *   return. If not provided, the default Database service will be returned.
 * @return ***REMOVED***!firebase.database.Database***REMOVED*** The default Database service if no app
 ...
 * ***REMOVED***@link firebase.database `firebase.database()`***REMOVED***.
 *
 * See
 * ***REMOVED***@link
 *   https://firebase.google.com/docs/database/web/start/
 *   Installation &amp; Setup in JavaScript***REMOVED***
 ...
 * firebase.database.enableLogging(function(message) ***REMOVED***
 *   console.log("[FIREBASE]", message);
 * ***REMOVED***);
 *
 * @param ***REMOVED***(boolean|function(string))=***REMOVED*** logger Enables logging if `true`;
 ...
 * @namespace
 */
firebase.database.ServerValue = ***REMOVED******REMOVED***;
...
/**
 * The ***REMOVED***@link firebase.app.App app***REMOVED*** associated with the `Database` service
 * instance.
 *
 * @example
 ...
 *
 * @param ***REMOVED***string=***REMOVED*** path Optional path representing the location the returned
 *   `Reference` will point. If not provided, the returned `Reference` will
 *   point to the root of the Database.
 * @return ***REMOVED***!firebase.database.Reference***REMOVED*** If a path is provided, a `Reference`
 ...
 *
 * @param ***REMOVED***string***REMOVED*** url The Firebase URL at which the returned `Reference` will
 *   point.
 * @return ***REMOVED***!firebase.database.Reference***REMOVED*** A `Reference` pointing to the provided
 *   Firebase URL.
 */
 ...
 *   Read and Write Data on the Web***REMOVED***
 *
 * @interface
 ...
 */
firebase.database.Reference.prototype.update = function(values, onComplete) ***REMOVED******REMOVED***;
 ...
 *   Enabling Offline Capabilities in JavaScript***REMOVED*** for more information on how
 * to use it.
 *
 ...
 *
 * @param ***REMOVED***firebase.database.Query***REMOVED*** other The query to compare against.
 * @return ***REMOVED***boolean***REMOVED*** Whether or not the current and provided queries are
 *   equivalent.
 */
firebase.database.Query.prototype.isEqual = function(other) ***REMOVED******REMOVED***;
 ...
 * ***REMOVED***@link https://firebase.google.com/docs/database/web/retrieve-data
 *   Retrieve Data on the Web***REMOVED***
 * for more details.
 *
 * <h4>value event</h4>
 *
 ...
 * @param ***REMOVED***Object=***REMOVED*** context If provided, this object will be used as `this`
 ...
 * listening.
 *
 * This is equivalent to calling ***REMOVED***@link firebase.database.Query#on `on()`***REMOVED***, and
 * then calling ***REMOVED***@link firebase.database.Query#off `off()`***REMOVED*** inside the callback
 * function. See ***REMOVED***@link firebase.database.Query#on `on()`***REMOVED*** for details on the
 * event types.
 *
 * @example
 ...
 * ***REMOVED***@link
 *  https://firebase.google.com/docs/database/web/lists-of-data#sort_data
 *  Sort data***REMOVED*** for alternatives to priority.
 *
 * @return ***REMOVED***!firebase.database.Query***REMOVED***
 */
 ...
 * @param ***REMOVED***string=***REMOVED*** key The child key to start at. This argument is only allowed
 ...
 *
 * @return ***REMOVED***!Object***REMOVED*** A JSON-serializable representation of this object.
 */
firebase.database.Query.prototype.toJSON = function() ***REMOVED******REMOVED***;
 ...
 * @return ***REMOVED***boolean***REMOVED*** `true` if data exists at the specified child path; else
 *  `false`.
 */
 ...
 * @return ***REMOVED***?Object***REMOVED*** A JSON-serializable representation of this object.
 */
firebase.database.DataSnapshot.prototype.toJSON = function() ***REMOVED******REMOVED***;
 ...
 * ***REMOVED***@link
 *   https://firebase.google.com/docs/database/web/offline-capabilities
 *   Enabling Offline Capabilities in JavaScript***REMOVED*** for more information.
 *
 ...
 * @param ***REMOVED***function(?Error)=***REMOVED*** onComplete An optional callback function that
 ...
 */
firebase.database.OnDisconnect.prototype.set = function(value, onComplete) ***REMOVED******REMOVED***;
 ...
 * ***REMOVED***@link firebase.database.Reference#update `update()`***REMOVED***.
 *
 * @example
 * var ref = firebase.database().ref("users/ada");
 * ref.update(***REMOVED***
